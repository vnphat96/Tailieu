...
Trong KG $Oxyz$, cho hai vectơ $\vec{u}=\left(2;1;-1\right)$ và $\vec{v}=\left(1;3;m\right)$. Tìm $m$ để $\left(\vec{u},\vec{v}\right)=90^\circ$.
\choice
{$m=-5$}
{\True $m=5$}
{$m=1$}
...
\begin{ex}%[Nguyễn Thành Tiến- Dự án Tổng ôn LVĐ 2022]%[2H3B1-1]%
Trong KG $Oxyz$, cho các vectơ $\vec{a}=\left(-1;1;0\right)$, $\vec{b}=\left(1;1;0\right)$ và $\vec{c}=\left(1;1;1\right)$. Mệnh đề nào dưới đây sai
\choice
{$\vec{a} \perp \vec{b}$}
...
\begin{ex}%[2H3B2-3]%
Trong KG $Oxyz$, mặt phẳng đi qua điểm $A(1 ; 3 ;-2)$ và song song với mặt phẳng $(P): 2 x-y+3 z+4=0$ là
\choice
{$2 x+y+3 z+7=0$}
{$2 x+y-3 z+7=0$}
{\True $2 x-y+3 z+7=0$}
