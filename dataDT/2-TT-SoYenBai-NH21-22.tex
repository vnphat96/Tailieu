...
Trong KG $Oxyz$, vectơ nào dưới đây là một vectơ chỉ phương của đường thẳng đi qua gốc tọa độ $O$ và điểm $Q(4;-3;5)$?
\choice
...
%%==========Câu 46
\begin{ex}%[2H3G3-7]
	Trong KG $Oxyz$, cho điểm $A(1;2;-3)$ và mặt phẳng $(P) \colon 2x+2y-z+9=0$. Đường thẳng $d$ đi qua $A$ và có vectơ chỉ phương là $\overrightarrow{u}=(3;4;-4)$ cắt $(P)$ tại $B$. Điểm $M$ thay đổi trong $(P)$ sao cho $M$ luôn nhìn đoạn $AB$ dưới một góc $90^\circ $. Khi độ dài $MB$ lớn nhất, đường thẳng $MB$ đi qua điểm nào trong các điểm sau?
	\choice
	{\True $I(3;-2;11)$}
	{$J(1;-2;5)$}
	{$H(-2;-1;3)$}
