...
% 	& z=t
% 	}\left(t\in \mathbb{R}\right) $}
% 	\loigiai{Đường thẳng $ Oy $ đi qua điểm $ A\left(0;2; 0\right) $ và nhận véc-tơ đơn vị $ \vec{j}=\left(0; 1; 0\right) $ làm véc-tơ chỉ phương nên có phương trình tham số là 
% 	$\heva{
% 	& x=0+0\cdot t \\
% 	& y=2+1\cdot t \\
% 	& z=0+0\cdot t
