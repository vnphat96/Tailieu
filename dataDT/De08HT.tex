...
% 	{$ \dfrac{x}{x^2+2} $}
% 	{$ \dfrac{2x+2}{x^2+2} $}
% 	\loigiai{Đạo hàm của hàm số $ y=\ln (x^2+2) $ là $ y'=\dfrac{\left(x^2+2\right)'}{x^2+2}=\dfrac{2x}{x^2+2} $.
% 	}
% \end{ex}
% %%%=========HetCau_13=========%%%
% %%%=========Cau_14=========%%%
...
% %%%=========Cau_15=========%%%
% \begin{ex}%[2H3B3-1]
% 	Trong không gian với hệ tọa độ $ Oxyz $, vectơ nào trong $ 4 $ phương án dưới đây là một vectơ chỉ phương của đường thẳng có phương trình $ \dfrac{x-1}{3}=\dfrac{3y}{2}=\dfrac{3-z}{1} $.\\
% 	\choice
...
% 	\loigiai{Đường thẳng $ \dfrac{x-1}{3}=\dfrac{3y}{2}=\dfrac{3-z}{1}\Leftrightarrow \dfrac{x-1}{3}=\dfrac{y}{\dfrac{2}{3}}=\dfrac{z-3}{-1} $ có một vectơ chỉ phương là
% 	$ \overrightarrow{b}=\left(3;\dfrac{2}{3};-1\right) $, suy ra $ \overrightarrow{a}_2=3\overrightarrow{b}=\left(9;2;-3\right) $ cũng là một vectơ chỉ phương của đường thẳng đã cho.
% 	}
% \end{ex}
% %%%=========HetCau_15=========%%%
% %%%=========Cau_16=========%%%
...
% 	\loigiai{
% 	\immini[thm]{	Gọi $ SAB $ là thiết diện qua trục của hình nón\\
...
% 	\loigiai{
% 	\immini[thm]{	Gọi $ H $ là trung điểm $ AB\Rightarrow SH\perp \left(ABCD\right) $.\\
...
% 	& z=t
% 	}\left(t\in \mathbb{R}\right) $}
% 	\loigiai{Đường thẳng $ Oy $ đi qua điểm $ A\left(0;2; 0\right) $ và nhận vectơ đơn vị $ \vec{j}=\left(0; 1; 0\right) $ làm vectơ chỉ phương nên có PTTS là 
% 	$\heva{
% 	& x=0+0\cdot t \\
% 	& y=2+1\cdot t \\
% 	& z=0+0\cdot t
...
\begin{ex}%[2H3K3-2]
	...
	Đường thẳng $ d_1 $ có một vectơ chỉ phương $ \overrightarrow{u}_1=\left(2;3;-5\right) $;\\
	$ d_2 $ có một vectơ chỉ phương $ \overrightarrow{u}_2=\left(3;-2;-1\right) $.\\
	...
	a=-1 \\
	b=1.
	} $ \\ Do đó $ A\left(0;0;1\right) $ và $ \overrightarrow{AB}=\left(2;2;2\right) $ là một vectơ chỉ phương của $ AB $, suy ra $ AB $ cũng có một vectơ chỉ phương $ \overrightarrow{u}=\dfrac{1}{2}\overrightarrow{AB}=\left(1;1;1\right) $.\\
...
\begin{ex}%[2D4G5-1]
	...
	{\True $ 8 $}
	\loigiai{
	\immini[thm]{ Gọi $ M, N $ lần lượt là điểm biểu diễn của hai số phức $ z_1, z_2 $.\\
	Do $ \heva{
...
\begin{ex}%[2H3G2-7]%[2H3G2-8]
	...
	{$ 2031\pi^2 $}
	\loigiai{
	\immini[thm]{Dễ thấy $ (P) \parallel (R) $, gọi $ O $ là tâm của đường tròn đáy hình nón, $ O'=IO\cap (Q) $, từ giả thiết ta có
