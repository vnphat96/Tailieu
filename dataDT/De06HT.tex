...
% 		Thật vậy ta có\\ $ \left(\displaystyle\int f(x)\mathrm{d}x+\displaystyle\int g(x)\mathrm{d}x\right)^{\prime}=\left(\displaystyle\int f(x)\mathrm{d}x\right)^{\prime}+\left(\displaystyle\int g(x)\mathrm{d}x\right)^{\prime}=f(x)+g(x) $.\\
...
% 		Mệnh đề 4 sai vì $VT=\displaystyle\int\left[f'(x)g(x)+f(x)g'(x)\right]\mathrm{d}x=\displaystyle\int\left[f(x)g(x)\right]^{\prime}\mathrm{d}x=f(x)g(x)+C\ne VP $.
% 	}
% \end{ex}
% %%%=========HetCau_2=========%%%
...
% 	\loigiai{
% 		Ta có: $ \displaystyle\int{3}^{2x}\mathrm{d}x=\dfrac{1}{2}\displaystyle\int{3}^{2x}\cdot2\mathrm{d}x=\dfrac{1}{2}\displaystyle\int{3}^{2x}\mathrm{d}(2x)=\dfrac{1}{2}\cdot \dfrac{3^{2x}}{\ln3}+C $.\\
...
% 	\loigiai{
% 		$ f'(x)=\left(\sqrt{x^2+1}\right)^{\prime}\cdot\mathrm{e}^{\sqrt{x^2+1}}=\dfrac{2x}{2\sqrt{x^2+1}}\cdot\mathrm{e}^{\sqrt{x^2+1}}=\dfrac{x}{\sqrt{x^2+1}}\cdot\mathrm{e}^{\sqrt{x^2+1}} $.
% 	}
% \end{ex}
% %%%=========HetCau_20=========%%%
...
% 	{$ y=\dfrac{\cos^3x}{3} $}
% 	\loigiai{
% 		Ta có $ \left(\cos^2x\right)^{\prime}=2\cos x\cdot(-\sin x)=-\sin 2x $.\\
...
% 			&\Leftrightarrow& F(2)=2\ln4 \,(\text{do}\, F(-1)=0).
% 		\end{eqnarray*}
% 	}
% \end{ex}
% %%%=========HetCau_37=========%%%
...
% %%%=========Cau_38=========%%%
% \begin{ex}%[2H3B3-2]
% 	Trong không gian tọa độ $ Oxyz $, cho mặt phẳng $ (P):2x-y+z+3=0 $ và điểm $ A\left(1;\,-2;1\right) $. Phương trình đường thẳng đi qua $ A $ và vuông góc với $ (P) $ là
% 	\renewcommand{\dotEX}{}
% 	\choice
...
% 		Phương trình đường thẳng $ \Delta $ đi qua điểm $ A(1;-2;1) $ là $ \left\{\begin{aligned}
% 			& x=1+2t \\ 
% 			& y=-2-t \\ 
% 			& z=1+t. 
% 		\end{aligned}\right. $ 
...
%%%=========Cau_43=========%%%
\begin{ex}%[2H3B3-2]
	Trong không gian với hệ tọa độ $ Oxyz $, cho điểm $ A\left(1;-1;3\right) $ và hai đường thẳng $ d_1\colon\dfrac{x-4}{1}=\dfrac{y+2}{4}=\dfrac{z-1}{-2} $; $ d_2\colon\dfrac{x-2}{1}=\dfrac{y+1}{-1}=\dfrac{z-1}{1}$. Phương trình đường thẳng qua $ A $ vuông góc với $ d_1 $ và cắt $ d_2 $ là
	\choice
	...
	\loigiai{
		Phương trình tham số của đường thẳng $ d_1\colon\begin{cases}
			x=4+t \\ 
			y=-2+4t \\ 
			z=1-2t
		...
		Phương trình đường thẳng qua $ A $ vuông góc với $ d_1 $ và cắt $ d_2 $ là phương trình đường thẳng $ AH $ qua $ A(1;-1;3) $ và nhận $ \overrightarrow{AH}=(-2;1;1) $ làm véctơ chỉ phương.
	}
\end{ex}
%%%=========HetCau_43=========%%%
