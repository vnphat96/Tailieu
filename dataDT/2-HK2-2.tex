...
Trong KG $Oxyz$, cho hai điểm $A(2;-1;3)$, $B(3;2;-4)$. Vectơ $\overrightarrow{AB}$ có tọa độ là
\choice
{$(1;-3;-7)$}
{\True $(1;3;-7)$}
{$(-1;3;-7)$}
...
Trong KG $Oxyz$, cho mặt phẳng $(\alpha)\colon 3x+2y-4z+1=0$. Vectơ nào dưới đây là một vectơ pháp tuyến của $(\alpha)$?
\choice
...
Mặt phẳng đi qua điểm $A(1 ; 0 ; 2)$ và có vectơ pháp tuyến $\vec{n}=\left[\overrightarrow{AB},\overrightarrow{AC}\right]=(1;-1;-1)$ có phương trình là
$$1(x-1)-1(y-0)-1(z-2)=0\Leftrightarrow x-y-z+1=0.$$
}
\end{ex}

\begin{ex}%[DA TexBook 12, Họa Sĩ Sân Cỏ]%[2H3B2-3]%trùng câu 15
Trong KG $Oxyz$, phương trình mặt phẳng $(P)$ đi qua điểm $B(2;1;-3)$, đồng thời vuông góc với hai mặt phẳng $(Q) \colon x+y+3z=0$, $(R) \colon 2x-y+z=0$?
\choice
{\True $4x+5y-3z-22=0$}
{$4x-5y-3z-12=0$}
{$2x+y-3z-14=0$}
{$4x+5y-3z+22=0$}
\loigiai{
$\vec{n}_{1}=(1;1;3)$ và $\vec{n}_{2}=(2;-1;1)$ lần lượt là các vectơ pháp tuyến của hai mặt phẳng $(Q)$ và $(R)$.\\
Vì mặt phẳng $(P)$ vuông góc với hai mặt phẳng $(Q)$ và $(R)$ nên ta chọn vectơ pháp tuyến mặt phẳng $(P)$ là $\vec{n}=\left[\vec{n}_{1},\vec{n}_{2}\right]=(4;5;-3)$.\\
...
Trong KG $Oxyz$, cho đường thẳng $d \colon \dfrac{x-2}{-1}=\dfrac{y-1}{2}=\dfrac{z+3}{1}$. Vectơ nào dưới đây là một vectơ chỉ phương của $d$?
\choice
...
\loigiai{
Đường thẳng $d \colon \dfrac{x-2}{-1}=\dfrac{y-1}{2}=\dfrac{z+3}{1}$ có một vectơ chỉ phương là $\overrightarrow{u}_3=(-1;2;1)$.}
\end{ex}
...
\loigiai{
Đường thẳng $\Delta_1$, $\Delta_2$ lần lượt có vectơ chỉ phương là $\overrightarrow{u}_1=(3;1;-2)$ và $\overrightarrow{u}_2=(4;-1;2)$.\\
Dễ thấy $\dfrac{3}{4}\neq\dfrac{1}{-1}$ nên $\Delta_1$ và $\Delta_2$ cắt nhau hoặc chéo nhau.\\
PTTS của $\Delta_1$ là $\Delta_1\colon\heva{& x=1+3t \\ & y=-2+t\\ & z=1-2t}, t\in\mathbb{R}$.\\
PTTS của $\Delta_2$ là $\Delta_2\colon\heva{& x=-4+4t' \\ & y=1-t'\\ & z=-5+2t'}, t'\in\mathbb{R}$.\\
...
Trong KG $Oxyz$. Đường thẳng $d \colon \heva{&x=t\\&y=1-t\\&z=2+t}$ đi qua điểm nào sau đây?
\choice
{$K(1;-1;1)$}
{$E(1;1;2)$}
{$H(1;2;0)$}
...
\begin{ex}%[2H3B3-2]%
Trong KG $Oxyz$, viết PTĐT $d$ đi qua điểm $M(1;2;3)$, đồng thời vuông góc với hai vectơ $\vec{a}=(2;3;0)$, $\vec{b}=(3;4;0)$.
\choice
...
{$\heva{& x=1 \\ & y=t\\ &z=3}$}
\loigiai{
Gọi $\vec{u}$ là vectơ chỉ phương của đường thẳng $d$. Do đường thẳng $d$ vuông góc đồng thời với hai vectơ $\vec{a}=(2;3;0)$, $\vec{b}=(3;4;0)$ nên $\vec{u}=[\vec{a},\vec{b}]=(0;0;-1)$ làm vectơ chỉ phương và đi qua $M(1;2;3)$ nên có phương trình $\heva{& x=1 \\ & y=2\\ &z=3-t.}$
}
\end{ex}
