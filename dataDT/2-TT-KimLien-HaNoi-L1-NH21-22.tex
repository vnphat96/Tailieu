...
\immini[thm]{Cho hàm số bậc bốn  $y=f(x)$  có đồ thị là đường cong trong hình.
Số nghiệm thực của phương trình  $2f(x)+3=0$  là
\choice
{\True $4$}
{$1$}
{$3$}
{$2$}}{\begin{tikzpicture}[scale=0.85, font=\footnotesize, line join=round, line cap=round, >=stealth]
...
\end{tikzpicture}}
\loigiai{
\immini[thm]{Ta có $2f(x)+3=0 \Leftrightarrow f(x)=-\dfrac{3}{2}$.\\
...
Trong không gian  $Oxyz$, cho đường thẳng  $d$  đi qua điểm  $M(1;-4;3)$  và có một vectơ chỉ phương là  $\vec{u}=(5;4;-2)$. Phương trình của  đường thẳng  $d$ là
\choice
...
{$\heva{&x=1-5t\\&y=-4-4t\\&z=3-2t}$}
\loigiai{
PTĐT   $d$ là $\heva{&x=1+5t\\&y=-4+4t\\&z=3-2t.}$}
\end{ex}
...
Trong không gian  $Oxyz$, cho  vectơ  $\overrightarrow{OA}=(3;-4;5)$. Toạ độ điểm $A$ là
\choice
{ $(-3;-4;-5)$}
{\True $(3;-4;5)$}
{$(3;4;5)$}
...
\immini[thm]{Thể tích của khối tứ diện đều cạnh  $a$ là
\choice
{ $\dfrac{a^3\sqrt{2}}{4}$}
...
\immini[thm]{Cho hàm số $y=ax^3+bx^2+cx+d$ có đồ thị như hình vẽ. Mệnh đề nào sau đây đúng?
\choice 
{ $a<0,b>0,c>0,d>0$}
{ $a>0,b>0,c<0,d>0$} 
{ $a<0,b<0,c<0,d>0$}
...
Trong không gian $Oxyz,$ cho mặt phẳng $( P )\colon x-3y+2z-5=0$. Vectơ nào dưới đây là một vectơ pháp tuyến của $(P)$?
\choice 
...
\loigiai{
Vectơ pháp tuyến của $(P)$ là $\overrightarrow{n}_2=(-1;\,3;\,-2)$.}
\end{ex} 

%Câu 23
\begin{ex}%[Dự án 16 - TeamTeXHoa - kim Liên Hà Nội lần 1-NH21-22 Nguyễn Hữu Chung Kiên Le Hoop] %[2H3B3-7]
Trong KG $Oxyz$, cho $M(1;\,-3;\,2)$ và mặt phẳng $( P )\colon x+3y-5z+4=0$. Đường thẳng đi qua $M(1;\,-3;\,2)$ và vuông góc với $( P )$ có phương trình là
\choice 
...
{ $\dfrac{x+1}{1}=\dfrac{y-3}{3}=\dfrac{z+2}{4}$}
\loigiai{
Mặt phẳng $( P )$ có một vectơ pháp tuyến là $\overrightarrow{n}=( 1;\,3;\,-5 )$.\\
Vì $d\perp ( P )$ nên đường thẳng $d$ có một vectơ chỉ phương $\overrightarrow{u}=\overrightarrow{n}=( 1;\,3;-5 )$.\\ 
...
Gọi $I(t)$ là số ca bị nhiễm bệnh Covid-19 ở quốc gia X tại ngày khảo sát thứ $t$. Sau $t$ ngày khảo sát ta có công thức $I(t)=A \cdot\mathrm{e}^{r_0 (t-1)}$ với $A$ là số ca nhiễm trong ngày khảo sát đầu tiên, $r_0$ là hệ số lây nhiễm. Biết rằng ngày đầu tiên khảo sát có $500$ ca bị nhiễm bệnh và ngày thứ $10$ khảo sát có $1000$ ca bị nhiễm bệnh. Hỏi ngày thứ $15$ số ca nhiễm bệnh gần nhất với số nào dưới đây, biết rằng trong suốt quá trình khảo sát hệ số lây nhiễm không đổi? 
	...
	Ngày thứ $15$ số ca nhiễm bệnh bằng $I(15)=500\mathrm{e}^{\tfrac{\ln 2}{9}(15-1)} \approx 1469{,}734492$.
	}
\end{ex}
...
{$\dfrac{\sqrt{3}}{3}$}
\loigiai{
\immini[thm]{Gọi $M$ là trung điểm $AC$.\\
...
\begin{ex}%[Dự án 16 - TeamTeXHoa - TT Kim Liên-HN-L1 - Nguyễn Thắng]%[2D1K3-1]
	\immini[thm]{Cho hàm số $y=f(x)$, đồ thị của hàm số $y=f'(x)$ là đường cong trong hình vẽ. Giá trị nhỏ nhất của hàm số $g(x)=f(3x)+3x^2-4x+1$ trên đoạn $\left[-\dfrac{2}{3};\dfrac{2}{3} \right]$ bằng
	\choice
	{$f(0)+1$}
	{$f(6)$}
	{\True $f(2)-\dfrac{1}{3}$}
...
\begin{ex}%[Dự án 16 - TeamTeXHoa - TT Kim Liên-HN-L1 - Nguyễn Thắng]%[2H3G2-8]
	Trong KG $Oxyz$, cho hai điểm $A\left( -1;2;3 \right)$ và $B\left( 3;2;5 \right)$. Xét hai điểm $M$ và $N$ thay đổi thuộc mặt phẳng $\left( Oxy \right)$ sao cho $MN=2023$. Tìm giá trị nhỏ nhất của $AM+BN$.
	\choice
	{$2\sqrt{17}$}
	{$\sqrt{65}$}
	{$25\sqrt{97}$}
