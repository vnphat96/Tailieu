...
\begin{ex}%[GHKI-Kiểm tra định kỳ lớp 12, Nguyễn Khuyến, HCM]%[Đỗ Viết Lân, Ex1-2020]%[2H1B3-2]
	...
	\loigiai{
		\immini[thm]{Do $AA'\parallel (BCC'B')\Rightarrow \mathrm{d}(A,(BCC'B'))=\mathrm{d}(M,(BCC'B'))\\ \Rightarrow V_{M.BCC'B'}=V_{A.BCC'B'}$.\\
...
\begin{ex}%[GHK1, Nguyễn Khuyến-TPHCM, 2019]%[Nguyễn Anh Tuấn, 12EX1-20]%[2H1K3-2]
	...
	{$ 8\sqrt{2} $}
	\loigiai{
		\immini[thm]{Gọi $ H $ là hình chiếu vuông góc của điểm $ C $ trên mặt phẳng $ (ABD) $ và $ K $ là hình chiếu vuông góc của $ H $ trên $ AB $.\\
...
\begin{ex}%[GHK1, Nguyễn Khuyến-TPHCM, 2019]%[Nguyễn Anh Tuấn, 12EX1-20]%[2D1G5-3]
	\immini[thm]{Cho hàm số $ y=f(x) $ có đồ thị như hình vẽ bên. Số điểm cực trị của hàm số $ y=f(f(x)) $ là
	\choice
	{$ 10 $}
	{$ 9 $}
	{$ 7 $}
