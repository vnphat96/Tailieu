...
\begin{ex}%[Đề KSCL lần 1 THPT Lương Tài - Bắc Ninh, 2020-2021]%[Võ Thanh Phong, 12EX3]%[1H3B3-3]
	...
	\choice
	 ...
	 {$60^{\circ}$}
	\loigiai{
		\immini[thm]{Gọi $H$ trung điểm của $SC$ suy ra $SH\perp (ABC)$.\\
...
\begin{ex}%[Đề KSCL lần 1 THPT Lương Tài - Bắc Ninh, 2020-2021]%[Võ Thanh Phong, 12EX3]%[2D1Y1-2]
	\immini[thm]{Cho đồ thị hàm số $y=f(x)$ liên tục trên $\mathbb{R}$ và có đồ thị như hình vẽ.
...
\end{tikzpicture}
	...
	\loigiai{
		\immini[thm]{Xét $y=f\left(1-x\right)+\dfrac{x^2}{2}-x$ có $y'=-f'(1-x)+x-1$.\\
...
\begin{ex}%[Đề KSCL lần 1 THPT Lương Tài - Bắc Ninh, 2020-2021]%[Đoàn Minh Tân, 12-EX-3]%[1H3B5-3]
	...
	{$\dfrac{a\sqrt{2}}{3}$}
	\loigiai{
		\immini[thm]{Ta có $\heva{&SA\perp AB\\& SA\perp BC}\Rightarrow SA\perp (ABC)$.\\
...
\begin{ex}%[Đề KSCL lần 1 THPT Lương Tài - Bắc Ninh, 2020-2021]%[Đoàn Minh Tân, 12-EX-3]%[2H1K3-3]
	...
	\loigiai{
		\immini[thm]{Từ $AA'=4A'M$, $BB'=4B'N$ suy ra $A'M=B'N$ nên $A'B'NM$ là hình bình hành.\\
...
\begin{ex}%[Đề KSCL lần 1 THPT Lương Tài - Bắc Ninh, 2020-2021]%[Đoàn Minh Tân, 12-EX-3]%	[1H3K5-4]
	...
	{$\dfrac{a\sqrt{3}}{2}$}
	\loigiai{
		\immini[thm]{Dựng hình bình hành $ACBD$, khi đó $BC\parallel (SAD)$.\\
