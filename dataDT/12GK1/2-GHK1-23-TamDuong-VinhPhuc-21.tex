...
\begin{ex}%[Đề thi HK1, Trường THPT Tam Dương, Vĩnh Phúc năm 2020-2021]%[Dự án 12EX3-Nguyễn Anh Quốc]%[2D1Y2-1]
	\immini[thm]{	Cho hàm số $y=ax^4+bx^2+c$, $(a,b,c\in \mathbb{R})$ có đồ thị như hình vẽ bên. Số điểm cực trị của hàm số là?
		\choice
		{\True $3$}
		{$2$}
		{$1$}
...
\begin{ex}%[Đề thi HK1, Trường THPT Tam Dương, Vĩnh Phúc năm 2020-2021]%[Dự án 12EX3-Nguyễn Anh Quốc]%[2H1Y1-2]
	\immini[thm]{ Hình đa diện trong hình vẽ bên dưới có bao nhiêu mặt?	
		\choice
		{$6$}
		{ $12$}
		{\True $11$}
...
\begin{ex}%[Thi thử lần 2, Sở GD và ĐT - Vĩnh Phúc, PTTH Tam dương, 2020-2021]%[nguyễn hoàng thanh, 12EX3]%[2D1Y2-2]
	\immini[thm]{Cho hàm số $ y=f(x) $ có bảng biến thiên như hình vẽ bên. Giá trị cực tiểu của hàm số đã cho bằng?
	}{
...
\begin{ex}%[Đề thi HK1, Trường THPT Tam Dương, Vĩnh Phúc năm 2020-2021]%[Dự án 12EX3-Nguyễn Anh Quốc]%[2D1B4-3]
	\immini[thm]{ Xác định $a$, $b$ để hàm số $y=\dfrac{ax-1}{x+b}$ có đồ thị như hình vẽ bên. Mệnh đề nào sau đây đúng?	
		\choice
		{$a=1$, $b=-1$}
		{$a=-1$, $b=1$}
		{\True $a=1$, $b=1$}
...
\begin{ex}%[Đề thi HK1, Trường THPT Tam Dương, Vĩnh Phúc năm 2020-2021]%[Dự án 12EX3-Nguyễn Anh Quốc]%[2H1B3-2]
	...
	{$V=64a^3$}
	\loigiai{
		\immini[thm]{Giả sử khối lập phương đã cho là $ABCD.A'B'C'D'$, theo đề bài ta có $AC'=a\sqrt{6}$, mà $AC'=\sqrt{3}AB\Rightarrow \sqrt{3}AB=a\sqrt{6}\Rightarrow AB=a\sqrt{2}$. Thể tích khối lập phương là $V=AB^3=\left(a\sqrt{2}\right)^3=2\sqrt{2}a^3$.}
		{\begin{tikzpicture}[scale=0.8,>=stealth, font=\footnotesize, line join=round, line cap=round]
...
\begin{ex}%[Thi thử lần 2, Sở GD và ĐT - Vĩnh Phúc, PTTH Tam dương, 2020-2021]%[nguyễn hoàng thanh, 12EX3]%[2H2B2-2]
	...
	{$ \dfrac{17a}{2} $}
	\loigiai{
		\immini[thm]{Gọi $ O $ là giao điểm $ AC $ và $ BD $, gọi $ I $ là trung điểm $ SC $.\\
...
\begin{ex}%[Thi thử lần 2, Sở GD và ĐT - Vĩnh Phúc, PTTH Tam dương, 2020-2021]%[nguyễn hoàng thanh, 12EX3]%[2H2B1-2]
	...
	{\True $S_{xq}=2\pi a^2$}
	\loigiai{
		\immini[thm]{Diện tích xung quanh hình nón $ S_{xq}=\pi Rl=\pi \cdot SA\cdot OA $.\\
...
\end{tikzpicture}
	...
	{$1 < m \leq 3$}
	\loigiai{
		\immini[thm]{Ta có $2|f(x)| - 2m = 0 \Leftrightarrow |f(x)| = m$.\\
...
\begin{ex}%[Thi thử lần 2, Sở GD và ĐT - Vĩnh Phúc, PTTH Tam dương, 2020-2021]%[nguyễn hoàng thanh, 12EX3]%[2D1K2-2]
	\immini[thm]{Cho hàm số $ y=f(x) $. Hàm số $ y=f'(x) $ có đồ thị như hình bên. Hàm số $ y=f(x) $ có bao nhiêu điểm cực trị?}{
...
\end{tikzpicture}
	...
	{ $1$}
	\loigiai{
		\immini[thm]{Dựa vào đồ thị, ta có bảng biến thiên như hình vẽ. \\
...
\begin{ex}%[Thi thử lần 2, Sở GD và ĐT - Vĩnh Phúc, PTTH Tam dương, 2020-2021]%[nguyễn hoàng thanh, 12EX3]%[2D1K4-1]
	\immini[thm]{Cho hàm số $ y=f(x) $ có đồ thị như hình vẽ. Đồ thị hàm số $ g(x)=\dfrac{2020}{2f(x)+1} $ có số đường tiệm cận đứng là}{
		\begin{tikzpicture}[scale=.8, font=\footnotesize, line join=round, line cap=round, >=stealth]
		\def\a{1} 
		\def\b{2}
		\def\c{1}
