...
\begin{ex}%[GHK I, THPT Nguyên Duy Hiệu, Quang Nam, 2021]%[Huỳnh Xuân Tín, 12-EX-2-2021]%[2D1Y5-1]
	\immini[thm]{Đồ thị sau đây là của hàm số nào? \choice
		{$y=\dfrac{2x+1}{x-2}$}
		{\True $y=x^3-3x+1$}
		{$y=x^4-2x^2+1$}
		{$y=-x^3-3x+1$}}{\begin{tikzpicture}[scale=0.7,>=stealth, font=\footnotesize, line join=round, line cap=round]
...
\begin{ex}%[GHK I, THPT Nguyên Duy Hiệu, Quang Nam, 2021]%[Huỳnh Xuân Tín, 12-EX-2-2021]%[2H1B3-2]
	...
	{$\dfrac{2a^3\sqrt{6}}{3}$}
	\loigiai
	{\immini[thm]{Xét $\triangle SAB$ vuông tại $A$ ta có $SA=\sqrt{SB^2-AB^2}=2a$.\\
...
Cho khối tứ diện đều $ABCD$ cạnh $3$. Gọi $M$, $N$, $P$, $Q$ lần lượt là trọng tâm của các tam giác $ABC$, $ABD$, $ACD$, $BCD$. Tính theo $V$ thể tích của khối tứ diện $MNPQ$.
	...
	\loigiai
	{\immini[thm]{Gọi $E$, $F$ theo thứ tự là trung điểm của $AB$, $BC$. Khi đó \[\dfrac{DQ}{DF}=\dfrac{DN}{DE}=\dfrac{2}{3}\Leftrightarrow NQ\parallel EF\Rightarrow \dfrac{NQ}{EF}=\dfrac{2}{3}.\]
	...
	\end{tikzpicture}}
\noindent
	\immini[thm]{\textit{Chú ý:} Để tính thể tích khối đa diện đều cạnh $a$. Ta thực hiện như sau\\
...
\immini[thm]{Cho hàm $y=f(x)$ liên tục trên $\mathbb{R}$ và có đồ thị hàm $f'(x)$ như hình vẽ. Tìm $m$ để bất phương trình $\break f(x+1)-\dfrac{1}{3} x^{3}+x-m>0$ có nghiệm trên $[0;2]$.
    \choice
	{$m<f(3)-\dfrac{2}{3}$}
	{$m<f(0)$}
	{$m<f(1)$}
...
{\begin{tikzpicture}[line cap=round,line join=round,font=\footnotesize,>=stealth,scale=1]
	...
	\loigiai
{\immini[thm]{$f(x+1)-\dfrac{1}{3} x^{3}+x-m>0\Leftrightarrow m<f(x+1)-\dfrac{1}{3} x^{3}+x$ (1)\\
