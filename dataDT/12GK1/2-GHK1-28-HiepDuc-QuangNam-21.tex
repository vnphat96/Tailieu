...
\begin{ex}%[2-GHK1, THPT Hiệp Đức - Quảng Nam, 2020 - 2021]%[Đỗ Đường Hiếu, 12-EX3-20]%[2D1B5-1]
	\immini[thm]{Đồ thị hàm số nào dưới đây có dạng đường cong trong hình vẽ?
		\choice
		{\True $y=-x^4+2x^2$}
		{$y=-x^3+3x$}
		{$y=x^4-2x^2$}
...
\begin{ex}%[2-GHK1, THPT Hiệp Đức - Quảng Nam, 2020 - 2021]%[Đỗ Đường Hiếu, 12-EX3-20]%[2D1B5-1]
	\immini[thm]{Đường cong trong hình vẽ là đồ thị của hàm số nào dưới đây?
		\choice
...
\begin{ex}%[2-GHK1, THPT Hiệp Đức - Quảng Nam, 2020 - 2021]%[Đỗ Đường Hiếu, 12-EX3-20]%[2D1B5-3]
 	\immini[thm]{Cho hàm số bậc ba $y=f(x)$ có đồ thị là đường cong như hình vẽ. Tìm số nghiệm thực dương của phương trình $f(x)=-1$.
 		\choice
 		{\True $1$}
 		{$3$}
 		{$2$}
 	...
 	\end{tikzpicture}}
 	\loigiai{
 	\immini[thm]{Đường thẳng $y=-1$ cắt đồ thị hàm số $y=f(x)$ tại ba điểm phân biệt, trong đó có hai điểm có hoành độ âm và một điểm có hoành độ dương.\\
...
\begin{ex}%[2-GHK1, THPT Hiệp Đức - Quảng Nam, 2020 - 2021]%[Đỗ Đường Hiếu, 12-EX3-20]%[2D1B5-3]
	\immini[thm]{Cho hàm số $y=f(x)$ có đồ thị như hình vẽ. Tìm số nghiệm thực của phương trình $4f(x)+3=0$.
		\choice
		{\True $2$}
		{$3$}
		{$4$}
...
\begin{ex}%[2-GHK1, THPT Hiệp Đức - Quảng Nam, 2020 - 2021]%[Đỗ Đường Hiếu, 12-EX3-20]%[2D1K5-3]
	\immini[thm]{Cho hàm số $y=f(x)$ liên tục trên $\mathbb{R}$ và có đồ thị như hình vẽ. Phương trình $f\left(f(x)-1\right)=0$ có tất cả bao nhiêu nghiệm thực phân biệt?
		\choice
		{\True $7$}
		{$6$}
		{$5$}
...
\begin{ex}%[2-GHK1, THPT Hiệp Đức - Quảng Nam, 2020 - 2021]%[Đỗ Đường Hiếu, 12-EX3-20]%[2H1Y1-2]
	\immini[thm]{Khối đa diện trong hình vẽ bên có bao nhiêu mặt?
		\choice
		{\True $9$}
		{$7$}
		{$8$}
...
\begin{ex}%[2-GHK1, THPT Hiệp Đức - Quảng Nam, 2020 - 2021]%[Đỗ Đường Hiếu, 12-EX3-20]%[2H1Y1-3]
	...
	\loigiai{
	\immini[thm]{Mặt phẳng $(AB'C')$ chia khối lăng trụ $ABC.A'B'C'$ thành khối chóp tam giác $A.A'B'C'$ và khối chóp tứ giác $A.BCC'B'$.}
	{\begin{tikzpicture}[scale=1, font=\footnotesize,line join=round, line cap=round,>=stealth]
			\path 
			(0,0) coordinate (A)
			(3,0) coordinate (B)
...
\begin{ex}%[2-GHK1, THPT Hiệp Đức - Quảng Nam, 2020 - 2021]%[Đỗ Đường Hiếu, 12-EX3-20]%[2H1B2-1]
	...
	{Ngũ giác đều}
	\loigiai{
		\immini[thm]{Tâm tất cả các mặt của một khối lập phương là các đỉnh của khối bát diện đều.}
		{\begin{tikzpicture}[scale=1, font=\footnotesize,line join=round, line cap=round,>=stealth]
			\path 
			(0,0) coordinate (A)
			(2,1) coordinate (B)
...
\begin{ex}%[2-GHK1, THPT Hiệp Đức - Quảng Nam, 2020 - 2021]%[Đỗ Đường Hiếu, 12-EX3-20]%[2H1B3-2]
	...
	{$\dfrac{\sqrt{2}a^3}{2}$}
	\loigiai{
	\immini[thm]{Thể tích khối chóp $S.ABCD$ là
...
\begin{ex}%[2-GHK1, THPT Hiệp Đức - Quảng Nam, 2020 - 2021]%[Đỗ Đường Hiếu, 12-EX3-20]%[2H1B3-4]
	...
	{$2a\sqrt{3}$}
	\loigiai{
	\immini[thm]{Diện tích tam giác $ABC$ là $S_{ABC}=\dfrac{a^2\sqrt{3}}{4}$. Do đó
...
\begin{ex}%[2-GHK1, THPT Hiệp Đức - Quảng Nam, 2020 - 2021]%[Đỗ Đường Hiếu, 12-EX3-20]%[2H1B3-2]
	...
	{$V=2a^3\sqrt{2}$}
	\loigiai{
	\immini[thm]{Do tam giác $ABC$ vuông cân tại $B$ và $AC=a\sqrt{2}$ nên suy ra $BA=BC=a$.\\
...
\begin{ex}%[2-GHK1, THPT Hiệp Đức - Quảng Nam, 2020 - 2021]%[Đỗ Đường Hiếu, 12-EX3-20]%[2H1K3-2]
	...
	{$\dfrac{8\sqrt{3}}{3}$}
	\loigiai{
	\immini[thm]{Gọi $M$ là trung điểm $BC$, ta có $BC\perp (A'AM)$. Do đó góc giữa hai mặt phẳng $(A'BC)$ và $(ABC)$ bằng góc $\widehat{A'MA}\Rightarrow \widehat{A'MA}=30^\circ$.\\
