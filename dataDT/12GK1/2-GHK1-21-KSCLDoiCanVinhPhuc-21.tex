...
\begin{ex}%[KSCL  PTTH Đội Cấn Vĩnh Phúc, 2020-2021]%[Phạm Tuấn, EX3-2021]%[2D1Y5-1]
\immini[thm]{Đường cong ở hình bên là đồ thị của một trong bốn hàm số đưới đây. Hàm số đó là hàm số nào?
\choice
{$y=x^3-x^2-1$}
{$y=-x^4+x^2-1$}
{$y=-x^3+x^2-1$}
...
\begin{ex}%[KSCL THPT Đội Cấn - Vĩnh Phúc, 2021]%[Nguyễn Cường, 12EX3]%[2H1B3-2]
	...
	{\True $5$}
	\loigiai{
\immini[thm]{Ta có $V_{ABC.A'B'C'}=3\cdot 5=15$.\\
...
\immini[thm]{Cho hàm số $y=f(x)$ có đồ thị như hình vẽ. Khẳng định nào trong các khẳng định sau đây là \textbf{sai}?
	\choice
...
\begin{ex}%[Khảo sát Toán 12 - THPT Đội Cấn -Vĩnh Phúc - 21]%[Phan Văn Thành]%[1H3B3-3]
	...
	{$ 60^\circ $}
	\loigiai{
	\immini[thm]{Do $SA \perp (ABC)$ nên $A$ là hình chiếu vuông góc của $S$ lên $(ABC)$.
...
\begin{ex}%[Khảo sát Toán 12 - THPT Đội Cấn -Vĩnh Phúc - 21]%[Phan Văn Thành]%[2H1B3-2]
	...
	{\True $  V=2 $}
	\loigiai{
	\immini[thm]{Vì $DD'\perp (A'B'C'D')$ nên thể tích khối chóp $D.A'B'C'D'$ là
...
\immini[thm]{Cho hàm số bậc ba $y=f(x)$ có đồ thị như hình vẽ bên.
...
Cho hình chóp $S.ABCD$ có $SA=a$, $SA\perp (ABCD)$, đáy $ABCD$ là hình vuông. Gọi $M$ là trung điểm của cạnh $AD$, góc giữa $(SBM)$ và mặt đáy bằng $45^\circ$. Tính khoảng cách từ điểm $D$ đến mặt phẳng $(SBM)$.
	...
	{$\dfrac{a\sqrt{2}}{3}$}
	\loigiai{
\immini[thm]{Ta có $(SBM)\cap (ABCD)=BM$. Kẻ đường cao $AH$ của $\triangle AMB$. \\
...
\immini[thm]{Đồ thị hình bên là đồ thị của hàm số nào?
	\choice
	{$y=\dfrac{x+2}{x+1}$}
...
\immini[thm]{	Ta có \begin{eqnarray*}
