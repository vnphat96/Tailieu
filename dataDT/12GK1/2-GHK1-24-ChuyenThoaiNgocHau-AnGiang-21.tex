...
\begin{ex}%[Thi thử, Chuyên Thoại Ngọc Hầu, An Giang, lần 1 2021]%[Bùi Anh Tuấn, 12EX3]%[2D1Y2-2]
	\immini[thm]{Cho hàm số $f(x)$ xác định, liên tục trên đoạn $[-2;2]$ và có đồ thị là đường cong trong hình vẽ bên. Hàm số $f(x)$ đạt cục đại tại điểm nào dưới đây?
		\choice
		{$x=-2$}
		{\True $x=-1$}
		{$x=1$}
...
\begin{ex}%[Đề giữa kì 1 THPT Chuyên Thoại Ngọc Hầu - An Giang - 21,EX3-24-Phan Anh]%[2D1B1-1]
	...
	{$(-\infty;0)$}
	{\True $(0;+\infty)$}
	\loigiai{\immini[thm]{Ta có $y'=8x^3$, $y'=0\Leftrightarrow x=0$.\\
...
\begin{ex}%[Thi thử, Chuyên Thoại Ngọc Hầu, An Giang, lần 1 2021]%[Bùi Anh Tuấn, 12EX3]%[2D1B5-1]
	\immini[thm]{Đường cong ở hình bên là đồ thị của một trong bốn hàm số dưới đây. Hàm số đó là hàm số nào?
		\choice
		{\True $y=x^3-3x^2+3$}
		{$y=-x^4+2x^2+1$}
		{$y=x^4-2x^2+1$}
...
\begin{ex}%[Đề giữa kì 1 THPT Chuyên Thoại Ngọc Hầu - An Giang - 21,EX3-24-Phan Anh]%[2D2Y4-2]
	...
	\loigiai{Ta có $y'=\left(x^2\right)'\cdot2^{x^2}\ln 2=2x\cdot2^{x^2}\ln 2=x\cdot2^{1+x^2}\ln 2$.}
\end{ex}
...
\begin{ex}%[Thi thử, Chuyên Thoại Ngọc Hầu, An Giang, lần 1 2021]%[Bùi Anh Tuấn, 12EX3]%[1D2B5-2]
	Gieo một con xúc xắc cân đối và đồng chất hai lần. Tính xác suất để có ít nhất một lần xuất hiện mặt sáu chấm.
	\choice
	{\True $\dfrac{12}{36}$}
	{$\dfrac{11}{36}$}
	{$\dfrac{6}{36}$}
...
\begin{ex}%[Thi thử, Chuyên Thoại Ngọc Hầu, An Giang, lần 1 2021]%[Bùi Anh Tuấn, 12EX3]%[2D1B5-3]
	\immini[thm]{Cho hàm số $y=f(x)$ liên tục trên $[-2;2]$ và có đồ thị là đường cong như hình vẽ bên. Hỏi phương trình $|f(x)-1|=1$ có bao nhiêu nghiệm phân biệt trên $[-2;2]$?
		\choice
		{$3$}
		{$4$}
		{\True $5$}
...
\begin{ex}%[Đề giữa kì 1 THPT Chuyên Thoại Ngọc Hầu - An Giang - 21,EX3-24-Phan Anh]%[2H1B3-2]
	...
	\loigiai{\immini[thm]{Ta có $ABC$ là tam giác vuông cân tại $B$ nên
...
\begin{ex}%[Đề giữa kì 1 THPT Chuyên Thoại Ngọc Hầu - An Giang - 21,EX3-24-Phan Anh]%[2H1K3-3]
	...
	{$V=6a^3$}
	{$V=8a^3$}
	\loigiai{\immini[thm]{Gọi $I$, $J$, $K$ lần lượt là trung điểm của $BC$, $CD$, $BD$.\\
...
\begin{ex}%[Thi thử, Chuyên Thoại Ngọc Hầu, An Giang, lần 1 2021]%[Bùi Anh Tuấn, 12EX3]%[2H1K3-3]
	...
	{$\dfrac{1}{7}$}
	\loigiai{ 
		\immini[thm]{Giả sử $AB=a$. Gọi $J$ là giao điểm của $C'I$ và $BC$, $K$ là giao điểm của $DJ$ và $AB$.\\
...
\begin{ex}%[Đề giữa kì 1 THPT Chuyên Thoại Ngọc Hầu - An Giang - 21,EX3-24-Phan Anh]%[2D1G5-3]
	\immini[thm]{Cho hàm số bậc ba $y=f(x)$ có đồ thị là đường cong như hình vẽ bên. Hỏi phương trình $f(xf(x))-2=0$ có bao nhiêu nghiệm phân biệt?
		\choice
		{$3$}
		{$4$}
		{$5$}
...
\begin{ex}%[Thi thử, Chuyên Thoại Ngọc Hầu, An Giang, lần 1 2021]%[Bùi Anh Tuấn, 12EX3]%[2D1K2-6]
	\immini[thm]{Cho hàm số $y=f(x)$ là hàm đa thức bậc bốn có đồ thị như hình vẽ bên. Có bao nhiêu giá trị của tham số $m$ thuộc đoạn $[-12;12]$ để hàm số $g(x)=\left|2f(x-1)+m\right|$ có $5$ điểm cực trị?
		\choice
		{$13$}
		{$14$}
		{\True $15$}
