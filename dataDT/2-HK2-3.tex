...
$ V=\pi\displaystyle\displaystyle\int\limits_0^\pi\sin ^2x\mathrm{\,d}x=\pi\displaystyle\displaystyle\int\limits_0^\pi\dfrac{1-\cos 2x}{2}\mathrm{\,d}x=\dfrac{\pi}{2}\left.\left(x-\dfrac{\sin 2x}{2}\right)\right|_0^{\pi}=\dfrac{\pi ^2}{2}$. }
\end{ex}
...
\loigiai{
$S=\int\limits_a^b{\left| f\left( x \right)-g\left( x \right) \right|\mathrm{\,d}x}\,$}
\end{ex}
...
{$3x + y +z -1 =0$}
\loigiai{
Ta có $ \overrightarrow{AB} = (-4;2;-2) = -2 ( 2; -1 ; 1) =-2 \overrightarrow{n_1}$ và vectơ pháp tuyến của $(P)$ là $ \overrightarrow{n_2} = (1;-2;0)$.\\
Vì $(Q)$ đi qua $A$, $B$ và vuông góc với $(P)$ nên $(Q)$ có một vectơ pháp tuyến là
...
\begin{ex}%[2H3B2-3]%
Trong KG $Oxyz$, cho điểm $M\left( 2;0;1 \right)$. Gọi $A,B$ lần lượt là hình chiếu của $M$ trên trục $Ox$ và trên mặt phẳng $\left( Oyz \right)$. Viết phương trình mặt phẳng trung trực của đoạn $AB$.
\choice
{\True  $4x-2z-3=0$}
{ $4x-2y-3=0$}
{ $4x-2z+3=0$}
...
Mặt phẳng trung trực của đoạn $AB$ đi qua trung điểm $I\left( 1;0;\dfrac{1}{2} \right)$ và nhận vectơ pháp tuyến $\overrightarrow{n}=\overrightarrow{AB}=\left( -2;0;1 \right)$ có phương trình là $-2\left( x-1 \right)+\left(z-\dfrac{1}{2} \right)=0\Leftrightarrow 4x-2z-3=0$.
}
\end{ex}
...
{$Q\left( -2;-3;1 \right)$}
\loigiai{
Thay tọa độ điểm $P\left( 1;2;-1 \right)$ vào PTĐT $d$ thấy thỏa mãn nên đường thẳng $d$ đi qua điểm $P\left( 1;2;-1 \right)$.}
\end{ex}
...
\loigiai{
Đường thẳng cần tìm đi qua $C(2;-1;3)$ và có vectơ chỉ phương là $\overrightarrow{u}=\left[\overrightarrow{AB},\overrightarrow{AD}\right]=(-4;-3;-1)$ nên có PTTS là $\heva{&x=2+4t\\&y=-1+3t\\&z=3+t.}$\\
...
Phương trình tiếp tuyến $\Delta$ có dạng $y=y'\left(x_{0}\right) \cdot\left(x-x_{0}\right)+y_{0} \Leftrightarrow y=2(x-2)+2 \Leftrightarrow y=2 x-2$.\\
...
{$x-y+2 z+9=0$}
\loigiai{
Gọi $(P)$ là mặt phẳng cần tìm có vectơ pháp tuyến là $\vec{n}$.\\
Đường thẳng $d_{1}$, $d_{2}$ có vectơ chỉ phương lần lượt là $\overrightarrow{u}_{1}=(3 ;-1 ;-1)$ và $\overrightarrow{u}_{2}=(1 ; 1 ;-1)$.\\
