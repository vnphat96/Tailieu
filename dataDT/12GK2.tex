...
Trong không gian $Oxyz$, phương trình tổng quát của mặt phẳng $(Oxz)$ là
\choice
{$y+z=0$}
{$x-1=0$}
{\True $y=0$}
...
Trong không gian $Oxyz$, cho hai vectơ $\vec{u}=\left(2;-1;4\right)$ và $\vec{v}=\vec{i}-3\vec{k}$. Tích vô hướng $\vec{u}\cdot \vec{v}$ bằng
\choice
{$-11$}
{$-13$}
{$5$}
...
Trong không gian $Oxyz$, phương trình mặt phẳng song song và cách $(Oyz)$ một đoạn bằng $2$ là
\choice
{$z \pm 2=0$}
{$y \pm 2=0$}
{$y+z \pm 2=0$}
...
\begin{ex}%[2H3B1-1]%
Trong không gian $Oxyz$, cho điểm $A(3;4;0)$ và điểm $B(3;-4;0)$. Chu vi của tam giác $OAB$ bằng
\choice
{$12$}
{$20$}
{$10+4\sqrt{2}$}
