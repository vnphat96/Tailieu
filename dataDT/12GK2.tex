...
\begin{ex}%[2H3Y2-2]%
Trong không gian $O x y z$, mặt phẳng $(P): 2 x+3 y-4 z+7=0$ có một vectơ pháp tuyến là
\choice
{$\vec{n}=(-2 ; 3 ;-4)$}
{$\vec{n}=(-2 ;-3 ;-4)$}
{\True $\vec{n}=(2 ; 3 ;-4)$}
...
Trong KG $Oxyz$, cho $A(1;2;-1)$, $B(0;-2;3)$. Diện tích tam giác $OAB$ bằng \choice
{$\dfrac{\sqrt{29}}{6} $}
...
Trong KG $Oxyz$, cho hai vectơ $\vec{u}=\left(2;-1;4\right)$ và $\vec{v}=\vec{i}-3\vec{k}$. Tích vô hướng $\vec{u}\cdot \vec{v}$ bằng
\choice
{$-11$}
{$-13$}
{$5$}
...
Trong KG $Oxyz$, phương trình mặt phẳng song song và cách $(Oyz)$ một đoạn bằng $2$ là
\choice
{$z \pm 2=0$}
{$y \pm 2=0$}
{$y+z \pm 2=0$}
...
Mặt phẳng $(P)$ tiếp xúc với mặt cầu $(S)$ tại điểm $A(6 ; 2 ;-5)$ nên $(P)$ đi qua $A(6 ; 2 ;-5)$ và có vectơ pháp tuyến là $\vec{n}=\overrightarrow{IA}=\left(5;1;-6\right)$ có phương trình là
...
Mặt phẳng $(P)$ đi qua hai điểm $A$, $B$ và song song với đường thẳng $CD$ có vectơ pháp tuyến
...
Trong KG $Oxyz$, cho hình hộp $ABCD.A'B'C'D'$ có $A(-3;2;1)$, $C(4;2;0)$, $B'(-2;1;1)$, $D'(3;5;4)$. Tọa độ đỉnh $A'$ là \choice
{$(-3;3;1) $}
{\True $(-3;3;3) $}
{$ (-3;-3;-3)$}
{$(-3;-3;3)$}
...
{$4\pi a^3$}
{$\dfrac{17\pi a^3}{3}$}
\loigiai{\immini[thm]{Ta có $V=\pi R^2h=12\pi a^3$.}
{
\begin{tikzpicture}
\def\h{3}
\def\a{2}
