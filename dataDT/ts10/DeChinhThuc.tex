            ...
            \item Xét phép thử: “Chọn ngẫu nhiên một số tự nhiên lớn hơn $10$ và nhỏ hơn $27$”.
                  \begin{enumerate}
                      ...
                      \item Số phần tử không gian mẫu là $n(\Omega)=16$.\\
                            ...
                            \begin{center} $\{11;13;17;19;23\}$. \end{center}
                            Suy ra số kết quả thuận lợi của biến cố $A$ là $n(A)=5$.\\
                            Vậy xác suất của biến cố $A$ bằng $P(A)=\dfrac{n(A)}{n(\Omega)}=\dfrac{5}{16}$.
                  \end{enumerate}
        \end{enumerate}
    }
\end{bt}
