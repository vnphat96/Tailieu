...
\begin{ex}%[De-chuan-hoa-so-1]%[Dương Quang]%[2D1N4-1]
	...
	{$x=-2$}
	{\True$y=-2$}
	\loigiai{$\underset{x\to -\infty }{\mathop{\lim \limits{n \to +\infty}}}\,\dfrac{2x-4}{x+2}=-2$ và $\underset{x\to +\infty }{\mathop{\lim \limits{n \to +\infty}}}\,\dfrac{2x-4}{x+2}=-2$ nên đồ thị hàm số có tiệm cận ngang là $y=-2$.
	}
\end{ex}
