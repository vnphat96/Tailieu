\begin{name}
 {Biên soạn: Dương Công Tạo \\ Phản biện: Hải Phụng}
 {Đề ôn tập chương I}
\end{name}
...
\begin{ex}%[2-D1B5-SO-17-2425]%[VN-MT-7, VM031]%[2D1N5-1]
 \immini[thm]{Đường cong cho trong hình bên là đồ thị của hàm số nào trong các hàm số dưới đây?
 \choice[2]
 {$y=-x^3+2x-1$}
 {$y=-x^3+3x+1$}
 {$y=2x^3-6x+1$}
...
\begin{ex}%[2-D1B5-SO-17-2425]%[VN-MT-7, VM031]%[2D1H4-1]
 \immini[thm]{Cho hàm số $y=\dfrac{ax^2+bx+1}{cx+2}$ có đồ thị như hình vẽ bên dưới. Tính giá trị biểu thức $T=2a+3b-c$.
 \choice[2]
 {$9$}
 {\True $10$}
 {$8$}
...
\begin{ex}%[2-D1B5-SO-17-2425]%[VN-MT-7, VM031]%[2D1H1-1]
 \immini[thm]{Hàm số $y=-x^3+3x^2$ đồng biến trên khoảng nào dưới đây?
 \choice
 {$(0;4)$}
 {$(-\infty;0)$}
 {$(2;+\infty)$}
...
\begin{ex}%[2-D1B5-SO-17-2425]%[VN-MT-7, VM031]%[2D1N2-2]
 \immini[thm]{Cho hàm số $y=f(x)$ xác định và liên tục trên đoạn $[-2; 2]$ và có đồ thị là đường cong trong hình vẽ sau.
...
\begin{ex}%[2-D1B5-SO-17-2425]%[VN-MT-7, VM031]%[2D1N3-1]
 \immini[thm]{Cho hàm số $f(x)$ liên tục trên đoạn $[-2;2]$ có đồ thị như hình vẽ.
...
\begin{ex}%[2-D1B5-SO-17-2425]%[VN-MT-7, VM031]%[2D1V5-5]
 \immini[thm]{Cho hàm số $y=f(x)$ có đạo hàm trên $\mathbb{R}$ và hàm số $y=f'(x)$ là hàm số bậc ba có đồ thị là đường cong trong hình vẽ.
 \choiceTF
...
\begin{ex}%[2-D1B5-SO-17-2425]%[VN-MT-7, VM031]%[2D1V4-1]
 \immini[thm]{Cho hàm số $y=\dfrac{ax+b}{x+c}.(a,b,c\in\mathbb{R})$ có đồ thị như hình vẽ. Khi đó 
 \choiceTF
...
\begin{ex}%[2-D1B5-SO-17-2425]%[VN-MT-7, VM031]%[2D1H3-6]
 Sau khi phát hiện một dịch bệnh, các chuyên gia y tế ước tính số người nhiễm bệnh kể từ ngày phát hiện bệnh nhân đầu tiên đến ngày thứ $t$ là $f(t)=-t^3+45t^2+600t$, $t\in \mathbb{N}$, $t\le 30$. Nếu coi $f(t)$ là hàm số xác định trên đoạn $[0;30]$ thì $f'(t)$ được xem là tốc độ truyền bệnh (người/ngày) tại thời điểm $t$. Trong $30$ ngày đầu tiên, có bao nhiêu ngày mà tốc độ truyền bệnh lớn hơn $1\,200$?
 \shortans{9}
 \loigiai{
 Ta có $f(t)=-t^3+45t^2+600t\Rightarrow f'(t)=-3t^2+90t+600$.\\
 Tốc độ truyền bệnh lớn hơn $1\,200$ nên \[f'(t) > 1200\Leftrightarrow-3t^2+90t+600> 1200\Leftrightarrow-3t^2+90t-600> 0\Leftrightarrow 10< t < 20.\]
 Vậy có $9$ ngày tốc độ truyền bệnh lớn hơn $1\,200$.
 }
\end{ex}
...
\begin{ex}%[2-D1B5-SO-17-2425]%[VN-MT-7, VM031]%[2D1V2-3]
 Tìm $m$ để hàm số $y=x^3-3mx^2+\left(m^2+2\right)x-m+1$ đạt cực đại tại $x=1$.
 \shortans{5}
 \loigiai{
 Ta có $y'=3x^2-6mx+m^2+2$.\\
 Hàm số $y=x^3-3mx^2+(m^2+2)x-m+1$ đạt cực đại tại $x=1$ khi và chỉ khi
 \[y'(1)=0\Leftrightarrow 3-6m+m^2+2=0\Leftrightarrow \hoac{&m=1\\&m=5.}
 \]
 \begin{itemize}
 \item Với $m=1$ ta có $y=x^3-3x^2+3x\Rightarrow y'=3x^2-6x+3$.\\
 $y'=0\Leftrightarrow 3x^2-6x+3=0\Leftrightarrow x=1\Rightarrow$ hàm số không có cực trị.
 \item Với $m=5$ ta có $y=x^3-15x^2+27x-4\Rightarrow y'=3x^2-30x+27$.\\
 $y'=0\Leftrightarrow 3x^2-30x+27=0\Leftrightarrow \hoac{&x=1\\&x=9.}$\\
 Bảng biến thiên
 \begin{center}
 \begin{tikzpicture}
 \tkzTabInit[nocadre=true,lgt=1.2,espcl=2.5,deltacl=0.5]
