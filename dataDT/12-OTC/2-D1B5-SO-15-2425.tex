\begin{name}
	{\tenchude}
	{ĐỀ KIỂM TRA CHƯƠNG I - Mã đề 101}
	{LỚP TOÁN THẦY PHÁT}
	{\thoigian}
\end{name}
\TN
\Opensolutionfile{ans}[ans/ans12D1De1]
...
\begin{ex}%[2-D1B5-SO-15-2425]%[VN-MT-7, Đoàn Thị Lý]%[2D1H2-2]
 \immini[thm]{
 Cho hàm số $y=f(x)$ có đồ thị $y=f'(x)$ như hình vẽ bên. Hàm số $y=f(x)$ có bao nhiêu điểm cực đại?
 \choice
 {\True $0$}
 {$1$}
 {$2$}
...
\begin{ex}%[2-D1B5-SO-15-2425]%[VN-MT-7, Đoàn Thị Lý]%[2D1H2-2]
 ...
 {\True Hàm số đã cho có $3$ điểm cực trị}
 ...
 \itemch \textbf{Sai}.\\
 Hàm số không nghịch biến trên khoảng $(-\infty;0)$.
 \itemch \textbf{Sai}.\\
...
\inputansbox{12,4,3}{ans/ans12D1De1}
