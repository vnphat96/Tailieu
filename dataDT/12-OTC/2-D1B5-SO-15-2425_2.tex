\begin{name}
	{\tenchude}
	{ĐỀ KIỂM TRA CHƯƠNG I - Mã đề 102}
	{LỚP TOÁN THẦY PHÁT}
	{\thoigian}
\end{name}
\TN
...
\begin{ex}%[2-D1B5-SO-15-2425]%[VN-MT-7, Đoàn Thị Lý]%[2D1N1-1]
 Cho hàm số $y=f(x)$ có đạo hàm $f'(x)=x(x+3)^3$, với mọi $x \in \mathbb{R}$. Hàm số đã cho nghịch biến trên khoảng nào dưới đây?
 \choice 
 {$(1;3)$}
 {$(-4;0)$}
 {$(0;1)$}
 {\True $(-2;0)$}
 \loigiai{
 Ta có $f'(x)=0 \Leftrightarrow\hoac{&x=0 \\&x=-3.}$ \\
 Bảng xét dấu $f'(x)$
 \begin{center}
 \begin{tikzpicture}
 ...
 \end{tikzpicture}
 \end{center}
 Dựa vào bảng xét dấu $f'(x)$ ta thấy hàm số đã cho nghịch biến trên $(-3;0)$.
 }
\end{ex}
...
\begin{ex}%[2-D1B5-SO-15-2425]%[VN-MT-7, Đoàn Thị Lý]%[2D1N4-1]
 Cho hàm số $y=\dfrac{x+1}{-3x+1}$. Tiệm cận ngang của đồ thị hàm số đã cho là
 \choice 
 {$y=3$}
 {$y=-7$}
 {\True $y=-\dfrac{1}{3}$}
 {$y=2$}
 \loigiai{
Ta có $\lim\limits _{x \to \pm \infty} y=\lim\limits _{x \to \pm \infty} \dfrac{x+1}{3x+1}=\lim\limits _{x \to \pm \infty} \dfrac{1+\dfrac{1}{x}}{-3+\dfrac{1}{x}}=-\dfrac13$, suy ra đồ thị hàm số có tiệm cận ngang $y=-\dfrac13$.
 }
\end{ex}
...
\begin{ex}%[2-D1B5-SO-15-2425]%[VN-MT-7, Đoàn Thị Lý]%[2D1H2-2]
 \immini[thm]{
 Cho hàm số $y=f(x)$ có đồ thị $y=f'(x)$ như hình vẽ bên. Hàm số $y=f(x)$ có bao nhiêu điểm cực tiểu?
  \choice
 {$0$}
 {\True $1$}
 {$2$}
...
\begin{ex}%[2-D1B5-SO-15-2425]%[VN-MT-7, Đoàn Thị Lý]%[2D1H3-1]
 Gọi $M$ và $m$ lần lượt là giá trị lớn nhất và giá trị nhỏ nhất của hàm số $y=f(x)=\dfrac{2x-1}{x-2}$ trên đoạn $[3;7]$ . Tính giá trị của $M^2+5m$.
 \choice 
 {$52$}
 {\True $38$}
 {$6$}
 ...
 Ta có 
 $y'=\dfrac{-3}{(x-2)^2}<0, \forall x \in[3 ; 7]$ nên hàm số $y=f(x)$ nghịch biến trên $[3;7]$.\\ Lúc đó
 \[M=\max\limits_{[3;7]} f(x) = f(3)=5,m=\min\limits_{[3;7]}f(x)=f(7)=\dfrac{13}{5}.\]
 Vậy $M^2+5m=38$.
 }
\end{ex}
...
\begin{ex}%[2-D1B5-SO-15-2425]%[VN-MT-7, Đoàn Thị Lý]%[2D1H5-4] 
 Đồ thị của hàm số $y=x^3-3 x+3$ cắt trục tung tại điểm có tung độ bằng 
 \choice
 {$0$}
 {$1$}
 {$2$}
 {\True $3$}
 \loigiai{
 Gọi $M\left(x_0;y_0\right)$ là giao điểm của đồ thị hàm số với trục tung. Ta có $x_0=0 \Rightarrow y_0=3$.
 }
\end{ex}

\begin{ex}%[2-D1B5-SO-15-2425]%[VN-MT-7, Đoàn Thị Lý]%[2D1H5-4]
 Số giao điểm của đồ thị hàm số $y=x^3-3 x+2$ và trục hoành là \choice 
 {$3$}
 {$0$}
 {\True $2$}
 {$1$}
 ...
 \end{tikzpicture}
 \end{center}
 Từ bảng biến thiên ta thấy đồ thị hàm số cắt trục hoành tại $2$ điểm phân biệt.
 }
\end{ex}
...
\begin{ex}%[2-D1B5-SO-15-2425]%[VN-MT-7, Đoàn Thị Lý]%[2D1H4-1]
 Tiệm cận xiên của đồ thị hàm số $y=f(x)=\dfrac{x^2-x+1}{x-1}$ có dạng $y=a x+b,(a, b \in \mathbb{Z})$. Tính giá trị biểu thức $P=5 a+2027 b$.
 \shortans{5}
 \loigiai{
 ...
 Vậy $a=1$, $b=0$, $P=5a+2027 b=5\cdot 1+2027\cdot 0=5$.
 }
\end{ex}
...
\begin{ex}%[2-D1B5-SO-15-2425]%[VN-MT-7, Đoàn Thị Lý]%[2D1V3-6]
 Một hộp sữa dung tích $2 \ell$ (lít) có dạng hình hộp chữ nhật với đáy là hình vuông cạnh bằng $x$ cm và chiều cao $h$ cm. Tìm giá trị của $x$ để diện tích toàn phần của hình hộp là nhỏ nhất.
 \shortans{12,6}
 \loigiai{
 \begin{center}
 \begin{tikzpicture}
 ...
 Theo bài ra, ta có $V=2\mathrm{\ell}=2000 \mathrm{\,cm}^3$. Suy ra $x^2h=2000\Rightarrow h=\dfrac{2000}{x^2}$.\\
 Ta có diện tích toàn phần của hộp sữa là \[S_{\rm{tp}}=S_{\rm{xq}}+S_{\rm{d}}=4hx+2x^2=4\cdot\dfrac{2000}{x^2}\cdot x+2x^2=2x^2+\dfrac{8000}{x}.\]
 Đặt $y=f(x)=2x^2+\dfrac{8000}{x}$, suy ra $f'(x)=4x-\dfrac{8000}{x^2}$.\\
 Xét $f'(x)=0\Leftrightarrow 4x-\dfrac{8000}{x^2}=0\Leftrightarrow 4x^3-8000=0\Leftrightarrow x=10\sqrt[3]{2}$.\\
...
Vậy $x_0=3\sqrt{3}$ và $x_0\sqrt{3}=7,35$.
}
\end{ex}
\Closesolutionfile{ans}

	\inputansbox{12,4,3}{ans/ans\currfilebase}
