...
%%==========Câu 38
\begin{ex}%[2H3Y1-1]
	Trong không gian $Oxyz$, Cho hai điểm $A(1;1;-1)$ và $B(2;3;2)$. Vectơ $\vec{AB}$ có tọa độ
	\choice
	{\True $(1;2;3)$}
	{$(-1;-2;3)$}
	{$(3;5;1)$}
...
%%==========Câu 39
\begin{ex}%[2H3Y2-2]
	Trong không gian $Oxyz$, cho mặt phẳng $(P)\colon x+y-z+2=0$. Một vectơ pháp tuyến của mặt phẳng $(P)$ có tọa độ là
	\choice
	{$(2;1;1)$}
	{$(1;2;1)$}
	{\True $(1;1;-1)$}
...
%%==========Câu 40
\begin{ex}%[2H3Y3-1]
	Trong không gian $Oxyz$, cho đường thẳng $d\colon \dfrac{x}{2}=\dfrac{y}{1}=\dfrac{z-1}{2}$. Một vectơ chỉ phương của $d$ là
	\choice
	{$\vec{u}=(0;0;1)$}
	{$\vec{u}=(0;0;-1)$}
	{$\vec{u}=(2;6;2)$}
