...
\begin{ex}%[2H2K2-1]
	...
	{$1156\pi$}
	\loigiai{
		\immini[thm]{Theo bài ra ta có $HA=r=12$, $OH=5$.\\
			Bán kính mặt cầu là $R=OA=\sqrt{AH^2+HO^2}=13$.\\
			Diện tích mặt cầu là $S=4\pi R^2=4\pi\cdot 13^2=676\pi$.}{\begin{tikzpicture}[scale=0.8, font=\footnotesize, line join=round, line cap=round, >=stealth]
				\def \r{2.5}
				\def \a{0.86*\r}
				\def \b{0.5*\r}
				\def \c{0.49*\r}
...
%%==========Câu 38
\begin{ex}%[2H3Y1-1]
	Trong KG $Oxyz$, Cho hai điểm $A(1;1;-1)$ và $B(2;3;2)$. Vectơ $\vec{AB}$ có tọa độ
	\choice
	{\True $(1;2;3)$}
	{$(-1;-2;3)$}
	{$(3;5;1)$}
...
%%==========Câu 39
\begin{ex}%[2H3Y2-2]
	Trong KG $Oxyz$, cho mặt phẳng $(P)\colon x+y-z+2=0$. Một vectơ pháp tuyến của mặt phẳng $(P)$ có tọa độ là
	\choice
	{$(2;1;1)$}
	{$(1;2;1)$}
	{\True $(1;1;-1)$}
	{$(1;-2;1)$}
	\loigiai{
		Một vectơ pháp tuyến của $(P)$ là $\overrightarrow{n}=(1;1;-1)$.
	}
	%<MyLT>
\end{ex}
...
%%==========Câu 40
\begin{ex}%[2H3Y3-1]
	Trong KG $Oxyz$, cho đường thẳng $d\colon \dfrac{x}{2}=\dfrac{y}{1}=\dfrac{z-1}{2}$. Một vectơ chỉ phương của $d$ là
	\choice
	{$\vec{u}=(0;0;1)$}
	{$\vec{u}=(0;0;-1)$}
	{$\vec{u}=(2;6;2)$}
	{\True $\vec{u}=(2;1;2)$}
	\loigiai{
		Ta có vectơ chỉ phương của $d$ là $\vec{u}=(2;1;2)$.
	}
\end{ex}
...
%%==========Câu 43
\begin{ex}%[2H3K2-6]
	Trong KG $Oxyz$, cho ba điểm $A(1;1;3)$, $B(-1;3;2)$, $C(-1;2;3)$. Khoảng cách từ gốc tọa độ đến mặt phẳng $(ABC)$ bằng
	\choice
	{$\dfrac{3}{2}$}
	{\True $3$}
	{$\sqrt{3}$}
	{$\dfrac{\sqrt{3}}{2}$}
	\loigiai{
		Ta có $\vec{AB}=(-2;2;-1)$ và $\vec{AC}=(-2;1;0)$ nên mặt phẳng $(ABC)$ nhận $\vec{n}=[\vec{AB},\vec{AC}]=(1;2;2)$ là vectơ pháp tuyến.\\
...
%%==========Câu 44
\begin{ex}%[2H3B3-2]
	Trong KG $Oxyz$, cho hai điểm $A(-1;2;2)$, $B(3;-2;-4)$. Khi đó mặt phẳng trung trực của đoạn thẳng $AB$ có phương trình là
	\choice
	{\True $2x-2y-3z-5=0$}
	{$2x-2y-3z=0$}
	{$2x+2y-3z-5=0$}
	...
	\loigiai{
		...
		Mặt phẳng trung trực của $AB$ đi qua trung điểm $I(1;0;-1)$ của $AB$ và có vectơ pháp tuyến $\overrightarrow{n}=(2;-2;-3)$.\\
...
%%==========Câu 9
\begin{ex}%[2D1B5-3]
	\immini{Cho hàm số $y=f(x)$ có bảng biến thiên như hình bên. Số nghiệm thực của phương trình $2f(x)-3=0$ là
		\choice
		{$1$}
		{$4$}
		{$2$}
...
%%==========Câu 33
\begin{ex}%[2H1B3-2]
	\immini{Cho hình lăng trụ tam giác đều $ ABC.A'B'C' $ có $ AB=a $, góc giữa đường thẳng $ A'C $ và mặt phẳng $(ABC)$ bằng $ 45^\circ $. Thể tích khối lăng trụ $ ABC.A'B'C' $ bằng
		\haicot
		{\True $ \dfrac{a^3\sqrt{3}}{4}$}
		{$\dfrac{a^3\sqrt{3}}{6}$}
		{$\dfrac{a^3\sqrt{3}}{2}$}
...
%%==========Câu 34
\begin{ex}%[2H1K3-2]
	\immini{Cho khối chóp tứ giác đều $ S.ABCD $ có cạnh đáy là $ a $, các mặt bên tạo với đáy một góc $ 60^{\circ} $. Tính thể tích khối chóp đó.
		\haicot
		{$ V=\dfrac{a^{3}\sqrt{3}}{2} $}
		{\True $ V=\dfrac{a^{3}\sqrt{3}}{6} $}
		{$ V=\dfrac{a^{3}\sqrt{3}}{12} $}
...
%%==========Câu 49
\begin{ex}%[1H3Y2-3]
	\immini{Cho hình lập phương $ABCD.A'B'C'D'$. Góc giữa hai đường thẳng $BA'$ và $B'C'$ bằng
		\choice
		{$45^\circ$}
		{$30^\circ$}
		{$60^\circ$}
