...
Trong KG $Oxyz$, biết mặt phẳng $ax+by+cz-24=0$ qua $A(1;2;3)$ và vuông góc với hai mặt phẳng $(P)\colon 3x-2y+z+4=0$, $(Q)\colon 5x-4y+3z+1=0$. Giá trị $a+b+c$ bằng
\choice
{$ 8 $}
{$ 9 $}
{$ 10 $}
...
Trong KG $Oxyz$, cho mặt phẳng $\left( P \right)\colon x+y-z-3=0$ và hai điểm $M\left( 1;1;1 \right)$, $N\left( -3;-3;-3 \right)$. Mặt cầu $(S)$ đi qua hai điểm $M$, $N$ và tiếp xúc với mặt phẳng $(P)$ tại điểm $Q$. Biết rằng $Q$ luôn thuộc một đường tròn cố định. Tính bán kính $R$ của đường tròn đó.
\choice
{ $R=\dfrac{2\sqrt{11}}{3}$}
{ $R=\dfrac{2\sqrt{33}}{3}$}
{\True $R=6$}
...
Trong KG $Oxyz$, cho hai điểm $A(1;1;-2)$, $B(3;-4;1)$. Tọa độ của vectơ $\overrightarrow{AB}$ là
\choice
{$(-2;5;-3)$}
{$(2;5;3)$}
{\True $(2;-5;3)$}
...
\begin{ex}%[2H3Y3-1]%
Trong KG $Oxyz$ cho đường thằng $\Delta: \dfrac{x-1}{2}=\dfrac{y-2}{2}=\dfrac{z+3}{1}$. Vectơ nào dưới đây là một vectơ chỉ phương của đường thẳng $\Delta$
\choice
