...
\begin{ex}%[0D1B3-1]
	\immini[thm]{Cho $A$, $B$ là hai tập hợp bất kì. Phần gạch sọc trong hình vẽ bên là tập hợp nào sau đây?
		\choice
		{$ A\cup B$}
		{$ B\setminus A$}
		{$ A\setminus B$}
...
\begin{ex}%[0D1B3-3]
	...
	\choice
	{\True \begin{tikzpicture}[scale=0.4, line join=round, line cap=round]
...
\begin{ex}%[0D1B3-3]
	\immini[thm]{Cho tập hợp hai tập hợp $A$ và $B$ được biểu diễn bởi biểu đồ Ven như hình vẽ bên. Mệnh đề nào đúng?}{
