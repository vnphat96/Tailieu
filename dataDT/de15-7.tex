...
\end{ex}
\begin{ex}%Câu 39.
Cho tập hợp $Y$ gồm $5$ điểm phân biệt trên mặt phẳng. Số vectơ khác $\overrightarrow{0}$ có điểm đầu, điểm cuối thuộc tập $Y$ là
\choice
{$25$}
{$5!$}
{$C_5^2$}
...
\end{ex}
\begin{ex}%Câu 41.
Trong không gian $Oxyz$, vectơ $\vec{a}(1; 3;-2)$ vuông góc với vectơ nào sau đây?
\choice
{$\vec{q}(1;-1; 2)$}
{$\vec{m}(2; 1; 1)$}
{\True $\vec{p}(1; 1; 2)$}
