...
\begin{ex}%[2H3B2-3] 
	...
	{$(P)\colon 3y+z-6=0$}
	\loigiai{
		Ta có $\overrightarrow{OM}=(-2;1;3)$.Trục hoành có vectơ chỉ phương là $\overrightarrow{i}=(1;0;0)$.\\
...
%%==========Câu 40
\begin{ex}%[2H3B2-8]
	Trong không gian $Oxyz$, cho ba điểm $A(a;0;0),\,B(0;b;0),\,C(0;0;c)$, trong đó $a>0,\,b>0,\,c>0$. Mặt phẳng $(ABC)$ đi qua điểm $I(1;2;3)$ sao cho thể tích khối tứ diện $OABC$ đạt giá trị nhỏ nhất. Khi đó các số $a,\,b,\,c$ thoả mãn đẳng thức nào dưới đây?
	\choice 
	{$a+b+c=12$}
	{\True $a+b+c=18$}
	{$a^2+b=c-6$}
