...
\loigiai{
Ta có $\displaystyle\int\dfrac{4^x+1}{2^x}\mathrm{d}x=\displaystyle\int\left(2^x+2^{-x}\right)\mathrm{d}x=\dfrac{2^x}{\ln 2}-\dfrac{1}{2^x\ln 2}+C$.
}
\end{ex}
...
\end{center}
\choice
{ $\int\limits_{-1}^2{\left( -2x+2 \right)}\mathrm{\,d}x$}
{ $\int\limits_{-1}^2{\left( 2x^2-2x-4 \right)}\mathrm{\,d}x$}
{\True $\int\limits_{-1}^2{\left( -2x^2+2x+4 \right)}\mathrm{\,d}x$}
{ $\int\limits_{-1}^2{\left( 2x-2 \right)}\mathrm{\,d}x$}
\loigiai{
Diện tích phần hình phẳng tô đậm trong hình vẽ là\\
$S=\int\limits_{-1}^2{\left| f\left( x \right)-g\left( x \right) \right|}\mathrm{\,d}x=\int\limits_{-1}^2{\left| {x^2}-2x-1-\left( -x^2+3 \right) \right|}\mathrm{\,d}x=\int\limits_{-1}^2{\left| 2x^2-2x-4 \right|}\mathrm{\,d}x$.\\
Vì $2x^2-2x-4\le 0\,\,\forall x\in \left[ -1;2 \right]$ nên $S=\int\limits_{-1}^2{\left( -2x^2+2x+4 \right)}\mathrm{\,d}x$.}
\end{ex}
...
\immini[thm]{Nêu công thức tính thể tích vật thể tròn xoay thu được khi quay hình phẳng (phần gạch sọc của hình vẽ) xung quanh trục hoành $Ox$.
\choice
...
\begin{ex}%[2H3Y2-2]%
Trong hệ trục tọa độ $Oxyz$ cho mặt phẳng $(\alpha)\colon 2x-y+3z-1=0$. Vectơ nào sau đây là vectơ pháp tuyến của mặt phẳng $(\alpha)$.
\choice
...
\loigiai{
Mặt phẳng $(\alpha)$ có một vectơ pháp tuyến là $\overrightarrow{n_1}=(2;-1;3)$.\\
Khi đó $\overrightarrow{n}=(-4;2;-6)$ cũng là vectơ pháp tuyến của mặt phẳng $(\alpha)$.}
\end{ex}
...
{\True $2x-3y-z-20=0$}
\loigiai{
Mặt phẳng đi qua $A$ và vuông góc với $A B$ nên có vectơ pháp tuyến $\vec{n}=\overrightarrow{AB}=(-4;6;2)$. Do đó ta có phương trình là
...
\begin{ex}%[2H3Y3-1]%
Trong không gian $Oxyz$, một vectơ chỉ phương của đường thẳng $d\colon \dfrac{x+2}{3}=\dfrac{y+1}{-2}=\dfrac{z-3}{-1}$ là
\choice
...
\loigiai{
Đường thẳng $d$ có một vectơ chỉ phương là $\overrightarrow{u}=(3;-2;-1)$, suy ra $\overrightarrow{u}_2=(-3;2;1)$ là vectơ chỉ phương của $d$.
}
\end{ex}
...
\loigiai{
Đường thẳng $\Delta_1$, $\Delta_2$ lần lượt có vectơ chỉ phương là $\overrightarrow{u}_1=(5;-2;1)$ và $\overrightarrow{u}_2=(-5;2;-1)$.\\
...
Trong không gian $Oxyz$, cho đường thẳng $d\colon \dfrac{x-3}{-1}=\dfrac{y+1}{2}=\dfrac{z+2}{3}$. Điểm có hoành độ bằng $2$ nằm trên đường thẳng $d$ là
\choice
...
Đường thẳng $AM$ có một vectơ chỉ phương là $\overrightarrow{AM}=(-4;3;-1)$.\\
