...
% %%==========Câu 35
% \begin{ex}%[1H3Y3-3]
% \immini[thm]{Cho hình chóp $ S. ABC $ có $ SA $ vuông góc với mặt phẳng $ (ABC) $, $ SA=\sqrt{2}a $, tam giác $ ABC $ vuông cân tại $ B $ và $ AC=2a $ (minh họa như hình bên). Góc giữa đường thẳng $ SB $ và mặt phẳng $ (ABC) $ bằng
% 	\choice
% 	{$ 30^\circ $}
% 	{\True $ 45^\circ $}
% 	{$ 60^\circ $}
...
% 	\end{tikzpicture}}
% 	\loigiai{
% 	\immini[thm]{Ta có $ SB\cap (ABC)=B $; $ SA\perp (ABC) $ tại $ A $.\\
...
% 	{$ \dfrac{2a\sqrt{38}}{19} $}
% 	\loigiai{
% 	\immini[thm]{Từ $ A $ kẻ $ AD\perp BC $ mà $ SA\perp (ABC)\Rightarrow SA\perp BC $.\\
...
% %%==========Câu 39
% \begin{ex}%[2D1K3-1]
% \immini[thm]{Cho hàm số $ y=f(x) $ liên tục trên $ \mathbb{R} $ có đồ thị $ y=f'(x) $ cho như hình dưới đây. Đặt $ g(x)=2f(x)- (x+1)^2 $. Mệnh đề nào dưới đây đúng.
% 	\choice
...
%%==========Câu 44
\begin{ex}%[2D3K3-5]
\immini[thm]{Một cái cổng hình parabol như hình vẽ. Chiều cao $GH=4$ m, chiều rộng $AB=4$ m, $AC=BD=0{,}9$ m. Chủ nhà làm hai cánh cổng khi đóng lại là hình chữ nhật $CDEF$ tô đậm giá là $1200000$ đồng/m$^2$, còn các phần để trắng làm xiên hoa có giá là $900000$ đồng/m$^2$.	Hỏi tổng chi phí để là hai phần nói trên gần nhất với số tiền nào dưới đây?
	\choice
	{\True $11445000$ (đồng)}
	{$7368000$ (đồng)}
	{$4077000$ (đồng)}
...
%%==========Câu 46
\begin{ex}%[2D1G2-2]
\immini[thm]{Cho hàm số $ y=f(x) $ có đồ thị $ y=f'(x) $ như hình vẽ bên. Đồ thị hàm số $ g(x)=  | 2f(x)- (x-1)^2 | $ có tối đa bao nhiêu điểm cực trị?
	\choice
	{$ 3 $}
	{\True $ 5 $}
	{$ 6 $}
...
%%==========Câu 48
\begin{ex}%[2D3G3-1]
\immini[thm]{Cho hàm số $ y=x^4-3x^2+m $ có đồ thị $ (C_m) $, với $ m $ là tham số thực. Giả sử $ (C_m) $ cắt trục $ Ox $ tại bốn điểm phân biệt như hình vẽ. Gọi $ S_1 $, $ S_2 $, $ S_3 $ là diện tích các miền gạch chéo được cho trên hình vẽ. Giá trị của $ m $ để $ S_1+S_3=S_2 $ là
	\choice
	{$ -\dfrac{5}{2} $}
	{\True $ \dfrac{5}{4} $}
	{$ -\dfrac{5}{4} $}
