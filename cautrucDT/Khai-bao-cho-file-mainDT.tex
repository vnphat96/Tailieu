...
\hoten \dotfill {\fontsize{10}{11}\selectfont \ngaylamde}
	...
	\notename
\vspace*{0.5cm}
	\addcontentsline{toc}{section}{\hspace*{-1.5cm}\color{\mauSEC}\fontfamily{qag}\fontsize{12pt}{1pt}\selectfont\bfseries {Đề \thedeso: #2 --- #3}} % đưa MT vào mục lục
}
\newcommand\tatsode{
	\let\oldname\name
	\renewcommand{\name}[4]{
...
\newcommand{\indamm}[1]{
	{\fontsize{11pt}{9pt}\sffamily \selectfont\bfseries\color{\maudl} #1}
}
\newcommand{\ind}[1]{
