...
\begin{ex}%[Dự án tex hóa đề cương Mariecurie - Biên soạn Thầy Nguyễn Ngọc Nguyên]%[2D1B3-1]
    \immini[thm]{	Cho hàm số $f(x)$ liên tục trên đoạn $[-1;5]$ và có đồ thị như hình vẽ bên. Gọi $M,m$ lần lượt là giá trị lớn nhất, nhỏ nhất của hàm số trên đoạn $[-1;5]$. Giá trị $M+m$ bằng }
    {
...
\begin{ex}%[2D1K3-1]%[Dự án TEX hóa đề cương Marie Curie - Ân Trương]
    ...
    \loigiai{
        ...
        \immini[thm]
        {
            Đây là phương trình hoành độ giao điểm của đồ thị hàm số $ y=f'(x) $ và phương trình đường thẳng $ y=x+1 $.\\
