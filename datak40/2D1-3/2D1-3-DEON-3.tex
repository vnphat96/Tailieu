...
\end{ex}
\begin{ex}
 \immini[thm]{Cho hàm số $y=f(x)$ liên tục trên $[-3;2]$ và có bảng biến thiên như sau. Gọi $M$, $m$ lần lượt là giá trị lớn nhất và giá trị nhỏ nhất của hàm số $y=f(x)$ trên đoạn $[-1;2]$. Giá trị của $M+2m$ bằng
 \choice
 {$6$}
 {$8$}
 {\True $3$}
...
\end{ex}
\begin{ex}
 \immini[thm]{Cho hàm số $y=f(x)$ có bảng biên thiên như hình bên. Tìm giá trị nhỏ nhất của hàm số trên trên $\mathbb{R}$.
 \choice
 {$2$}
 {$0$}
 {$-3$}
...
\end{ex}
\begin{ex}%[2D1H3-2]
 \immini[thm]{Cho hàm số $y=f(x)$ liên tục trên $\mathbb{R}$ và có đồ thị như hình bên. Xét tính đúng sai của các khẳng định sau:
 \choiceTF
