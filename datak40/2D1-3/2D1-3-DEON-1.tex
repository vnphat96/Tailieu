...
\begin{ex}%[Võ Thị Thùy Trang - DA1]%[2D1B3-2]%4
    \immini{Cho hàm số $y=f(x)$ liên tục trên đoạn $[-1;3]$ và có đồ thị như hình. Gọi $M$ và $m$ lần lượt là giá trị lớn nhất và nhỏ nhất của hàm số đã cho trên đoạn $[-1;3]$. Giá trị của $M-m$ bằng
        \choice
        {$0$}
        {$1$}
        {$4$}
...
\begin{ex}%[Đề kiểm tra HK1 THPT Lương Ngọc Quyến - Thái Nguyên, 2020-2021]%[Lý Văn Hoàng, 12-EX-5-2021]%[2D1K3-6]%
    ...
    {$85$ triệu đồng}
    \loigiai{
        \immini{Gọi chiều rộng của đáy là $x$ (m) $(x>0)$ thì chiều dài của bể là $2x$ (m).\\
