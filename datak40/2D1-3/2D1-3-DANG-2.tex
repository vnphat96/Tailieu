...
\begin{ex}
    ...
    \loigiai{
        ...
        Ta có $y'=1-\frac{4}{x^2}=\frac{x^2-4}{x^2} \Rightarrow y'=0 \Leftrightarrow\left[\begin{array}{l}x=2 \in(0 ;+\infty) \\ x=-2 \notin(0 ;+\infty)\end{array}\right.$.
        Bảng biến thiên
...
\begin{ex}
    ...
    \loigiai{
        Ta có: $y'=3 x^2-6 m x+3\left(m^2-1\right)=0 \Leftrightarrow\left[\begin{array}{l}x_1=m-1 \\ x_2=m+1\end{array}\right.$.
...
\begin{ex}
    ...
    \loigiai{ Xét hàm số $y=f(x)=x+\dfrac{1}{x}-2$ trên khoảng $(-\infty ; 0)$;\\
        Trên khoảng $(-\infty ; 0)$, ta có $f'(x)=1-\dfrac{1}{x^2}=\dfrac{x^2-1}{x^2}$.
        \begin{itemize}
...
\begin{ex}
    ...
    \loigiai{Xét hàm số $y=f(x)=\dfrac{x-2}{2 x-3}$ trên nửa khoảng $[2 ; 6)$;\\
        Ta có $f'(x)=\dfrac{1}{(2x-3)^2}>0,\;\forall x\in (2;6)$.\\
...
\begin{ex}
    ...
    \loigiai{Xét hàm số $y=f(x)=\sqrt{4-x^2}$;\\
        ...
        Ta có $f'(x)=\dfrac{-x}{\sqrt{4-x^2}}$; $f'(x)=0 \Leftrightarrow x=0\in(-2 ; 2)$.\\
...
\begin{ex}
    ...
    \loigiai{Xét hàm số $y=f(x)=x \ln x$ trên đoạn $\left[\mathrm{e}^{-2} ; \mathrm{e}\right]$.\\
        Ta có $f'(x)=\ln x -1$; $f'(x)=0 \Leftrightarrow x=\mathrm{e}\notin(\mathrm{e}^{-2} ; \mathrm{e})$'\\
