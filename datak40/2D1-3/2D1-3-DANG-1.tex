...
\begin{vd}%[Dự án tex hóa đề cương Mariecurie - Biên soạn Thầy Nguyễn Ngọc Nguyên]
    \immini[thm]{ Cho hàm số $y=f(x)$ có bảng biến thiên như hình vẽ, tìm Max-min của $y=f(x)$ trên
        \begin{listEX}[2]
            \item $(-\infty; -4]$.
            \item $(-\infty; 1)$.
            \item $(-\infty; 6)$.
...
\end{vd}
\begin{vd}
    \immini[thm]{Cho hàm số $y=f(x)$ có đồ thị như hình vẽ. Tìm Max-min của
        \begin{listEX}[2]
            \item $y=f(x)$ trên $[-2;3]$.
            \item $y=f(x)$ trên $[0;3]$.
            \item $y=|f(x)|$.
...
\end{vd}
\begin{vd}
    \immini[thm]{Cho hàm số $y=f(x)$ có đồ thị hàm số $y=f'(x)$ như hình vẽ. Tìm Max-min của hàm số
        \begin{listEX}
...
\begin{ex}%[2D1B3-1]
    \immini[thm]{Cho hàm số $f(x)$ liên tục trên đoạn $[-1;3]$ và có đồ thị như hình vẽ. Gọi $M$ và $m$ lần lượt là giá trị lớn nhất, giá trị nhỏ nhất của hàm số đã cho trên $[-1;3]$. Giá trị $M-m$ bằng
        \choice[2]
        {$0$}
        {\True $5$}
        {$4$}
        {$1$}}{\begin{tikzpicture}[scale=0.8,xscale=0.8,yscale=0.5,>=stealth, font=\scriptsize, line join=round, line cap=round]
            \def\a{-1} \def\b{0} \def\c{2} % Hệ số
...
\begin{ex}%[Dự án tex hóa đề cương Mariecurie - Biên soạn Thầy Nguyễn Ngọc Nguyên]%[2D1B3-1]
    \immini[thm]{Cho hàm số $f(x)$ liên tục trên đoạn $[-2;3]$ và có đồ thị như hình bên. Gọi $M,m$ lần lượt là giá trị lớn nhất, nhỏ nhất của hàm số đã cho trên đoạn $[-2;3
...
\begin{ex}%[Võ Thị Thùy Trang - DA1]%[2D1Y3-1]
    \immini[thm]{Cho hàm số $y=f(x)$ xác định và liên tục trên $[-2;3]$ có bảng biến thiên như hình bên. Gọi $M$, $m$ lần lượt là giá trị lớn nhất và nhỏ nhất của hàm số trên đoạn $\left[-2;3\right]$. Tổng $M+m$ bằng
        \choice
        {$-1$}
        {$3$}
        {\True $1$}
...
\end{ex}
\begin{ex}%[Võ Thị Thùy Trang - DA1]%[2D1Y3-1]
    \immini[thm]{Cho hàm số $y=f(x)$ liên tục trên $\mathbb{R}$ và có bảng biến thiên trên đoạn $[-1;4]$ như hình bên dưới. Gọi $M$ và $m$ lần lượt là giá trị lớn nhất và nhỏ nhất của hàm số đã cho trên đoạn $\left[-1;4\right]$. Giá trị của $M+m$ bằng
        \choice
        {$-4$}
        {\True $-28$}
        {$20$}
...
\begin{ex}%[Võ Thị Thùy Trang - DA1]%[2D1B3-2]%5
    \immini[thm]{Cho hàm số $y=f(x)$ xác định, liên tục trên đoạn $[-2;2]$ và có đồ thị là đường cong trong hình vẽ bên dưới. Gọi $M$ và $m$ lần lượt là giá trị lớn nhất và nhỏ nhất của hàm số đã cho trên đoạn $[-2;2]$. Giá trị của $M-m$ bằng
        \choice
        {$0$}
        {\True $8$}
        {$4$}
...
\begin{ex}%[Võ Thị Thùy Trang - DA1]%[2D1B3-2]%6
    \immini[thm]{Cho hàm số $y=f(x)$ xác định và liên tục trên $\mathbb{R}$ có đồ thị bên dưới. Gọi $M$ và $m$ lần lượt là giá trị lớn nhất và nhỏ nhất của hàm số đã cho trên đoạn $[1;3]$. Giá trị của $M+m$ bằng
        \choice
        {$4$}
        {$-6$}
        {$-2$}
...
\begin{ex}%[Dự án tex hóa đề cương Mariecurie - Biên soạn Thầy Nguyễn Ngọc Nguyên]%[2D1K3-1]
    \immini[thm]{Cho hàm số $f(x)$ liên tục trên đoạn $[a;b]$ và có đồ thị như hình bên. Gọi $M,m$ lần lượt là giá trị lớn nhất, nhỏ nhất của hàm số $y=|f(x)|$ trên đoạn $[a;b]$. Giá trị của $M-m$ bằng
        \choice[2]
        { \True $4$}
        {$-2$}
        {$5$}
...
\end{ex}
\begin{ex}%[Dự án tex hóa đề cương Mariecurie - Biên soạn Thầy Nguyễn Ngọc Nguyên]%[2D1K3-1]
    \immini[thm]{	Cho hàm số $f(x)$ liên tục trên đoạn $[-1;5]$ và có đồ thị như hình vẽ bên. Gọi $M,m$ lần lượt là giá trị lớn nhất, nhỏ nhất của hàm số $y=|f(x)|$ trên đoạn $[-1;5]$. Giá trị của $M-m$ bằng}
    {
...
\begin{ex}%[Võ Thị Thùy Trang - DA1]%[2D1G3-2]%8
    \immini[thm]{Cho hàm số $y=f(x)$ liên tục trên đoạn $[-1;3]$ và có đồ thị như hình vẽ. Giá trị lớn nhất của hàm số $y=f\left(3\sin^2 x -1\right)$ bằng
        \choice
        {$0$}
        {$1$}
        {$3$}
...
\begin{ex}%[Võ Thị Thùy Trang - DA1]%[2D1G3-2]%9
    \immini[thm]{Cho hàm số $y=f(x)$ liên tục trên đoạn $[-1;3]$ và có bảng biến thiên bên dưới. Tìm giá trị lớn nhất của hàm số $y=3\left|\cos x\right| -1$.
        \choice
        {$4$}
        {$3$}
        {\True $2$}
...
\begin{ex}%[Võ Thị Thùy Trang - DA1]%[2D1G3-2]%10
    \immini[thm]{Cho hàm số $y=f(x)$ liên tục trên đoạn $[-2;2]$ có đồ thị như hình. Gọi $M$, $m$ lần lượt là giá trị lớn nhất và nhỏ nhất của hàm số $y=3f\left(\dfrac{4\sin x -1}{3}\right)$ trên $\left(0;\dfrac{7\pi}{6}\right)$. Giá trị của $2M-m$ bằng
        \choice
        {$4$}
        {\True $2$}
        {$5$}
...
\begin{ex}%[Võ Thị Thùy Trang - DA1]%[2D1G3-2]%11
    \immini[thm]{Cho hàm số $y=f(x)$ liên tục trên đoạn $[-1;3]$ và có đồ thị như hình. Gọi $M$, $m$ lần lượt là giá trị lớn nhất và nhỏ nhất của hàm số $y=f\left(f(x)\right)$ trên đoạn $\left[-1;0\right]$. Giá trị của $M-m$ bằng
        \choice
        {$2$}
        {\True $3$}
        {$4$}
...
\begin{ex}%[Võ Thị Thùy Trang - DA1]%[2D1G3-2]%12
    \immini[thm]{Cho hàm số $y=f(x)$ xác định, liên tục trên đoạn $[-2;2]$ và có đồ thị là đường cong trong hình vẽ bên dưới. Gọi $M$, $m$ lần lượt là giá trị lớn nhất và nhỏ nhất của hàm số $y=f\left(f(x)\right)$ trên đoạn $\left[-1;1\right]$. Giá trị của $M-m$ bằng
        \choice
        {$2$}
        {$4$}
        {$6$}
...
\begin{ex}%[2D1H3-1]%[GV- Thái Văn Sang]%[Du-An-Ngan-Hang-Cau-Hoi-2024-K12]%10
    \immini[thm]{Cho hàm số $y=f(x)$ liên tục trên $R$ và hàm số $y=f'(x)$ có đồ thị như hình vẽ dưới đây.Xét hàm số $y=f(x)$ trên đoạn $\left[\dfrac{1}{2};\dfrac{3}{2} \right]$, biết $f\left(\dfrac{3}{2}\right)<f\left(\dfrac{1}{2}\right)$. Xét tính đúng hoặc sai của các phát biểu sau đây?
        \choiceTF
...
\begin{ex}%[2D1V3-1]%[GV- Thái Văn Sang]%[Du-An-Ngan-Hang-Cau-Hoi-2024-K12]%10
    \immini[thm]{ Cho hàm số $f(x)$ có đồ thị của hàm số $y=f'(x)$ như hình vẽ. Biết $f(0)+f(1)-2f(2)=f(4)-f(3)$. Gọi giá trị nhỏ nhất $m$, giá trị lớn nhất $M$ của hàm số $f(x)$ trên đoạn $[0;4]$. Xét tính đúng hoặc sai của các phát biểu sau
        \choiceTF
        {\True $M=f(2)$}
        {\True $m=f(4)$}
        {$m=f(-1)$}
