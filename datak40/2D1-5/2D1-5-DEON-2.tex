...
\begin{ex}%[2D1B5-1]
    \immini[thm]{Bảng biến thiên ở hình bên là của hàm số nào trong các hàm số dưới đây?
        \choice
        {$y=-x^3+3x^2-3$}
        {$y=x^3+3x^2-1$}
        {$y=x^3-3x+2$}
        {\True $y=x^3-3x^2+2$}}{\begin{tikzpicture}
...
\end{ex}
\begin{ex}%[2D1B5-3]
    \immini[thm]{Cho hàm số $y=f(x)=ax^4+bx^2+c$ có đồ thị như hình vẽ. Số nghiệm của phương trình $2f(x)+3=0$ là
        \choice
        {$ 3 $}
        {$ 1 $}
        {$ 2 $}
...
\begin{ex}%[2D1Y5-1]
    \immini[thm]{Đường cong trong hình bên là đồ thị của một hàm số trong bốn hàm số được liệt kê ở bốn phương án $A$, $B$, $C$, $D$ dưới đây. Hỏi hàm số đó là hàm số nào?
        ...
        {$y=-x^3+3x+1$}
        {\True $y=x^3-3x+1$}
        {$y=x^4-x^2+1$}}{\begin{tikzpicture}[scale=0.3, font=\footnotesize, line join=round, line cap=round, >=stealth]
...
\end{ex}
\begin{ex}%[2D1Y5-1]
    \immini[thm]{	Đường cong ở hình bên là đồ thị của hàm số $y=ax^4+bx^2+c$. Mệnh đề nào sau đây đúng?
        \choice
        {$y'=0$ có hai nghiệm và $a<0$}
        {$y'=0$ có ba nghiệm và $a>0$}
        {$y'=0$ có hai nghiệm và $a>0$}
        {\True $y'=0$ có một nghiệm và $a<0$}}{\begin{tikzpicture}[scale=0.7,>=stealth, font=\footnotesize, line join=round, line cap=round]
...
\begin{ex}%[2D1B5-3]
    ...
    \centerline{\begin{tikzpicture}[>=stealth,scale=1]
...
\end{ex}
\begin{ex}%[2D1B5-4]
    \immini[thm]{Cho hàm số $y=f(x)$ có đồ thị như hình vẽ bên. Phương trình $f(x)=-3$ có số nghiệm là
        \choice
        {$0$}
        {$1$}
        {$2$}
...
\end{ex}
\begin{ex}%[2D1K5-1]
    \immini[thm]{Cho hàm số $ f(x)=ax^4+bx^2+c $ ($ a\ne 0 $) có đồ thị như hình vẽ.
...
\end{ex}
\begin{ex}%[2D1B5-1]
    \immini[thm]{Biết hàm số $y=\dfrac{x+a}{x-1}$ ($a$ là số thực cho trước, $a\ne -1$) có đồ thị như trong hình bên. Mệnh đề nào dưới đây đúng?
        \choice
        {\True $y'>0$, $\forall x\ne 1$}
...
\end{ex}
\begin{ex}%[2D1K5-1]
    \immini[thm]{Cho hàm số $y=\dfrac{ax-b}{x-1}$ có đồ thị như hình vẽ bên dưới. Khẳng định nào sau đây là đúng?
        \choice
        {\True $ b<a<0 $}
        {$ 0<b<a $}
        {$ b<0<a $}
...
\end{ex}
\begin{ex}%[2D1Y5-1]
    \immini[thm]{Đường cong ở hình bên là đồ thị của hàm số $y=ax^3+b x^2+cx+d$. Mệnh đề nào sau đây đúng?
        \choice
        {$y'=0$ có 3 nghiệm và $a<0$}
        {$y'=0$ có 2 nghiệm và $a>0$}
        {$y'=0$ có 3 nghiệm và $a>0$}
        {\True $y'=0$ có 2 nghiệm và $a<0$}}{\begin{tikzpicture}[scale=0.5,>=stealth, font=\footnotesize, line join=round, line cap=round]
...
\end{ex}
\begin{ex}%[2D1B5-1]
    \immini[thm]{Giả sử đồ thị hình bên là của một trong các hàm được liệt kê ở các đáp án A, B, C, D. Hỏi đó là hàm số nào?
        \choice
        {\True $y=x^4-2x^2-1$}
        {$y=x^4+2x^2$}
        {$y=x^4-2x^2+1$}
...
\end{ex}
\begin{ex}%[2D1B5-3]
    \immini[thm]{Cho hàm số $y=f(x)$ có đồ thị như hình vẽ. Số nghiệm của phương trình $2f^2(x)-1=0$ trên đoạn $[-2;3]$ là
        \choice
        {$7$}
        {\True $8$}
        {$5$}
