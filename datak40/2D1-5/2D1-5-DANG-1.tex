...
\begin{vd}
    ...
    \end{tikzpicture}}
    {\True \begin{tikzpicture}[>=stealth, scale=0.5, font=\footnotesize]
    ...
    \loigiai{
        ...
        \immini[thm]{Ngoài ra hàm số có hệ số $a>0$ nên chọn hình bên
...
\begin{vd}
    ...
    \end{tikzpicture}}
    \loigiai{
        Đồ thị của hàm số đã cho có tiệm cận đứng $x=-1$, tiệm cận ngang $y=-1$. Ngoài ra đồ thị hàm số còn qua các điểm $A(1;0)$ và $B(0;1)$. \immini[thm]{Đồ thị ở phương án thỏa mãn các tính chất trên.
        }{
            \begin{tikzpicture}[>=stealth, scale=0.4, font=\footnotesize]
                \draw[->] (-5,0)--(4,0) node[below] {$x$};
                \draw[->] (0,-5)--(0,3) node[left] {$y$};
...
\end{ex}
\begin{ex}%[2D1Y5-1]
    \immini[thm]{Đồ thị hình bên là đồ thị của hàm số nào dưới đây?
        \choice
        { $ y = \dfrac{3 - 2x}{x+1}$}
        {$y = \dfrac{1 - 2x}{x -1}$}
        {$ y = \dfrac{1 - 2x}{1 - x}$}
...
\end{ex}
\begin{ex}%[2D1Y5-1]
    \immini[thm]{Đồ thị hình vẽ là đồ thị của hàm số nào dưới đây?
        \choice
        {$y=\dfrac{2x-1}{x-1}$}
        {\True $y=\dfrac{x+1}{x-1}$}
        {$y=x^4+x^2+1$}
...
\end{ex}
\begin{ex}%[2D1Y5-1]
    \immini[thm]{Đường cong ở hình bên là đồ thị của hàm số $y=\dfrac{a x+b}{c x+d}$. Mệnh đề nào dưới đây đúng?
        \choice
        {$y'<0$, $\forall x\ne2$}
        {$y'<0$, $\forall x\ne-1$}
        {$y'>0$, $\forall x\ne 2$}
...
\end{ex}
\begin{ex}%[2D1K5-1]
    \immini[thm]{Cho hàm số $f(x)=\dfrac{ax-2}{bx+c}$ với có bảng biến thiên như hình vẽ bên. Giá trị $a+b+c$ thuộc khoảng nào dưới đây?
        \choice
        {\True $\left(-1;1\right)$}
        {$\left(-2;-1\right)$}
        {$\left(2;3\right)$}
...
\end{ex}
\begin{ex}%[2D1B5-1]
    \immini[thm]{Hàm số nào trong bốn hàm số dưới đây có bảng biến thiên như hình bên?
        \choice
        {$ y=\dfrac{2x-1}{x+3} $}
        {$ y=\dfrac{4x-6}{x-2} $}
        {$ y=\dfrac{3-x}{2-x}$}
...
\end{ex}
\begin{ex}
    \immini[thm]{Đường cong trong hình vẽ bên là đồ thị của một trong bốn hàm số sau. Hỏi đó là hàm số nào?
        \choice
        {$y=\dfrac{x-1}{x-2}$}
        {$y=x+2$}
        {$y=x^4-3x^2+1$}
...
\end{ex}
\begin{ex}
    \immini[thm]{Đường cong trong hình vẽ bên là đồ thị của một trong bốn hàm số sau. Hỏi đó là đồ thị của hàm số nào?
        \haicot
        {$y=\dfrac{x-2}{x+1}$}
        {$y=\dfrac{x+2}{x-2}$}
        {\True $y=\dfrac{x-2}{x-1}$}
...
\end{ex}
\begin{ex}
    \immini[thm]{Cho hàm số $ y=\dfrac{ax+1}{bx-2} $ có đồ thị như hình vẽ. Tính $T=a+b$
        \haicot
        {\True $ T=2 $}
        {$ T=0 $}
        {$ T=-1 $}
...
\end{ex}
\begin{ex}
    \immini[thm]{Hãy xác định $a$, $b$ để hàm số $y = \dfrac{2 - ax}{x + b}$ có đồ thị như hình vẽ?
        \choice
        {$a = 1$; $b = - 2$}
        {$a = b = 2$}
        {\True $a = - 1$; $b = -2$}
...
\end{ex}
\begin{ex}
    \immini[thm]{Cho đồ thị hàm số $y=\dfrac{ax-b}{x-1}$ như hình vẽ. Tìm khẳng định đúng?
        \choice
        {$a<0$, $b<0$}
        {$0<b<a$}
        {\True $b<0<a$}
...
\end{ex}
\begin{ex}
    \immini[thm]{Cho hàm số $y=\dfrac{ax+4}{bx+c}\ (a,\ b,\ c\in \mathbb{R})$ có bảng biến thiên như sau. Trong các số $a,\ b,\ c$ có bao nhiêu số dương?
        \choice
        {$0$}
        {\True $1$}
        {$2$}
...
\end{ex}
\begin{ex}
    \immini[thm]{Hình vẽ bên là đồ thị của hàm số $y=\dfrac{ax+b}{cx+d}$. Mệnh đề nào sau đây là đúng?
        \choice
        {$ab>0,bd<0$}
        {$ab<0,ad>0$}
        {\True $ab<0,ad<0$}
...
\end{ex}
\begin{ex}
    \immini[thm]{Hình vẽ dưới đây là đồ thị hàm số $y=\dfrac{ax+b}{cx+d}$ $ac\ne0$, $ad-cb\ne0$. Mệnh đề nào sau đây đúng?
        \choice
        {\True $ad>0$ và $ab<0$}
        {$bd<0$ và $ab>0$}
        {$ad<0$ và $ab<0$}
...
\end{ex}
\begin{ex}
    \immini[thm]{Bảng biến thiên sau là của một trong bốn hàm số sau. Hỏi đó là hàm số nào?
        \choice
...
\end{ex}
\begin{ex}
    \immini[thm]{Cho hàm số $y = \dfrac{x + a}{b x +c}$, $\left( a, b, c \in \mathbb{Z}\right) $.
        \choiceTF
...
\end{ex}
\begin{ex}%[2D1K5-1]%
    \immini[thm]{Cho hàm số $ f(x)=\dfrac{a x-1}{b x+c}\ (a, b, c\in\mathbb{R})$ có bảng biến thiên như sau.
        \choiceTF
...
\end{ex}
\begin{ex}
    \immini[thm]{Cho hàm số $f(x)=\dfrac{ax+b}{cx+d}$ với $a$, $b$, $c$, $d \in \mathbb{R}$ có đồ thị hàm số $y=f'(x)$ nhận $x=-1$ làm tiệm cận đứng như hình vẽ bên. Biết rằng giá trị lớn nhất của hàm số $y=f(x)$ trên đoạn $[-3;-2]$ bằng $8$.
        \choiceTF
        {\True $f'(0)=3$}
...
\end{ex}
\begin{ex}
    \immini[thm]{Cho hàm số $y=\dfrac{ax^2+bx+c}{mx+n}$ có đồ thị như hình bên.
        \choiceTF
...
\end{ex}
\begin{ex}
    \immini[thm]{Cho hàm số $y=\dfrac{ax^2+bx+c}{x+n}$ có đồ thị như hình bên.
        \choiceTF
