...
%%==========Ví dụ 9
\begin{vd}%[2D1B1-2]
    \immini[thm]{Cho hàm số $y=f(x)$ liên tục trên $\mathbb{R}$ và có đồ thị như hình bên. Tìm các khoảng đơn điệu của hàm số $f(x)$.
    }{\vspace{-0.3cm}
...
%%==========Ví dụ 14
\begin{vd}%[2D1B5-5]
    \immini[thm]{Cho hàm số $y=f(x)$ có đạo hàm liên tục trên $\mathbb{R}$, hàm số $y=f'(x)$ có đồ thị như hình bên.
        Tìm các khoảng đơn điệu của hàm số $f(x)$.
    }{\vspace{-0.5cm}
...
%%==========Ví dụ 50
\begin{vd}%[2D1K2-6]
    \immini[thm]{Cho hàm số $y=f(x)$ có đồ thị đạo hàm $f'(x)$ như hình vẽ bên dưới. Có bao nhiêu giá trị nguyên của tham số $m$ thuộc khoảng $(-12;12)$ sao cho hàm số $y=f(x)+mx+12$ có đúng một điểm cực trị?
    }{
