...
\begin{vd}%[2D1Y1-1]
 ...
 \centerline{\begin{tikzpicture}[>=stealth,font=\scriptsize,x=1.5cm,y=.7cm]
 ...
 \end{tikzpicture}}
 \item Đồ thị của $y=f'(x)$ như hình vẽ\\
 \centerline{ \begin{tikzpicture}[>=stealth,font=\scriptsize]
...
\begin{vd}%[2D1Y2-2]
 ...
 \item Viết PTĐT đi qua hai điểm cực trị của đồ thị hàm số.
 \end{itemize}
 \begin{listEX}[3]
 \item
...
\begin{ex}%[2D1Y2-2]
 ...
 {Hàm số có hai điểm cực tiểu}}{	\begin{tikzpicture}
...
\begin{ex}%[2D1Y2-2]
 ...
 {$x=7$}
 {$x=-2$}
 {\True $x=6$}}{\begin{tikzpicture}[yscale=.5,xscale=1,
...
\begin{ex}%[2D1Y2-2]
 ...
 {$1$}
 {$0$}
 {\True $2$} }{\begin{tikzpicture}[yscale=.5,xscale=1,
 kxd/.pic={\draw[double] (90:.5)--(-90:.5);}]
 \begin{scope}[shift={(-.5,.5)}]
 \draw
 (0,0) rectangle +(8,-5.5)
...
\begin{ex}%[2D1Y2-2]
 ...
 \choice[2]
 {$2$}{$1$}{$3$}{\True $0$}}{\begin{tikzpicture}[yscale=.5,xscale=1,
 kxd/.pic={\draw[double] (90:.5)--(-90:.5);}]
 \begin{scope}[shift={(-.5,.5)}]
 \draw
 (0,0) rectangle +(8,-5)
...
\begin{ex}%[2D1B2-2]
 ...
 {$x=1$}
 {\True $x=0$}
 {$x=2$}}{\begin{tikzpicture}[>=stealth,line join=round, line cap=round, font=\footnotesize,scale=0.7]
 \def\a{-1} % Hệ số a phải khác 0
 \def\b{2}
 \def\c{1}
...
\begin{ex}%[2D1B2-2]
 ...
 {$1$}
 {\True $2$}
 {$3$}}{\begin{tikzpicture}[>=stealth,line join=round, line cap=round, font=\footnotesize,scale=0.6]
...
\begin{ex}%[2D1B2-2]
 ...
 {$5$}
 {$6$}
 {$3$}}{\begin{tikzpicture}[>=stealth,line join=round, line cap=round, font=\scriptsize]
 \begin{scope}[scale=.5]
...
\begin{ex}%[2D1B2-2]
 ...
 {\True $x=-1$}
 {$x=1$}
 {$x=2$}}{\begin{tikzpicture}[>=stealth,line join=round, line cap=round, font=\scriptsize,yscale=0.5]
...
\begin{ex}%[2D1B2-2]
 ...
 {$x=-1$}
 {$x=2$}
 {$x=3$}}{\begin{tikzpicture}[>=stealth,line join=round, line cap=round, font=\scriptsize,x=.8cm]
 \begin{scope}[scale=.6]
...
\begin{ex}%[2D1K2-2]
 ...
 {\True $\sqrt{10}$}
 {$\sqrt{2}$}
 {$2$}}{\begin{tikzpicture}[>=stealth,line join=round, line cap=round, font=\scriptsize,x=.8cm]
 \begin{scope}[scale=.6]
 \draw[-stealth](-3,0)--(0,0)node[above right]{$O$}--(5,0)node[below left]{$x$};
 \draw[-stealth](0,-4)--(0,-1)node[ right]{$-1$}--(0,2)node[below left]{$y$};
 \draw[dashed]
...
\end{ex}
\begin{ex}%[2D1K2-2]
 \immini[thm]{Cho hàm số $y=f(x)$ có đồ thị như hình vẽ bên. PTĐT đi qua hai điểm cực tiểu của đồ thị hàm số đã cho là.\choice[1]
 {\True $x+3y+7=0$}
 {$x-y+1=0$}
 {$x+y+1=0$}
 {$3x-y-9=0$}}{\begin{tikzpicture}[>=stealth,line join=round, line cap=round, font=\scriptsize,x=.8cm]
 \begin{scope}[scale=.6]
 \draw[-stealth](-3,0)--(0,0)node[above right]{$O$}--(5,0)node[below left]{$x$};
 \draw[-stealth](0,-4)--(0,-1)node[ right]{$-1$}--(0,2)node[below left]{$y$};
 \draw[dashed]
...
\Opensolutionfile{ans}[ans/2D1-2-DANG-1]
\begin{ex}%[2D1Y2-2]
 \immini{Cho hàm số $y=f(x)$ có bảng biến thiên như hình vẽ. Mệnh đề nào dưới đây \textbf{sai}?
 \choice[1]
 {Hàm số có ba điểm cực trị}
 {Hàm số có giá trị cực đại bằng $ 3 $}
 {\True Hàm số có giá trị cực đại bằng $0$}
...
%%câu 8
\begin{ex}%[2D1Y2-2]
 \immini{Cho hàm số $y= f(x)$ có bảng biến thiên như sau. 	Điểm cực đại của hàm số đã cho là
 \choice[2]
 {$x=-4$}
 {$x=7$}
 {$x=-2$}
...
%--câu 4
\begin{ex}%[2D1Y2-2]
 \immini{	Cho hàm số $y=f(x)$ xác định, liên tục trên $\mathbb R$ và có bảng biến thiên như sau. 	Hàm số đã cho có bao nhiêu điểm cực trị?
 \choice[2]
 {$3$}
 {$1$}
 {$0$}
...
%%câu 5
\begin{ex}%[2D1Y2-2]
 \immini{Cho hàm số $y=f(x)$ có bảng biến thiên như sau. 	Hàm số đã cho có bao nhiêu cực tiểu?
 \choice[2]
 {$2$}{$1$}{$3$}{\True $0$}}{\begin{tikzpicture}[yscale=.5,xscale=1,
 kxd/.pic={\draw[double] (90:.5)--(-90:.5);}]
 \begin{scope}[shift={(-.5,.5)}]
...
\end{ex}
\begin{ex}%[2D1Y2-2]
 \immini{	Cho hàm số $y=f(x)$ có bảng biến thiên như hình
 vẽ. Tổng các điểm cực đại và điểm cực tiểu của hàm số đã cho bằng
 \choice[2]
 {$5$}
 {\True $ 1 $}
...
\end{ex}
\begin{ex}%[2D1Y2-2]
 \immini{	Cho hàm số $y=f(x)$ có bảng biến thiên như hình vẽ. Tổng các điểm cực trị của hàm số đã cho bằng
 \choice[2]
 {$ 2 $}
 {$ 1 $}
 {\True $ -4 $}
...
\end{ex}
\begin{ex}%[2D1B2-2]
 \immini{	Cho hàm số $y=f(x)$ có bảng biến thiên như hình vẽ. Khoảng cách giữa điểm cực đại và điểm cực tiểu của đồ thị hàm số đã cho bằng
 \choice[2]
 {$ 3 $}
 {\True $\sqrt{10}$}
 {$\sqrt{2}$}
...
\end{ex}
\begin{ex}%[2D1B2-2]
 \immini{Cho hàm số $f(x)$ liên tục trên $\mathbb{R}$ và có bảng biến thiên như hình vẽ. Đường thẳng đi qua hai điểm cực trị của đồ thị hàm số đã cho có phương trình
 \choice[2]
 {\True $3y=4x+1$}
 {$3y=x-2$}
 {$3y=13-2x$}
...
\end{ex}
\begin{ex}%[2D1B2-2]
 \immini{Cho hàm số $y=f(x)$ có đồ thị như hình vẽ bên. Hàm số đã cho đạt cực tiểu tại điểm.
 \choice[2]
 {$x=-1$}
 {$x=1$}
 {\True $x=0$}
...
\end{ex}
\begin{ex}%[2D1B2-2]
 \immini{Cho hàm số $y=f(x)$ liên tục trên $[a;b]$ và có đồ thị như hình vẽ bên. Số điểm cực đại của hàm số đã cho là
 \choice[2]
 {$4$}
 {$1$}
 {\True $2$}
...
\end{ex}
\begin{ex}%[2D1B2-2]
 \immini{Cho hàm số $y=f(x)$ liên tục trên $[a;b]$ và có đồ thị như hình vẽ bên. Số điểm cực trị của hàm số đã cho là
 \choice[2]
 {\True $4$}
 {$5$}
 {$6$}
...
%%==========Câu 50
\begin{ex}%[2D1B2-2]
 \immini{	Cho hàm số $y=f(x)$ xác định, liên tục trên $[-2;2]$ và có đồ thị như hình vẽ bên. Hàm số $y=f(x)$ đạt cực đại tại
 \choice[2]
 {$x=-2$}
 {\True $x=-1$}
 {$x=1$}
...
%%==========Câu 52
\begin{ex}%[2D1B2-2]
 \immini{	Cho hàm số $y=f(x)$ có đồ thị như hình vẽ bên. Hàm số đã cho đạt cực đại tại điểm.
 \choice[1]
 {\True $x=0$}
 {$x=-1$}
 {$x=2$}
...
\end{ex}
\begin{ex}%[2D1K2-2]
 \immini{Cho hàm số $y=f(x)$ có đồ thị như hình vẽ bên. Khoảng cách giữa hai điểm cực tiểu của đồ thị hàm số đã cho bằng.
 \choice[1]
 {$3$}
 {\True $\sqrt{10}$}
 {$\sqrt{2}$}
...
\end{ex}
\begin{ex}%[2D1K2-2]
 \immini{Cho hàm số $y=f(x)$ có đồ thị như hình vẽ bên. PTĐT đi qua hai điểm cực tiểu của đồ thị hàm số đã cho là.\choice[1]
 {\True $x+3y+7=0$}
 {$x-y+1=0$}
 {$x+y+1=0$}
 {$3x-y-9=0$}}{\begin{tikzpicture}[>=stealth,line join=round, line cap=round, font=\scriptsize,x=.8cm]
...
\end{ex}
\begin{ex}%[2D1B2-2]
 \immini{	Cho hàm số $y=f(x)$ xác định trên $\mathbb{R} \setminus \{1\}$ và có bảng xét dấu của đạo hàm như hình vẽ. Hàm số đã cho có bao nhiêu cực trị?
 \choice
 {$0 $}
 {\True $ 1 $}
 {$ 3 $}
...
\end{ex}
\begin{ex}%[2D1B2-2]
 \immini{Cho hàm số $y=f(x)$ xác định trên $\mathbb{R} \setminus \{5\}$ và có bảng xét dấu của đạo hàm như hình vẽ. Hàm số đã cho có bao nhiêu cực trị?
 \choice
 {$4 $}
 {$1 $}
 {$ 3 $}
...
\end{ex}
\begin{ex}%[2D1B2-2]
 \immini{	Cho hàm số $y=f(x)$ có bảng xét dấu của đạo hàm như hình vẽ. Hàm số đã cho đạt cực tiểu tại
 \choice
 {\True $x=0$}
 { $x=2$}
 {$y=0$}
...
\end{ex}
\begin{ex}%[2D1Y2-2]
 \immini{Cho hàm số $f(x)$ có đạo hàm trên $\mathbb{R}$ và đồ thị hàm số $y=f'(x)$ trên $\mathbb{R}$ như hình vẽ. Mệnh đề nào đúng?
 \choice
 {\True Hàm số $y=f(x)$ có $1$ điểm cực đại và $1$ điểm cực tiểu}
 {Hàm số $y=f(x)$ có $2$ điểm cực đại và $2$ điểm cực tiểu}
 {Hàm số $y=f(x)$ có $1$ điểm cực đại và $2$ điểm cực tiểu}
...
\end{ex}
\begin{ex}%[2D1Y2-2]
 \immini{Cho hàm số $y=f(x)$ xác định và liên tục trên $\mathbb{R}$ và hàm số $y=f'(x)$ có đồ thị như hình vẽ bên. Khẳng định nào đúng?
 \choice
 {Hàm số $f(x)$ đạt cực đại tại điểm $x=1$}
 {\True Hàm số $f(x)$ đạt cực đại tại điểm $x=0$}
 {Hàm số $f(x)$ đạt cực đại tại điểm $x=-1$}
