...
\begin{ex}
    \immini[thm]{Cho hàm số $y=f\left(x\right)$ có bảng biến thiên như sau. Hàm số đã cho nghịch biến trên khoảng nào dưới đây?
        \choice
        {$\left(1;+\infty\right)$}
        {\True $\left(0;1\right)$}
        {$\left(-\infty;0\right)$}
...
\begin{ex}%[2D1H1-3]
    \immini[thm]{Cho hàm số $y=f(x)$ xác định liên tục và liên tục trên $\mathbb{R}$ và có bảng biến thiên như sau. Khẳng định nào sau đây đúng?
        \choice
        {Hàm số có $2$ cực trị}
...
\begin{ex}%[2D1H1-3]
    \immini[thm]{Cho hàm số $y=f(x)$ có bảng biến thiên như sau. Tìm giá trị cực đại $y_{\text{CĐ}}$ và giá trị cực tiểu $y_{\text{CT}}$ của hàm số đã cho.
        \choice
...
\begin{ex}
    \immini[thm]{Cho hàm số $y=f(x)$ xác định trên $\mathbb{R} \setminus \{0\}$, liên tục trên mỗi khoảng xác định và có bảng biến thiên như hình bên. Hàm số đã cho có bao nhiêu điểm cực trị?
        \choice
        {\True $ 1 $}
        {$ 0 $}
        {$ 3 $}
...
\begin{ex}
    \immini[thm]{Cho hàm số bậc ba $y=f(x)$ có đồ thị như hình vẽ bên. Mệnh đề nào sau đây đúng?
        \choice
...
\begin{ex}%2D1B5-5]
    \immini[thm]{Cho hàm số bậc bốn $y=f(x)$ có đồ thị hàm số $y=f'(x)$ như hình vẽ dưới. Hàm số $y=f(x)$ đồng biến trên khoảng nào?
        \haicot
        {$(-\infty;0)$}
        {\True $(-3;+\infty)$}
        {$(-\infty;4)$}
...
\begin{ex}%[2D1H1-4]
    \immini[thm]{Cho hàm số $y=f(x)$ xác định và liên tục trên đoạn $\left[0 ; \dfrac{16}{5}\right]$ thoả mãn\\
...
\begin{ex}%[2D1H2-2]
    \immini[thm]{Cho hàm số $y=f(x)$ có đồ thị $f'(x)$ trên $[2;5]$ như hình bên. Xét tính đúng sai của các mệnh đề sau:
        \choiceTF
