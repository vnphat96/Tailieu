...
\end{ex}
\begin{ex}%[2D1K2-2]
    \immini[thm]{Cho hàm số $ y=f(x)$ có đồ thị hàm $ y=f'(x) $ như hình vẽ. Số điểm cực trị của hàm số đã cho là
        \choice[2]
        {$ 4 $}
        { $ 1 $}
        {\True$ 2 $}
...
\begin{ex}%[2D1K2-2]
    ...
    \loigiai{
        Dựa vào đồ thị ta thấy Đồ thị hàm số có hai điểm cực trị là $A(-1;2)$ và $B(1,-2)$, PTĐT qua hai điểm cực trị là
...
\end{ex}
\begin{ex}%[2D1K2-2]
    \immini[thm]{Cho hàm số $y=f(x)$ có đạo hàm liên tục trên $\mathbb{R}$ và có đồ thị hàm số $f\left(3-x\right)$ như hình vẽ bên. Hỏi hàm số $y=f\left(x^2-2x\right)$ có mấy cực trị?
        \choice
        {\True $1$}
        {$2$}
        {$3$}
...
\end{ex}
\begin{ex}%[2D1G2-2]
    \immini[thm]{Cho hàm số $y=f(x)$ có đạo hàm liên tục trên $\mathbb{R}$ và $f(0)=0$; $f(4) > 4$. Biết hàm $y=f'(x)$ có đồ thị như hình vẽ bên. Số điểm cực trị của hàm số $g(x)=\left|f\left(x^2\right)-2x\right|$ là
        \choice
        {2}
        {1}
        {4}
