...
\begin{ex}
    ...
    \loigiai{
        Ta có $\lim \limits_{n \to +\infty}_{x \rightarrow-\infty} \frac{x-1}{x^2-8 x+m}=\lim \limits_{n \to +\infty}_{x \rightarrow+\infty} \frac{x-1}{x^2-8 x+m}=0$ nên hàm số có một tiện cận ngang $y=0$.
...
\begin{ex}
    ...
    \loigiai{
        ...
        \begin{listEX}
            ...
            $y=x+m+1\left(\Delta_m\right)$ vì $\lim \limits_{n \to +\infty}_{x \rightarrow \infty}[y-(x+m+1)]=\lim \limits_{n \to +\infty}_{x \rightarrow \infty} \frac{m}{x-1}=0$.
            ...
            \item Ta có với $m \neq 0, x=1$ là tiệm cận đứng vì $\lim \limits_{n \to +\infty}_{x \rightarrow 1} y=\infty$ nên $y=x+m+1$ là tiệm cận xiên.
