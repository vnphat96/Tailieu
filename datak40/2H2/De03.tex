...
%Câu 5
\begin{ex}
	\immini[thm]{Cho hình tứ diện $ABCD$. Gọi $M$, $N$ lần lượt là trung điểm $AB$, $CD$, $I$ là trung điểm của đoạn $MN$. Mệnh đề nào sau đây sai?
		\choice
...
%Câu 6
\begin{ex}
	\immini[thm]{Cho hình lập phương $ABCD.A'B'C'D'$ có cạnh bằng $a$. Hãy tìm mệnh đề đúng trong những mệnh đề sau đây
		\choice
