...
\begin{vd}
	...
	Một chiếc xe có khối lượng $1{,}5$ tấn đang đi xuống trên một đoạn đường dốc có góc nghiêng $5^\circ$ so với phương ngang.
		...
		\end{tikzpicture}}
	Tính công sinh bởi trọng lực $\vec{P}$ khi xe đi hết đoạn đường dốc dài $30$ m (làm tròn kết quả đến hàng đơn vị), biết rằng trọng lực $\vec{P}$ được xác định bởi công thức $\vec{P} = m\vec{g}$, với $m$ (đơn vị: kg) là khối lượng của vật và $\vec{g}$ là gia tốc trọng trường có độ lớn $g = 9{,}8$ m/s$^2$.
	\dongcham{4}
	\loigiai{
		\begin{center}
...
\begin{ex}
	...
	{
		\includegraphics[scale=.08]{images/xe-1.jpg}
	}
	\loigiai{
