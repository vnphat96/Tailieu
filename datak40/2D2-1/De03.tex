...
\begin{ex}
	...
	\begin{ex}
		...
		{\True $2\vec{NM}=\vec{AB}+\vec{CD}$}
			...
			\end{tikzpicture}}
		\loigiai{
			$\vec{GA}+\vec{GC}=2\vec{GM}$ đúng vì $M$ là trung điểm $AC$.\\
			...
			$2\vec{NM}=\vec{AB}+\vec{CD}$ sai vì $\vec{AB}+\vec{CD} =\left(\vec{AM}+\vec{MN}+\vec{NB}\right)+\left(\vec{CM}+\vec{MN}+\vec{ND}\right) =2\vec{MN}+\vec{0}+\vec{0}=2\vec{MN}$.
		}
	\end{ex}
	%Câu 13
	\begin{ex}
...
Cho hình lập phương $ABCD.A_1B_1C_1D_1$ có cạnh $a$. Gọi $M$ là trung điểm $AD$. Các mệnh đề sau đúng hay sai?
	...
	{\True $\vec{C_1M}=\vec{C_1C}+\vec{C_1D_1}+\dfrac{1}{2}\vec{C_1B_1}$}
\loigiai{
...
%Câu 19
\begin{ex}
Cho hình lập phương $ABCD \cdot A'B'C'D'$. Góc giữa hai vectơ $\vec{A'B}$ và $\vec{AC'}$ bằng
\loigiai{
{\centering\color{red} HINH O DAY}\\
