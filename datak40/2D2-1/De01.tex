...
\begin{ex}
	...
	{$2\sqrt{2}$}
	\loigiai{
		Ta có: $|\vec{u}| = |\vec{SA}-\vec{SC}| = |\vec{CA}| =2\sqrt{6}$.
	}
\end{ex}
%Câu 7
\begin{ex}
...
\begin{ex}
	...
	\loigiai{
		...
		\begin{enumerate}[a)]
			...
			\item $IJ^2={{\vec{IJ}}^2}\,=\dfrac{1}{4}{{\left(\vec{AC}+\vec{AD}-\dfrac{3}{2}\vec{AB}\right)}^2}=\dfrac{1}{4}\left(\dfrac{17}{4}a^2+2\vec{AC} \cdot \vec{AD}-3\vec{AC} \cdot \vec{AB}-3\vec{AB} \cdot \vec{AD}\right)=\dfrac{5a^2}{16}\Rightarrow IJ=\dfrac{a\sqrt{5}}{4}$.\\
...
\begin{ex}
	...
	\loigiai{
		...
		Khi đó $\cos \left(AC_1,CB_1\right)=| \cos \left(\vec{AC_1},\vec{CB_1}\right)|=\dfrac{| \vec{AC_1} \cdot \vec{CB_1}|}{AC_1 \cdot CB_1}=\dfrac{| y^2-\dfrac{1}{2}x^2|}{x^2+y^2}$.\\
		Theo đề $\left(AC_1,CB_1\right)>60^\circ $, suy ra $\dfrac{| y^2-\dfrac{1}{2}x^2|}{x^2+y^2}<\dfrac{1}{2}\Leftrightarrow 3y^4-6x^2y^2<0\Leftrightarrow \dfrac{y}{x}<\sqrt{2}$.\\
...
\begin{ex}
	...
	Trả lời: $24$.\\
	Ta có:\\
	$\vec{AB}\left(\vec{AB}-\vec{CA}\right)=\vec{AB} \cdot \vec{AB}+\vec{AB} \cdot \vec{AC}={{\vec{AB}}^2}+| \vec{AB}| \cdot | \vec{AC}| \cdot \cos \left(\vec{AB},\vec{AC}\right)$\\
...
\begin{ex}
	...
	\loigiai{
	Trả lời: $120$.\\
	Ta có $6\sqrt{3}=| \vec{a}+2\vec{b}|\Leftrightarrow {{\left(6\sqrt{3}\right)}^2}={{| \vec{a}+2\vec{b}|}^2}={{\left(\vec{a}+2\vec{b}\right)}^2}$\\
