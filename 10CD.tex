...
\def\chamngon{\lq\lq  Failure is not the opposite of success. It is a part of success.\rq\rq\\ -- Arianna Huffington --
}
\def\QRde{10CK2}
%%%%%%%%%%%%% Đn lại A.B.C.D
\khoanhtrondapan
...
% 		\includegraphics[width=5cm]{QRcode/10H3.png} \\
% 		\indam{CHƯƠNG II} & \indam{CHƯƠNG III}
%  \end{tabular}
% \end{center}
