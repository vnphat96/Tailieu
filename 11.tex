...
\def\tenchude{GTLG - HSLG}
\def\tendethi{KIỂM TRA CHƯƠNG I}
\def\tentruong{LỚP TOÁN THẦY PHÁT}
\def\thoigian{Mỗi một ngày trôi qua là một cơ hội để bạn trở nên tốt hơn}
%%%%%%%%%%%%% Nội dung head & foot
% \def\diachi{ }
\def\diachi{VNPmath - 0962940819}
\def\tenchuyende{\tenchude}
\def\tentacgia{GV.VŨ NGỌC PHÁT}
\def\chamngon{\lq\lq  Mỗi một ngày trôi qua là một cơ hội để bạn trở nên tốt hơn\rq\rq
}
% \tatsode
\batsode
%%%%%%%%%%%%% Đn lại A.B.C.D
...
\input{input11.tex}
% \begin{center}
% 	\includegraphics[width=5cm]{QRcode/11D1XOTC} 
% \end{center}

% %--------Lời giải chi tiết
\FULLWIDTH \hienLG \hienDA 
\setcounter{deso}{0}
\chap{LỜI GIẢI CHI TIẾT}
\setcounter{subsection}{0} \setcounter{ex}{0} \setcounter{dang}{0}
% \def\tenchude{GIỚI HẠN DÃY SỐ - GIỚI HẠN HÀM SỐ - HÀM SỐ LIÊN TỤC}
