...
\begin{ex}%[Trương Hữu Đăng]%[1H3K5-3]
	...
	\loigiai{
		...
		}
		{
			...
			\end{tikzpicture}
		}Phương trình mặt phẳng $(SCD)$ đi qua $D$ và có vectơ pháp tuyến $\vec{n}=\left[\vec{CD},\vec{CS}\right]=(\sqrt{3};\sqrt{3};2)$: $\sqrt{3}x+\sqrt{3}y+2z-2\sqrt{3}=0$.\\
...
\begin{ex}%[Trương Hữu Đăng]%[1H3K5-3]
	...
	{ $100$}
	{$5$}
	\loigiai{\immini[thm]{Theo tính chất của hình lập phương thì $AB\perp \left(ADD'A'\right)$ và $AB\perp \left(BCC'B'\right)$. \\
...
\begin{ex}%[Trương Hữu Đăng]%[1H3K5-3]
	...
	\loigiai{
		\immini[thm]{Vì $CS=CA$ nên $\triangle SCA$ là tam giác vuông tại $C$; tương tự $\triangle SBA$ là tam giác vuông tại $B$. \\
...
\begin{ex}%[Trương Hữu Đăng]%[1H3K5-3]
	...
	{$\dfrac{a\sqrt{3}}{7}$}
	\loigiai{
		\immini[thm]{Gọi $H$ là trung điểm của $AB$. Vì $\triangle SAB$ đều và vuông góc với đáy nên $SH$ là đường cao của hình chóp.\\
...
\begin{ex}%[Trương Hữu Đăng]%[1H3K5-3]
	...
	{ $\dfrac{22a}{\sqrt{15}}$}
	\loigiai{
		\immini[thm]{ Ta có $BC\perp AB$ và $BC\perp SA$ nên $BC\perp (SAB)$ hay hình chiếu của $C$ lên $(SAB)$ là điểm $B$ nên $\widehat{\left( SC,(SAB)\right)}=\widehat{(SC,SB)}=\widehat{BSC}=30^{\circ}$. Suy ra $SB=\dfrac{BC}{\tan30^{\circ} }=2a\sqrt{3}$ và $SA=\sqrt{SB^2-AB^2}=a\sqrt{11}$.\\
...
\begin{ex}%[Trương Hữu Đăng]%[1H3K5-3]
	...
	{\True $\dfrac{a\sqrt{21}}{7}$}
	{$\dfrac{a\sqrt{3}}{4}$}
	\loigiai{\immini[thm]{Gọi $N$ là trung điểm $BC$ $\Rightarrow AN\perp BC\Rightarrow BC\perp(A'AN)$.\\
...
\begin{ex}%[Trương Hữu Đăng]%[1H3K5-3]
	...
	{$ \dfrac{a}{2}$}
	{$ \dfrac{3a}{2}$}
	\loigiai{\immini[thm]{Gọi $ H $ là tâm của tam giác đều $ ABC $. Gọi $ M=AH \cap BC $ suy ra $ M $ là trung điểm cạnh $ BC $. Do đó, góc $ \widehat{SMH}=60^{\circ} $.\\
...
\begin{ex}%[Trương Hữu Đăng]%[1H3K5-3]
	...
	\loigiai{\immini[thm]{Tam giác $A'AB$ vuông tại $A$ nên $A'B=\sqrt{A'A^2+AB^2}=a\sqrt{5}$.\\
