...
\begin{khung}
	\subsubsection{PTĐT}
	\begin{itemize}
		\item Đường thẳng $d$ đi qua điểm $M(x_0;y_0;z_0)$ và có vectơ chỉ phương (VTCP) $\vec{u}_d=(a_1;a_2;a_3)$ có PTTS $\heva{&x=x_0+a_1t\\&y=y_0+a_2t\\&z=z_0+a_3t},\, ( t\in \mathbb{R})$.
...
\begin{ex}%[Phạm Hoài, PT-ĐMH2023]%[2H3Y3-3]%Câu 3
	Trong KG $Oxyz$, cho đường thẳng $d\colon \dfrac{x+1}{2}=\dfrac{y-1}{3}=\dfrac{z+3}{-2}$. Điểm nào dưới đây thuộc $d$?
	\choice
	{$ N(2;3;-2)$}
	{$ M(1;1;-3)$}
	{$ Q(3;2;-2)$}
	{\True $ P(-1;1;-3)$}
	\loigiai{
		Đường thẳng $d$ đi qua điểm $ M(x_0;y_0;z_0)$ nhận vectơ chỉ phương $\overrightarrow{u}=(u_1;u_2;u_3)$ có phương trình\\
...
\begin{ex}%[Phạm Hoài, PT-ĐMH2023]%[2H3Y3-3]%Câu 4
	Trong KG $Oxyz$ , điểm nào dưới đây thuộc đường thằng $d\colon \dfrac{x+2}{1}=\dfrac{y-1}{1}=\dfrac{z+2}{2}$ ?
	\choice
	{$P\left(1;1;2\right)$}
	{$N\left(2;-1;2\right)$}
...
\begin{ex}%[Phạm Hoài, PT-ĐMH2023]%[2H3Y3-3]%Câu 5
	...
	{\True $P(0;2;-8)$}
	\loigiai{
		Lần lượt thay tọa độ các điểm vào PTĐT 
		\begin{itemize}
...
\begin{ex}%[Phạm Hoài, PT-ĐMH2023]%[2H3Y3-3]%Câu 6
	...
	{$M\left(5;4;-7\right)$}
	\loigiai{
		Thay tọa độ các điểm $ M$ trong bốn đáp án A, B, C, D vào PTĐT $\Delta $ ta thấy điểm $M\left(-5;11;-15\right)$ thỏa mãn. Vậy đường thẳng $\Delta $ đi qua điểm $M\left(-5;11;-15\right)$.}
\end{ex}
...
\begin{ex}%[Phạm Hoài, PT-ĐMH2023]%[2H3Y3-3]%Câu 8
	...
	{$M\left(8;,9;10\right)$}
	\loigiai{
		Thay $ t=0$ vào PTĐT $d$ ta được $\heva{
			& x=2\\ 
			& y=-1\\ 
			& z=0.}$\\
...
\begin{ex}%[Phạm Hoài, PT-ĐMH2023]%[2H3Y3-3]%Câu 9
	Trong KG $Oxyz$ , điểm nào sau đây không nằm trên đường thẳng $\Delta \colon \dfrac{x-1}{2}=\dfrac{y+1}{1}=\dfrac{z}{3}$?
	\choice
	{$ M\left(1;-1;0\right)$}
	{$ N\left(3;0;3\right)$}
	{$ P\left(-3;-3;-6\right)$}
	...
	\loigiai{
		Thay tọa độ $ M$ vào PTĐT $\Delta $ ta được $ 0=0=0$ (đúng). Suy ra $M\in\Delta $.\\
		Thay tọa độ $ N$ vào PTĐT $\Delta $ ta được $ 1=1=1$ (đúng). Suy ra $ N\in\Delta $.\\
		Thay tọa độ $ P$ vào PTĐT $\Delta $ ta được $-2=-2=-2$ (đúng). Suy ra $P\in\Delta $.\\
		Thay tọa độ $ Q$ vào PTĐT $\Delta $ ta được $ 2=2=\dfrac{5}{3}$ (Vô lý)\\
		$\Rightarrow Q\notin\Delta $.}
\end{ex}

\begin{ex}%[Phạm Hoài, PT-ĐMH2023]%[2H3Y3-3]%Câu 10
	Trong KG $Oxyz$ , cho đường thẳng $(d) \colon \heva{& x=1-t\\ 
		& y=2t\\ 
	...
	{$ Q\left(-1;2;1\right)$}
	\loigiai{
		Thay lần lượt tọa độ các điểm vào PTĐT $(d)$, ta thấy chỉ có đáp án $ N\left(0;2;3\right)$ thỏa mãn.}
\end{ex}

\begin{ex}%[Phạm Hoài, PT-ĐMH2023]%[2H3Y3-3]%Câu 11
	Trong KG $Oxyz$, điểm nào dưới đây thuộc đường thẳng $ d\colon\dfrac{x-2}{-3}=\dfrac{y+1}{2}=\dfrac{z+3}{1}$?
	\choice
	{$\left(3;-2 ; 1\right)$}
...
\begin{ex}%[Phạm Hoài, PT-ĐMH2023]%[2H3Y3-3]%Câu 13
	...
	{\True $P(-1;2;1)$}
	\loigiai{
		Theo PTĐT, đường thẳng $ d$ đi qua điểm $ P(-1;2;1)$.}
\end{ex}
...
\begin{ex}%[Phạm Hoài, PT-ĐMH2023]%[2H3Y3-3]%Câu 14
	...
	{$ N\left(-1\,;5\,;4\right)$}
	\loigiai{
		Thay tọa độ $4$ điểm $ M$, $N$, $P$, $Q$ vào PTĐT $ d$ ta có:\\
		\begin{itemize}
			\item $\heva{
				& 1=1+2t\\ 
				& 2=2-3t\\ 
...
\begin{ex}%[Phạm Hoài, PT-ĐMH2023]%[2H3Y3-3]%Câu 18
	...
	\loigiai{
		\begin{itemize}
			\item \textbf{Cách 1.}
			Nếu $d$ qua $M\left(x_0;y_0;z_0\right)$ , có vectơ chỉ phương $\overrightarrow{u}\left(a;b;c\right)$ thì PTĐT $d$ là\\
			 $\heva{
				& x=x_0+at\\ 
				& y=y_0+bt\\ 
				& z=z_0+ct}$ , ta chọn đáp án $N\left(1;5;2\right)$.
			\item \textbf{Cách 2.} Thay tọa độ các điểm vào PTĐT $d$ , ta có\\
			$\heva{
				& 1=1-t\\ 
				& 2=5+t\\ 
			...
			Thay tọa độ điểm $N$ vào PTĐT $d$ , ta có $\heva{
				& 1=1-t\\ 
				& 5=5+t\\ 
...
\begin{ex}%[Phạm Hoài, PT-ĐMH2023]%[2H3Y3-3]%Câu 18
	...
	{$ N\left(2;5;-3\right)$}
	\loigiai{
		Thay lần lượt các tọa độ trên vào PTĐT $ d$, ta thấy $Q\left(-3;-2;1\right)$ là điểm không thuộc $ d$.}
\end{ex}
...
\begin{ex}%[Phạm Hoài, PT-ĐMH2023]%[2H3Y3-3]%Câu 19
	...
	\loigiai{
		Thay $\heva{& x=3\\ 
			& y=1\\ 
			& z=3}$ vào PTĐT $ d$ ta được $\dfrac{2}{2}=\dfrac{1}{1}=\dfrac{3}{3}$ (đúng).}
\end{ex}
...
\begin{ex}%[Phạm Hoài, PT-ĐMH2023]%[2H3Y3-3]%Câu 20
	...
	\loigiai{
		...
		Thay tọa độ các điểm vào PTĐT $d$
	...
	\begin{ex}%[Phạm Hoài, PT-ĐMH2023]%[2H3Y3-3]%Câu 21
		...
		\loigiai{
			...
			Thay tọa độ điểm $ N\left(-1;5;-5\right)$ vào PTĐT $ d$ ta có\\ $\dfrac{-1+2}{1}=\dfrac{5-3}{2}=\dfrac{-5}{-5}=1$. \\
			Suy ra điểm $ N$ thuộc đường thẳng $ d$.\\
			Thay tọa độ điểm $ P\left(3;1;5\right)$ vào PTĐT $ d$ ta có\\ $\dfrac{3+2}{1}\ne\dfrac{1-3}{2}$.\\
	...
	\begin{ex}%[Phạm Hoài, PT-ĐMH2023]%[2H3Y3-3]%Câu 22
		...
		{\True $M(3;3;-6)$}
		\loigiai{
			Thay tọa độ của lần lượt các điểm đã cho vào PTĐT $ d$ chỉ thấy tọa độ của điểm $ M$ thỏa mãn.}
	\end{ex}
	...
	\begin{ex}%[Phạm Hoài, PT-ĐMH2023]%Câu 23
		...
		{$ E(2;-2;3)$}
		\loigiai{
			Thay tọa độ các điểm $ E,N,F$ vào PTĐT $ d$ ta thấy thỏa mãn nên $ E,N,F$ thuộc $ d.$\\
			Thay tọa độ các điểm $ M$vào PTĐT $ d$ ta thấy không thỏa mãn nên $ M$ không thuộc $ d.$}
	\end{ex}
	...
	\begin{ex}%[Phạm Hoài, PT-ĐMH2023]%[2H3Y3-3]%Câu 24
		...
		{$M\left(3;\,-2;\,-4\right)$}
		\loigiai{
			Thay lần lượt tọa độ các điểm vào PTĐT $d$ ta thấy tọa độ của $Q$ không thỏa mãn phương trình $\left(\dfrac{-3-1}{2}=\dfrac{1+1}{-1}\ne\dfrac{-2+2}{-2}\right)$. \\Vậy điểm $Q$ không thuộc đường thẳng $d$ .}
	\end{ex}
	...
	\begin{ex}%[Phạm Hoài, PT-ĐMH2023]%[2H3Y3-3]%Câu 25
		...
		{$M\left(-2;1;4\right)$}
	\loigiai{
		Vì khi thay điểm $Q(2;-5;4)$ vào PTĐT $d$ ta được\\
