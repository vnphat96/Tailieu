...
\begin{khung}
	\begin{vd}[Đề tham khảo BGD 2023]%[2D1Y5-3]
		\immini[thm]{Cho hàm số $f(x) = \dfrac{ax+b}{cx+d}$ có đồ thị là đường cong trong hình bên. Tọa độ giao điểm của đồ thị hàm số với trục hoành là
			\choice
...
\begin{ex} %[2D1B5-3]
\immini[thm]{Cho hàm số $f(x) = \dfrac{ax+b}{cx+d}$ có đồ thị như hình bên. Tìm tọa độ giao điểm của đồ thị hàm số bên với đường thẳng $y =-1$.
	\choice
