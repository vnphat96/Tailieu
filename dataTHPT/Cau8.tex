...
\loigiai{
\begin{center}
	$\displaystyle\int\limits_0^1\left[3f(x)-2g(x)\right]\mathrm{d}x=3\displaystyle\int\limits_0^1f(x)\text{d}x-2\displaystyle\int\limits_0^1g(x)\mathrm{d}x=3\cdot2-2\cdot5=-4$.
\end{center}
}
\end{ex}
...
Vậy $\displaystyle\int\limits_{-2}^1f(x)\mathrm{d}x=\displaystyle\int\limits_{-2}^3f(x)\text{d}x-\displaystyle\int\limits_1^3f(x)\mathrm{d}x=-4-2=-6$.
}
\end{ex}
