...
\begin{ex}%[2H3Y2-5]
	...
	{$120^{\circ}$}
	\loigiai{
		$\overrightarrow{n}_{P}=(1;-2;-1)$ là một vectơ pháp tuyến của $(P)$.\\
		$\overrightarrow{n}_{Q}=(1;1;2)$ là một vectơ pháp tuyến của $(Q)$.\\
...
%%==========Câu 2
\begin{ex}%[2H3Y2-5]
	Trong KG $Oxyz$, cho mặt phẳng $(P)\colon x-z-3=0$. Tính góc giữa $(P)$ và mặt phẳng $(Oxy)$.
	\choice
	{\True $45^{\circ}$}
	{$90^{\circ}$}
	{$30^{\circ}$}
	{$60^{\circ}$}
	\loigiai{
		Mặt phẳng $(P)$ có vectơ pháp tuyến $\overrightarrow{n}_{1}=(1; 0;-1)$, mặt phẳng $(Oxy)$ có vectơ pháp tuyến $\overrightarrow{n}_{2}=(0; 0; 1)$.\\
...
%%==========Câu 3
\begin{ex}%[2H3Y2-5]
	Trong KG $Oxyz$, biết hình chiếu của $O$ lên mặt phẳng $(P)$ là $H(2;-1;-2)$. Số đo góc giữa mặt phẳng $(P)$ với mặt phẳng $(Q)\colon x-y-5=0$ là
	\choice
	{$90^{\circ}$}
	{$60^{\circ}$}
	{\True $45^{\circ}$}
	...
	\loigiai{
		...
		Ta có $\overrightarrow{OH}=(2;-1;-2)$ là một vectơ pháp tuyến của mặt phẳng $(P)$, $\overrightarrow{n}=(1;-1;0)$ là một vectơ pháp tuyến của mặt phẳng $(Q)$.\\
		Khi đó
...
\begin{ex}%[2H3Y2-5]
	...
	{$90^{\circ}$}
	\loigiai{
		Mặt phẳng $(P)$ có một vectơ pháp tuyến $\overrightarrow{n}=(1;-1;0)$.\\
...
%%==========Câu 5
\begin{ex}%[2H3Y2-5]
	Trong KG $Oxyz$, góc giữa mặt phẳng $(\alpha)\colon\sqrt{2}x+y+z-5=0$ và mặt phẳng $(Oxy)$ là
	\choice
	{$90^{\circ}$}
	{$30^{\circ}$}
	{$45^{\circ}$}
...
%%==========Câu 6
\begin{ex}%[2H3Y2-5]
	Trong KG $Oxyz$, cho điểm $H(2;-1;-2)$ là hình chiếu vuông góc của gốc tọa độ $O$ xuống mặt phẳng $(P)$, số đo góc giữa mặt $(P)$ và mặt phẳng $(Q)\colon x-y-11=0$ bằng bao nhiêu?
	\choice
	{$90^{\circ}$}
	{$60^{\circ}$}
	{\True $45^{\circ}$}
...
%%==========Câu 7
\begin{ex}%[2H3Y2-5]
	Trong KG $Oxyz$, cho hai mặt phẳng $(P)\colon x-2y-z+2=0$ và $(Q)\colon 2x-y+z+1=0$. Góc giữa $(P)$ và $(Q)$ là
	\choice
	{$120^{\circ}$}
	{$90^{\circ}$}
	{$30^{\circ}$}
	{\True $60^{\circ}$}
	\loigiai{
		$(P)\colon x-2y-z+2=0$ có vectơ pháp tuyến là $\overrightarrow{n}_{1}=(1;-2;-1)$.\\
		$(Q)\colon 2x-y+z+1=0$ có vectơ pháp tuyến là $\overrightarrow{n}_{2}=(2;-1; 1)$.\\
		Áp dụng công thức
...
%%==========Câu 8
\begin{ex}%[2H3B2-5]
	Trong KG $Oxyz$, cho hai mặt phẳng $(P)\colon x+(m+1)y-2z+m=0$ và $(Q)\colon 2x-y+3=0$, với $m$ là tham số thực. Để $(P)$ vuông góc với $(Q)$ thì giá trị của $m$ bằng bao nhiêu?
	\choice
	{$m=3$}
	{$m=-1$}
	{$m=-5$}
	{\True $m=1$}
	\loigiai{
		Mặt phẳng $(P)$ có vectơ pháp tuyến $\overrightarrow{n}_{1}=(1; m+1;-2)$, mặt phẳng $(Q)$ có vectơ pháp tuyến $\overrightarrow{n}_{2}=(2;-1;0)$.\\
...
%%==========Câu 9
\begin{ex}%[2H3B2-5]
	Trong KG $Oxyz$, cho mặt phẳng $(P)$ đi qua các điểm $A(-2;0;0)$, $B(0;3;0)$, $C(0;0;-3)$. Mặt phẳng $(P)$ vuông góc với mặt phẳng nào trong các mặt phẳng sau?
	\choice
	{$3x-2y+2z+6=0$}
	{$x-2y-z-3=0$}
	{\True $2x+2y-z-1=0$}
	...
	\loigiai{
		...
		\begin{itemize}
			...
			\item Mặt phẳng $x-2y-z-3=0$ có vectơ pháp tuyến $\overrightarrow{n}_1=(1;-2;-1)$. Ta có $\overrightarrow{n}_{(P)}\cdot \overrightarrow{n}_1=5 \neq 0$ nên loại $x-2y-z-3=0$.
			\item Mặt phẳng $2x+2y-z-1=0$ có vectơ pháp tuyến $\overrightarrow{n}_2=(2;2;-1)$. Ta có $\overrightarrow{n}_{(P)}\cdot \overrightarrow{n}_2=0$ nên chọn $2x+2y-z-1=0$.
			\item Mặt phẳng $x+y+z+1=0$ có vectơ pháp tuyến $\overrightarrow{n}_3=(1;1;1)$. Ta có $\overrightarrow{n}_{(P)}\cdot \overrightarrow{n}_3=3 \neq 0$ nên loại $x+y+z+1=0$.
		\end{itemize}
	}
\end{ex}
...
%%==========Câu 10
\begin{ex}%[2H3B2-5]
	Trong KG $Oxyz$, cho mặt phẳng $x-my+z-1=0\;(m \in \mathbb{R})$, mặt phẳng $(Q)$ chứa trục $Ox$ và qua điểm $A(1;-3;1)$. Tìm số thực $m$ để hai mặt phẳng $(P)$, $(Q)$ vuông góc.
	\choice
	{$m=-\dfrac{1}{3}$}
	{$m=\dfrac{1}{3}$}
	{\True $m=3$}
	...
	\loigiai{
		...
		Mặt phẳng $(Q)$ qua điểm $A(1;-3;1)$ và chứa trục $Ox$ suy ra $(Q)$ có vectơ pháp tuyến\\ $\overrightarrow{n}_{Q}=\left[\overrightarrow{OA}, \vec{i}\right]=(0;1;3)$.\\
		Mặt phẳng $(P)$ có vectơ pháp tuyến $\overrightarrow{n}_{P}=(1;-m;1)$.
...
\begin{ex}%[2H3B2-5]
	Trong KG $Oxyz$, cho mặt phẳng $(P)\colon x+2y-2z+3=0$, mặt phẳng $(Q)\colon x-3y+5z-2=0$. Cô-sin của góc giữa hai mặt phẳng $(P)$, $(Q)$ là
	\choice
	{$-\dfrac{5}{7}$}
	{$-\dfrac{\sqrt{35}}{7}$}
	{$\dfrac{5}{7}$}
	...
	\loigiai{
		Ta có vectơ pháp tuyến của mặt phẳng $(P)$ là $\overrightarrow{n}_{(P)}=(1;2;-2)$, vectơ pháp tuyến của mặt phẳng $(Q)$ là $\overrightarrow{n}_{Q}=(1;-3;5)$.\\
...
\begin{ex}%[2H3B2-5]
	Trong KG $Oxyz$, gọi $\alpha$ là góc giữa hai mặt phẳng $(P)\colon x-\sqrt{3}y+2z+1=0$ và mặt phẳng $(Oxy)$. Khẳng định nào sau đây đúng?
	\choice
	{$\alpha=30^{\circ}$}
	{$\alpha=60^{\circ}$}
	{$\alpha=90^{\circ}$}
	{\True $\alpha=45^{\circ}$}
	\loigiai{
		Mặt phẳng $(P)$ có một vectơ pháp tuyến là $\overrightarrow{n}_{(P)}=\left(1;-\sqrt{3};2\right)$.\\
		Mặt phẳng $(Oxy)\colon z=0$ có một vectơ pháp tuyến là $\overrightarrow{n}=(0;0;1)$.\\
...
\begin{ex}%[2H3B2-5]
	...
	\loigiai{
		Ta có $(P)\colon\dfrac{x-2}{3}+\dfrac{y-1}{2}+\dfrac{z-4}{-6}=1 \Leftrightarrow (P)\colon 2x+3y-z-9=0$ suy ra $(P)$ có một vectơ pháp tuyến là $\overrightarrow{n}_{(P)}=(2;3;-1)$.\\
		$(Q)\colon x+2y+3z+7=0 \Rightarrow (Q)$ có một vectơ pháp tuyến là $\overrightarrow{n}_{(Q)}=(1;2;3)$.\\
...
\begin{ex}%[2H3B2-5]
	Trong KG $Oxyz$, cho mặt phẳng $(P)\colon x-2y+2z-5=0$. Xét mặt phẳng
	...
	{$\hoac{&m=4\\&m=\sqrt{2}}$}
	\loigiai{
		Mặt phẳng $(P)$, $(Q)$ có vectơ pháp tuyến lần lượt là $\overrightarrow{n}_{(P)}=(1;-2;2)$, $\overrightarrow{n}_{(Q)}=(1;0;2m-1)$. Vì $(P)$ tạo với $(Q)$ góc $\dfrac{\pi}{4}$ nên
		\begin{eqnarray*}
...
\begin{ex}%[2H3B2-7]
	Trong KG $Oxyz$, cho hai mặt phẳng $(\alpha)\colon x+y+z-1=0$ và \linebreak $(\beta)\colon 2x-y+mz-m+1=0$, với $m$ là tham số thực. Giá trị của $m$ để $(\alpha)\perp(\beta)$ là
	\choice
	{$1$}
	{$-4$}
	{\True $-1$}
	{$0$}
	\loigiai{
		Mặt phẳng $(\alpha)$ có vectơ pháp tuyến $\overrightarrow{n}_(\alpha)=(1;1;1)$ và $(\beta)$ có vectơ pháp tuyến $\overrightarrow{n}_(\beta)=(2;-1;m)$.\\
...
\begin{ex}%[2H3B2-5]
	Trong KG $Oxyz$, cho mặt phẳng $(\alpha)\colon 2x-y+z-3=0$ và $(\beta)\colon 3x-4y+5z=0$. Góc tạo bởi hai mặt phẳng $(\alpha)$ và $(\beta)$ bằng
	\choice
	{$90^{\circ}$}
	{\True $30^{\circ}$}
	{$60^{\circ}$}
...
\begin{ex}%[2H3B2-5]
	Trong KG $Oxyz$, cho hai mặt phẳng $(P)$ và $(Q)$ lần lượt có hai vectơ pháp tuyến là $\overrightarrow{n}_{(P)}$ và $\overrightarrow{n}_{(Q)}$. Biết góc giữa hai vectơ $\overrightarrow{n}_{(P)}$ và $\overrightarrow{n}_{(Q)}$ bằng $30^{\circ}$. Góc giữa hai măt phẳng $(P)$ và $(Q)$ bằng
	\choice
	{\True $30^{\circ}$}
	{$45^{\circ}$}
	{$60^{\circ}$}
...
\begin{ex}%[2H3B2-5]
	Trong KG $Oxyz$, cho hai mặt phẳng $(P)$ và $(Q)$ lần lượt có hai vectơ pháp tuyến là $\overrightarrow{n}_{(P)}$ và $\overrightarrow{n}_{(Q)}$. Biết góc giữa hai vectơ $\overrightarrow{n}_{(P)}$ và $\overrightarrow{n}_{(Q)}$ bằng $120^{\circ}$. Góc giữa hai mặt phẳng $(P)$ và $(Q)$ bằng
	\choice
	{$30^{\circ}$}
	{$45^{\circ}$}
	{\True $60^{\circ}$}
...
\begin{ex}%[2H3B2-5]
	Trong KG $Oxyz$, cho hai mặt phẳng $(P)$ và $(Q)$ lần lượt có hai vectơ pháp tuyến là $\overrightarrow{n}_{(P)}$ và $\overrightarrow{n}_{(Q)}$. Biết cô-sin góc giữa hai vectơ $\overrightarrow{n}_{(P)}$ và $\overrightarrow{n}_{(Q)}$ bằng $\dfrac{1}{2}$. Góc giữa hai mặt phẳng $(P)$ và $(Q)$ bằng
	\choice
	{$30^{\circ}$}
	{$45^{\circ}$}
	{\True $60^{\circ}$}
