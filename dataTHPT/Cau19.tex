...
%Câu 8
\begin{ex}%[2D1Y2-2]
	\immini[thm]{Cho hàm số bậc bốn $y=f(x)$ liên tục trên $\mathbb{R}$ và có đồ thị là đường cong như hình vẽ bên. Tìm điểm cực tiểu của đồ thị hàm số $y=f(x)$.
		\choicew{.6\textwidth}
		\choice
		{$x=0$}
		{$y=-2$}
...
%Câu 13
\begin{ex}%[2D1B2-2]
	\immini[thm]{ Cho hàm số $y=f(x)$ có đạo hàm trên $\mathbb{R}$. Biết rằng hàm số $y=f'(x)$ có đồ thị như hình bên.
...
%Câu 17
\begin{ex}%[2D1K2-2]
	\immini[thm]{ Cho hàm số bậc năm $y=f(x)$ liên tục trên $\mathbb{R}$, hàm số $y=f'(x)$ có đồ thị như hình vẽ. Hàm số $y=f(x)+\dfrac{2017-2018x}{2017}$ có số điểm cực trị là
		\choice
		{$3$}
		{$2$}
		{$1$}
...
%Câu 21
\begin{ex}%[2D1K2-2]
	\immini[thm]{Cho hàm số bậc bốn $y=f(x)$ có đồ thị như hình vẽ bên. Hỏi đồ thị hàm số $y=\left|f(x)\right|$ có bao
		nhiêu điểm cực trị?
		\choice
		{\True $5$}
		{$3$}
