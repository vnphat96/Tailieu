...
\immini[thm]{Cho hàm số bậc ba $y=f(x)$ có đồ thị là đường cong trong hình bên. Giá trị cực đại của hàm số đã cho là
\choice
{$-1$}
{\True $3$}
{$2$}
{$0$}}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round,>=stealth,x=0.6cm,y=0.6cm]
\def \xmin{-1.7};
\def \xmax{3.7};
\def \ymin{-1.5};
\def \ymax{4.1};
...
\immini[thm]{Cho hàm số $f(x)=ax^3+bx^2+cx+d$  có đồ thị như hình vẽ bên.
Mệnh đề nào sau đây {\bf sai}?
\choice
{Hàm số đạt cực đại tại $x=0$}
{Hàm số đạt cực tiểu tại $x=2$}
{\True Hàm số đạt cực đại tại $x=4$}
{Hàm số có hai điểm cực trị}}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round,>=stealth,x=0.6cm,y=0.6cm]
\def \xmin{-1.7};
\def \xmax{3.7};
\def \ymin{-1.5};
\def \ymax{4.7};
...
\begin{ex}%[Cau27-GV14]%[2D1Y2-2]
\immini[thm]{Cho hàm số $y=f(x)$ liên tục trên $\mathbb{R}$ và có đồ thị như hình bên. Hỏi hàm số có bao nhiêu điểm cực trị?
\choice
{$2$}
{$3$}
{$4$}
{\True $5$}}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round,>=stealth,x=0.6cm,y=0.6cm]
\def \xmin{-3.1};
\def \xmax{3.1};
\def \ymin{-0.7};
\def \ymax{3.5};
...
\begin{ex}%[Cau27-GV14]%[2D1Y2-2]
\immini[thm]{Cho hàm số $y=ax^3+bx^2+cx+d$ có đồ thị như hình vẽ bên. Hàm số đã cho có bao nhiêu điểm cực trị?
\choice
{\True $2$}
{$1$}
{$3$}
{$4$}}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round,>=stealth,x=0.6cm,y=0.6cm]
\def \xmin{-1.7};
\def \xmax{5.3};
\def \ymin{-1.5};
\def \ymax{2.0};
...
\begin{ex}%[Cau27-GV14]%[2D1Y2-2]
\immini[thm]{Cho hàm số $y=f(x)$ có đồ thị như hình vẽ bên. Tìm điểm cực đại của hàm số.
\choice
{$y=-2$}
{\True $x=-1$}
{$x=1$}
{$y=2$}}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round,>=stealth,x=0.6cm,y=0.6cm]
\def \xmin{-2.5};
\def \xmax{2.7};
\def \ymin{-2.5};
\def \ymax{3.0};
...
\immini[thm]{Cho hàm số $y=f(x)$. Đồ thị hàm số $y=f'(x)$ như hình bên. Tìm mệnh đề đúng.
\choice
{Hàm số $y=f(x)$ nghịch biến trên khoảng $(0;2)$}
{Hàm số $y=f(x)$ có hai cực trị}
{Hàm số $y=f(x)$ đạt cực tiểu tại $x=2$}
{\True Hàm số $y=f(x)$ chỉ có một cực trị}}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round,>=stealth,x=0.6cm,y=0.6cm]
\def \xmin{-1.7};
\def \xmax{3.7};
\def \ymin{-1.5};
\def \ymax{4.7};
...
\begin{ex}%[Cau27-GV14]%[2D1Y2-2]
\immini[thm]{Cho hàm số $f(x)$ xác định, liên tục trên tập số thực $\mathbb{R}$ và có đồ thị như hình bên. Hàm số $y=f(x)$
đạt cực tiểu tại điểm nào dưới đây?
\choice
{$x=0$}
{$x=-2$ và $x=0$}
{\True $x=-2$}
{$x=1$}}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round,>=stealth,x=0.6cm,y=0.6cm]
\def \xmin{-3.2};
\def \xmax{1.7};
\def \ymin{-2.5};
\def \ymax{3.1};
...
\begin{ex}%[Cau27-GV14]%[2D1Y2-2]
\immini[thm]{Tìm điểm cực tiểu của hàm số $y=f(x)$, biết hàm số $y=f(x)$ có đồ thị như hình vẽ.
\choice
{$x=0$}
{$x=-2$}
{$x=1$}
{\True $x=2$}}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round,>=stealth,x=0.6cm,y=0.6cm]
\def \xmin{-1.7};
\def \xmax{3.2};
\def \ymin{-2.5};
\def \ymax{3.1};
...
\begin{ex}%[Cau27-GV14]%[2D1Y2-2]
\immini[thm]{Cho hàm đa thức bậc ba $y=f(x)$ có đồ thị như hình vẽ bên. Biết hàm số $f(x)$ có các điểm cực trị là $x_1$, $x_2$. Tích $x_1x_2$ bằng
\choice
{$4$}
{\True $0$}
{$-4$}
{$-2$}}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round,>=stealth,x=0.6cm,y=0.6cm]
\def \xmin{-1.7};
\def \xmax{3.2};
\def \ymin{-2.5};
\def \ymax{3.1};
...
\begin{ex}%[Cau27-GV14]%[2D1Y2-2]
\immini[thm]{Cho đồ thị hàm số như hình vẽ bên. Giá trị cực đại của hàm số là
\choice
{\True $1$}
{$4$}
{$-1$}
{$-3$}}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round,>=stealth,x=0.6cm,y=0.6cm]
\def \xmin{-2.5};
\def \xmax{2.7};
\def \ymin{-3.5};
\def \ymax{2.0};
...
\begin{ex}%[Cau27-GV14]%[2D1Y2-2]
\immini[thm]{Cho hàm số $y=f(x)$ có đồ thị như hình vẽ bên. Mệnh đề nào dưới đây đúng?
\choice
{Giá trị cực đại của hàm số là $0$}
{\True Giá trị cực tiểu của hàm số bằng $-1$}
{Điểm cực tiểu của hàm số là $-1$}
{Điểm cực đại của hàm số là $3$}}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round,>=stealth,x=0.6cm,y=0.6cm]
\def \xmin{-1.5};
\def \xmax{3.2};
\def \ymin{-1.5};
\def \ymax{3.7};
...
\begin{ex}%[Cau27-GV14]%[2D1Y2-2]
\immini[thm]{Cho hàm số $y=ax^4+bx^2+c$, $(a\neq 0)$ có đồ thị như hình vẽ bên. Số điểm cực đại của hàm số là
\choice
{$3$}
{$4$}
{$1$}
{\True $2$}}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round,>=stealth,x=0.6cm,y=0.6cm]
\def \xmin{-2.5};
\def \xmax{2.7};
\def \ymin{-1.5};
\def \ymax{3.5};
...
\begin{ex}%[Cau27-GV14]%[2D1Y2-2]
\immini[thm]{Cho hàm số $y=f(x)$ có đồ thị như hình bên. Giá trị cực đại của hàm số bằng
\choice
{$1$}
{\True $3$}
{$2$}
{$-1$}}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round,>=stealth,x=0.6cm,y=0.6cm]
\def \xmin{-2.5};
\def \xmax{2.7};
\def \ymin{-1.5};
\def \ymax{3.5};
...
\begin{ex}%[Cau27-GV14]%[2D1Y2-2]
\immini[thm]{Cho hàm số có đồ thị như hình vẽ bên. Số điểm cực trị của hàm số đã cho là
\choice
{$1$}
{$2$}
{\True $3$}
...
\begin{ex}%[2D1Y2-2]
\immini[thm]{Cho hàm số $y=f(x)$ có đồ thị như hình vẽ sau. Khẳng định nào sau đây đúng?
\choice
{Hàm số có hai điểm cực trị âm và một điểm cực trị dương}
{\True Hàm số có hai điểm cực trị dương và một điểm cực trị âm}
{Hàm số đạt cực tiểu tại $x=-2$}
{Hàm số đat cưc đại tại $x=0$}}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round,>=stealth,x=0.6cm,y=0.6cm]
\def \xmin{-2.1};
\def \xmax{3.7};
\def \ymin{-1.9};
\def \ymax{3.5};
...
\begin{ex}%[Cau27-GV14]%[2D1Y2-2]
\immini[thm]{Cho hàm số bậc bốn $y=f(x)$ có đồ thị hàm số như hình bên. Số điểm cực tiểu của hàm số đã cho là
\choice
{\True $2$}
{$1$}
{$3$}
...
\begin{ex}%[Cau27-GV14]%[2D1Y2-2]
\immini[thm]{Cho hàm số $y=ax^3+bx^2+cx+d$ $(a,b,c,d \in \mathbb{R})$, có đồ thị như hình vẽ bên. Số điểm cực trị của hàm số đã cho là
\choice
{\True $2$}
{$0$}
{$3$}
...
\begin{ex}%[Cau27-GV14]%[2D1Y2-2]
\immini[thm]{Cho hàm số $y=f(x)$ có đồ thị như hình vẽ dưới đây. Giá trị cực tiểu của hàm số là
\choice
{$2$}
{$0$}
{$5$}
{\True $1$}}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round,>=stealth,x=0.6cm,y=0.6cm]
\def \xmin{-1.0};
\def \xmax{4.7};
\def \ymin{-0.9};
\def \ymax{6.5};
...
\begin{ex}%[Cau27-GV14]%[2D1Y2-2]
\immini[thm]{Cho hàm số $y=f(x)$ xác định, liên tục trên đoạn $[-4;0]$ và có đồ thị là đường cong trong hình vẽ bên. Hàm số $f(x)$ đạt cực tiểu tại điểm nào dưới đây?
\choice
{$x=-2$}
{\True $x=-1$}
{$x=-3$}
{$x=2$}}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round,>=stealth,x=0.6cm,y=0.6cm]
\def \xmin{-5.5};
\def \xmax{1.7};
\def \ymin{-2.5};
\def \ymax{3.5};
...
\begin{ex}%[Cau27-GV14]%[2D1Y2-2]
\immini[thm]{Cho hàm số $y=f(x)$ liên tục trên đoạn $[0;4]$ có đồ thị như hình vẽ bên. Mệnh đề nào sau đây đúng?
\choice
{\True Hàm số đạt cực tiểu tại $x=3$}
{Hàm số đạt cực tiểu tại $x=0$}
{Hàm số đạt cực đại tại $x=4$}
{Hàm số đạt cực đại tại $x=2$}}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round,>=stealth,x=0.6cm,y=0.6cm]
\def \xmin{-1.0};
\def \xmax{4.7};
\def \ymin{-2.5};
\def \ymax{3.5};
...
\begin{ex}%[Cau27-GV14]%[2D1Y2-2]
\immini[thm]{ Cho hàm số  $f(x)$ có đồ thị như hình vẽ bên. Số điểm cực đại của hàm số đã cho là
\choice
{$0$}
{\True $1$}
{$2$}
