...
\begin{center}
	...
	\textbf{Trường hợp} & $$a>0$$ & $$a<0$$ \\ 
	\hline 
	Phương trình $y'=0$ có $3$ nghiệm phân biệt ($a.b<0$) & \begin{tikzpicture}[scale=0.6,line cap=round,line join=round,>=stealth]
	...
	\end{tikzpicture} & \begin{tikzpicture}[scale=0.6,line cap=round,line join=round,>=stealth]
		\draw[->,color=black] (-3,0) -- (3,0) node[below left]{$x$};
		\draw[->,color=black] (0,-3) -- (0.,2.5) node[below left]{$y$};
		\draw[color=black] (0pt,-10pt) node[right] {$O$};
		\clip(-3,-3) rectangle (3,2.5);
	...
	\end{tikzpicture} \\ 
	\hline 
	Phương trình $y'=0$ có $1$ nghiệm ($a.b\geq 0$) &\begin{tikzpicture}[scale=0.6,line cap=round,line join=round,>=stealth]
		\draw[->,color=black] (-3,0) -- (3,0) node[below left]{$x$};
		\draw[->,color=black] (0,-3) -- (0.,2.5) node[below left]{$y$};
		\draw[color=black] (0pt,-10pt) node[right] {$O$};
		\clip(-3,-3) rectangle (3,2.5);
...
\end{tikzpicture}}
{\True \begin{tikzpicture}[scale=0.8, font=\footnotesize,line join=round, line cap=round,>=stealth]
		\draw[->] (-2,0)--(0,0)node[below left]{$O$}--(2,0) node[below]{$x$};
...
\begin{ex}%[Đỗ Đường Hiếu, ĐMH-2023]%[2D1Y5-1]
\immini[thm]{Đường cong ở hình vẽ bên là đồ thị của hàm số nào dưới đây?
\choice
{$y=\dfrac{x-1}{x+1}$}
{$y=x^3-3x^2-1$}
{$y=-x^3+3x+1$}
...
\begin{ex}%[Đỗ Đường Hiếu, ĐMH-2023]%[2D1Y5-1]
\immini[thm]{Đồ thị sau đây là của hàm số nào?
\choice
{$y=-x^3+3x^2+1$}
{\True $y=x^3-3x+1$}
{$ y=-x^3-3x^2-1$}
...
%Câu 13
\begin{ex}%[Đỗ Đường Hiếu, ĐMH-2023]%[2D1Y5-1]
	\immini[thm]{Đồ thị của hàm số nào dưới đây có dạng đường cong như hình vẽ?
		\choice 
		{$y=x^3-2x^2-2$}
		{$y=x^3-3x^2+2$}
		{$y=-x^4+3x^2+2$}
