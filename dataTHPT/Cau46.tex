...
%Câu 46.8.
\begin{ex}%[Vô Văn Tự, PTĐMH-2023]%[2H3G2-6]
	Trong không gian với hệ tọa độ $Oxyz$, cho hình lăng trụ $ABC.A'B' C'$ có đáy $ABC$ là tam giác vuông cân tại $A$ và có độ dài các cạnh $B C=4$ và thể tích khối lăng trụ bằng $8$. Biết phương trình mặt phẳng $(ABC)\colon x+y-z-2=0$. Hãy viết phương trình mặt phẳng $\left(A' B' C'\right)$ biết nó cắt trục $O x$ tại điểm có hoành độ dương.
	\choice
	{$x+y-z-2+2 \sqrt{3}=0$}
...
\begin{ex}%[Vô Văn Tự, PTĐMH-2023]%[2H3G3-8]
	...
	\loigiai{
		...
		Phương trình đường thẳng $A C\colon \heva{&x=-1+2 t \\&y=t \\&z=1+2 t.}$\\
