...
\begin{ex}%[Vô Văn Tự, PTĐMH-2023]%[2H3G3-7]
	...
	\begin{itemize}
		...
		$\Rightarrow I I' \perp(P) \Rightarrow \overrightarrow{I I'}=(1;2;2)$ là một vectơ pháp tuyến của mặt phẳng $(P)$.\\
...
\begin{ex}%[Vô Văn Tự, PTĐMH-2023]%[2H3G2-6]
	...
	\loigiai{
		Ta có $\mathrm{d}(A,(P))=\dfrac{|2+4+3+3|}{\sqrt{2^2+(-2)^2+1}}=4=A M \Rightarrow M$ là hình chiếu vuông góc của $A$ lên $(P)$.\\
		 $\Rightarrow M \in(P)$ và $\overrightarrow{A M}=(a-1;b+2;c-3)$ cùng phương với vectơ pháp tuyến của $(P)$ là $\vv{n}=(2 ;-2;1)$.\\
...
\begin{ex}%[Vô Văn Tự, PTĐMH-2023]%[2H3G2-6]
	...
	\loigiai{
		...
		Dễ có $H(0;0;3)$. Vậy $(P)$ đi qua $H(0;0;3)$, có vectơ pháp tuyến $\overrightarrow{M H}=(-1 ;-2;0)$.\\
...
%Câu 46.8.
\begin{ex}%[Vô Văn Tự, PTĐMH-2023]%[2H3G2-6]
	Trong không gian $Oxyz$, cho hình lăng trụ $ABC.A'B' C'$ có đáy $ABC$ là tam giác vuông cân tại $A$ và có độ dài các cạnh $B C=4$ và thể tích khối lăng trụ bằng $8$. Biết phương trình mặt phẳng $(ABC)\colon x+y-z-2=0$. Hãy viết phương trình mặt phẳng $\left(A' B' C'\right)$ biết nó cắt trục $O x$ tại điểm có hoành độ dương.
	\choice
	{$x+y-z-2+2 \sqrt{3}=0$}
...
%Câu 46.10.
\begin{ex}%[Vô Văn Tự, PTĐMH-2023]%[2H3G3-7]
	Trong không gian $Oxyz$, cho mặt cầu $(S)\colon x^2+(y-3)^2+(z-6)^2=45$ và $M(1;4;5)$. Ba đường thẳng thay đổi $d_1$, $d_2$, $d_3$ nhưng luôn đôi một vuông góc tại $O$ cắt mặt cầu tại điểm thứ hai lần lượt là $A$, $B$, $C$. Khoảng cách lớn nhất từ $M$ đến mặt phẳng $(A B C)$ là
	\choice
	{$\sqrt{5}$}
	{$4$}
	{\True $\sqrt{6}$}
...
\begin{ex}%[Vô Văn Tự, PTĐMH-2023]%[2H3G2-6]%[2H3G2-6]
	...
	\loigiai{
		...
		$.\\
		Vectơ pháp tuyến của mặt phẳng $(A B C)$ và mặt phẳng $(P)$ lần lượt là $\overrightarrow{n}_1=\left(\dfrac{1}{a};\dfrac{1}{b};\dfrac{1}{2}\right)$ và $\overrightarrow{n}_2=(2 ;-2;0)$.\\
...
\begin{ex}%[Vô Văn Tự, PTĐMH-2023]%[2H3G3-8]
	...
	\loigiai{
		...
		Mặt phẳng $(\alpha)$ có một vectơ pháp tuyến là $\overrightarrow{n}_1=\left(\dfrac{1}{4};\dfrac{1}{b};\dfrac{1}{3}\right)$.\\
		Mặt phẳng $(O y z)$ có một vectơ pháp tuyến là $\overrightarrow{n_2}=(1;0;0)$.\\
...
\begin{ex}%[Vô Văn Tự, PTĐMH-2023]%[2H3G3-8]
	...
	\end{center}
		...
		Vectơ chỉ phương của đường thẳng $d$ là $\overrightarrow{u}_d=(2;1;3)$.\\
		...
		Khi đó $A K \perp(P)$ nên $(P)$ có vectơ pháp tuyến $\overrightarrow{A K}=\left(-\dfrac{43}{7} ;-\dfrac{4}{7};\dfrac{30}{7}\right)$,
		ta chọn vectơ pháp tuyến của $(P)$ là $\overrightarrow{n}=(43;4 ;-30)$.\\
...
\begin{ex}%[Vô Văn Tự, PTĐMH-2023]%[2H3G3-8]
	...
	\loigiai{
		...
		Trong đó $\overrightarrow{A B}=\left(\dfrac{1}{2} ;-1 ;-1\right)$, $\overrightarrow{u}_d=(m;1-m;1)$ là vectơ chỉ phương của đường thẳng $d$,\\
		Do đó $(1) \Leftrightarrow \dfrac{1}{2} \cdot m-1 \cdot(1-m)-1=0 \Leftrightarrow m=\dfrac{4}{3}$.
	}
\end{ex}
%Câu 46.18.
\begin{ex}%[Vô Văn Tự, PTĐMH-2023]%[2H3G3-8]
	Trong không gian $Oxyz$, cho ba điểm $A(-1;0;1)$, $B(3;2;1)$, $C(5;3;7)$. Gọi $M(a;b;c)$ là điểm thỏa mãn $M A=M B$ và $M B+M C$ đạt giá trị nhỏ nhất. Tính $P=a+b+c$
	\choice
	{$P=0$}
	{$P=2$}
	{\True $P=5$}
...
%Câu 46.19.
\begin{ex}%[Vô Văn Tự, PTĐMH-2023]%[2H3G3-8]
	Trong không gian $Oxyz$, cho điểm $A(1;2 ;-3)$ và mặt phẳng $(P)\colon 2 x+2 y-z+9=0$. Đường thẳng $d$ đi qua $A$ và vuông góc với mặt phẳng $(Q)\colon 3 x+4 y-4 z+5=0$, cắt mặt phẳng $(P)$ tại $B$. Điểm $M$ nằm trong mặt phẳng $(P)$ sao cho $M$ luôn nhìn $A B$ dưới góc vuông. Tính độ dài lớn nhất của $M B$.
	\choice
	{$M B=\dfrac{\sqrt{5}}{2}$}
	{\True $M B=\sqrt{5}$}
	{$M B=\sqrt{41}$}
