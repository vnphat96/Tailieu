...
\loigiai{
Vì $d$ có véc-tơ chỉ phương $\vec{a}=(1;-4;-5)$, suy ra $d$ cũng có một véc-tơ chỉ phương khác nữa là $\vec{b}=(-1;4;5)$. Phương trình tham số của đường thẳng $d$ đi qua điểm $M(1;2;3)$ và có véc-tơ chỉ phương $\vec{b}=(-1;4;5)$ là $\heva{&x=1-t\\&y=2+4 t\\&z=3+5t.}$
}
\end{ex}
