...
\begin{ex}%[2D2Y4-2]
	...
	\loigiai{
		$y^{\prime}=\left(2x^2 + x\right)^{\prime}\cdot 2^{2x^2 + x}\cdot\ln 2=(4x + 1)\cdot 2^{2x^2 + x}\cdot\ln 2$.
	}
\end{ex}
\begin{ex}%[2D2Y4-2]
...
\begin{ex}%[2D2Y4-2]
	...
	\loigiai{
		Học sinh ghi công thức $\left(\mathrm{e}^{u}\right)^{\prime}=u'\cdot \mathrm{e}^u$\\
		$\Rightarrow y^{\prime}=\left(x^2 + x\right)^{\prime}\cdot \mathrm{e}^{x^2 + x} = (2x + 1)\cdot \mathrm{e}^{x^2 + x}$.
	}
\end{ex}
\begin{ex}%[2D2Y4-2]
	...
	\loigiai{
		Ta có $(\cos u)^{\prime}= -u'\sin u$.\\
		$\Rightarrow y^{\prime}=(\cos2x)^{\prime}\cdot\mathrm{e}^{\cos 2 x}= -2 \sin 2 x \cdot \mathrm{e}^{\cos 2 x} $.
	}
\end{ex}
...
\begin{ex}%[2D2Y4-2]
	...
	{$5^{\sin x}\cdot\ln 5$}
	\loigiai{
	Ta có	$\left(a^u\right)^{\prime}= u'\cdot a^u\cdot \ln u$ và $(\sin x)^{\prime}=\cos x $\\
		$\Rightarrow y^{\prime}= 5^{\sin x}\cdot\ln 5\cdot \cos x$.
	}
\end{ex}
%6
...
\begin{ex}%[2D2B4-2]
	...
	{$ - 2x \mathrm{e}^x$}
	\loigiai{
		$(u\cdot v)^{\prime}= u'\cdot v + v'\cdot u$\\
		$\Rightarrow y^{\prime}=\left(x^2 - 2x + 2\right)'\mathrm{e}^x + \left(\mathrm{e}^x\right)^{\prime}\cdot \left(x^2 - 2x + 2\right) = (2x-2)\cdot \mathrm{e}^{x} + \mathrm{e}^{x}\cdot \left(x^2-2x+2\right)= x^2\mathrm{e}^{x}$.
	}
\end{ex}
