...
%%==========Câu 1
\begin{ex}%[2D4Y1-2]
\immini[thm]{Số phức nào dưới đây có điểm biểu diễn trên mặt phẳng tọa độ là điểm $M$ như hình vẽ bên?
	\choice
	{\True $1-2i$}
	{$i+2$}
	{$i-2$}
...
%%==========Câu 2
\begin{ex}%[2D4Y1-2]
	\immini[thm]{Điểm $M$ trong hình bên là điểm biểu diễn của số phức $z$. Mệnh đề nào sau đây đúng?
...
%%==========Câu 9
\begin{ex}%[2D4Y1-2]
\immini[thm]{Trong hình vẽ bên, điểm $P$ biển diễn số phức $z_1$, điểm $Q$ biểu diễn số phức $z_2$. Tìm số phức $z=z_1+z_2$?
	\choice
	{\True $1+3i$}
	{$-3+i$}
	{$-1+2i$}
