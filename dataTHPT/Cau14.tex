...
\begin{khung}
	...
	[Đề minh họa BGD 2022-2023]
			\immini[thm]{Cho khối chóp $S.ABC$ có đáy là tam giác vuông cân tại $A$, $AB=2$, $SA$ vuông góc với đáy và $SA=3$ (Tham khảo hình vẽ). Thể tích khối chóp đã cho bằng
			\choice
			{$12$}
			{\True $2$}
			{$6$}
...
\begin{ex}%[Nguyễn Văn Hiệp]%[2H1B3-2] % Câu 2.
	...
	{$\dfrac {1}{2}\, SA\cdot AB^2 $}
		\loigiai{\immini[thm]{Diện tích đáy của hình chóp là $S_{ABCD}=\dfrac {1}{2}AC\cdot BD$.\\
...
\end{ex}
	...
	{\True $4a^3$}
	{$12a^3$}
	\loigiai{\immini[thm]{Ta có $S_{\triangle ABC}=\dfrac {1}{2}\cdot 3a\cdot 4a=6a^2$.\\
...
\begin{ex}%[Nguyễn Văn Hiệp]%[2H1B3-2] % Câu 4.
	...
	{$\dfrac {a^3\sqrt {3}}{6}$}
	{$\dfrac {a^3}{4}$}
	\loigiai{\immini[thm]{Thể tích của khối chóp $S.ABC$ bằng\\
...
\begin{ex}%[Nguyễn Văn Hiệp]%[2H1B3-2] % Câu 5.
	...
	{$\dfrac {a^3}{4}$}
	\loigiai{\immini[thm]{Ta có $h=SA=a\sqrt {3}$; $B=S_{ABCD}=a^2$.\\
...
\begin{ex}%[Nguyễn Văn Hiệp]%[2H1B3-2] % Câu 7.
	...
	{$3a^3$}
	{$\dfrac {1}{6}a^3$}
	\loigiai{\immini[thm]{Thể tích khối chóp là\\
...
\begin{ex}%[Nguyễn Văn Hiệp]%[2H1B3-2] % Câu 8.
	...
	{$20$}
	{$30$}
	\loigiai{\immini[thm]{Dễ thấy $SA\perp (SBC)$\\
...
\begin{ex}%[Nguyễn Văn Hiệp]%[2H1B3-2] % Câu 11.
	...
	{$\dfrac{2\sqrt {2}{a^3}}{3}$}
		\loigiai{\immini[thm]{Diện tích đáy hình chữ nhật là \\
...
\begin{ex}%[Nguyễn Văn Hiệp]%[2H1B3-2] % Câu 12
	...
	{\True $\dfrac {2}{3} a^3$}
	{$\dfrac {1}{3} a^3$}
	\loigiai{\immini[thm]{Ta có $AB=BC=\dfrac {AC}{\sqrt {2}}=\dfrac {2a}{\sqrt {2}}=a\sqrt {2}$.\\
...
\begin{ex}%[Nguyễn Văn Hiệp]%[2H1B3-2] % Câu 13.
	...
	{$9a^3$}
	{\True $ a^3$}
	\loigiai{\immini[thm]{Ta có $S_{ABCD}=a^2$, đường cao $SA=3a$.\\
...
\begin{ex}%[Nguyễn Văn Hiệp]%[2H1B3-2] % Câu 15.
	...
	{$V=40$}
	{$V=24$}
	\loigiai{\immini[thm]{Ta có $10^2=8^2+6^2$ hay $BC^2=CA^2+AB^2$.\\
...
\begin{ex}%[Nguyễn Văn Hiệp]%[2H1B3-2] % Câu 20.
	...
	{$\sqrt {2}$}
	\loigiai{\immini[thm]{Cho $ABCD$ là tứ diện đều.\\
