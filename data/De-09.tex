...
%%==========Câu 10
\begin{ex}%[2H3Y3-1]
	Trong KG $Oxyz$, cho đường thẳng $d\colon\dfrac{x-1}{-1}=\dfrac{y-1}{1}=\dfrac{z+1}{-2}$. Một vectơ chỉ phương của $d$ là 
	\choice
	...
	\loigiai{
	Một vectơ chỉ phương của d là $\overrightarrow{u_1}(1;-1; 2)$.}
\end{ex}
%%==========Câu 11
\begin{ex}%[2H3Y2-1]
	Trong KG $Oxyz$, cho hai vectơ $\overrightarrow{a}=(2; 1;-2)$ và vectơ $\overrightarrow{b}=(1; 0; 2)$. Tìm tọa độ vectơ $\overrightarrow{c}$ là tích có hướng của $\overrightarrow{a}$ và $\overrightarrow{b}$ 
	\choice
...
%%==========Câu 12
\begin{ex}%[2H3Y1-3]
	Trong KG $Oxyz$, cho hai điểm $A(1; 2; 3), B(-3; 0; 1)$. Mặt cầu nhận $AB$ làm đường kính có phương trình là
	\choice
...
\begin{ex}%Câu 39.%[2H3T3-2]
	Trong KG $Oxyz$, cho hai đường thẳng $d_1\colon\dfrac{x-2}{-1}=\dfrac{y-1}{3}=\dfrac{z-1}{2}$ và $d_2\colon\heva{&x=1-3t\\&y=-2+t\\&z=-1-t}$. Phương trình đường thằng nằm trong $(\alpha)\colon x+2y-3z-2=0$ và cắt hai đường thẳng $d_1, d_2$ là
	\choice
	...
	\loigiai{
		...
		\begin{itemize}
			...
			\item $d$ đi qua điểm $A(3;-2;-1)$ và có vectơ chỉ phương $\overrightarrow{AB}=(-5; 1;-1)$.
		\end{itemize}
...
\begin{ex}%Câu 49.%[2H3K2-3]
	Trong KG $Oxyz$, mặt phẳng $(P)$ đi qua giao tuyến của hai mặt phẳng $(\alpha_1)\colon y+2z-4=0$, $(\alpha_2)\colon x+y-5z-5=0$ và vuông góc với mặt phẳng $(\alpha_3)\colon x+y+z-2=0$. Phương trình của mặt phẳng $(P)$ là
	\choice
	{\True $x+2y-3z-9=0$}
	{$3x+2y+5z-5=0$}
	{$3x+2y+5z+4=0$}
	...
	\loigiai{
		...
		Mặt phẳng $(P)$ đi qua $M(1; 4; 0)$ và nhận $\overrightarrow{n}=\left[\overrightarrow{u_1},\overrightarrow{n_3}\right]=(3; 6;-9)$ làm vectơ pháp tuyến có phương trình $(P)\colon 3(x-1)+6(y-4)-9(z-0)=0\Leftrightarrow x+2y-3z-9=0$.}
%<MyLT>
\end{ex}
\begin{ex}%Câu 50.%[2H3G2-6]
	\immini
	{
		Trong KG $Oxyz$, cho mặt cầu $(S)$ có phương trình $(S)\colon (x-1)^2+(y-2)^2+(z-3)^2=4$. Xét đường thẳng $d\colon\heva{&x=1+t\\&y=-mt\\&z=(m-1)t}$, $ m $ là tham số thực. Giả sử $(P)$ và $(P)$ là hai mặt phẳng chứa $ d $ và tiếp xúc với $(S)$ lần lượt tại $T$ và $T$. Khi $ m $ thay đổi, giá trị nhỏ nhất của độ dài đoạn thẳng $TT$ là		
		\choice
