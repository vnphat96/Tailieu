...
\begin{vd}%[1C8B6-3]
	...
	\loigiai
	{\immini[thm]{Diện tích tam giác đều $A B C$ là
...
\end{bt}
\begin{bt}%[1K7KQ-2]
	\immini[thm]{Một sọt đựng đồ có dạng hình chóp cụt đều. Đáy và miệng sọt là các hình vuông tương ứng có cạnh bằng $60$ cm, $30$ cm, cạnh bên của sọt dài $50$ cm. Tính thể tích của sọt. }{
...
\end{vd}
\begin{vd}%[1C8B6-2]
	\immini[thm]{Tính thể tích của khối chóp $S.ABCD$. Biết đáy $ABCD$ là hình vuông cạnh $a$, $SA \perp (ABCD)$, góc giữa đường thẳng $SB$ và mặt phẳng $(ABCD)$ bằng $60^{\circ}$.}{
...
\begin{bt}%[1K7BQ-1]
	...
	\loigiai{
	\immini[thm]{Tam giác vuông $OBC$ có diện tích là $S_{OBC}=\dfrac{1}{2}bc$.\\
...
\begin{vd}%[2H1B3-2]
	...
	\loigiai{
	\immini[thm]{Ta có $V_{ABC.A'B'C'}=S_{\Delta ABC}\cdot AA'=\dfrac{1}{2}AB\cdot AC\cdot AA'=\dfrac{a^3}{2}$.}
...
\begin{bt}%[2H1B3-2]
	...
	\loigiai{
	\immini[thm]{Thể tích khối lăng trụ tam giác đều: $V=h\cdot S=a\cdot\dfrac{a^2\sqrt{3}}{4}=\dfrac{a^3\sqrt{3}}{4}$.}
...
\begin{vd}%[2H1K3-2]
	...
	\loigiai{
	\immini[thm]{Gọi $M$ là trung điểm của $BC$, $I$ là trọng tâm $\triangle ABC$
...
\begin{bt}%[1K7KQ-1]
	...
	\loigiai{
	\immini[thm]{Gọi $A'H$ là đường cao của tam giác cân $A'AC$. Khi đó, $H$ là trung điểm của $AC$.\\
...
% 	\loigiai{ 
% 	\immini[thm]{Diện tích đáy tam giác đều là $S_{ABC}=a^2\cdot \dfrac{\sqrt{3}}{4}$;
...
% 			\item Chứng minh rằng các tam giác
% 			$ASC$ và $BSD$ là tam giác vuông cân.
% 			\immini[thm]{Hai tam giác $ASC$ và $ABC$ có $AS=AB=a$, $CS=CS$, $AC$ là cạnh chung nên $\triangle ASC=\triangle ABC$.\\
...
% \end{bt}
% \begin{bt}%[1C8B6-2]
% 	\immini[thm]{Một loại đèn đá muối có dạng khối chóp tứ giác đều (Hình $97$). Tính theo $a$ thể tích của đèn đá muối đó, giả sử các cạnh đáy và các cạnh bên đều bằng $a$.}{\includegraphics[scale=0.4]{HINHVE/CD/Hinh97}}
% 	\loigiai
% 	{\immini[thm]{Hình biểu diễn của đèn đá muối là hình chóp tứ giác đều $S.ABCD$ như hình vẽ bên.\\
...
% 		\begin{enumerate}
% 			\item Chứng minh rằng hai mặt phẳng $\left(ACC'A'\right)$ và $\left(BDD'B'\right)$ vuông góc với nhau.
% 			\immini[thm]{Vì $ABCD.A'B'C'D'$ là lăng trụ đứng nên $$CC'\perp (ABCD)\Rightarrow CC'\perp BD.$$
...
% 	\item \immini[thm]{ Kẻ $AK \perp A'B'$ thì $AK =\dfrac{8-3}{2} = 2{,}5 \text{ dm}$.\\
% 	$A'B'=8-1-1=6 \text{ dm}.$\\
...
% 	\end{tikzpicture}
% 	}
% 	\item \immini[thm]{Ta có: $AC=3\sqrt{2}, A'C'=6\sqrt{2}, AA'=\sqrt{\dfrac{17}{2}}$.\\
...
% 	\loigiai{
% 	\immini[thm]{Diện tích đáy lớn $S=6\cdot a^2\dfrac{\sqrt{3}}{4}=\dfrac{3\sqrt{3}}{2}a^2$.\\
...
% \begin{bt}%[1C8K6-5]
% 	\immini[thm]{Người ta xây dựng một chân tháp bằng bê tông có dạng khối chóp cụt tứ giác đều. Cạnh đáy dưới dài $5$ m, cạnh đáy trên dài $2$ m, cạnh bên dài $3$ m. Biết rằng chân tháp được làm bằng bê tông tươi với giá tiền là $1\,470\,000$ đồng/m$^3$. Tính số tiền để mua bê tông tươi làm chân tháp theo đơn vị đồng.
% 	}{\vspace*{-5mm}
% 	\begin{tikzpicture}[scale=0.9, font=\footnotesize, line join=round, line cap=round,>=stealth]
...
% 	\end{tikzpicture}}
% 	\loigiai
% 	{\immini[thm]{Diện tích đáy dưới của khối chóp cụt là $S_1=5^2=25$ m$^2$.\\
...
% 	\loigiai
% 	{\immini[thm]{Diện tích tam giác vuông cân là $S=\dfrac{1}{2}\cdot 12^2=72$ cm$^2$.\\
...
\begin{ex}%[2H1B3-2]
	...
	{$\dfrac{a^3\sqrt{6}}{12}$}
	\loigiai{
		\immini[thm]{Vì tam giác $ABC$ vuông tại $A$ nên $AC=\sqrt{BC^2-AB^2}=\sqrt{(a\sqrt{3})^2-a^2)}=a\sqrt{2}.$\\
...
\begin{ex}%[2H1B3-2]
	\immini[thm]{Cho khối lăng trụ đứng $ABC.A'B'C'$ có đáy $ABC$ là tam giác vuông cân tại $B$, $AB = BB' = a$ (\textit{tham khảo hình vẽ bên}). Tính thể tích $V$ của khối lăng trụ.
		\choice
		{$V = \dfrac{a^3}{3} $}
		{$V = a^3$}
		{\True $V = \dfrac{a^3}{2}$}
...
\begin{ex}%[2H1B3-2]
	...
	{$8a^3$}
	{\True$24a^3$}
	\loigiai{\immini[thm]{Áp dụng định lí Pythago vào tam giác $ABC$ vuông tại $B$, có\\
			$AC^2=AB^2+AD^2$\\
...
\begin{ex}%[2H1B3-2]
	...
	{$\dfrac{a^3\sqrt{3}}{24}$}
	\loigiai{
		\immini[thm]{Gọi $M$ là trung điểm của $BC$, $H$ là hình chiếu vuông góc của $M$ trên $AA'$. Suy ra $MH$ là khoảng cách giữa hai đường thẳng $ AA'$ và $BC$. Ta có  $AM=a\sqrt{3}$ và \break $ AG=\dfrac{2}{3}AM=\dfrac{2a\sqrt{3}}{3}.$
...
\begin{ex}%[2H1G3-2]
	...
	{$V=6$ }
	\loigiai{
		\immini[thm]{ Gọi $H$ là hình chiếu vuông góc của $B$ lên $AC$ $\Rightarrow BH \perp (ACC'A')\Rightarrow BH\perp AA'$. \\
...
\begin{ex}%[2H2B3-3]
	...
	{$\dfrac{5}{6}V$} 
	\loigiai{
		\immini[thm]{Ta có:$\heva{&PA=2PB \Rightarrow \dfrac{BP}{BA}=\dfrac{1}{3}\\
