...
\begin{ex}%[DCHT Toán 11 - KNTT -Nguyễn Văn Hiệp]%[1K7GP-7]
	...
	{$a\sqrt{2}$}
	{$\dfrac{a\sqrt{3}}{3}$}
	\loigiai{\immini[thm]{Dễ thấy khoảng cách này bằng khoảng cách từ điểm $D$ đến đường thẳng $SA$.\\
...
\begin{ex}%[DCHT Toán 11 - KNTT -Nguyễn Văn Hiệp]%[1K7GP-7]
	...
	{$d>4a$}
	\loigiai
	{\immini[thm]{Gọi $H$ là hình chiếu vuông góc của $A$ lên $(BCD)$. Khi đó ta có $H$ là trực tâm của tam giác $BCD$.\\
