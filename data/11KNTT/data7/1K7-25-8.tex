...
\begin{vd}%[Nguyễn Trần Phong]%[1K7BO-7]
	...
	\loigiai{
		\immini[thm]{Gọi $O$, $O'$ lần lượt là trọng tâm tam giác $ABC$ và $A'B'C'$.\\
...
\begin{vd}%[Nguyễn Trần Phong]%[1K7BO-7]
	...
	\loigiai{
		\immini[thm]{Gọi $H$ là hình chiếu của $A$ lên $BC$. Do tam giác $ABC$ đều nên $H$ cũng là trung điểm $BC$.\\
...
\begin{vd}%[Nguyễn Trần Phong]%[1K7BO-7]
	...
	\loigiai{
		\immini[thm]{Trong  $(SBC)$, gọi $K= SI \cap EF$.\\
...
\begin{vd}%[Nguyễn Trần Phong]%[1K7KKO-7]
	...
	{\begin{listEX}
			\item Chứng minh $BC \perp SA$ và $SA \perp (SBC)$.
			\immini[thm]{Ta có $SO\perp (ABC)$ nên $SO\perp BC$.\quad $(1)$\\
...
\begin{ex}%[Nguyễn Trần Phong]%[1K7BO-7]
	...
	\loigiai{\immini[thm]{ Trong hình thang $BDD'B'$, gọi $H$ là hình chiếu của $D'$ lên $BD$.
...
\begin{ex} %[Nguyễn Trần Phong]%[1K7KO-7]
	...
	{$\dfrac{2}{3} $}
	\loigiai{
		\immini[thm]{Gọi $N$ là trung điểm $BC$, do tam giác $ABC$ đều nên $BC \perp AN$.\\
...
\begin{ex}%[Nguyễn Trần Phong]%[1K7KO-7]
	...
	{$ \dfrac{a^2}{2}$}
	{\True $ 2a^2$}
	\loigiai{\immini[thm]{Gọi $N$, $Q$ lần lượt là trung điểm $SB$ và $DC$.\\
...
\begin{ex}%[Nguyễn Trần Phong]%[1K7KO-7]
	...
	\loigiai
	{\immini[thm]{Ta có $SA\perp AB$, $AD\perp AB$ và $(\alpha)\perp AB$ nên $(\alpha)\parallel SA$, $(\alpha)\parallel AD$.\\
