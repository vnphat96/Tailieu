...
\begin{bt}%[1K7BN-4]
	\immini[thm]{Trên một sân phẳng nằm ngang, tại các điểm $A$, $B$, $C$, $D$ người ta dựng các cột thẳng đứng $AM$, $BN$, $CP$, $DQ$ và nối các sợi dây thẳng giữa $M$ và $P$, $N$ và $Q$ như Hình $7.35$. 
		\begin{enumerate}
