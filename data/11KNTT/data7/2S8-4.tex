...
\begin{boxdn}
	\immini[thm]{Đường thẳng $\Delta$ cắt hai đường thẳng chớ nhau $a$, $b$ và vuông góc với cả hai đường thẳng đó được gọi là đường vuông góc chung của $a$ và $b$.\\
...
\begin{vd}%[1H3G5]
	...
	\loigiai{	
	\begin{enumerate}
	\item \immini[thm]{Ta có $(SCD) \perp (SAC)$. Hạ $AH \perp SC \Rightarrow AH \perp (SCD)$. Suy ra $AH$ là khoảng cách từ $A$ tới $(SCD)$.\\
...
\begin{vd}%[1H3K5]
	...
	\loigiai{
	\immini[thm]{Hạ $A'H \perp AC$. Ta có $BD \perp (OAA')$ suy ra $BD \perp A'H \Rightarrow A'H \perp (ABCD)$. Do $(ABCD) \parallel (A'B'C'D)$ nên $A'H$ là khoảng cách giữa hai mặt đáy. \\
...
\begin{vd}%[1H3K5]
	...
	\loigiai{
	\immini[thm]{Ta chứng minh được $(MNP) \parallel (SBC)$.\\
...
% 	\loigiai{
% 	\immini[thm]{Dựng $OM \perp CD$ và $OH \perp SM$ khi đó\\ Ta có
...
% \end{bt}
% \begin{bt}%[1K7BP-3]
% 	\immini[thm]{Giá đỡ ba chân ở hình bên đang được mở sao cho ba chân cách đều nhau một khoảng bằng $110$ cm. Tính chiều cao giá đỡ, biết các chân của giá đỡ dài $129$ cm.}{
% 	\begin{tikzpicture}[scale=.7,font=\footnotesize,line join = round, line cap = round, >= stealth]
...
% 	\end{tikzpicture}}
% 	\loigiai{
% 	\immini[thm]{Ta có $S.ABC$ là hình chóp đều. Gọi $E$ là trung điểm $BC$ và $H$ là trọng tâm tam giác $ABC$, suy ra $SH\perp (ABC)$.\\
