\begin{dang}{Đường vuông góc chung của hai đường thẳng chéo nhau}
	...
	% 	\immini[thm]{\textbf{Bước 1.} Xác định mặt phẳng $(P)$ đi qua $b$ và vuông góc với $a$, giao điểm của $a$ và $(P)$ là $H$, hình chiếu của $H$ trên $b$ là $K$.\\
...
\begin{vd}%[1K7KP-5]
	...
	\loigiai{ 
		\begin{listEX}[1]
			\item $SB$ và $CD$.
			\immini[thm]{Ta có $\heva{&BC\perp AB\\&BC\perp SA\\&AB\cap SA=A}\Rightarrow BC\perp(SAB).$\\
...
% 	\loigiai{
% 		\immini[thm]{Gọi $I$ và $J$ lần lượt là tâm của hai hình vuông $BCC'B'$ và $ADD'A'$.\\
...
\begin{bt}%[1K7KP-5]
	...
	\loigiai{
		\immini[thm]{Ta có $\heva{&AO \perp AA'\\&AO \perp BD}\Rightarrow \mathrm{d}(BD,AA')=\dfrac{1}{2}AC=\dfrac{a\sqrt{3}}{2}$.
...
\begin{bt}%[1K7KP-5]
	...
	\loigiai{
		\immini[thm]{Kẻ $OH \perp SB$ tại $H$.\\
...
\begin{bt}%[1K7KP-5]
	\immini[thm]{Cho lăng trụ $ABCD.A'B'C'D'$ có đáy $ABCD$ là hình vuông cạnh $2a$, $O$ là giao điểm của $AC$ và $BD$, $AA' = a$, $AA'$ vuông góc với mặt phẳng chứa đáy. Tính
		\begin{enumerate}
...
\begin{ex}%[Tex hoá SGK KNTT]%Thien Tran Xuan]%[1K7KP-5]
	...
	{$\dfrac{\sqrt{3}}{2}$}
	{\True $\sqrt{2}$}
	\loigiai{\immini[thm]{Gọi $M$ là trung điểm của $DC$.\\
...
\begin{ex}%[Tex hoá SGK KNTT]%Thien Tran Xuan]%[1K7KP-5]
	...
	\loigiai{
		\immini[thm]{Ta chứng minh $(SHC) \perp DM$ tại $H$.\\
			Thật vậy:
			\begin{itemize}
...
\begin{ex}%[1K7KP-5]
	...
	\loigiai{
		\immini[thm]{Gọi $M, N$ lần lượt là trung điểm của $AB$ và $CD$.\\
...
\begin{ex}%[1K7KP-5]
	...
	{$\dfrac{a\sqrt{2}}{2}$}
	\loigiai{
		\immini[thm]{Gọi $O$, $E$ lần lượt là trung điểm $AC$ và hình chiếu của $O$ trên $A'C$.\\
