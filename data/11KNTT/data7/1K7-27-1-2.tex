...
\begin{vd}%[1K7YQ-1]
	...
	{\True $V=10$}
	\loigiai{
		\immini[thm]{Diện tích tam giác $ABC$ là $S_{ABC}=\dfrac{1}{2}\cdot AB\cdot AC=\dfrac{1}{2}\cdot 4\cdot 5=10$.\\
...
\begin{vd}%[1K7BQ-1]
	...
	{$\dfrac{\sqrt{2}}{2}a^3$}
	\loigiai{
		\immini[thm]{Gọi $H$ là trọng tâm của tam giác $ABC$ và $M$ là trung điểm $BC$.\\
...
\begin{vd}%[1K7YQ-1]
	...
	{\True $V=36$}
	\loigiai{
		\immini[thm]{Vì $ABCD.A'B'C'D'$ là lăng trụ tứ giác đều nên $B'B\perp (ABCD)$.\\
...
\begin{vd}%[1K7KQ-1]
	...
	{$a^3$}
	\loigiai{
		\immini[thm]{Vì $ABC.A'B'C'$ là lăng trụ tam giác đều nên $A'A\perp (ABC)$.\\
...
\begin{ex}%[1K7YQ-1]
	...
	{$12a^3$}
	\loigiai{
		\immini[thm]{Diện tích tam giác $ABC$ là $S_{ABC}=\dfrac{1}{2}\cdot AB\cdot AC=6a^2$.\\
...
\begin{ex}%[1K7KQ-1]
	...
	{$V=a^3\sqrt{2}$}
	\loigiai{
		\immini[thm]{Do $ABCD.A'B'C'D'$ là hình lăng trụ, đáy $ABCD$ là hình chữ nhật nên $A'B'=AB=a$; $A'D'=AD=a\sqrt{2}$.\\
...
\begin{ex}%[1K7BQ-1]
	...
	{$V=\dfrac{a^3}{6}$}
	\loigiai{
		\immini[thm]{Diện tích hình chữ nhật $ABCD$ là $S_{ABCD}=AB\cdot BC=2a^2$.\\
...
\begin{ex}%[1K7KQ-1]
	...
	{$V=\dfrac{1}{8}$}
	\loigiai{
		\immini[thm]{Giả sử tứ diện đều $ABCD$ có cạnh bằng $1$ như hình vẽ.\\
...
\begin{ex}%[1K7YQ-1]
	...
	{$V=6 a^3$}
	\loigiai{
		\immini[thm]{Thể tích của khối lăng trụ đã cho là $$V=S_{ABC}\cdot AA'=\dfrac{1}{2}AB\cdot AC\cdot AA'=\dfrac{1}{2}\cdot a \cdot 2a \cdot 3a=3a^3.$$
...
\begin{ex}%[1K7KQ-1]
	...
	\loigiai{
		\immini[thm]{Đặt $AA'=b,\mathrm{d}\left(A;\left(A'BD\right)\right)=h$. Gọi $O=AC \cap BD$.\\
