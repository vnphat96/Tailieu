...
\begin{dang}{Khoảng cách giữa hai đường thẳng chéo nhau}
	\begin{enumerate}
		...
		\immini[thm]{Khi đó: $ \mathrm{d}(a; b)=MN$ với $ \heva{&MN\perp a\\&MN \perp b.}$
		}{
		...
		% 	\begin{itemize}
		% 		\item[]
		% 		\immini[thm]{\item \textbf{Bước 1.} Xác định giao điểm của cạnh bên và mặt đáy.\\
		% 			Ta có $SB\cap (ABCD)=B$.
...
\begin{vd}%[Tex hoá SGK KNTT]%[Phạm Văn Long]%[1K7BP-4]
	...
	\loigiai{
		\immini[thm]{Gọi $H$ là hình chiếu của $A$ trên $BC$. Tam giác $ABH$ vuông tại $H$ và có $AB=a$, $\widehat{ABH}=60^\circ$ nên $BH=\dfrac{a}{2}$.\\
...
\begin{vd}%[Tex hoá SGK KNTT]%[Phạm Văn Long]%[1K7BP-4]
	...
	\loigiai{ 
		\begin{itemize}
			...
			\immini[thm]{Ta có $SC\cap (ABCD)=C$ \tagEX{1}
...
\begin{vd}%[Tex hoá SGK KNTT]%[Phạm Văn Long]%[1K7BP-4]
	...
	\loigiai{
		\immini[thm]{Tam giác $ABC$ vuông tại $A$ nên $AC=\sqrt{BC^2 - AB^2}=a\sqrt{3}$.\\
...
\begin{bt}%[Tex hoá SGK KNTT]%[Phạm Văn Long]%[1K7KP-4]
	...
	\loigiai{
		\immini[thm]{Vì $AB\parallel CD$ nên $AB\parallel\left(SCD\right)$, suy ra
...
% 	\loigiai{	
% 		\immini[thm]{Gọi $N$ là trung điểm của $AC$. \\
...
% \end{ex}
% \begin{ex}%[Tex hoá SGK KNTT]%[Phạm Văn Long]%[1K7BP-4]
% 	\immini[thm]{ Cho hình chóp $S.ABCD$ có đáy là hình thang, $AB=2a$, $AD=DC=CB=a$, $SA$ vuông góc với mặt đáy và $SA=3a$ (minh họa như hình bên dưới). Gọi $M$ là trung điểm của $AB$. Khoảng cách giữa hai đường thẳng $SB$ và $DM$ bằng	
% 		\choice
% 		{\True$\dfrac{3a}{4}$}
% 		{$\dfrac{3a}{2}$}
...
% 	\end{tikzpicture}}
% 	\loigiai{
% 		\immini[thm]{Gọi $N$, $P$ lần lượt là trung điểm của $SA$ và $DM$. \\
...
% \end{ex}
% \begin{ex}%[Tex hoá SGK KNTT]%[Phạm Văn Long]%[1K7BP-4]
% 	\immini[thm]{Cho hình lập phương $ABCD.A'B'C'D'$ có cạnh bằng $a$. Khoảng cách giữa hai đường thẳng $BD$ và $A'C'$ bằng
% 		\choice
% 		{$\sqrt{3}a$}
% 		{\True $a$}
% 		{$\dfrac{\sqrt{3}a}{2}$}
...
% \begin{ex}%[Tex hoá SGK KNTT]%[Phạm Văn Long]%[1K7BP-4]
% 	\immini[thm]{Cho hình lăng trụ đứng $ABC.A'B'C'$ có đáy $ABC$ là tam giác vuông $BA=BC=a$, cạnh bên $AA'=a \sqrt{2}, M$ là trung điểm $BC$. Khoảng cách giữa hai đường thẳng $AM$ và $B'C$ bằng
% 		\choice
