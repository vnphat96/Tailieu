\begin{dang}{Góc giữa đường thẳng và mặt phẳng}
	...
	\end{note}
	\begin{nx}
		\immini[thm]{Cho điểm $A$ có hình chiếu $H$ trên mặt phẳng $(P)$. Lấy điểm $O$ thuộc mặt phẳng $(P)$, $O$ không trùng $H$. Khi đó góc giữa đường thẳng $A O$ và mặt phẳng $(P)$ bằng góc $AOH$}{\begin{tikzpicture}[scale=.6,font=\footnotesize,line join=round,line cap=round,>=stealth]
				\path 
				(0,0)coordinate(A) 
				(7,0)coordinate(B) 
				(60:3.5)coordinate(C) 
...
\end{bt}
\begin{bt}%[Huỳnh Đức Vũ, soạn đề cương toán 11-KNTT]%[1H3B3-3]
	\immini[thm]{Cho hình lập phương $ABCD.A'B'C'D'$ (tham khảo hình bên). Tính $\sin$ của góc giữa đường thẳng $AC'$ và mặt phẳng $(ABCD)$.}
	...
	\end{tikzpicture}}
	\loigiai{
		\immini[thm]{Vì $AC$ là hình chiếu vuông góc của $AC'$ lên mặt phẳng $(ABCD)$ nên góc giữa đường thẳng $AC'$ và mặt phẳng $(ABCD)$ cũng là góc giữa hai đường thẳng $AC$ và $AC'$.\\
			Suy ra
...
\begin{bt}%[Huỳnh Đức Vũ, soạn đề cương toán 11-KNTT]%[1H3K3-3]
	...
	\loigiai{
		\immini[thm]{Từ giả thiết ta có, các tam giác $S A C$, $S B D$ cân tại $S$ nên $SO \perp BD$, $SO \perp AC$. Suy ra $SO\perp (ABCD)$.\\
...
\begin{ex}%[Huỳnh Đức Vũ, soạn đề cương toán 11-KNTT]%[1H3B3-3]
	...
	{$75^{\circ}$}
	\loigiai{
		\immini[thm]{Góc giữa $SC$ và $(ABCD)$ là $\widehat{SCA}$.\\
...
\begin{ex}%[Huỳnh Đức Vũ, soạn đề cương toán 11-KNTT]%[1H3B3-3]
	...
	{$60^{\circ}$}
	\loigiai{
		\immini[thm]{Ta có: $\heva{&C B \perp A B \\& C B \perp S A} \Rightarrow C B \perp(S A B)$.\\
...
\begin{ex}%[Huỳnh Đức Vũ, soạn đề cương toán 11-KNTT]%[1H3B3-3]
	...
	{\True $4$}
	\loigiai{
		\immini[thm]{Ta có $BI$ là hình chiếu vuông góc của $IM$ lên $\left(ABC\right)$.\\
...
\begin{ex}%[Huỳnh Đức Vũ, soạn đề cương toán 11-KNTT]%[1H3B3-3]
	...
	{$\sqrt 3 $}
	\loigiai{
		\immini[thm]{Gọi $H$ là trung điểm cạnh $BC.$\\
			Ta có $HG\perp (ABC)$\\
