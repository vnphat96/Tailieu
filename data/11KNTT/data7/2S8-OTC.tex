...
\end{ex}
\begin{ex}%[1T8B2-2]
	\immini[thm]{Cho hình chóp $S.ABCD$ có đáy $ABCD$ là hình vuông, $SA$ vuông góc với mặt đáy. Đường thẳng $CD$ vuông góc với mặt phẳng nào sau đây?
	\choice
	{\True $(SAD)$}
	{$(SAC)$}
	{$(SAB)$}
...
\end{ex}
\begin{ex}%[1T8B5-1]
	\immini[thm]{Cho hình chóp $S.ABCD$ có đáy $ABCD$ là hình vuông cạnh $b$, $SA$ vuông góc với mặt đáy, $SC = 2b\sqrt{2}$. Số đo góc giữa cạnh bên $SC$ và mặt đáy là
	\choice
	{$60^\circ$}
	{$30^\circ$}
	{$45^\circ$}
	...
	\loigiai{
	\immini[thm]{Do $SA \perp (ABCD)$ nên $AC$ là hình chiếu của $SC$ trên $(ABCD)$.\\
...
\begin{ex}%[1T8B3-2]
	...
	{$(ABCD)$}
	\loigiai{
	\immini[thm]{Ta có $\heva{&SA \perp BM\\&SA \perp DM\\&BM, DM \subset (MBD)\\&BM \cap DM = \{M\}} \Rightarrow SA \perp (MBD)$ (1).\\
...
\begin{ex}%[1T8K5-2]
	...
	{\True $65^\circ 12'$}
	\loigiai{
	\immini[thm]{Gọi $O$ là tâm hình chữ nhật $ABCD$.\\
...
\begin{ex}%[1T8B4-7]
	...
	\loigiai{
	\immini[thm]{Gọi $H$ và $H'$ lần lượt là tâm đáy $ABC$ và $A'B'C'$.\\
...
\begin{ex}%[1T8B3-6]
	...
	{$12$}
	\loigiai{
	\immini[thm]{Cho hình hộp chữ nhật $ABCD.A'B'C'D'$ với $AB = 3$; $AD = 4$; $AA' = 5$.\\
...
\begin{ex}%[1T8B4-6]
	...
	{$\dfrac{a^3\sqrt{2}}{2}$}
	\loigiai{
	\immini[thm]{Ta có $S_{\triangle ABC} = \dfrac{a^2\sqrt{3}}{4}$.\\
...
\begin{bt}%[1T8B3-2]%[1T8K4-3]
	...
	\begin{itemize}
	\item[a)] 
	\immini[thm]{Do $M$ là trung điểm $AB$. Suy ra $SM \perp AB$.\\
...
\begin{bt}%[1T8K4-4]
	...
	\loigiai{
	\immini[thm]{Gọi $Q$ là trung điểm điểm $SA$. Suy ra $PQ \parallel AD$.\\
...
\begin{bt}
	...
	\loigiai{
	\immini[thm]{Do $\heva{&(SBI) \perp (ABCD)\\&(SCI) \perp (ABCD)\\&(SBI) \cap (SCI) = SI} \Rightarrow SI \perp (ABCD)$.\\
...
\begin{bt}
	...
	\item[b)] 
	\immini[thm]{Diện tích đáy dưới của khối chóp cụt là $S_1 = (2a)^2 = 4a^2$ (đvdt).\\
...
\begin{bt}
	...
	\loigiai{
	\immini[thm]{Diện tích hình thoi $ABCD$ là $S_{ABCD} = \dfrac{1}{2}AC \cdot BD = \dfrac{a^2}{2}$ (đvdt).\\
