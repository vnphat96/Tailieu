...
\begin{vd}[TH]%[1K7KQ-4]
	...
	\loigiai{
		a) $A B \parallel A^{\prime} B^{\prime} \Rightarrow A B \parallel\left(A^{\prime} B^{\prime} C^{\prime} D^{\prime}\right), A D \parallel A^{\prime} D^{\prime} \Rightarrow A D \parallel\left(A^{\prime} B^{\prime} C^{\prime} D^{\prime}\right)$.\\
		Do đó $(A B C D) \parallel\left(A^{\prime} B^{\prime} C^{\prime} D\right)$.\\
