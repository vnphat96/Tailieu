...
\loigiai{
    ...
    & \cdots \\
    b_n&=a_1(1+r)^n + a_1(1+r)^{n-1} + \cdots + a_1(1+r) \\
	& \quad + d(1+r)^{n-1} + 2d(1+r)^{n-2} + \cdots + (n-2)d(1+r)^2 + (n-1)d(1+r).
    \end{align*}
	Ta có
    \begin{itemize}
        ...
        $\Rightarrow (1+r)S = d(1+r)^n + 2d(1+r)^{n-1} + \cdots + (n-2)d(1+r)^3 + (n-1)d(1+r)^2$.\\
    ...
    & \cdots \\
    c_n&=A(1+s)^n - a_1(1+s)^n - a_1(1+s)^{n-1} - \cdots - a_1(1+s) \\
	&\quad - d(1+s)^{n-1} - 2d(1+s)^{n-2} - \cdots - (n-2)d(1+s)^2 - (n-1)d(1+s).
    \end{align*}
