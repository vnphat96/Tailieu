...
\TL
\begin{ex}%[10-11-12EX-HK1-2425]%[Tran Quoc]%[1D6H2-2]
Cho $a$, $b$, $c$ là các số thực dương khác $1$ thỏa mãn $\log_a b=3$, $\log_a c=4$. Tính giá trị biểu thức $P=\log_{\tfrac{a}{b}} \sqrt{c}$.
\shortans{-1}
\loigiai{Ta có $P=\log_{\tfrac{a}{b}} \sqrt{c}=\dfrac{\log_{a}\sqrt{c}}{\log_{a}\dfrac{a}{b}}=\dfrac{\dfrac{1}{2}\log_{a}c}{\log_{a}a-\log_{a}b}=\dfrac{\dfrac{1}{2}\cdot 4}{1-3}=-1$.}
\end{ex}

\begin{ex}%[1H3G3-2]
	Cho hình lăng trụ đứng $ABC.A'B'C'$ có $AA'=BC=a$, $AC=a\sqrt{3}$ và $\Delta ABC$ vuông tại $B$. Điểm $M$ nằm trên cạnh $AC$ sao cho $AM=\dfrac{1}{3}AC$. Chứng minh rằng $A'C \perp (B'MN)$.
	\loigiai{
		\begin{center}
			\begin{tikzpicture}
		...
		\\ Từ $(3),(4)$ ta suy ra $A'C \perp (B'MN)$.
	}
\end{ex}
