...
\begin{bt}%[1H2B4-5]
	...
	\loigiai{
		\immini[thm]{Hai mặt phẳng $(P)$ và $(SCD)$ có điểm $M$ chung.\\
...
\begin{bt}%[1H2B3-5]
	...
	\loigiai{
		\begin{enumerate}
			\immini[thm]{	\item  $\triangle ABD $ có $MN$ là đường trung bình nên $MN\parallel BD$ và $MN=\dfrac{1}{2}BD$.\\
...
\begin{ex}%[1H2G1-3]
	...
	{$\dfrac{2}{3}$}
	\loigiai
	{\immini[thm]{Gọi $M$ là trung điểm của $BC$, $N$ là giao điểm của $AC$ và $MD$.\\
