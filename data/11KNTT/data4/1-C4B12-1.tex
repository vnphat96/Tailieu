...
\begin{bt}%[1H1B3-2]%Câu 1
    ...
    \loigiai{
        \immini[thm]{Gọi $E$ là trung điểm cạnh $BC$. \\
...
\begin{bt}%[1H1B3-2]% Câu 2
    ...
    \loigiai{
        \immini[thm]{Ta có $\heva{& BO=\dfrac{1}{2}BD \\ & BO'=\dfrac{1}{2}BF }\Rightarrow OO'\parallel DF$. Mà $DF\subset (ADF)\Rightarrow OO' \parallel (ADF)$.\\
...
\begin{bt}%Câu 3
    ...
    \loigiai{
        \immini[thm]{Trong ${( ABCD )}$, gọi ${I=AN\cap CD}$\\
...
\begin{ex}%[1H1B3-2]% Câu 1
    ...
    { $( 1 )$ và $( 3 )$}
    \loigiai{
        \immini[thm]{Gọi $E$ là trung điểm của $AB$, $M,N$ lần lượt là trọng tâm của tam giác $ABC,ABD$.\\
...
\begin{ex}%[1H1B3-2]%Câu 2
    ...
    \loigiai{
        \immini[thm]{Xét tam giác $SAC$ có $M,N$ lần lượt là trung điểm của $SA,SC$.\\
...
\begin{ex}%[1H1B3-2]%Câu 3
    ...
    \loigiai{
        \immini[thm]{Theo định lí Talet, ta có $\dfrac{SM}{SA}=\dfrac{SN}{SB}$ suy ra $MN$ song song với $AB$.\\
...
\begin{ex}%[1H1B3-2]% Câu 4
    ...
    {$MN  \parallel ( SBC ) $}
    \loigiai{
        \immini[thm]{$MN$ là đường trung bình của $\triangle SAC$ nên $MN  \parallel AC.$\\
            Ta có $\heva{
...
\begin{ex}%[1H1B3-2]% Câu 6
    ...
    {	\True $MO'$ cắt $( BEC )$}
    \loigiai{
        \immini[thm]{Xét tam giác ${ACE}$ có $OO'$ lần lượt là trung điểm của $AC, AE$.\\
...
\begin{ex}%[1H1B3-1]%Câu 7
    ...
    {$M,R,S,N$}
    \loigiai{
        \immini[thm]{Theo tính chất của đường trung bình của tam giác ta có\\
...
\begin{ex}%[1H1B3-2]%Câu 11
    ...
    { $MG  \parallel (ABC)$}
    \loigiai{
        \immini[thm]{Lấy điểm $J$ là trung điểm cạnh $AD$, do $G$ trọng tâm tam giác $ABD$ nên $BG=2GJ$.\\
...
\begin{bt}%[1H1B3-3]%Câu13
    ...
    \loigiai{
        \immini[thm]{${MN}$ là đường trung bình của tam giác ${ABC}$ nên $MN \parallel BC.$\\
...
\begin{bt}%[1K4KC-5]
    ...
    \loigiai{
        \immini[thm]{  $AB\parallel (P)$ khi đó $(P)\cap\left(ABCD\right)=d_1$ với $d_1$ đi qua $I$ và $d_1\parallel AB.$\\
