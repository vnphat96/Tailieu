...
\begin{vd}%[1K4BA-7]
	Trong KG $Oxyz$ cho hình chóp $S.ABCD$ đáy $ABCD$ là hình chữ nhật. Tìm tập hợp tất cả các giao điểm của hai mặt phẳng $(SAB)$ và $(SCD)$?
	\loigiai{
	\begin{center}
...
\end{vd}
\begin{vd}%[1K4BA-7]
	Trong KG $Oxyz$ cho hình chóp $S.ABCD$ đáy $ABCD$ là hình thoi. Gọi $M,N$ lần lượt là trung điểm của $SB,SD$. Tìm tập hợp tất cả các điểm là giao điểm của hai mặt phẳng $(AMN)$ và $(ABD)$?\\
	\loigiai{
	\begin{center}
		\begin{tikzpicture}[line join=round, line cap=round,thick]
			\coordinate (A) at (0,0);
