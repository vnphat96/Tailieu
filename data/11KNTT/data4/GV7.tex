...
\begin{vd}%[1K4BA-5]
	...
	\loigiai{\immini[thm]{Gọi $N$ là giao của $SD$ và mặt phẳng $(MBC)$. Do các mặt phẳng $(MBC)$ và $(SAD)$ lần lượt chứa hai đường song song là $BC$ và $AD$, nên giao tuyến của chúng cũng song song với hai đường đó, tức $MN\parallel AD.$ Suy ra $N$ là trung điểm của $SD.$
...
\begin{vd}%[1K4YA-5]
	...
	\loigiai{
		\immini[thm]{$\bullet$ Thiết diện là tứ giác $MNEF$\\
...
\begin{ex}%[1K4BA-5]
	...
	{hình thang}
	\loigiai{
		\immini[thm]{Ta có điểm $K$ là điểm chung của hai mặt phẳng $(ABD)$ và $(IJK)$. \\
...
\begin{ex}%[1K4KA-5]
	...
	{Một tứ giác}
	\loigiai{
		\immini[thm]{Trong $(ABCD) \colon MN \cap AC=K$.\\
...
\begin{ex}%[1K4BA-5]
	...
	{Một hình thoi}
	\loigiai{
		\immini[thm]{Ta có $(SBC) \cap (ABM)=BM$ \\
...
\begin{ex}%[1K4KA-5]
	...
	{\True hình bình hành}
	\loigiai{
		\immini[thm]{Mặt phẳng $(ABC)$ chứa đường thẳng $AB$ song song với mặt phẳng $(P)$ nên mặt phẳng $(ABC)$ cắt mặt phẳng $(P)$ theo giao tuyến song song với $AB$.\\
