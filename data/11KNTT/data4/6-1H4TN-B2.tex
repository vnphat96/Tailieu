...
\begin{ex}%[Huỳnh Văn Quy]%[1H2B2]
	...
	\loigiai{Gọi $I$ là trung điểm của $SD$. Xét tam giác $IAC$ có: $\dfrac{IG}{IA}=\dfrac{IE}{IC}=\dfrac{1}{3}$.
		\immini[thm]{Theo định lí đảo của định lí Thalet, ta có $GE||AC$\quad (1).\\
...
\begin{ex}%[1H2B2-4]%
	...
	{Hình bình hành $MNIJ$}
	\loigiai{
		\immini[thm]{Ta có $ MN\parallel AB $; $ MN=\dfrac{1}{2}AB$ và $PQ \parallel CD; PQ=\dfrac{1}{2}CD$. Từ đó, suy ra $MN=PQ$ và $ MN\parallel PQ$.\\
