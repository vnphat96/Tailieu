...
\begin{ex}%[Ân Thọ]%[1H2B2]
	\immini[thm]{Cho tứ diện $ABCD$. Gọi $M$ và $N$ là hai điểm phân biệt nằm trên đường thẳng $AB$, $M’$ và $N’$ là hai điểm phân biệt nằm trên đường thẳng $CD$. Các mệnh đề sau đây, mệnh đề nào đúng?	
		\choice
