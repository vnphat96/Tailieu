...
{\True Chéo nhau}
\loigiai{
\immini[thm]{Ta có $a$ và $ b$ là hai đường thẳng chéo nhau nên $a$ và $ b$ không đồng phẳng.\\
...
{trùng nhau}
\loigiai{
\immini[thm]{Do đường thẳng $a$ nằm trên $mp(P)$ , đường thẳng $b$ cắt $(P)$ tại $O$ và $O$ không thuộc $a$ nên đường thẳng $a$ và đường thảng $b$ không đồng phẳng nên vị trí tương đối của $a$ và $b$ là chéo nhau.}{\begin{tikzpicture}[line join=round, line cap=round,>=stealth,thick]
				%%mp 1
\coordinate (I) at (0,0);
\coordinate (J) at (2,2);
\coordinate (K) at (5,0);
...
{$ BD$}
\loigiai{
\immini[thm]{Do $ IJ$ là đường trung bình của tam giác $ SAC\Rightarrow IJ\parallel AC$.}{\begin{tikzpicture}[line join=round, line cap=round,thick,scale=0.6]
\coordinate (A) at (0,0);
 		\coordinate (B) at (2,-2);
	 		\coordinate (D) at (5,0);
...
{$ GK\parallel SB$}
\loigiai{
\immini[thm]{Gọi $ M,N$ lần lượt là trung điểm của $ AB,BC$. \\
...
{$ PQ$ và $ RT$}
\loigiai{
 \immini[thm]{Ta có: $M$, $Q$ lần lượt là trung điểm của $AC$, $CD$\\
...
{$ AB$}
\loigiai{
\immini[thm]{Gọi $ N$ là trung điểm của $ SA$.\\
...
{$ MN$}
\loigiai{
 \immini[thm]{Gọi $ M$, $N$ lần lượt là trung điểm của $AB$, $CD$ và $G_1$, $G_2$ lần lượt là trọng tâm của các tam giác $ SAB$, $ SCD$ nên $G_1\in SM,G_2\in SN$\\
...
{\True $ SC$}
\loigiai{
 \immini[thm]{Ta có $ C'D'\parallel CD$; $A'B'\parallel AB$, mà $ AB\parallel CD.$ \\
 Do đó 
...
{$ IJ$ cắt $ AB$}
\loigiai{
\immini[thm]{Gọi $ E$ là trung điểm $ AB$.\\
...
{$ SC$}
\loigiai{
 \immini[thm]{Gọi $ H$ và $ K$ lần lượt là trung điểm cạnh $ AB;\,AD$. Với $ G$ và $ G'$ lần lượt là trọng tâm tam giác $ SAB$ và $ SAD$ ta có: $\dfrac{SG}{SH}=\dfrac{SG'}{SK}=\dfrac{2}{3}\Rightarrow GG'//HK$.\\
...
{$ GE$ cắt $CD$}
\loigiai{
 \immini[thm]{Gọi $ M$ là trung điểm của $ AB$.\\ Trong tam giác $ MCD$ có $\dfrac{MG}{MD}=\dfrac{ME}{MC}=\dfrac{1}{3}$ suy ra $ GE{\rm{//}}CD$}{ \begin{tikzpicture}[line join=round, line cap=round,thick]
 		\coordinate (A) at (0,4);
 		\coordinate (B) at (-2,0);
 		\coordinate (C) at (0,-3);
 		\coordinate (D) at (3,0);
...
{$ NP\parallel BC$}
\loigiai{
\immini[thm]{Do $(P)\parallel \left(ABC\right)$ nên $ AB\parallel (P)$.\\
...
{$\dfrac{3}{2}$}
\loigiai{
\immini[thm]{Gọi $E$ và $F$ lần lượt là trung điểm $AB$ và $CD$.\\
...
\begin{ex}%[1K4BA-3]
	...
	\loigiai{
		\immini[thm]{Ta có hai mặt phẳng $(S A D)$ và $(S B C)$ có $1$ điểm chung là $S$ và lần lượt chứa hai đường thẳng $A D$ và $B C$ song song nhau nên giao tuyến $d$ của hai mặt phẳng $(S A D)$ và $(S B C)$ đi qua $S$ và song song $A D$,  $B C$.
		}{
...
\begin{ex}%[1K4BA-3]
	...
	{$BD$}
	\loigiai{
		\immini[thm]{ Ta có $A D \parallel B C \Rightarrow(S A D) \cap(S B C)=d$, với $d$ là đường thẳng đi qua $S$ và song song với $A D$.	}{
			\begin{tikzpicture}[scale=0.7, font=\footnotesize, line join=round, line cap=round, >=stealth]
				\def\a{4}
				\path 	(0:0) coordinate (A)
				++(0:\a+2) coordinate (D)
...
\begin{ex}%[1K4BA-3]
	...
	{$SA$}
	\loigiai{
		\immini[thm]{Xét $\triangle A B C$ có $M$ và $N$ lần lượt là trung điểm của $A B$ và $A C$ nên $M N$ là đường trung bình suy ra $M N \parallel B C$.\\
...
\begin{ex}%[1K4BA-3]
	...
	\loigiai{
		\immini[thm]{ Gọi $O=A C \cap B D$. Ta có $(S A C) \cap(S B D)=S O$.\\
...
\begin{ex}%[1K4BA-5]
	...
	{$AB=CD$}
	\loigiai{
		\immini[thm]{Xét tam giác $AB D$ có $M N$ là đường trung bình nên $M N \parallel B D$, $M N=\dfrac{1}{2} B D$.\\ Tương tự tam giác $B C D$ có $P Q$ là đường trung bình nên $P Q \parallel B D$, $P Q=\dfrac{1}{2} B D$.\\
...
\begin{ex}%[1K4KA-5]
	...
	{Hình thang}
	\loigiai{
		\immini[thm]{ Ta có $(B M C) \cap(A B C D)=B C$, $(B M C) \cap(S A B)=B M$. \\
...
\begin{ex}%[1K4KA-5]
	...
	{\True Lục giác}
	\loigiai{
		\immini[thm]{Ta có $\heva{&M N \parallel A C \\ &N P \parallel A B'} \Rightarrow(M N P) \parallel\left(A B' C\right)$.\\
...
\begin{ex}%[1K4KA-5]
	...
	\loigiai{
		\immini[thm]{ $M N$ không song song với $B D$. Suy ra trong $(S B D)$ ta có $M N$ cắt $B D$. Do đó đáp án \,\lq\lq  Đường thẳng $M N$ cắt mặt phẳng $(A B C D)$\rq\rq\, đúng.\\
...
\begin{ex}%[1K4KA-5]
	...
	{Ngũ giác}
	\loigiai{
		\immini[thm]{Gọi $\alpha$ là mặt phẳng đi qua $M$ và song song với $B C$ và $A D$.\\
...
\begin{ex}%[1K4KA-5]
	...
	{Hai đường thẳng $M N$ và $S C$ chéo nhau}
	\loigiai{
		\immini[thm]{ $M N \cap B D=I \Rightarrow M N \cap(A B C D)=I$. nên \,\lq\lq  Đường thẳng $M N$ cắt mặt phẳng $(A B C D)$\rq\rq\, đúng.\\
...
\begin{ex}%[1K4KA-5]
	...
	\loigiai{
		\immini[thm]{ Vì $M N \parallel A B \Rightarrow A B \parallel(M N P)$ mà $A B \subset(A B C D)$ nên $m p(M N P)$ cắt $m p(A B C D)$ theo giao tuyến là đường thẳng qua $P$ và song song với $A B$.\\
...
\begin{ex}%[1K4KA-5]
	...
	\loigiai{
		\immini[thm]{Do $M, N$ lần lượt là trung điêm của $A B, A C \Rightarrow M N \parallel B C$.\\
			Ta có
			$$
			\heva{&
...
\begin{ex}%[1K4KA-5]
	...
	{\True $k=3$}
	\loigiai{
		\immini[thm]{Dễ thấy giao tuyến của hai mặt phẳng $(G I J)$ và $(S A B)$ là đường thẳng $G x$ đi qua $G$ và song song với các đường thẳng $A B, I J$. Giao tuyến $G x$ cắt $S A$ tại $M$ và cắt $S B$ tại $N$.\\
...
\begin{ex}%[1K4KA-5]
	...
	{hình ngũ giác}
	\loigiai{
		\immini[thm]{ Xét trong mặt phẳng $(S B C)$ ta có $N G \cap B C=\{P\}$.\\
