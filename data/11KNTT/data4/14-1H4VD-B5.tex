...
\begin{vd}
	...
	\loigiai{
	\immini[thm]{Vì hình chóp $S.ABCD$ có $AB \parallel CD$ và $AB=2$ cm, $CD=6$ cm nên hình biễu diễn của hình chóp cũng có đáy $AB \parallel CD$ và $\dfrac{AB}{CD}=\dfrac{2}{6}=\dfrac{1}{3}$.\\
