...
\begin{vd}%[1K4BA-2]
\immini[thm]{Cho hai hình bình hành $A B C D$ và $A B E F$ không cùng nằm trong một mặt phẳng.
\begin{enumerate}[a)]
...
\loigiai{
\immini[thm]{$\triangle ABC$ có $ON$ là đường trung bình.\\
...
\loigiai{
\immini[thm]{Gọi $M$ là trung điểm của $BC$ nên $\dfrac{M G}{M A}=\dfrac{1}{3}$; $\dfrac{M G'}{M S}=\dfrac{1}{3}$ (tính chất của trọng tâm).\\
...
{$AB$}
\loigiai{
\immini[thm]{Ta có $I J \parallel A B$ (tính chất đường trung bình trong tam giác $S A B$ ) và $E F \parallel C D$ (tính chất đường trung bình trong tam giác $S C D$ ).\\
