...
\begin{vd}
	...
	\loigiai{\immini[thm]{Gọi $E$ là trung điểm $AB$. Ta có $\heva{&I\in CE\\&J\in DE}\Rightarrow IJ$ và $CD$ đồng phẳng.\\
...
\begin{vd}
	...
	\loigiai{
		\begin{enumerate}[a)]
			\immini[thm]{	\item Chứng minh $MN\parallel PQ$.\\
...
\begin{vd}
	...
	\loigiai{
		\begin{enumerate}
			\immini[thm]{	\item $\heva{& S \in (SAB) \cap (SCD)\\& AB \subset (SAB),~ CD \subset (SCD)\\& AB \parallel CD}$\\
