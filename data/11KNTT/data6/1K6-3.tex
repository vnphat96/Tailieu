...
\end{center}
% \begin{note}
% 	\immini[thm]{Từ tính liên tục và sự biến thiên của hàm số mũ, ta có thể chứng minh được mệnh đề sau:
...
\begin{ex}
	\immini[thm]{	Đồ thị trong hình vẽ bên dưới là đồ thị của hàm số nào sau đây?
		\choice
		{$y=(\sqrt{2})^x$}
		{$y=\left(\dfrac{1}{2}\right)^x $}
...
\end{ex}
\begin{ex}
	\immini[thm]{	Cho đồ thị ba hàm số $ y=a^x $, $ y=b^x $, $ y=c^x $ như hình vẽ bên. Kết luận nào sau đây đúng?
		\choice
		{\True $0<c<1<b<a$}
		{$0<a<1<c<b$}
		{$0<a<1<b<c$}
...
\begin{ex}
	\immini[thm]{	Đường cong ở hình bên là đồ thị của một hàm số trong bốn hàm số được liệt kê ở bốn
...
\begin{ex}
	\immini[thm]{Đồ thị như hình vẽ bên là đồ thị của hàm số nào trong các hàm số sau
		\choice
		{$y=\log_\frac{3}{2}x$}
...
\begin{ex}
	\immini[thm]{Cho đồ thị hàm số $y=a^x, y= \log_b x$ (như hình vẽ). Khẳng định nào sau đây đúng?
		\choice
		{$0<b<1<a$}
		{\True $0<a<1<b$}
		{$a, b >1$}
...
\begin{ex}
	\immini[thm]{Cho đồ thị hàm số $y=a^x$, $y=\log_b x$ như hình vẽ. Trong các khẳng định sau, đâu là khẳng định đúng?
		\choice
		{\True $0<b<1<a$}
		{$a>1$, $b>1$}
		{$0<a<1<b$}
...
\begin{ex}
	\immini[thm]{Cho đồ thị của ba hàm số $y=\log _{a} x$, $y=\log _{b} x$,  $y=\log _{c} x$ như hình vē. Khẳng định nào sau đây đúng?
		\choice
		{$b>c>a$}
		{\True $b>a>c$}
		{$c>a>b$}
