...
%			\hline 
%			$\ln 6{,}52$ & \lnk \sixk \dotk \fivek \twok \equalk & $1{.}874874376$ & $\ln 6{,}52 \approx 1{,}8749$ \\ 
%			\hline 
...
\begin{bt}
	...
	\loigiai{
		...
		\begin{eqnarray*}
			...
			&=&-\ln\left(2^3\cdot 3^2\right)=-3\ln2-2\ln3=-3a-2b.
		\end{eqnarray*}
	}
\end{bt}
\begin{bt}
...
\begin{ex}
	...
	\loigiai{
		...
		Ta có $T=\log _{10 e}(10 a)=\dfrac{\ln \left({10\cdot10^b}\right) }{\ln {(10e)}}=\dfrac{\ln10+b.\ln 10}{\ln 10+\ln e}=\dfrac{c+bc}{c+1}$.}
\end{ex}
\begin{ex}
