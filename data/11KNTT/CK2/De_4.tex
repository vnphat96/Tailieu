...
% \end{tikzpicture}}
\loigiai{
\immini[thm]{Vì $ SB\perp (ABCD)$ nên hình chiếu của $ SD $ lên $(ABCD)$ là $ BD $ nên góc giữa đường thẳng $ SD $ và mặt phẳng $(ABCD)$ là $\widehat{SDB}$.}
{\begin{tikzpicture}[scale=0.5, font=\footnotesize,line join=round, line cap=round,>=stealth]
\tkzDefPoints{0/0/B,-2/-2/A,5/0/C,3/-2/D,0/5/S}
\tkzDrawSegments(S,A S,C S,D A,D D,C)
...
\begin{ex}%[1H8C7-7]%[Phạm Hoàng Điệp]%[Đợt 1 - HSA - Đề 22]
