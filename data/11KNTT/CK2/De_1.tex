...
\begin{ex}%[1H8N6-1]
\immini[thm]{	Cho hình chóp $S.ABC$ có $\triangle ABC$ vuông tại $B$ và $SA\perp \left(ABC\right)$. Góc giữa đường thẳng $SC$ và mặt phẳng $\left(SAB\right)$ là góc nào sau đây?
\choice
{$\widehat{SAC}$}
{$\widehat{CSA}$}
{\True $\widehat{CSB}$}
...
\begin{ex}%[1H8V7-2]%[Tex hoá đề CK2-form 2025-Đợt 2-Nguyễn Kiều Nhã Tú]
Cho hình chóp $S.ABC$ có đáy $ABC$ là tam giác đều cạnh $1$, biết khoảng cách từ $A$ đến $(SBC)$ là $\dfrac{\sqrt{6}}{4}$, từ $B$ đến $(SCA)$ là $\dfrac{\sqrt{15}}{10}$, từ $C$ đến $(SAB)$ là $\dfrac{\sqrt{30}}{20}$ và hình chiếu vuông góc $H$ của $S$ xuống đáy nằm trong tam giác $ABC$. Thể tích khối chóp $V_{S.ABC}$ bằng $\dfrac{a}{b}$  ($\dfrac{a}{b}$ là phân số tối giản). Khi đó $a+b$ bằng
\shortans[0]{$49$}
\loigiai{
\immini[thm]{Gọi $M$, $N$, $P$ lần lượt là hình chiếu của $H$ lên $AC$, $BC$, $AB$.\\
Đặt $SH=h \Rightarrow V_{S.ABC}=\dfrac{1}{3} \cdot h \cdot \dfrac{\sqrt{3}}{4}=\dfrac{h \sqrt{3}}{12}$.\\
$S P=\dfrac{2 S_{SAB}}{AB}=2 S_{SAB}=\dfrac{6 V_{S.ABC}}{d(C,(SAB))}=\dfrac{h \sqrt{3}}{2} \div \dfrac{\sqrt{30}}{20}=h \sqrt{10}$.\\
Suy ra $P H=\sqrt{SP^2-S H^2}=3 h$.\\
Tương tự, tính được $H M=2h$, $HN=h$.\\
Ta có $S_{ABC}=S_{HAB}+S_{HAC}+S_{HBC}=\dfrac{1}{2}(HP+HM+HN) \Leftrightarrow 3h=\dfrac{\sqrt{3}}{4} \Leftrightarrow h=\dfrac{\sqrt{3}}{12}$.\\
$V_{S.ABC}=\dfrac{\sqrt{3}}{12} \cdot \dfrac{\sqrt{3}}{12}=\dfrac{1}{48}$. Suy ra $a+b=49$.}
{
\begin{tikzpicture}
\def\a{5}
\def\h{4}
...
($(C)!2/3!(P)$) coordinate (H)
($(C)!1/2!(A)$) coordinate (M)
($(C)!1/2!(B)$) coordinate (N)
($(H)+(90:\h)$) coordinate (S);
\draw (C)--(A) (C)--(B)
(A)--(S)	(B)--(S)	(C)--(S);
\draw[dashed] (A)--(B) (S)--(H) (P)--(H)--(M) (H)--(N);
\foreach \x / \goc in {A/180,B/0,C/-135,H/125,P/45,S/90,M/-135,N/-45}
\fill (\x) circle (1.5pt)
($(\x)+(\goc:3mm)$) node {$\x$};
\end{tikzpicture}
}
...
\loigiai{\immini[thm]{Gọi $O$ là tâm của hình vuông $ABCD$.\\
...
\shortans[0]{$49$}
\loigiai{
\immini{Gọi $M$, $N$, $P$ lần lượt là hình chiếu của $H$ lên $AC$, $BC$, $AB$.\\
Đặt $SH=h \Rightarrow V_{S.ABC}=\dfrac{1}{3} \cdot h \cdot \dfrac{\sqrt{3}}{4}=\dfrac{h \sqrt{3}}{12}$.\\
$S P=\dfrac{2 S_{SAB}}{AB}=2 S_{SAB}=\dfrac{6 V_{S.ABC}}{d(C,(SAB))}=\dfrac{h \sqrt{3}}{2} \div \dfrac{\sqrt{30}}{20}=h \sqrt{10}$.\\
Suy ra $P H=\sqrt{SP^2-S H^2}=3 h$.\\
Tương tự, tính được $H M=2h$, $HN=h$.\\
