...
%Câu 3
\begin{ex}
\immini[thm]{Hàm số nào có đồ thị như hình bên dưới đây?
\choice
{$y=\log _2x$}
{$y=\log_{\tfrac{1}{2}}x$}
{\True $y=2^x$}
...
%Câu 17
\begin{ex}
Gieo đồng thời một con xúc xắc và một đồng xu cân đối đồng chất. Xác suất đồng xu xuất hiện mặt ngửa và con xúc xắc xuất hiện mặt $6$ chấm là
\choice
{$\dfrac{1}{2}$}
{$\dfrac{1}{6}$}
{$\dfrac{2}{3}$}
