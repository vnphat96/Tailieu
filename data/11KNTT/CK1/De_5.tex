...
\begin{ex}%[1H4H1-3]
\immini[thm]{Cho hình chóp $S.ABCD$ có đáy là hình thang với đáy lớn $AB$. Gọi $M$ là trung điểm $SC$. Tìm giao tuyến của mặt phẳng $(MAD)$ và $(SBC)$.
\choice
...
\loigiai
{\immini[thm]{Gọi $I=CM \cap BD$, khi đó $SI$ và $MN$ cùng thuộc $(SCM)$ nên cắt nhau tại $K$.\\
...
\loigiai{
\immini[thm]{Ta có: $\heva{&AB\parallel CD\\&M\in (CMD)\cap (SAB)\\&CD\subset (CMD),AB\subset (SAB)}$\\
