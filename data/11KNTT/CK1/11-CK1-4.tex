...
\begin{ex}%[1H4C3-4]
	...
	\shortans{1}
	\loigiai{
		\immini[thm]{Trong mặt phẳng $(ABC)$, gọi $M$ là giao điểm của $AI$ và $BC$.\\ Trong mặt phẳng $(SAM)$, kẻ $IA'$ song song $SA$ cắt $SM$ tại $A'$.\\ Điểm $A'$ là điểm cần tìm. Tương tự ta xác định các điểm $B',C'$.\\ Vì $IA' \parallel SA$ nên $\dfrac{IA'}{SA}=\dfrac{MI}{MA}$.\\
