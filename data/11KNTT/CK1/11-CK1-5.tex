...
%=======Câu 9
\begin{ex}%[1H4H3-3]
	\immini[thm]{	Cho tứ diện $ABCD$, gọi $I$, $J$, $K$ lần lượt là trung điểm của $AC$, $BC$, $BD$. Giao tuyến của hai mặt phẳng $(ABD)$ và $(IJK)$ là
		\choice
...
\begin{ex}%[1H4H5-3]
	...
	\loigiai{
		\immini[thm]{	Vì $B'D' \parallel BD$ nên $B'D' \parallel\left(BDC'\right)$.\\
