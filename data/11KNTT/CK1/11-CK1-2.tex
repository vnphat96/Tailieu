...
\end{name}
\caulc
\Opensolutionfile{ans}[ans/11-CK1-2]
...
\begin{ex}%[1H4H2-3]%[Dự án tex đề HK1 năm học 2024-2025, Huỳnh Quy]
	\immini[thm]{Cho hình chóp $S. ABCD$ có đáy là hình thang đáy lớn $AD$. Gọi $M$, $N$ lần lượt là trung diểm của $SB$, $SD$. Giao tuyến của hai mặt phẳng $(AMN)$ và $(ABCD)$ là đường thẳng song song với
	\choice
	{Đường thẳng $AC$}
	{Đường thẳng $CD$}
	{Đường thẳng $AD$}
...
\shortans{$10$}
\loigiai{
\immini[thm]{Gọi $O$ là tâm hình bình hành $ABCD$. Gọi $H=MN\cap SO$, khi đó $K=SC\cap AH$.\\
