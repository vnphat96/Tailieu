...
\begin{ex}%[Đỗ Minh Phúc]%[1K5BE-2]
	...
	\loigiai{
		Ta có $\lim \limits{n \to +\infty}\dfrac{n^2+1}{2n^2+n+1}=\lim \limits{n \to +\infty}\dfrac{1+\dfrac{1}{n^2}}{2+\dfrac{1}{n}+\dfrac{1}{n^2}}=\dfrac{1}{2}$.}
\end{ex}
...
\begin{ex}%[Đỗ Minh Phúc]%[1K5BE-2]
	...
	{$1$}
	\loigiai{
		Ta có $\lim \limits{n \to +\infty}\dfrac{2023^n+2024^n}{2025^n}=\lim \limits{n \to +\infty}\left(\dfrac{2023}{2025} \right)^n+ \lim \limits{n \to +\infty}\left(\dfrac{2024}{2025}\right)^n=0+0=0$.}
\end{ex}

\begin{ex}%[Đỗ Minh Phúc]%[1K5BE-4]%
	Tìm $\lim \limits{n \to +\infty}\left(\sqrt{n^2+1}-2n\right)$ ta được kết quả là
	\choice
	{\True $-\infty$}
	{$+\infty$}
	{$0$}
	...
	\loigiai{
		\begin{itemize}
			\item Cách 1: $\lim\left(\sqrt{n^2+1}-2n\right)=\lim \limits{n \to +\infty}n\left(\sqrt{1+\dfrac{1}{n^2}}-2\right)=-\infty$\\
			(vì $\lim \limits{n \to +\infty}n=+\infty$ và $\lim\left(\sqrt{1+\dfrac{1}{n^2}}-2\right)=-1<0$).
			\item Cách 2: $\lim \limits{n \to +\infty}\left(\sqrt{n^2+1}-2n\right)=\lim\dfrac{n^2+1-4n^2}{\sqrt{n^2+1}+2n}=\lim\dfrac{-3n+\dfrac{1}{n}}{\sqrt{1+\dfrac{1}{n^2}}+2}=-\infty$.
		\end{itemize}
	}
\end{ex}
...
\begin{ex}%[Đỗ Minh Phúc]%[1K5KE-3]%
	Tính $\lim \limits{n \to +\infty}n\left(\sqrt{4n^2+3}-\sqrt[3]{8n^3+n}\right)$.
	\choice
	{\True $\dfrac{2}{3}$}
	{$+\infty$}
	{$-\infty$}
	...
	\loigiai{Ta có
		\begin{align*}
			&\lim \limits{n \to +\infty}n\left(\sqrt{4n^2+3}-\sqrt[3]{8n^3+n}\right)\\
			=&\lim \limits{n \to +\infty}n\left[\left(\sqrt{4n^2+3}-2n\right)+\left(2n-\sqrt[3]{8n^3+n}\right)\right]\\
			=&\lim \limits{n \to +\infty}n\left[\dfrac{3}{\sqrt{4n^2+3}+2n}+\dfrac{-n}{(2n)^2+2n\cdot\sqrt[3]{8n^3+n}+\sqrt[3]{8n^3+n}^2} \right]\\
			=&\lim \limits{n \to +\infty}\left[\dfrac{3}{\sqrt{4+\dfrac{3}{n^2}}+2}+\dfrac{-1}{2^2+2\sqrt[3]{8+\dfrac{1}{n^2}}+\sqrt[3]{8+\dfrac{1}{n^2}}^2}\right]\\
			=&\dfrac{2}{3}.
		\end{align*}
	}
\end{ex}
...
\begin{ex}%[Đỗ Minh Phúc]%[1K5KE-2]
	...
	{\True $10$}
	\loigiai{
		Ta có $$\lim \limits{n \to +\infty}u_n=\lim \limits{n \to +\infty}\dfrac{\sqrt{2n^3+n}+3n-1}{\sqrt{6n^3+2n^2}+n}=\lim \limits{n \to +\infty}\dfrac{\sqrt{2+\dfrac{1}{n^2}}+\dfrac{3}{\sqrt{n}}-\dfrac{1}{n\sqrt{n}}}{\sqrt{6+\dfrac{2}{n}}+\dfrac{1}{\sqrt{n}}}=\sqrt{\dfrac{1}{3}}.$$
...
\begin{ex}%[Đỗ Minh Phúc]%[1K5BG-2]%
	\immini{Cho hàm số $y=f(x)$ có đồ thị dưới đây, trên khoảng $(-2;3)$ hàm số gián đoạn tại điểm nào?
		...
		{\True $x=1$}
		{$x=2$}
		{$x=3$}}{	\begin{tikzpicture}[line join=round, line cap=round, >=stealth, scale=0.5]
