...
\begin{bt}%[DCHT Toán 11 - KNTT -Hứa Chí Ninh]%[1K5KG-4]
	...
	\loigiai{
		...
		Ta có $\left\{ \begin{aligned}
			...
			& \lim\limits_{x\to {1^{+}}}{\mathop{\,\,\lim }}\,f\left( x \right)=\,\lim\limits_{x\to {1^{+}}}{\mathop{\lim {x^3}=1}}\, \\
...
% 			Tại $x_0=400$, ta có
% 			\begin{eqnarray*}
% 				&& \lim\limits_{x \rightarrow 400^-} P(x)=\lim _{x \rightarrow 400^{-}}(4{,}5 x)=4{,}5 \cdot 400=1800. \\
% 				&& \lim _{x \rightarrow 400^{+}} P(x)=\lim _{x \rightarrow 400^{+}}(4 x)=4 \cdot 400=1600.
% 			\end{eqnarray*}
