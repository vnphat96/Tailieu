...
% 			Tại $x_0=400$, ta có
% 			\begin{eqnarray*}
% 				&& \lim\limits_{x \rightarrow 400^-} P(x)=\lim \limits_{n \to +\infty}_{x \rightarrow 400^{-}}(4{,}5 x)=4{,}5 \cdot 400=1800. \\
% 				&& \lim \limits_{n \to +\infty}_{x \rightarrow 400^{+}} P(x)=\lim \limits_{n \to +\infty}_{x \rightarrow 400^{+}}(4 x)=4 \cdot 400=1600.
% 			\end{eqnarray*}
