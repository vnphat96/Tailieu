...
% 			Tại $x_0=400$, ta có
% 			\begin{eqnarray*}
% 				&& \lim\limits_{x \rightarrow 400^-} P(x)=\lim \limits_{x \rightarrow 400^{-}}(4{,}5 x)=4{,}5 \cdot 400=1800. \\
% 				&& \lim \limits_{x \rightarrow 400^{+}} P(x)=\lim \limits_{x \rightarrow 400^{+}}(4 x)=4 \cdot 400=1600.
% 			\end{eqnarray*}
...
% 	\immini[thm]{Hình bên cạnh biểu thị độ cao $ h $ (m) của một quả bóng được đá lên thời gian $ t $ (s), trong đó $ h(t)= -2t^{2}+8t$. Kết luận nào sau đây là đúng?
% 		\choice
...
% 	\loigiai{
% 		\immini[thm]{Đồ thị hàm số $f(x)$ là một đường liền nét trên khoảng $(1;5)$.\\
