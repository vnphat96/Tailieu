...
\begin{vd}%[1C3K1-6]
	\immini[thm]{Từ hình vuông có độ dài cạnh bằng $1$, người ta nối các trung điểm của cạnh hình vuông để tạo ra hình vuông mới như hình bên. Tiếp tục quá trình này đến vô hạn.
		\begin{enumEX}{1}
...
\begin{vd}%[1C3G1-6]
	...
	\immini[thm]{	Gọi $p_n$ là độ dài của $C_n$, $S_n$ là diện tích hình phẳng giới hạn bởi $C_n$ và đoạn thẳng $AB$.
		\begin{enumEX}{1}
			\item Tính $p_n$, $S_n$.
...
\end{bt}
\begin{bt}%[1T3K1-5]
	\immini[thm]{Cho tam giác đều có cạnh bằng $a$, gọi là tam giác $H_1$. Nối các trung điểm của $H_1$ để tạo thành tam giác $\mathrm{H}_2$. Tiếp theo, nối các trung điểm của $\mathrm{H}_2$ để tạo thành tam giác $\mathrm{H}_3$ (Hình bên). Cứ tiếp tục như vậy, nhận được dãy tam giác $H_1, H_2, H_3, \ldots$\\
