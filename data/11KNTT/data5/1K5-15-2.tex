...
\begin{vd}
    ...
    &= \lim \limits_{n \to +\infty}\dfrac{- 2 + \frac{3}{n}}{\sqrt{1 - \frac{2}{n} + \frac{3}{n^2}} + 1} \\
    &= \dfrac{- 2}{\sqrt{1} + 1} = - 1
    \end{align*}
    }
\end{vd} 
...
\begin{vd}
    ...
    &= \lim \limits_{n \to +\infty}\dfrac{4}{\sqrt{1 + \frac{2}{n}} + \sqrt{1 - \frac{2}{n}}} \\
...
\begin{vd}
    ...
    &= \lim \limits_{n \to +\infty}\dfrac{2 - \frac{1}{n}}{\sqrt{2 - \frac{1}{n} + \frac{1}{n^2}} + \sqrt{2 - \frac{3}{n} + \frac{2}{n^2}}} \\
...
I &= \lim \limits_{n \to +\infty}\left(n - \sqrt[3]{n^3 + 3n^2 + 1}\right) \\
 ...
 &= \lim \limits_{n \to +\infty}\dfrac{- 3 - \frac{1}{n^2}}{1 + \sqrt[3]{1 + \frac{3}{n} + \frac{1}{n^3}} + \sqrt[3]{\left(1 + \frac{3}{n} + \frac{1}{n^3}\right)^2}} \\ 
...
\loigiai{
    ...
    &= \lim \limits_{n \to +\infty}\dfrac{\frac{-2}{n}}{\sqrt[3]{\left(1 - \frac{2}{n^2}\right)^2} + \sqrt[3]{1 - \frac{2}{n^2}} + 1} \\
    &= 0 
    \end{align*}
    }
    \end{bt}
...
\loigiai{
    ...
    &= \lim \limits_{n \to +\infty}\dfrac{5}{\sqrt{4 + \frac{5}{n}} + 2} \\
...
\loigiai{
    ...
    &= \lim \limits_{n \to +\infty}\dfrac{- 30 + \frac{24}{n}}{3 - \frac{5}{n} + \sqrt{\frac{1}{n^2}}} \\
    &= \dfrac{- 30}{3 + \sqrt{9}} = - 5
    \end{align*}
    }
    \end{bt}  
...
\loigiai{
    ...
    &= \lim \limits_{n \to +\infty}\dfrac{\left(3 + \frac{4}{n} - \frac{1}{n^2}\right)\left(\sqrt{9 + \frac{1}{n}} + 2\right)}{\left(\sqrt{4 + \frac{2}{n}} + 1 - \frac{1}{n}\right)\left(5 + \frac{1}{n}\right)} \\
...
\loigiai{
    ...
    &= 0 + \lim \limits_{n \to +\infty}\dfrac{1 - \frac{5}{n}}{2 + \sqrt{4 - \frac{1}{n} + \frac{5}{n^2}}} \\
...
\loigiai{
    ...
    &= \lim \limits_{n \to +\infty}\dfrac{3 - \frac{1}{n} + \frac{2}{n^2}}{\sqrt{3 + \frac{1}{n^2}} + \sqrt{\frac{1}{n} - \frac{1}{n^2}}} \\
    &= \sqrt{3}
    \end{align*}
    }
    \end{bt}  
...
\Opensolutionfile{ans}[ans/ans-1K5-1-Dang2]
	...
	{3}
	\loigiai{
		Ta có $I = \lim \limits_{n \to +\infty}\left(\sqrt{n^2 + 2n + 3} - n\right) = \lim \limits_{n \to +\infty}\dfrac{2n + 3}{\sqrt{n^2 + 2n + 3} + n} = \lim \limits_{n \to +\infty}\dfrac{2 + \frac{3}{n}}{\sqrt{1 + \frac{2}{n} + \frac{3}{n^2}} + 1} = 1$
  }
    \end{ex}
    \begin{ex}%[1K5?E-4]
  ...
  \begin{ex}%[1K5?E-4]
	...
	{2}
	\loigiai{
		Ta có $I = \lim \limits_{n \to +\infty}\left(n - \sqrt{n^2 + 2n - 3}\right) = \lim \limits_{n \to +\infty}\dfrac{- 2n + 3}{n + \sqrt{n^2 + 2n - 3}} = \lim \limits_{n \to +\infty}\dfrac{- 2 + \frac{3}{n}}{1 + \sqrt{1 + \frac{2}{n} - \frac{3}{n^2}}} = - 1$
  }
    \end{ex}
  \begin{ex}%[1K5?E-4]
	...
	{0}
	\loigiai{
		Ta có $I = \lim \limits_{n \to +\infty}\left(\sqrt{n^2 - n + 1} - n\right) = \lim \limits_{n \to +\infty}\dfrac{- n + 1}{\sqrt{n^2 - n + 1} + n} = \lim \limits_{n \to +\infty}\dfrac{- 1 + \frac{1}{n}}{\sqrt{1 - \frac{1}{n} + \frac{1}{n^2}} + 1} = - \dfrac{1}{2}$
  }
    \end{ex}
  \begin{ex}%[1K5?E-4]
	...
	{0}
	\loigiai{
		Ta có $I = \lim \limits_{n \to +\infty}\left(\sqrt[3]{n^3 - n^2} - n\right)) = \lim \limits_{n \to +\infty}\dfrac{- n^2}{\sqrt[3]{(n^3 - n^2)^2} + n\sqrt[3]{(n^3 - n^2)} + n^2} = \lim \limits_{n \to +\infty}\dfrac{- 1}{\sqrt[3]{\left(1 - \frac{1}{n}\right)^2} + \sqrt[3]{1 - \frac{1}{n}} + 1} = - \dfrac{1}{3}$
  }
    \end{ex}
    \begin{ex}%[1K5?E-4]
	...
	\loigiai{
		Ta có $I = \lim \limits_{n \to +\infty}\left(\sqrt{2n^2 + 2n - 1} - \sqrt{2n^2 + n}\right) = \lim \limits_{n \to +\infty}\dfrac{n}{\sqrt{2n^2 + 2n - 1} + \sqrt{2n^2 + n}} = \lim \limits_{n \to +\infty}\dfrac{1}{\sqrt{2 + \frac{2}{n} - \frac{1}{n^2}} + \sqrt{2 + \frac{2}{n}}} = \dfrac{1}{2\sqrt{2}}$
  }
    \end{ex}
  \begin{ex}%[1K5?E-4]
  ...
  \begin{ex}%[1K5?E-4]
	...
	{\True $\dfrac{9}{2}$}
	\loigiai{
		Ta có $I = \lim \limits_{n \to +\infty}n\left(\sqrt{n^2 + n + 1} - \sqrt{n^2 + n - 8}\right) = \lim \limits_{n \to +\infty}\dfrac{9n}{\sqrt{n^2 + n + 1} + \sqrt{n^2 + n - 8}}\\ = \lim \limits_{n \to +\infty}\dfrac{9}{\sqrt{1 + \frac{1}{n} + \frac{1}{n^2}} + \sqrt{1 + \frac{1}{n} - \frac{8}{n^2}}} = \dfrac{9}{2}$ 
  }
    \end{ex}
