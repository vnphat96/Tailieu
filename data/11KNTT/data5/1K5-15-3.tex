...
\loigiai{
	...
	+ Nếu $c>0$\\
	$2=\lim \limits_{x \rightarrow+\infty}\left(\sqrt{a x^2+b x}-c x\right)=\lim \limits_{x \rightarrow+\infty} \frac{\left(\sqrt{a x^2+b x}-c x\right)\left(\sqrt{a x^2+b x}+c x\right)}{\sqrt{a x^2+b x}+c x}=\lim \limits_{x \rightarrow+\infty} \frac{\left(a-c^2\right) x^2+b x}{\sqrt{a x^2+b x}+c x}$ là hữu hạn nên: $a-c^2=0 \Leftrightarrow a=c^2$ (1)\\
	Khi đó: $2=\lim \limits_{x \rightarrow+\infty} \frac{b x}{\sqrt{a x^2+b x}+c x}=\lim \limits_{x \rightarrow+\infty} \frac{b}{\sqrt{a+\frac{b}{x}}+c}=\frac{b}{\sqrt{a}+c} \Leftrightarrow 2(\sqrt{a}+c)=b$\\
...
\end{ex}
\begin{ex}%[1K5?E-4]
	Tính $I=\lim \limits_{x \rightarrow+\infty} \frac{\sqrt{x^2+x+1}-x}{3}=\frac{a}{b} ; a, b \in \mathbb{N}$ và $\frac{a}{b}$ là phân số tối giản. Khi đó $2 a-b$ bằng kết quả nào sau đây?
\choice
{ 4 }
{\True -4}
{-5}
{5}
\loigiai{
	Ta có, $\lim \limits_{x \rightarrow+\infty} \frac{\sqrt{x^2+x+1}-x}{3}=\lim \limits_{x \rightarrow+\infty} \frac{\left(\sqrt{x^2+x+1}-x\right)\left(\sqrt{x^2+x+1}+x\right)}{3\left(\sqrt{x^2+x+1}+x\right)}$
	$$
	=\lim \limits_{x \rightarrow+\infty} \frac{\left(x^2+x+1\right)-x^2}{3\left(\sqrt{x^2+x+1}+x\right)}=\lim \limits_{x \rightarrow+\infty} \frac{x+1}{3\left(\sqrt{x^2+x+1}+x\right)}=\lim \limits_{x \rightarrow+\infty} \frac{1+\frac{1}{x}}{3\left(\sqrt{1+\frac{1}{x}+\frac{1}{x^2}}+1\right)}=\frac{1}{6}
	$$
...
\loigiai{
	$$
	\text { Ta có } I=\lim \limits_{x \rightarrow+\infty}\left(x+1-\sqrt{x^2-x+2}\right)=\lim \limits_{x \rightarrow+\infty} \frac{3 x-1}{x+1+\sqrt{x^2-x+2}}=\lim \limits_{x \rightarrow+\infty} \frac{3-\frac{1}{x}}{1+\frac{1}{x}+\sqrt{1-\frac{1}{x}+\frac{2}{x^2}}}=\frac{3}{2} \text {. }
	$$
}
\end{ex}
\begin{ex}%[1K5?E-4]
...
\loigiai{
	Ta có
	$$
	\lim \limits_{x \rightarrow a} \frac{x^4-a}{x-a}=\lim \limits_{x \rightarrow a} \frac{(x-a)(x+a)\left(x^2+a^2\right)}{x-a}=\lim \limits_{x \rightarrow a}\left[(x+a)\left(x^2+a^2\right)\right]=4 a^3
	$$
	Mà theo giả thiết $\lim \limits_{x \rightarrow a} \frac{x^4-a}{x-a}=4$. Do đó $4 a^3=4 \Leftrightarrow a=1$.}
\end{ex}
\begin{ex}%[1K5?E-4]	
...
{\True $\frac{a+3 b}{c}=5$}
\loigiai{
	Ta có: $\lim \limits_{x \rightarrow-\infty} \frac{a x-b \sqrt{9 x^2+2}}{c x+1}=5 \Leftrightarrow \lim \limits_{x \rightarrow-\infty} \frac{a x-b|x| \sqrt{9+\frac{2}{x^2}}}{c x+1}=5 \Leftrightarrow \lim \limits_{x \rightarrow-\infty} \frac{a+b \sqrt{9+\frac{2}{x^2}}}{c+\frac{1}{x}}=5$ $\Leftrightarrow \frac{a+b \sqrt{9+0}}{c+0}=5 \Leftrightarrow \frac{a+3 b}{c}=5$.}
\end{ex}
\begin{ex}%[1K5?E-4]
...
\end{ex}
\begin{ex}%[1K5?E-4]
	Biết $\lim \limits_{x \rightarrow-\infty}\left(\sqrt{x^2+b x+1}+a x\right)=-\frac{1}{2}$, tính giá trị biều thức $P=a+b$.
\choice
{1}
{3}
{\True 2}
{0}
\loigiai{
	Ta có $\lim \limits_{x \rightarrow-\infty}\left(\sqrt{x^2+b x+1}+a x\right)=\lim \limits_{x \rightarrow-\infty} x\left(-\sqrt{1+\frac{b}{x}+\frac{1}{x^2}}+a\right)$.\\
	Vì $\lim \limits_{x \rightarrow-\infty} x=-\infty$ và $\lim \limits_{x \rightarrow-\infty}\left(-\sqrt{1+\frac{b}{x}+\frac{1}{x^2}}+a\right)=-1+a$ nên để giới hạn đã cho là một số hữu hạn thi điều kiện là $-1+a=0 \Leftrightarrow a=1$.\\
	Với $a=1$ ta có $\lim \limits_{x \rightarrow-\infty}\left(\sqrt{x^2+b x+1}+x\right)=\lim \limits_{x \rightarrow-\infty} \frac{b x+1}{\sqrt{x^2+b x+1}-x}=\lim \limits_{x \rightarrow-\infty} \frac{b+\frac{1}{x}}{-\sqrt{1+\frac{b}{x}+\frac{1}{x^2}}-1}=-\frac{b}{2}$.\\
