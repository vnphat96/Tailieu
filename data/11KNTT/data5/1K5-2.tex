...
\begin{bt}%[DCHT Toán 11 - KNTT- Phạm Tuấn]%[1K5YF-8] 
	...
	\dapso{$\displaystyle \lim \limits_{v \rightarrow c^{-}} L =0$}
	\loigiai{
		Ta có $\displaystyle \lim \limits_{v \rightarrow c^{-}} L = \lim \limits_{v \rightarrow c^{-}} L_0 \sqrt{1-\frac{v^2}{c^2}} =  \lim \limits_{v \rightarrow c^{-}} L_0 \sqrt{1-\frac{c^2}{c^2}} =0$. 
	}
\end{bt}
