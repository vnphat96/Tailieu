...
% 		Chọn dãy số $x_n = -\dfrac{2}{n\pi }$. Dễ thấy $x_n<0$ và $\lim x_n =0$. \\
% 		Ta có $\lim \sin \dfrac{1}{2x} = \lim \sin (-n\pi ) =0$. \\
% 		Chọn dãy số $x_n = -\dfrac{2}{\frac{\pi}{2}+ n2\pi} $. Dễ thấy $x_n<0$ và $\lim x_n =0$. \\
% 		Ta có $\lim \sin \dfrac{1}{2x} = \lim \sin (-\frac{\pi}{2}- n2\pi ) =-1$.  \\
