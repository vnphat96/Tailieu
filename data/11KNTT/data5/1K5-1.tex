...
% 	\begin{enumEX}{2}
% 		\item $\lim \dfrac{2^n+3\cdot 4^n}{4^n-5\cdot 3^n}$.
% 		\item $T=\lim\dfrac{3\cdot7^n+2\cdot 4^n}{4\cdot 5^n+7^n}$.
% 	\end{enumEX}
% 	\loigiai{
% 		\begin{enumEX}{1}
% 			\item $\lim \dfrac{2^n+3\cdot 4^n}{4^n-5\cdot 3^n}=\lim \dfrac{\left(\dfrac {1} {2}\right)^n+3}{1-5\left(\dfrac {3} {4}\right)^n}=3$.
...
\begin{ex}%[1C3Y1-2]%[Anh Duy]%Câu 7.
	...
	{$\dfrac{\sin n}{\sqrt{n}}$}
	\loigiai{
		Có $\lim\dfrac{n+1}{n}=\lim 1+\lim\dfrac{1}{n}=1$.}
\end{ex}
...
\begin{vd}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5BE-3]
	...
	\loigiai{
		...
		\begin{align*}
			...
			&= \lim \dfrac{- 2 + \dfrac{3}{n}}{\sqrt{1 - \dfrac{2}{n} + \dfrac{3}{n^2}} + 1} \\
			&= \dfrac{- 2}{\sqrt{1} + 1} = - 1
		\end{align*}
	}
\end{vd} 
...
\begin{vd}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5KE-3]
	...
	\loigiai{
		...
		\begin{align*}
			...
			&= \lim \dfrac{2 - \dfrac{1}{n}}{\sqrt{2 - \dfrac{1}{n} + \dfrac{1}{n^2}} + \sqrt{2 - \dfrac{3}{n} + \dfrac{2}{n^2}}} \\
...
\begin{vd}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5GE-3]
	...
	\loigiai{
		...
		\begin{align*} 
			...
			&= \lim \dfrac{- 3 - \dfrac{1}{n^2}}{1 + \sqrt[3]{1 + \dfrac{3}{n} + \dfrac{1}{n^3}} + \sqrt[3]{\left(1 + \dfrac{3}{n} + \dfrac{1}{n^3}\right)^2}} \\ 
...
% 			&= \lim \dfrac{\dfrac{-2}{n}}{\sqrt[3]{\left(1 - \dfrac{2}{n^2}\right)^2} + \sqrt[3]{1 - \dfrac{2}{n^2}} + 1} \\
% 			&= 0 
% 		\end{align*}
% 	}
% \end{bt}
...
% 			&= \lim \dfrac{5}{\sqrt{4 + \dfrac{5}{n}} + 2} \\
...
% 			&= \lim \dfrac{- 30 + \dfrac{24}{n}}{3 - \dfrac{5}{n} + \sqrt{\dfrac{1}{n^2}}} \\
% 			&= \dfrac{- 30}{3 + \sqrt{9}} = - 5
% 		\end{align*}
% 	}
% \end{bt}  
...
% 			&= \lim \dfrac{\left(3 + \dfrac{4}{n} - \dfrac{1}{n^2}\right)\left(\sqrt{9 + \dfrac{1}{n}} + 2\right)}{\left(\sqrt{4 + \dfrac{2}{n}} + 1 - \dfrac{1}{n}\right)\left(5 + \dfrac{1}{n}\right)} \\
...
% 			&= 0 + \lim \dfrac{1 - \dfrac{5}{n}}{2 + \sqrt{4 - \dfrac{1}{n} + \dfrac{5}{n^2}}} \\
...
% 			&= \lim \dfrac{3 - \dfrac{1}{n} + \dfrac{2}{n^2}}{\sqrt{3 + \dfrac{1}{n^2}} + \sqrt{\dfrac{1}{n} - \dfrac{1}{n^2}}} \\
% 			&= \sqrt{3}
% 		\end{align*}
% 	}
% \end{bt}  
...
\begin{ex}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5TE-3]
	...
	{$3$}
	\loigiai{
		Ta có $I = \lim \left(\sqrt{n^2 + 2n + 3} - n\right) = \lim \dfrac{2n + 3}{\sqrt{n^2 + 2n + 3} + n} = \lim \dfrac{2 + \dfrac{3}{n}}{\sqrt{1 + \dfrac{2}{n} + \dfrac{3}{n^2}} + 1} = 1$
	}
\end{ex}
...
\begin{ex}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5BE-3]
	...
	{$2$}
	\loigiai{
		Ta có $I = \lim \left(n - \sqrt{n^2 + 2n - 3}\right) = \lim \dfrac{- 2n + 3}{n + \sqrt{n^2 + 2n - 3}} = \lim \dfrac{- 2 + \dfrac{3}{n}}{1 + \sqrt{1 + \dfrac{2}{n} - \dfrac{3}{n^2}}} = - 1$
	}
\end{ex}
\begin{ex}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5BE-3]
	...
	{$0$}
	\loigiai{
		Ta có $I = \lim \left(\sqrt{n^2 - n + 1} - n\right) = \lim \dfrac{- n + 1}{\sqrt{n^2 - n + 1} + n} = \lim \dfrac{- 1 + \dfrac{1}{n}}{\sqrt{1 - \dfrac{1}{n} + \dfrac{1}{n^2}} + 1} = - \dfrac{1}{2}$
	}
\end{ex}
\begin{ex}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5BE-3]
	...
	{$0$}
	\loigiai{
		Ta có $I = \lim \left(\sqrt[3]{n^3 - n^2} - n\right)) = \lim \dfrac{- n^2}{\sqrt[3]{(n^3 - n^2)^2} + n\sqrt[3]{(n^3 - n^2)} + n^2} = \lim \dfrac{- 1}{\sqrt[3]{\left(1 - \dfrac{1}{n}\right)^2} + \sqrt[3]{1 - \dfrac{1}{n}} + 1} = - \dfrac{1}{3}$
	}
\end{ex}
...
\begin{ex}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5BE-3]
	...
	\loigiai{
		Ta có $I = \lim \left(\sqrt{2n^2 + 2n - 1} - \sqrt{2n^2 + n}\right) = \lim \dfrac{n}{\sqrt{2n^2 + 2n - 1} + \sqrt{2n^2 + n}} = \lim \dfrac{1}{\sqrt{2 + \dfrac{2}{n} - \dfrac{1}{n^2}} + \sqrt{2 + \dfrac{2}{n}}} = \dfrac{1}{2\sqrt{2}}$
	}
\end{ex}
...
\begin{ex}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5BE-3]
	...
	{\True $\dfrac{9}{2}$}
	\loigiai{
		Ta có $I = \lim n\left(\sqrt{n^2 + n + 1} - \sqrt{n^2 + n - 8}\right) = \lim \dfrac{9n}{\sqrt{n^2 + n + 1} + \sqrt{n^2 + n - 8}}\\ = \lim \dfrac{9}{\sqrt{1 + \dfrac{1}{n} + \dfrac{1}{n^2}} + \sqrt{1 + \dfrac{1}{n} - \dfrac{8}{n^2}}} = \dfrac{9}{2}$ 
	}
\end{ex}
\Closesolutionfile{ans}
% \begin{indapan}{10}
...
\begin{vd}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5YE-4]
	Tìm giới hạn 
	\begin{enumEX}[a)]{2}
		\item[a)] $\lim (n^3 + n^2 + n + 1)$.
		\item[b)] $\lim \left(n^2 - n\sqrt{n} + 1\right)$.
	\end{enumEX}
	\loigiai{
		\begin{enumEX}[a)]{1}
			\item $\lim (n^3 + n^2 + n + 1) = \lim n^3\left(1 + \dfrac{1}{n} + \dfrac{1}{n^2} + \dfrac{1}{n^3}\right) = + \infty$.
			\item $\lim \left(n^2 - n\sqrt{n} + 1\right) = \lim n^2\left(1 - \dfrac{1}{\sqrt{n}} + \dfrac{1}{n^2}\right) = + \infty.$
		\end{enumEX}
	}
\end{vd}
\begin{vd}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5BE-4]
	Tìm giới hạn
	\begin{enumEX}[a)]{3}
		\item[a)] $\lim \dfrac{n^5 + n^4 - n - 2}{4n^3 + 6n^2 + 9}$.
		\item[b)] $\lim \dfrac{\sqrt[3]{n^6 - 7n^3 - 5n + 8}}{n + 12}$.
		\item[c)] $\lim \left(n + \sqrt{n^2 - n + 1}\right)$.
	\end{enumEX}
	\loigiai{
		\begin{enumEX}[a)]{1}
			\item $\lim \dfrac{n^5 + n^4 - n - 2}{4n^3 + 6n^2 + 9} = \lim \dfrac{n^2 + n - \dfrac{1}{n^2} - \dfrac{2}{n^3}}{4 + \dfrac{6}{n} + \dfrac{9}{n^3}} = \lim \dfrac{n^2 + n}{4} = + \infty$.
			\item $\lim \dfrac{\sqrt[3]{n^6 - 7n^3 - 5n + 8}}{n + 12} = \lim \dfrac{n^2\sqrt[3]{1 - \dfrac{7}{n^3} - \dfrac{5}{n^5} + \dfrac{8}{n^6}}}{n + 12} = \lim \dfrac{n\sqrt[3]{1 - \dfrac{7}{n^3} - \dfrac{5}{n^5} + \dfrac{8}{n^6}}}{1 + \dfrac{12}{n}} = + \infty$.
			\item $\lim \left(n + \sqrt{n^2 - n + 1}\right) = n\left(1 + \sqrt{1 - \dfrac{1}{n} + \dfrac{1}{n^2}}\right) = \lim 2n = + \infty$
		\end{enumEX}
	}
\end{vd}
\begin{vd}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5KE-4]
	Tìm giới hạn
	\begin{enumEX}[a)]{3}
		\item[a)] $\lim \dfrac{1^3 + 2^3 + ... + n^3}{n^2 + 3n\sqrt{n} + 2}$.
		\item[b)] $\lim \left(n + \sqrt[3]{n^3 - 2n + 1}\right)$.
		\item[c)] $\lim \dfrac{n^3 - 3n}{2n + 15}$.
	\end{enumEX}
	\loigiai{
		\begin{enumEX}[a)]{1}
			\item $\lim \dfrac{1^3 + 2^3 + ... + n^3}{n^2 + 3n\sqrt{n} + 2} = \lim \dfrac{\dfrac{1}{4}n^2(n + 1)^2}{n^2 + 3n\sqrt{n} + 2} = \lim \dfrac{\dfrac{1}{4}(n + 1)^2}{1 + \dfrac{3}{\sqrt{n}} + \dfrac{2}{n^2}} = \lim \dfrac{1}{4}(n + 1)^2 = + \infty$.
			\item $\lim \left(n + \sqrt[3]{n^3 - 2n + 1}\right) = n\left(1 + \sqrt[3]{1 - \dfrac{2}{n^2} + \dfrac{1}{n^3}}\right) = \lim 2n = + \infty$.
			\item $\lim \dfrac{n^3 - 3n}{2n + 15} = \lim \dfrac{n^2 - 3}{2 + \dfrac{15}{n}} = + \infty$
		\end{enumEX}
	}
\end{vd}
% \subsubsection{Bài tập rèn luyện} 
...
% 	Tìm giới hạn
% 	\begin{enumEX}[a)]{2}
% 		\item[a)] $\lim \sqrt{5n^2 - 8n + 7}$.
% 		\item[b)] $\lim \sqrt{n^3 - 5n + 6}$.
% 	\end{enumEX}
% 	\loigiai{
% 		\begin{enumEX}[a)]{1}
% 			\item $\lim \sqrt{5n^2 - 8n + 7} = \lim n\sqrt{5 - \dfrac{8}{n} + \dfrac{7}{n^2}} = + \infty$.
% 			\item $\lim \sqrt{n^3 - 5n + 6} = \lim n\sqrt{n} \sqrt{1 - \dfrac{5}{n^2} + \dfrac{6}{n^3}} = + \infty$.
% 		\end{enumEX}
% 	}
% \end{bt}
...
% 	Tìm giới hạn
% 	\begin{enumEX}[a)]{2}
% 		\item[a)] $\lim \dfrac{\sqrt{5n^4 - 8n^2 + 10}}{4n + 5}$.
% 		\item[b)] $\lim \dfrac{n^2 - 15n + 11}{\sqrt{n^2 - 8n + 7}}$.
% 	\end{enumEX}
% 	\loigiai{
% 		\begin{enumEX}[a)]{1}
% 			\item $\lim \dfrac{\sqrt{5n^4 - 8n^2 + 10}}{4n + 5} = \lim \dfrac{n^2\sqrt{5 - \dfrac{8}{n^2} + \dfrac{10}{n^4}}}{4n + 5} = \dfrac{n\sqrt{5 - \dfrac{8}{n^2} + \dfrac{10}{n^4}}}{4 + \dfrac{5}{n}} = \lim \dfrac{n\sqrt{5}}{4} = + \infty$.
% 			\item $\lim \dfrac{n^2 - 15n + 11}{\sqrt{n^2 - 8n + 7}} = \lim \dfrac{n - 15 + \dfrac{11}{n}}{\sqrt{1 - \dfrac{8}{n} + \dfrac{7}{n^2}}} = + \infty$.
% 		\end{enumEX}
% 	}
% \end{bt}
% \begin{bt}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5BE-4]
...
% 	\loigiai{
% 		$$
% 		\lim \left(\dfrac{1}{n^2}+\dfrac{2}{n^2}+\ldots+\dfrac{n}{n^2}\right)=\lim \left(\dfrac{1+2+\ldots+n}{n^2}\right)=\lim \left(\dfrac{n(n+1)}{2 n^2}\right)=\lim \left(\dfrac{1+\dfrac{1}{n}}{2}\right)=\dfrac{1}{2} .
% 		$$}
% \end{bt}
% \begin{bt}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5GE-4]
% 	Tính giới hạn: $\lim \left[\left(1-\dfrac{1}{2^2}\right)\left(1-\dfrac{1}{3^2}\right) \ldots\left(1-\dfrac{1}{n^2}\right)\right]$.\\
...
% 		\\ Khi đó $\lim \left[\left(1-\dfrac{1}{2^2}\right)\left(1-\dfrac{1}{3^2}\right) \ldots\left(1-\dfrac{1}{n^2}\right)\right]=\lim \dfrac{n+1}{2 n}=\dfrac{1}{2}$.}
% \end{bt}
% \begin{bt}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5BE-4]
...
% 		Suy ra $\lim S_n=\dfrac{u_1}{1-q}=\dfrac{3}{1+\dfrac{1}{5}}=\dfrac{5}{2}$.}
% \end{bt}
...
% 		Quảng đường quả bóng đã bay từ lúc thả đến lúc không máy nữa bằng: $\lim \left[8+48\left(1-\left(\dfrac{3}{4}\right)^{n-1}\right)\right]=8+48=56$.}
% \end{bt}
% \begin{bt}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5GE-4]
...
% 	Giá trị của giới hạn $\lim \left(1+\dfrac{1}{2}+\dfrac{1}{2^2}+\ldots+\dfrac{1}{2^n}\right)$ là
% 	\choice
% 	{$1$}
% 	{\True $2$} 
% 	{$\dfrac{1}{2}$}
% 	{$\dfrac{3}{2}$}
% 	\loigiai{
% 		Ta có: $\lim \left(1+\dfrac{1}{2}+\dfrac{1}{2^2}+\ldots+\dfrac{1}{2^n}\right)=\dfrac{1}{1-\dfrac{1}{2}}=2$.}
% \end{ex}
% \begin{ex}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5BE-4]
% 	Tính giới hạn $I=\lim \dfrac{5\cdot4^{n+1}+3^{n+2}}{2^{2 n+1}+1}$.
% 	\choice
% 	{$I=+\infty$}
% 	{\True $I=10$}
% 	{$I=0$}
% 	{$I=20$}
% 	\loigiai{
% 		Ta có $I=\lim \dfrac{5.4^{n+1}+3^{n+2}}{2^{2 n+1}+1}=\lim \dfrac{20.4^n+9.3^n}{2 \cdot 4^n+1}=\lim \dfrac{20+9 \cdot\left(\dfrac{3}{4}\right)^n}{2+\left(\dfrac{1}{4}\right)^n}=\dfrac{20}{2}=10$.}
% \end{ex}
...
% \end{ex}
% \begin{ex}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5BE-4]
% 	Tính $\lim \dfrac{3 n^3-2}{1-2 n^3}$ được kết quả là
% 	\choice
% 	{$\dfrac{3}{2}$}
% 	{\True $-\dfrac{3}{2}$}
% 	{$\dfrac{1}{2}$}
% 	{$\dfrac{-1}{2}$}
% 	\loigiai{
% 		Ta có: $\lim \dfrac{3 n^3-2}{1-2 n^3}=\lim \dfrac{n^3\left(3-\dfrac{2}{n^3}\right)}{n^3\left(\dfrac{1}{n^3}-2\right)}=\lim \dfrac{3-\dfrac{2}{n^3}}{\dfrac{1}{n^3}-2}=\dfrac{3-0}{0-2}=-\dfrac{3}{2}$.}
...
% 		$$
% 		\begin{aligned}
% 			& \lim \dfrac{\sqrt{n^2-4 n}-\sqrt{4 n^2+1}}{\sqrt{3 n^2+1}-n}=\lim \dfrac{\sqrt{1-\dfrac{4}{n}}-\sqrt{4+\dfrac{1}{n^2}}}{\sqrt{3+\dfrac{1}{n^2}}-1}=\dfrac{-1-\sqrt{3}}{2}=\dfrac{6-\sqrt{3}}{2}-\dfrac{7}{2} . \\
...
% \end{ex}
% \begin{ex}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5KE-4]
% 	Tính $\lim \left(\dfrac{1}{n^2+4}+\dfrac{2}{n^2+4}+\dfrac{3}{n^2+4}+\ldots+\dfrac{2n+4}{n^2+4}\right)$.
% 	\choice
% 	{$\dfrac{1}{2}$}
% 	{$0$}
% 	{$1$}
% 	{\True $2$}
% 	\loigiai{
% 		Ta có $\lim \left(\dfrac{1}{n^2+4}+\dfrac{2}{n^2+4}+\dfrac{3}{n^2+4}+\ldots+\dfrac{2 n+4}{n^2+4}\right)$
% 		$$
% 		\begin{aligned}
% 			& =\lim \left(\dfrac{1+2+3+\ldots+2 n+4}{n^2+4}\right) \\
% 			& =\lim \dfrac{(1+2 n+4)(2 n+4)}{2\left(n^2+4\right)} \\
% 			& =\lim \dfrac{(2 n+5)(2 n+4)}{2\left(n^2+4\right)} \\
% 			& =\lim \dfrac{\left(2+\dfrac{5}{n}\right)\left(2+\dfrac{4}{n}\right)}{2\left(1+\dfrac{4}{n^2}\right)}=2
% 		\end{aligned}
% 		$$
% 	}
% \end{ex}
...
% 		Suy ra $u_n=1-\dfrac{1}{\sqrt{n+1}} \Rightarrow \lim u_n=1$}
% \end{ex}

% \begin{ex}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5GE-4]
% 	Với $n$ là số tự nhiên lớn hơn $2$ , đặt $S_n=\dfrac{1}{\mathrm{C}_3^3}+\dfrac{1}{\mathrm{C}_4^3}+\dfrac{1}{\mathrm{C}_5^3}+\ldots+\dfrac{1}{\mathrm{C}_n^3}$. Tính $\lim S_n$
% 	\choice
% 	{$1$} 
% 	{$\dfrac{3}{2}$}
% 	{$3$}
...
% 		\end{aligned}
% 		$$
% 		Vậy $\lim S_n=\lim 3\left(\dfrac{1}{2}-\dfrac{1}{n(n-1)}\right)=\dfrac{3}{2}$}
% \end{ex} 
% \begin{ex}%[Dự án soạn đề cương toán 11 - KNTT, Minh Trí]%[1K5GE-4]
% 	Cho $f(n)=\left(n^2+n+1\right)^2+1$. Xét dãy số $\left(u_n\right)$ sao cho $u_n=\dfrac{f(1) \cdot f(3) \cdot f(5) \ldots f(2 n-1)}{f(2) \cdot f(4) \cdot f(6) \ldots f(2 n)}$. Tính $\lim n \sqrt{u_n}$
% 	\choice
% 	{\True $\lim n \sqrt{u_n}=\dfrac{1}{\sqrt{2}}$}
% 	{$\lim n \sqrt{u_n}=\sqrt{2}$}
% 	{$\lim n \sqrt{u_n}=\sqrt{3}$}
...
% 		$\lim n \sqrt{u_n}=\lim n \cdot \sqrt{\dfrac{2}{(2 n+1)^2+1}}=\dfrac{1}{\sqrt{2}}$}
% \end{ex}
\Closesolutionfile{ans}
% \begin{indapan}{10}
% 	{ans/ans-1K5-1-Dang3}
...
\begin{vd}%[1C3B1-5]
	...
	\loigiai{
		\begin{enumerate}
			...
			Khi đó $\lim S_n=\lim \left(2-\dfrac{1}{2^{n-1}}\right)=2$.
		\end{enumerate}
	}
\end{vd}
\begin{vd}%[1C3Y1-5]
...
\begin{ex}%[1D4B1-5]
	...
	\loigiai{
		...
		\end{eqnarray*}
		Suy ra $\lim S=\lim \dfrac{1}{4}\cdot\left(1-\left(\dfrac{-1}{3}\right)^n\right)=\dfrac{1}{4}$.	
	}
\end{ex}
\begin{ex}%[1D4B1-5]
...
\begin{vd}%[1C3K1-6]
	...
	\loigiai{
		\begin{enumerate}
			...
			\item $\lim u_n=\lim \dfrac{1}{2^n}=\lim\left(\dfrac{1}{2}\right)^n=0$.
	...
	\loigiai{
		\begin{enumerate}
			...
			\begin{eqnarray*}
				...
				&=&\dfrac{\pi R^2}{2^{n+1}}.	
			\end{eqnarray*}			
			\item $\lim p_n=\lim \left(\pi R\right) = \pi R$.\\
			$\lim S_n=\lim \dfrac{\pi R^2}{2^{n+1}}=0$ (Vì $\lim \left(\pi R^2\right)=\pi R^2$ và $\lim 2^{n+1}=+\infty$).
		\end{enumerate}
	}
\end{vd}
\begin{vd}%[1D4K1-6]
...
\begin{vd}%[0D1Y1-1]
	...
	\loigiai{
		\begin{listEX}
			...
			\end{aligned} $$
			suy ra $\lim p_n=\lim 3 \cdot \dfrac{1}{2^{n-1}} a=0$.
			$$ \begin{aligned}
			...
			\end{aligned}$$
			suy ra $\lim S_n=\lim \dfrac{1}{4^{n-1}} \cdot \dfrac{a^2 \sqrt{3}}{4}=0$.
			\item[b)] Dựa vào dữ kiện đề bài suy ra tổng $\left(p_n\right)$ là tổng của cấp số nhân lùi vô hạn với công bội $q=\dfrac{1}{2}$ và
			$ p_1+p_2+\ldots+p_n+\ldots=\lim \left(p_n\right)=\dfrac{p_1}{1-q}=\dfrac{3 a}{1-\frac{1}{2}}=6a.$\\
			Dựa vào dữ kiện đề bài suy ra tổng $\left(S_n\right)$ là tổng của cấp số nhân lùi vô hạn với công bội $q=\dfrac{1}{4}$ và
			$S_1+S_2+\ldots+S_n+\ldots=\lim \left(S_n\right)=\dfrac{S_1}{1-q}=\dfrac{\frac{a^2 \sqrt{3}}{4}}{1-\frac{1}{4}}=\dfrac{a^2 \sqrt{3}}{12}$.
		\end{listEX}
	}
\end{vd}
% \subsubsection{Bài tập rèn luyện} 
...
% 	}
% 	\begin{enumerate}
% 		\item Kí hiệu $a_n$ là diện tích của hình vuông thứ $n$ và $S_n$ là tổng diện tích của $n$ hình vuông đầu tiên. Viết công thức tính $a_n$, $S_n$ ($n=1,2,3, \ldots$) và tìm $\lim S_n$ (giới hạn này nếu có được gọi là tổng diện tích của các hình vuông).
% 		\item Kí hiệu $p_n$ là chu vi của hình vuông thứ $n$ và $Q_n$ là tổng chu vi của $n$ hình vuông đầu tiên. Viết công thức tính $p_n$ và $Q_n$ $(n=1,2,3, \ldots)$ và tìm $\lim Q_n$ (giới hạn này nếu có được gọi là tổng chu vi của các hình vuông).
% 	\end{enumerate}
% 	\loigiai{
% 		\begin{enumerate}
...
% 	\begin{enumerate}
% 		\item Tính diện tích $S_n$ của $H_n$ và tính $\lim S_n$.
% 		\item Tính chu vi $p_n$ của $H_n$ và tính $\lim p_n$.
% 	\end{enumerate}
...
% 			$\lim S_n=\lim \left(\dfrac{5}{9}\right)^n=0$.
...
% 			$\lim p_n=\lim 4\cdot \left(\dfrac{5}{3}\right)^n=+\infty$.
% 		\end{enumerate}
% 	}
% \end{bt}
% \begin{bt}%[1T3K1-5]
...
% 		\item[b)] Tìm $\underset{d \rightarrow f^{+}}\lim \varphi(d), \underset{d \rightarrow f^{-}}\lim \varphi(d)$ và $\underset{d \rightarrow f}\lim \varphi(d)$. Giải thích ý nghĩa của các kết quả tìm được.
% 	\end{listEX}
% 	\loigiai{
% 		\begin{listEX}
% 			\item[a)] Ta có $$\dfrac{1}{d}+\dfrac{1}{d^{\prime}}=\dfrac{1}{f} \Leftrightarrow d^{\prime}=\dfrac{d f}{d-f}.$$
% 			Vậy $\varphi(d)=\dfrac{d f}{d-f}$.		
% 			\item[b)] Vì $\underset{d \rightarrow f^{+}}\lim df=f^2; \underset{d \rightarrow f^{+}}\lim (d-f)=0 ; d \rightarrow f^{+} \Rightarrow d-f>0 $ nên $ \underset{d \rightarrow f^{+}}\lim  \dfrac{d f}{d-f}=+\infty$.\\
% 			Vậy $\underset{d \rightarrow f^{+}}\lim \varphi(d)=\underset{d \rightarrow f^{+}}\lim  \dfrac{d f}{d-f}=+\infty$.\\
% 			\textbf{Ý nghĩa}: Khi đặt vật nằm ngoài tiêu cự và tiến dần đến tiêu điểm thì cho ảnh thật ngược chiều với vật ở vô cùng.\\
% 			Vì $\underset{d \rightarrow f^{-}}\lim df=f^2; \underset{d \rightarrow f^{+}}\lim (d-f)=0 ; d \rightarrow f^{-} \Rightarrow d-f<0 $ nên $ \underset{d \rightarrow f^{+}}\lim  \dfrac{d f}{d-f}=-\infty$.\\
% 			Vậy $\underset{d \rightarrow f^{+}}\lim \varphi(d)=\underset{d \rightarrow f^{+}}\lim  \dfrac{d f}{d-f}=-\infty$.\\
...
\begin{vd}%[1D4B1-2]
	...
	\loigiai{
		\begin{enumerate}[a)]
			...
			Mà $\lim \dfrac{1}{n}=0$ nên suy ra $\lim \dfrac{(-1)^n}{3n+2}=0$.
			...
			Mà $\lim \dfrac{1}{n^2}=0$ nên suy ra $\lim \dfrac{n\sin 2n}{n^3+2}=0$.
			\item Ta có $0\leqslant \left|\dfrac{(-1)^n\cos n}{\sqrt{n}}\right|\leqslant \dfrac{1}{\sqrt{n}}$, $\forall n\in \mathbb{N^*}$.\\
			Mà $\lim \dfrac{1}{\sqrt{n}}=0$ nên suy ra $\lim \dfrac{(-1)^n\cos n}{\sqrt{n}}=0$.
			...
			Mà $\lim \dfrac{5}{2n^2+1}=0$ nên suy ra $\lim \dfrac{3\sin n-4\cos n}{2n^2+1}=0$.
		\end{enumerate}
	}
\end{vd}
%bai2
\begin{vd}%[1D4K1-2]
	...
	\loigiai{
		\begin{enumerate}
			...
			Mà $\lim \dfrac{1}{n}=0$ nên suy ra $\lim \left(\sqrt{n^3+2}-\sqrt{n^3+1}\right)=0$.
			...
			Mà $\lim \left[{\left(\dfrac{3}{5}\right)}^n+{\left(\dfrac{4}{5}\right)}^n\right]=\lim {\left(\dfrac{3}{5}\right)}^n+\lim {\left(\dfrac{4}{5}\right)}^n=0$ và $$\lim \left[{\left(\dfrac{2}{5}\right)}^n+4\right]=\lim {\left(\dfrac{2}{5}\right)}^n+4=0+4=4$$ nên $\lim \dfrac{3^n\sin 2n+4^n}{2^n+4\cdot 5^n}=0$.
			...
			Mà $\lim \dfrac{1}{n}=0$ nên suy ra $\lim \dfrac{n+\sin 2n}{n^2+n}=0$.
			...
			Mà $\lim \dfrac{1}{\sqrt{n}}=0$ nên suy ra $\lim \dfrac{n+\cos \dfrac{n\pi}{5}}{n\sqrt{n}+\sqrt{n}}=0$.
		\end{enumerate}
	}
\end{vd}
%bai3
\begin{vd}%[1D4B1-1]
	...
	\loigiai{
		\begin{enumerate}[a)]
			...
			\end{itemize}
			\item Theo câu b), ta có $0<u_n<{\left(\dfrac{2}{3}\right)}^n$. Mà $\lim {\left(\dfrac{2}{3}\right)}^n=0$. Do đó $\lim u_n=0$.
		\end{enumerate}
	}
\end{vd}
%bai4
\begin{vd}%[1D4B1-2]
	...
	\loigiai{
		\begin{enumerate}
			\item Ta có $\lim \left(\dfrac{-n^3}{n^3+1}-(-1)\right)=\lim \left(\dfrac{1}{n^3+1}\right)$. \\
			Vì $0\leqslant \left|\dfrac{1}{n^3+1}\right|<\dfrac{1}{n^3}$, $\forall n\in \mathbb{N^*}$. Mà $\lim \dfrac{1}{n^3}=0$ nên suy ra $\lim \left(\dfrac{1}{n^3+1}\right)=0$. \\
			Do đó $\lim \left(\dfrac{-n^3}{n^3+1}\right)=-1$.
			\item Ta có $\lim \left(\dfrac{n^2+3n+2}{2n^2+n}-\dfrac{1}{2}\right)=\lim \dfrac{5n+4}{2(2n^2+n)}$. \\
			Vì $0<\left|\dfrac{5n+4}{2(2n^2+n)}\right|<\dfrac{5n+5}{2n(n+1)}=\dfrac{5}{2}\cdot \dfrac{1}{n}$, $\forall n\in \mathbb{N^*}$. Mà $\lim \left(\dfrac{5}{2}\cdot \dfrac{1}{n}\right)=\dfrac{5}{2}\cdot \lim \dfrac{1}{n}=0$ nên suy ra $\lim \dfrac{5n+4}{2(2n^2+n)}=0$. \\
			Do đó $\lim \left(\dfrac{n^2+3n+2}{2n^2+n}\right)=\dfrac{1}{2}$.
		\end{enumerate}
	}
\end{vd}
%bai5
\begin{vd}%[1D4K1-2]
	Chứng minh rằng
	\begin{enumEX}[a)]{2}
		\item $\lim \left(\dfrac{3\cdot 3^n-\sin 3n}{3^n}\right)=3$.
	...
	\loigiai{
		\begin{enumerate}[a)]
			...
			Vì $0\leqslant \left|\dfrac{-\sin 3n}{3^n}\right|=\dfrac{\left|-\sin 3n\right|}{3^n}\leqslant \dfrac{1}{3^n}={\left(\dfrac{1}{3}\right)}^n$, $\forall n\in \mathbb{N^*}$. Mà $\lim {\left(\dfrac{1}{3}\right)}^n=0$ nên suy ra $\lim \left(\dfrac{-\sin 3n}{3^n}\right)=0$. \\
			Do đó $\lim \left(\dfrac{3.3^n-\sin 3n}{3^n}\right)=3$.
			...
			Mà $\lim \dfrac{1}{8}\cdot \dfrac{1}{n}=\dfrac{1}{8}\lim \dfrac{1}{n}=0$ nên suy ra $\lim \left(\sqrt{n^2+n}-n-\dfrac{1}{2}\right)$. \\
...
\begin{vd}%[1D4K1-5]
	Tìm các giới hạn sau
	\begin{enumEX}[a)]{1}
		\item $\lim \left(\dfrac{1}{\sqrt{4n^2+1}}+\dfrac{1}{\sqrt{4n^2+2}}+\cdots +\dfrac{1}{\sqrt{4n^2+n}}\right)$.
		\item $\lim \dfrac{{1\cdot 3\cdot 5\cdot 7}\cdots (2n-1)}{{2\cdot 4\cdot 6}\cdots (2n)}$.
	\end{enumEX}
	\loigiai{
		\begin{enumerate}[a)]
			\item Ta có
			...
			\end{center}
			Mà $\lim \dfrac{n}{\sqrt{4n^2}}=\lim \dfrac{1}{2}=\dfrac{1}{2}$; $\lim \dfrac{n}{\sqrt{4n^2+n}}=\lim \dfrac{1}{\sqrt{4+\dfrac{1}{n}}}=\dfrac{1}{\sqrt{4+0}}=\dfrac{1}{2}$. \\
			Do đó $\lim \left(\dfrac{1}{\sqrt{4n^2+1}}+\dfrac{1}{\sqrt{4n^2+2}}+\cdots +\dfrac{1}{\sqrt{4n^2+n}}\right)=\dfrac{1}{2}$.
			...
			Vậy ta có $0<u_n<\dfrac{1}{\sqrt{2n+1}}$, $\forall n\in \mathbb{N^*}$. Mà $\lim \dfrac{1}{\sqrt{2n+1}}=0$ nên suy ra $$\lim \dfrac{{1\cdot 3\cdot 5\cdot 7}\cdots (2n-1)}{{2\cdot 4\cdot 6}\cdots (2n)}=0.$$
		\end{enumerate}
	}
\end{vd}
% \subsubsection{Bài tập rèn luyện}
...
% %%==========Câu 3
% \begin{ex}%[1D4B1-2]
% 	Giới hạn $\lim \dfrac{\cos n}{n}$ bằng
% 	\choice
% 	{$1$}
% 	{\True $0$}
% 	{$-1$}
% 	{$+\infty$}
% 	\loigiai{
% 		Ta có: $\left| \dfrac{\cos n}{n} \right|\le \dfrac{1}{n}$ và $\lim \dfrac{1}{n}=0$ nên $\lim \dfrac{\cos n}{n}=0$.
% 	}
% \end{ex}
% %%==========Câu 4
% \begin{ex}%[1D4B1-2]
...
% 		Vì $\lim \left( - \dfrac{1}{n} \right) = \lim  \dfrac{1}{n} = 0$ nên $\lim \dfrac{\sin 2024n}{n} = 0$.
% 	}
% \end{ex}
% %%==========Câu 6
% \begin{ex}%[1D4K1-2]
% 	Tính $I=\lim \left(\dfrac{1}{\sqrt{n^2+n+1}}+\dfrac{1}{\sqrt{n^2+n+2}}+...+\dfrac{1}{\sqrt{n^2+2n}}\right)$.
% 	\choice
% 	{$I=+\infty$}
% 	{$I=3$}
% 	{$I=2$}
...
% 		Mà $\lim \dfrac{n}{\sqrt{n^2+2n}}=\lim \dfrac{1}{\sqrt{1+\dfrac{2}{n}}}=1$; $\lim \dfrac{n}{\sqrt{n^2+n+1}}=\lim \dfrac{1}{\sqrt{1+\dfrac{1}{n}+\dfrac{1}{n^2}}}=1$.\\
% 		Vậy $I=1$.
% 	}
% \end{ex}
% %%==========Câu 7
...
% %%==========Câu 10
% \begin{ex}%[1D4G1-2]
% 	Cho dãy số $(u_n)$ được xác định bởi $\heva{& u_1=3 \\ & 2(n+1)u_{n+1}=nu_n+n+2}$. Tính $\lim u_n$.
% 	\choice
% 	{\True $\lim u_n=1$}
% 	{$\lim u_n=4$}
% 	{$\lim u_n=3$}
...
% 			Mà $\lim\dfrac{1}{n}=0\Rightarrow\lim u_n=0$. Suy ra có vô số $n$ để $u_n<\dfrac{1}{2020}$.
% 		\end{itemize}
% 	}
% \end{ex}
% %%==========Câu 12
...
% 		Mặt khác $\lim \dfrac{n}{\sqrt{n^2 + n}} = \lim \dfrac{n}{\sqrt{n^2 + 1}} = 1$.\\
% 		Do đó $\lim u_n = 1$.
% 	}
% \end{ex}
% %Câu 13
...
% 		Ta có $\lim \left(-\dfrac{n}{n^2 + 1}\right) = \lim \dfrac{-\dfrac{1}{n}}{1 + \dfrac{1}{n^2}} = 0$; $\lim \dfrac{n}{n^2 + 1} = \lim \dfrac{\dfrac{1}{n}}{1 + \dfrac{1}{n^2}} = 0$.\\
% 		Suy ra $\lim \left(\dfrac{n\cos 2n}{n^2 + 1}\right) = 0 \Rightarrow \lim \left(5 - \dfrac{n\cos 2n}{n^2 + 1}\right) = 5$.
% 	}
% \end{ex}
% %Câu 15
% \begin{ex}%[1D4K1-2]
% 	Kết quả của $\lim \left(n^2\sin \dfrac{n\pi }{5} - 2n^3\right)$ bằng
% 	\choice
% 	{\True $-\infty$}
% 	{$0$}
% 	{$+\infty$}
% 	{$-2$}
% 	\loigiai{
% 		Ta có $\lim \left(n^2\sin \dfrac{n\pi}{5} - 2n^3\right) = \lim n^3\left(\dfrac{1}{n}\sin \dfrac{n\pi}{5} - 2\right) = -\infty $.\\
% 		Vì $\sin \dfrac{n\pi}{5} \le 1 \Rightarrow \dfrac{1}{n} \sin \dfrac{n\pi }{5} \le \dfrac{1}{n}$.\\
% 		Mà $\lim \dfrac{1}{n} = 0$ nên $\lim \left(\dfrac{1}{n}\sin \dfrac{n\pi}{5} - 2\right) = -2$.\\
% 		Mặt khác $\lim n^3 = +\infty$.\\
% 		Vậy $\lim \left(n^2\sin \dfrac{n\pi }{5} - 2n^3\right) = -\infty$.
% 	}
% \end{ex}
% %Câu 16
% \begin{ex}%[1D4K1-2]
