...
Ta có $\displaystyle \lim \limits{n \to +\infty}f \left(x_n\right) = \displaystyle \lim \limits{n \to +\infty}\dfrac{x_n^2 - 4}{x_n + 2} = \displaystyle \lim \limits{n \to +\infty}\dfrac{\left(x_n + 2 \right) \cdot \left(x_n - 2 \right)}{\left(x_n + 2 \right)} = \displaystyle \lim \limits{n \to +\infty}\left(x_n - 2 \right) = -4$.
...
Ta có $\displaystyle \lim \limits{n \to +\infty}f\left(x_n \right) = \displaystyle \lim \limits{n \to +\infty}\dfrac{2x_n + 3}{x_n - 1} = \displaystyle \lim \limits{n \to +\infty}\dfrac{2 + \cfrac{3}{x_n}}{1 - \cfrac{1}{x_n}} = 2.$ \\
