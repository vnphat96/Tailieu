...
\dapso{$\displaystyle \lim \limits{n \to +\infty}_{v \rightarrow c^{-}} L =0$}
\loigiai{
Ta có $\displaystyle \lim \limits{n \to +\infty}_{v \rightarrow c^{-}} L = \lim \limits{n \to +\infty}_{v \rightarrow c^{-}} L_0 \sqrt{1-\frac{v^2}{c^2}} =  \lim \limits{n \to +\infty}_{v \rightarrow c^{-}} L_0 \sqrt{1-\frac{c^2}{c^2}} =0$. 
}
\end{bt}
