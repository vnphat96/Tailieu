...
\begin{dang}{Dùng định nghĩa chứng minh giới hạn}
	Để chứng minh $\lim \limits_{n \to +\infty}u_n = L$ ta chứng minh $\lim \limits_{n \to +\infty} \left( u_n- L \right) = 0$.
\end{dang}
\begin{vd}%[Phan Quốc Trí]%[1D4B1]
	...
	\loigiai{
		\begin{enumerate}[a.]
			\item Ta có $\lim \limits_{n \to +\infty}\left( \dfrac{-n^3}{n^3+1}  - (-1) \right)= \lim \limits_{n \to +\infty}\left( \dfrac{1}{n^3+1} \right)$. Vì $0\le \left| \dfrac{1}{n^3+1} \right|<\dfrac{1}{n^3}, \; \forall n \in \mathbb{N^*}$.\\
			Mà $\lim \limits_{n \to +\infty}\dfrac{1}{n^3}=0$ nên suy ra $\lim\left( \dfrac{1}{n^3+1} \right) =0$. Do đó $\lim \limits_{n \to +\infty}\left( \dfrac{-n^3}{n^3+1} \right) = -1$.
			\item Ta có $\lim \limits_{n \to +\infty}\left( \dfrac{n^2+3n+2}{2n^2+n} -\dfrac{1}{2} \right)=\lim \limits_{n \to +\infty} \dfrac{5n+4}{2\left(2n^2+n\right)}$\\
			Vì $0<\left|\dfrac{5n+4}{2\left(2n^2+n\right)} \right|<\dfrac{5n+5}{2n\left(n+1\right)}=\dfrac{5}{2}.\dfrac{1}{n},\; \forall n \in \mathbb{N^*}$. Mà  $\lim \limits_{n \to +\infty}\left( \dfrac{5}{2}.\dfrac{1}{n} \right) =\dfrac{5}{2}.\lim \limits_{n \to +\infty}\dfrac{1}{n}=0$\\
			Nên suy ra $\lim \limits_{n \to +\infty} \dfrac{5n+4}{2\left(2n^2+n\right)}=0$. Do đó $\lim \limits_{n \to +\infty}\left( \dfrac{n^2+3n+2}{2n^2+n}  \right)=\dfrac{1}{2}$.
		\end{enumerate}
	}
\end{vd}
\begin{vd}%[Phan Quốc Trí]%[1D4B1]
	...
	\begin{multicols}{2}
		\begin{enumerate}[a.]
			\item $\lim \limits_{n \to +\infty}\left(\dfrac{3.3^n-\sin 3n}{3^n} \right)=3$
	...
	\loigiai{
		\begin{enumerate}[a.]
			...
			Mà $\lim \limits_{n \to +\infty}\left(\dfrac{1}{3}\right)^n =0$ nên suy ra $\lim \limits_{n \to +\infty}\left( \dfrac{-\sin 3n}{3^n} \right)=0$. Do đó $\lim \limits_{n \to +\infty}\left(\dfrac{3.3^n-\sin 3n}{3^n} \right)=3$.
			...
			\end{eqnarray*}
			Mà $\lim \limits_{n \to +\infty}\dfrac{1}{8}.\dfrac{1}{n}=\dfrac{1}{8}\lim \limits_{n \to +\infty}\dfrac{1}{n}=0$ nên suy ra $\lim \limits_{n \to +\infty}\dfrac{-1}{2\left(2\sqrt{n^2+n}+(2n+1)\right)}=0$.\\
...
\begin{bt}%[Phan Quốc Trí]%[1D4B1]
	...
	\begin{multicols}{2}
		\begin{enumerate}[a.]
			\item $\lim \limits_{n \to +\infty}\dfrac{2n^2+n}{n^2+4}=2$
			\item $\lim \limits_{n \to +\infty}\dfrac{6n+2}{n+5}=6$
			\item $\lim \limits_{n \to +\infty}\dfrac{7^n-2.8^n}{8^n+3^n}=-2$
			\item $\lim \limits_{n \to +\infty}\dfrac{2.3^n +5^n}{5^n+3^n}=1$.
		\end{enumerate}
	\end{multicols}
	\loigiai{
		\begin{enumerate}[a.]
			\item Ta có  $\lim \limits_{n \to +\infty}\left( \dfrac{2n^2+n}{n^2+4} -2 \right)= \lim \limits_{n \to +\infty}\dfrac{n-8}{n^2+4}$. Vì $0\le \left|\dfrac{n-8}{n^2+4} \right|\le \dfrac{n}{n^2}=\dfrac{1}{n}$.\\
			Mà $\lim \limits_{n \to +\infty}\dfrac{1}{n} = 0$ nên suy ra $\lim \limits_{n \to +\infty}\left( \dfrac{2n^2+n}{n^2+4} -2 \right)=0$. Do đó $\lim \limits_{n \to +\infty}\dfrac{2n^2+n}{n^2+4}=2$.
			\item Ta có $\lim \limits_{n \to +\infty}\left( \dfrac{6n+2}{n+5}-6 \right) = \lim \limits_{n \to +\infty}\dfrac{-28}{n+5}$\\
			Vì $\left| \dfrac{-28}{n+5} \right| < \dfrac{28}{n}$. Mà $\lim \limits_{n \to +\infty}\dfrac{28}{n}=0$ nên $\lim \limits_{n \to +\infty}\left( \dfrac{6n+2}{n+5}-6 \right) =0$. Do đó  $\lim \limits_{n \to +\infty}\dfrac{6n+2}{n+5}=6$.
			\item Ta có $\lim \limits_{n \to +\infty}\left( \dfrac{7^n-2.8^n}{8^n+3^n} +2 \right) = \lim \limits_{n \to +\infty}\dfrac{7^n+2.3^n}{8^n+3^n}$\\
			Vì $0<\left| \dfrac{7^n+2.3^n}{8^n+3^n} \right| < \dfrac{7^n+2.3^n}{8^n+3^n} < \dfrac{3.7^n}{8^n}=3\left(\dfrac{7}{8} \right)^n$.\\
			Mà $\lim \limits_{n \to +\infty}3\left(\dfrac{7}{8}\right)^n=0$ nên $\lim \limits_{n \to +\infty}\left( \dfrac{7^n-2.8^n}{8^n+3^n} +2 \right)=0$. Do đó $\lim \limits_{n \to +\infty}\dfrac{7^n-2.8^n}{8^n+3^n}=-2$.
			\item Ta có $\lim \limits_{n \to +\infty}\left( \dfrac{2.3^n +5^n}{5^n+3^n}-1\right) = \lim \limits_{n \to +\infty}\dfrac{3^n}{5^n+3^n}$.\\
			vì $0< \left| \dfrac{3^n}{5^n+3^n} \right|< \dfrac{3^n}{5^n+3^n} <\left( \dfrac{3}{5} \right)^n$\\
			Mà $\lim \limits_{n \to +\infty}\left( \dfrac{3}{5} \right)^n =0$ nên $\lim \limits_{n \to +\infty}\left( \dfrac{2.3^n +5^n}{5^n+3^n}-1\right)=0$. Do đó $\lim \limits_{n \to +\infty}\dfrac{2.3^n +5^n}{5^n+3^n}=1$.
		\end{enumerate}
	}
\end{bt}
...
\begin{bt}%[Phan Quốc Trí]%[1D4B1]
	...
	\begin{multicols}{2}
		\begin{enumerate}[a.]
			\item $\lim \limits_{n \to +\infty}\left( \sqrt{4n^2+4n} -2n \right)=1$
			\item $\lim \limits_{n \to +\infty}\dfrac{\sqrt{n}+\sin^n n}{\sqrt{n}+1}=1$
			\item $\lim \limits_{n \to +\infty}\dfrac{\sqrt{n^2+2n}-n}{n}=0$
			\item $\lim \limits_{n \to +\infty}\left( \sqrt[3]{n^3+2n}-n \right)=0$.
		\end{enumerate}
	\end{multicols}
	\loigiai{
		\begin{enumerate}[a.]
			\item Ta có $\lim \limits_{n \to +\infty}\left( \sqrt{4n^2+4n} -2n-1 \right)=\lim \limits_{n \to +\infty}\dfrac{-1}{\sqrt{4n^2+4n} +2n+1}$\\
			Vì $0\le \left| \dfrac{-1}{\sqrt{4n^2+4n} +2n+1} \right| \le \dfrac{1}{\sqrt{4n^2+4n} +2n+1} < \dfrac{1}{2n+2n}=\dfrac{1}{4n}$\\
			Mà $\lim \limits_{n \to +\infty}\dfrac{1}{4n}=0$ nên $\lim \limits_{n \to +\infty}\left( \sqrt{4n^2+4n} -2n-1 \right)=0$. Do đó $\lim \limits_{n \to +\infty}\left( \sqrt{4n^2+4n} -2n \right)=1$
			\item Ta có $\lim \limits_{n \to +\infty}\left(  \dfrac{\sqrt{n}+\sin^n n}{\sqrt{n}+1} -1\right)=\lim \limits_{n \to +\infty}\dfrac{\sin^n n -1}{\sqrt{n}+1}$\\
			Vì $0 \le \left| \dfrac{\sin^n n -1}{\sqrt{n}+1} \right| < \dfrac{2}{\sqrt{n}}$.\\
			Mà $\lim \limits_{n \to +\infty}\dfrac{2}{\sqrt{n}} =0$ nên $\lim \limits_{n \to +\infty}\left(  \dfrac{\sqrt{n}+\sin^n n}{\sqrt{n}+1} -1\right)=0$. Do đó $\lim \limits_{n \to +\infty}\dfrac{\sqrt{n}+\sin^n n}{\sqrt{n}+1}=1$.
			...
			Mà $\lim \limits_{n \to +\infty}\dfrac{1}{n} =0$ nên $\lim \limits_{n \to +\infty}\dfrac{\sqrt{n^2+2n}-n}{n}=0$.
			\item Ta có
			\begin{eqnarray*}
			...
			\end{eqnarray*}
			Mà $\lim \limits_{n \to +\infty}\dfrac{1}{n} =0$. Do đó $\lim \limits_{n \to +\infty}\left( \sqrt[3]{n^3+2n}-n \right)=0$
		\end{enumerate}
	}
\end{bt}
\begin{bt}%[Phan Quốc Trí]%[1D4B1]
	...
	\begin{multicols}{2}
		\begin{enumerate}[a.]
			\item $\lim \limits_{n \to +\infty}\dfrac{6^n \cos 3n +5^n}{2^n+2.7^n}=0$
			\item $\lim \limits_{n \to +\infty}\dfrac{4n \sin^n 2n + \cos^n 2n}{4n^2+8n}=0$
		\end{enumerate}
	\end{multicols}
	\loigiai{
		\begin{enumerate}[a.]
			\item Ta có $\left| \dfrac{6^n \cos 3n +5^n}{2^n+2.7^n} \right|\le \dfrac{6^n+5^n}{2.7^n}\le \dfrac{2.6^n}{2.7^n}=\left(\dfrac{6}{7} \right)^n$.\\
			Mà $\lim \limits_{n \to +\infty}\left(\dfrac{6}{7} \right)^n = 0$ nên $\lim \limits_{n \to +\infty}\dfrac{6^n \cos 3n +5^n}{2^n+2.7^n}=0$.
			\item Ta có $\left| \dfrac{4n \sin^n 2n + \cos^n 2n}{4n^2+8n} \right|\le \left| \dfrac{4n+1}{4n(n+2)} \right| \le \dfrac{4(n+2)}{4n(n+2)}=\dfrac{1}{n}$\\
			Mà $\lim \limits_{n \to +\infty}\dfrac{1}{n}=0$ nên $\lim \limits_{n \to +\infty}\dfrac{4n \sin^n 2n + \cos^n 2n}{4n^2+8n}=0$.
		\end{enumerate}
	}
\end{bt}
...
\begin{vd}%[Nguyễn Bình Nguyên]%[1D4B1]
	...
	\loigiai{
		Ta có: $\lim \limits_{n \to +\infty}\dfrac{{{n}^2}-4{{n}^3}}{2{{n}^3}+5n-2}=\lim \limits_{n \to +\infty}\dfrac{{{n}^3}(\dfrac{1}{n}-4 )}{{{n}^3}(2+\dfrac{5}{{{n}^2}}-\dfrac{2}{{{n}^3}} )}=\lim \limits_{n \to +\infty}\dfrac{\dfrac{1}{n}-4}{2+\dfrac{5}{{{n}^2}}-\dfrac{2}{{{n}^3}}}=-\dfrac{4}{2}=-2$.
	}
\end{vd}
\begin{vd}%[Nguyễn Bình Nguyên]%[1D4B1]
	Tính $\lim \limits_{n \to +\infty}\dfrac{{{n}^3}-7n}{1-2{{n}^2}}$.
	\loigiai{
		Ta có: $\lim \limits_{n \to +\infty}\dfrac{{{n}^3}-7n}{1+2{{n}^2}}=\lim \limits_{n \to +\infty}\dfrac{{{n}^3}(1-\dfrac{7}{{{n}^2}} )}{{{n}^2}(\dfrac{1}{{{n}^2}}+2 )}=\lim \limits_{n \to +\infty}(n.\dfrac{1-\dfrac{7}{{{n}^2}}}{\dfrac{1}{{{n}^2}}+2} )=+\infty $.\\
		Vì $\lim \limits_{n \to +\infty}(\dfrac{1-\dfrac{7}{{{n}^2}}}{\dfrac{1}{{{n}^2}}+2} )=\dfrac{1}{2}>0;\,\,\lim \limits_{n \to +\infty}n=+\infty $.
	}
\end{vd}
\begin{vd}%[Nguyễn Bình Nguyên]%[1D4B1]
	Tính $\lim \limits_{n \to +\infty}\dfrac{n+2}{{{n}^2}+n+1}$
	\loigiai{
		Ta có: $\lim \limits_{n \to +\infty}\dfrac{n+3}{{{n}^2}+n+2}=\lim \limits_{n \to +\infty}\dfrac{n(1+\dfrac{3}{n} )}{{{n}^2}(1+\dfrac{1}{n}+\dfrac{2}{{{n}^2}} )}=\lim \limits_{n \to +\infty}\dfrac{1}{n}.\dfrac{1+\dfrac{3}{n}}{1+\dfrac{1}{n}+\dfrac{3}{{{n}^2}}}=0$.
	}
\end{vd}
\begin{vd}%[Nguyễn Bình Nguyên]%[1D4B1]
	Tính $\lim \limits_{n \to +\infty}\dfrac{5^{n+1}-4^{n}+1}{2.5^n-6^n}$.
	\loigiai{
		Ta có : $\lim \limits_{n \to +\infty}\dfrac{5^{n+1}-4^{n}+1}{2.5^n-6^n}=\lim \limits_{n \to +\infty}\dfrac{\dfrac{5^{n+1}-4^n+1}{6^n}}{\dfrac{2.5^n-6^n}{6^n}}=\lim\dfrac{5.\left(\dfrac{5}{6}\right)^n-\left(\dfrac{2}{3}\right)^n+\left(\dfrac{1}{6}\right)^n}{2\left(\dfrac{5}{6}\right)^n-1}=0$.
	}
\end{vd}
\begin{center}
...
\begin{bt}%[Nguyễn Bình Nguyên]%[1D4Y1]
	...
	\begin{enumerate}
		\begin{multicols}{2}
			\item $\lim \limits_{n \to +\infty}\dfrac{3n+2}{2n+3}$.
			\item $\lim \limits_{n \to +\infty}\dfrac{4n^2-1}{2n^2+n}$.
		\end{multicols}
	\end{enumerate}
	\loigiai{
		\begin{enumerate}
			\item Chia cả tử và mẫu cho $n$ có bậc lớn nhất. Ta có : $\lim \limits_{n \to +\infty}\dfrac{3n+2}{2n+3}=\lim\dfrac{3+\dfrac{2}{n}}{2+\dfrac{3}{n}}=\dfrac{3}{2}$.
			\item Tương tự: $\lim \limits_{n \to +\infty}\dfrac{4n^2-1}{2n^2+n}=\lim \limits_{n \to +\infty}\dfrac{4-\dfrac{1}{n^2}}{2+\dfrac{1}{n}}=2$.
		\end{enumerate}
	}
\end{bt}
\begin{bt}%[Nguyễn Bình Nguyên]%[1D4B1]
	...
	\begin{enumerate}
		\begin{multicols}{2}
			\item $\lim \limits_{n \to +\infty}\dfrac{\sqrt{n^2+2n}-3}{n+2}$.
			\item $\lim \limits_{n \to +\infty}\dfrac{\sqrt{n^2+2n}-n-1}{\sqrt{n^2+n}+n}$.
		\end{multicols}
	\end{enumerate}
	\loigiai{
		\begin{enumerate}
			\item Ta có : $\lim \limits_{n \to +\infty}\dfrac{\sqrt{1+\dfrac{2}{n}}-\dfrac{3}{n}}{1+\dfrac{2}{n}}=1$.
			\item Tương tự: $\lim \limits_{n \to +\infty}\dfrac{\sqrt{1+\dfrac{2}{n}}-1-\dfrac{1}{n}}{\sqrt{1+\dfrac{1}{n}}+1}=0$.
		\end{enumerate}
	}
\end{bt}
\begin{bt}%[Nguyễn Bình Nguyên]%[1D4K1]
	Tính giới hạn $\lim \limits_{n \to +\infty}\dfrac{\sqrt{4n^4+2n}-3n^2}{\sqrt{n^3+2n}-n}$.
	\loigiai{
		Ta có : \\
		$\lim \limits_{n \to +\infty}\dfrac{\sqrt{4n^4+2n}-3n^2}{\sqrt{n^3+2n}-n}
		=\lim \limits_{n \to +\infty}\dfrac{\sqrt{n^4\left(4+\dfrac{2}{n^3}\right)}-3n^2}{\sqrt{n^3\left(1+\dfrac{2}{n^2}\right)}-n}$\\
		$=\lim \limits_{n \to +\infty}\dfrac{n^2\left(\sqrt{4+\dfrac{2}{n^3}}-3\right)}{\sqrt{n^3}\left(\sqrt{1+\dfrac{2}{n^2}}-\dfrac{1}{\sqrt n}\right)}
		=\lim\dfrac{\sqrt n\left(\sqrt{4+\dfrac{2}{n^3}-3}\right)}{\sqrt{1+\dfrac{2}{n^2}}-\dfrac{1}{\sqrt n}}$.\\
		Vì $\lim\sqrt n=+\infty$ và $\lim \limits_{n \to +\infty}\dfrac{\sqrt{4+\dfrac{2}{n^3}}-3}{\sqrt{1+\dfrac{2}{n^2}}-\dfrac{1}{\sqrt n}}=\dfrac{2-3}{1}=-1$.\\
		Do đó : $\lim \limits_{n \to +\infty}\dfrac{\sqrt{4n^4+2n}-3n^2}{\sqrt{n^3+2n}-n}=-\infty$.
	}
\end{bt}
\begin{bt}%[Nguyễn Bình Nguyên]%[1D4B1]
	Tính các giới hạn
	\begin{enumerate}
		\begin{multicols}{2}
			\item $\lim \limits_{n \to +\infty}\dfrac{7. 5^n-2. 7^n}{5^n-5. 7^n}$.
	...
	\loigiai{
		\begin{enumerate}
			...
			\item Tương tự: $\lim \limits_{n \to +\infty}\dfrac{4. 3^n+7^{n+1}}{2. 5^n+7^n}=\lim\dfrac{4.\dfrac{3^n}{7^n}+7}{2.\dfrac{5^n}{7^n}+1}=7$.
...
\begin{bt}%[Nguyễn Bình Nguyên]%[1D4K1]
	Tính giới hạn của 
	\begin{enumerate}[a)]
		\item $A=\lim \limits_{n \to +\infty}\left[\dfrac{1}{1.3}+\dfrac{1}{3.5}+...+\dfrac{1}{(2n-1)(2n+1)}\right]$.
		\item $B=\lim \limits_{n \to +\infty}\left[\dfrac{1}{2\sqrt{1}+1\sqrt{2}}+\dfrac{1}{3\sqrt{2}+2\sqrt{3}}+...+\dfrac{1}{(n+1)\sqrt{n}+n\sqrt{n+1}}\right]$.
	\end{enumerate}
	\loigiai{
		\begin{enumerate}
			\item 	$A=\lim \limits_{n \to +\infty}\left[\dfrac{1}{1.3}+\dfrac{1}{3.5}+...+\dfrac{1}{(2n-1)(2n+1)}\right]$\\
			$=\lim \limits_{n \to +\infty}\left[\left(1-\dfrac{1}{3}\right)+\left(\dfrac{1}{3}-\dfrac{1}{5}\right)+...+\left(\dfrac{1}{2n-1}-\dfrac{1}{2n+1}\right)\right]$\\
			$=\lim \limits_{n \to +\infty}\left[1-\dfrac{1}{2n+1}\right]=1$.
			\item $B=\lim \limits_{n \to +\infty}\left[\dfrac{1}{2\sqrt{1}+1\sqrt{2}}+\dfrac{1}{3\sqrt{2}+2\sqrt{3}}+...+\dfrac{1}{(n+1)\sqrt{n}+n\sqrt{n+1}}\right]$\\
			$=\lim \limits_{n \to +\infty}\left[\left(\dfrac{2\sqrt{1}-1\sqrt{2}}{2.1}\right)+\left(\dfrac{3\sqrt{2}-2\sqrt{3}}{3.2}\right)+...+\left(\dfrac{(n+1)\sqrt{n}-n\sqrt{n+1}}{n(n+1)}\right)\right]$\\
			$=\lim \limits_{n \to +\infty}\left[\left(\sqrt{1}-\dfrac{1}{\sqrt{2}}\right)+\left(\dfrac{1}{\sqrt{2}}-\dfrac{1}{\sqrt{3}}\right)+...+\left(\dfrac{1}{\sqrt{n}}-\dfrac{1}{\sqrt{n+1}}\right)\right]\\
			$\\
			$=\lim \limits_{n \to +\infty}\left[1-\dfrac{1}{\sqrt{n+1}}\right]=1$.
		\end{enumerate}
	}
\end{bt}
...
\begin{bt}%[Nguyễn Bình Nguyên]%[1D4G1]
	...
	\end{array} \right.$$
	Tìm số hạng tổng quát $u_n$ của dãy. Tính $\lim \limits_{n \to +\infty}u_n.$
	\loigiai{
		...
		Vậy $\lim \limits_{n \to +\infty}u_n =\lim \limits_{n \to +\infty}\dfrac{2}{4n^2-5}=0$.}
\end{bt}
...
\begin{bt}%[Nguyễn Bình Nguyên]%[1D4G1]
	...
	\loigiai{
		...
		Vậy $\lim \limits_{n \to +\infty}a_n=-4$.
	}
\end{bt}
...
\begin{bt}%[Nguyễn Bình Nguyên]%[1D4G1]
	...
	\loigiai{
		...
		Đặt $\lim \limits_{n \to +\infty}x_n=L$  suy ra $L \ge 2017$. Khi đó ta có:
		...
		Vậy $\lim \limits_{n \to +\infty}x_n=+\infty$.\\
		...
		Do $\lim \limits_{n \to +\infty}\dfrac{1}{x_{n+1}-1}=0$ nên dãy $(y_n)$ có giới hạn hữu hạn và $\lim \limits_{n \to +\infty}y_n=\dfrac{1}{2016}.$
	}
\end{bt}
...
\begin{dang}{Dãy số dạng Lũy thừa - Mũ}
	\begin{itemize}
		\begin{multicols}{2}
			\item $\lim \limits_{n \to +\infty}n^k=+\infty$, $k>0$.
			\item $\lim \limits_{n \to +\infty}\dfrac{1}{n^{k}}=0$, $k>0$.
			\item $\lim \limits_{n \to +\infty}a^n=0,-1<a<1$.
			\item $\lim \limits_{n \to +\infty}a^n=+\infty,a>1$.
...
\begin{note}
	\begin{itemize}
		\item $\lim \limits_{n \to +\infty}u_n=+\infty, \lim \limits_{n \to +\infty}v_{n}=a>0\Rightarrow \lim \limits_{n \to +\infty}u_nv_n=+\infty$;
		\item $\lim \limits_{n \to +\infty}u_n=+\infty, \lim \limits_{n \to +\infty}v_{n}=a<0\Rightarrow \lim \limits_{n \to +\infty}u_nv_n=-\infty$;
		\item $\lim \limits_{n \to +\infty}u_n=-\infty, \lim \limits_{n \to +\infty}v_{n}=a>0\Rightarrow \lim \limits_{n \to +\infty}u_nv_n=-\infty$;
		\item $\lim \limits_{n \to +\infty}u_n=-\infty, \lim \limits_{n \to +\infty}v_{n}=a<0\Rightarrow \lim \limits_{n \to +\infty}u_nv_n=+\infty$.
	\end{itemize}
...
\begin{vd}%[P[han Chiến Thắng]%[1D4Y1]
	...
	\begin{enumerate}[a)]
		\begin{multicols}{2}
			\item $\lim \limits_{n \to +\infty}(2^n+3^n)$;
	...
	\loigiai{
		\begin{enumerate}[a)]
			\item $\lim \limits_{n \to +\infty}(2^n+3^n)=\lim \limits_{n \to +\infty}3^n\left[\left(\dfrac{2}{3}\right)^n+1\right]=+\infty$.
			\item $\lim\left[-4^n+(-2)^n\right]=\lim \limits_{n \to +\infty}4^n\left[-1+\left(\dfrac{-2}{4}\right)^n\right]=-\infty$.
		\end{enumerate}
	}
\end{vd}
...
\begin{bt}%[P[han Chiến Thắng]%[1D4B1]
	...
	\loigiai{
		\begin{enumerate}[a)]
			...
			\item \item $\lim(2\cdot 3^n-4^{n+1}+7)=\lim \limits_{n \to +\infty}4^n\left(2\cdot\dfrac{3^n}{4^n}-4+\dfrac{7}{4^n}\right)=-\infty$.
		\end{enumerate}
	}
\end{bt}
\begin{bt}%[P[han Chiến Thắng]%[1D4K1] 
	Tính giới hạn sau $\lim \limits_{n \to +\infty}(2\cdot 3^n-n+1)$.
	\loigiai{Ta có: $3^n-n>0$ với $\forall n\in\mathbb{N}$. Do đó, $\lim \limits_{n \to +\infty}(2\cdot 3^n-n+1)\geq \lim \limits_{n \to +\infty}(3^n+1)=+\infty$. 
		
		Vậy $\lim \limits_{n \to +\infty}(2\cdot 3^n-n+1)=+\infty$.}
\end{bt}
\begin{bt}%[P[han Chiến Thắng]%[1D4K1]
	...
	\loigiai{
		...
		Từ đó, $\lim \limits_{n \to +\infty}u_n=\dfrac{3}{2}$, $\lim \limits_{n \to +\infty}v_n=\dfrac{5}{3}$. Vậy $\lim\dfrac{1+\dfrac{1}{3}+\left(\dfrac{1}{3}\right)^2+\cdots +\left(\dfrac{1}{3}\right)^n}{1+\dfrac{2}{5}+\left(\dfrac{2}{5}\right)^2+\cdots +\left(\dfrac{2}{5}\right)^n}=\dfrac{9}{10}$.
	}
\end{bt}
...
\begin{bt}%[P[han Chiến Thắng]%[1D4G1]
	...
	\loigiai{Đặt $v_n=\dfrac{u_n+1}{u_n+4}$. Ta có: $v_{n+1}=\dfrac{u_{n+1}+1}{u_{n+1}+4}=\dfrac{2(u_n+1)}{5(u_n+4)}=\dfrac{2}{5}v_n=\cdots=\left(\dfrac{2}{5}\right)^{n+1}$. 
		...
		Vậy, ta có $v_n=\left(\dfrac{2}{5}\right)^{n}$, do đó $\lim\dfrac{u_n+1}{u_n+4}=\lim \limits_{n \to +\infty}v_n=0$.
	}
\end{bt}
...
\begin{bt}%[P[han Chiến Thắng]%[1D4G1]
	...
	\loigiai{ Ta có: $u_{n+1}-1=\dfrac{u_n-1}{2}=\dfrac{1}{2^2}(u_{n-1}-1)=\cdots =\dfrac{1}{2^{n}}(u_1-1)=\dfrac{1}{2^{n-1}}$. 
		...
		Do đó, $u_n=\dfrac{1}{2^{n-2}}+1$. Vậy, $\lim \limits_{n \to +\infty}u_n=\lim\left(\dfrac{1}{2^{n-2}}+1\right)=1.$
	}
\end{bt}
...
\begin{vd}%[Lê Minh Cường][1D4Y1]
	...
	\loigiai{
		Ta có
		$$\lim \limits_{n \to +\infty}\sqrt{\dfrac{8n+2}{2n-1}} = \lim \limits_{n \to +\infty}\sqrt{\dfrac{8+\dfrac{2}{n}}{2-\dfrac{1}{n}}} = \sqrt{\dfrac{8+0}{2-0}} = 2.  $$
	}
\end{vd}
...
\begin{vd}%[Lê Minh Cường][1D4B1]
	Tính giới hạn:
	$$\lim \limits_{n \to +\infty}\left(\sqrt{4n^2+3n+1}-2n\right)$$
	\loigiai{
		\begin{align*}
		&\lim \limits_{n \to +\infty}\left(\sqrt{4n^2+3n+1}-2n\right)
		=\lim \limits_{n \to +\infty}\dfrac{4n^2+3n+1-4n^2}{\sqrt{4n^2+3n+1}+2n}\quad (*)\\
		=&\lim \limits_{n \to +\infty}\dfrac{3n+1}{\sqrt{4n^2+3n+1}+2n}
		=\lim \limits_{n \to +\infty}\dfrac{n\left(3+\dfrac{1}{n}\right)}{\sqrt{n^2\left(4+\dfrac{3}{n}+\dfrac{1}{n^2}\right)}+2n}&\\
		=&\lim \limits_{n \to +\infty}\dfrac{n\left(3+\dfrac{1}{n}\right)}{n\left(\sqrt{4+\dfrac{3}{n}+\dfrac{1}{n^2}}+2\right)}
		=\lim \limits_{n \to +\infty}\dfrac{3+\dfrac{1}{n}}{\sqrt{4+\dfrac{3}{n}+\dfrac{1}{n^2}}+2}
		=\dfrac{3}{4}.
		\end{align*}
		\textbf{Nhận xét.} 
		\begin{itemize}
			...
			\item Giới hạn $\lim \limits_{n \to +\infty}\dfrac{a}{n^k}=0$, với $a=\textrm{const}$ lại một lần nữa được sử dụng.
		\end{itemize} 
	}
\end{vd}
\begin{vd}%[Lê Minh Cường][1D4B1]
	...
	\begin{enumerate}[a)]
		\item $\lim \limits_{n \to +\infty}\dfrac{\sqrt{4n^2+1}+2n-1}{\sqrt{n^2+4n+1}+n}$.
		\item $\lim \limits_{n \to +\infty}\dfrac{n^2 +\sqrt[3]{1-n^6}}{\sqrt{n^4+1}+n^2}$.
	\end{enumerate}
	\loigiai{
		\begin{enumerate}[a)]
			\item $\lim \limits_{n \to +\infty} \dfrac{\sqrt{4n^2+1}+2n-1}{\sqrt{n^2+4n+1}+n}=\lim \limits_{n \to +\infty}\dfrac{\sqrt{4+\dfrac{1}{n^2}}+2-\dfrac{1}{n}}{\sqrt{1+\dfrac{4}{n}+\dfrac{1}{n^2}}+1}=\dfrac{\sqrt{4}+2}{\sqrt{1}+1}=2$.
			\item $\lim \limits_{n \to +\infty}\dfrac{n^2 +\sqrt[3]{1-n^6}}{\sqrt{n^4+1}+n^2}=\lim \limits_{n \to +\infty}\dfrac{1+\sqrt[3]{\dfrac{1}{n^6}-1}}{\sqrt{1+\dfrac{1}{n^4}}+1}=\dfrac{1+\sqrt[3]{-1}}{\sqrt{1}+1}=0$.
		\end{enumerate}
	}
\end{vd}
\begin{vd}%[Lê Minh Cường][1D4B1]
	Tính giới hạn:
	$$\lim \limits_{n \to +\infty}\dfrac{\sqrt{4n^2+1}-\sqrt{9n^2+2}}{2-n}.$$
	\loigiai{
		\begin{align*}
		&\lim \limits_{n \to +\infty}\dfrac{\sqrt{4n^2+1}-\sqrt{9n^2+2}}{2-n}
		=\lim \limits_{n \to +\infty}\dfrac{\sqrt{n^2\left(4+\dfrac{1}{n^2}\right)}-\sqrt{n^2\left(9+\dfrac{2}{n^2}\right)}}{n\left(\dfrac{2}{n}-1\right)}\\
		=&\lim \limits_{n \to +\infty}\dfrac{n\left(\sqrt{4+\dfrac{1}{n^2}}-\sqrt{9+\dfrac{2}{n^2}}\right)}{n\left(\dfrac{2}{n}-1\right)}
		=\lim \limits_{n \to +\infty}\dfrac{\sqrt{4+\dfrac{1}{n^2}}-\sqrt{9+\dfrac{2}{n^2}}}{\dfrac{2}{n}-1}
		=1.
		\end{align*}
		\textbf{Nhận xét.} 
		\begin{itemize}
			...
			\item Cần chú ý giới hạn quan trọng $\lim \limits_{n \to +\infty}\dfrac{a}{n^k}=0$, với $a=\textrm{const}$.
		\end{itemize} 
	}
\end{vd}
...
\begin{vd}%[Lê Minh Cường][1D4B1]
	Tính giới hạn:
	$$\lim \limits_{n \to +\infty}\left(\sqrt{n+3}-\sqrt{n-5}\right)n$$
	\loigiai{
		\begin{align*}
		&\lim \limits_{n \to +\infty}\left(\sqrt{n+3}-\sqrt{n-5}\right)n\\
		=&\lim \limits_{n \to +\infty}\dfrac{(n+3-n+5)n}{\sqrt{n+3}+\sqrt{n-5}}\\
		=&\lim \limits_{n \to +\infty}\dfrac{8n}{\sqrt{n}\left(\sqrt{1+\dfrac{3}{n}}+\sqrt{1-\dfrac{5}{n}}\right)}\\
		=&\lim \limits_{n \to +\infty}\sqrt{n}\dfrac{8}{\sqrt{1+\dfrac{3}{n}}+\sqrt{1-\dfrac{5}{n}}}\\
		=&+\infty. \left(\text{vì }  \lim \limits_{n \to +\infty}\sqrt{n}=+\infty  \text{ và } \lim \limits_{n \to +\infty}\dfrac{8}{\sqrt{1+\dfrac{3}{n}}+\sqrt{1-\dfrac{5}{n}}}=\dfrac{8}{2}=4=\textrm{const} \right).
		\end{align*}
		...
		\begin{center}
			...
			\end{array}\right.$ thì $\lim \limits_{n \to +\infty}{u_n}.{v_n}=\left\{\begin{array}{cl}
			+\infty & \text{(nếu $ c>0 $)}\\
			-\infty & \text{(nếu $ c<0 $)}
			\end{array}\right.$.
		\end{center}
...
\begin{bt}%[Lê Minh Cường][1D4Y1]
	...
	\loigiai{\begin{enumerate} \item [a)] Ta có: $\lim\sqrt{n^2+1}=\lim\sqrt{n^2(1+\dfrac{1}{n^2})}$;\\
			...
			Vậy $\lim \limits_{n \to +\infty}u_n=+\infty.$
			...
			Vậy $\lim \limits_{n \to +\infty}v_n=+\infty.$
...
\begin{bt}%[Lê Minh Cường][1D4Y1]
	Tính giới hạn:
	$$\lim \limits_{n \to +\infty}\left(\sqrt{3}n-\sqrt{3n^2-2n-1}\right)$$
	\loigiai{
		\begin{align*}
		&\lim \limits_{n \to +\infty}\left(\sqrt{3}n-\sqrt{3n^2-2n-1}\right)\\
		=&\lim \limits_{n \to +\infty}\dfrac{3n^2-3n^2+2n+1}{\sqrt{3}n+\sqrt{3n^2-2n-1}}\\
		=&\lim \limits_{n \to +\infty}\dfrac{2n+1}{\sqrt{3}n+\sqrt{3n^2-2n-1}}\\
		=&\lim \limits_{n \to +\infty}\dfrac{n\left(2+\dfrac{1}{n}\right)}{n\left(\sqrt{3}+\sqrt{3-\dfrac{2}{n}-\dfrac{1}{n^2}}\right)}\\
		=&\lim \limits_{n \to +\infty}\dfrac{2+\dfrac{1}{n}}{\sqrt{3}+\sqrt{3-\dfrac{2}{n}-\dfrac{1}{n^2}}}\\
		=&\dfrac{1}{\sqrt{3}}.
		\end{align*}
	}
\end{bt}
...
\begin{bt}%[Lê Minh Cường][1D4B1]
	Tìm giới hạn $$\lim \limits_{n \to +\infty}\left( \sqrt{n^2 + 2n} - n \right) $$
	\loigiai{
		Ta có
		\begin{align*}
...
\begin{bt}%[Lê Minh Cường][1D4B1]
	Tìm giới hạn $$\lim \limits_{n \to +\infty}\left( \sqrt{n^3 + 2n} - n^2 \right) $$
	\loigiai{
		Ta có
...
\begin{bt}%[Lê Minh Cường][1D4B1] Tìm giới hạn
	...
	\loigiai{$\lim(\sqrt{n^2+3n-1}-\sqrt{n+1})=\lim\dfrac{(\sqrt{n^2+3n-1}-\sqrt{n+1})(\sqrt{n^2+3n-1}+\sqrt{n+1})}{\sqrt{n^2+3n-1}+\sqrt{n+1}}\\
		=\lim\dfrac{n^2+2n-2}{\sqrt{n^2+3n-1}+\sqrt{n+1}}=\lim \limits_{n \to +\infty}\dfrac{n\left(1+\dfrac{2}{n}-\dfrac{2}{n^2}\right)}{\sqrt{1+\dfrac{3}{n}-\dfrac{1}{n^2}}+\sqrt{1+\dfrac{1}{n}}}=+\infty$.}
\end{bt}
...
\begin{bt}%[Lê Minh Cường][1D4G1]
	...
	\loigiai{
		...
		Như vậy, các số hạng của dãy $u_n$ kể từ số hạng thứ $m^2 + 1$ trở đi đều lớn hơn $M$. Do đó $\lim \limits_{n \to +\infty}u_n = +\infty$.}
	
\end{bt}

\begin{bt}%[Lê Minh Cường][1D4K1]
	Tính $\lim \limits_{n \to +\infty}\dfrac{\sqrt{n^2+2}-\sqrt{n+5}}{3n+3}.$
	\loigiai{
		$\lim \limits_{n \to +\infty}\dfrac{\sqrt{n^2+2}-\sqrt{n+5}}{3n+3}=\lim \limits_{n \to +\infty}\dfrac{\sqrt{n^2\left(1+\dfrac{2}{n^2}\right)}-\sqrt{n^2\left(\dfrac{1}{n}+\dfrac{5}{n^2}\right)}}{n\left(3+\dfrac{3}{n}\right)}=\lim \limits_{n \to +\infty}\dfrac{n\sqrt{1+\dfrac{2}{n^2}}-n\sqrt{\dfrac{1}{n}+\dfrac{5}{n^2}}}{n\left(3+\dfrac{3}{n}\right)}=\newline \lim \limits_{n \to +\infty}\dfrac{\sqrt{1+\dfrac{2}{n^2}}-\sqrt{\dfrac{1}{n}+\dfrac{5}{n^2}}}{\left(3+\dfrac{3}{n}\right)}=\dfrac{1}{3}.$}	     
\end{bt}
...
\begin{bt}%[Lê Minh Cường][1D4K1]
	...
	\loigiai{\begin{align*}
		\text{Ta có}: \lim \limits_{n \to +\infty}u_n&=\lim\dfrac{\sqrt{n^2+1}-\sqrt{2n^2+4n-4}}{3n+15}\\
		...
		\end{align*}\\
		Vậy $\lim \limits_{n \to +\infty}u_n		=\dfrac{1-\sqrt{2}}{3}.$
	}
\end{bt}
\begin{bt}%[Lê Minh Cường][1D4K1]
	Tính giới hạn của dãy số $(u_n)$ với $u_n=(\sqrt{n^2-n+2}-n).$
	\loigiai{
		$\lim \limits_{n \to +\infty}u_n= \lim \limits_{n \to +\infty}(\sqrt{n^2-n+2}-n)=\lim \limits_{n \to +\infty}\dfrac{n^2-n+2-n^2}{\sqrt{n^2-n}+n}=\lim \limits_{n \to +\infty}\dfrac{-n+2}{\sqrt{n^2-n}+n}=\lim \limits_{n \to +\infty}\dfrac{n\left(-1+\frac{2}{n}\right)}{\sqrt{n^2\left(1-\frac{1}{n}\right)}+n}=\newline 
		\lim \limits_{n \to +\infty}\dfrac{n\left(-1+\frac{2}{n}\right)}{n\sqrt{1-\frac{1}{n}}+n}=\lim \limits_{n \to +\infty}\dfrac{-1+\frac{2}{n}}{\sqrt{1-\frac{1}{n}}+1}=-\dfrac{1}{2}.$}
\end{bt}

\begin{bt}%[Lê Minh Cường][1D4K1]
	Tính $\lim \limits_{n \to +\infty}\dfrac{\sqrt{n^3+3n^2-2n+1}}{n-1}.$
	\loigiai{
		$\lim \limits_{n \to +\infty}\dfrac{\sqrt{n^3+3n^2-2n+1}}{n-1}=\lim \limits_{n \to +\infty}\dfrac{\sqrt{n^2\left(n+3-\dfrac{2}{n}+\dfrac{1}{n^2}\right)}}{n-1}= \lim \limits_{n \to +\infty}\dfrac{n\sqrt{n+3-\dfrac{2}{n}+\dfrac{1}{n^2}}}{n\left(1-\dfrac{1}{n}\right)}=\newline \lim \limits_{n \to +\infty}\dfrac{\sqrt{n+3-\dfrac{2}{n}+\dfrac{1}{n^2}}}{\left(1-\dfrac{1}{n}\right)}=+\infty.$}
\end{bt}	
...
\begin{bt}%[Lê Minh Cường][1D4K1]
	...
	\loigiai{
		\begin{enumerate}[a)]
			\item \begin{align*}
			\lim \limits_{n \to +\infty}\left(\sqrt{n^2+2n}-n-1\right)&=\lim\dfrac{\left(\sqrt{n^2+2n}-(n+1)\right)\left(\sqrt{n^2+2n}+(n+1)\right)}{\sqrt{n^2+2n}+n+1}\\
			&=\lim \limits_{n \to +\infty}\dfrac{-1}{\sqrt{n^2+2n}+n+1}=0.
			\end{align*}
			\item \begin{align*}
			\lim \limits_{n \to +\infty}\dfrac{\sqrt{4n^2+1}-2n-1}{\sqrt{n^2+4n+1}-n}&=\lim \limits_{n \to +\infty}\dfrac{\left(\sqrt{4n^2+1}-(2n+1)\right)\left(\sqrt{4n^2+1}+2n+1\right)\left(\sqrt{n^2+4n+1}+n\right)}{\left(\sqrt{n^2+4n+1}-n\right)\left(\sqrt{n^2+4n+1}+n\right)\left(\sqrt{4n^2+1}+2n+1\right)}\\
			&=\lim \limits_{n \to +\infty}\dfrac{-4n\left(\sqrt{n^2+4n+1}+n\right)}{\left(4n+1\right)\left(\sqrt{4n^2+1}+2n+1\right)}\\
			&=\lim \limits_{n \to +\infty}\dfrac{-4\left(\sqrt{1+\dfrac{4}{n}+\dfrac{1}{n^2}}+1\right)}{\left(4+\dfrac{1}{n}\right)\left(\sqrt{4+\dfrac{1}{n^2}}+2+\dfrac{1}{n}\right)}\\
...
\begin{bt}%[Lê Minh Cường][1D4K1]
	...
	\loigiai{
		\begin{align*}
		\lim\left(\sqrt{n^2+2n+3}-1+n\right)=\lim\left[\sqrt{n^2+2n+3}-(1-n)\right]&=\lim \limits_{n \to +\infty}\dfrac{n^2+2n+3-(1-n)^2}{\sqrt{n^2+2n+3}+n-1}\\
		&=\lim \limits_{n \to +\infty}\dfrac{4n+2}{\sqrt{n^2+2n+3}+n-1}\\
		&=\lim \limits_{n \to +\infty}\dfrac{4+\dfrac{2}{n}}{\sqrt{1+\dfrac{2}{n}+\dfrac{3}{n}}+1-\dfrac{1}{n}}=2.
		\end{align*}}
\end{bt}
\begin{bt}%%[Lê Minh Cương]%[1D4K1]
	...
	\loigiai{
		...
		\newline Suy ra $0<\sqrt[n]{a}-1<\dfrac{a}{n}\rightarrow 0$ nên $\lim \limits_{n \to +\infty}\sqrt[n]{a}=1$.
		\newline Với $0<a<1$ thì $\dfrac{1}{a}>1\Rightarrow \lim \limits_{n \to +\infty}\sqrt[n]{\dfrac{1}{a}}=1\Rightarrow \lim \limits_{n \to +\infty}\sqrt[n]{a}=1$\\
...
\begin{bt}%[Lê Minh Cường][1D4G1]
	...
	\loigiai{
		\begin{align*}
		\lim \limits_{n \to +\infty}\left(\sqrt[3]{n^3-3}-\sqrt{n^2+n-2}\right)&= \lim\left[\left(\sqrt[3]{n^3-3}-n\right)+\left( n-\sqrt{n^2+n-2}\right)\right]\\
		&=\lim \limits_{n \to +\infty}\left[\dfrac{\left(\sqrt[3]{n^3-3}-n\right)\left(\sqrt[3]{(n^3-3)^2}+n\sqrt[3]{n^3-3}+n^2\right)}{\sqrt[3]{(n^3-3)^2}+n\sqrt[3]{n^3-3}+n^2}\right.\\
		&\hspace*{60pt}\left.+\dfrac{\left(n-\sqrt{n^2+n-2}\right)\left(n+\sqrt{n^2+n-2}\right)}{n+\sqrt{n^2+n-2}}\right]\\
		&=\lim \limits_{n \to +\infty}\left[\dfrac{-3}{\sqrt[3]{(n^3-3)^2}+n\sqrt[3]{n^3-3}+n^2}+ \dfrac{2-n}{n+\sqrt{n^2+n-2}}\right]\\
		&=\lim \limits_{n \to +\infty}\left[\dfrac{\dfrac{-3}{n^2}}{\sqrt[3]{\left(1-\dfrac{3}{n^3}\right)^2}+\sqrt[3]{1-\dfrac{3}{n^3}}+1}+\dfrac{\dfrac{2}{n}-1}{1+\sqrt{1+\dfrac{1}{n}-\dfrac{2}{n^2}}}\right]\\
		&=0-\dfrac{1}{2}=-\dfrac{1}{2}.
		\end{align*}}
\end{bt}
\begin{bt}%[Lê Minh Cường][1D4G1]
	Tìm $\lim \limits_{n \to +\infty}u_n$ biết $u_n=\dfrac{1}{2\sqrt{1}+1\sqrt{2}}
	...
	\loigiai{
		...
		Suy ra $u_n=\dfrac{1}{\sqrt{1}}-\dfrac{1}{\sqrt{2}}+\dfrac{1}{\sqrt{2}}-\dfrac{1}{\sqrt{3}}+\ldots+\dfrac{1}{\sqrt{n}}-\dfrac{1}{\sqrt{n+1}}=\dfrac{1}{\sqrt{1}}-\dfrac{1}{\sqrt{n+1}}$ từ đó ta có $\lim \limits_{n \to +\infty}u_n=1$.
	}
\end{bt}

\begin{bt}%%[Lê Minh Cương]%[1D4G1]
	Tính giới hạn $\lim \limits_{n \to +\infty}\left(\dfrac{1}{\sqrt{n^2+n}}+\dfrac{1}{\sqrt{n^2+n+1}}+\ldots+\dfrac{1}{\sqrt{n^2+2n}}\right)$.
	\loigiai{
		Sử dụng đánh giá $1<\dfrac{1}{\sqrt{n^2+n}}+\dfrac{1}{\sqrt{n^2+n+1}}+\ldots+\dfrac{1}{\sqrt{n^2+2n}}<\dfrac{n+1}{\sqrt{n^2+n}}$ và 
		$\lim \limits_{n \to +\infty}\dfrac{n+1}{\sqrt{n^2+n}}=1$.
		
		Ta được $\lim \limits_{n \to +\infty}\left(\dfrac{1}{\sqrt{n^2+n}}+\dfrac{1}{\sqrt{n^2+n+1}}+\ldots+\dfrac{1}{\sqrt{n^2+2n}}\right)=1$
	}
\end{bt}
...
\begin{bt}%[Lê Minh Cường][1D4G1]
	...
	\loigiai{Với $a$ nhỏ tùy ý, ta chọn $n_{a}>\sqrt{\dfrac{9}{a^2}-1}$, ta có: 
		...
		\newline Suy ra $\lim \limits_{n \to +\infty}\left|\dfrac{1-2n}{\sqrt{n^2+1}}+2\right| =0\Rightarrow \lim\limits_{n\to \infty}\left(\dfrac{1-2n}{\sqrt{n^2+1}} \right)=-2. $		
	}
\end{bt}

\begin{bt}%[Lê Minh Cường][1D4G1]
	Tính giới hạn của $B=\lim \limits_{n \to +\infty}\dfrac{\sqrt{1+2+...+n}-n}{\sqrt[3]{1^2+2^2+...+n^2}+2n}$.
	\loigiai{
