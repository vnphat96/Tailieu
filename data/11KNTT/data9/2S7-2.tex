...
\begin{vd}%[1T7B2-1]
	...
	=\dfrac{1}{u\ln 2}$.\\
	Suy ra $y'_x=y'_u\cdot u'_x=\dfrac{1}{u\ln 2} \cdot 2x=\dfrac{1}{\left(x^2+2\right)\ln2}\cdot 2x=\dfrac{2x}{\left(x^2+2\right)\ln 2}$.\\
...
\begin{bt}%[1T7B2-1]
	...
	\item Ta có $y'=\left(x^2-x\right)'\cdot 2^{x^2-x}\cdot \ln2=(2x-1)\ln2\cdot 2^{x^2-x}.$
	\end{enumerate}}
\end{bt}
\begin{bt}%[1K9BV-1]
	Tính đạo hàm của hàm số sau
...
\begin{vd}%[1D5B5]
	...
	\loigiai{
		\begin{enumerate}
			\item ${y}'=\left(\sqrt{2x+5}\right)^{\prime}=\dfrac{2}{2\sqrt{2x+5}}=\dfrac{1}{\sqrt{2x+5}}$\\
			$y''=-\dfrac{\left(\sqrt{2x+5}\right)^{\prime}}{2x+5}=-\dfrac{\dfrac{2}{2\sqrt{2x+5}}}{2x+5}=-\dfrac{1}{\left(2x+5\right)\sqrt{2x+5}}$.
...
% 		\begin{align*}
% 			& s'=\left(t^3-3t^2+5t+2\right)^{\prime}=3t^2-6t+5 \\ 
...
\begin{bt}%[1D5B5]
	...
	\loigiai{
		Gia tốc tức thời của chuyển động tại thời điểm $t$ chính là đạo hàm cấp hai của phương trình chuyển động tại thời điểm $t$.
		\begin{align*}
			& {s}'=\left(t^3-3t^2-9t+2\right)^{\prime}=3t^2-6t-9 \\ 
...
\begin{bt}%[1C7B2-1]
	...
	\item Ta có $f'(x)=\left(2^{3 x+2}\right)'=(3x+2)'\cdot 2^{3 x+2}\cdot \ln2=3\cdot 2^{3 x+2}\cdot \ln2 $.	
	\end{enumerate}	
	}
\end{bt}
%--------------------------------------
...
\loigiai{
\begin{enumerate}
\item Ta có $y'=(3-2x)\ln2 \cdot 2^{3x-x^2}.$
\item Ta có $y'=\dfrac{1}{x\ln3}.$
\end{enumerate}
}
\end{bt}
\begin{bt}%[1K9KV-1]
...
\begin{bt}%[1T7B2-7]
	...
	\begin{center}
	%\includegraphics[scale=0.6]{DataCTST/hinh/hinh-2}
...
\begin{bt}%[1C7Y3-1]
	...
	\loigiai{
		\begin{enumerate}
			...
			$\Rightarrow y''=\left(\dfrac{1}{x\ln 3}\right)'=-\dfrac{(x\ln3)'}{(x\ln3)^{2}} =-\dfrac{\ln 3}{(x\ln 3)^{2}} =-\dfrac{1}{x^{2}\ln3}$.
			\item $ y=2^{x} $.\\
...
\begin{bt}%[1C7B3-1]
	...
	\loigiai{
		\begin{enumerate}
			...
			\item $ y=\log_{3}(2x+1) $ tại điểm $ x_{0}=3 $.\\
			Ta có $ y'= \dfrac{2}{(2x+1)\ln 3}\Rightarrow y''=\dfrac{-2\left[(2x+1)\ln3\right]'}{\left[(2x+1)\ln3\right]^{2}}=-\dfrac{4\ln3}{\left[(2x+1)\ln3\right]^{2}} = - \dfrac{4}{(2x+1)^2\ln3}$.\\
			Suy ra $ y''(3)=-\dfrac{4\ln3}{\left[(2\cdot 3+1)\ln3\right]^{2}}=-\dfrac{4}{49\ln3} $.
			\item $ y=\mathrm{e}^{4x+3} $ tại điểm $ x_{0}=1 $.\\
...
\begin{bt}%[1D5K5]
	...
	\loigiai{
		${y}'=2\cos 4x.{\left(\cos 4x\right)}^{\prime}\Rightarrow {y}'=-8\cos 4x.\sin 4x\Rightarrow {y}'=-4\sin 8x$\\
		${y}''=-32\cos 8x$\\
