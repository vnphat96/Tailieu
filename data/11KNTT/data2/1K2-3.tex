...
\end{bt}
\begin{bt}[VD]%[DCHT Toán 11 - KNTT -Tên Huỳnh Thanh Chí]%[1K2K7-2]
	...
	Vì sau mỗi giờ, số lượng vi khuẩn tăng lên bằng số lượng vi khuẩn trước đó cộng cho số lượng vi khuẩn tăng lên. Nên ta có:
	\begin{itemize}
	\item Tại thời điểm ban đầu: $ T_0=5\ 000 $.
	\item Tại thời điểm sau $ 1 $ giờ: $ T_1=5\ 000+5\ 000\cdot 0{,}08= 5\ 000\cdot(1{,}08)$.
	\item Tại thời điểm sau $ 2 $ giờ: $ T_2=T_1+T_1\cdot\cdot 0{,}08=T_1\cdot (1{,}08)=5\ 000\cdot(1{,}08)^2 $.
	\end{itemize}
	Do đó ta có thể nhận thấy rằng, số lượng vi khuẩn ở thời gian $ n $ giờ là một cấp số nhân có số hạng đầu $ u_1=5\ 000 $ và công bội $ q=1{,}08 $.\\
	Suy ra số hạng tổng quát $ u_n=5\ 000\cdot (1{,}08)^{n-1} $.\\
	Vậy số lượng vi khuẩn sau $ 5 $ giờ là $ u_5=5\ 000\cdot (1{,}08)^{5-1}\approx 6802 $ (vi khuẩn).
	}
\end{bt}
\subsubsection{Câu hỏi trắc nghiệm}
...
\begin{vd}[VD]%[1K2K3-3]
	...
	\loigiai{
		...
		\begin{eqnarray*}
			...
			&T_2&=\dfrac{1}{2}\cdot T_1=\dfrac{1}{2^2}\cdot S;\\
			&T_3&=\dfrac{1}{2}\cdot T_2=\dfrac{1}{2^3}\cdot S;\\
			&\vdots &\\
			&T_{10}&=\dfrac{1}{2}\cdot T_9=\dfrac{1}{2^{10}}\cdot S.
		\end{eqnarray*}
...
\begin{vd}[VD]%[DCHT Toán 11 - KNTT -Đỗ Chí Tâm]%[1K2K7-5]
	Một cấp số nhân có số hạng đầu $u_1=3$, công bội $q=2$. Biết $S_n=765$, tìm $n$. \dapso{$n=8$}
	\loigiai{ 
...
\begin{bt}[TH] %[DCHT Toán 11 - KNTT - Dung Phuong] %[1K2B7-7]
	...
	\loigiai{
		\begin{enumEX}[a)]{1} 
			...
			Vậy công thức tính số dân của tỉnh đó sau $n$ năm là $u_n=u_1q^{n-1}\Rightarrow u_n=2\cdot 1{,}01^{n-1}$.
			\item Số dân của tỉnh đó sau $10$ năm kể từ năm 2020 là $u_{10}=2\cdot 1{,}01^9 = 2{,}187$ (triệu dân).
		\end{enumEX}
	}
\end{bt}
\begin{bt}[TH] %[DCHT Toán 11 - KNTT - Dung Phuong] %[1K2B7-7]
...
\begin{bt}[TH] %[DCHT Toán 11 - KNTT - Dung Phuong] %[1K2B7-7]
	...
	\loigiai{
		...
		Ta có $u_5=3\cdot 0{,}2^4=\dfrac{3}{325}=4{,}8\cdot10^{-3}$.\\
...
\begin{bt}[TH]%[DCHT Toán 11 - KNTT - Dung Phuong]%[1K2B7-7]
	\immini{Cho hình vuông $C_1$ có cạnh bằng $4$. Người ta chia mỗi cạnh hình vuông thành bốn phần bằng nhau và nối các điểm chia một cách thích hợp để có hình vuông $C_2$ (\textit{Hình 4}). Từ hình vuông $C_2$ lại làm tiếp tục như trên để có hình vuông $C_3$. Cứ tiếp tục quá trình như trên, ta nhận được dãy các hình vuông $C_1, C_2, C_3, \ldots , C_n, \ldots$ Gọi $a_n$ là độ dài cạnh hình vuông $C_n$. Chứng minh rằng dãy số $\left(a_n\right)$ là cấp số nhân.}{
		\begin{tikzpicture}
...
\begin{bt}[TH] %[DCHT Toán 11 - KNTT - Dung Phuong] %[1K2B7-7]
	...
	\loigiai{
		Theo đề ta có $\heva{&u_1=400\\&u_{13}=800} \Leftrightarrow \heva{&u_1=400\\&u_1q^{12}=800} \Rightarrow q^{12} = 2 \Rightarrow q = \pm \pm \sqrt[12]{2}$.
	}
\end{bt}
...
\begin{ex}%[1K2K7-7]
	...
	{\True $604359000$ đồng}
	\loigiai{
		Gọi $S_0$ triệu đồng là số tiềngia đình đó định kỳ gửi tiết kiệm vào đầu hằng tháng, $r$ là lãi suất tiền gửi hằng tháng. Ta có $S_0=15$ triệu đồng, $r=0{,}6$
		\%/tháng.\\
