...
\end{ex}
\begin{ex}%[1K2G7-1]
	Cho bốn số $a,b,c,d$ biết rằng $a,b,c$ theo thứ tự đó lập thành một cấp số nhân công bội $q \in \mathbb{N}$, còn $b,c,d$ theo thứ tự đó lập thành cấp số cộng.
	\begin{enumerate}
		\item Chứng minh rằng $b+d=2c$.
		\item Tìm $q$ biết rằng $a+d=14$ và $b+c=12$.
	\end{enumerate}
	\loigiai{
		\begin{enumerate}
			\item Vì $b,c,d$ lập thành cấp số cộng nên $c-b=d-c \Rightarrow b+d=2c$.
			\item $\heva{&b=aq\\&c=aq^2\\&b+d=2c\\&a+d=14\\&c+d=12}\Rightarrow\heva{&aq+d=2aq^2,&(1)\\&a+d=14,&(2)\\&a\left(q+q^2\right)=12,&(3)}$.\\
				...
				$\dfrac{12q}{q+q^2}+14-\dfrac{12}{q+q^2}=2\dfrac{12q^2}{q+q^2}\Leftrightarrow 12q+14q+14q^2-12=24q^2\Leftrightarrow 10q^2-26q+12=0\Leftrightarrow \hoac{&q=2\\&q=\dfrac{6}{5}}$.\\
				Vì $q\in\mathbb{N}$ nên $q=2$.			
		\end{enumerate}
	}
\end{ex}
\begin{ex}%[1K2G7-5]
