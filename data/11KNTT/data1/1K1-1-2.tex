...
\end{bt}
\begin{bt}%[1K1Y1-2]
	\immini[thm]{Góc lượng giác được biểu diễn ở hình bên có số đo bao nhiêu độ? \dapso{$660^\circ$}}
	{\begin{tikzpicture}[>=stealth,line join=round,line cap=round,font=\footnotesize,scale=1]
			\def\r{2.5}
			\path 
			(0,0) coordinate (O)
...
%	\loigiai{
%		\begin{enumerate}
%			\item \immini[thm]{Ta có $510^\circ=360^\circ+150^\circ$. Góc lượng giác gốc $O$ có tia đầu $Ou$, tia cuối $Ov$ và có số đo $510^\circ$ được biểu diễn ở hình bên.}{
...
%				\end{tikzpicture}
%			}
%			\item \immini[thm]{Ta có $-\dfrac{7\pi}{4}=-\pi+\left(-\dfrac{\pi}{6}\right)$. Góc lượng giác gốc $O$ có tia đầu $Ou$, tia cuối $Ov$ và có số đo $-\dfrac{7\pi}{6}$ được biểu diễn ở hình bên.}{
%				\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round, >=stealth]
%					\begin{axis}[
%						axis line style={draw=none},
%						axis lines=middle,
...
\end{ex}
\begin{ex}%[1K1Y1-2]
	\immini[thm]{Góc lượng giác nào sau đây \textbf{không} thuộc họ góc lượng giác cho trên hình vẽ bên?
		\choice
		{$\dfrac{\pi}{3}$}
		{$\dfrac{7\pi}{3}$}
		{\True $\dfrac{4\pi}{3}$}
...
\end{ex}
\begin{ex}%[1K1Y1-2]
	\immini[thm]{Cho góc $\widehat{mOn}=120^\circ$. Góc nào sau đây có cùng điểm cuối với góc đã cho ở hình bên?
		\choice
		{$240^\circ$}
		{$-120^\circ$}
		{$-60^\circ$}
...
\end{ex}
\begin{ex}%[1K1Y1-2]
	\immini[thm]{Góc lượng giác trên hình có số đo bao nhiêu?
		\choice
		{$\dfrac{\pi}{2}$}
		{\True $\dfrac{13\pi}{2}$}
		{$-\dfrac{13\pi}{2}$}
...
\end{ex}
\begin{ex}%[1K1Y1-2]
	\immini[thm]{Biết góc $\widehat{mOn}=\dfrac{\pi}{3}$, hỏi góc lượng giác nào sau đây có cùng tia cuối với góc ở hình bên?
		\choice
		{$\dfrac{7\pi}{3}$}
		{\True $\dfrac{13\pi}{3}$}
		{$-\dfrac{4\pi}{3}$}
