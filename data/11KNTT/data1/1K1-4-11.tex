...
\end{vd}
\begin{vd}%[1K1K4-A]%[DCHT-11-KNTT]%[Vĩ Lê Văn]
	Giải phương trình: $\sin ^{2026} x+\cos ^{2026} x=1$
	\dapso{$x=k \dfrac{\pi}{2}, \quad k  \in \mathbb{Z}$.}
	\loigiai{
		$\begin{aligned} (1)& \Leftrightarrow \sin ^{2026} x+\cos ^{2026} x=\sin ^2 x+\cos ^2 x \\ & \Leftrightarrow \sin ^2 x\left(\sin ^{2024} x-1\right)=\cos ^2 x\left(1-\cos ^{2024} x\right)\quad (2).\end{aligned}$\\
		Ta thấy $\left\{\begin{aligned}
			&\sin ^2 x \geq 0\\& \sin ^{2024} x \leq 1\end{aligned} \Rightarrow \sin ^2 x\left(\sin ^{2024} x-1\right) \leq 0, \forall x\right.$.\\
		Và $\left\{\begin{aligned}
			&\cos ^2 x \geq 0\\& 1-\cos ^{2024} x \geq 0\end{aligned} \Rightarrow \cos ^2 x\left(1-\cos ^{2024} x\right) \geq 0, \forall x\right.$.\\
		Do đó $(2)\Leftrightarrow \heva{&\sin ^2 x\left(\sin ^{2024} x-1\right) =0\\&\cos ^2 x\left(1-\cos ^{2024} x\right)=0 }\Leftrightarrow \sin2x=0\Leftrightarrow x=k \dfrac{\pi}{2}, \quad k  \in \mathbb{Z}$.\\
