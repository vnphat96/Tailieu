\section{CÁC PHÉP BIẾN ĐỔI LƯỢNG GIÁC}
\subsection{LÝ THUYẾT CẦN NHỚ}
\subsubsection{Công thức cộng:} 
\begin{gachsoc}
	\begin{listEX}[2]
		\item [\ding{172}] $\sin (a+b)=\sin a\cos b+ \cos a\sin b$.
		\item [\ding{173}] $\sin (a-b)=\sin a\cos b-\cos a\sin b$.
...
\begin{vd}
	Khai triển:
	\begin{tasks}(3)
		\task $\cos \left(x+\dfrac{\pi}{3}\right)$;
		\task $\cos \left(x-\dfrac{\pi}{6}\right)$;
		\task $\sin \left(x+60^{\circ}\right)$;
		\task $\sin \left(\dfrac{\pi}{6}-x\right)$;
		\task $\tan \left(a+\dfrac{\pi}{3}\right)$;
		\task $\tan \left(\dfrac{\pi}{6}-2 a\right)$.
	\end{tasks}
\loigiai{
	\begin{enumerate}[a)]
		...
		\item $\tan\left(\dfrac{\pi}{6} - 2a\right) = \dfrac{\tan\dfrac{\pi}{6} - \tan 2a}{1 + \tan\dfrac{\pi}{6} \tan 2a} = \dfrac{\dfrac{\sqrt{3}}{3} - \tan 2a}{1 + \dfrac{\sqrt{3}}{3} \tan 2a} = \dfrac{\sqrt{3} - 3\tan 2a}{3 + \sqrt{3}\tan 2a}$.
	\end{enumerate}
}
\end{vd}
\dongcham{22}
...
\end{vd} \dongcham{15}
\begin{vd}
	\immini{Một sợi cáp $R$ được gắn vào một cột thẳng đứng ở vị trí cách mặt đất $14 \mathrm{~m}$. Một sợi cáp $S$ khác cũng được gắn vào cột đó ở vị trí cách mặt đất $12 \mathrm{~m}$. Biết rằng hai sợi cáp trên cùng được gắn với mặt đất tại một vị trí cách chân cột $15 \mathrm{~m}$ (Hình bên).
		\begin{tasks}
...
\begin{vd}
	...
	\begin{enumEX}[a)]{2}
		\item $A=\cos 45^{\circ} \cos15^{\circ}$.
		\item $B=\cos 75^{\circ} \sin 15^{\circ}$.
		\item $C=\sin 75^{\circ} \sin 15^{\circ}$.
		\item $D=\sin \dfrac{11\pi}{12} \cos \dfrac{5\pi}{12}$.
	\end{enumEX}
	\loigiai{
		\begin{enumerate}[a)]
	...
	\loigiai{
		\begin{listEX}[1]
			...
			\begin{eqnarray*}
				...
				&=& \dfrac{\sin 90^\circ}{\cos 9^\circ \cdot \cos 81^\circ} - \dfrac{\sin 90^\circ}{\cos 27^\circ \cdot \cos 63^\circ}\\
				&=&\dfrac{\cos 27^\circ \cdot \cos 63^\circ - \cos 9^\circ \cdot \cos 81^\circ}{\cos 9^\circ \cdot \cos 81^\circ \cdot \cos 27^\circ \cdot \cos 63^\circ}\\
				&=&\dfrac{ \dfrac{1}{2} \cdot \left( \cos 90^\circ+\cos 36^\circ\right) -\dfrac{1}{2} \cdot \left( \cos 90^\circ+\cos 72^\circ\right)	}
				{\dfrac{1}{2} \cdot \left( \cos 90^\circ+\cos 36^\circ\right) \cdot  \dfrac{1}{2} \cdot \left( \cos 90^\circ+\cos 72^\circ\right)}\\
				&=& \dfrac{2 \cdot \left( \cos 36^\circ - \cos 72^\circ\right) }{\cos 36^\circ \cdot \cos 72^\circ}\\
				&=& \dfrac{(-4) \cdot \sin 54^\circ \cdot \sin (-18^\circ)
				}{\sin 54^\circ \cdot \sin 18^\circ}\\
				&=& 4.
			\end{eqnarray*}
		\end{listEX}
	}
...
\boxmini{BÀI TẬP TỔNG HỢP TỰ LUYỆN CHO CÁC DẠNG TOÁN}
...
\begin{bt}
	\immini{Tam giác $ABC$ vuông tại $B$ và có hai cạnh góc vuông là $AB=4$, $BC=3$. Vẽ điểm $D$ nằm trên tia đối của tia $CB$ thỏa mãn $\widehat{CAD}=30^{\circ}$. Tính $\tan \widehat{BAD}$, từ đó tính độ dài cạnh $CD$ (\textit{làm tròn đến hàng phần chục}).}{\hspace{1cm}
