...
\begin{ex}%[1C1B1-3]
	\immini{Cho lục giác đều $A B C D E F$ nội tiếp trong đường tròn lượng giác (thứ tự đi từ $A$ đến các đỉnh theo chiều ngược chiều kim đồng hồ). Xét tính đúng sai của các khẳng định sau:
		\choiceTF
