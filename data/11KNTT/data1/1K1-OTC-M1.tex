...
\begin{ex}
    ...
    {\True $\dfrac{2x}{1+x^2}$}
    \loigiai{
    Ta có $\sin 2\alpha =2\sin \alpha \, \cdot \,\text{cos}\alpha =2\dfrac{\sin \alpha }{\text{cos}\alpha }\text{ \cdot co}{{\text{s}}^2}\alpha =2\tan \alpha \cdot \dfrac{1}{1+{{\tan }^2}\alpha }=\dfrac{2x}{1+x^2}$
    }
    \end{ex}
    %Câu 7
    \begin{ex}
    ...
    \choice
    {\True $\sin \left(\dfrac{\pi }{2}-x\right)>0$. B. $\sin 2x=\dfrac{4\sqrt{2}}{9}$}
    ...
    %Câu 17
    \begin{ex}
    Tổng số giờ ban ngày của ngày thứ $x$ trong năm được tính bởi công thức
    $g(x)=3\sin (0 \cdot 0172x-1 \cdot 376)+12$
    Trong đó $x$ đại diện cho ngày trong năm, $1\le x\le 365$. Hỏi ngày thứ mấy trong năm có số giờ ban ngày dài nhất?
    \shortans{171}
    \loigiai{
    Ta có $-1\le \sin (0 \cdot 0172x-1 \cdot 376)\le 1$\\
    $-3\le 3\sin (0 \cdot 0172x-1 \cdot 376)\le 3$\\
    $9\le 3\sin (0 \cdot 0172x-1 \cdot 376)+12\le 15$\\
    Suy ra $9\le g(x)\le 15$\\
    Do đó, số giờ ban ngày dài nhất trong một ngày là 15 giờ.\\
    Ta có phương trình $3\sin (0 \cdot 0172x-1 \cdot 376)+12=15$\\
    $\sin (0 \cdot 0172x-1 \cdot 376)=1$\\
    $x\approx 171{,}3$\\
    ...
    Trong khoảng thời gian từ 5 đến 10 giây, khoảng thời điểm sau $6$ giây đến trước $9$ giây thì\\
    người đó hít vào nên $a+b=6+9=15$
    }
    \end{ex}
    %Câu 21
    \begin{ex}
    ...
    Suy ra $a=6$; $b=1$. Vậy $a+b=7$
    }
    \end{ex}
    %Câu 22
    \begin{ex}
    Một vật $M$ được gắn vào đầu lò xo và dao động quanh vị trí cân bằng, toạ độ $x$ (đơn vị: cm) tại thời điểm $t$ (giây) được tính bởi công thức $x=8{,}6\sin \left(8t+\dfrac{\pi }{2}\right)$. Có bao nhiêu thời điểm trong khoảng 2 giây đầu tiên thì $s=4{,}3$ cm?
    \shortans{5}
    \loigiai{
    Khi $x=4{,}3$ thì $8{,}6\sin \left(8t+\dfrac{\pi }{2}\right)=4{,}3\Rightarrow \sin \left(8t+\dfrac{\pi }{2}\right)=\dfrac{1}{2}$\\
    $\Leftrightarrow \left[\begin{array}{*{35}{l}}\\
     8t+\dfrac{\pi }{2}=\dfrac{\pi }{6}+k2\pi \\\\
     8t+\dfrac{\pi }{2}=\dfrac{5\pi }{6}+l2\pi \\\\
    \end{array}(k,l\in \mathbb{Z})\Leftrightarrow \left[\begin{array}{*{35}{l}}\\
     t=-\dfrac{\pi }{24}+k\dfrac{\pi }{4} \\\\
     t=\dfrac{\pi }{24}+l\dfrac{\pi }{4} \\\\
    \end{array}(k,l\in \mathbb{Z}) \cdot \right. \right$.\\
    Vì $t\in (0;2)$ nên $\left\{ \begin{array}{*{35}{l}}\\
     0<-\dfrac{\pi }{24}+k\dfrac{\pi }{4}<2 \\\\
     0<\dfrac{\pi }{24}+l\dfrac{\pi }{4}<2 \\\\
    \end{array} \right$.$\Leftrightarrow \left\{ \begin{array}{*{35}{l}}\\
     \dfrac{1}{6}<k<\dfrac{8}{\pi }+\dfrac{1}{6} \\\\
     -\dfrac{1}{6}<l<\dfrac{8}{\pi }-\dfrac{1}{6} \\\\
    \end{array} \right$.\\
