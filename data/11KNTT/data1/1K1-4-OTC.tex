...
\begin{ex}%[Câu 45]%[1K1K1-9]
	\immini[thm]{Người ta muốn làm một cánh diều hình quạt có bán kính là $a$, độ dài cung tròn là $b$ và có chu vi là $80$ cm (như hình vẽ). Khi diện tích cánh diều đạt giá trị lớn nhất, tổng $a+b$ bằng
		\choice
		{$50$ cm}
		{$40$ cm}
		{$70$ cm}
