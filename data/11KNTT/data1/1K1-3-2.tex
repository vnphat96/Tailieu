...
\loigiai{
	\begin{enumerate}
		\item $y=5-3\cos 4x$có tập xác định: $\mathscr{D}=\mathbb{R}$.\\
		$\forall x \in \mathbb{R}$, ta có
		\begin{eqnarray*}
			&&-1 \leq \cos 4x \leq 1\\
			&\Leftrightarrow& -3 \geq -3\cos 4x \geq -3\\
			&\Leftrightarrow& 5+3 \geq 5-3\cos 4x \geq 5-3\\
			&\Leftrightarrow& 2 \leq y \leq 8.
		\end{eqnarray*}
		Vậy tập giá trị của hàm số là $[2;8]$.
		\item $y=2+3\cos x$ có tập xác định: $\mathscr{D}=\mathbb{R}$.\\
		$\forall x \in \mathbb{R}$, ta có
		\begin{eqnarray*}
			&&-1 \leq \cos x \leq 1\\
			&\Leftrightarrow& -3 \geq 3\cos x \geq -3\\
...
\begin{tasks}
	\task $y=3-\sin 2 x$ trên $\left[ 0; \dfrac{\pi}{2}\right]$;
	\task $y=\sin 2 x+2$ trên $\left[ 0; \dfrac{\pi}{2}\right]$;
	\task $y=\cos \left(x+\dfrac{\pi}{3}\right)$ trên $[0 ; \pi]$;
	\task $y=\sin \left(2 x+\dfrac{\pi}{4}\right)+\dfrac{1}{2}$ trên $\left[-\dfrac{\pi}{4} ; \dfrac{\pi}{4}\right]$;
	\task $y=\sin^4 x+\cos^4 x$ trên $\left[0 ; \dfrac{\pi}{6}\right]$;
	\task $y=\sin^6 x+\cos^6 x$  trên $\left[-\dfrac{\pi}{2} ; \dfrac{\pi}{2}\right]$;
	\task $y=\sqrt{3} \sin 2 x+2 \cos^2 x+3$ trên $\left[-\dfrac{5 \pi}{6}; \dfrac{\pi}{4}\right]$;
	\task $y=\sin 2 x+\cos 2 x+3$ trên $\left[-\dfrac{\pi}{4} ; \dfrac{\pi}{4}\right]$.	
\end{tasks}
\loigiai{
	\begin{enumerate}
		\item $y=3-\sin 2 x$ trên $\left[ 0; \dfrac{\pi}{2}\right]$\\
		\immini
		...
		\item $y=\sin 2 x+2$ trên $\left[ 0; \dfrac{\pi}{2}\right]$\\
		\immini
		{Ta có $x\in \left[ 0; \dfrac{\pi}{2}\right]\Rightarrow 2x\in \left[ 0; \pi\right]$.\\
			Với mọi $2x\in \left[ 0; \pi\right]$ ta có
			\allowdisplaybreaks
		...
		\item $y=\cos \left(x+\dfrac{\pi}{3}\right)$ trên $[0 ; \pi]$\\
		\immini
		...
		\item $y=\sin \left(2 x+\dfrac{\pi}{4}\right)+\dfrac{1}{2}$ trên $\left[-\dfrac{\pi}{4} ; \dfrac{\pi}{4}\right]$\\
		\immini
		...
		\item $y=\sin^4 x+\cos^4 x$ trên $\left[0 ; \dfrac{\pi}{6}\right]$\\
		Ta có
		\allowdisplaybreaks
		\begin{eqnarray*}
			\sin^4 x+\cos^4 x
		...
		\item $y=\sin^6 x+\cos^6 x$  trên $\left[-\dfrac{\pi}{2} ; \dfrac{\pi}{2}\right]$\\
		Ta có
		\allowdisplaybreaks
		\begin{eqnarray*}
			\sin^6 x+\cos^6 x
		...
		\item $y=\sqrt{3} \sin 2 x+2 \cos^2 x+3$ trên $\left[-\dfrac{5 \pi}{6}; \dfrac{\pi}{4}\right]$.\\
		Ta có
		\allowdisplaybreaks
		\begin{eqnarray*}
			y
		...
		\item $y=\sin 2 x+\cos 2 x+3$ trên $\left[-\dfrac{\pi}{4} ; \dfrac{\pi}{4}\right]$.\\
