...
\begin{ex}
	...
	\loigiai{
		...
		$\Leftrightarrow \cos \left(\dfrac{\pi t}{6}+\dfrac{\pi }{4}\right)=1\Leftrightarrow \dfrac{\pi t}{6}+\dfrac{\pi }{4}=k2\pi \Leftrightarrow t=-\dfrac32 + 12k$ với $k\in \mathbb{Z}$.\\
		Vì $0\le t\le 24$ nên $t \in \left\{10,5; 22,5\right\} $
	}
\end{ex}
%Câu 12
\begin{ex}
