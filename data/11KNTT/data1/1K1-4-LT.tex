...
\begin{tomtat}
	\subsubsection{Phương trình \boldmath $ sin\, x = a $ \unboldmath.}
	Phương trình $\sin x = a$ có nghiệm khi và chỉ khi $a \in [-1;1]$. 
	...
	\subsubsection{Phương trình \boldmath $ cos\, x = a $ \unboldmath.}
	Phương trình $\cos x = a$ có nghiệm khi và chỉ khi $a \in [-1;1]$. 
	\begin{enumerate}[\faCheckSquareO]
		\item Trường hợp $a \in \{-1;0;1\}$.
		      \begin{boxdn}
			      \begin{tikzpicture}[smooth,samples=300,scale=0.8,>=stealth]
		...
		\item Trường hợp $a \in \left\{\pm \dfrac{1}{2};\pm \dfrac{\sqrt{2}}{2};\pm \dfrac{\sqrt{3}}{2}\right\}$ hoặc $a \in (-1;1)$. Ta bấm máy \shiftk \cosk để tìm góc $\alpha$ hoặc $\beta^\circ$ tương ứng.
		      ...
		      % \end{boxdn}
	\end{enumerate}
	\subsubsection{Phương trình \boldmath $ tan\, x = a $ \unboldmath.}
	\begin{enumerate}[\faCheckSquareO]
		      ...
		      \begin{boxdn}
			      \immini[thm]{
				      ...
				      \end{listEX}
					      ...
					      \draw (I) circle(1cm);
					      \draw[->] (1,-1.3)--(1,1.5)node[right]{\footnotesize$\tan$};
	...
	\subsubsection{Phương trình \boldmath $ cot\, x = a $ \unboldmath.}
		      ...
		      \begin{boxdn}
			      \immini[thm]{
				      ...
				      \end{listEX}
					      ...
					      \draw (I) circle(1cm);
					      \draw[->] (-1.4,1)--(2,1)node[above]{\footnotesize$\cot$};
					      \tkzInterLC[R](I,A)(I,1cm)\tkzGetPoints{M}{N}
					      \tkzDrawPoints[size=3,fill=black](I,M,N,A)
					      \tkzDrawSegments(A,M)
					      \tkzLabelPoints[below,font=\footnotesize](M)
