...
\begin{tomtat}
	...
	\begin{tc}
		Hàm số $y=\tan x$:
		\begin{itemize}
			\item    Có tập xác định là $\mathbb{R} \backslash\left\{\dfrac{\pi}{2}+k \pi \Big| k \in \mathbb{Z} \right\}$ và tập giá trị là $\mathbb{R}$;
	...
	\begin{tc}
		Hàm số $y=\cot x$:
		\begin{itemize}
			\item    Có tập xác định là $\mathbb{R} \backslash\{k \pi \mid k \in \mathbb{Z} \}$ và tập giá trị là $\mathbb{R}$; 
			\item    Là hàm số lẻ và tuần hoàn với chu kì $\pi$;
