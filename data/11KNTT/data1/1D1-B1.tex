...
\subsubsection{QUAN HỆ GIỮA CÁC GIÁ TRỊ LƯỢNG GIÁC}
	...
	\iconMT \indam{Giá trị lượng giác của các góc có liên quan đặc biệt:}
			...
			\immini{	\color{mauB}\begin{itemize}
...
\dongcham{1}
\begin{vd} 
	\immini{Xác định số đo các góc lượng giác $(Ou,Ov)$, $(Ov,Om)$ và $(Ou,Om)$ được minh họa ở hình bên.}{
...
\begin{dang}{Tính các giá trị lượng giác của một góc lượng giác}
	\begin{itemize}
		...
		\immini{ Nếu đề bài có giới hạn miền của góc $\alpha$, thì ta cần xem trên miền đó, các GTLG tương ứng sẽ mang dấu như thế nào. Cụ thể:
...
\begin{bt}%[Tex hóa SGK CD-CT,T7/22, TVN-099]%[1T1K1-3]
	\immini{Trong hình vẽ bên, mâm bánh xe ô tô được chia thành năm phần bằng nhau. Viết công thức số đo tổng quát của góc lượng giác $(Ox, ON)$.\\
	\cham{5}}
	{
...
\begin{bt}%[Tex hóa SGK CD-CT,T7/22, TVN-099]%[1T1B1-6]
	\immini{Hải lí là một đơn vị chiều dài hàng hải, được tính bằng độ dài một cung chắn một góc $\alpha=\left(\dfrac{1}{60}\right)^{\circ}$ của đường kinh tuyến (Hình bên). Đổi số đo $\alpha$ sang radian và cho biết 1 hải lí bằng khoảng bao nhiêu kilômét, biết bán kính trung bình của Trái Đất là $6371\, km$. Làm tròn kết quả đến hàng phần trăm.}
