...
\begin{ex}
	...
	\loigiai{
		...
		Vậy $D=\mathbb{R}\backslash \left\{ \dfrac{\pi }{2}+k2\pi ,k\in \mathbb{Z} \right\}$.\\
		d) $y=\dfrac{1}{\tan x}$\\
...
\begin{ex}
	...
	\loigiai{
		...
		b) Vì $\cos x\ge -1\Leftrightarrow 2+\cos x\ge 1>0,\forall x\in \mathbb{R}$ nên tập xác định của hàm số là $D=\mathbb{R}$.\\
		Ta có:\\
		...
		d) Vì $2+\sin x\ge 1>0,\forall x\in \mathbb{R}$ nên tập xác định của hàm số là $D=\mathbb{R}$.\\
