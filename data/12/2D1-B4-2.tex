	...
	\loigiai{
		\begin{enumerate}[a)]
			\item Tập xác định: $\mathbb{R} \backslash\{-1\}$.\\
			      Sự biến thiên:
			      \begin{itemize}
				      \item [$\bullet$] Đạo hàm $y'=\dfrac{2}{(x+1)^{2}}>0$ với mọi $x \neq -1$.
				      \item [$\bullet$] Giới hạn và tiệm cận:\\
				            $\displaystyle\lim \limits_{x \rightarrow -1^{-}} y= +\infty, \displaystyle\lim \limits_{x \rightarrow -1^{+}} y= -\infty$. Do đó, đường thẳng $x=-1$ là tiệm cận đứng của đồ thị hàm số.\\
				            $\displaystyle\lim \limits_{x \rightarrow-\infty} y=1, \displaystyle\lim \limits_{x \rightarrow +\infty} y=1$. Do đó, đường thẳng $y=1$ là tiệm cận ngang của đồ thị hàm số.
			...
			\item Tập xác định $\mathbb{R} \backslash\{1\}$.\\
			      Sự biến thiên:
			      \begin{itemize}
				      \item [$\bullet$] Đạo hàm: $y'=\dfrac{-3}{(x-1)^{2}}<0$ với mọi $x \neq 1$.
				      \item [$\bullet$] Giới hạn và các đường tiệm cận:\\
				            $\displaystyle\lim \limits_{x \rightarrow 1^{-}} y=-\infty, \displaystyle\lim \limits_{x \rightarrow 1^{+}} y=+\infty$. Do đó, đường thẳng $x=1$ là tiệm cận đứng của đồ thị hàm số.\\
				            $\displaystyle\lim \limits_{x \rightarrow+\infty} y=2, \displaystyle\lim \limits_{x \rightarrow-\infty} y=2$. Do đó, đường thẳng $y=2$ là tiệm cận ngang của đồ thị hàm số.
			...
			\item Tập xác định: $D = \mathbb{R} \setminus \left\{ 2\right\}$.\\
			      ...
			      \begin{itemize}
				      ...
				      \item [$\bullet$] Giới hạn và tiệm cận:\\
				            $\displaystyle\lim \limits_{x \rightarrow 2^{-}} y=+\infty, \displaystyle\lim \limits_{x \rightarrow 2^{+}} y=-\infty$. Do đó, đường thẳng $x=2$ là tiệm cận đứng của đồ thị hàm số.\\
				            $\displaystyle\lim \limits_{x \rightarrow+\infty} y=-1, \displaystyle\lim \limits_{x \rightarrow-\infty} y=-1$. Do đó, đường thẳng $y=-1$ là tiệm cận ngang của đồ thị hàm số.
				      \item [$\bullet$] Bảng biến thiên:
				            \begin{center}
