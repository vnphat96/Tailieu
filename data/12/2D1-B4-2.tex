		...
		\begin{enumerate}[a)]
			\item Tập xác định: $\mathbb{R} \backslash\{-1\}$.\\
			      ...
			      \begin{itemize}
				      ...
				      \item [$\bullet$] Giới hạn và tiệm cận:\\
				            $\displaystyle\lim \limits{n \to +\infty}_{x \rightarrow -1^{-}} y= +\infty, \displaystyle\lim \limits{n \to +\infty}_{x \rightarrow -1^{+}} y= -\infty$. Do đó, đường thẳng $x=-1$ là tiệm cận đứng của đồ thị hàm số.\\
				            $\displaystyle\lim \limits{n \to +\infty}_{x \rightarrow-\infty} y=1, \displaystyle\lim \limits{n \to +\infty}_{x \rightarrow +\infty} y=1$. Do đó, đường thẳng $y=1$ là tiệm cận ngang của đồ thị hàm số.
			...
			\item Tập xác định $\mathbb{R} \backslash\{1\}$.\\
			      ...
			      \begin{itemize}
				      ...
				      \item [$\bullet$] Giới hạn và các đường tiệm cận:\\
				            $\displaystyle\lim \limits{n \to +\infty}_{x \rightarrow 1^{-}} y=-\infty, \displaystyle\lim \limits{n \to +\infty}_{x \rightarrow 1^{+}} y=+\infty$. Do đó, đường thẳng $x=1$ là tiệm cận đứng của đồ thị hàm số.\\
				            $\displaystyle\lim \limits{n \to +\infty}_{x \rightarrow+\infty} y=2, \displaystyle\lim \limits{n \to +\infty}_{x \rightarrow-\infty} y=2$. Do đó, đường thẳng $y=2$ là tiệm cận ngang của đồ thị hàm số.
			...
			\item Tập xác định: $D = \mathbb{R} \setminus \left\{ 2\right\}$.\\
			      ...
			      \begin{itemize}
				      ...
				      \item [$\bullet$] Giới hạn và tiệm cận:\\
				            $\displaystyle\lim \limits{n \to +\infty}_{x \rightarrow 2^{-}} y=+\infty, \displaystyle\lim \limits{n \to +\infty}_{x \rightarrow 2^{+}} y=-\infty$. Do đó, đường thẳng $x=2$ là tiệm cận đứng của đồ thị hàm số.\\
				            $\displaystyle\lim \limits{n \to +\infty}_{x \rightarrow+\infty} y=-1, \displaystyle\lim \limits{n \to +\infty}_{x \rightarrow-\infty} y=-1$. Do đó, đường thẳng $y=-1$ là tiệm cận ngang của đồ thị hàm số.
				      \item [$\bullet$] Bảng biến thiên:
				            \begin{center}
