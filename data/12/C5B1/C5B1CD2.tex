...
\begin{ex}%[2H5H1-3]
	Trong không gian $Oxyz$, cho điểm $A(1; -2; 3)$ và hai véc-tơ  $\overrightarrow{v}=(-1; 2; 3)$, $\overrightarrow{u}=(-2; 0; 1)$.
	\choiceTF
...
\end{ex}
\begin{ex}%[2H5H1-3]
	Trong không gian với hệ tọa độ $Oxyz$, cho ba điểm $A(1;1;4)$, $B(2;7;9)$, $C(0;9;13)$.
	\choiceTF
...
\end{ex}
\begin{ex}%[2H5H1-3]
	Trong không gian với hệ tọa độ $Oxyz$, cho hai điểm $A(1;0;0)$, $B(4;1;2)$.
	\choiceTF
...
\begin{ex}%[2H5H2-3]%Câu 28
	Trong không gian với hệ tọa độ $Oxyz$, cho hai điểm $A(1 ; 0 ; 0), B(4 ; 1 ; 2)$. Mệnh đề nào sau đây đúng hay sai?
	\choiceTF
...
\begin{ex} %[2H5H2-3]%câu 33
	Trong không gian $Oxyz$, phương trình tổng quát mặt phẳng $(P)\colon ax+by+cz+d=0$ đi qua điểm $M(3 ;-1 ; 4)$ đồng thời vuông góc với giá của véc-tơ $\overrightarrow{a}=(1 ;-1 ; 2)$. Tính $a+b+c$.
	\shortans{$2$}
	\loigiai{
...
\begin{ex} %[2H5H2-3]%Câu 34.
	Trong không gian với hệ tọa độ $Oxyz$, phương trình mặt phẳng $(P)\colon ax+by+cz+d=0$ qua $M(0 ;-2 ; 1)$ và có cặp véc-tơ chỉ phương $\overrightarrow{a}=(-2 ;-3 ; 8), \overrightarrow{b}=(-1 ; 0 ; 6)$. Tính $a+b+c$.
	\shortans{$17$} 
	\loigiai{
...
\begin{ex}%[2H5V2-5]%Câu 41
	Trong không gian với hệ tọa độ $Oxyz$, cho mặt phẳng $(P)\colon 2 x+2y-z-1=0$ Mặt phẳng nào sau đây song song với $(P)$ và cách $(P)$ một khoảng bằng $3$?
	\choice
...
\begin{ex} %[2H5V2-5]%Cau 45
	Trong không gian với hệ tọa độ $Oxyz$, cho mặt phẳng $(P)\colon 2 x-2 y+z-5=0$.  Viết phương trình mặt phẳng $(Q)$ song song với mặt phẳng $(P)$, cách $(P)$ một khoảng bằng $3$ và cắt trục $Ox$ tại điểm có hoành độ dương. 
	\choice
	{$(Q)\colon 2x-2y+z+4=0$}
