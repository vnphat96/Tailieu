...
\begin{dang}{VIẾT PHƯƠNG TRÌNH TỔNG QUÁT MẶT PHẲNG KHI BIẾT MỘT ĐIỂM THUỘC MẶT PHẲNG VÀ MỘT Vectơ PHÁP TUYẾN HOẶC HAI Vectơ CHỈ PHƯƠNG}
1. Lập phương trình tổng quát của mặt phẳng đi qua điểm $M_0 \left(x_0;y_0;z_0\right)$ và biết một vectơ pháp tuyến $\overrightarrow{n} = \left(A;B;C\right)$\\
...
$\textbf{Chú ý:}$
\begin{enumerate}[a.]
\item Phải nắm vững khái niệm $\textbf{vectơ pháp tuyến}$ và $\textbf{vectơ chỉ phương}$ của mặt phẳng.
\begin{itemize}
\item Vectơ pháp tuyến của mặt phẳng là vec-tơ có giá vuông góc với mặt phẳng đó. Nếu $\overrightarrow{n}$ là một vectơ pháp tuyến của mặt phẳng thì $k\overrightarrow{n}$ ($k \neq 0)$ cũng là một vectơ pháp tuyến của mặt phẳng đó.
\item Vec-tơ chỉ phương của mặt phẳng là vec-tơ có giá song song với mặt phẳng đó. Nếu $\overrightarrow{a}$ là một vectơ chỉ phương của mặt phẳng thì $k\overrightarrow{a}$ cũng là một vectơ chỉ phương của mặt phẳng đó.
\end{itemize}
...
\item Đường thẳng vuông góc mặt phẳng thì vectơ chỉ phương của đường thẳng là vectơpháp tuyến của mặt phẳng.
\end{itemize}
\end{enumerate}
