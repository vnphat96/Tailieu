...
%%%==============EX_10============%%%
\begin{ex}%[2H5V1-5]
	Trong không gian với hệ tọa độ $Oxyz$, cho hình chóp $S. ABCD$, đáy $ABCD$ là hình chữ nhật. Biết $A(0; 0; 0)$, $D(2; 0; 0)$, $B(0; 4; 0)$, $S(0; 0; 4)$. Gọi $M$ là trung điểm của $SB$. Tính khoảng cách từ điểm $B$ đến mặt phẳng $(AMC)$.(Kết quả làm tròn đến hàng phần chục).
	\begin{center}
