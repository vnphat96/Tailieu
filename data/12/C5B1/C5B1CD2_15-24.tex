\begin{ex}%[2H5H2-3]%Câu 28
	Trong không gian $Oxyz$, cho hai điểm $A(1 ; 0 ; 0), B(4 ; 1 ; 2)$. Mệnh đề nào sau đây đúng hay sai?
	\choiceTF
...
\begin{ex}%[2H5H2-3]%Cau 30
	Trong không gian $Oxyz$, cho điểm $A(3 ; 5 ; 2)$.  Gọi $A_{1}, A_{2}, A_{3}$ lần lượt là hình chiếu của điểm $A$ lên các mặt phẳng $(Oxy),(Oyz),(Oxz)$. Mệnh đề nào sau đây đúng hay sai?
	\choiceTF
...
\begin{ex} %[2H5H2-3]%Cau 31
	Trong không gian $Oxyz$, cho hai điểm $A(4 ; 0 ; 1)$ và $B(-2 ; 2 ; 3)$. Mệnh đề nào sau đây đúng hay sai?
	\choiceTF
...
\begin{ex} %[2H5H2-3]%câu 33
	Trong không gian $Oxyz$, phương trình tổng quát mặt phẳng $(P)\colon ax+by+cz+d=0$ đi qua điểm $M(3 ;-1 ; 4)$ đồng thời vuông góc với giá của vectơ $\overrightarrow{a}=(1 ;-1 ; 2)$. Tính $a+b+c$.
	\shortans{$2$}
	\loigiai{
...
\begin{ex} %[2H5H2-3]%Câu 34.
	Trong không gian $Oxyz$, phương trình mặt phẳng $(P)\colon ax+by+cz+d=0$ qua $M(0 ;-2 ; 1)$ và có cặp vectơ chỉ phương $\overrightarrow{a}=(-2 ;-3 ; 8), \overrightarrow{b}=(-1 ; 0 ; 6)$. Tính $a+b+c$.
	\shortans{$17$} 
	\loigiai{
...
\begin{ex} %[2H5H2-3] %Câu 35
	Trong không gian $Oxyz$, cho $A(1 ; 1 ; 0), B(0 ; 2 ; 1), C(1 ; 0 ; 2), D(1 ; 1 ; 1)$. Mặt phẳng $(\alpha)\colon ax+by+cz+d=0$ đi qua $A(1 ; 1 ; 0), B(0 ; 2 ; 1),(\alpha)$ song song với đường thẳng $CD$. Tính $a+b+c$.
	\shortans{$4$}
	\loigiai{
...
\begin{ex} %[2H5H2-3]%Câu 36 
	Trong không gian $Oxyz$, cho điểm $M(2 ; 1 ;-3)$ và mặt phẳng $(P)\colon 3 x-2 y+z-3=0$. Phương trình của mặt phẳng đi qua $M$ và song song với $(P)$ có dạng $(Q)\colon ax+by+cz+d=0$. Tính $a+b+c$.
	\shortans{$2$}
	\loigiai{
...
\begin{ex} %[2H5H2-4]%Câu 39
	Trong không gian $Oxyz$, cho hai điểm $A(2 ; 4 ; 1), B(-1 ; 1 ; 3)$ và mặt phẳng $(P)\colon x-3y+2z-5=0$. Lập phương trình mặt phẳng $(Q)$ đi qua hai điểm $A, B$ và vuông góc với mặt phẳng $(P)\colon ax+by+cz+d=0$. Tính $a+b+c$.
	\shortans{$5$}
	\loigiai{
...
\begin{dang}{VIẾT PHƯƠNG TRÌNH TỔNG QUÁT MẶT PHẲNG KHI BIẾT MỘT Vectơ PHÁP TUYẾN HOẶC HAI Vectơ CHỈ PHƯƠNG MÀ KHÔNG BIẾT ĐIỂM THUỘC MẶT PHẲNG}
\end{dang}
\begin{tomtat}
	Khi viết phương trình tổng quát của mặt phẳng $(\alpha)$ mà có một vectơ pháp tuyến $\overrightarrow{n}=(A ; B ; C)$ hoặc có hai vectơ chỉ phương $\overrightarrow{a}, \overrightarrow{b}$ (với $\overrightarrow{n}=\left[\overrightarrow{a}, \overrightarrow{b}\right]$) và không tìm được điểm $M_0\left(x_0 ; y_0 ; z_0\right) \in(\alpha)$ thì ta thực hiện các bước sau
	\begin{itemize}
...
\begin{ex}%[2H5V2-5]%Câu 41
	Trong không gian $Oxyz$, cho mặt phẳng $(P)\colon 2 x+2y-z-1=0$ Mặt phẳng nào sau đây song song với $(P)$ và cách $(P)$ một khoảng bằng $3$?
	\choice
...
\begin{ex} %[2H5V2-5]%Câu 43.
	Trong không gian $Oxyz$ cho $A(2 ; 0 ; 0), B(0 ; 4 ; 0), C(0 ; 0 ; 6), D(2 ; 4 ; 6)$. Gọi $(P)$ là mặt phẳng song song với mặt phẳng $(A B C),(P)$ cách đều $D$ và mặt phẳng $(ABC)$. Phương trình của $(P)$ là
	\choice
	{\True $6x+3y+2z-24=0$}
	{$6x+3y+2z-12=0$}
	{$6x+3y+2z=0$}
...
\begin{ex} %[2H5V2-5]%Cau 45
	Trong không gian $Oxyz$, cho mặt phẳng $(P)\colon 2 x-2 y+z-5=0$.  Viết phương trình mặt phẳng $(Q)$ song song với mặt phẳng $(P)$, cách $(P)$ một khoảng bằng $3$ và cắt trục $Ox$ tại điểm có hoành độ dương. 
	\choice
	{$(Q)\colon 2x-2y+z+4=0$}
...
\begin{ex}  %[2H5V2-5]%Câu 48
	Trong không gian $Oxyz$, gọi $(\gamma)$ là mặt phẳng cách đều hai mặt phẳng sau đây:
...
\begin{ex} %[2H5V2-5]%Câu 49.
	Trong không gian $Oxyz$ cho các điểm $A(2 ; 0 ; 0), B(0 ; 4 ; 0), C(0 ; 0 ; 6), D(2 ; 4 ; 6)$. Gọi $(P)$ là mặt phẳng song song với mặt phẳng $(A B C),(P)$ cách đều $D$ và mặt phẳng $(A B C)$. Viêt phương trình của mặt phẳng $(P)\colon ax+by+cz+d=0$. Tính $a+b+c$.
	\shortans{$11$}
	\loigiai{
...
\begin{dang}{VIẾT PHƯƠNG TRÌNH TỔNG QUÁT MẶT PHẲNG KHI BIẾT ĐIỂM THUỘC MẶT PHẲNG VÀ KHÔNG BIẾT Vectơ PHÁP TUYẾN HOẶC KHÔNG BIẾT HAI Vectơ CHỈ PHƯƠNG}
\end{dang}
\begin{tomtat}
...
\begin{ex} %[2H5V2-5]%Câu 50
	Trong không gian $Oxyz$, cho $3$ điểm $A(1 ; 0 ; 0), B(0 ;-2 ; 3), C(1 ; 1 ; 1)$. Gọi $(P)$ là mặt phẳng chứa $A, B$ sao cho khoảng cách từ $C$ tới mặt phẳng $(P)$ bằng $\dfrac{2}{\sqrt{3}}$.  Phương trình mặt phẳng $(P)$ là
	\choice
