...
\begin{itemize}
	\immini[thm]{	\item [\iconCH] Trong không gian, tập hợp tất cả các điểm $M$  cách điểm $I$ cố định một khoảng không đổi $r$ $(r>0)$  cho trước được gọi là mặt cầu tâm $I$ bán kính $R$. Kí hiệu $S(I;r)$ hay viết tắt là $(S)$. Vậy $S(I;R)=\{M|IM=r\}.$
...
\begin{vd}
	...
	\begin{enumEX}[a)]{1}
		\item $(x-2)^2 + y^2 + (z+1)^2 = 4$\dotfill.
		\item $x^2+y^2+z^2-2x-4y+6z-2=0$ \dotfill.
		\item $x^2 + y^2 + z^2 - 2x + 4y + 3z + 8 = 0$\dotfill.
		\item $3x^2+3y^2+3z^2+6x+12y-9z+1=0$\dongcham{2}
	\end{enumEX}
	\loigiai{
		\begin{enumEX}[a)]{1}
			\item 
...
\begin{vd}%GV:Phan Phú Quý
	...
	\includegraphics[width=7cm]{images/2P5-B4-PhuQuy-H2}
	%\includegraphics[width=7cm]{images/5372.pdf}\\
...
\begin{vd}
	...
	\begin{center}
		\includegraphics[height=3cm]{images/2P5-B4-TheUt-H3}
	\end{center}
	\loigiai{
		\immini[thm]{Xét quả bóng tiếp xúc với các bức tường và chọn hệ trục $ Oxyz $ như hình vẽ bên.\\
