...
\begin{vd}%[2H5H2-7]
	...
	\end{listEX}
	\loigiai{
		\immini[thm]{Gọi $O$ là trung điểm của $AB$ suy ra $SO\perp(ABCD)$.\\
...
\begin{ex}
	...
	{$53,4^{\circ}$}
	\loigiai{
		\immini[thm]{Gắn hình hộp chữ nhật $ABCD.A'B'C'D'$ vào hệ trục tọa độ $Oxyz$. Khi đó $A(0,0,0)$, $B(0;2;0)$, $C(3;2;0)$, $D(3;0;0)$, $A'(0;0;4)$, $B'(0;2;4)$, $C'(3;2;4)$, $D'(3;0;4)$.\\
