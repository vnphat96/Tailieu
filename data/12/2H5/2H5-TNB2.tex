...
\begin{ex}%[2H5V2-3]
	...
	\loigiai{
		...
		Vì $d'$ nằm trong mặt phẳng $(P)$, cắt và vuông góc với $d$ nên $d'$ đi qua $M$ và có vectơ chỉ phương $\overrightarrow{u}_{d'}=\left[\overrightarrow{n}_{(P)}, \overrightarrow{u}_d\right]=(2 ;-5 ;-1)$ hay $d'$ nhận vectơ $\overrightarrow{v}=(-2 ; 5 ; 1)$ làm vectơ chỉ phương.\\
