...
\immini{\khung{\textbf{Vectơ chỉ phương}  $\vec{u}$ của đường thẳng $d$ là những vectơ khác $\vec{0}$ và có giá song song hoặc trùng với $d$. }
	\iconMT \indam{Chú ý:}  Nếu $\vec{u}$ và $\vec{u'}$ cùng là vectơ chỉ phương của $d$ thì $\vec{u'} = k \cdot \vec{u}$ (\textit{tọa độ tỉ lệ nhau}).
	}{
