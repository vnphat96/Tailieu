...
\begin{itemize}
	\immini[thm]{\item [\iconMT] \indam{Định nghĩa:} Vectơ pháp tuyến $\vec{n}$ của mặt phẳng $(P)$ là những vectơ khác $\vec{0}$ và có giá vuông góc với $(P)$. 
...
\begin{itemize}
	\immini[thm]{\item [\iconMT] \indam{Định nghĩa:} Cho điểm $M(x_0;y_0;z_0)$ và mặt phẳng $(P) \colon ax+by+cz+d=0$. Gọi $H$ là hình chiếu vuông góc của điểm $M$ lên mặt phẳng $(P)$. Khi đó độ dài đoạn $MH$ được gọi là khoảng cách từ điểm $M$ đến $(P)$. Kí hiệu $\mathrm{d}\left(M,(P) \right)$.
