		...
		\loigiai{
			\begin{itemize}
				...
				\begin{itemize}
					...
					Lập phương trình tham số đường thẳng $I M$ với $\heva{&\text{qua } I \\&\vec{u}_{I M}=\vec{n}_P=(A ; B ; C).}$\\
...
\begin{ex}%[2H5C1-5]
		Trong không gian với hệ tọa độ $Oxyz$, cho hai điểm $A(1 ; 0 ; 2)$, $B(3 ; 1 ;-1)$ và mặt phẳng $(P)\colon x+y+z-1=0$. Gọi $M(a ; b ; c) \in(P)$ sao cho $\left|3 \vec{M A}-2 \vec{M B}\right|$ đạt giá trị nhỏ nhất. Tính $S=9a+3b+6c$.
		\choice
		{$4$}
		{\True $3$}
		{$2$}
...
%%%=============EX_2=============%%%
\begin{ex}%[2H2C2-2]
	Trong không gian với hệ tọa độ $Oxyz$, cho ba điểm $A(4;2; 2)$, $B(1;1;-1)$, $C(2;-2;-2)$. Tìm tọa độ điểm $M$ thuộc $(Oxy)$ sao cho $\left|\vec{MA}+2\vec{MB}-\vec{MC}\right|$ nhỏ nhất.
	\choice
	{\True $M(2;3;0)$}
	{$M(1;3;0)$}
	{$M(2;-3;0)$}
...
%%%=============EX_4=============%%%
\begin{ex}%[2H2C2-2]
	Trong không gian với hệ tọa độ $Oxyz$, cho ba điểm $A(4;2;2)$, $B(1;1;-1)$, $C(2;-2;-2)$. Tìm tọa độ điểm $M$ thuộc mặt phẳng $(Oyz)$ sao cho $\left|\vec{MA}+2\vec{MB}-\vec{MC}\right|$ nhỏ nhất
	\choice
	{$M(2; 3; 1)$}
	{\True $M(0; 3; 1)$}
	{$M(0;-3; 1)$}
...
\begin{ex}%[2H2C2-2]
	...
	\loigiai{
		...
		Đường thẳng $MI$ đi qua $I(-2;-3;3)$ và vuông góc với mặt phẳng $(P)$ có phương trình tham số là $MI\colon \heva{&x=-2+t\\&y=-3+t\\&z=3-t.}$\\
...
\begin{ex}%[2H5C1-5]
	Trong không gian với hệ tọa độ $Oxyz$, cho ba điểm $A\left(1;4;5 \right)$, $B\left(3;4;0 \right)$, $C\left(2;-1;0 \right)$ và mặt phẳng $(P)\colon 3x+3y-2z-29=0$. Gọi $M\left(a;b;c \right)$ là điểm thuộc $(P)$ sao cho biểu thức $T=M{{A}^2}+M{{B}^2}+3M{{C}^2}$ đạt GTNN. Tính tổng $ a+b+c$.
	\choice
	{\True 8}
	{10}
	{$-10$}
...
\begin{ex}%[2H5C1-5]
	...
	\loigiai{
		...
		Phương trình đường thẳng $M E$ $\colon\heva{&x=3+3 t \\& y=t \\& z=1-t.}$\\
...
\begin{ex}%[2H5C1-5]
	...
	\loigiai{
		...
		Phương trình đường thẳng đi qua $I$ và vuông góc với mặt phẳng $(P)$ là $\heva{&x=0+t \\& y=1-t \\& z=2+t.}$\\
...
%%%==============EX_2============%%%
\begin{ex}%[2H5V2-5] 
	Trong không gian với hệ tọa độ $Oxyz$, cho $A(2;3;-1)$, $B(2;3;2)$, $C(-1;0;2)$.Tìm tọa độ điểm $M$ thuộc mặt phẳng $(Oxz)$ để $S=\left|\overrightarrow{MA}-4\overrightarrow{MC}\right|+\left|\overrightarrow{MA}+\overrightarrow{MB}+\overrightarrow{MC}\right|$ nhỏ nhất.
	\choice
...
%%%==============EX_3============%%%
\begin{ex}%[2H5C1-3] 
	Trong không gian với hệ tọa độ $Oxyz$ cho mặt phẳng $(P)$ đi qua điểm $M(9;1;1)$ cắt các tia $Ox$, $Oy$, $Oz$ lần lượt tại $A$, $B$, $C$ ($A$, $B$, $C$ không trùng với gốc tọa độ). Thể tích tứ diện $OABC$ đạt giá trị nhỏ nhất là bao nhiêu?
	\choice
	{\True $\dfrac{81}{2}$}
	{$\dfrac{243}{2}$}
	{$\dfrac{81}{6}$}
...
%%%==============EX_8============%%%
\begin{ex}%[2H5V2-7]
	Trong không gian với hệ tọa độ $Oxyz$, cho điểm $A(2;-1;-2)$ và đường thẳng $(d)$ có phương trình $\dfrac{x-1}{1}=\dfrac{y-1}{-1}=\dfrac{z-1}{1}$. Gọi $(P)$ là mặt phẳng đi qua điểm $A$, song song với đường thẳng $(d)$ và khoảng cách từ $(d)$ tới mặt phẳng $(P)$ là lớn nhất. Khi đó mặt phẳng $(P)$ có dạng $x+ay+bz+c=0$. Tính $T=a+b+c+d$.
	\shortans[0]{$-15$}
	\loigiai{
...
%%%%==============EX_11============%%%
\begin{ex}%[2H5V1-5]
	Trong không gian $Oxyz$, cho hai điểm $A(1;2;-1),B(3;0;3)$. Gọi $(P)$ là mặt phẳng đi qua điểm $A$ và cách $B$ một khoảng lớn nhất. Biết $\overrightarrow{n}=(1;a;b)$ là một véc-tơ pháp tuyến của $(P)$. Tính $T=a+b$.
	\shortans[0]{$1$}
	\loigiai{
...
\begin{ex}%[2H2V2-2]
	...
	\loigiai{
		...
		Phương trình đường thẳng $AC\colon\heva{&x=-1+2t \\
			&y=t \\
...
%%%==============Cau_EX15==============%%%
\begin{ex}%[2H2V2-2]
	Trong không gian với hệ tọa độ $Oxyz$, cho $A(-3;1;1)$, $B(5;1;1)$ và hai mặt phẳng $(P)\colon x+2y+z-4=0$, $(Q)\colon -x+y+z-1=0$. Gọi $M(a;b;c)$ là điểm nằm trên hai mặt phẳng $(P)$ và $(Q)$ sao cho $MA+MB$ đạt giá trị nhỏ nhất. Tính $T=a^2+b^2+c^2$.
	\shortans[]{$3$}
	\loigiai{
		...
		\end{itemize}
		Khi đó đường thẳng $d$ đi qua $N(1;1;1)$ và có một véctơ chỉ phương là $\overrightarrow{u}_d=\left[\overrightarrow{n}_P, \overrightarrow{n}_Q\right]=(1;-2;3)$ nên có phương trình tham số là $d\colon \heva{&x=1+t \\
			&y=1-2t \\
...
\begin{ex}%[2H5C2-3]
	...
	\loigiai{
		...
		Ta có phương trình đường thẳng $AK \colon \heva{&x=1\\ &y=4+2t\\ &z=3-t.}$\\ Gọi $K(1;4+2t;3-t)\in AK$.\\
