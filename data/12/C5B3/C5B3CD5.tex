...
%%%%==============EX_11============%%%
\begin{ex}%[2H5V1-5]
	Trong KG $Oxyz$, cho hai điểm $A(1;2;-1),B(3;0;3)$. Gọi $(P)$ là mặt phẳng đi qua điểm $A$ và cách $B$ một khoảng lớn nhất. Biết $\overrightarrow{n}=(1;a;b)$ là một vectơ pháp tuyến của $(P)$. Tính $T=a+b$.
	\shortans[0]{$1$}
	\loigiai{
