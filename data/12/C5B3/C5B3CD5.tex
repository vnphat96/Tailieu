...
\begin{ex}%[2H5C1-5]
		Trong không gian $Oxyz$, cho hai điểm $A(1 ; 0 ; 2)$, $B(3 ; 1 ;-1)$ và mặt phẳng $(P)\colon x+y+z-1=0$. Gọi $M(a ; b ; c) \in(P)$ sao cho $\left|3 \vec{M A}-2 \vec{M B}\right|$ đạt giá trị nhỏ nhất. Tính $S=9a+3b+6c$.
		\choice
		{$4$}
		{\True $3$}
		{$2$}
	...
	\begin{itemize}
		...
		Gọi $\Delta$ là đường thẳng qua $I$ và vuông góc với $(P)$. Khi đó $\Delta$ nhận vectơ pháp tuyến của $(P)$ là $\vec{n}=(1 ; 1 ; 1)$  làm vectơ chỉ phương.\\
...
%%%=============EX_2=============%%%
\begin{ex}%[2H2C2-2]
	Trong không gian $Oxyz$, cho ba điểm $A(4;2; 2)$, $B(1;1;-1)$, $C(2;-2;-2)$. Tìm tọa độ điểm $M$ thuộc $(Oxy)$ sao cho $\left|\vec{MA}+2\vec{MB}-\vec{MC}\right|$ nhỏ nhất.
	\choice
	{\True $M(2;3;0)$}
	{$M(1;3;0)$}
	{$M(2;-3;0)$}
...
%%%=============EX_4=============%%%
\begin{ex}%[2H2C2-2]
	Trong không gian $Oxyz$, cho ba điểm $A(4;2;2)$, $B(1;1;-1)$, $C(2;-2;-2)$. Tìm tọa độ điểm $M$ thuộc mặt phẳng $(Oyz)$ sao cho $\left|\vec{MA}+2\vec{MB}-\vec{MC}\right|$ nhỏ nhất
	\choice
	{$M(2; 3; 1)$}
	{\True $M(0; 3; 1)$}
	{$M(0;-3; 1)$}
...
%%%=============EX_5=============%%%
\begin{ex}%[2H2C2-2]
	Trong không gian $Oxyz$, cho các điểm $A(1;-1;3)$, $B(2;1;0)$, $C(-3;-1;-3)$ và mặt phẳng $(P)\colon x+y-z-4=0$. Gọi $M(a,b,c)$ là điểm thuộc mặt phẳng $(P)$ sao cho biểu thức $T=\left|3\vec{MA}-2\vec{MB}+\vec{MC}\right|$ đạt giá trị nhỏ nhất. Tính giá trị của biểu thức $S=a+b+c$. 
	\choice
	{$S=3$}
	{$S=-1$}
	{\True $S=2$}
...
\begin{ex}%[2H5C1-5]
	Trong không gian $Oxyz$, cho ba điểm $A\left(1;1;1 \right),B\left(-1;2;0 \right),C\left(3;-1;2 \right)$ và điểm $M$ thuộc mặt phẳng $(\alpha)\colon2x-y+2z+7=0$. Tính giá trị nhỏ nhất của $\break P=\left| 3\overrightarrow{MA}+5\overrightarrow{MB}-7\overrightarrow{MC} \right|$.
	\choice
	{${{P}_{\min}}=20$}
	{${{P}_{\min}}=5$}
	{${{P}_{\min}}=25$}
...
\begin{ex}%[2H5C1-5]
	Trong không gian $Oxyz$, cho ba điểm $A\left(1;4;5 \right)$, $B\left(3;4;0 \right)$, $C\left(2;-1;0 \right)$. Gọi $M\left(a;b;c \right)$ là điểm sao cho $M{{A}^2}+M{{B}^2}+3M{{C}^2}$ đạt giá trị nhỏ nhất. Tổng $ a+b+c$ có giá trị bằng
	\choice
	{2}
	{3}
	{\True 4}
...
\begin{ex}%[2H5C1-5]
	Trong không gian $Oxyz$, cho ba điểm $A\left(1;4;5 \right)$, $B\left(3;4;0 \right)$, $C\left(2;-1;0 \right)$ và mặt phẳng $(P)\colon 3x+3y-2z-29=0$. Gọi $M\left(a;b;c \right)$ là điểm thuộc $(P)$ sao cho biểu thức $T=M{{A}^2}+M{{B}^2}+3M{{C}^2}$ đạt GTNN. Tính tổng $ a+b+c$.
	\choice
	{\True 8}
	{10}
	{$-10$}
...
\begin{ex}%[2H5C1-5]
	Trong không gian $Oxyz$, cho ba điểm $A\left(2;-2;4 \right)$, $B\left(-3;3;-1 \right)$, $C\left(-1;-1;-1 \right)$ và mặt phẳng $(P)\colon2x-y+2z+8=0$. Xét điểm $M$ thay đổi thuộc $(P)$, tìm giá trị nhỏ nhất của biểu thức $T=2M{{A}^2}+M{{B}^2}-M{{C}^2}$.	
	\choice
	{\True $102$}
	{$105$}
	{$30$}
...
\begin{ex} %[2H2C2-5]
	...
	\loigiai{Gọi $M=(a;b;c)$.\\
		...
		Đường thẳng $AB$ có vectơ chỉ phương $\overrightarrow{AB}=(10,0,2)$ và qua điểm $B(2,1,3)$ nên có phương trình $\heva{&x=2+5t\\&y=1\\&z=3+t.}$\\
...
\begin{ex} %[2H2C2-5]
	Trong không gian $Oxyz$ cho $A(3;2;1)$, $B(-2;3;6)$. Điểm $ M(x_M;y_M;z_M)$ thay đổi thuộc mặt phẳng $(Oxy)$. Tìm giá trị của biểu thức $ T=x_M+y_M+z_M$ khi $\left|\overrightarrow{MA}+3\overrightarrow{MB}\right|$ nhỏ nhất.
	\shortans{$2$}
	\loigiai{
...
\begin{ex}%[2H2C2-5]
	Trong không gian $Oxyz$, cho ba điểm $ A(-1;2;5)$, $B(3;-1;0)$, $C(-4;0;-2)$. Gọi $I$ là điểm trên mặt phẳng $(Oxy)$ sao cho biểu thức $\left|\overrightarrow{IA}-2\overrightarrow{IB}+3\overrightarrow{IC}\right|$ đạt giá trị nhỏ nhất. Tính khoảng cách từ $I$ đến mặt phẳng $(P)\colon 4x+3y+2=0$.
	\shortans{$6$}
	\loigiai{
...
\end{ex}
\begin{ex} %[2H2C2-5]
	Trong không gian $Oxyz$, cho bốn điểm $A(2;4;-1)$, $B(1;4;-1)$, $C(2;4;3)$ và $D(2;2;-1)$, biểu thức $MA^2+MB^2+MC^2+MD^2$ đạt giá trị nhỏ nhất khi $M(x;y;z)$. Giá trị $x+y+z$ bằng
	\shortans{$5{,}25$}
	\loigiai{
...
\begin{ex} %[2H2C2-5]
	Trong không gian $Oxyz$, cho điểm $A(a;b;c)$ với $a$, $b$, $c$ là các số thực dương thỏa mãn $5(a^2+b^2+c^2)=9(ab+2bc+ca)$ và $Q=\dfrac{a}{b^2+c^2}-\dfrac{1}{(a+b+c)^3}$ có giá trị lớn nhất. Gọi $M$, $N$, $P$ lần lượt là hình chiếu vuông góc của $A$ lên các tia $Ox$, $Oy$, $Oz$. Khi đó phương trình mặt phẳng $(MNP)$ là $mx+ny+pz-1=0$. Giá trị $m+np$ bằng
	\shortans{$147$}
	\loigiai{
...
\begin{itemize}
	...
	\begin{note}
		Để tìm vectơ pháp tuyến $\overrightarrow{n}_P$ của $(P)$ đơn giản hơn thì nên gọi $\overrightarrow{n}_P=(1;b;c)$.
	\end{note}
\end{itemize}
...
\begin{ex}%[2H5V1-5] 
	...
	\loigiai{
		...
		Khi đó mặt phẳng $(P)$ qua $O(0;0;0)$ có một vectơ pháp tuyến là $\overrightarrow{AK}=(0;-2;2)$.\\
...
\begin{ex}%[2H5V1-5]
	...
	\loigiai{
		...
		Suy ra $AM\perp (P)\Rightarrow \overrightarrow{AM}=(-3;-3;-3)$ là vectơ pháp tuyến của $(P)$.\\
		Mặt phẳng $(P)$ đi qua $A(1;7;2)$ và nhận $\overrightarrow{AM}=(-3;-3;-3)$ là vectơ pháp tuyến nên có phương trình $-3(x-1)-3(y-7)-3(z-2)=0\Leftrightarrow x+y+z-10=0$.	
	}
\end{ex}
%Câu 39
\begin{ex}%[2H5V1-5]
	Trong không gian $Oxyz$, cho điểm $A(2;-1;-2)$ và đường thẳng $d$ có phương trình $\dfrac{x-1}{1}=\dfrac{y-1}{-1}=\dfrac{z-1}{1}$. Gọi $(P)$ là mặt phẳng đi qua điểm $A$, song song với đường thẳng $d$ và khoảng cách từ $d$ tới mặt phẳng $(P)$ là lớn nhất. Khi đó mặt phẳng $(P)$ vuông góc với mặt phẳng nào sau đây?
	\choice
	{$x-y-6=0$}
	{$x+3y+2z+10$}
	{$x-2y-3z-1=0$}
	...
	\loigiai{
		...
		Và khi đó $(P)$ nhận $\overrightarrow{AH}=(-1;2;3)$ làm vectơ pháp tuyến.\\
...
%Câu 40
\begin{ex}%[2H5V1-5]
	Trong không gian với hệ toạ độ $Oxyz$, gọi $(P)$ là mặt phẳng đi qua hai điểm $A(1;-7;-8)$, $B(2;-5;-9)$ sao cho khoảng cách từ điểm $M(7;-1;-2)$ đến $(P)$ đạt giá trị lớn nhất. Biết $(P)$ có một vectơ pháp tuyến là $\overrightarrow{n}=(a;b;4)$, khi đó giá trị của tổng $a+b$ là
	\choice
	{$-1$}
	{\True $3$}
	{$6$}
	...
	\loigiai{
		...
		Đường thẳng $AB$ có vectơ chỉ phưng là $\vec{u}=(1;2;-1)$.\\
		...
		Mặt phẳng $(P)$ có một vectơ pháp tuyến là $\overrightarrow{n}=(2;1;4)$.\\
		Vậy ta có $a+b=3$.
	}
\end{ex}
%Câu 41
\begin{ex}%[2H5V1-5]
	...
	\loigiai{
		...
		Do đó $(\alpha)$ có vectơ pháp tuyến là $\overrightarrow{n}=(1;1;-1)$.\\
...
%Câu 42
\begin{ex}%[2H5V1-5]
	Trong không gian hệ tọa độ $Oxyz$, cho đường thẳng $d\colon \dfrac{x+1}{-2}=\dfrac{y}{1}=\dfrac{z-1}{1}$ và điểm $A(1;2;3)$. Gọi $(P)$ là mặt phẳng chứa $d$ và cách điểm $A$ một khoảng cách lớn nhất. Vectơ nào dưới đây là một vectơ pháp tuyến của $(P)$.
	\choice
	...
	\loigiai{
		...
		Suy ra $\overrightarrow{AH}=(-2t-2;t-2;t-2)$, vectơ chỉ phương của đường thẳng $d$ là $\overrightarrow{u}_d=(-2;1;1)$.\\
		...
		Vậy một vectơ pháp tuyến của $(P)$ là $\overrightarrow{n}=(1;1;1)$.
	}
\end{ex}
%Câu 43
\begin{ex}%[2H5V1-5]
...
%Câu 44
\begin{ex}%[2H5V1-5]
	Trong không gian $Oxyz$, cho điểm $A(2;5;3)$ và đường thẳng $d\colon \dfrac{x-1}{2}=\dfrac{y}{1}=\dfrac{z-2}{2}$. Biết rằng $(P)\colon ax+by+cz-3=0$ ($a$, $b$, $c\in \mathbb{Z}$) là mặt phẳng chứa $d$ và khoảng cách từ $A$ đến $(P)$ lớn nhất. Khi đó tổng $T=a+b+c$ bằng
	\choice
	{$3$}
	{$-3$}
	{\True $-2$}
	...
	\loigiai{
		\begin{center}
			...
			\end{tikzpicture}
		\end{center}
		Đường thẳng $d$ đi qua $M(1;0;2)$, có một vectơ chỉ phương $\overrightarrow{u}=(2;1;2)$.\\
		...
		Khi đó $(P)$ đi qua $M(1;0;2)$, có một vectơ pháp tuyến $\overrightarrow{AK}=(1;-4;1)$ nên $$(P)\colon x-4y+z-3=0.$$
		Vậy $T=a+b+c=1+(-4)+1=-2$.
	}
\end{ex}
%Câu 45
\begin{ex}%[2H5V1-5]
	...
	\loigiai{
		...
		PTTS của $d\colon \heva{&x=-1-2t\\&y=t\\&z=1+t} (t\in \mathbb{R})$, vectơ chỉ phương là $\overrightarrow{u}=(-2;1;1)$.\\
		...
		Do $\overrightarrow{n}=(1;1;1)$ cùng hướng với $\overrightarrow{MA}$ nên $\overrightarrow{n}=(1;1;1)$ là một vectơ pháp tuyến của $(P)$. 
	}
\end{ex}
%Câu 46
\begin{ex}%[2H5V1-5]
...
%%%==============EX_2============%%%
\begin{ex}%[2H5V2-5] 
	Trong không gian $Oxyz$, cho $A(2;3;-1)$, $B(2;3;2)$, $C(-1;0;2)$.Tìm tọa độ điểm $M$ thuộc mặt phẳng $(Oxz)$ để $S=\left|\overrightarrow{MA}-4\overrightarrow{MC}\right|+\left|\overrightarrow{MA}+\overrightarrow{MB}+\overrightarrow{MC}\right|$ nhỏ nhất.
	\choice
...
%%%==============EX_3============%%%
\begin{ex}%[2H5C1-3] 
	Trong không gian $Oxyz$ cho mặt phẳng $(P)$ đi qua điểm $M(9;1;1)$ cắt các tia $Ox$, $Oy$, $Oz$ lần lượt tại $A$, $B$, $C$ ($A$, $B$, $C$ không trùng với gốc tọa độ). Thể tích tứ diện $OABC$ đạt giá trị nhỏ nhất là bao nhiêu?
	\choice
	{\True $\dfrac{81}{2}$}
	{$\dfrac{243}{2}$}
	{$\dfrac{81}{6}$}
...
\Opensolutionfile{ans}[ans/ans-C5B3CD5-KQ]
\begin{ex}%[2H5V1-3]
	Trong không gian $Oxyz$, cho điểm $A(2;1;-1)$. Gọi $(P)\colon  ax+by+cz=0$ là mặt phẳng chứa trục $Oy$ sao cho khoảng cách từ $A$ đến $(P)$ là lớn nhất. Tính $a+b+c$.
	\shortans{$1$}
	\loigiai{
		\immini[thm]{
			...
			Độ dài đoạn thẳng $AH$ dài nhất khi $H$ và $A'$ trùng nhau. Khi đó mặt phẳng $(P)$ nhận $\overrightarrow{A'A}=(2;0;-1)$ làm vectơ pháp tuyến.\\
			Phương trình mặt phẳng $(P)$ đi qua $A'(0;1;0)$ có vectơ pháp tuyến $\overrightarrow{A'A}=(2;0;-1)$ là 
...
%%%==============EX_6============%%%
\begin{ex}%[2H5V1-3]
	Trong không gian $Oxyz$, cho điểm $A(2;1;1)$. Gọi $(P)\colon ax+by+c=0$ là mặt phẳng chứa trục $Oy$ sao cho khoảng cách từ $A$ đến $(P)$ lớn nhất. Tính $a+b+c$.
	\SA{3}
	\loigiai{
		\immini[thm]{
			...
			Phương trình $(P)$ đi qua $K(0;1;0)$ và có vectơ pháp tuyến $\overrightarrow{AK}=(-2;0;-1)$ là
			$$-2(x-0)+0(y-1)-1(z-0)=0 \Leftrightarrow 2x+z=0.$$
			Vậy $a+b+c=3$.	
		}{
			\begin{tikzpicture}[line join=round, line cap=round,>=stealth,thick,scale=0.5]
...
%%%==============EX_7============%%%
\begin{ex}%[2H5V1-5]
	Trong không gian $Oxyz$, cho điểm $A(1;2;2)$. Gọi $(P)$ là mặt phẳng chứa trục $Ox$ sao cho khoảng cách từ $A$ đến $(P)$ lớn nhất. Phương trình của mặt phẳng $(P)$ có dạng $y+az=0$. Tính $a$.
	\shortans[0]{$1$}
	\loigiai{
		...
		Phương trình mặt phẳng $(P)$ đi qua điểm $M(1;0;0)$ và có vectơ pháp tuyến là $\overrightarrow{MA}=(0;2;2)$ có dạng $0.(x-1)+2(y-0)+2(z-0)=0$ $\Leftrightarrow y+z=0$.
	}
\end{ex}
%%%==============EX_8============%%%
\begin{ex}%[2H5V2-7]
	Trong không gian $Oxyz$, cho điểm $A(2;-1;-2)$ và đường thẳng $(d)$ có phương trình $\dfrac{x-1}{1}=\dfrac{y-1}{-1}=\dfrac{z-1}{1}$. Gọi $(P)$ là mặt phẳng đi qua điểm $A$, song song với đường thẳng $(d)$ và khoảng cách từ $(d)$ tới mặt phẳng $(P)$ là lớn nhất. Khi đó mặt phẳng $(P)$ có dạng $x+ay+bz+c=0$. Tính $T=a+b+c+d$.
	\shortans[0]{$-15$}
	\loigiai{
...
%%%%==============EX_9============%%%
\begin{ex}%[2H5C1-5]
	Trong không gian $Oxyz$, cho điểm $A(2;5;3)$ và đường thẳng $d\colon \dfrac{x-1}{2}=\dfrac{y}{1}=\dfrac{z-2}{2}$. Gọi $(P)$ là mặt phẳng chứa $(d)$ sao cho khoảng cách từ $A$ đến $(P)$ là lớn nhất. Biết khoảng cách từ gốc tọa độ $O$ đến mặt phẳng $(P)$ bằng $\dfrac{m\sqrt{n}}{n}$ với $m,n\in\mathbb{Z}$. Tính $T=m+n$.
	\shortans[0]{$3$}
	\loigiai{
...
%%%%==============EX_10============%%%
\begin{ex}%[2H5V1-5]
	Trong không gian $Oxyz$, cho điểm $A(1; 1; 2)$ và mặt phẳng $(P)\colon (m-1)x+y+mz-1=0$, với $m$ là tham số. Biết khoảng cách từ điểm $A$ đến mặt phẳng $(P)$ lớn nhất. Tính $m$.
	\shortans[0]{$5$}
	\loigiai{
...
%%%%==============EX_11============%%%
\begin{ex}%[2H5V1-5]
	Trong không gian $Oxyz$, cho hai điểm $A(1;2;-1),B(3;0;3)$. Gọi $(P)$ là mặt phẳng đi qua điểm $A$ và cách $B$ một khoảng lớn nhất. Biết $\overrightarrow{n}=(1;a;b)$ là một vectơ pháp tuyến của $(P)$. Tính $T=a+b$.
	\shortans[0]{$1$}
	\loigiai{
		...
		Khi đó mặt phẳng $(P)$ đi qua $A$ và nhận $\overrightarrow{AB}=(2;-2; 4)$ làm vectơ pháp tuyến.
		Suy ra $\overrightarrow{n}=(1;-1;2)$ là một vectơ pháp tuyến của mặt phẳng $(P)$. \\
		Vậy $T=1$.
	}
\end{ex}
%%%%==============EX_12============%%%
\begin{ex}%[2H5V1-5]
	Trong không gian $Oxyz$, cho điểm $A(1;2;-3)$ và mặt phẳng $(P)\colon 2x+2y-z+9=0$. Đường thẳng $d$ qua và vuông góc với $(Q)\colon 3x+4y-4z+5=0$, cắt mặt phẳng $(P)$ tại $B$. Điểm $M$ nằm trong $(P)$ sao cho $M$ luôn nhìn $AB$ dưới góc vuông. Tính độ dài lớn nhất của $MB$ (làm tròn một chữ số).
	\shortans[0]{$2{,}2$}
	\loigiai{
...
%%%==============Cau_EX15==============%%%
\begin{ex}%[2H2V2-2]
	Trong không gian $Oxyz$, cho $A(-3;1;1)$, $B(5;1;1)$ và hai mặt phẳng $(P)\colon x+2y+z-4=0$, $(Q)\colon -x+y+z-1=0$. Gọi $M(a;b;c)$ là điểm nằm trên hai mặt phẳng $(P)$ và $(Q)$ sao cho $MA+MB$ đạt giá trị nhỏ nhất. Tính $T=a^2+b^2+c^2$.
	\shortans{$3$}
	\loigiai{
		Từ giả thiết ta có $M$ thuộc giao tuyến $d$ của hai mặt phẳng $(P)$ và $(Q)$.
		\begin{itemize}
			\item Mặt phẳng $(P)$ có một vectơ pháp tuyến là $\overrightarrow{n}_P=(1;2;1)$.
			\item Mặt phẳng $(Q)$ có một vectơ pháp tuyến là $\overrightarrow{n}_Q=(-1;1;1)$.
		\end{itemize}
		Khi đó đường thẳng $d$ đi qua $N(1;1;1)$ và có một vectơ chỉ phương là $\overrightarrow{u}_d=\left[\overrightarrow{n}_P, \overrightarrow{n}_Q\right]=(1;-2;3)$ nên có PTTS là $d\colon \heva{&x=1+t \\
			&y=1-2t \\
		...
		Dấu \lq\lq =\rq\rq\, xảy ra khi và chỉ khi hai vectơ $\overrightarrow{u}$ và $\overrightarrow{v}$ cùng hướng hay $\dfrac{t+\dfrac{2}{7}}{\dfrac{2}{7}-t}=\dfrac{\dfrac{2}{\sqrt{7}}}{\dfrac{2}{\sqrt{7}}} > 0\Rightarrow t=0$.\\
		Do đó $M(1;1;1)$.\\
		Vậy $T=a^2+b^2+c^2=3$.
	}
\end{ex}
...
%%%==============Cau_EX16==============%%%
\begin{ex}%[2H2V2-2]
	Trong không gian $Oxyz$ cho mặt phẳng $(P)\colon y-1=0$, đường thẳng $d\colon \left\{\begin{array}{l}x=1\\ y=2-t \\ z=1\end{array}\right.$ và hai điểm $A(-1;-3; 11), B\left(\dfrac{1}{2}; 0; 8\right)$. Hai điểm $M, N$ thuộc mặt phẳng $(P)$ sao cho $d(M, d)=2$ và $NA=2NB$. Tìm giá trị nhỏ nhất của đoạn $MN$.
	\shortans{$1$}
	\loigiai{
...
%%%==============Cau_EX17==============%%%
\begin{ex}%[2H2V2-2]
	Trong không gian $Oxyz$, cho bốn điểm $A(2;0;1)$, $B(3;1;5)$, $C(1; 2; 0)$, $D(4; 2; 1)$. Gọi $(\alpha)$ là mặt phẳng đi qua $D$ sao cho ba điểm $A$, $B$, $C$ nằm cùng phía đối với $(\alpha)$ và tổng khoảng cách từ các điểm $A$, $B$, $C$ đến mặt phẳng $(\alpha)$ là lớn nhất. Giả sử phương trình $(\alpha)$ có dạng $2x+m y+n z-p=0$. Khi đó, tính giá trị của $T=m+n+p$.
	\shortans{$9$}
	\loigiai{
...
%%%==============HetCau_EX17==============%%%
\begin{ex}%Câu 1
	Trong không gian $Oxyz$ gọi $(P)\colon ax+by+cz-3=0$ ($a$,$b$,$c$ là các số nguyên không đồng thời bằng $0$) là phương trình mặt phẳng đi qua hai điểm $M(0;-1;2)$, $N(-1;1;3)$ và không đi qua $H(0;0;2)$. Biết rằng khoảng cách từ $H(0;0;2)$ đến mặt phẳng $(P)$ đạt giá trị lớn nhất. Tính giá trị của $P=a-2b+3c+12$. 
	\shortans{$16$}
	\loigiai{
...
\begin{ex}%Câu 2
	Trong không gian $Oxyz$ Mặt phẳng $(P)$ đi qua điểm $M(1;1;1)$ cắt các tia $Ox$, $Oy$, $Oz$ lần lượt tại $A(a;0;0)$, $B(0;b;0)$, $C(0;0;c)$ sao cho thể tích khối tứ diện $O.ABC$ nhỏ nhất. Tính $T=a+2b+3c$.
	\shortans{$18$}
	\loigiai{
...
\begin{ex}%Câu 3
	Trong không gian $Oxyz$, cho điểm $M(1;4;9)$. Gọi $(P)$ là mặt phẳng đi qua $M$ và cắt 3 tia $Ox$, $Oy$, $Oz$ lần lượt tại các điểm $A$, $B$, $C$ (khác $O$) sao cho $OA+OB+OC$ đạt giá trị nhỏ nhất. Tính khoảng cách $d$ từ gốc tọa độ $O$ đến mặt phẳng $(P)$ (làm tròn đến hàng phần trăm).
	\shortans{$5{,}14$}
	\loigiai{
		Giả sử $A(a;0;0)$, $B(0;b;0)$, $C(0;0;c)$ với $a,b,c > 0$.\\
...
\begin{ex}%Câu 4
	Trong không gian $Oxyz$, mặt phẳng $(P)$ đi qua điểm $M(1;2;1)$ cắt các tia $Ox$, $Oy$, $Oz$ lần lượt tại các điểm $A$, $B$, $C$ ($A$, $B$, $C$ không trùng với gốc $O$) sao cho tứ diện $O.ABC$ có thể tích nhỏ nhất. Viết phương trình mặt phẳng $(P)\colon\dfrac{x}{a}+\dfrac{y}{b}+\dfrac{z}{c}=1$. Tính $T=a+b+c$.
	\shortans{$12$}
	\loigiai{
...
\begin{ex}%Câu 5
	Trong không gian $Oxyz$, cho ba điểm $A(a;0;0)$, $B(0;b;0)$, $C(0;0;c)$, trong đó $a$, $b$, $c$ là các số thực thỏa mãn $\dfrac{2}{a}-\dfrac{2}{b}+\dfrac{1}{c}=1$. Tính khoảng cách từ gốc tọa độ $O$ đến mặt phẳng $(ABC)$.
	\shortans{$3$}
	\loigiai{
...
\begin{ex}%Câu 7
	Trong không gian $Oxyz$, cho ba điểm $A(a,0,0), B(0,b,0), C(0,0,c)$ với $a, b, c$ là những số dương thay đổi thỏa mãn $a^2+4b^2+16c^2=49$. Tính tổng $S=a^2+b^2+c^2$ khi khoảng cách từ $O$ đến mặt phẳng $(ABC)$ đạt giá trị lớn nhất.
	\shortans{$12{,}3$}
	\loigiai{
...
\begin{ex}%Câu 8
	Trong không gian $Oxyz$, cho mặt phẳng $(P)\colon x+y-z+2=0$ và hai điểm $A(3;4;1)$; $B(7;-4;-3)$. Điểm $M(a;b;c)(a > 2)$ thuộc $(P)$ sao cho tam giác $ABM$ vuông tại $M$ và có diện tích nhỏ nhất. Tính giá trị biểu thức $T=a+b+c$.
	\shortans{$0$}
	\loigiai{
...
\begin{ex}%[2H5C2-3]
	Trong không gian $Oxyz$, cho điểm $A(1;4;3)$ và mặt phẳng $(P) \colon 2y-z=0$. Biết điểm $B$ thuộc $(P)$, điểm $C$ thuộc $(Oxy)$ sao cho chu vi tam giác $ABC$ nhỏ nhất. Tính giá trị nhỏ nhất đó (làm tròn đến hàng phần trăm).
	\shortans{$8{,}94$}
	\loigiai{
...
\begin{dang}{GIÁ TRỊ LỚN NHẤT, GIÁ TRỊ NHỎ NHẤT LIÊN QUAN ĐẾN GÓC}
	...
	Trong không gian $Oxyz$, cho đường thẳng $d$ và mặt phẳng $(P)$ cắt nhau. Lập phương trình của mặt phẳng $(Q)$ chứa $d$ và tạo với mặt phẳng $(P)$ một góc nhỏ nhất.\\
	...
	Trong không gian $Oxyz$, cho hai đường thẳng $d$ và $d'$ chéo nhau. Viết phương trình mặt phẳng $(P)$ chứa $d$ và tạo với $d'$ một góc lớn nhất.\\
	\textbf{Phương pháp giải}
	\begin{itemize}
		\item \textbf{Cách 1: Phương pháp hình học}\\
		\begin{center}
...
\TN
\begin{ex}%[2H5C1-5]
	Trong không gian $Oxyz$, cho đường thẳng $d \colon \dfrac{x}{1}=\dfrac{y+1}{-2}=\dfrac{2-z}{1}$. Gọi $(P)$ là mặt phẳng chứa đường thẳng $d$ và tạo với mặt phẳng $(Q) \colon 2x-y-2z-2=0$ một góc có số đo nhỏ nhất. Điểm $A(1;2;3)$ cách mặt phẳng $(P)$ một khoảng bằng
	\choice
	{\True $\sqrt{3}$}
	{$\dfrac{5\sqrt{3}}{3}$}
	{$\dfrac{7\sqrt{11}}{11}$}
