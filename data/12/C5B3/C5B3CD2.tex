\begin{dang}{ỨNG DỤNG MẶT CẦU TRONG KHÔNG GIAN}
...
% \begin{bt}%[2H5V3-3]
% 	Trong không gian $Oxyz$, cho hình chóp $S.ABCD$, đáy $ABCD$ là hình chữ nhật. Biết $A(0;0;0)$, $D(2;0;0)$, $B(0;4;0)$, $S(0; 0;4)$. Viết phương trình mặt cầu ngoại tiếp hình chóp $S.ABCD$.
% 	\loigiai{
% 		\begin{center}
...
% \begin{bt}%[2H5V3-3]
% 	\immini[thm]{Cho tứ diện $SABC$, có $SA$, $SB$, $SC$ đôi một vuông góc và $SA=5$, $SB=2$, $SC=4$. Chọn hệ tọa độ $Oxyz$ như hình vẽ, viết phương trình mặt cầu ngoại tiếp hình chóp $SABC$.
% 	}{
% 		\begin{tikzpicture}[line join=round,line cap=round,>=stealth,scale=0.7,font=\footnotesize]
% 		\tikzset{every node/.style={scale=0.8}}
% 		\coordinate (O) at (0,0);
...
% \vspace{-1.0cm}
% \begin{bt}%[2H5V3-3]
% 	\immini[thm]{Cho hình lập phương $ABCD.A'B'C'D'$ có độ dài cạnh bằng $1$. Chọn hệ tọa độ $Oxyz$ như hình vẽ, viết phương trình mặt cầu ngoại tiếp hình lập phương $ABCD.A'B'C'D'$.
% 	}{
% 	\begin{tikzpicture}[line join=round,line cap=round,>=stealth,scale=0.7,font=\footnotesize]
% 		\tikzset{every node/.style={scale=0.8}}
% 		\def \dai{3}
...
% \begin{bt}%[2H5V3-3]
% 	\immini[thm]{Cho hình lập phương $ABCD.A'B'C'D'$ có độ dài cạnh bằng $2a$. Chọn hệ tọa độ $Oxyz$ như hình vẽ.
% 	\begin{enumerate}
