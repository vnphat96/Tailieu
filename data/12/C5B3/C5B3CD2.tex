...
\begin{bt}%[2H5V3-3]
	Trong không gian với hệ tọa độ $Oxyz$, cho hình chóp $S.ABCD$, đáy $ABCD$ là hình chữ nhật. Biết $A(0;0;0)$, $D(2;0;0)$, $B(0;4;0)$, $S(0; 0;4)$. Viết phương trình mặt cầu ngoại tiếp hình chóp $S.ABCD$.
	\loigiai{
		\begin{center}
