...
%Câu 63
\begin{ex}%[2H5N3-2]
	Trong không gian với hệ tọa độ $Oxyz$, cho mặt cầu có tâm $I(1;-4;3)$ và đi qua điểm $A(5;-3;2)$. Tính bán kính của mặt cầu đã cho (làm tròn kết quả đến hàng phần nghìn).
	\shortans{$ 4{,}24 $}
...
%Câu 65
\begin{ex}%[2H5H3-2]
	Trong không gian với hệ tọa độ $Oxyz$, cho $A(-1; 0; 0)$, $B(0; 0; 2)$, $C(0;-3; 0)$. Tính bán kính mặt cầu ngoại tiếp tứ diện $OABC$ (làm tròn đến hàng phần nghìn).
	\shortans{$ 1{,}87 $}
