...
\begin{ex}%[2H5V3-2]
	...
	\choice 
		...
		{$m \in \mathbb{R}$}
	\loigiai{
		Từ phương trình đường thẳng $\Delta$ và mặt cầu $(S)$, ta có
		\begin{align*}
...
\begin{ex}%[2H5V3-2]
	Trong không gian với hệ tọa độ $Oxyz$, cho đường thẳng $d\colon \dfrac{x-1}{2}=\dfrac{y}{-1}=\dfrac{z+2}{1}$. Gọi $(S)$ là mặt cầu có bán kính $R=5$, có tâm $I$ thuộc đường thẳng $d$ và tiếp xúc với trục $Oy$. Biết rằng $I$ có tung độ dương. Điểm nào sau đây thuộc mặt cầu $(S)$?
	\choice 
		{$M(-1;-2;1)$}
		{\True $N(1;2;-1)$}
		{$P(-5;2;-7)$}
...
\begin{ex}%[2H5V3-3]
	Trong không gian với hệ tọa độ $Oxyz$, cho  mặt phẳng $(P)\colon 2x-2y-z-4=0$ và điểm $I(1;2;3)$. Mặt cầu tâm $I$ tiếp xúc với $(P)$ tại điểm $H(a;b;c)$. Tính $a+b+c$.
	\shortans{$5$}
 	\loigiai{
		Tọa độ điểm $H$ là hình chiếu của điểm $I$ trên mặt phẳng $(P)$.\\ Phương trình đường thẳng $d$ qua $I$ và vuông góc với mặt phẳng $(P)$ là $\heva{&x=1+2 t \\ &y=2-2 t \\ &z=3-t.}$\\
...
\begin{ex}%[2H5V3-3]
	Trong không gian với hệ tọa độ $Oxyz$ cho mặt phẳng $(P)\colon z+2=0$, điểm $K(0;0;-2)$ và đường thẳng $d\colon \dfrac{x}{1}=\dfrac{y}{1}=\dfrac{z}{1}$. Phương trình mặt cầu tâm thuộc đường thẳng $d$ và cắt mặt phẳng $(P)$ theo thiết diện là
...
\begin{ex}%[2H5V3-2] 
	...
	\loigiai{
		...
		\begin{itemize}
			...
			\item Đường thẳng qua $I(3 ;-2 ; 1)$ vuông góc với $(P)$ có phương trình tham số là $\heva{&x=3+2 t \\& y=-2-2 t \\& z=1-t.}$\\
...
\begin{ex}%[2H5V3-4]
	Trong không gian với hệ tọa độ $Oxyz$, cho mặt phẳng $(P)\colon x-2y+2z-3=0$ và mặt cầu $(S)$ tâm $I(5;-3; 5)$, bán kính $R=2\sqrt{5}$. Từ một điểm $A$ thuộc mặt phẳng $(P)$ kẻ một đường thẳng tiếp xúc với mặt cầu $(S)$ tại $B$. Tính $OA$ biết $AB=4$.
	\choice
	{\True $OA=\sqrt{11}$}
	{$OA=5$}
	{$OA=3$}
...
\begin{ex}%[2H5V1-7] 
	Trong không gian với hệ tọa độ $Oxyz$ cho hai điểm $A(0 ; 0 ; 3)$, $B(-2 ; 0 ; 1)$ và mặt phẳng $(\alpha)\colon 2 x-y+2 z+8=0$. Hỏi có bao nhiêu điểm $C$ trên mặt phẳng $(\alpha)$ sao cho tam giác $ABC$ đều?
	\choice
	{$2$}
	{$1$}
	{\True $0$}
	...
	\loigiai{
		...
		và điểm $M(1 ; 10 ; 0) \in d$ nên phương trình tham số của $d$ là $\heva{&x=1+t \\& y=10 \\& z=-t.}$\\
...
\begin{ex}%[2H5V3-2]
	Trong không gian với hệ tọa độ $Oxyz$, cho phương trình mặt cầu $\left(S_m\right)\colon x^2+y^2+z^2+(m+2) x+2m y-2m z-m-3=0$. Biết rằng với mọi số thực $m$ thì $\left(S_m\right)$ luôn chứa một đường tròn cố định. Tính bán kính $r$ của đường tròn đó (làm tròn đến hàng phần trăm).
	\shortans[]{$1{,}89$}
	\loigiai{
