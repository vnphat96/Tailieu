...
\begin{ex}
	...
	\loigiai{$\underset{x\to -\infty }{\mathop{\lim \limits{n \to +\infty}}}\,\dfrac{2x-4}{x+2}=2$ và $\underset{x\to +\infty }{\mathop{\lim \limits{n \to +\infty}}}\,\dfrac{2x-4}{x+2}=2$ nên hàm số có tiệm cận ngang là $y=2$.
	}
\end{ex}
...
\begin{ex}
	...
	{$\lim \limits{n \to +\infty}_{x \rightarrow-\infty} f(x)=2$ ; $\lim \limits{n \to +\infty}_{x \rightarrow 1^{-}} f(x)=-\infty$}
...
\end{tikzpicture}}
	...
	\begin{enumerate}[a)]
		...
		\item Theo hình vẽ thì $\lim \limits{n \to +\infty}_{x \rightarrow-\infty} f(x)=2$ ; $\lim \limits{n \to +\infty}_{x \rightarrow 1^{-}} f(x)=-\infty$.
