...
\begin{ex}
	Cho đồ thị của hàm số $y=f(x)=\dfrac{2 x^2}{x^2-1}$. Xét tính đúng sai của các khẳng định sau:
	\begin{center}
		\begin{tikzpicture}[scale=.5,>=stealth, font=\footnotesize, line join=round, line cap=round]
...
\end{ex}
\begin{ex}%[2D1V4-4]%[Tran Ngoc Thanh]%[Du an C]
Để loại bỏ $p\%$ một loài tảo độc khỏi một hồ nước, người ta ước tính chi phí bỏ ra là
\[
C(p)=\dfrac{45p}{100-p} \text { (triệu đồng), với } 0 \leq p<100.
\]
\choiceTF[t]
{Để loại bỏ $10\%$ tảo độc khỏi hồ nước thì chi phí bỏ ra là $10$ triệu đồng}
{Tiệm cận đứng của đồ thị hàm số là $x=45$}
{\True Với chi phí là $11{,}25$ triệu đồng thì loại bỏ được $20\%$ tảo độc ra khỏi hồ nước}
{Có thể loại bỏ hoàn toàn tảo độc khỏi hồ nước}
\loigiai{
\begin{itemchoice}
\itemch Sai.\\
Ta có $C(10)=\dfrac{45\cdot 10}{100-10}=5$.\\
Vậy chi phí để loại bỏ $10\%$ tảo độc khỏi hồ nước là $5$ triệu đồng.
\itemch Sai.\\
Ta có $\displaystyle\lim_{p\to 100^-}C(p)=\displaystyle\lim_{p\to 100^-}\dfrac{45p}{100-p}=+\infty$. \\
Suy ra đồ thị hàm số có tiệm cận đứng là đường thẳng $p=100$.
\itemch Đúng.\\
Ta có $11{,}25=\dfrac{45p}{100-p} \Rightarrow p=20$.\\
...
\begin{ex}
	...
	\end{tikzpicture}}
\end{ex}
\begin{ex}%[2D1V4-3]%[THPT Văn Giang Hưng Yên-L3-2425-ChuHa]
Cho hàm số $y=\dfrac{x^2+2x-1}{x-1}$ và đồ thị của nó là $(C)$.
\choiceTF
{\True Hàm số có $2$ điểm cực trị}
{\True Đồ thị $(C)$ có tiệm cận đứng là đường thẳng $x=1$}
{Hàm số nghịch biến trên khoảng $(0;2)$}
{\True $M$ là điểm bất kì thuộc đồ thị $(C)$. Tích khoảng cách từ $M$ đến tiệm cận đứng và tiệm cận xiên của đồ thị $(C)$ luôn bằng $\sqrt{2}$}
\loigiai{
\begin{itemchoice}
\itemch
Ta có $y'=\dfrac{(2x+2)(x-1)-(x^2+2x-1)}{(x-1)^2}
=\dfrac{x^2-2x-1}{(x-1)^2}$.\\
Ta có $y'=0\Leftrightarrow x^2-2x-1=0\Leftrightarrow x=1\pm\sqrt{2}$.\\
Vậy hàm số có $2$ điểm cực trị.
\itemch
Xét giới hạn $\lim\limits_{x\to 1^+}\dfrac{x^2+2x-1}{x-1}=+\infty$.\\
...
\tkzTabLine{,+,0,-,d,-,0,+,}
\tkzTabVar{-/$-\infty$, +/$f(1-\sqrt{2})$, -D+/$-\infty$ /$+\infty$,-/$f(1+\sqrt{2})$, +/$+\infty$}
\end{tikzpicture}
\end{center}
Từ bảng biến thiên suy ra hàm số nghịch biến trên $\left(1-\sqrt{2};1\right)$ và $\left(1;1+\sqrt{2}\right)$.\\
Do hàm số gián đoạn tại $x=1$ nên không nghịch biến trên khoảng $(0;2)$.
\itemch
Ta có $y=x+3+\dfrac{2}{x-1}$.\\
Tiệm cận xiên của đồ thị là $(d_1)\colon x-y+3=0$, tiệm cận đứng là $(d_2)\colon x-1=0$.\\
Gọi $M\left(a;a+3+\dfrac{2}{a-1}\right) \in (C)$ (với $a\ne 1$).\\
Khoảng cách từ $M$ đến tiệm cận đứng là $\mathrm{d}(M,d_2)=|a-1|$.\\
Khoảng cách từ $M$ đến tiệm cận xiên là
\[\mathrm{d}(M,d_1)=\dfrac{\left|a-\left(a+3+\dfrac{2}{a-1}\right)+3\right|}{\sqrt{1^2+(-1)^2}}=\dfrac{\left|-\dfrac{2}{a-1}\right|}{\sqrt{2}}=\dfrac{2}{\sqrt{2}|a-1|}=\dfrac{\sqrt{2}}{|a-1|}.\]
Tích các khoảng cách là $T = \mathrm{d}(M,d_1) \cdot \mathrm{d}(M,d_2) = \dfrac{\sqrt{2}}{|a-1|} \cdot |a-1| = \sqrt{2}$.
\end{itemchoice}
}
\end{ex}
...
Ta có \[a=\lim\limits_{x\to-\infty}\dfrac{g(x)}{x}=\lim\limits_{x\to-\infty}\dfrac{\dfrac{x^3}{3}-3x-6\ln (2-x)+1}{x^3+2x^2+2x}=\dfrac{1}{3}.\]
và  \[b=\lim\limits_{x\to-\infty}\left(g(x)-\dfrac{1}{3}x \right)=\lim\limits_{x\to-\infty}\left(\dfrac{\dfrac{x^3}{3}-3x-6\ln (2-x)+1}{x^2+2x+2}-\frac{1}{3}x \right)=-\dfrac{2}{3}.	\]
