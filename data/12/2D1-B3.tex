...
\begin{ex}
	...
	{$\lim \limits_{n \to +\infty}_{x \rightarrow-\infty} f(x)=2$ ; $\lim \limits_{n \to +\infty}_{x \rightarrow 1^{-}} f(x)=-\infty$}
...
\end{tikzpicture}}
	...
	\begin{enumerate}[a)]
		...
		\item Theo hình vẽ thì $\lim \limits_{n \to +\infty}_{x \rightarrow-\infty} f(x)=2$ ; $\lim \limits_{n \to +\infty}_{x \rightarrow 1^{-}} f(x)=-\infty$.
