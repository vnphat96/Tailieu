<<<<<<< HEAD
\newpage\def\tenchude{ỨNG DỤNG CỦA TÍCH PHÂN}
\setcounter{dang}{0}
\section{ỨNG DỤNG HÌNH HỌC CỦA TÍCH PHÂN}
\subsection{Diện tích hình thang cong}
\subsubsection{Hình phẳng giới hạn bởi đồ thị hàm số, trục hoành và hai đường thẳng \indamct{$x=a$ và $x=b$}}
\immini[thm]{
...
\end{tikzpicture}}
\textbf{Chú ý:} Giả sử hàm số $y=f(x)$ liên tục trên $[a;b]$. Nếu $f(x)$ \textbf{không đổi dấu} trên $[a;b]$ thì

	$$\displaystyle\int\limits_a^b \left|f(x)\right|\mathrm{\,d}x=\displaystyle\left|\int\limits_a^b f(x)\mathrm{\,d}x\right|.$$

\subsubsection{Hình phẳng giới hạn bởi hai đồ thị hàm số và hai đường thẳng \indamct{$x=a$ và $x=b$}}
\immini[thm]{Cho 2 hàm số $y=f(x)$ và $y=g(x)$ liên tục trên $[a;b]$. Khi đó diện tích của hình phẳng giới hạn bởi đồ thị hai hàm số $y=f(x)$ và $y=g(x)$ và hai đường thẳng $x=a$ và $x=b$ được tính bởi công thức
$$
...
\immini[thm]{Trong không gian, cho một vật thể nằm trong khoảng không gian giữa hai mặt phẳng $(P)$ và $(Q)$ cùng vuông góc với trục $Ox$ tại các điểm $a$ và $b$. Mặt phẳng vuông góc với trục $Ox$ tại điểm $x(a\leq x \leq b)$ cắt vật thể theo mặt cắt có diện tích $S(x)$. Khi đó, nếu $S(x)$ là hàm số liên tục trên $[a;b]$ thì thể tích của vật thể được tính bởi công thức
	$$V=\displaystyle\int\limits_a^b S(x)\mathrm{\,d}x$$}{\begin{tikzpicture}[scale=.8,font=\footnotesize,line join=round,line cap=round,>=stealth]
...
\immini[thm]{Cho hàm số $y=f(x)$ liên tục, không âm trên $[a;b]$. Hình phẳng $(H)$ giới hạn bởi đồ thị hàm số $y=f(x)$, trục hoành $O x$ và hai đường thẳng $x=a$ và $x=b$ quay quanh trục $O x$ tạo thành một khối tròn xoay có thể tích bằng
...
\end{tikzpicture}}
\begin{dang}{Tính diện tích hình phẳng giới hạn bởi đồ thị các hàm số}
\end{dang}
...
%%%%%-------------Câu 21
\begin{ex}%[2D4N3-1]
	\immini[thm]{Cho hàm số  $y=f(x)$ liên tục trên $\mathbb{R}$. Gọi $S$  là diện tích hình phẳng giới hạn bởi các đường $y=f(x)$, $y=0$, $x= -1$, $x = 5$ (như hình vẽ bên dưới).
	Mệnh đề nào sau đây đúng?
	\choice
	{$S=-\int\limits_{-1}^{1} f(x) \mathrm{\,d}x - \int\limits_{1}^{5} f(x) \mathrm{\,d}x$}
	{$S=\int\limits_{-1}^{1} f(x) \mathrm{\,d}x + \int\limits_{1}^{5} f(x) \mathrm{\,d}x$}
	{\True  $S=\int\limits_{-1}^{1} f(x) \mathrm{\,d}x - \int\limits_{1}^{5} f(x) \mathrm{\,d}x$}
	{$S=-\int\limits_{-1}^{1} f(x) \mathrm{\,d}x + \int\limits_{1}^{5} f(x) \mathrm{\,d}x$}
	...
	\loigiai{
		...
		Suy ra $S= \int\limits_{1}^{5} \left|f(x)\right| \mathrm{\,d}x = 
		\int\limits_{-1}^{1} \left|f(x)\right| \mathrm{\,d}x +\int\limits_{1}^{5} \left|f(x)\right| \mathrm{\,d}x = \int\limits_{-1}^{1} f(x) \mathrm{\,d}x - \int\limits_{1}^{5} f(x) \mathrm{\,d}x$.
...
%%%%%-------------Câu 26
\begin{ex}%[2D4N3-1]
	\immini[thm]{Diện tích phần hình phẳng được gạch sọc trong hình vẽ sau được tính theo công thức nào dưới đây?
	\choice
...
\begin{ex}%[2D4H3-1]
	...
	\begin{center}
		\begin{tikzpicture}[font=\footnotesize, line join=round, line cap=round, >=stealth, scale = 0.8]
			...
			\draw[fill] (1,0) node[below left]{$1$} circle (1pt) (2,0) node[below left]{$2$} circle (1pt) (3,0) node[below left]{$3$} circle (1pt) (4,0) node[below left]{$4$} circle (1pt) (5,0) node[below left]{$5$} circle (1pt);
			\draw[fill] (0,2) node[left]{$2$} circle (1pt) (0,-2) node[left] {$-2$} circle (1pt);
			\draw[line width = 1pt] (0,0)--(1,2)--(2,2);
...
\begin{ex}%[2D4N3-1]
	\immini[thm]{Tính diện tích hình phẳng được tô màu trong hình bên dưới.
	\shortans{$ 3 $}
...
%Câu 37
\begin{ex}%[2D4H3-1]
	\immini[thm]{Biết diện tích phần hình phẳng gạch chéo trong hình vẽ bên có diện tích là $ \dfrac{a}{b} $ với $ a$, $b \in \mathbb{Z} $ và phân số $ \dfrac{a}{b} $ tối giản. Tính tổng $ a+b $.
	\shortans{$ 11 $}
	}{\begin{tikzpicture}[font=\footnotesize, line join=round, line cap=round, >=stealth, scale = 1]
...
%Câu 38
\begin{ex}%[2D4H3-1]
	\immini[thm]{Biết diện tích phần tam giác cong $ OAB $ trong hình vẽ bên có diện tích là $ \dfrac{a}{b} $ với $ a$, $b \in \mathbb{Z} $ và phân số $ \dfrac{a}{b} $ tối giản. Tính hiệu $ b-a $.
	\shortans{$ 5 $}
			...
			\fill[pattern=north west lines] (0,0)-- plot[domain=0:1](\x,{(\x)^3}) --(1,1)-- plot[domain=1:2](\x, {((\x)-2)^2}) --(2,0) --cycle;
...
%Câu 39
\begin{ex}%[2D4H3-1]
	\immini[thm]{Hình vuông $OABC$ có cạnh bằng $4$ được chia thành hai phần bởi đường cong $(C)$ có phương trình $y=\dfrac{1}{4} x^{2}$. Gọi $S_2$, $S_2$ lần lượt là diện tích của phần không tô màu và phần tô màu như hình vẽ bên dưới. Tỉ số $\dfrac{S_1}{S_2}$ bằng bao nhiêu?
	\shortans{$ 2 $}
	}{\begin{tikzpicture}[font=\footnotesize, line join=round, line cap=round, >=stealth, scale = 0.8]
...
%câu 40
\begin{ex}%[2D4V3-1]
	\immini[thm]{Cho hình thang cong $(H)$ giới hạn bởi các đường $y=\mathrm{e}^{x}$, $y=0$, $x=0$, $x=\ln 4$. Đường thẳng $x=k$, $(0<k<\ln 4)$ chia $(H)$ thành hai phần có diện tích là $S_1$ và $S_2$ như hình vẽ bên. Tìm $k$ để $S_1=2 S_2$ (làm tròn kết quả đến hàng phần chục).
	\shortans{$1,1$}
	}{\begin{tikzpicture}[font=\footnotesize, line join=round, line cap=round, >=stealth, scale =1]
...
\subsubsection{Hình phẳng giới hạn bởi hai đồ thị hàm số và hai đường thẳng \indamct{$x=a$ và $x=b$}}
\immini{Cho 2 hàm số $y=f(x)$ và $y=g(x)$ liên tục trên $[a;b]$. Khi đó diện tích của hình phẳng giới hạn bởi đồ thị hai hàm số $y=f(x)$ và $y=g(x)$ và hai đường thẳng $x=a$ và $x=b$ được tính bởi công thức
$$
S=\displaystyle\int\limits_a^b|f(x)-g(x)|\mathrm{\,d}x
$$}{\begin{tikzpicture}[scale=.8,font=\footnotesize,line join=round,line cap=round,>=stealth]
	% Draw axes
...
\subsection{Thể tích hình khối}
\subsubsection{Thể tích của vật thể}
\immini{Trong không gian, cho một vật thể nằm trong khoảng không gian giữa hai mặt phẳng $(P)$ và $(Q)$ cùng vuông góc với trục $Ox$ tại các điểm $a$ và $b$. Mặt phẳng vuông góc với trục $Ox$ tại điểm $x(a\leq x \leq b)$ cắt vật thể theo mặt cắt có diện tích $S(x)$. Khi đó, nếu $S(x)$ là hàm số liên tục trên $[a;b]$ thì thể tích của vật thể được tính bởi công thức
	$$V=\displaystyle\int\limits_a^b S(x)\mathrm{\,d}x$$}{\begin{tikzpicture}[scale=.8,font=\footnotesize,line join=round,line cap=round,>=stealth]
	\draw plot[smooth,tension=.65] coordinates{(1,2) (2.5,2.3) (3.5,2.2)};
	\draw[dashed] plot[smooth,tension=.65] coordinates{(3.5,2.2) (4,2)};
	\draw plot[smooth,tension=.65] coordinates{(4,2) (5,2.2) (5.5,2.1)};
...
\subsubsection{Thể tích khối tròn xoay}
\immini{Cho hàm số $y=f(x)$ liên tục, không âm trên $[a;b]$. Hình phẳng $(H)$ giới hạn bởi đồ thị hàm số $y=f(x)$, trục hoành $O x$ và hai đường thẳng $x=a$ và $x=b$ quay quanh trục $O x$ tạo thành một khối tròn xoay có thể tích bằng
	$$V=\displaystyle\pi\int\limits_a^b \left[f(x)\right]^2\mathrm{\,d}x$$}
{\begin{tikzpicture}[scale=.8,font=\footnotesize,line join=round,line cap=round,>=stealth]
	 \draw[->] (-1,0) -- (6,0) node[right] {$x$};
	\draw[->] (0,-2) -- (0,2) node[above] {$y$};
...
%%%%%-------------Câu 21
\begin{ex}%[2D4N3-1]
	\immini{Cho hàm số  $y=f(x)$ liên tục trên $\mathbb{R}$. Gọi $S$  là diện tích hình phẳng giới hạn bởi các đường $y=f(x)$, $y=0$, $x= -1$, $x = 5$ (như hình vẽ bên dưới).
	Mệnh đề nào sau đây đúng?
	\choice
	{$S=-\int\limits_{-1}^{1} f(x) \mathrm{\,d}x - \int\limits_{1}^{5} f(x) \mathrm{\,d}x$}
	{$S=\int\limits_{-1}^{1} f(x) \mathrm{\,d}x + \int\limits_{1}^{5} f(x) \mathrm{\,d}x$}
...
%%%%%-------------Câu 26
\begin{ex}%[2D4N3-1]
	\immini{Diện tích phần hình phẳng được gạch sọc trong hình vẽ sau được tính theo công thức nào dưới đây?
	\choice
	{$\displaystyle\int\limits_{-1}^{1} \left( x^2 -2 + \sqrt{|x|}\right)\mathrm{\,d}x$}
	{$\displaystyle\int\limits_{-1}^{1} \left( x^2 -2 - \sqrt{|x|}\right)\mathrm{\,d}x$}
	{$\displaystyle\int\limits_{-1}^{1} \left( -x^2 + 2 + \sqrt{|x|}\right)\mathrm{\,d}x$}
