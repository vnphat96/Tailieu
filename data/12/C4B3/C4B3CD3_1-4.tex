...
%Câu 5
\begin{ex}%[2D4C3-2]
		\immini[thm]{Một hoa văn trang trí được tạo ra từ một miếng bìa mỏng hình vuông cạnh bằng $10$\,cm bằng cách khoét đi bốn phần bằng nhau có hình dạng parabol như hình bên. Biết $AB=5$\,cm, $OH=4$\,cm. Biết giá trang trí hoa văn $1\mathrm{cm^2}$ là $50\,000$\,đồng, tính số tiền cần bỏ ra để trang trí hoa văn đó.
		\choice
		{$2\,553\,333$\,đồng}
		{\True $2\,333\,333$\,đồng}
		{$2\,780\,333$\,đồng}
