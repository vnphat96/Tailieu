...
\begin{ex}%Câu 13.%[Nguyễn Chiến Thắng, TLDH4]%[2H1K3-2]
	...
	{$V=\dfrac{a^3}{3}$}
	\loigiai{
		\immini[thm]{	Ta có $S_{ABCD}=AB\cdot AD=a\cdot a\sqrt 3=\sqrt 3a^2$.\\
...
\begin{ex}%Câu 14.%[Nguyễn Chiến Thắng, TLDH4]%[2H1K3-2]
	...
	{$V=\dfrac{a^3}{4}$}
	\loigiai{
		\immini[thm]{	Diện tích đáy $B=S_{ABC}=\dfrac{1}{2}a\cdot 2a=a^2$.\\
			Chiều cao: $h=a$.\\
...
\begin{ex}%Câu 15.%[Nguyễn Chiến Thắng, TLDH4]%[2H1K3-2]
	...
	{$V=\dfrac{\sqrt{2}}{9}a^3$}
	\loigiai{
		\immini[thm]{Ta có $SM=a\sqrt{3}$. $\Delta SCD$ đều nên $SC=CD=2a$.\\
			Suy ra: $SO=\dfrac{AC}{2}=\dfrac{2a\sqrt{2}}{2}=a\sqrt{2}$.\\
			Vậy $V=\dfrac{1}{3}SO\cdot S_{ABCD}=\dfrac{1}{3}a\sqrt{2}\cdot 4a^2=\dfrac{4a^3\sqrt{2}}{3}$.}
		{
			\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round, >=stealth]
...
\begin{ex}%Câu 17.%[Nguyễn Chiến Thắng, TLDH4]%[2H1K3-2]
	...
	{\True $V=\dfrac{a^3}{8}$}
	\loigiai{
		\immini[thm]{Gọi $I$ là trung điểm của $AB$ ta có $AB\perp(SIC)$. Mặt khác, góc giữa hai mặt phẳng $(SAB)$ và $(ABC)$ là góc $\widehat{SIC}=90^{\circ}\Rightarrow SI\perp(ABC)$.\\
...
\begin{ex}%Câu 18.%[Nguyễn Chiến Thắng, TLDH4]%[2H1K3-2]
	...
	{$\dfrac{a^3}{24}$}
	\loigiai{
		\immini[thm]{	Gọi $H$ là hình chiếu vuông góc của $S$ lên cạnh $AC$ nên $SH\perp(ABC)$.\\
...
\begin{ex}%Câu 20.%[Nguyễn Chiến Thắng, TLDH4]%[2H1K3-3]
	...
	\loigiai{
		\immini[thm]{$\dfrac{V_{N.BMP}}{V_{C.SAB}}=\dfrac{\dfrac{1}{3}\mathrm{d}\left(N,(SAB)\right)\cdot S_{BMP}}{\dfrac{1}{3}\mathrm{d}\left(C,(SAB)\right)\cdot S_{SAB}}$;\\
...
\begin{ex}%Câu 22.%[Nguyễn Chiến Thắng, TLDH4]%[2H1K3-3]
	...
	\loigiai{
		\immini[thm]{	Gọi $h$, $S$ lần lượt là chiều cao và diện tích đáy của khối chóp $S.ABCD$. Khi đó $V_{S.ABCD}=\dfrac{1}{3}S\cdot h$. Nối $MN$ cắt $SA$ tại $E$, $MC$ cắt $AD$ tại $F$. Tam giác $SBM$ có $A$, $N$ lần lượt là trung điểm của $BM$ và $SB$ suy ra $E$ là trọng tâm tam giác $SBM$. Tứ giác $ACDM$ là hình bình hành nên $F$ là trung điểm $MC$.\\
...
\begin{ex}%Câu 23.%[Nguyễn Chiến Thắng, TLDH4]%[2H1K3-2]
	...
	{$\dfrac{a^3\sqrt{3}}{7}$}
	\loigiai{
		\immini[thm]{	Ta có: $AC=AB\cos C=a\sqrt{3};BC=a;S_{ABC}=\dfrac{a^3\sqrt{3}}{2}$.\\
...
\begin{ex}%Câu 24.%[Nguyễn Chiến Thắng, TLDH4]%[2H1K3-2]
	...
	{$V=\dfrac{2\sqrt{2}}{9}$}
	\loigiai{
		\immini[thm]{	Tam giác vuông $SAB$, có $SB=\sqrt{SA^2+AB^2}=\sqrt{3}$.\\
...
\begin{ex}%Câu 25.%[Nguyễn Chiến Thắng, TLDH4]%[2H1K3-6]
	\immini[thm]{	Người ta cắt một tờ giấy hình vuông cạnh bằng $1$ để gấp thành một hình chóp tứ giác đều sao cho bốn đỉnh của hình vuông dán lại thành đỉnh của hình chóp (hình vẽ). Để thể tích khối chóp lớn nhất thì cạnh đáy $x$ của hình chóp bằng}
