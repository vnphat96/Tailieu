...
\begin{ex}%[2D4H3-1]
	\immini[thm]{Cho hàm số $f(x)$ liên tục trên $\mathbb{R}$. Đồ thị hàm số $y=f'(x)$ được cho như hình bên. Diện tích các hình phẳng $(K)$, $(H)$ lần lượt là $\dfrac{5}{12}$ và $\dfrac{8}{3}$. Biết $f(-1)=\dfrac{19}{12}$, tính $f(2)$(kết quả làm tròn đến hàng phần mười).
	}
	{
