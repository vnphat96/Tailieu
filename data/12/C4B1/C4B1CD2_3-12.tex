...
\indapan{8}{ans/ans-C4B1CD2-LC}

\Opensolutionfile{ans}[ans/ans-C4B1CD2-KQ]
\TNSA
\begin{ex}%[2D4H1-4]
...
\end{ex}
\Closesolutionfile{ans}
\indapan{6}{ans/ans-C4B1CD2-KQ}
\begin{dang}{BÀI TOÁN CHO HÀM $f'(x)$, TÌM HÀM $f(x)$}
	$\displaystyle \int f'(x) \mathrm{\,d}x=f(x)+C$
\end{dang}
\Opensolutionfile{ans}[ans/ans-C4B1CD2-CAU24_30-LC]
\TN
\begin{ex}%[2D4H1-2]
...
\end{ex}
\Closesolutionfile{ans}
\indapan{10}{ans/ans-C4B1CD2-CAU24_30-LC}
\Opensolutionfile{ans}[ans/ans-C4B1CD2-CAU31_33-KQ]
\TNSA
\begin{ex}%[2D4V1-3]
