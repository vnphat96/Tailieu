...
\begin{vd}%Ví dụ 3.%[DuongPham - ĐCHT THPT]%[2D3B3-3]
	\immini[thm]{Quay hình phẳng $(H)$ như hình được tô đậm trong hình vẽ bên quanh trục $Ox$ ta được khối tròn xoay có thể tích là 
		\choice
		{\True $V=4\sqrt{3}\pi$}
		{$V=6\sqrt{3}\pi$}
		{$V=5\sqrt{3}\pi$}
...
\begin{vd}%Ví dụ 4.%[DuongPham - ĐCHT THPT]%[2D3K3-5]
	\immini[thm]{	Trong chương trình nông thôn mới, tại một xã X có xây một cây cầu bằng bê tông như hình vẽ. Tính thể tích khối bê tông để đổ đủ cây cầu (Đường cong trong hình vẽ là các đường Parabol)
		\choice
		{$19\,\mathrm{m^3}$}
		{$21\,\mathrm{m^3}$}
		{$18\,\mathrm{m^3}$}
...
\begin{ex}%Câu 38.%[DuongPham - ĐCHT THPT]%[2D3B3-3]
	...
	\loigiai{
		\immini[thm]{
			...
			\Rightarrow V=V_1+V_2=\pi\displaystyle\int\limits_0^1 x^2\mathrm{\,d}x+\pi\displaystyle\int\limits_1^2 (2-x)\mathrm{\,d}x$.}{\begin{tikzpicture}[scale=1,>=stealth, font=\footnotesize, line join=round, line cap=round]
...
\begin{ex}%Câu 41.%[DuongPham - ĐCHT THPT]%[2D3B3-3]
	...
	{$2\pi$}
	\loigiai{
		\immini[thm]{Đặt $V$ là thể tích cần tìm.\\
...
\begin{ex}%Câu 42.%[DuongPham - ĐCHT THPT]%[2D3K3-3]
	\immini[thm]{	Bên trong hình vuông cạnh $a$, dựng hình sao cho bốn cạnh đều như hình vẽ bên (các kích thước cần thiết cho như ở trong hình). Tính thể tích của khối tròn xoay sinh ra khi quay hình sao đó quay trục $xy$. 
		\choice
		...
		\end{tikzpicture}}
	\loigiai{
		\immini[thm]{Gọi $V$ là thể tích khối tròn xoay cần tính.\\
...
\begin{dang}{Bài toán về công của lực tác dụng vào vật}
	\begin{itemize}
		...
		\immini[thm]{\item Giả sử $ f(x) $ là lực tác dụng lên vật tại vị trí $ x $, đường đi của lực tác dụng (quỹ đạo của vật được tác dụng lực) tương ứng với trục tọa độ $ Ox $. Khi đó, công toàn phần sinh ra trong cả quá trình chuyển động của vật từ vị trí $ x=a $ đến vị trí $ x=b $ là
...
\begin{vd}%[2D3B3-7]%[Phạm Thế Sinh]%Ví dụ 1.
	\immini[thm]{Một lực $ 40 $N cần thiết để kéo căng một chiếc lò xo có độ dài tự nhiên từ $ 10 $ cm đến $ 15 $ cm. Hãy tính công sinh ra khi kéo lò xo từ độ dài từ $ 15 $ cm đến $ 18 $ cm.}{
...
\end{vd}
\begin{vd}%[2D3K3-7]%[Phạm Thế Sinh]%Ví dụ 2.
	\immini[thm]{Người thợ hồ nâng một xô nước bị rỉ lên cao $ 20 $ m với tốc độ cố định. Cho trọng lượng của xô là $ 3 $N, trọng lượng ban đầu của nước là $ 2 $N. Biết rằng xô nước bị rỉ nên lượng nước trong xô sẽ chảy ra với tốc độ không đổi trong thời gian nâng xô nước lên. Người ta ước tính rằng lượng nước trong xô sẽ thay đổi theo đồ thị là hình bên. Hỏi người thợ hồ đã dùng một công là bao nhiêu để nâng xô nước lên cao $ 20 $ m, với giả sử rằng bỏ qua trọng lượng sợi dây?}{
...
\begin{ex}%Câu 13.[Đỗ Đường Hiếu - ĐCHT THPT]%[2D3T3-7]
	\immini[thm]{Một quán café muốn làm cái bảng hiệu là một phần của Elip có kích thước, hình dạng giống như hình vẽ và có chất lượng bằng gỗ. Diện tích gỗ bề mặt bảng hiệu là (làm tròn đến hàng phần chục)
		\choice
		{$1{,}3$}
		{\True $1{,}4$}
		{$1{,}5$}
...
\begin{ex}%Câu 14.[Đỗ Đường Hiếu - ĐCHT THPT]%[2D3T3-7]
	\immini[thm]{Anh An muốn làm cửa rào sắt có hình dạng và kích thước giống như hình vẽ kế bên, biết đường cong phía trên là một parabol. Giá $1$m$^2$ cửa rào sắt có giá là $700000$ đồng. Vậy anh An phải trả bao nhiêu tiền để làm cài cửa rào sắt như vậy (làm tròn đến hàng nghìn)
		\choice
		{\True $6417000$ đồng}
		{$6320000$ đồng}
		{$6520000$ đồng}
