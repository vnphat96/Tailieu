...
\begin{vd}%[Thành Đức Trung]%[2D3B3-3]%Ví dụ 6
	...
	\loigiai{
		...
		Chọn hệ trục vuông góc $Oxy$ sao cho $O(0;0),A(1;0),B\left(0;-\sqrt{3}\right)$ với $O$ là trung điểm $AC$. Phương trình đường thẳng $AB$ là $y=\sqrt{3}(x-1)$, thể tích khối tròn xoay khi quay $ABO$ quanh trục $AC$ (trùng $Ox$) tính bởi
...
\begin{ex}%Câu 29.%[Paul Hieu Nguyen]%[2D3K3-3]
	...
	\loigiai{
		Phương trình đường thẳng $OB\colon y=x\cdot\tan\alpha$; $OA=2017\cos\alpha$.\\
