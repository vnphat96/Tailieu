...
\end{ex}
\begin{ex}%[2D4H1-1]
	Cho $F(x)$ là một nguyên hàm của $f(x) = \dfrac{2}{x}$. Biết $F(-1) = 0$. Tính $F(2)$.
	\choice
	{$2 \ln 2 + 1$}
	{$\ln 2$}
	{$ 2 \ln 3 + 2$}
...
\end{ex}
\begin{ex}%[2D4H1-1]
	Cho hàm số $f(x)$ liên tục, có đạo hàm trên $[-1;2]$, $f(-1) = 8$, $f(2) = -1$. Tính $\displaystyle\int\limits_{-1}^{2} f'(x) \, \mathrm{d}x$.
	\choice
	{$1$}
	{$7$}
	{\True $-9$}
...
\end{ex}
\begin{ex}%[2D4H1-1]
	Biết $F(x) = x^2$ là một nguyên hàm của hàm số $f(x)$ trên $\mathbb{R}$. Tính $\displaystyle\int\limits_{1}^{3} \left[ 1 + f(x) \right] \mathrm{d}x$.
	\choice
	{\True $10$}
	{$8$}
	{$ \dfrac{26}{3}$}
