...
\begin{vd}%Ví dụ 4.%[Lương Như Quỳnh, TLDH1]%[2D1B5-6]
	Cho hàm số $y=\dfrac{-x+1}{x+2}$ có đồ thị $(C)$. Gọi $d$ là tiếp tuyến của $(C)$ biết $d$ song song với đường thẳng $y=-3x-1$. PTĐT $d$ có dạng $y=ax+b$ với $a$, $b\in\mathbb{Z}$. Tính $S=a^3-b^2$. 
	\choice
	{\True $S=-196$}
	{$S=-52$}
	{$S=-2224$}
