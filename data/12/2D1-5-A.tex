...
\textbf{Trường hợp} & $$a>0$$ & $$a<0$$ \\ 
	\hline 
	Phương trình $y'=0$ có $3$ nghiệm phân biệt ($a.b<0$) & \begin{tikzpicture}[line cap=round,line join=round,>=stealth,scale=0.5]
	...
	\end{tikzpicture} & \begin{tikzpicture}[line cap=round,line join=round,>=stealth,scale=0.5]
		\draw[->,color=black] (-3,0) -- (3,0) node[below left]{$x$};
	\draw[->,color=black] (0,-3) -- (0.,2.5) node[below left]{$y$};
	\draw[color=black] (0pt,-10pt) node[right] {$O$};
	\clip(-3,-3) rectangle (3,2.5);
	...
	\end{tikzpicture} \\ 
	\hline 
Phương trình $y'=0$ có $1$ nghiệm ($a.b\geq 0$) &\begin{tikzpicture}[line cap=round,line join=round,>=stealth,scale=0.5]
	\draw[->,color=black] (-3,0) -- (3,0) node[below left]{$x$};
\draw[->,color=black] (0,-3) -- (0.,2.5) node[below left]{$y$};
\draw[color=black] (0pt,-10pt) node[right] {$O$};
\clip(-3,-3) rectangle (3,2.5);
...
\end{tikzpicture} & 	\begin{tikzpicture}[>=stealth, font=\footnotesize, line join=round, line cap=round,scale=0.5]
