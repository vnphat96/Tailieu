...
\begin{ex}%[Lê Quốc Dũng]%[2H1K3-4]%Câu 45.
	...
	\loigiai{
		...
		Suy ra $\text{d}\left(H,(SBC)\right)=\dfrac{2}{3}\text{d}\left(A,(SBC)\right)$. Từ $H$ kẻ $HK\perp BC$.\\
		Kẻ $HE\perp SK\Rightarrow HE\perp(SBC)$.\\
		Ta dễ tính được $HK=\dfrac{a\sqrt{3}}{6}\Rightarrow\text{d}\left(H,(SBC)\right)=\dfrac{a\sqrt{6}}{9}$.\\
		Vậy $\text{d}\left(A,(SBC)\right)=\dfrac{3}{2}\text{d}\left(H,(SBC)\right)=\dfrac{3}{2}\cdot\dfrac{a\sqrt{6}}{9}=\dfrac{a\sqrt{6}}{6}$.}
		{\begin{tikzpicture}[scale=1,font=\footnotesize, line join=round, line cap=round, >=stealth]
			\tkzSetUpPoint[size=2]
...
\begin{ex}%[Lê Quốc Dũng]%[2H1K3-2]%Câu 47.
	...
	\loigiai{
		...
		Kẻ $MI\perp AA'$; $BC\perp IM$ nên $\text{d}(AA'; BC)=IM=\dfrac{a\sqrt{3}}{4}$.\\
...
\begin{ex}%[Lê Quốc Dũng]%[2H1K3-2]%Câu 48.
	...
	\loigiai{
		...
		Vì $AB\parallel CD$ nên $\text{d}\left(A;(SCD)\right)=\text{d}\left(I;(SCD)\right)=IK=\dfrac{IS\cdot IJ}{\sqrt{IS^2+IJ^2}}$ \\
