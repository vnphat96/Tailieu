...
\begin{ex}%Câu 6.%[Đỗ Đường Hiếu - ĐCHT THPT]%[2H1B1-1]
	...
	{\begin{tikzpicture}[line join=round]
		...
		\draw[dashed] (D3)--(C3)--(M);
		\end{tikzpicture}}
	{\True \begin{tikzpicture}[line join=round]
		%==Phần thông số có thể tùy chỉnh
		\def\a{0.3}
		\def\b{2}
		\def\h{2}
...
\begin{ex}%Câu 9.%[Đỗ Đường Hiếu - ĐCHT THPT]%[2H1B3-2]
	...
	{$\dfrac{a^3}{4}$}
	\loigiai{
		\immini[thm]{Ta có: $h=SA=a\sqrt{3}$; $B=S_{ABCD}=a^2$.\\
...
\begin{ex}%Câu 10.%[Đỗ Đường Hiếu - ĐCHT THPT]%[2H1B3-3]
	...
	{\True $\dfrac{1}{24}$}
	\loigiai{
		\immini[thm]{Theo công thức tỉ số thể tích khối chóp, ta được
...
\begin{ex}%Câu 13.%[Đỗ Đường Hiếu - ĐCHT THPT]%[2H1Y1-2]
	\immini[thm]{Tìm số mặt của hình đa diện ở hình vẽ bên.
	\choice
	{$11$}
	{$10$}
	{$12$}
...
\begin{ex}%Câu 14.%[Đỗ Đường Hiếu - ĐCHT THPT]%[2H1B1-1]
	...
	\loigiai{
	\immini[thm]{Xét tứ diện (hình vẽ bên). Quan sát đường tô đậm, ta thấy cạnh đó chỉ có hai mặt.\\
...
\begin{ex}%Câu 19.%[Đỗ Đường Hiếu - ĐCHT THPT]%[2H1B3-2]
	...
	{$\dfrac{V}{4}$}
	\loigiai{
		\immini[thm]{Ta có $V_{ABCB'C'}=V-V_{A.A'B'C'}=V-\dfrac{V}{3}=\dfrac{2V}{3}$.}
		{	\begin{tikzpicture}[line join=round]
		%==Phần thông số có thể tùy chỉnh
		\def\a{4}
		\def\h{3}
...
\begin{ex}%Câu 20.%[Đỗ Đường Hiếu - ĐCHT THPT]%[2H1B1-3]
	...
	{Năm tứ diện đều}
	\loigiai{
		\immini[thm]{Hình chóp tam giác đều là $ACB'D'$.\\
...
\begin{ex}%[Lê Quốc Dũng]%[2H1K3-2]%Câu 47.
	...
	\loigiai{
		\immini[thm]{Ta có $A'G\perp(ABC)$ nên $A'G\perp BC$; $BC\perp AM\Rightarrow BC\perp(MAA')$.\\
