...
\begin{vd}%[Nguyễn Cao Cường - ĐCHT THPT]%[2D3Y1-1]%Ví dụ 1:
	Tìm nguyên hàm của hàm số $f(x)=(x-1)^3$.
	\loigiai{
	Ta có $\displaystyle\int(x-1)^3\mathrm{\,d}x=\dfrac{(x-1)^4}{4}+C$.}
\end{vd}%
\begin{vd}%[Nguyễn Cao Cường - ĐCHT THPT]%[2D3Y1-1]%Ví dụ 2:
	Tìm nguyên hàm của hàm số $f(x)=\dfrac{1}{1-x}$.	
	\loigiai{
	Ta có $\displaystyle\int\dfrac{1}{1-x}\mathrm{\,d}x=-\ln|1-x|+C$.}
\end{vd}%
\begin{vd}%[Nguyễn Cao Cường - ĐCHT THPT]%[2D3Y1-1]%Ví dụ 3:
	Tìm nguyên hàm của hàm số $f(x)=\sqrt{x}-1$ trên $(0;+\infty)$.
	\loigiai{
	Ta có $\displaystyle\int(\sqrt{x}-1)\mathrm{\,d}x=\dfrac{2}{3}\sqrt{x^3}-x+C$.}
\end{vd}%
\begin{vd}%[Nguyễn Cao Cường - ĐCHT THPT]%[2D3Y1-1]%Ví dụ 4:
	Tìm nguyên hàm của hàm số $f(x)=\dfrac{1}{2x+1}+\cos x$.
	\loigiai{
	Áp dụng công thức cơ bản của nguyên hàm ta có $\displaystyle\int\left(\dfrac{1}{2x+1}+\cos x\right)\mathrm{\,d}x=\dfrac{1}{2}\ln|2x+1|+\sin x+C$.}
\end{vd}%
\begin{vd}%[Nguyễn Cao Cường - ĐCHT THPT]%[2D3Y1-1]%Ví dụ 5:
