...
\begin{vd}%[Hưng Nguyễn, dự án 12-EX-DCHT]%[2D4K2-4]
	...
	\loigiai{
		\immini
		{
			...
			PTĐT $OI$ đi qua điểm $O(0;0)$, có véc-tơ chỉ phương $\overrightarrow{OI}=(2;4)$ là $\dfrac{x}{2}=\dfrac{y}{4}\Leftrightarrow y=2x$.
		}
		{
			\begin{tikzpicture}[scale=.7, font=\footnotesize, line join=round, line cap=round,>=stealth]
...
\begin{ex}%[Hưng Nguyễn, dự án 12-EX-DCHT]%[2D4K2-4]
	...
	\loigiai{
		\immini
		{
			...
			PTĐT $AB$ đi qua $A(1;1)$, có véc-tơ chỉ phương $\overrightarrow{AB}=(6;3)$ là $\dfrac{x-1}{6}=\dfrac{y-1}{3}$ hay $x-2y+1=0$.\\
