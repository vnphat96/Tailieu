...
\begin{tomtat}
	...
	\end{center}
	\begin{nx}
	Vì điểm biểu diễn của số phức $z=a+bi$ là $M(a;b)$ hay $\overrightarrow{OM}=(a;b)$. Do đó cần nhớ những kiến thức cơ bản về vectơ, hệ trục $Oxy$ và hệ thức lượng trong tam giác.\\
	Cho ham giác $ABC$, hai vectơ $\vec{a}=(a_1;a_2)$, $\vec{b}=(b_1;b_2)$ và $R,\:r,\:p$ lần lượt là bán kính đường tròn ngoại tiếp, nội tiếp và nửa chu vi tam giác $ABC$.
	\begin{enumerate}
...
\begin{ex}%[Ngô Quang Anh, 12-EX-1-DCHT]%[2D4Y1-2] 
	...
	\immini[thm]{	Điểm $A(2;1)$ biểu diễn cho số phức $z_1=2+i$.\\
...
\begin{ex}%[Ngô Quang Anh, 12-EX-1-DCHT]%[2D4Y1-1]
	...
	\immini[thm]{Tìm phần thực và phần ảo của số phức $\overline{z}$.
		\choice
...
\begin{ex}%[Ngô Quang Anh, 12-EX-1-DCHT]%[2D4B2-2]
	...
	\immini[thm]{Hỏi khẳng định nào sau đây {\bf sai}?
		\haicot
...
\begin{ex}%[Ngô Quang Anh, 12-EX-1-DCHT]%[2D4B3-2]
	Trên mặt phẳng phức, gọi $M$ là điểm biểu diễn số phức $z=\left(2-3i\right)\cdot\left(1+i\right)$ và $\varphi$ là góc tạo bởi chiều dương trục hoành và vectơ $\overrightarrow{OM}$. Tính $\sin 2\varphi$.
	\choice
...
\begin{ex}%[Ngô Quang Anh, 12-EX-1-DCHT]%[2D4B3-2]
	Trên mặt phẳng phức, gọi $M$ là điểm biểu diễn số phức $z=\left(2+i\right)^2\cdot\left(4-i\right)$ và gọi $\varphi$ là góc tạo bởi chiều dương trục hoành và vectơ $\overrightarrow{OM}$. Tính $\cos 2\varphi$.
	\choice
...
\begin{ex}%[Ngô Quang Anh, 12-EX-1-DCHT]%[2D4G5-2] 
	...
	\loigiai{ 
		\immini[thm]{Đặt $z=a+bi$. Khi đó $z(4+3i)=4a-3b+(3a+4b)i$ và $M(a;b); M'(a;-b), N(4a-3b;3a+4b), N'(4a-3b;-3a-4b)$.\\
			$\vec{MN}=(3a-3b;3a+3b)$. \\
...
\begin{bt}%[Đỗ Đường Hiếu, dự án (12-EX-1-DCDH(L1))]%[2D4K3-4]
	\begin{listEX}[1]
		\item Cho số phức $z$ thỏa mãn $\left|z-(1+i)\right|=\left|z+2i\right|$. Tập hợp các điểm biểu diễn số phức $w=(3-4i)z-1$ trên mặt phẳng tọa độ là một đường thẳng. Viết PTĐT đó. \dapso{$3x+y+8=0$}
		...
		\item Cho các số phức $z$ thỏa mãn $\left|z-2-i\right|=\left|\bar{z}+2i\right|$. Tập hợp các điểm biểu diễn số phức $w=(1+i)z-2$ trên mặt phẳng tọa độ là một đường thẳng. Viết PTĐT đó. \dapso{$3x+y+5=0$}
		\loigiai{Gọi $M(x;y)$ là điểm biểu diễn số phức $w=x+yi$ ($x,y\in\mathbb{R}$). Ta có 
...
\begin{bt}%[Đỗ Đường Hiếu, dự án (12-EX-1-DCDH(L1))]%[2D4K3-4]
	\begin{enumerate}
		...
		\loigiai{\immini[thm]{Gọi $M(x;y)$ là điểm biểu diễn số phức $z=x+yi$ ($x,\,y\in\mathbb{R}$) thỏa mãn bài toán.\\
				Theo đề bài ta có 
				\begin{eqnarray*}
	...
	\loigiai{
		...
		\begin{itemize}  
			...
			{\immini {Mặt khác
					...
					Mà PTĐT đi qua hai điểm $I$, $N$ là $\dfrac{x + 1}{3} = \dfrac{y - 1}{2}\Leftrightarrow 2x - 3y + 5 = 0$.\\
...
\begin{ex}%[Vương Quyền, dự án 12-EX-1-DCHT]%[2D4G5-1]
	...
	\loigiai{
		...
		Suy ra $P_{\min}=AB=7$.
		PTTS của đường thẳng đi qua hai điểm  $AB\colon\heva{& x=1\\& y=7t}$ với $t\in\mathbb{R}$.\\
...
\begin{vd}%[Hưng Nguyễn, dự án 12-EX-DCHT]%[2D4K2-4]
	...
	\loigiai{
		\immini
		{
			...
			PTĐT $OI$ đi qua điểm $O(0;0)$, có vectơ chỉ phương $\overrightarrow{OI}=(2;4)$ là $\dfrac{x}{2}=\dfrac{y}{4}\Leftrightarrow y=2x$.
		}
		{
			\begin{tikzpicture}[scale=.7, font=\footnotesize, line join=round, line cap=round,>=stealth]
...
\begin{ex}%[Hưng Nguyễn, dự án 12-EX-DCHT]%[2D4K2-4]
	...
	\loigiai{
		\immini
		{
			...
			PTĐT $AB$ đi qua $A(1;1)$, có vectơ chỉ phương $\overrightarrow{AB}=(6;3)$ là $\dfrac{x-1}{6}=\dfrac{y-1}{3}$ hay $x-2y+1=0$.\\
