\boxde
\Opensolutionfile{ans}[ans/2D1-2-DEON-4]
\BTTN
\begin{ex}
 \immini[thm]{Cho hàm số $f(x)$ có bảng biến thiên như hình bên. Hàm số đã cho đồng biến trên khoảng nào dưới đây?
 \choice
 {\True $(0;1)$}
 {$(2;+\infty)$}
 {$(1;+\infty)$}
...
\begin{ex}%[Câu 7]%[2D1N2-2]
 \immini[thm]{Cho hàm số $y=f(x)$ xác định trên $\mathbb{R}$ và có bảng biến thiên như hình vẽ bên. Hàm số $y=f(x)$ đạt cực đại tại
 \choice
 { \True $x=10$}
 { $x=8$}
 { $x=12$}
...
\end{ex}
\begin{ex}
 \immini[thm]{Đường cong ở hình bên là đồ thị hàm số $y=\dfrac{ax+b}{cx+d}$, với $a,b,c,d$ là các số thực. Mệnh đề nào dưới đây là đúng?
 \choice
 {$y'<0,\,\,\forall x \neq 1$}
 {$y'<0,\,\,\forall x \neq 2$}
 {$y'>0,\,\,\forall x \neq 2$}
...
\begin{ex}%[Câu 8]%[2D1N2-2]
 \immini[thm]{Cho hàm số có đồ thị như hình bên.
