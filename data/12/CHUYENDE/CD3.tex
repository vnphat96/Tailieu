...
\end{tikzpicture}
    ...
    \loigiai{
        \begin{itemchoice}
            ...
            \itemch Sai. Vì $\overrightarrow{AA'}\cdot\overrightarrow{AD}=0$ (2 véc-tơ vuông góc với nhau)
...
\immini
{
        Cho biết công $A$ (đơn vị: $J$) sinh bởi lực $\vec{F}$ tác dụng lên một vật được tính bằng công thức $A = \vec{F}\cdot\vec{d}$, trong đó $\vec{d}$ là véc-tơ biểu thị độ dịch chuyển của vật (đơn vị của $\left|\vec{d}\right|$ là m) khi chịu tác dụng của lực $\vec{F}$.\\
...
\shortans{$9\,6$}
    \loigiai{Ta có $1{,}5$ tấn = $1~500$ kg.\\
        ...
        Véc-tơ $\vec{d}$ biểu thị độ dịch chuyển của xe có độ dài là $\left|\vec{d}\right| = 7{,}5$ (m) và $\left(\vec{P},\vec{d}\right)= 90^\circ - 5^\circ = 85^\circ$.\\
