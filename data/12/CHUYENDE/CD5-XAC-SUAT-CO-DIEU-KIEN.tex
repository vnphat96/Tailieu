...
\begin{vd} % Bài 6.2
    ...
    \loigiai{
        ...
        Xác suất cần tìm: $P(A|B) = \frac{P(A \cap B)}{P(B)} = \frac{0,16}{0,51} = \frac{16}{51}$.
    }
    \dotlineEX{1}
\end{vd}
\begin{vd} % Bài 6.1
    ...
    \loigiai{
        ...
        Vì thẻ số 10 là số chẵn nên $A \cap B = A$. Xác suất cần tìm là $P(A|B) = \frac{n(A \cap B)}{n(B)} = \frac{1}{10}$.
    }
    \dotlineEX{1}
\end{vd}
...
\begin{vd} % Bài 6.18
    ...
    { Xác suất người đó uống thuốc Y, biết rằng người đó khỏi bệnh là $\frac{4}{7}$}
    \loigiai{
        Tổng số người dùng thuốc X = $1600+800=2400$. (Ý a đúng)
        Ý b: $P(\text{Khỏi} | X) = \frac{1600}{2400} = \frac{2}{3}$ (Sai).
        Ý c: Tổng số người khỏi bệnh = $1600+1200=2800$ (Đúng).
        Ý d: $P(Y | \text{Khỏi}) = \frac{1200}{2800} = \frac{3}{7}$ (Sai).
    }
\end{vd}
\begin{vd} % Bài 6.6
    Trong một túi có một số chiếc kẹo cùng loại, chỉ khác màu, trong đó có 6 cái kẹo màu cam, còn lại là kẹo màu vàng. Hà lấy ngẫu nhiên một cái kẹo từ trong túi, không trả lại. Sau đó Hà lại lấy ngẫu nhiên thêm một cái kẹo khác. Biết rằng xác suất Hà lấy được cả hai cái kẹo màu cam là $\frac{1}{3}$. Hỏi ban đầu trong túi có bao nhiêu cái kẹo?\shortans{10}
    \loigiai{
        Gọi số kẹo ban đầu trong túi là $n$ ($n > 6$).
        Xác suất lấy lần 1 được kẹo cam là $\frac{6}{n}$.
        Sau khi lấy 1 kẹo cam, trong túi còn $n-1$ kẹo, trong đó có 5 kẹo cam. Xác suất lấy lần 2 kẹo cam là $\frac{5}{n-1}$.
        Xác suất lấy 2 kẹo cam: $\frac{6}{n} \cdot \frac{5}{n-1} = \frac{1}{3} \Leftrightarrow n(n-1) = 90 \Leftrightarrow n^2 - n - 90 = 0 \Rightarrow n = 10$.
        \textbf{Đáp án:} 10
    }
\end{vd}
\begin{vd}[Minh hoạ BGD-2025]%[Câu 6]
    ...
    \loigiai{
        ...
        Xác suất $P(T) = \frac{6}{10} = 0.6$.
        Xác suất quả bóng chuyển sang màu vàng là $P(\overline{T}) = \frac{4}{10} = 0.4$.
        ...
        Nếu $T$ xảy ra (chuyển bóng đỏ), hộp II có 8 đỏ, 3 vàng $\Rightarrow P(D|T) = \frac{8}{11}$.
        Nếu $\overline{T}$ xảy ra (chuyển bóng vàng), hộp II có 7 đỏ, 4 vàng $\Rightarrow P(D|\overline{T}) = \frac{7}{11}$.
        Suy ra $P(D) = \frac{8}{11} \times \frac{6}{10} + \frac{7}{11} \times \frac{4}{10} = \frac{76}{110}$.
        Gọi $S$ là biến cố "Quả bóng lấy ra từ hộp II chính là quả bóng được chuyển từ hộp I sang".
        Ta cần tính xác suất điều kiện $P(S|D) = \frac{P(S \cap D)}{P(D)}$.
        Biến cố $S \cap D$ nghĩa là "Quả bóng chuyển sang là màu đỏ VÀ quả bóng lấy ra chính là quả bóng đó".
        Xác suất chuyển bóng đỏ là $\frac{6}{10}$. Khi đã chuyển sang, hộp II có 11 quả bóng, xác suất để bốc trúng đúng quả vừa chuyển là $\frac{1}{11}$.
        Do đó, $P(S \cap D) = \frac{6}{10} \times \frac{1}{11} = \frac{6}{110}$.
        Vậy xác suất cần tìm là:
        $P(S|D) = \frac{\frac{6}{110}}{\frac{76}{110}} = \frac{6}{76} = \frac{3}{38} \approx 0.08$.
...
%    \loigiai{
%        Mặt xúc xắc chia hết cho 3 là $\{3, 6\}$. Xác suất chọn chuồng I là $\frac{2}{6} = \frac{1}{3}$. Xác suất chọn chuồng II là $\frac{2}{3}$.
%        - Chuồng I: Xác suất bắt được gà mái là $\frac{5}{7}$.
%        - Chuồng II: Xác suất bắt được gà mái là $\frac{3}{8}$.
%        Xác suất bắt được gà mái là: $P = \frac{1}{3} \cdot \frac{5}{7} + \frac{2}{3} \cdot \frac{3}{8} = \frac{5}{21} + \frac{6}{24} = \frac{41}{84}$.
%        \textbf{Đáp án:} 41/84
%    }
\end{vd}
...
\begin{ex}%[134706] [MĐ1]
    ...
    \choice
    {\True $P(A|B) = \frac{P(AB)}{P(B)}$}
    {$P(A|B) = \frac{P(A \cup B)}{P(B)}$}
    {$P(A|B) = \frac{P(AB)}{P(A)}$}
    {$P(A|B) = \frac{P(A \cup B)}{P(A)}$}
%    \loigiai{
%        Theo định nghĩa xác suất có điều kiện, ta có $P(A|B) = \frac{P(AB)}{P(B)}$ (với $P(B) > 0$).
%    }
\end{ex}
\begin{ex}%[134710] [MĐ1]
...
\begin{ex}%[360681] [MĐ1]
    ...
    {\True $0$}
%    \loigiai{
%        Vì $A, B$ xung khắc nên $P(AB) = 0$. Khi đó $P(A|B) = \frac{P(AB)}{P(B)} = \frac{0}{0,4} = 0$.
%    }
\end{ex}
\begin{ex}%[360664] [MĐ1]
...
\begin{ex}%[143806] [MĐ2]
    ...
    {$\frac{2}{7}$}
    \loigiai{
        Ta có $P(\overline{A}) = 1 - P(A) = 1 - \frac{2}{7} = \frac{5}{7}$.\\
        Theo công thức xác suất toàn phần:
        $$P(B) = P(A)P(B|A) + P(\overline{A})P(B|\overline{A}) = \frac{2}{7} \cdot \frac{1}{4} + \frac{5}{7} \cdot \frac{1}{5} = \frac{2}{28} + \frac{5}{35} = \frac{1}{14} + \frac{1}{7} = \frac{3}{14}.$$
    }
    \dotlineEX{1}
\end{ex}
\begin{ex}%[135717] [MĐ2]
    ...
    \loigiai{
        ...
        Xác suất cần tìm: $P = \frac{400}{1200} = \frac{1}{3}$.
    }
\end{ex}
\begin{ex}%[135722] [MĐ2]
...
%        Xác suất cần tìm là $P = \frac{41}{49}$.
%    }
\end{ex}
\begin{ex}%[135724] [MĐ2]
...
%        Xác suất để lần thứ 2 bốc được bi đỏ là $P = \frac{2}{9}$.
%    }
\dotlineEX{1}
\end{ex}
\begin{ex}%[360669] [MĐ2]
    ...
    {$\frac{4}{19}$}
    \loigiai{
        Xác suất lần 1 lấy được sản phẩm thấp là $\frac{5}{20}$.\\
        Xác suất lần 2 lấy được sản phẩm thấp (khi đã lấy 1 sản phẩm thấp ra) là $\frac{4}{19}$.\\
        Xác suất cả 2 lần đều thấp là $P = \frac{5}{20} \cdot \frac{4}{19} = \frac{1}{19}$.
    }
\end{ex}
\begin{ex}%[143807] [MĐ2]
...
\begin{ex}%[143809] [MĐ2]
    ...
    {\True $0,6$}
    \loigiai{
        Ban đầu hộp có 10 viên. Xác suất viên bi bị mất là đỏ: $P(M_Đ) = \frac{6}{10} = 0,6$. Xác suất bị mất là trắng: $P(M_T) = \frac{4}{10} = 0,4$.\\
        Gọi $A$ là biến cố "Lấy được viên bi đỏ từ 9 viên còn lại".
        \begin{itemize}
            \item Nếu mất bi đỏ: Hộp còn 5 đỏ, 4 trắng. $P(A|M_Đ) = \frac{5}{9}$.
            \item Nếu mất bi trắng: Hộp còn 6 đỏ, 3 trắng. $P(A|M_T) = \frac{6}{9}$.
        \end{itemize}
        Áp dụng công thức xác suất toàn phần:
        $$P(A) = P(M_Đ)P(A|M_Đ) + P(M_T)P(A|M_T) = 0,6 \cdot \frac{5}{9} + 0,4 \cdot \frac{6}{9} = \frac{3}{9} + \frac{2,4}{9} = \frac{5,4}{9} = 0,6.$$
    }
\end{ex}
\begin{ex}%[143810] [MĐ2]
    ...
    {$0,233\%$}
    \loigiai{
        Vì năng suất nhà máy hai gấp 3 lần nhà máy một nên tỷ lệ linh kiện của nhà máy một là $\frac{1}{4} = 0,25$ và nhà máy hai là $\frac{3}{4} = 0,75$.\\
...
\begin{ex}%[143818] [MĐ2]
    ...
    \loigiai{
        ...
        $$P(N|D) = \frac{P(N \cap D)}{P(D)} = \frac{0,009}{0,207} = \frac{9}{207} = \frac{1}{23}.$$
    }
\end{ex}
\begin{ex}%[145260] [MĐ2]
    ...
    \loigiai{
        ...
        $$P(H|B) = \frac{P(H \cap B)}{P(B)} = \frac{0,14}{0,26} = \frac{7}{13} \approx 0,538 \approx 54\%.$$
    }
\end{ex}
\begin{ex}%[143819] [MĐ2]
...
%        $$P(M_1|T) = \frac{P(M_1 \cap T)}{P(T)} = \frac{0,396}{0,984} = \frac{396}{984} = \frac{33}{82}.$$
%    }
\dotlineEX{2}
\end{ex}
\begin{ex}%[143820] [MĐ2]
    ...
    \loigiai{
        ...
        $$P(N|\overline{V}) = \frac{P(N \cap \overline{V})}{P(\overline{V})} = \frac{0,12}{0,54} = \frac{12}{54} = \frac{2}{9}.$$
    }
\end{ex}
\begin{ex}%[145262] [MĐ2]
    ...
    \loigiai{
        ...
        $$P(N|D) = \frac{P(N \cap D)}{P(D)} = \frac{0,0475}{0,0665} = \frac{475}{665} = \frac{5}{7}.$$
    }
\end{ex}
\begin{ex}%[145263] [MĐ2]
    ...
    \loigiai{
        ...
        $$P(U|D) = \frac{P(U \cap D)}{P(D)} = \frac{0,039}{0,096} = \frac{39}{96} = \frac{13}{32} = 0,40625.$$
    }
\end{ex}
\begin{ex}%[143821] [MĐ2]
    ...
    {$\frac{37}{140}$}
    \loigiai{
        Tổng số VĐV là $14$. Xác suất chọn được VĐV đội I là $P(I) = \frac{6}{14} = \frac{3}{7}$, đội II là $P(II) = \frac{8}{14} = \frac{4}{7}$.\\
        Gọi $V$ là biến cố "Vận động viên đạt huy chương vàng". $P(V|I) = 0,65$ và $P(V|II) = 0,55$.\\
        Xác suất chọn được VĐV đạt huy chương vàng:
        $$P(V) = \frac{3}{7} \cdot 0,65 + \frac{4}{7} \cdot 0,55 = \frac{1,95 + 2,2}{7} = \frac{4,15}{7}.$$
        Xác suất VĐV đó thuộc đội I là:
        $$P(I|V) = \frac{P(I \cap V)}{P(V)} = \frac{\frac{1,95}{7}}{\frac{4,15}{7}} = \frac{1,95}{4,15} = \frac{195}{415} = \frac{39}{83}.$$
    }
\end{ex}
\begin{ex}%[145269] [MĐ2]
...
%        $$P(Nam|A) = \frac{P(Nam \cap A)}{P(A)} = \frac{0,0720}{0,1656} = \frac{7200}{16560} = \frac{10}{23}.$$
%    }
\end{ex}
\begin{ex}%[143822] [MĐ2]
    ...
    \loigiai{
        ...
        Gọi $Đ$ là biến cố "Rút được quả bóng đen". Ta có $P(Đ|I) = \frac{6}{10} = 0,6$; $P(Đ|II) = \frac{3}{7}$.\\
        Xác suất rút được bóng đen chung:
        $$P(Đ) = 0,5 \cdot 0,6 + 0,5 \cdot \frac{3}{7} = 0,3 + \frac{1,5}{7} = \frac{2,1 + 1,5}{7} = \frac{3,6}{7}.$$
        Xác suất quả bóng đen đó từ túi I:
        $$P(I|Đ) = \frac{P(I \cap Đ)}{P(Đ)} = \frac{0,3}{\frac{3,6}{7}} = \frac{2,1}{3,6} = \frac{21}{36} = \frac{7}{12}.$$
    }
\end{ex}
\begin{ex}%[144409] [MĐ2]
    ...
    {\True $\frac{2}{7}$}
    \loigiai{
        Xác suất người này nói sự thật là $P(T) = \frac{2}{3}$, xác suất nói dối là $P(D) = \frac{1}{3}$.\\
        Thực tế gieo xúc xắc: Xác suất ra số 4 là $P(S_4) = \frac{1}{6}$, không ra số 4 là $P(\overline{S_4}) = \frac{5}{6}$.\\
        Anh ta "báo cáo là số 4" (gọi là biến cố $B$) trong 2 trường hợp:
        \begin{itemize}
            \item Thực sự ra số 4 và anh ta nói thật: $P(S_4 \cap T) = \frac{1}{6} \cdot \frac{2}{3} = \frac{2}{18}$.
            \item Thực sự không ra số 4 và anh ta nói dối (biến thành báo số 4): $P(\overline{S_4} \cap D) = \frac{5}{6} \cdot \frac{1}{3} = \frac{5}{18}$.
        \end{itemize}
        Xác suất anh ta báo cáo là số 4: $P(B) = \frac{2}{18} + \frac{5}{18} = \frac{7}{18}$.\\
        Xác suất số thực sự là 4 khi báo cáo là 4:
        $$P(S_4|B) = \frac{\frac{2}{18}}{\frac{7}{18}} = \frac{2}{7}.$$
    }
\end{ex}
\begin{ex}%[144829] [MĐ2]
    ...
    \loigiai{
        ...
        $$P(T|C) = \frac{P(T \cap C)}{P(C)} = \frac{0,72}{0,73} \approx 0,9863 \approx 98,6\%.$$
    }
    \dotlineEX{1}
\end{ex}
\begin{ex}%[135802] [MĐ2]
    ...
    \choiceTF
    {\True Xác suất để Việt nhận được 2 viên bi trắng là $\frac{15}{91}$}
    { Xác suất để Việt nhận được 2 viên bi đen là $\frac{2}{7}$}
    {\True Xác suất để Việt nhận được viên bi đen ở lần thứ nhất và viên bi trắng ở lần thứ hai là $\frac{24}{91}$}
    { Xác suất để Việt nhận được viên bi trắng ở lần thứ nhất và viên bi đen ở lần thứ hai là $\frac{12}{49}$}
    \loigiai{
        Tổng số bi trong túi ban đầu là $8 + 6 = 14$ viên.\\
        a) Lấy 2 viên bi trắng không hoàn lại: $P = \frac{6}{14} \cdot \frac{5}{13} = \frac{15}{91}$. (Đúng)\\
        b) Lấy 2 viên bi đen không hoàn lại: $P = \frac{8}{14} \cdot \frac{7}{13} = \frac{4}{13}$. Mệnh đề cho $\frac{2}{7}$, là sai.\\
        c) Đen lần 1, trắng lần 2: $P = \frac{8}{14} \cdot \frac{6}{13} = \frac{24}{91}$. (Đúng)\\
        d) Trắng lần 1, đen lần 2: $P = \frac{6}{14} \cdot \frac{8}{13} = \frac{24}{91}$. Mệnh đề cho $\frac{12}{49}$, là sai.
    }
    \dotlineEX{2}
\end{ex}
\begin{ex}%[135806] [MĐ2]
...
\begin{ex}%[146776] [MĐ2]
    ...
    \choiceTF
    {\True Xác suất để người đó mua được con gà mái là $\frac{5}{7}$}
    { Xác suất để người đó mua được con gà trống là $\frac{2}{5}$}
    {\True Một người thứ hai lại đến mua gà, người bán gà lại bắt ngẫu nhiên ra 1 con, xác suất để người thứ hai mua được con gà trống khi người thứ nhất mua được con gà mái là $\frac{1}{3}$}
    {Trong trường hợp người bán gà quên mất rằng con gà bán cho người thứ nhất là gà trống hay gà mái. Xác suất để người thứ hai mua được gà trống bằng $\frac{3}{7}$}
    \loigiai{
        Tổng số gà trong lồng là $7$ con.
        \begin{itemize}
            \item a) Xác suất bắt được gà mái lần đầu là $\frac{5}{7}$. (Đúng)
            \item b) Xác suất bắt được gà trống lần đầu là $\frac{2}{7}$. Mệnh đề cho $\frac{2}{5}$ là (Sai).
            \item c) Nếu người thứ nhất mua gà mái, lồng còn 4 mái, 2 trống (tổng 6 con). Xác suất người thứ hai mua được gà trống là $\frac{2}{6} = \frac{1}{3}$. (Đúng)
            ...
            $$P = \frac{5}{7} \cdot \frac{2}{6} + \frac{2}{7} \cdot \frac{1}{6} = \frac{10}{42} + \frac{2}{42} = \frac{12}{42} = \frac{2}{7}.$$
            Mệnh đề cho $\frac{3}{7}$ là (Sai).
        \end{itemize}
    }
    \dotlineEX{2}
\end{ex}
\begin{ex}%[144831] [MĐ3]
    ...
    {\True Nếu vật được rút ra bị lỗi, xác suất để vật đó được tạo ra bởi Máy II bằng $\frac{15}{23}$}
    \loigiai{
        ...
        d) Xác suất vật lỗi do máy II tạo ra: $P(M_2|L) = \frac{P(M_2 \cap L)}{P(L)} = \frac{0,030}{0,046} = \frac{30}{46} = \frac{15}{23}$. (Đúng)
    }
\end{ex}
\begin{ex}%[145264] [MĐ3]
    ...
    \loigiai{
        ...
        b) Xác suất là thư rác biết đã bị chặn: $P(R|C) = \frac{0,0285}{0,0382} \approx 0,746 = 74,6\%$. (Sai)\\
        c) Xác suất là thư đúng khi không bị chặn: $P(\overline{R}|\overline{C}) = \frac{P(\overline{R} \cap \overline{C})}{P(\overline{C})} = \frac{0,97 \cdot (1 - 0,01)}{1 - 0,0382} = \frac{0,97 \cdot 0,99}{0,9618} = \frac{0,9603}{0,9618} \approx 0,9984 = 99,84\%$. (Đúng)\\
...
\begin{ex}%[144879] [MĐ3]
    ...
    \loigiai{
        ...
        d) Nếu bắn trúng, xác suất dùng súng mới là $P(M|T) = \frac{0,38}{0,86} \approx 0,44$. Xác suất dùng súng cũ là $P(C|T) = \frac{0,48}{0,86} \approx 0,56$. Khả năng dùng súng cũ cao hơn. (Sai)
    }
\end{ex}
\begin{ex}%[144885] [MĐ3]
    ...
    { Rút ngẫu nhiên được một bệnh án của một bệnh nhân bị biến chứng. Xác suất để bệnh án đó là của bệnh nhân bị biến chứng do hoá chất gây ra là $\frac{12}{17}$}
%    \loigiai{
...
%        d) Xác suất do hóa chất khi biết bị biến chứng: $P(H|B) = \frac{P(H \cap B)}{P(B)} = \frac{0,10}{0,34} = \frac{10}{34} = \frac{5}{17}$. (Sai)
%    }
\end{ex}
\begin{ex}%[144894] [MĐ3]
    ...
    \loigiai{
        ...
        c) Lỗi do kỹ sư 1 thực hiện: $P(K_1|L) = \frac{P(K_1 \cap L)}{P(L)} = \frac{0,018}{0,034} = \frac{18}{34} = \frac{9}{17}$. (Sai)\\
        d) Lỗi do kỹ sư 2 thực hiện là $P(K_2|L) = \frac{0,016}{0,034} = \frac{8}{17}$. Ta thấy $\frac{9}{17} > \frac{8}{17}$. (Đúng)
    }
    \dotlineEX{2}
\end{ex}
\begin{ex}%[145230] [MĐ3]
    ...
    \loigiai{
        ...
        c) Xác suất thắng DA 2 khi biết thắng DA 1: $P(B|A) = \frac{P(A \cap B)}{P(A)} = \frac{0,3}{0,4} = 0,75$. (Đúng)\\
        d) Xác suất thắng DA 2 khi biết không thắng DA 1: $P(B|\overline{A}) = \frac{P(B \cap \overline{A})}{P(\overline{A})} = \frac{0,2}{1 - 0,4} = \frac{0,2}{0,6} = \frac{1}{3} \approx 0,33$. (Sai)
    }
    \dotlineEX{2}
\end{ex}
\begin{ex}%[145231] [MĐ3]
    ...
    {\True Xác suất làm đúng cả 2 bài, biết rằng làm đúng ít nhất một bài là $\frac{14}{19}$}
    \loigiai{
        ...
        $P(D_1|D_2) = \frac{P(D_1 \cap D_2)}{P(D_2)} = \frac{0,56}{0,62} = \frac{28}{31}$. Mệnh đề cho 0,8 là (Sai)\\
        d) Đúng 2 bài biết đúng ít nhất 1 bài: $\frac{P(D_1 \cap D_2)}{P(\text{Ít nhất 1 bài})} = \frac{0,56}{0,76} = \frac{56}{76} = \frac{14}{19}$. (Đúng)
    }
    \dotlineEX{3}
\end{ex}
\begin{ex}[KSCL12-Sở Quảng Ninh-2026]
    ...
    \loigiai{
        ...
        $$P(\overline{A}|\overline{B}) = \frac{P(\overline{A}) \cdot P(\overline{B}|\overline{A})}{P(\overline{B})} = \frac{0,55 \cdot 0,2}{1 - 0,7775} = \frac{0,11}{0,2225} \approx 0,494 > 0,45.$$
...
\begin{ex}%[360662] [MĐ2]
    ...
    \shortans{$0,05$}
    \loigiai{
        Gọi $B$ là biến cố người đó nhiễm bệnh $\Rightarrow P(B) = \frac{1500}{9000} = \frac{1}{6}$; $P(\overline{B}) = \frac{7500}{9000} = \frac{5}{6}$.\\
        Gọi $A$ là biến cố kết quả thử âm tính. Ta có $P(A|B) = 1 - 0,76 = 0,24$ và $P(A|\overline{B}) = 1 - 0,07 = 0,93$.\\
        Xác suất âm tính: $P(A) = P(B)P(A|B) + P(\overline{B})P(A|\overline{B}) = \frac{1}{6} \cdot 0,24 + \frac{5}{6} \cdot 0,93 = 0,04 + 0,775 = 0,815$.\\
        Xác suất bị nhiễm bệnh khi âm tính: $P(B|A) = \frac{P(B \cap A)}{P(A)} = \frac{0,04}{0,815} \approx 0,04907 \approx 0,05$.
    }
    \dotlineEX{1}
\end{ex}
\begin{ex}%[135784] [MĐ2]
    ...
    \loigiai{
        ...
        Xác suất lấy được sách tiếng Việt biết đó là sách Khoa học là $P = \frac{7}{10} = 0,7$.
    }
    \dotlineEX{1}
\end{ex}
\begin{ex}%[135859] [MĐ2]
    ...
    \loigiai{
        ...
        - Xác suất cả 2 bút màu xanh: $\frac{7}{12} \cdot \frac{6}{11} = \frac{42}{132}$.\\
        - Xác suất cả 2 bút màu đen: $\frac{5}{12} \cdot \frac{4}{11} = \frac{20}{132}$.\\
        Xác suất lấy 2 bút cùng màu là $P = \frac{42 + 20}{132} = \frac{62}{132} = \frac{31}{66} \approx 0,4696 \approx 0,47$.
    }
\end{ex}
\begin{ex}%[378716] [MĐ2]
    ...
    \loigiai{
        ...
        Xác suất lấy được 2 cái kẹo màu cam liên tiếp (không hoàn lại) là: $\frac{6}{N} \cdot \frac{5}{N-1}$.\\
        Theo bài ra ta có: $\frac{30}{N(N-1)} = \frac{1}{3} \Leftrightarrow N(N-1) = 90 \Leftrightarrow N^2 - N - 90 = 0$.\\
...
\begin{ex}%[143811] [MĐ2]
    ...
    \shortans{$0,74$}
    \loigiai{
        Tổng số xạ thủ là 10. Xác suất chọn được xạ thủ loại I là $P(\text{I}) = \frac{2}{10} = 0,2$. Xác suất chọn được xạ thủ loại II là $P(\text{II}) = \frac{8}{10} = 0,8$.\\
...
\begin{ex}%[143812] [MĐ2]
    ...
    \loigiai{
        ...
        $$P(\text{Ngày 2 R} \mid \text{Ngày 1 N}) = \frac{P(NR)}{P(\text{Ngày 1 N})} = \frac{0,1}{0,4} = 0,25.$$
    }
    \dotlineEX{1}
\end{ex}
\begin{ex}%[378735] [MĐ2]
    ...
    \shortans{$0,49$}
    \loigiai{
        Xác suất xúc xắc ra số chấm chia hết cho 3 (mặt 3, 6) là $P(\text{C I}) = \frac{2}{6} = \frac{1}{3}$.\\
        Xác suất ra số chấm không chia hết cho 3 (mặt 1, 2, 4, 5) là $P(\text{C II}) = \frac{4}{6} = \frac{2}{3}$.\\
        Xác suất bắt được gà mái:
        $$P(\text{Mái}) = P(\text{C I})P(\text{Mái} \mid \text{C I}) + P(\text{C II})P(\text{Mái} \mid \text{C II}) = \frac{1}{3} \cdot \frac{5}{7} + \frac{2}{3} \cdot \frac{3}{8} = \frac{5}{21} + \frac{1}{4} = \frac{41}{84} \approx 0,488.$$
        Làm tròn đến hàng phần trăm ta được $0,49$.
    }
    \dotlineEX{1}
\end{ex}
\begin{ex}%[143814] [MĐ2]
    Có 2 hộp áo; hộp một có 10 áo trong đó có 1 phế phẩm; hộp hai có 8 áo trong đó có 2 phế phẩm. Lấy ngẫu nhiên 1 áo từ hộp một bỏ sang hộp hai; sau đó từ hộp này chọn ngẫu nhiên ra 2 áo. Gọi $p$ là xác suất để cả 2 áo này đều là phế phẩm. Tính $\frac{1}{p}$.
    \shortans{$30$}
    \loigiai{
        Xác suất chuyển 1 áo phế phẩm từ hộp một sang hộp hai là $\frac{1}{10}$. Khi đó hộp hai có 3 phế phẩm, 6 áo tốt (tổng 9). Xác suất lấy ra 2 phế phẩm là $\frac{C_3^2}{C_9^2} = \frac{3}{36}$.\\
        Xác suất chuyển 1 áo tốt là $\frac{9}{10}$. Khi đó hộp hai có 2 phế phẩm, 7 áo tốt. Xác suất lấy ra 2 phế phẩm là $\frac{C_2^2}{C_9^2} = \frac{1}{36}$.\\
        Xác suất $p$:
        $$p = \frac{1}{10} \cdot \frac{3}{36} + \frac{9}{10} \cdot \frac{1}{36} = \frac{3+9}{360} = \frac{12}{360} = \frac{1}{30}.$$
        Vậy $\frac{1}{p} = 30$.
    }
\end{ex}
\begin{ex}%[378722] [MĐ3]
...
\end{ex}
\begin{ex}%[143815] [MĐ3]
    Một chiếc máy bay có thể xuất hiện ở vị trí A với xác suất $\frac{2}{3}$ và ở vị trí B với xác suất $\frac{1}{3}$. Người ta đặt 3 khẩu súng ở vị trí A và 1 khẩu súng ở vị trí B. Biết rằng xác suất bắn trúng máy bay của mỗi khẩu pháo là 0,7 và các khẩu pháo hoạt động độc lập với nhau, tính xác suất máy bay rơi, biết rằng máy bay sẽ rơi nếu bị bắn trúng. Viết kết quả làm tròn đến hàng phần trăm.
    \shortans{$0,88$}
    \loigiai{
        Nếu máy bay ở A (xác suất $\frac{2}{3}$): Bị bắn bởi 3 khẩu. Xác suất trượt cả 3 là $(1 - 0,7)^3 = 0,3^3 = 0,027$. Xác suất rơi là $1 - 0,027 = 0,973$.\\
        Nếu máy bay ở B (xác suất $\frac{1}{3}$): Bị bắn bởi 1 khẩu. Xác suất rơi là $0,7$.\\
        Xác suất máy bay rơi:
        $$P = \frac{2}{3} \cdot 0,973 + \frac{1}{3} \cdot 0,7 = \frac{1,946 + 0,7}{3} = \frac{2,646}{3} = 0,882.$$
...
\begin{ex}%[143813] [MĐ3]
    ...
    \shortans{$0,9$}
    \loigiai{
        Xác suất chuyển 1 sản phẩm tốt từ hộp thứ nhất sang hộp thứ hai là $\frac{9}{10}$. Khi đó hộp thứ hai có 19 tốt, 2 xấu (tổng 21). Xác suất lấy được sản phẩm tốt là $\frac{19}{21}$.\\
        Xác suất chuyển 1 sản phẩm xấu là $\frac{1}{10}$. Khi đó hộp thứ hai có 18 tốt, 3 xấu (tổng 21). Xác suất lấy được sản phẩm tốt là $\frac{18}{21}$.\\
        Xác suất cần tìm:
        $$P = \frac{9}{10} \cdot \frac{19}{21} + \frac{1}{10} \cdot \frac{18}{21} = \frac{171 + 18}{210} = \frac{189}{210} = \frac{9}{10} = 0,9.$$
    }
    \dotlineEX{2}
\end{ex}
\begin{ex}%[145259] [MĐ3]
    ...
    \shortans{$0,59$}
    \loigiai{
        Xác suất chuyển 1 viên bi đỏ từ hộp thứ nhất là $\frac{5}{10} = 0,5$. Hộp thứ hai sẽ có 7 đỏ, 4 xanh (tổng 11). Xác suất rút được bi đỏ là $\frac{7}{11}$.\\
        Xác suất chuyển 1 viên bi xanh từ hộp thứ nhất là $\frac{5}{10} = 0,5$. Hộp thứ hai sẽ có 6 đỏ, 5 xanh (tổng 11). Xác suất rút được bi đỏ là $\frac{6}{11}$.\\
        Xác suất cần tìm:
        $$P = 0,5 \cdot \frac{7}{11} + 0,5 \cdot \frac{6}{11} = \frac{13}{22} \approx 0,5909.$$
...
\begin{ex}%[145233] [MĐ3]
    ...
    \loigiai{
        ...
        $$P(N|C) = \frac{P(N \cap C)}{P(C)} = \frac{0,28}{0,58} = \frac{14}{29} \approx 0,4827.$$
