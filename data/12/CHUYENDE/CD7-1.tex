...
}
{
    \begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round, >=stealth]
        ...
        \foreach \x/\g in {A/160,B/-145,C/-45,D/0,S/90}\fill (\x) circle (1pt)+(\g:3mm) node[black]{$ \x $};
    \end{tikzpicture}
}
    \loigiai{
    ...
    \immini[thm]
{
    ...
    }
    {
        \begin{tikzpicture}[line join=round, line cap=round,>=stealth]
            ...
            \draw (S)--(A)--(B)--(C)--(S)--(B);
            \draw[dashed] (A)--(C);
            \foreach \x/\g in {A/180,B/-90,C/0,S/180}\fill (\x) circle (1pt)+(\g:3mm) node{$\x$};
        \end{tikzpicture}
    }
   \loigiai{
       \immini[thm]{
...
}
{
    \begin{tikzpicture}[line join=round, line cap=round,>=stealth]
        ...
        \foreach \x/\g in {A/130,B/0,C/-90,D/-90,O/-120,S/90,H/10}\fill (\x) circle (1pt)+(\g:3mm) node{$\x$};
    \end{tikzpicture}
}
   \loigiai{
       \immini[thm]{
    ...
    \immini[thm]
{
    ...
    }
    {
        \begin{tikzpicture}[line join=round, line cap=round, >=stealth]
            ...
            \draw[dashed](B)--(D);
            \foreach \i/\g in {A/0,B/180,C/190,D/0,M/150,N/0}{\fill(\i) circle (1.5pt) ($(\i)+(\g:3mm)$) node[scale=1]{$\i$};}
        \end{tikzpicture}
    }
   \loigiai{
       \immini[thm]{Vì $M$, $N$ lần lượt là trung điểm của $AB$, $AC$ nên $MN$ là đường trung bình
       ...
       {\begin{tikzpicture}[scale=.7, font=\small, line join=round, line cap=round, >=stealth]
               ...
               \draw(A)--(B) (A)--(C) (A)--(D) (A)--(B) (B)--(C)--(D)  (M)--(N);
               \draw[dashed](B)--(D);
               \foreach \i/\g in {A/90,B/180,C/-90,D/0,M/150,N/0}{\fill(\i) circle (1.5pt) ($(\i)+(\g:3mm)$) node[scale=1]{$\i$};}
       \end{tikzpicture}}
   }
\end{ex}
...
%    \loigiai{
%        \immini[thm]{Góc tạo bởi $SC$ và $(ABC)$ là $\widehat{SCA}$.\\
...
\begin{ex}%[1H8H5-3]
    ...
    }
    {
        \begin{tikzpicture}[line join=round, line cap=round]
            ...
            \draw[dashed](A)--(D);
            \foreach \i/\g in {B/90,A/180,C/-90,D/0}{\fill(\i) circle (1.5pt) ($(\i)+(\g:3mm)$) node[scale=1]{$\i$};}
        \end{tikzpicture}
    }
    %    \loigiai{
        %        \immini[thm]{
...
}
{
    \begin{tikzpicture}[>=stealth,line join=round,line cap=round]
        ...
        \foreach \i/\g in {S/90,A/180,B/-90,C/-60,D/30,H/30,O/-90}{\fill(\i) circle (1.5pt) ($(\i)+(\g:3mm)$) node[scale=1]{$\i$};}
    \end{tikzpicture}
}
%    \loigiai{
%        \begin{center}
...
\immini[thm]
{
    ...
    {Độ dài $SO=a \sqrt{5}$}
    {\True $BD\perp(SAC)$}
    {$d(O,(SBC))=\dfrac{a\sqrt{2}}{2}$}
    {\True $d(BD,SC)=\dfrac{a \sqrt{30}}{5}$}
}
{
    \begin{tikzpicture}[line join = round, line cap = round,]
        \path
...
}
{
    \begin{tikzpicture}[>=stealth,line join=round,line cap=round,
        ...
        \foreach \i/\g in {A/180,B/-90,C/-90,D/0,A'/90,C'/90,D'/90,B'/180,H/90,O/90}{\fill(\i) circle (1pt) ($(\i)+(\g:3mm)$) node[scale=1]{$\i$};}
    \end{tikzpicture}
}
%    \loigiai{
%        \begin{center}
...
}
{
    \begin{tikzpicture}[>=stealth,line join=round,line cap=round,
        ...
        \foreach \i/\g in {A/180,B/-90,C/-90,D/0,A'/90,C'/90,D'/90,B'/180,O/90}{\fill(\i) circle (1pt) ($(\i)+(\g:3mm)$) node[scale=1]{$\i$};}
    \end{tikzpicture}
}
...
}
{
    \begin{tikzpicture}[line join=round, line cap=round]
        ...
        \foreach \i/\g in {A/180,B/-90,C/0,A'/180,B'/-50,C'/0,M/-50}{\fill(\i) circle (1.0pt) ($(\i)+(\g:3mm)$) node[scale=1]{$\i$};}
    \end{tikzpicture}
}
%    \loigiai{
%        \begin{center}
    ...
    \loigiai{
        \begin{center}
            \begin{tikzpicture}[line join=round,line cap=round,>=stealth,font=\small,scale=.8]
                ...
                \foreach \i/\g in {S/90,A/140,B/180,C/-45,D/0,O/50,H/150,K/70}{\fill(\i) circle (1.5pt) ($(\i)+(\g:4mm)$) node[scale=1]{$\i$};}
            \end{tikzpicture}
        \end{center}
    ...
    \loigiai{
        \begin{center}
            \begin{tikzpicture}[line join=round,line cap=round,>=stealth,font=\small,scale=1]
                ...
                \foreach \i/\g in {S/90,A/180,B/-115,C/-45,D/0,M/90,H/-110}{\fill(\i) circle (1.5pt) ($(\i)+(\g:4mm)$) node[scale=1]{$\i$};}
            \end{tikzpicture}
            \begin{tikzpicture}[line join=round,line cap=round,>=stealth,font=\small,scale=1]
                \coordinate (A) at (0,0);
                \coordinate (B) at (0,-4);
                ...
                \foreach \i/\g in {A/150,B/-115,C/-45,D/0,M/90,H/-45,I/90,K/90}{\fill(\i) circle (1.5pt) ($(\i)+(\g:4mm)$) node[scale=1]{$\i$};}
            \end{tikzpicture}
        \end{center}
        ...
        \begin{center}
            \begin{tikzpicture}[declare function={a=2.65;b=4.5;h=3;},line join=round]
                ...
                \foreach \t/\g in {A/160,B/-90,C/-90,D/0,S/90,H/-90,K/90,E/-90,F/180}{
                    \fill (\t) circle (1pt) node[shift={(\g:7pt)},font=\small]{$ \t $};
                }
            \end{tikzpicture}
        \end{center}
...
\begin{ex}%[1H8V5-4]
    ...
    \shortans{0,77}
    \loigiai{
        \immini[thm]{Dựng $D$ sao cho $BD\parallel  OM$ và $OM$ là đường trung bình của tam giác $BCD$.\\
        ...
        \begin{center}
            \begin{tikzpicture}[scale=1, font=\small, line join=round, line cap=round, >=stealth]
                \foreach \x/\y/\z/\t in {A/0/0/180,B/4/0/-90,C/2.5/-1.5/-90,D/8/0/0,A'/0/4/90,B'/4/4/90,C'/2.5/2.5/90} {
                    \coordinate (\x) at (\y,\z);
                    \fill (\x) circle (1pt) ($(\x)+(\t:3mm)$) node {$\x$};
                }
                \coordinate (K) at ($(C)!0.5!(D)$);
                \coordinate (H) at ($(B')!0.7!(K)$);
                \foreach \x/\y in {K/-80,H/0} {\fill (\x) circle (1pt) ($(\x)+(\y:3mm)$) node {$\x$};}
    ...
    \loigiai{
        \begin{center}
            \begin{tikzpicture}[line join=round, line cap=round,>=stealth,font=\small,scale=0.6]
                ...
                \foreach \i/\g in {A/-90,B/-90,C/-0,D/-90,A'/180,B'/90,C'/90,D'/90,O/-90,M/0}{\fill(\i) circle (1pt) ($(\i)+(\g:3mm)$) node[scale=1]{$\i$};}
            \end{tikzpicture}
        \end{center}
