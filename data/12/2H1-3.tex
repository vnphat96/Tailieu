...
\begin{vd}%Ví dụ 1%[Nguyễn Diệu Linh]%[2H1B3-3]
	...
	\loigiai{
	\immini[thm]{	Ta có $\triangle ABC$ vuông cân tại $A$ nên $AB=AC=a$.\\
...
\begin{vd}%Ví dụ 2%[Nguyễn Diệu Linh]%[2H1B3-3]
	...
	\loigiai{
\immini[thm]{	$ABCD.A'B'C'D'$ là lăng trụ đứng nên $BD^2=BD'^2-DD'^2=9a^2$\\$\Rightarrow BD=3a$.\\
...
\begin{vd}%Ví dụ 3%[Nguyễn Diệu Linh]%[2H1B3-3]
	...
	\loigiai{
\immini[thm]{	Gọi $I$ là trung điểm $BC$. Ta có $\triangle ABC$ đều nên $AI=\dfrac{AB\sqrt{3}}{2}=2\sqrt{3}$ và $AI\perp BC$\\$\Rightarrow A'I\perp BC$ (định lý 3 đường vuông góc).\\
...
\begin{vd}%Ví dụ 5%[Nguyễn Diệu Linh]%[2H1B3-3]
	...
	\loigiai{
\immini[thm]{	Ta có $\triangle ABD$ đều nên: $BD=a$ và $S_{ABCD}=2S_{ABD}=\dfrac{a^2\sqrt{3}}{2}$.\\
...
\begin{vd}%Ví dụ 1%[Nguyễn Diệu Linh]%[2H1B3-3]
	...
	\loigiai{
	\immini[thm]{	Ta có $AA'\perp(ABC)\Rightarrow AA'\perp AB$ và $AB$ là hình chiếu của $A'B$ trên đáy $ABC$.\\
...
\begin{vd}%Ví dụ 2%[Nguyễn Diệu Linh]%[2H1B3-3]
	...
	\loigiai{
	\immini[thm]{	Xét $\triangle ABC$ vuông tại $A$ $\Rightarrow AB=AC\cdot\tan 60^{\circ}=a\sqrt{3}$.\\
...
\begin{vd}%Ví dụ 3%[Nguyễn Diệu Linh]%[2H1B3-3]
	...
	\loigiai{
\immini[thm]{	Ta có $ABCD.A'B'C'D'$ là lăng trụ đứng nên ta có: $DD'\perp(ABCD)$\\
...
\begin{vd}%Ví dụ 1%[Nguyễn Diệu Linh]%[2H1B3-3]
	...
	\loigiai{
	\immini[thm]{	Ta có $AA'\perp(ABC)$ và $BC\perp AB$\\$\Rightarrow BC\perp A'B$ \\ $\Rightarrow \left((A'BC);(ABC)\right)=\widehat{ABA'}=60^{\circ}$.\\
...
\begin{vd}%Ví dụ 2%[Nguyễn Diệu Linh]%[2H1K3-3]
	...
	\loigiai{
	\immini[thm]{	$\triangle ABC$ đều $\Rightarrow AI\perp BC$ mà $AA'\perp(ABC)$ nên $A'I\perp BC$.\\
...
\begin{vd}%Ví dụ 3%[Nguyễn Diệu Linh]%[2H1B3-3]
	...
	\loigiai{
	\immini[thm]{Gọi $O$ là tâm $ABCD$. Ta có $ABCD$ là hình vuông nên $OC\perp BD$ và $CC'\perp(ABCD)$ nên $OC'\perp BD$. \\Vậy $\left((BDC');(ABCD)\right)=\widehat{C'OC}=60^{\circ}$.\\
		$S_{ABCD}=a^2$.\\
...
\begin{vd}%Ví dụ 4%[Nguyễn Diệu Linh]%[2H1K3-3]
	...
	\loigiai{
	\immini[thm]{	Ta có $AA'\perp (ABCD)$\\$\Rightarrow AC$ là hình chiếu của $A'C$ trên $(ABCD)$.\\
...
\begin{vd}%[2H1K3-2]%Ví dụ 2.
	...
	\loigiai{
		\immini[thm]{Hạ $SH\perp (ABC)$, Kẻ $HE\perp B,HF\perp BC,HJ\perp AC$.\\
...
\begin{vd}%[2H1B3-2]%Ví dụ 4.
	...
	\loigiai{
		\immini[thm]{Hình lập phương được chia thành khối $ACB'D'$ và bốn khối $CB'D'C'$, $BB'AC$, $D'ACD$, $AB'A'D'$.\\
