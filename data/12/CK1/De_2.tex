...
\begin{ex}%[Dự án TL12New-4in1-NCT]%[2D1H4-1]
	\immini[thm]{Cho hàm số $f(x)$ có đồ thị như hình vẽ bên. Tiệm cận đứng và tiệm cận ngang của đồ thị hàm số lần lượt là
		\choice
		{$x=1$ và $y=-2$}
		{\True $x=-1$ và $y=2$}
		{$x=1$ và $y=2$}
...
\begin{ex}%[2H2V1-3] 2
	...
	\loigiai{
		+ Nắm vững khái niệm ba vectơ đồng phẳng} \end{ex}
