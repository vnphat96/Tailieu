...
Trong không gian $Oxyz$, cho đường thẳng $\Delta$ đi qua điểm $M(x_0;y_0;z_0)$ và có vectơ chỉ phương $\vec{u}=(a;b;c)$ và $abc\ne 0$. Khi đó hệ phương trình nào sau đây là phương trình chính tắc của đường thẳng $\Delta$?
\choice
...
Trong không gian $Oxyz$, cho mặt phẳng $(P)\colon x-2y-3z-2=0$. Đường thẳng $d$ vuông góc với mặt phẳng $(P)$ có một vectơ chỉ phương là
\choice
...
\loigiai
{
Ta có $(P)\colon x-2y-3z-2=0$, suy ra một vectơ pháp tuyến của $(P)$ là $\overrightarrow{u}_{2}=(1;-2;-3)$.
}
\end{ex}
...
% \shortans{$125$}
\loigiai{
Ta có vectơ chỉ phương của $d_1$ là $\overrightarrow{u_1} = (-3; 1; 2)$ và vectơ chỉ phương của $d_2$ là $\overrightarrow{u_2} = (2; 5; 3)$.\\
Do $d \perp d_1$ và $d \perp d_2$ nên vectơ chỉ phương của $d$ là $\overrightarrow{u} =\left[\overrightarrow{u_1}, \overrightarrow{u_2}\right] = (-7; 13; -17)$.\\
