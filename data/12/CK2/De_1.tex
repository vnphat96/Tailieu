...
Do $IA^2+IB^2+3IC^2$ không đổi nên $S$ đạt giá trị nhỏ nhất khi và chỉ khi $MI$ đạt giá trị nhỏ nhất. Tức là $M$ là hình chiếu của $I$ lên mặt phẳng $(P)\colon 3x-3y-2z-12=0$ Suy ra $\overrightarrow{IM}$ cùng phương với vectơ chỉ phương pháp tuyến $\overrightarrow{n}=(3;-3;-2)$ của $(P)$.\\
