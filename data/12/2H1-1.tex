...
\textbf{a. Phép tịnh tiến theo vectơ $\overrightarrow{v}$} 
\immini[thm]{
...
\begin{vd}%Ví dụ 5.%[2H1B1-2]
	...
	\begin{center}
		...
		\def\x{4}; % Xác định tọa độ của vectơ tịnh tiến các hình (x,y)
		\def\y{2};
		\def\z{-2};
		% Vẽ hình 1
		...
		\draw (b) --(d)--(d');
		% Vẽ hình 2 tịnh tiến từ một phần của hình 1 theo vectơ (x,y)
...
\end{center}
	...
	{hình (d)}
	\loigiai{
		Nhận thấy tọa độ điểm $M$ thỏa mãn PTĐT $d$.}
\end{ex}
...
\begin{vd}%[BCO Tuan, dự án DCHT]%[2H1B1-4]%Ví dụ 3.
	Trong không gian cho hai vectơ $\vec{u}$ và $\vec{v}$. Với $M$ là điểm bất kỳ, ta gọi $M_1$ là ảnh của $M$ qua phép $T_{\vec{u}}$ và $M_2$ là ảnh của $M_1$ qua phép $T_{\vec{v}}$. Tìm phép biến hình biến điểm $M$ thành đểm $M_2$.
	\loigiai{
		...
		Như vậy, phép biến hình biến điểm $M$ thành điểm $M_2$ là phép tịnh tiến theo vectơ $\vec{u}+\vec{v}$.}
\end{vd}
\begin{vd}%[BCO Tuan, dự án DCHT]%[2H1B1-4]%Ví dụ 4.
	...
	\loigiai{
		...
		Lấy $2$ điểm phân biệt $A$, $B$ cố định tùy ý thuộc đường thẳng. Khi đó phép tịnh tiến theo vectơ $\vec{AB}$ biến đường thẳng thành chính nó.}
\end{vd}
...
\begin{ex}%[BCO Tuan, dự án DCHT]%[2H1B1-4]%Câu 1.
	...
	\loigiai{
		...
		Lấy $A \in d$ và $A' \in d'$ thì phép tịnh tiến theo vectơ $\vec{AA'}$ biến $d$ thành $d'$.	
	}
\end{ex}
...
\begin{ex}%[BCO Tuan, dự án DCHT]%[2H1B1-4]%Câu 3.
	...
	\loigiai{
		\immini
		{
			...
			Khi đó phép tịnh tiến theo vectơ $\vec{u}=\vec{A’A}$ biến $\Delta A’B’C’$ thành $\Delta ABC$ và phép tịnh tiến theo vectơ $\vec{v}=\vec{A’A}$ biến $\Delta A’B’C’$ thành $\Delta ABC$. Như vậy chỉ có hai phép tịnh tiến biến tam giác này thành tam giác kia.
		}
		{
...
\begin{ex}%[BCO Tuan, dự án DCHT]%[2H1B1-4]%Câu 4.
	Cho hình lập phương $ABCD. A’B’C’D’$. Gọi $I$, $J$ lần luợt là trung điểm của các cạnh $AD$, $BC$. Phép tịnh tiến theo vectơ $\vec{u}=\dfrac{1}{2}\vec{AD}$ biến tam giác $A’IJ$ thành tam giác
	\choice
	{$C’CD$}
	...
	\loigiai{
		\immini[thm]{
			Gọi $\mathrm{T}$ là phép tịnh tiến theo vectơ $\vec{u} = \dfrac{1}{2} \vec{AD}$. \\
...
\begin{ex}%[BCO Tuan, dự án DCHT]%[2H1B1-4]%Câu 8.
	...
	\loigiai{
		\immini[thm]{
			...
			Vậy $M_2$ là ảnh của $M$ qua phép tịnh tiến theo vectơ $\vec{u} = 2 \vec{IJ}$.
		}{
...
\begin{ex}%[BCO Tuan, dự án DCHT]%[2H1B2-3]%Câu 10.
	...
	{$3$}
	{\True $4$}
	\loigiai{\immini[thm]{Hình chóp tứ giác đều có bốn mặt đối xứng đó là $(SAC)$, $(SBD)$, $(SMN)$ và $(SIJ)$ với $M$, $N$, $I$, $J$ lần lượt là trung điểm của $AB$, $CD$, $AD$, $BC$.}
...
\begin{ex}%[BCO Tuan, dự án DCHT]%[2H1B1-4]%Câu 11.
	...
	{$DB’$}
	{$AC’$}
	\loigiai{\immini[thm]{Ta có $\text{Đ}_O(A')=C$, $\text{Đ}_O(B)=D'$. Do đó $\text{Đ}_O(A'B)=CD'$.
		}{\begin{tikzpicture}[scale=.7, line join = round, line cap = round]
			\tikzset{label style/.style={font=\footnotesize}}
...
\begin{ex}%[BCO Tuan, dự án DCHT]%[2H1B1-4]%Câu 13.
	...
	{$2$}
	{\True $3$}
	\loigiai{\immini[thm]{Tứ diện đều $ABCD$ có ba trục đối xứng đó là ba đường thẳng đi qua trung điểm của cặp cạnh đối diện.\\Thật vậy, gọi $I$, $K$ lần lượt là trung điểm của $AB$, $CD$.\\ Khi đó $\text{Đ}_{IK}(A)=B$, $\text{Đ}_{IK}(C)=D$ nên $\text{Đ}_{IK}(AC)=BD$ hay $\text{Đ}_{IK}(ABCD)=BADC$.
		}{\begin{tikzpicture}[scale=0.7, line join = round, line cap = round]
			\tikzset{label style/.style={font=\footnotesize}}
