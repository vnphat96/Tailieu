...
\end{ex}
\begin{ex}%[2D1G2-2]
    \immini[thm]{Cho hàm số $ y=f(x) $ có đạo hàm liên tục trên $ \mathbb{R} $. Đồ thị hàm số $ y=f'(x) $ như hình vẽ bên. Xét hàm số $ g(x)=f(x)+x^2-2x $. Mệnh đề nào sau đây đúng?
        \choice
    ...
    \loigiai{\immini[thm]{$ g'(x)=f'(x)+2x-2 $. Cho $ g'(x)=0 \Leftrightarrow f'(x)=2-2x $.\\
