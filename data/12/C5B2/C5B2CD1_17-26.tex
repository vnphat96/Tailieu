...
\begin{dang}{GÓC GIỮA HAI ĐƯỜNG THẲNG}
	...
	Cho đường thẳng $\Delta $ có vectơ chỉ phương $\overrightarrow {u}=(a;b;c)$ và mặt phẳng $(P)$ có vectơ pháp tuyến $\overrightarrow {n}=(A; B; C)$. Khi đó, ta có
	...
	Cho hai mặt phẳng $(P_1)$, $(P_2)$ có hai vectơ pháp tuyến lần lượt là \break  $\overrightarrow{n_1}=(A_1;B_1;C_1)$, $ \overrightarrow{n_2}=(A_2;B_2;C_2)$. Khi đó, ta có
