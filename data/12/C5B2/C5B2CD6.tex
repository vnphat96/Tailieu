...
Trong KG $Oxyz$, cho mặt phẳng $(P)\colon 4x-7y+z+25=0$ và đường thẳng $d_1\colon\dfrac{x+1}{1}=\dfrac{y}{2}=\dfrac{z-1}{-1}$. Gọi $d_1'$ là hình chiếu vuông góc của $d_1$ lên mặt phẳng $(P)$. Đường thẳng $d_2$ nằm trong $(P)$ tạo với $d_1$, $d_1'$ các góc bằng nhau, $d_2$ có véc-tơ chỉ phương $\overrightarrow{u}_2=(a;b;c)$. Tính $\dfrac{a+2b}{c}$.
\choice
