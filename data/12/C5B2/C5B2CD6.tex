...
Trong không gian $Oxyz$, cho điểm $A(-2;0;1)$, đường thẳng $d$ qua điểm $A$ và tạo với trục $Oy$ góc $45^\circ$. PTĐT $d$ là
\choice
...
Trong không gian $Oxyz$, cho mặt phẳng $(P)\colon 4x-7y+z+25=0$ và đường thẳng $d_1\colon\dfrac{x+1}{1}=\dfrac{y}{2}=\dfrac{z-1}{-1}$. Gọi $d_1'$ là hình chiếu vuông góc của $d_1$ lên mặt phẳng $(P)$. Đường thẳng $d_2$ nằm trong $(P)$ tạo với $d_1$, $d_1'$ các góc bằng nhau, $d_2$ có vectơ chỉ phương $\overrightarrow{u}_2=(a;b;c)$. Tính $\dfrac{a+2b}{c}$.
\choice
...
\end{ex}
\begin{ex}%[Câu 1]%[2H5H2-7]
	Trong không gian $Oxyz$, cho hai đường thẳng $d_1\colon \dfrac{x-1}{2}=\dfrac{y-2}{-2}=\dfrac{z+1}{-1}$,  $d_2\colon \heva{&x=t \\&y=0 \\&z=-t}$. Mặt phẳng $(P)$ qua $d_1$ tạo với $d_2$ một góc $45^\circ$ và nhận vectơ $\vec{n}=(1;b;c)$ làm một vectơ pháp tuyến. Xác định tích $b\cdot c$.
	\choice
	{$-4$ hoặc $0$}
	{$4$ hoặc $0$}
	{\True $-4$}
...
\begin{ex}%[Câu 3]%[2H5H2-7]
	Trong không gian $Oxyz$, cho đường thẳng $d\colon \heva{&x=0 \\&y=3-t \\&z=t}$. Gọi $(P)$ là mặt phẳng chứa đường thẳng $d$ và tạo với mặt phẳng $(Oxy)$ một góc $45^\circ$. Điểm nào sau đây thuộc mặt phẳng $(P)$?
	\choice
	{\True $M(3;2;1)$}
	{$N(3;2;-1)$}
	{$P(3;-1;2)$}
...
\begin{ex}%[Câu 5]%[2H5H2-7]
	Trong không gian $Oxyz$, mặt phẳng nào dưới đây đi qua $A(2; 1; - 1)$ tạo với trục $Oz$ một góc $30^\circ $?
	\choice
...
\begin{ex}%[Câu 9]%[2H5H2-7]
	Trong không gian $Oxyz$, cho điểm $A(3;-1;0)$ và đường thẳng $d\colon \dfrac{x-2}{-1}=\dfrac{y+1}{2}=\dfrac{z-1}{1}$. Phương trình mặt phẳng $(\alpha)$ chứa $d$ sao cho khoảng cách từ $A$ đến $(\alpha)$ lớn nhất có dạng $ax+by+cz=0$. Khi đó $\dfrac{a}{b}$ bằng
	\shortans{$1$}
	\loigiai{
...
\begin{ex}%[Câu 10]%[2H5H1-6]
	Trong không gian $Oxyz$, cho hai mặt phẳng $(P)\colon x+2y-2z+1=0,$ $(Q)\colon x+my+(m-1)z+2024=0$. Khi hai mặt phẳng $(P)$, $(Q)$ tạo với nhau một góc nhỏ nhất thì giá trị của $m$ bằng bao nhiêu?
	\shortans{$0{,}5$}
	\loigiai{
...
\begin{ex}%[Câu 13]%[2H5V1-6]
	Trong không gian $Oxyz$, biết mặt phẳng $(P)\colon ax+by+cz+d=0$ với $c<0$ đi qua hai điểm $A(0;1;0)$, $B(1;0;0)$ và tạo với mặt phẳng $(yOz)$ một góc $60^\circ $. Tính giá trị $a+b+c$. (Kết quả lấy đến hàng phần chục)
	\shortans{$0{,}6$}
	\loigiai{
...
\begin{ex}%[Câu 15]%[2H5H2-6]
	Trong không gian $Oxyz$, cho đường thẳng $\mathrm{d}\colon\dfrac{x-3}{-2}=\dfrac{y}{-1}=\dfrac{z-1}{1}$ và điểm $A(2;-1;0)$. Khoảng cách từ điểm $A$ đến đường thẳng $d$ bằng
	\choice
	{$\sqrt{7}$}
	{$\dfrac{\sqrt{7}}{2}$}
...
\begin{ex}%[Câu 18]%[2H5H2-6]
	Trong không gian $Oxyz$, cho mặt phẳng $(P)\colon 2x-2y-z+1=0$ và đường thẳng $\Delta\colon\dfrac{x-1}{2}=\dfrac{y+2}{1}=\dfrac{z-1}{2}$. Tính khoảng cách $\mathrm{d}$ giữa $\Delta $ và $(P)$.
	\choice
	{\True $\mathrm{d}=2$}
	{$\mathrm{d}=\dfrac{5}{3}$}
	{$\mathrm{d}=\dfrac{2}{3}$}
...
\begin{ex}%[Câu 11]%[2H5C2-6]
	Trong không gian $Oxyz$, cho đường thẳng $d\colon \dfrac{x-3}{2}=\dfrac{y+2}{1}=\dfrac{z+1}{-1}$, mặt phẳng $(P)\colon x+y+z+2=0$. Gọi $M$ là giao điểm của $d$ và $(P)$, $\Delta$ là đường thẳng nằm trong mặt phẳng $(P)$ vuông góc với $d$ và cách $M$ một khoảng bằng $\sqrt{42}$. PTĐT $\Delta$ là
	\choice
