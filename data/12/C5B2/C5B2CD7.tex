\begin{dang}{VTTĐ của ĐT và MP}

\end{dang}
\begin{ex}%[2H5H2-5]
Trong không gian $Oxyz$, cho đường thẳng $\Delta:\dfrac{x-2}{-3}=\dfrac{y}{1}=\dfrac{z+1}{2}$. Gọi $M$ là giao điểm của $\Delta$ với mặt phẳng $(P): x+2y-3z+2=0$. Tọa độ điểm $M$ là
\choice
{$M(2;0;-1)$}
{$M(5;-1;-3)$}
{$M(1;0;1)$}
...
\begin{ex}%[2H5H2-5]
Trong không gian $Oxyz$, cho $3$ điểm $A(1;0;0)$, $B(0;2;0)$, $C(0;0;3)$ và $d\colon\heva{&x=-t\\&y=2+t\\&z=3+t}$. Gọi $M(a;b;c)$ là tọa độ giao điểm của đường thẳng $d$ và mặt phẳng $(ABC)$. Tổng $S=a+b+c$ là
\choice
{$-7$}
{\True $11$}
{$5$}
...
\begin{ex}%[2H5H2-5]
Trong không gian $Oxyz$, cho đường thẳng $d: \dfrac{x+1}{1}=\dfrac{y}{-3}=\dfrac{z-5}{-1}$ và mặt phẳng $(P): 3x-3y+2z+6=0$. Mệnh đề nào dưới đây đúng?
\choice
...
{$d$ nằm trong $(P)$}
\loigiai{
Đường thẳng $d$ có vectơ chỉ phương $\overrightarrow{u}=(1;-3;-1)$.\\
Mặt phẳng $(P)$ có vectơ pháp tuyến  $\overrightarrow{n}=(3;-3;2)$.\\
...
\begin{ex}%[2H5H2-5]
Trong không gian $Oxyz$, cho mặt phẳng $(P): 3x+5y-z-2=0$ và đường thẳng $d: \dfrac{x-12}{4}=\dfrac{y-9}{3}=\dfrac{z-1}{1}$. Trong các mệnh đề sau, mệnh đề nào đúng?
\choice
{$d\subset (Q)$}
{$d\parallel (Q)$}
{\True $d$ cắt $(Q)$}
{$d\perp (Q)$}
\loigiai{
  $(P): 3x+5y-z-2=0$ có vectơ pháp tuyến $\overrightarrow{n}=(3;5;-1)$.  \\
  $d: \dfrac{x-12}{4}=\dfrac{y-9}{3}=\dfrac{z-1}{1}$ có vectơ chỉ phương $\overrightarrow{u}=(4;3;1)$.  \\
...
{$d\perp (P)$}
\loigiai{
$(P): 3x-3y+2z-5=0$ có vectơ pháp tuyến là $\overrightarrow{n}=(3;-3;2)$.\\
$d$ có vectơ chỉ phương là $\overrightarrow{u}=(2;4;3)$.\\
...
$d$ có vectơ chỉ phương là $\overrightarrow{u}=(1;2;-3)$.\\
...
\begin{ex}%[2H5V2-5]
Trong không gian $Oxyz$, cho đường thẳng $\Delta:\dfrac{x}{-2}=\dfrac{y-2}{1}=\dfrac{z+1}{3}$ và mặt phẳng $(P):11x+my+nz-16=0$. Biết $\Delta\subset (P)$, tính giá trị của $T=m+n$.
\choice
{$T=2$}
{$T=-2$}
{\True $T=14$}
...
\loigiai{
	\begin{itemize}
		...
		$\Rightarrow T=m+n=14$.
		\item Cách $2$: Đường thẳng $\Delta$ đi qua $A(0;2;-1)$ có vectơ chỉ phương $\overrightarrow{u}=(-2;1;3)$.\\
		Mặt phẳng $(P)$ có vectơ pháp tuyến $\overrightarrow{n}=(11;m;n)$.\\
...
{\True $m=-1$}
\loigiai{
Một vectơ chỉ phương của $d$ là $\overrightarrow{u}=(1;-1;1)$; $A(1;-1;2)\in d$.\\
Một vectơ pháp tuyến của $(P)$ là $\overrightarrow{n}=\left(2;1;-m^2\right)$.
\begin{eqnarray*}
...
{\True $m\neq -1$}
\loigiai{
$(P)$ có vectơ pháp tuyến $\overrightarrow{n}=(2;m;-3)$.\\
$d$ có vectơ chỉ phương là $\overrightarrow{u}=(4;-1;3)$.\\
...
{$\emptyset$}
\loigiai{
Ta có $d$ đi qua $M(2;-3;1)$và có vectơ chỉ phương $\overrightarrow{u}=(-1;1;1)$.\\
Và $(P)$ có vectơ pháp tuyến $\overrightarrow{n}=(m^2;-2m;6-3m)$.\\
...
\loigiai{
Ta có
$\left(P_{m}\right):mx+2y+nz+1=0$ có vectơ pháp tuyến $\overrightarrow{n}_P=(m;2;n)$.\\
$\left(Q_{m}\right):x-my+nz+2=0$ có vectơ pháp tuyến $\overrightarrow{n}_Q=(1;-m;n)$.\\
$\left(\alpha\right):4x-y-6z+3=0$ có vectơ pháp tuyến $\overrightarrow{n}_{\alpha}=(4;-1;-6)$.\\
