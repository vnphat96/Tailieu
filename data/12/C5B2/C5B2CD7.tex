\begin{dang}{VỊ TRÍ TƯƠNG ĐỐI CỦA ĐƯỜNG THẲNG VỚI MẶT PHẲNG}
...
\begin{ex}%[2H5H2-5]
Trong không gian với hệ tọa độ $Oxyz$, cho $3$ điểm $A(1;0;0)$, $B(0;2;0)$, $C(0;0;3)$ và $d\colon\heva{&x=-t\\&y=2+t\\&z=3+t}$. Gọi $M(a;b;c)$ là tọa độ giao điểm của đường thẳng $d$ và mặt phẳng $(ABC)$. Tổng $S=a+b+c$ là
\choice
{$-7$}
{\True $11$}
{$5$}
...
\begin{ex}%[2H5H2-5]
Trong không gian với hệ tọa độ $Oxyz$, cho đường thẳng $d: \dfrac{x+1}{1}=\dfrac{y}{-3}=\dfrac{z-5}{-1}$ và mặt phẳng $(P): 3x-3y+2z+6=0$. Mệnh đề nào dưới đây đúng?
\choice
...
\begin{ex}%[2H5V2-5]
Trong không gian với hệ tọa độ $Oxyz$, cho đường thẳng $\Delta:\dfrac{x}{-2}=\dfrac{y-2}{1}=\dfrac{z+1}{3}$ và mặt phẳng $(P):11x+my+nz-16=0$. Biết $\Delta\subset (P)$, tính giá trị của $T=m+n$.
\choice
{$T=2$}
{$T=-2$}
{\True $T=14$}
