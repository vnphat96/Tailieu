...
%\end{luuy}
%
%\begin{dang}{Lập phương trình đường thẳng $\Delta$ dạng tham số và dạng chính tắc (nếu có)} 
%	\textbf{Phương pháp:} Đường thẳng $\Delta$ qua $M(x_0;y_0;z_0)$ và có vectơ chỉ phương $\overrightarrow{u}_\Delta=(a; b; c)$.\\
%	Phương trình tham số của $\Delta:\heva{&x=x_0+at \\&y=y_0+bt \\	&z=z_0+ct}$ $(t\in\mathbb{R})$.\\
%	Phương trình chính tắc của $\Delta: \dfrac{x-x_0}{a}=\dfrac{y-y_0}{b}=\dfrac{z-z_0}{c}$ $(a_1 a_2 a_3 \neq 0)$.
%\end{dang}
%
%\begin{dang}
%	{Lập phương trình tham số và chính tắc (nếu có) của đường thẳng $\Delta$ đi qua hai điểm $A$ và $B$.}
...
%
%\begin{dang}
%	{Viết phương trình đường thẳng $\Delta$ dạng tham số và chính tắc (nếu có), biết $\Delta$ đi qua điểm $M$ và song song với đường thẳng $d$.}
...
% 
%\begin{dang}
%	{Viết phương trình đường thẳng $\Delta$ qua $M$ và song song với hai mặt phẳng $(P),(Q)$.}
...
%
%\begin{dang}
%	{Viết phương trình đường thẳng $\Delta$ dạng tham số và chính tắc (nếu có), biết $\Delta$ đi qua điểm $M$ và vuông góc với mặt phẳng $(P): Ax+By+Cz+D=0$.}
...
\begin{ex}%[Dự án 2025_K12_TL TV]%[Phạm Thị Thanh Thủy]%[2H5N2-3]
	...
	{$\heva{&x=t \\
		...
		&z=0}$ $(t \in \mathbb{R})$}
	\loigiai{
	Đường thẳng $Oy$ đi qua điểm $A(0;2;0)$ và nhận véc-tơ đơn vị $\overrightarrow{j}=(0;1;0)$ làm véc-tơ chỉ phương nên có phương trình tham số là $\heva{&x=0\\&y=2+t \\&z=0}$ $(t \in \mathbb{R})$.
	}
\end{ex}
%%%==============EX_5============%%%
\begin{ex}%[Dự án 2025_K12_TL TV]%[Phạm Thị Thanh Thủy]%[2H5N2-3]
	...
	{\True $\heva{&x=0\\
			...
			&z=t
			&}$}
	\loigiai{Trục $Oz$ đi qua gốc tọa độ $O(0; 0; 0)$ và nhận véc-tơ đơn vị $\overrightarrow{k}=(0; 0; 1)$ làm véc-tơ chỉ phương nên có phương trình tham số $\heva{&x=0\\
			&y=0\\
			&z=t.}$
	}
\end{ex}
...
\begin{ex}%[Dự án 2025_K12_TL TV]%[Phạm Thị Thanh Thủy]%[2H5N2-3]
	...
	{\True $\heva{&x=t \\
			&y=0 \\
			&z=0&}$}
	\loigiai{Trục $Ox$ đi qua $O(0; 0; 0)$ và có véctơ chỉ phương $\overrightarrow{i}=(1; 0; 0)$ nên có phương trình tham số là
		$\heva{&x=0+1\cdot t \\
		&y=0+0t \\
...
\begin{ex}%[Dự án 2025_K12_TL TV]%[Phạm Thị Thanh Thủy]%[2H5H2-3]
	...
	\loigiai{
		...
		Vậy phương trình đường thẳng $\Delta$ đi qua $M(3; 2;-1)$ và có véc-tơ chỉ phương $\overrightarrow{u_{\Delta}}=(1; 0; 1)$ là		
		$\heva{	&x=3+t \\
			&y=2\\
			&z=-1+t.}$
	}
