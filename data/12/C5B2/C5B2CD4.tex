...
\TN
\begin{ex}%[2H5N2-7]
	\immini[thm]{Cho hình lập phương $ABCD.A'B'C'D'$ có cạnh bằng $a$, gọi $\alpha$ là góc giữa đường thẳng $A'B$ và mặt phẳng $(BB'D'D)$. Chọn hệ trục tọa độ $Oxyz$ như hình vẽ, tính $\sin \alpha$.
		\choice[2]
		{$\dfrac{\sqrt{3}}{5}$}
		{$\dfrac{\sqrt{3}}{2}$}
		{\True $\dfrac{1}{2}$}
...
\begin{ex}%[2H5V2-7]%[Dự án 2025-K12-TL-TV]%[Thành Đức Trung]
	...
	\loigiai
	{
		...
		Mặt phẳng $\left(SAC\right)$ có vectơ pháp tuyến $\overrightarrow{n}_1 = \left(-1;1;0\right)$. \\
		Mặt phẳng $\left(SBC\right)$ có vectơ pháp tuyến $\overrightarrow{n}_2 = \left(1;0;1\right)$.\\
		Suy ra
...
\begin{ex}%[2H5V2-7]%[Dự án 2025-K12-TL-TV]%[Thành Đức Trung]
	...
	\loigiai
	{
		...
		\begin{itemize}
			...
			Một vectơ pháp tuyến của $\left(SBC\right)$ là $\overrightarrow{n}_1 = \left(2;0;1\right)$.
			...
			Một vectơ pháp tuyến của $\left(AMC\right)$ là $\overrightarrow{n}_2 = \left(2;-2;1\right)$.
		\end{itemize}
		Suy ra 
...
\begin{ex}%[2H5C4-1]%[Dự án 2025-K12-TL-TV]%[Thành Đức Trung]
	...
	{$\cos \alpha=\dfrac{1}{2}$}
	\loigiai
	{\immini[thm]{Chọn $AB=2 \Rightarrow BD=2; AC=2\sqrt{3}$, đặt
			$AA'=h$.\\
...
\begin{ex}%[2H5C4-1]%[Dự án 2025-K12-TL-TV]%[Thành Đức Trung]
	...
	{Gọi $O, M$ lần lượt là trung điểm của $AB, CD$.\\ Vì mặt bên $(SAB)$ là tam giác đều và vuông góc với $(ABCD)$ nên $SO \perp(ABCD)$.
		\immini[thm]{Xét hệ trục $Oxyz$ có $O(0 ; 0 ; 0), M(1 ; 0 ; 0), A\left(0 ; \dfrac{1}{2} ; 0\right)$,\\ $S\left(0 ; 0 ; \dfrac{\sqrt{3}}{2}\right), C\left(1 ; \dfrac{-1}{2} ; 0\right), D\left(1 ; \dfrac{1}{2} ; 0\right)$.\\
		...
		\end{tikzpicture}}\noindent
		Mặt phẳng $(SAC)$ có vectơ pháp tuyến $\overrightarrow{n_1}=[\overrightarrow{S A}, \overrightarrow{AC}]=\left(\dfrac{-\sqrt{3}}{2} ; \dfrac{-\sqrt{3}}{2} ; \dfrac{-1}{2}\right)$.\\
		Mặt phẳng $(SAD)$ có vectơ pháp tuyến $\overrightarrow{n_1}=[\overrightarrow{SC}, \overrightarrow{CD}]=\left(\dfrac{\sqrt{3}}{2} ; 0 ; 1\right)$.\\
...
\begin{ex}%[2H2C2-4]%[Dự án 2025-K12-TL-TV]%[Thành Đức Trung]
	...
	{$75^{\circ}$}
	\loigiai
	{\immini[thm]{Chọn hệ trục tọa độ $Oxyz$ sao cho $O \equiv A'$, $Ox \equiv A'D'$, $Oy \equiv A'B'$, $Oz \equiv A'A$.\\
...
\begin{ex}%[2H5V4-5]%[Dự án 2025-K12-TL-TV]%[Thành Đức Trung]
	...
	{$\sqrt{3}$}
	\loigiai
	{\immini[thm]{Gọi $I$ hình chiếu của $M$ lên $(ABCD)$, suy ra $I$ là trung điểm của $AO$ suy ra
...
\begin{ex}%[2H5V1-6]%[Dự án 2025-K12-TL-TV]%[Thành Đức Trung]
	...
	{$\dfrac{4\sqrt{2}}{13}$}
	\loigiai
	{Gọi $O, H$ lần lượt là trung điểm của $AB$ và trọng tâm tam giác $ABC$.\\Vì $A'. ABC$ là tứ diện đều cạnh $a$ nên $A'H\perp (ABC)$.\immini[thm]{
			...
			$\\
			và $\overrightarrow{AB}=\overrightarrow{A'B'} \Rightarrow B'\left(-1 ; \dfrac{\sqrt{3}}{6} ; \dfrac{\sqrt{6}}{3}\right)$.\\ Dễ thấy $(ABC)$ có vectơ pháp tuyến $\overrightarrow{n_1}=(0 ; 0 ; 1)$.}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round, >=stealth]
				\def\ac{5} % cạnh AC
				\def\ab{1.75} % cạnh AB
				\def\ben{4} % cạnh bên
		...
		Mặt phẳng $(CMN)$ có vectơ pháp tuyến $\overrightarrow{n_2}=\left(0 ; \dfrac{\sqrt{6}}{6} ; \dfrac{5 \sqrt{3}}{12}\right)=\dfrac{\sqrt{3}}{12}(0 ; 2 \sqrt{2} ; 5)$
...
\begin{ex}%[2H5V1-6]
	...
	\loigiai{
		...
		$\begin{aligned}[t]
			...
			=a^2(1;-1;2).
		\end{aligned}$\\
		Mặt phẳng $(SBC)$ có một vectơ pháp tuyến $\overrightarrow{n}_1$, mặt phẳng $(AMC)$ có một vectơ pháp tuyến $\overrightarrow{n}_2$.\\
...
\begin{ex}%[2H5V2-7]
	...
	{$\dfrac{\sqrt{55}}{10}$}
	\loigiai{
		Trong không gian $Oxyz$ chọn $A\equiv O(0;0;0), AB\equiv Ox, AD\equiv Oy, AS\equiv Oz$.
		\begin{center}
			\begin{tikzpicture}[line cap=round, line join=round, >=stealth, font=\footnotesize]
				\def\a{1} \def\h{3}
				\path 	
		...
		$\begin{aligned}[t]
			...
			=(-a^2;a^2;0)=a^2(-1;1;0).
		\end{aligned}$\\
		Mặt phẳng $(SAC)$ có một vectơ pháp tuyến là $\overrightarrow{n}_{(SAC)}$.\\
...
\begin{ex}%[2H5V2-7]
	...
	\loigiai{
		...
		\end{aligned}$\\
		Mặt phẳng $(ABCD)$ có vectơ pháp tuyến $\overrightarrow{k}=(0;0;1)$.\\
		...
		Mặt phẳng $(SBD)$ có vectơ pháp tuyến là $\overrightarrow{i}=(1;0;0)$.\\
...
\begin{ex}%[2H5V2-7]
	...
	\loigiai{
		...
		Có các vectơ $\overrightarrow{SC}=(1;1;-\sqrt{2})$, $\overrightarrow{SB}=(1;0;-\sqrt{2})$.\\
		Do $(AMN)\perp SC$ nên mặt phẳng $(AMN)$ có một vectơ pháp tuyến là $\overrightarrow{SC}$. \\
...
\begin{ex}%[2H5V2-7]
	...
	\loigiai{
		...
		Nên đường thẳng $BD$ có một vectơ chỉ phương là $\overrightarrow{u}=\left(-1;\sqrt{3};0\right)$.\\
		Ta có 
		$\begin{aligned}[t]
		...
		\end{aligned}$\\
		Như vậy, mặt phẳng $(SBC)$ có một vectơ pháp tuyến là $\overrightarrow{n}=(1;0;1)$.\\
...
\begin{ex}%[2H5V1-6]
	...
	\loigiai{
		...
		\end{aligned}$\\
		Ta có vectơ pháp tuyến của $(AB'C')$ là $\overrightarrow{n}_1$ và vectơ pháp tuyến của $(MNP)$ là $\overrightarrow{n}_2$.\\
...
\begin{ex}%[2H5V1-6]
	...
	\loigiai{
		...
		Mặt phẳng $(AMN)$ có một vectơ pháp tuyến là $\overrightarrow{n}$. \\
		Mặt phẳng $(ABC)$ có một vectơ pháp tuyến $\overrightarrow{HM}=(0;0;1)$.\\
...
\begin{ex}%[2H5V1-6]
	...
	\loigiai{
		...
		\Rightarrow (AMC)$ có một vectơ pháp tuyến $\overrightarrow{n}=(-2;2;-1)$.\\
		$\overrightarrow{SB}=(a;0;-2a)$, $\overrightarrow{SC}=(a;a;-2a)$.\\
		$\left[\overrightarrow{SB},\overrightarrow{SC}\right]=a^2(2;0;1)
		\Rightarrow (SBC)$ có một vectơ pháp tuyến $\overrightarrow{k}=(2;0;1)$.\\
...
\begin{ex}%[2H5V1-6]
	...
	\loigiai{
		...
		Mặt phẳng $(GMN)$ có cặp vectơ chỉ phương
		$\heva{&\overrightarrow{GM}=\dfrac{a}{12}\left(3;6;\sqrt{3}\right),\\&\overrightarrow{GN}=\dfrac{a}{12}\left(-3;6;\sqrt{3}\right).}$\\
		Suy ra vectơ pháp tuyến $\overrightarrow{n}=\left[\overrightarrow{GM};\overrightarrow{GN}\right] 
		=\dfrac{a^2}{144}
		\left(
		\begin{vmatrix}
			6&\sqrt{3}\\6&\sqrt{3}
...
\begin{ex}%[2H5V1-6]
	...
	\loigiai{
		...
		Mặt phẳng $(ABC)$ có cặp vectơ chỉ phương
		$\left\{\begin{aligned}
		...
		\end{aligned}$\\
		Mặt phẳng $AB'I$ có cặp vectơ chỉ phương
