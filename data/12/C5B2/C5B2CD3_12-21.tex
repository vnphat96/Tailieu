...
\end{ex} 
\begin{ex}%[2H5V2-5]
	Trong không gian $Oxyz$, cho mặt phẳng $\left(P\right) \colon  x+2y+z-4=0$ và đường thẳng $d \colon \dfrac{x+1}{2}=\dfrac{y}{1}=\dfrac{z+2}{3}$. Phương trình đường thằng $\Delta $ nằm trong mặt phẳng $(P)$, đồng thời cắt và vuông góc với đường thẳng $d$ là
	\choice 
	...
	\loigiai{
		...
		Vì $\Delta \perp d$ và $ \Delta \subset (P) \Rightarrow \Delta$ có vectơ chỉ phương $\vec{u}=\left[\vec{u};\overrightarrow{u}_{d}\right]=(5;-1;-3)$.\\
