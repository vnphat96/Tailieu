...
\begin{ex}%Câu 11%[2H5V1-3]
	Trong không gian với hệ tọa độ $Oxyz$, phương trình mặt phẳng $(P)$ song song và cách đều hai đường thẳng $d_1\colon\dfrac{x-2}{-1}=\dfrac{y}{1}=\dfrac{z}{1}$ và $d_2\colon\dfrac{x}{2}=\dfrac{y-1}{-1}=\dfrac{z-2}{-1}$ có dạng $ax+by+cz+1=0$. Tính $a^2+b^2+c^2$.
	\shortans{$8$}
	\loigiai{
...
\begin{ex}%Câu 15%[2H5V2-3]
	Trong không gian $Oxyz$, cho ba đường thẳng $d\colon\dfrac{x}{1}=\dfrac{y}{1}=\dfrac{z+1}{-2}$,\break  $\Delta_1\colon\dfrac{x-3}{2}=\dfrac{y}{1}=\dfrac{z-1}{1}$, $\Delta_2\colon\dfrac{x-1}{1}=\dfrac{y-2}{2}=\dfrac{z}{1}$. Đường thẳng $\Delta $ vuông góc với $d$ đồng thời cắt $\Delta_1$, $\Delta_2$ tương ứng tại $H$, $K$ sao cho độ dài $HK$ nhỏ nhất. Biết rằng $\Delta $ có một véc-tơ chỉ phương $\overrightarrow{u}=(h; k; 1)$. Tính giá trị $h-k$.
	\shortans{$0$}
	\loigiai{
