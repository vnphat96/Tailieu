...
\begin{ex}%[Dự án 2025_K12_TL TV]%[Lê Quốc Hiệp]%[2H5H2-3]
	...
	\loigiai{
		...
		\begin{itemchoice}
			\itemch \textbf{Đúng.}\\
			Đường thẳng $d$ đi qua điểm $M(1;2;-3)$ nhận véc tơ $\vec{u}=(2;-1;1)$ làm vectơ chỉ phương nên có phương trình dạng chính tắc là $\dfrac{x-1}{2}=\dfrac{y-2}{-1}=\dfrac{z+3}{1}$.
			\itemch \textbf{Sai.}\\
