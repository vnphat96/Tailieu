...
% \subsubsection{Vectơ chỉ phương của đường thẳng. PTTS của đường thẳng.}
%  \immini{\tickv Cho đường thẳng $\Delta $ và vectơ $\overrightarrow{u}$ khác $\overrightarrow{0}$. Vectơ $\overrightarrow{u}$ được gọi là vectơ chỉ phương của đường thẳng $\Delta $ nếu giá của $\overrightarrow{u}$ song song hoặc trùng với $\Delta $.\\
%  \tickv Trong không gian với hệ trục tọa độ $Oxyz$, PTTS của đường thẳng $\Delta $ đi qua điểm $M(x_{0} ;y_{0} ;z_{0} )$ và nhận $\overrightarrow{u}=(a;b;c)$ (với $a^{2} +b^{2} +c^{2} \ne 0$) làm vectơ chỉ phương có dạng
%  $$\heva{&x=x_{0} +at \\& y=y_{0} +bt \\ & z=z_{0} +ct.} $$   với $t\in  \mathbb{R}$ ($t$ được gọi là tham số).
% }{
% 	\begin{tikzpicture}[scale=.7]
