...
{$4$}
\loigiai{
	 Điều kiện đề có nghiệm phức không thuần thực: $\Delta'=4-b<0 \Leftrightarrow b>4$.\\
...
\loigiai{
	 ...
	 Điều kiện để phương trình có hai nghiệm phức phân biệt là\[\Delta'=a^{2}-a^{2}+2 a=2 a<0.\eqno (2)\]
