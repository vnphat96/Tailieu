...
\end{bt}
\begin{bt}%[2D5H2-3]
	\immini[thm]{Máy tính và thiết bị lưu điện (UPS) được kết nối như hình 5. Khi xảy ra sự cố điện, UPS bị hỏng với xác suất $0{,}02$. Nếu UPS bị hỏng khi xảy ra sự cố điện, máy tính sẽ bị hỏng với xác suất $0{,}1$; ngược lại, nếu UPS không bị hỏng, máy tính sẽ không bị bỏng.
	\begin{listEX}
