...
\end{ex}
\begin{ex}%[Dự án 2025 - đề cấu trúc mới, Hung Doan]%[2D4N3-1]
	\immini[thm]{Cho hàm số $y=f(x)$ có đồ thị như hình vẽ. Diện tích $S$ của hình phẳng trong phần gạch sọc được tính theo công thức
		\choice
...
\end{ex}
\begin{ex}%[Dự án 2025 - đề cấu trúc mới, Hung Doan]%[2D4N3-1]
	\immini[thm]{Cho hàm số $f(x)$ liên tục trên $\mathbb{R}$. Gọi $S$ là diện tích hình phẳng giới hạn bởi các đường $y=f(x)$, $y=0$,$ x=-1$, $x=2$ (như hình vẽ bên). Mệnh đề nào dưới đây đúng?
		\choice
...
\begin{ex}%[Dự án 2025 - đề cấu trúc mới, Hung Doan]%[2D4V3-3]
	\immini[thm]{Cho đồ thị của hai hàm số $y=f(x)$, $y=g(x)$ và phần tô màu như hình vẽ.
		\choiceTF
