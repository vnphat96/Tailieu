...
\begin{ex}%[2D4V3-3]
	...
	{$\dfrac{2\pi}{3}$}
	\loigiai{
	\immini[thm]{Xét các phương trình sau
	\begin{itemize}
...
\end{ex}
\begin{ex}%[2D4V3-1]
	\immini[thm]{Trong mặt phẳng tọa độ $Oxy$, cho hình chữ nhật $(H)$ có một cạnh nằm trên trục hoành và có hai đỉnh trên một đường chéo là $A(-1;0)$ và $C\left( a;\sqrt{a}\right)$, với $a>0$. Biết rằng đồ thị của hàm số $y=\sqrt{x}$ chia hình $(H)$ thành hai phần có diện tích bằng nhau. Tìm $a$.	\shortans{$3$}
