...
\shortans{2}
\loigiai{
\immini[thm]{Ta có $x^4-mx^2=0\Leftrightarrow x^2\left(x^2-m\right)=0\Leftrightarrow\hoac{
& x=0\\
& x=\sqrt{m}\\
& x=-\sqrt{m}}$ vì $m>0$.\\
...
\begin{ex}%[2D4C3-1]
\immini[thm]{Cho hàm số bậc ba $y=f(x)$ có đồ thị là đường cong trong hình bên. Biết hàm số $f(x)$ đạt cực trị tại hai điểm $x_1$, $x_2$ thỏa mãn $x_2=x_1+2$ và $f\left(x_1\right)+f\left(x_2\right)=0$. Gọi $S_1$ và $S_2$ là diện tích của hai hình phẳng được gạch trong hình bên. Tỉ số $\dfrac{S_1}{S_2}$ bằng}{
...
Theo giả thiết, ta có $|x y|=2$. Suy ra $y=\dfrac{2}{x}$ hoặc $y=\dfrac{-2}{x}$.\\
Ứng với hình dưới, ta có các đường viền cong $AK$, $DE$ là một phần của đồ thị hàm số $y=\dfrac{-2}{x}$; các đường viền cong $BC$, $GH$ là một phần của đồ thị hàm số $y=\dfrac{2}{x}$.
\immini[thm]{Khi đó, diện tích phần màu xanh bằng
\begin{eqnarray*}
...
\immini[thm]{Một hoa văn trang trí được tạo ra từ một miếng bìa hình vuông cạnh bằng $10$ cm bằng cách khoét đi bốn phần bằng nhau có hình dạng parabol như hình vẽ bên. Biết $ AB=5$ cm, $OH=4$ cm. Tính diện tích của bề mặt hoa văn đó (đơn vị: cm$^2$) (kết quả làm tròn đến chữ số thập phân thứ nhất).
\shortans{$46{,}7$}
...
\immini[thm]{Chọn hệ trục tọa độ như hình vẽ bên.\\
...
\immini[thm]{Chướng ngại vật \lq\lq tường cong\rq\rq trong một sân thi đấu X-Game là một khối bê tông có chiều cao từ mặt đất lên là $3$ m. Giao của mặt tường cong và mặt đất là đoạn thẳng $AB = 2$ m. Thiết diện của khối tường cong cắt bởi mặt phẳng vuông góc với $AB$ tại $A$ là một hình tam giác vuông cong $ACE$ với $AC = 4$ m, $CE = 3$ m và cạnh cong $AE$ nằm trên một đường Parabol có trục đối xứng vuông góc với mặt đất. Tại vị trí $M$ là trung điểm của $AC$ thì tường cong có độ cao $1$ m. Thể tích bê tông cần sử dụng để tạo nên khối tường cong đó gần nhất với số nào dưới đây?
\shortans{$9{,}3$}
...
\immini[thm]{Một bể nước có thiết kế phía dưới là hình hộp chữ nhật có đáy là hình vuông cạnh $10$ m, chiều cao là $1$ m; phía trên là hình chóp cụt đều có đáy trên là hình vuông cạnh $15$ m. Tổng chiều cao của bể là $4$ m. Lúc đầu bể không có nước, người ta bơm nước vào bể với tốc độ không đổi là $5$ m$^3$/phút. Hỏi sau một giờ bơm thì tốc độ dâng lên của nước trong bể là bao nhiêu m/phút (làm tròn kết quả đến hàng phần trăm)?}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round,>=stealth]
...
\shortans[0]{18{,}8}
\loigiai{
\immini[thm]{Giả sử mặt trên của Lavabo được biểu diễn như hình vẽ bên dưới.\\ Chọn hệ trục tọa độ $Oxy$ như hình vẽ.\\ Gọi $(E)$ là elip nhỏ bên trong.}{
