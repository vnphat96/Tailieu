...
%Câu 3
\begin{ex}%[2D4H3-1]
	\immini[thm]{Cho hàm số $ y=f(x) $ liên tục trên $ \mathbb{R} $ và có đồ thị như hình vẽ bên. Gọi $ S $ là diện tích hình phẳng được giới hạn bởi đồ thị hàm số $ y=f(x) $ và trục hoành. Khẳng định nào sau đây đúng?
	\choice
...
%Câu 3
\begin{ex}%[2D4V3-4]
	\immini[thm]{Cho vật thể đáy là hình tròn có bán kính bằng $1$ (tham khảo hình vẽ). Khi cắt vật thể bằng mặt phẳng vuông góc với trục $Ox$ tại điểm có hoành độ $x\ (-1\leq x\leq 1)$ thì được thiết diện là một tam giác đều. Tính thể tích vật thể đó (làm tròn đến chữ số đầu tiên sau dấu phẩy).\shortans{$2{,}3$}
	}{
