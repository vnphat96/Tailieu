...
\begin{dang}{Các bài toán liên quan đến góc}
	\begin{itemize}
		...
		\item Giả sử $(\alpha):Ax+By+Cz+D=0$ và $(\beta): A'x+B'y+C'z+D'=0$ có các vectơ pháp tuyến tương ứng là $\vec{n}_{\alpha}=(A;B;C)$ và $\vec{n}_{\beta}=(A';B';B')$. Khi đó, góc $\varphi$ giữa hai mặt phẳng $(\alpha)$ và $(\beta)$ được tính theo công thức
...
\begin{vd}%[Đề thi thử Toán 2018 THPT Quốc gia lần 1 trường Lý Thái Tổ]%[Lê Ngọc Hiếu-EX-7]%[2H3K4-1]
	...
	{$\dfrac{1}{2}$}
	\loigiai{
		\immini[thm]{Chọn hệ trục tọa độ $Bxyz$ như hình vẽ.\\
...
\begin{vd}%[TT lần 1, Sở giáo dục Hà Nội, năm 2018]%[2H3K4-1]
	...
	{$1$}
	\loigiai{
		\immini[thm]{Không mất tính tổng quát, giả sử các cạnh của hình chóp bằng $2\sqrt2$.\\
			Chọn hệ trục tọa độ như hình vẽ.\\
			Khi đó: $E(1;1;0)$, $M(0;-1;1)$, $\vec{ME}=(1;2;-1)$ và $\vec{OC}=(0;2;0)$ là vectơ pháp tuyến của $(SBD)$.\\
...
\begin{vd}%[Thi thử L1, Cộng Hiền, Hải Phòng, 2018]%[Dương Xuân Lợi, 12EX11]%[2H3K4-1]
	\immini[thm]{Cho hình chóp $S.ABCD$ có đáy $ABCD$ là hình chữ nhật và cạnh bên $SA$ vuông góc với đáy. Biết rằng $AB=a$, $AD=a\sqrt{2}$, $SA=2a$. Gọi góc giữa hai mặt phẳng $(SBC)$ và mặt phẳng $(SBD)$ là $\alpha$. Tính $\cos\alpha$. (tham khảo hình vẽ bên)
		\choice
	...
	\loigiai{
		\immini[thm]{
			...
			$(SBC)$ có một vectơ pháp tuyến $\overrightarrow{n}_1=[\overrightarrow{BC},\overrightarrow{BS}]=(2a^2\sqrt{2};0;a^2\sqrt{2})$.\\
			$(SBD)$ có  một vectơ pháp tuyến $\overrightarrow{n}_2=[\overrightarrow{BS},\overrightarrow{BD}]=(-2a^2\sqrt{2};-2a^2;-a^2\sqrt{2})$.\\
...
Cho hình chóp $ S.ABCD $ có đáy là hình chữ nhật, $ AB=3 $, $ BC=4 $. Tam giác $ SAC $ nằm trong mặt phẳng vuông góc với đáy, khoảng cách từ điểm $ C $ đến đường thẳng $ SA $ bằng $ 4 $. Cô-sin góc giữa hai mặt phẳng $ (SAB) $ và $ (SAC) $ bằng bao nhiêu?
	...
	\loigiai{
		...
		Vectơ pháp tuyến của mặt phẳng $ (SAB) $ là $ \vec{n}_1=\left( -16;12;12 \right) $.\\
		Vectơ pháp tuyến của mặt phẳng $ (SAC) $ là $ \vec{j}=(0;0;1) $.\\
...
\begin{ex}%[Đề THPT L1, Hoàng Mai, Nghệ An 2018]%[Thái Văn Đạt, EX10]%[2H3G4-1]
	...
	\loigiai{
		...
		Vectơ pháp tuyến của mặt phẳng $(SAC)$ là $$\vec{n_1}=[\vec{AC},\vec{AS}]=\left(\sqrt{3};0;\dfrac{-\sqrt{3}}{2}\right).$$
		Vectơ pháp tuyến của mặt phẳng $(SBC)$ là $$\vec{n_2}=[\vec{BC},\vec{SC}]=\left(-\sqrt{3};-1;\dfrac{-\sqrt{3}}{3}\right).$$
...
\begin{ex}%[Đề thi thử, THPT Quỳ Hợp 2, Nghệ An 2018]%[Hùng Nam Lý, dự án EX9]%[2H3K4-1]
	...
	\loigiai{
		...
		\noindent Ta có $\vec{SD}=\left(-\dfrac{a\sqrt{2}}{2};0;-\dfrac{a\sqrt{2}}{2}\right)\Rightarrow \vec{u}=\left(1;0;1\right)$ là vectơ chỉ phương của $SD.$\\
		...
		$\Rightarrow \vec{n}=(3;-1;1)$ là vectơ pháp tuyến của mặt phẳng $(SAM).$\\
...
\begin{vd}%[2-TT-33-BenTre-VinhPhuc-18]%[Đoàn Nhật Thiện-12EX-8]%[2H3K4-1]
	...
	\loigiai{
		\immini[thm]{Ta có $C_1D\parallel B_1A\Rightarrow C_1D\parallel (AB_1C)$\\
			...
			\end{tikzpicture}}
		Ta có $\vec{AB_1}=(a;0;2a\sqrt{3})$, $\vec{AC}=(a;a\sqrt{3};0)$, $[\vec{AB_1},\vec{AC}]=\left(-6a^2;2\sqrt{3}a^2;\sqrt{3}a^2\right)$. Mặt phẳng $(AB_1C)$ qua ba điểm $A$, $B_1$, $C$.\\ Khi đó mặt phẳng $(AB_1C)$ có một vectơ pháp tuyến $\vec{n}=(-6,2\sqrt{3};\sqrt{3})$. Phương trình mặt phẳng $(AB_1C)\colon -6x+2\sqrt{3}y+\sqrt{3}z=0$.\\
...
\begin{vd}%[Đề HK2, 2018, Sở Đồng Nai]%[Trần Quang Thạnh, dự án EX9]%[2H3K4-1]
	...
	{\True $h=\dfrac{2}{3} $}
	\loigiai{
		\immini[thm]{Chọn hệ trục tọa độ $Oxyz$ sao cho $M(0;0;0)$, $S(0;0;2)$, $N(1;0;0)$, $Q(0;1;0)$. Lúc đó $P(1;1;0)$, $\vec{SN}=(1;0;-2)$, $\vec{MP}=(1;1;0)$ và $\vec{MN}=(1;0;0)$.\\
...
\begin{ex}%[TT-Đặng Thúc Hứa- Nghệ An lần 2 - 2018]%[PhanMinhTâm, Ex10]%[2H3K4-1]
	\immini[thm]{Cho hình chóp $ S.ABCD $ có đáy $ ABCD $ là hình chữ nhật, $ AB=2a $, $ BC=a $, tam giác $ SAB $ là tam giác đều và nằm trong mặt phẳng vuông góc với đáy. Gọi $ E $ là trung điểm của $ CD $. Tính theo $ a $ khoảng cách giữa hai đường thẳng $ BE $ và $ SC $.
		\choice
		{$ a $}
		{$ \dfrac{a\sqrt{15}}{5} $}
		{$ \dfrac{a\sqrt{3}}{2} $}
...
\begin{ex}%[Đề thi thử THPT Quốc gia lần 3, THPT Chuyên Hạ Long, Quảng Ninh, 2018]%[Nguyễn Thị Chúc, dự án 12EX11]%[2H3G4-1]
	...
	\loigiai{
		...
		{Gắn hệ trục tọa độ như hình vẽ.\\
			...
			Ta có: $\overrightarrow{CS}=\left(\dfrac{4a}{5}; \dfrac{6a}{5}; 2a\sqrt{13}\right) \Rightarrow \overrightarrow{u_1}=\left(\dfrac{2}{5}; \dfrac{3}{5};\sqrt{13}\right)$ là vectơ chỉ phương của $SC$.\\
			Ta có: $\overrightarrow{MN}=\left(\dfrac{6a}{5}; -\dfrac{4a}{5}; 0\right) \Rightarrow \overrightarrow{u_2}=(3;-2;0)$ là vectơ chỉ phương của $MN$.\\
...
\begin{ex}%[Thi thử, THPT Lê Văn Thịnh, Bắc Ninh, 2018]%[Lê Phước Thật, dự án EX12]%[2H3K4-1]
	...
	{$d=\dfrac{10}{3\sqrt{5}}$}
	\loigiai{
		\immini[thm]{Chọn hệ trục tọa độ $Oxyz$ như sau: $O\equiv B, C$ nằm trên tia $Ox, A$ nằm trên tia $Oy, B'$ nằm trên tia $Oz$.\\
...
\begin{vd}%[HK2 (2017-2018), THPT LÊ QUÝ ĐÔN, HÀ NỘI]%[Trần Hòa, dự án EX9]%[2H3G4-1][2H3G3-8]
	...
	%
	\loigiai{
		\immini[thm]{Gọi $G$ là trọng tâm tam giác $CC'B$, ta có
			\begin{eqnarray*}
				& & CM^2+C'M^2+B'M^2\\
...
\begin{ex}%[Đề KSCL Toán 12 THPT năm học 2017 – 2018 sở GD và ĐT Thanh Hóa]%[Phạm Doãn Lê Bình, 12-Ex-9]%[2H3G4-1]
	\immini[thm]{Cho hình chóp $S.ABCD$ có đáy $ABCD$ là hình vuông cạnh bằng $2$, $SA = 2$ và $SA$ vuông góc với mặt đáy $(ABCD)$. Gọi $M$ và $N$ là hai điểm thay đổi trên hai cạnh $AB$, $AD$ sao cho mặt phẳng $(SMC)$ vuông góc với mặt phẳng $(SNC)$. Tính tổng $T = \dfrac{1}{AN^2} + \dfrac{1}{AM^2}$ khi thể tích hình chóp $S.AMCN$ đạt giá trị lớn nhất.
		\choice
		{$T=\dfrac{2+\sqrt{3}}{4}$}
		{$T = \dfrac{13}{9}$}
		{$T=2$}
...
\begin{vd}%[TT, THPT Chuyên KHTN, Hà Nội]%[Bùi Quốc Hoàn, dự án EX10]%[2H3B4-1]
	Trong không gian $Oxyz$, cho mặt phẳng $\left(\alpha\right)\colon 2x - y - 3z = 4$. Gọi $A$, $B$, $C$ lần lượt là giao điểm của mặt phẳng $\left(\alpha\right)$ với các trục tọa độ $Ox$, $Oy$, $Oz$. Thể tích tứ diện $OABC$ bằng
	\choice
	{$\dfrac{32}{9}$}
	{\True $\dfrac{16}{9}$}
	{$1$}
...
\begin{ex}%[Đề TT L3 trường THPT Thực hành Cao Nguyên, Đắk Lắk 2018]%[Ngô Trung Kiên, 12EX11-2018]%[2H3K4-1]
	...
	\loigiai{
		...
		Phương trình mặt phẳng $(P)$ đi qua điểm $M(1;2;3)$ nhận $\vec{OM}$ làm vectơ pháp tuyến là
...
\begin{ex}%[Thi thử lần 3, chuyên ĐHSP Hà Nội, 2018]%[Nguyễn Thành Khang, dự án 12Ex10-18]%[2H3G4-1]
	...
	\loigiai{
		\immini[thm]{
			...
			Ta có $\left[\vec{MC},\vec{CD}\right]=\left(\dfrac{ax\sqrt{2}}{4},\dfrac{ax\sqrt{2}}{4},\dfrac{3a^2}{4}\right)=\dfrac{a}{4}\left(x\sqrt{2},x\sqrt{2},3a\right)$ nên mp$(MCD)$ có vectơ pháp tuyến $\vec{n_1}=\left(x\sqrt{2},x\sqrt{2},3a\right)$.\\
			Và $\left[\vec{AS},\vec{AB}\right]=\left(\dfrac{ax\sqrt{2}}{2},\dfrac{ax\sqrt{2}}{2},\dfrac{-a^2}{2}\right)=\dfrac{a}{2}\left(x\sqrt{2},x\sqrt{2},-a\right)$ nên mp$(SAB)$ có vectơ pháp tuyến $\vec{n_2}=\left(x\sqrt{2},x\sqrt{2},-a\right)$.
		}{
			\begin{tikzpicture}[scale=0.8,>=stealth]
...
\begin{ex}%[TT-Đặng Thúc Hứa- Nghệ An lần 2 - 2018]%[PhanMinhTâm, Ex10]%[2H3G4-1]
	\immini[thm]{Cho hình chóp $ S.ABC $ có $ AB=a $, $ AC=a\sqrt{3} $, $ SB>2a $ và $ \widehat{ABC}=\widehat{BAS}=\widehat{BCS}=90^{\circ} $. Sin của góc giữa đường thẳng $ SB $ và mặt phẳng $ (SAC) $ bằng $ \dfrac{\sqrt{11}}{11} $. Tính thể tích khối chóp $ S.ABC $.
		\choice
...
\begin{ex}%[KSCL lần 4, Chuyên Vĩnh Phúc, 2018]%[Hà Lê, 12EX-8]%[2H3K4-1]
	\immini[thm]{Cho hình chóp  $S.ABCD$ có đáy là hình vuông cạnh $a$, $SAD$ là tam giác đều và nằm trong mặt phẳng vuông góc với đáy. Gọi $M$ và $N$ lần lượt là trung điểm của $BC$ và $CD$ (tham khảo hình vẽ bên). Tính bán kính $R$ của khối cầu ngoại tiếp hình chóp $S.CMN$.
		\choice
...
\begin{ex}%[Đề thi hết học kì 2, Bình Minh, Ninh Bình 2018]%[Nguyễn Tuấn Anh, dự án EX9]%[2H3K4-1]
	...
	{$x=\sqrt{3}$}
	\loigiai{
		\immini[thm]{Gán hệ trục tọa độ $Oxyz$ sao cho $C(0;0;0)$ trùng với gốc tọa độ và $A(x;0;0), B(0;x;0), C'(0;0;x)$.\\
...
\begin{ex}%[Thi thử, Sở GD\&ĐT Cao Bằng, 2018]%[Trần Hòa, dự án (12EX-10)]%[2H3G4-1]
	...
	\loigiai{
		\immini[thm]{Chọn hệ trục tọa độ $Oxyz$ như hình vẽ.\\
		...
		$[\vec{CB},\vec{CA}]=(0;-9\sqrt{3};12)\Rightarrow \vec{n}_1=(0;-3\sqrt{3};4)$ là một vectơ pháp tuyến của mặt phẳng $(ABC)$.\\
		$[\vec{CA},\vec{CD}]=(-12\sqrt{3};0;12)\Rightarrow \vec{n}_2=(-\sqrt{3};0;1)$ là một vectơ pháp tuyến của mặt phẳng $(ACD)$.\\
...
\begin{ex}%[Đề TT Sở Hậu Giang]%[12-EX-11, Trần Hòa]%[2H3K4-1]
	...
	\loigiai{
		...
		$\vec{SD}=(0;\sqrt{3};\sqrt{3})\Rightarrow \vec{u}=(0;1;-1)$ là một vectơ chỉ phương của đường thẳng $SD$.\\
		$\vec{SA}=(1;0;-\sqrt{3})$, $\vec{SC}=(-1;\sqrt{3};-\sqrt{3})\Rightarrow [\vec{SA},\vec{SC}]=(3;2\sqrt{3};\sqrt{3})\Rightarrow \vec{n}=(\sqrt{3};2;1)$ là một vectơ pháp tuyến của mặt phẳng $(SAC)$. Vì $\alpha$ là góc tạo bởi $SD$ và mặt phẳng $(SAC)$ nên
...
\begin{ex}%[Đề TT lần 1, Chuyên Nguyễn Thị Minh Khai, Sóc Trăng 2018]%[Hung Tran,12EX-8]]%[2H3K4-1]
	\immini[thm]{Cho hình lăng trụ tam giác $ABC.A'B'C'$ có đáy $ABC$ là tam giác vuông tại $A, AB=3,AC=4,AA'=\dfrac{\sqrt{61}}{2}$; hình chiếu của $B'$ trên mặt phẳng $(ABC)$ là trung điểm cạnh $BC$. Gọi $M$ là trung điểm cạnh $A'B'$ (tham khảo hình vẽ bên). Cô-sin của góc tạo bởi hai mặt phẳng $(AMC')$ và $(A'BC)$ bằng
		\choice
		...
		\end{tikzpicture}}
	\loigiai{
		\immini[thm]{Chọn hệ trục tọa độ gốc $A$ như hình vẽ.\\
			...
			\end{tikzpicture}}
		Hai mặt phẳng $(AMC')$ và $(A'BC)$ lần lượt nhận hai vectơ $\overrightarrow{n_1}=(-8;-3;2)$ và $\overrightarrow{n_2}=(4;3;4)$ làm vectơ pháp tuyến.\\
...
\begin{ex}%[KSCL Lớp 12, Phả Lại - Hải Dương - 2018]%[Vũ Văn Trường, dự án(12EX-9)]%[2H3K4-1]
	...
	\loigiai{
		\immini[thm]{
			...
			Từ đó suy ra các mặt phẳng $(SBC)$ và $(SHB)$ lần lượt có vectơ pháp tuyến là $\overrightarrow{n_1}=(4;0;-3)$ và $\overrightarrow{n_2}=(0;4;1)$.\\
	...
	\loigiai{
		\immini[thm]{
			...
			\begin{itemize}
				...
				Suy ra, mặt phẳng $(SAB)$ có vectơ pháp tuyến $\overrightarrow{n}_1=(0;-2;1)$.
				...
				Suy ra, mặt phẳng $(SAC)$ có vectơ pháp tuyến $\overrightarrow{n}_2=(2\sqrt{3};0;-1)$.
			\end{itemize}
		}{
...
\begin{ex}%[Thi thử L6, lớp 12, Chuyên Thái Bình, Thái Bình 2018]%[Võ Tấn Đạt, 12EX10]%[2H3G4-1]
	...
	\loigiai{
		\immini[thm]{Gọi $h \; (h>0)$ là chiều cao lăng trụ. Tam giác $ABC$ vuông cân tại $A$ nên ta tính được $AB=AC=a\sqrt{3}$.\\
			...
			Như vậy $\overrightarrow{n_1}=\left[\overrightarrow{AC},\overrightarrow{B'C}\right]=(ha\sqrt{3};0;-3a^2)$ là một vectơ pháp tuyến của mặt phẳng $(AB'C)$ và $\overrightarrow{n_2}~=~\left[\overrightarrow{BC},\overrightarrow{B'C}\right]~=~(ha\sqrt{3};ha\sqrt{3};0)$ là một vectơ pháp tuyến của mặt phẳng $(BCC'B')$.}{\begin{tikzpicture}[scale=.5,>=stealth]
...
\begin{ex}%[Đề TT THPT Quốc gia tháng 6, 2017 - 2018, cụm Tp. Vũng Tàu]%[Nguyễn Hoàng Hải, dự án 12EX11]%[2H3K4-1]
	...
	\loigiai{
		...
		\begin{itemize}
			...
			vậy $ (SBC) $ có một vectơ pháp tuyến là $ \vec{n}_1=\left( -\dfrac{1}{2};0;-1 \right) $.
			\item $ \left[ \vec{SC},\vec{SD} \right]=a^2\left( 0;\dfrac{1}{2};\dfrac{1}{2} \right) $, vậy $ (SCD) $ có một vectơ pháp tuyến là $ \vec{n}_2=\left( 0;\dfrac{1}{2};\dfrac{1}{2} \right) $.
		\end{itemize}
...
\begin{ex}%[Thi thử L3, Bắc Yên Thành, Nghệ An, 2018]%[Nguyễn Tiến Thùy, 12EX-11]%[2H3K4-1]
	...
	\loigiai{
		\immini[thm]{
			...
			từ đó suy ra mặt phẳng $(SBD)$ có vectơ pháp tuyến là $\vec{n}_1=(1;1;1)$.
		}{
		...
		\noindent Mặt khác, mặt phẳng $(MNP)$ có hai vectơ chỉ phương là $\vec{MN}=(1;1;0)$ và $\vec{MP}=(0;1;1)$, từ đó suy ra $\vec{n}_2=\left[\vec{MN},\vec{MP}\right]=(1;-1;1)$ là vectơ pháp tuyến của mặt phẳng $(MNP)$.\\
...
\begin{ex}%[Thi thử L3, THPT Hậu Lộc 2, Thanh Hóa, 2018]%[Hưng Nguyễn, dự án 12-EX-11]%[2H3G4-1]
	...
	\loigiai{
		...
		Từ đó suy ra mặt phẳng $(SHC)$ nhận $\overrightarrow{n}=(3\sqrt{3};-3;2\sqrt{3})$ là vectơ pháp tuyến.\\
...
\begin{ex}%[Đề HK2, 2018, Sở Đồng Nai]%[Trần Quang Thạnh, dự án EX9]%[2H3K4-1]
	...
	{$45^{\circ} $}
	\loigiai{
		\immini[thm]{Chọn hệ trục tọa độ $Oxyz$ sao cho $M(0;0;0)$, $N(1;0;0)$, $Q(0;1;0)$ và $M'(0;0;1)$. Lúc đó $P(1;1;0), N'(1;0;1), Q'(0;1;1)$ và $P'(1;1;1)$.\\
...
\begin{ex}%[Thi thử L3, Chuyên Lào Cai, 2018]%[Trần Chiến, dự án 12-EX-11-2018]%[2H3K4-1]
	...
	\loigiai{
		\immini[thm]{
			...
			Suy ra $\overrightarrow{MN}=\left(\dfrac{\sqrt{2}}{2};-\dfrac{\sqrt{2}}{4};-\dfrac{1}{2}\right)$ do đó đường thẳng $MN$ có một vectơ chỉ phương là $\overrightarrow{u}=(2;-1;-\sqrt{2})$.\\
			Ta thấy mặt phẳng $(SBD)$ có một vectơ pháp tuyến là $\overrightarrow{i}=(1;0;0)$.
		}{
...
\begin{ex}%[Thi thử lần 4, THPT Lê Hồng Phong, Thanh Hóa, 2018]%[Lê Quân - Dự án 12-EX-11-2018]%[2H3K4-1]
	...
	\loigiai{
		\immini[0.1]{
			...
			$ \Rightarrow \vec{u}=(1;2;0)$ là một vectơ pháp tuyến của $ (SAC)$;\\
		...
		$ \Rightarrow \vec{v}=(0;3;-1)$ là một vectơ pháp tuyến của $ (SBC)$.\\
