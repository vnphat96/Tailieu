...
\begin{vd}%[Đỗ Đường Hiếu]%[2H3B1]
	Trong không gian $Oxyz$, cho các vectơ $\overrightarrow{a}=(5;-7;2)$, $\overrightarrow{b}=(0;3;4)$, $\overrightarrow{c}=(-1;2;3)$. Tìm tọa độ các vectơ $\overrightarrow{u}=2\overrightarrow{a}-\overrightarrow{b}$, $\overrightarrow{v}=3\overrightarrow{a}+4\overrightarrow{b}+2\overrightarrow{c}$.
	\loigiai{
		\begin{itemize}
...
\begin{vd}%[Đỗ Đường Hiếu]%[2H3B1]%[2H3K1]
	Trong không gian $Oxyz$, cho các vectơ $\overrightarrow{u}=3\overrightarrow{i}-2\overrightarrow{j}+\overrightarrow{k}$, $\overrightarrow{v}=-\dfrac{3}{2}\overrightarrow{i}+\overrightarrow{j}-\dfrac{1}{2}\overrightarrow{k}$, $\overrightarrow{w}=6\overrightarrow{i}+m\overrightarrow{j}-n\overrightarrow{k}$.
	\begin{enumerate}
...
\begin{ex}%[Đề TT lần 1, THPT Chuyên Hạ Long, Quảng Ninh 2018]%[Lê Minh An, Ex5-2018]%[2H3Y1-1]
	Trong không gian $Oxyz$, cho hai vectơ $\overrightarrow{a}=(2;-3;1)$ và $\overrightarrow{b}=(-1;0;4)$. Tìm tọa độ vectơ $\overrightarrow{u}=-2\overrightarrow{a}+3\overrightarrow{b}$.
...
\begin{ex}%[Đề GHK2, Hàm Rồng, Thanh Hóa, năm 2019]%[Nguyễn Tiến Thùy, 12EX5-2019]%[2H3Y1-1]
	Trong không gian $Oxyz$, cho bốn điểm $A(1;0;2)$, $B(-2;1;3)$, $C(3;2;4)$ và $D(6;9;-5)$. Tọa độ trọng tâm của tứ diện $ABCD$ là
	\choice
	{\True $(2;3;1)$}
	{$(2;3;-1)$}
	{$(-2;3;1)$}
...
\begin{ex}%[Thi thử, Sở GD và ĐT - Hải Phòng, 2019]%[Trần Xuân Thiện, 12EX10]%[2H3Y1-2]
	Trong không gian $Oxyz$, cho ba vectơ $ \overrightarrow{a}=(-1;1;0) $, $  \overrightarrow{b}=(1;1;0) $, $ \overrightarrow{c}=(1;1;1) $. Trong các mệnh đề sau, mệnh đề nào \textbf{sai}?
	\choice
...
\begin{ex}%[Nhật Thiện, Dự án sách tham khảo 12 NPK]%[2H3B1-2] %34
	Trong không gian $Oxyz$, cho ba điểm $A(1;1;1 )$, $B(-1;1;0 )$, $C(3;1;-1 )$. Điểm $M$ trên mặt phẳng $(Oxz )$ cách đều ba điểm $A$, $B$, $C$ có tọa độ là
	\choice 
...
\begin{ex}%[Đề tham khảo - THPT.QG 2017]%[2H3B1-2]
	Trong không gian $Oxyz$, cho các điểm $A(3;-4;0)$, $B(-1;1;3)$, $C(3;1;0)$. Tìm tọa độ điểm $D$ trên trục hoành sao cho $AD=BC$.
	\choice 
...
\begin{vd}%[Nhật Thiện, Dự án sách tham khảo 12 NPK]%[2H3Y1-3] %81
	Trong không gian $Oxyz$, cho mặt cầu $(S )\colon (x+1 )^2+(y-2 )^2+(z-1 )^2=9$ . Tính tọa độ tâm $I$ và bán kính $R$ của $(S )$. 
...
\begin{vd}%[Nhật Thiện, Dự án sách tham khảo 12 NPK]%[2H3Y1-3] %82
	Trong không gian $Oxyz$, cho mặt cầu $(S )$ có phương trình $x^2+y^2+z^2+2x-4y+6z-2=0$. Tính tọa độ tâm $I$ và bán kính $R$ của $(S )$.
	\loigiai { 
...
\begin{vd}%[Nhật Thiện, Dự án sách tham khảo 12 NPK]%[2H3B1-3] %85
	Trong không gian $Oxyz$, Tính bán kính $(S)$ mặt cầu tâm $I(6,3,-4 )$ và tiếp xúc với $Ox$.
	\loigiai { 
...
\begin{vd}%[Nhật Thiện, Dự án sách tham khảo 12 NPK]%[2H3K1-4] %90
	Trong không gian $Oxyz$, cho mặt cầu $(S )$ có phương trình $x^2+y^2+z^2-(2m-2 )x+3my+(6m-2 )z-7=0$. Gọi $R$ là bán kính của $(S )$, tìm $m$ để $R$ đạt giá trị nhỏ nhất.
	\loigiai { 
...
\begin{vd}%[Nhật Thiện, Dự án sách tham khảo 12 NPK]%[2H3Y1-3] %92
	Trong không gian $Oxyz$, mặt cầu $(S )$ có tâm $I(1;-2;0 )$, bán kính $R=5$. Viết phương trình của mặt cầu $(S )$.
	\loigiai {Ta có phương trình mặt cầu $(S)\colon (x-1 )^2+(y+2 )^2+z^2=25$.}
\end{vd}
\begin{vd}%[Nhật Thiện, Dự án sách tham khảo 12 NPK]%[2H3B1-3] %93
	Trong không gian $Oxyz$, cho hai điểm $A(2;4;1 )$, $B(-2;2;-3 )$. Viết phương trình mặt cầu có đường kính $AB$.
	\loigiai { 
...
\begin{vd}%[Nhật Thiện, Dự án sách tham khảo 12 NPK]%[2H3B1-3] %94
	Trong không gian $Oxyz$, mặt cầu $(S )$ có tâm $I(-1;4;2 )$ và có thể tích $V=972\pi $. Viết phương trình của mặt cầu $(S )$.
	\loigiai { 
...
\begin{vd}%[Nhật Thiện, Dự án sách tham khảo 12 NPK]%[2H3B1-3] %96
	Trong không gian $Oxyz$, mặt cầu $(S )$ đi qua $A(0,2,0 )$, $B(2;3;1 )$, $C(0,3;1 )$ và có tâm ở trên mặt phẳng $(Oxz )$. Viết phương trình của mặt cầu $(S )$.
	\loigiai { 
...
\end{vd}
 \begin{vd}%[Nhật Thiện, Dự án sách tham khảo 12 NPK]%[2H3B1-3] %98
	Trong không gian $Oxyz$, cho các điểm $A(2,0,0 )$, $B(0,4,0 )$, $C(0,0,4 )$. Viết phương trình mặt cầu ngoại tiếp tứ diện $OABC$ ($O$ là gốc tọa độ).
	\loigiai { 
...
\begin{ex}%[Đề TT lần 1, THPT Chuyên Hạ Long, Quảng Ninh 2018]%[Lê Minh An, Ex5-2018]%[2H3Y1-3]
	Trong không gian $Oxyz$, cho mặt cầu có phương trình $(x+1)^2+(y-3)^2+z^2=16$. Tìm tọa độ tâm $I$ và bán kính $R$ của mặt cầu đó.
...
\begin{ex}%[Thi thử L1, THPT Chuyên ĐH Vinh, Nghệ An, 2019]%[Nguyễn Đắc Giáp, dự án 12EX6]%[2H3K1-3]
	Trong không gian $Oxyz$, cho các điểm $M\left(2;1;4\right)$, $N\left(5;0;0\right)$, $P\left(1;-3;1\right)$. Gọi $I(a;b;c)$ là tâm mặt cầu tiếp xúc với mặt phẳng $(Oyz)$ đồng thời đi qua các điểm $M, N, P$. Tìm $c$ biết $a+b+c<5$.
	\choice
	{$3$}
	{$1$}
	{\True $2$}
...
\begin{ex}%	[Thi thử L2, Chuyên DHSP Ha Noi, 2018 ]%[2H3K1-3]%[MyNguyen, Dự án (12EX-8)]
	Trong không gian $Oxyz$, mặt cầu $(S)$ đi qua điểm $O(0;0;0)$ và cắt các tia $Ox, Oy, Oz$ lần lượt tại các điểm $A,B,C$ khác $O$ thỏa mãn tam giác $ABC$ có trọng tâm là điểm $G(2;4;8)$. Tọa độ tâm mặt cầu $(S)$ là
	\choice
	{\True $(3;6;12)$}
...
\begin{ex}%[Đề thử sức lần 1, Toán học tuổi trẻ, 2019]%[Nguyễn Trung Kiên, dự án 12-EX-4-2019]%[2H3K1-4]
	Trong không gian $Oxyz$ cho ba điểm $A(-1;2;2)$, $B(3;-1;-2)$, $C(-4;0;3)$. Tọa độ điểm $I$ trên mặt phẳng $(Oxz)$ sao cho biểu thức $\left|\vv{IA}-2\vv{IB}+3\vv{IC}\right|$ đạt giá trị nhỏ nhất là
	\choice
