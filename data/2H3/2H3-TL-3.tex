...
\section{PHƯƠNG TRÌNH ĐƯỜNG THẲNG TRONG KHÔNG GIAN}
 ...
 \subsection{Dạng toán và bài tập}
	...
	\end{ex}
	\begin{dang}{Viết phương trình đường thẳng}%dang 2
		\begin{itemize}
...
\begin{vd}%[Phan Anh Tiến- dự án 12-EX-1-DCHT][2H3K3-2]
	Viết phương trình đường thẳng $(d)$ là hình chiếu vuông góc của $(a)$ lên mặt phẳng $(P)$, với $(a)\colon\dfrac{x+1}{1}=\dfrac{y-1}{1}=\dfrac{z-3}{1}$ và $(P)\colon x-y+z-3=0$.
...
\end{ex}	
	\begin{dang}{Tìm tọa độ điểm liên quan đến đường thẳng}%dang 3
		...
		\begin{itemize}
			...
			\item Viết phương trình tham số của đường thẳng $d\colon  \left\{\begin{aligned}
			&x=x_0+at\\
			&y=y_0+bt\\
			&z=z_0+ct\\
			\end{aligned}\right.$ (*).
...
\begin{vd} %[Nguyễn Quốc Thịnh, dự án 12-EX-DCHT-1-DCHT-2019]% [2H3G3-2]
	Trong không gian với hệ trục $Oxyz$, cho đường thẳng $ \left(d\right) \colon \dfrac{x-2}{-1}=\dfrac{y-1}{-2}=\dfrac{z-1}{1}$ và mặt cầu $ \left(S\right) \colon {\left(x+1\right)}^{2}+{\left(y-2\right)}^{2}+{\left(z-1\right)}^{2}=25$. Viết phương trình đường thẳng $ \Delta $ đi qua điểm $ M\left(-1;-1;-2\right)$ cắt đường thẳng $ \left(d\right)$ và cắt mặt cầu $ \left(S\right)$ tại hai điểm $ A$ và $ B$ sao cho $ AB=8$.
	...
	\loigiai{
		...
		Vậy phương trình đường thẳng $ \Delta \colon \dfrac{x+1}{2}=\dfrac{x+1}{2}=\dfrac{z+2}{1}$.}
\end{vd}
...
\begin{vd}%[Trần Tuấn Việt,Dự án 12EX1-DCHT 2018]%[2H3K1-1]%Bài 168
	Trong không gian với hệ tọa độ $Oxyz$, cho mặt phẳng $(P)\colon x - 2y + 2z - 1 = 0$ và hai đường thẳng $\Delta _1\colon \dfrac{x - 4}{1} = \dfrac{y + 1}{2} = \dfrac{z}{2}$, $\Delta _2\colon \heva{& x = 3\\&y = 1 + t\\&z = 2 + t}$. Xác định tọa độ điểm $M \in \Delta _1$ sao cho khoảng cách từ $M$ đến đường thẳng $\Delta _2$ và khoảng cách từ $M$ đến mặt phẳng $(P)$ bằng nhau. \dapso{$M(5; 1; 2)$ và $M(2; -5; -4)$}
