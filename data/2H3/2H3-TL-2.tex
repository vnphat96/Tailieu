...
\begin{ex}%[Đánh giá NLGV - Yên Phong 1 - Bắc Ninh]%[Lê Minh An - Ex12-1-2018]%[2H3B2-3]
	Trong không gian với hệ tọa độ $Oxyz$, cho $A(1;-1;2)$; $B(2;1;1)$ và mặt phẳng $(P)\colon x+y+z+1=0$. Mặt phẳng $(Q)$ chứa $A$, $B$ và vuông góc với mặt phẳng $(P)$. Mặt phẳng $(Q)$ có phương trình là
	\choice
	{\True $3x-2y-z-3=0$}
	{$x+y+z-2=0$}
	{$-x+y=0$}
...
\begin{dang}{Tìm tọa độ điểm liên quan đến mặt phẳng}
		...
		\textbf{Cách 2:}
	\begin{itemize}
		\item Gọi $d$ là đường thẳng đi qua $M$ và vuông góc với $(P)$. Viết phương trình tham số của $d$ $$d\colon  \left\{\begin{aligned}
		&x=x_M+at\\
		&y=y_M+bt\\
		&z=z_M+ct\\
...
\begin{ex}%[GHK2, Chuyên KHTN, Hà Nội, 2019]%[Nguyễn Văn Sang, 12EX7]%[2H3K2-4]
	Trong không gian với hệ tọa độ $Oxyz$, cho hai điểm $A(0;0;3)$, $B(-2;0;1)$ và mặt phẳng $(\alpha)\colon 2x-y+2z+8=0$. Hỏi có bao nhiêu điểm $C$ nằm trên mặt phẳng $(\alpha)$ sao cho tam giác $ABC$ đều?
	\choice
	{$2$}
	{\True $0$}
	{vô số}
...
\begin{ex}%[KSCL giữa HK2 Cụm trường THPT TP Nam Định]%[Nguyễn Tiến, 12EX7]%[2H3K2-4]
	...
	\loigiai{
		...
		Đường thẳng $MI$ đi qua $I(-2;-3;3)$ và vuông góc với mặt phẳng $(P)$ có phương trình tham số là $MI\colon\heva{&x=-2+t\\ &y=-3+t\\ &z=3-t}$ ($t\in\mathbb{R}$). Lấy $M(-2+t;-3+t;3-t)\in MI$.\\
...
\begin{vd}%[Đề KT Toán 12 trường THCS và THPT Nguyễn Khuyến - Bình Dương lần 5, 2019]%[Trần Thịnh, dự án 12-EX-2-2019]%[2H3B2-5]
	Trong không gian với hệ tọa độ $Oxyz$, cho điểm $H(2;-1;2)$. Biết rằng $H$ là hình chiếu vuông góc của gốc tọa độ $O$ xuống mặt phẳng $(P)$. Tính số đo góc giữa mặt phẳng $(P)$ và mặt phẳng $(Q)\colon x-y-11=0$.
	\loigiai{
...
\begin{ex}%[Thi thử, THPT Chuyên Ngoại Ngữ - Hà Nội, 2019]%[Trần Nhân Kiệt, 12EX7-2019]%[2H3G2-5]
	Trong không gian với hệ tọa độ $Oxyz$, cho đường thẳng $d\colon \dfrac{x}{ - 1}=\dfrac{y + 1}{2}=\dfrac{z - 2}{1}$ và mặt phẳng $(P)\colon 2x - y - 2z - 2=0$, $(Q)$ là mặt phẳng chứa $d$ và tạo với mặt phẳng $(P)$ một góc nhỏ nhất. Gọi $\overrightarrow{n}_Q=(a ; b ; 1)$ là một véc-tơ pháp tuyến của $(Q)$. Đẳng thức nào đúng?
	\choice
	{$a-b=-1$}
	{\True $a+b=-2$}
	{$a-b=1$}
...
\begin{ex}%[Nguyễn Bình Nguyên,Dự án Tex sách tham khảo 12]%
	%[2H3B2-6]
	Trong không gian với hệ tọa độ $Oxyz$, cho hai mặt phẳng $(P)\colon x+y-z+1=0$ và $(Q )\colon x-y+z-5=0$. Điểm $M$ nằm trên trục $Oy$ cách đều $(P)$ và $(Q)$ là
	\choice
	{\True $M(0;2;0)$}
	{$M(0;3;0)$}
	{$M(0;-3;0)$}
...
\begin{vd}%[Đề thi thử THPTQG lần 2 THPT Thoại Ngọc Hầu, An Giang, năm 2019]%[Nguyễn Thành Khang, dự án 2019-Ex-7]%[2H3Y2-7]
	Trong không gian với hệ tọa độ $Oxyz$, cho hai mặt phẳng $(\alpha)\colon 2x+y+mz-2=0$ và $(\beta)\colon x+ny+2z+8=0$. Tính $S=m+n$ để $(\alpha)$ song song với $(\beta)$.
	\loigiai{
...
\end{vd}
\begin{vd}%[Đề thi thử THPTQG lần 2 THPT Thoại Ngọc Hầu, An Giang, năm 2019]%[Nguyễn Thành Khang, dự án 2019-Ex-7]%[2H3Y2-7]
	Trong không gian với hệ tọa độ $Oxyz$, cho điểm $I(1;-2;3)$. Viết phương trình mặt cầu tâm $I$	và tiếp xúc với mặt phẳng $(P)\colon x+2y-2z-6=0$.
	\loigiai{
...
\begin{vd}%[Thi thử, Ngô Sĩ Liên - Bắc Giang, 2019]%[Trần Nhân Kiệt, 12EX6-2019]%[2H3B2-7]
	Trong không gian với hệ tọa độ $Oxyz$, cho điểm $I(-3;0;1)$. Mặt cầu $(S)$ có tâm $I$ và cắt mặt phẳng $(P)\colon x-2y-2z-1=0$ theo một thiết diện là một hình tròn. Diện tích của hình tròn này bằng $\pi$. Viết phương trình mặt cầu $(S)$.
...
\begin{ex}%[VTED 2019-L3]%[Nguyễn Thành Khoa - Phạm Hoàng Đăng]%[2H3B2-7]%Câu 3.
	Trong không gian với hệ tọa độ $Oxyz$, cho mặt cầu $(S)\colon x^2+(y-4)^2+z^2=25$ và mặt phẳng $(P)\colon x+2y-2z-11=0$. Hỏi khẳng định nào sau đây đúng?
	\choice
...
\begin{ex}%[VTED 2019-L3]%[Nguyễn Thành Khoa - Phạm Hoàng Đăng]%[2H3B2-7]%Câu 6.
	Trong không gian với hệ tọa độ $Oxyz$, cho mặt cầu $(S)\colon (x-3)^2+(y+2)^2+(z-1)^2=100$ và mặt phẳng $(P)\colon 2x-2y-z+9=0$. Mặt phẳng $(P)$ cắt mặt cầu $(S)$ theo giao tuyến là đường tròn $(C)$. Tìm tọa độ tâm $J$ và bán kính $r$ của đường tròn $(C)$.
	\choice
	{\True $J(-1;2;3)$, $r=8$}
	{$J(3;2;1)$, $r=8$}
	{$J(-1;2;3)$, $r=64$}
...
\begin{vd}%[2-GHK1-70, THPT Chuyên Lê Hồng Phong - Nam Định, 2018]%[Trần Xuân Thiện - Nguyễn Anh Tuấn, 12-EX-3-2019]%[2H3K2-8]
	Trong không gian với hệ tọa độ $Oxyz$, cho mặt phẳng $(P)\colon x+y-z+2=0$ và hai điểm $A(3;4;1)$, $B(7;-4;-3)$. Điểm $M(a;b;c)$, với $a>2$, thuộc mặt phẳng $(P)$ sao cho tam giác $ABM$ vuông tại $M$ và có diện tích nhỏ nhất. Tính giá trị biểu thức $a+b+c$.
...
\begin{vd}%[Đề tập huấn Sở Ninh Bình, 2019]%[Nguyễn Văn Hải, dự án(12EX-5-2019)]%[2H3G2-8]
	Trong không gian với hệ tọa độ $Oxyz$, cho hai mặt phẳng $(P) \colon x-y+z+3=0$, $(Q) \colon x+2y-2z-5=0$ và mặt cầu $(S) \colon x^2+y^2+z^2-2x+4y-6z-11=0$. Gọi $M$ là điểm di động trên $(S)$ và $N$ là điểm di động trên $(P)$ sao cho $MN$ luôn vuông góc với $(Q)$. Tìn giá trị lớn nhất của độ dài đoạn thẳng $MN$.
...
\begin{vd}%[Đề GHK2, Hàm Rồng, Thanh Hóa, năm 2019]%[Nguyễn Tiến Thùy, 12EX5-2019]%[2H3K2-8]
	Trong không gian với hệ tọa độ $Oxyz$, cho ba điểm $A(0;-2;-1)$, $B(-2;-4;3)$, $C(1;3;-1)$. Tìm điểm $M\in (Oxy)$ sao cho $\left|\overrightarrow{MA}+\overrightarrow{MB}+3\overrightarrow{MC}\right|$ đạt giá trị nhỏ nhất.
	\loigiai{
