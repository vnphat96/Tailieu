...
% \begin{ex}
% 	Cho $\cos\alpha=-\dfrac{5}{9}$ và $90^\circ<\alpha<180^\circ$. Tính các giá trị lượng giác của góc $\dfrac{\alpha}{2}$.
% 	\loigiai{
% 		Vì $90^\circ<\alpha<180^\circ$ nên $45^\circ<\dfrac{\alpha}{2}<90^\circ$. Suy ra $\sin\dfrac{\alpha}{2}>0$ và $\cos\dfrac{ \alpha}{2}>0$.\\
% 		Ta có \\
% 		$\cos^2\dfrac{\alpha}{2}=\dfrac{1+\cos\alpha}{2}\Rightarrow\cos\dfrac{\alpha}{2}=\dfrac{\sqrt{2}}{3}$; $\sin\dfrac{\alpha}{2}=\sqrt{1-\cos ^2\dfrac{\alpha}{2}}=\dfrac{\sqrt{7}}{3}$; $\tan\dfrac{\alpha}{2}=\dfrac{\sqrt{14}}{2}$; $\cot\dfrac{\alpha}{2}=\dfrac{\sqrt{14}}{7}$.
% 	}
% \end{ex}
\begin{ex}
