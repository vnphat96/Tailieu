...
%%%=============EX_8=============%%%
\begin{ex}%[0D3H2-3]
	\immini[thm]{Hàm số nào có đồ thị như hình vẽ bên?
		\choice
		{\True $y=-x^2+4x-3$}
		{$y=-x^2-4x-3$}
		{$y=-2x^2-x-3$}
...
\begin{ex}%[0D2V2-2] 
	...
	\loigiai{
		\begin{itemchoice}
			...
			\itemch \textbf{Sai.}\\
			\immini[thm]{Miền nghiệm của hệ $(I)$ là miền trong của tứ giác $ABCD$ kể cả bờ là các đoạn thẳng $AB$, $BC, CD, AD$ với $A(3; 0)$, $B(5; 1)$, $C(1; 5)$, $D(1; 3)$ (miền không bị gạch bỏ ở hình vẽ bên).}
