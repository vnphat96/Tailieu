...
{$[12 ;+\infty)$}
{$(-1 ; 0)$}
\loigiai{Ta có $A \setminus B=[-1 ; 0]$.
}
\end{ex}
...
{$C_B A=\{-4 ;-3 ;-2 ;-1 ; 0\}$}
	\loigiai{Ta có $A=\{0 ; 1 ; 2 ; 3\}, B=\{-4 ;-3 ;-2 ;-1 ; 0 ; 1 ; 2 ; 3 ; 4\}$.\\
	 Suy ra $C_B A=B \setminus A=\{-4 ;-3 ;-2 ;-1 ; 4\}$.
	}
\end{ex}
...
\choice
{$\mathbb{R} \setminus \mathbb{Q}=\mathbb{N}$}
...
\begin{center}
	\includegraphics[width=10cm]{images/0-GK1-CanhDieu-De6-NH23-24-H1}
\end{center}
	\choice
	{$96{,}4$}
	{$134{,}2$}
...
{\True $1358{,}56$}
	...
	$$
	\Rightarrow\hoac{
		&C \approx 20^{\circ} 55' 30^{\prime \prime} \\
		&C \approx 159^{\circ} 4' 30^{\prime \prime}~(\text{loại})}
	$$
	Nên $\widehat{B}=180^{\circ}-(\widehat{A}+\widehat{C}) \approx 129^{\circ} 4' 30^{\prime \prime}$\\
	Áp dụng công thức diện tích, ta có: $S=\dfrac{1}{2} A B \cdot B C \cdot \sin B=\dfrac{1}{2} \cdot 50 \cdot 70 \cdot \sin \left(129^{\circ} 4' 30 "\right) \approx 1358,56$.
	}
\end{ex}
...
%%==========Bài 1
\begin{bt}%[0D1K3-2]
Cho tập hợp $A=\{a, b, c, d\} ; B=\{b ; d ; e\} ; C=\{a ; b ; c\}$ Chứng minh: $$A \cap(B \setminus C)=(A \cap B) \setminus(A \cap C).$$
	\loigiai{
Ta có $B \setminus C=\{d ; e\} \Rightarrow A \cap(B \setminus C)=\{d\}$
$$
A \cap B=\{b ; d\}, A \cap C=\{a ; b ; c\} \Rightarrow(A \cap B) \setminus(A \cap C)=\{d\}
$$
Vậy $A \cap(B \setminus C)=(A \cap B) \setminus(A \cap C)$
	}
\end{bt}
...
\end{enumerate}
	...
	\begin{enumerate}
		...
		\begin{aligned}
			...
			& \Rightarrow B \approx 83^{\circ} 25' \\
			& \Rightarrow C=180^{\circ}-(A+B) \approx 180^{\circ}-\left(60^{\circ}+83^{\circ} 25'\right)=36^{\circ} 35' .
		\end{aligned}
		$$
