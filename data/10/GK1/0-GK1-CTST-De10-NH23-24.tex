...
\begin{ex}%[0-GK1-NH22-23--TeamTeXHoa--Võ Thị Thùy Trang]%[0T2B1-2]
	...
	{\True \begin{tikzpicture}[>=stealth,x=1cm,y=1cm,scale=.5]
			...
			\path[fill=green,opacity=0.5] (-1.5,4)-|(-4,-4)--(2.5,-4)--cycle;
			\draw (-1.5,4)--(2.5,-4);
	...
	{\begin{tikzpicture}[>=stealth,x=1cm,y=1cm,scale=.5]
			...
			\draw[->] (0,-4)--(0,4) node[left]{$y$};
			\draw (0,0)node[below left]{$O$};
			\path[fill=green,opacity=0.5] (-4,2.5)|-(4,-4)--(4,-1.5)--cycle;
			\draw (-4,2.5)--(4,-1.5);
...
\begin{ex}%[0-GK1-NH22-23--TeamTeXHoa--Võ Thị Thùy Trang]%[0T2B1-2]
	...
	{\begin{tikzpicture}[>=stealth,x=1cm,y=1cm,scale=.5]
			...
			\draw[->] (0,-4)--(0,4) node[left]{$y$};
			\draw (0,0)node[below left]{$O$};
			\path[fill=blue,opacity=0.6] (-0.5,-4)-|(4,4)--(3.5,4)--cycle;
			\draw (-0.5,-4)--(3.5,4);
...
\begin{ex}%[0-GK1-NH22-23--TeamTeXHoa--Võ Thị Thùy Trang]%[0T2B2-2]
	Điểm $M\left(x;y\right)$ là điểm có tung nhỏ nhất thuộc miền nghiệm của hệ bất phương trình $\heva{&2x+y\le 1\\&x-y\le 2\\&5x+y\ge -4}$. Tính $F=y-x$.
	\choice
	{$-8$}
	{$2$}
	{\True $-2$}
	...
	\loigiai{
		...
		\begin{center}
			\begin{tikzpicture}[>=stealth,x=1cm,y=1cm,scale=1]
				...
				\path[fill=red,opacity=0.5] (-2.5,7)-|(4,-4)--(3,-4)--cycle;
				\draw (-2.5,7)--(3,-4);
...
\setcounter{bt}{35}
%%==========Bài 1
\begin{bt}%[0-GK1-NH22-23--TeamTeXHoa--Võ Thị Thùy Trang]%[0T1k3-4]
	Cho tập $A=\left\{x \in \mathbb{R} \Big| \dfrac{1}{|x-2|}>\dfrac{1}{2}\right\}$ và $B=\{x \in \mathbb{R}|1 \leq | x | \leq 2\}$. Tìm $(A\cup B)\setminus (A\cap B)$.
	\loigiai{
		Với $x \neq 2$, ta có $\dfrac{1}{|x-2|}>\dfrac{1}{2} \Rightarrow|x-2|<2 \Rightarrow 0<x<4$, suy ra $A=(0 ; 4)\setminus\{2\}$.\\
		Ta có $1 \leq|x| \leq 2 \Rightarrow \hoac{&1 \leq x \leq 2 \\& -2 \leq x \leq-1}$, suy ra $B=[-2 ;-1] \cup[1 ; 2]$.\\
		$
		A \cup B=[-2 ;-1] \cup(0 ; 4)$,  $A \cap B=[1 ; 2)$.\\
		Suy ra $(A \cup B)\setminus (A \cap B)=[-2 ;-1] \cup(0 ; 1) \cup[2 ; 4)$.	}
\end{bt}
\begin{bt}%[0-GK1-NH22-23--TeamTeXHoa--Võ Thị Thùy Trang]%[0T2k2-2] 
	Tìm giá trị lớn nhất của biết thức $F(x;y)=x+2y$, biết $x$, $y$ thỏa mãn các điều kiện $\heva{&0 \leq y \leq 4 \\& x \geq 0 \\& x-y-1 \leq 0 \\& x+2 y-10 \leq 0.}$
	\loigiai{
...
\end{bt}
\begin{bt}%[0-GK1-NH22-23--TeamTeXHoa--Võ Thị Thùy Trang]%[0T4G2-1]
	Cho hình chữ nhật $ABCD$ có $M$ là trung điểm của $AD$; $N$ là trung điểm của đoạn $BM$; $I$ là trung điểm của đoạn $NC$. Biết $AB=1$ và $\cos \widehat{BIM}=-\dfrac{1}{\sqrt{4097}}$. Tìm độ dài cạnh $BC$.
	\loigiai{
		\begin{center}
			\begin{tikzpicture}[>=stealth,line join=round,line cap=round]
				\draw[black] (0,0)coordinate(A)--(0:4)coordinate(B)--([turn]90:2)coordinate(C)--([turn]90:4)coordinate(D)--cycle;
				\coordinate(M) at ($(A)!0.5!(D)$);
				\coordinate(N) at ($(B)!0.5!(M)$);
				\coordinate(I) at ($(N)!0.5!(C)$);
				\draw (I)--(B)--(M)--(I) (N)--(C)--(M);
				\foreach \diem/\vitrin in {A/left,B/right,C/right,D/left,M/left,N/below,I/above} \fill[black](\diem)circle(1.5pt)node[\vitrin]{$\diem$};
			\end{tikzpicture}
			
		\end{center}
		Đặt $BC=2x\quad (x>0)$.\\
		Ta có $B M^2=C M^2=x^2+1$.
		\[
		\begin{aligned}
			& C N^2=\dfrac{2\left(C B^2+C M^2\right)-M B^2}{4}=\dfrac{2\left(4 x^2+x^2+1\right)-\left(x^2+1\right)}{4}=\dfrac{9 x^2+1}{4} . \\
			& B I^2=\dfrac{2\left(B N^2+B C^2\right)-C N^2}{4}=\dfrac{2\left(\dfrac{x^2+1}{4}+4 x^2\right)-\dfrac{9 x^2+1}{4}}{4}=\dfrac{25 x^2+1}{16} . \\
			& MI^2=\dfrac{2\left(M N^2+M C^2\right)-C N^2}{4}=\dfrac{2\left(\dfrac{x^2+1}{4}+x^2+1\right)-\dfrac{9 x^2+1}{4}}{4}=\dfrac{x^2+9}{16} .
		\end{aligned}
		\]
		Ta có
		\[
		\begin{aligned}
			& \cos \widehat{BIM}=\dfrac{IB^2+IM^2-MB^2}{2\cdot IB \cdot IM} \\
			\Leftrightarrow& \dfrac{25x^2+1}{16}+\dfrac{x^2+9}{16}-x^2-1 =-\dfrac{1}{\sqrt{4097}}\cdot 2 \sqrt{\dfrac{25 x^2+1}{16}} \cdot \sqrt{\dfrac{x^2+9}{16}}\\
			\Leftrightarrow& \sqrt{4097}\left(3-5 x^2\right)=\sqrt{25 x^2+1} \sqrt{x^2+9}. \\
			\Leftrightarrow& \heva{&3-5x^2\geq 0 \\&
				4097(3-5x^2)^2-(25x^2+1)(x^2+9)= 0}\\
			\Leftrightarrow& \heva{&3-5 x^2 \geq 0 \\&
				256\left(400x^4-481x^2+144\right)=0}\\
			\Leftrightarrow& \heva{&3-5x^2 \geq 0\\&256(4x-3)(4x+3)(5x-4)(5x+4)= 0}
			\Leftrightarrow x=\dfrac{3}{4}.
		\end{aligned}
		\]
		Do đó $BC=2x=\dfrac{3}{2}$.	
	}
\end{bt}
