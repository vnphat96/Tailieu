...
\begin{ex}%[0D1N2-3]%[KNTT - Lớp 10 - Ôn tập giữa học kì 1 - Đề 2]%[Phamhaiduong]
	\immini[thm]{Hình vẽ bên biểu diễn cho tập hợp nào trên trục số?}{\begin{tikzpicture}[>=stealth,line width=1pt]
...
\begin{ex}%[0H4V3-2]%[KNTT - Lớp 10 - Ôn tập giữa học kì 1 - Đề 2]%[Phamhaiduong]
	...
	\loigiai{\immini[thm]{Ta có $\widehat{C A D}=\widehat{C B D}+\widehat{A D B}$\\
