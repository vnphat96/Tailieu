...
% 	Cho mạch điện gồm $4$ bóng đèn, xác suất hỏng của mỗi bóng là $0{,}05$. Tính xác suất để khi cho dòng điện chạy qua mạch điện thì có ít nhất một bóng sáng.
% 	\begin{center}
% 		\usetikzlibrary{circuits.ee.IEC}
% 		\begin{tikzpicture}[circuit ee IEC]
% 			\draw (0,0)--(0.5,0) (0.5,-0.5)--(0.5,0.5) (1.5,0.5)--(1.5,-0.5) (1.5,0)--(2,0) (2,-0.5)--(2,0.5) (3,0.5)--(3,-0.5) (3,0)--(3.5,0);
% 			\draw (0.5,-0.5) to[bulb] (1.5,-0.5) (0.5,0.5) to[bulb] (1.5,0.5) (2,-0.5) to[bulb] (3,-0.5) (2,0.5) to[bulb] (3,0.5);
% 		\end{tikzpicture}
% 	\end{center}
% 	\loigiai{
