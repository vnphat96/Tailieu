...
\begin{note}
	...
	% \begin{multicols}{2}
		\begin{itemize}
		\item $\tan \alpha = \dfrac{\sin \alpha}{\cos \alpha}$ với $\alpha \ne 90^\circ$ \quad và \quad $\cot \alpha = \dfrac{\cos \alpha}{\sin \alpha}$ vói $\alpha \ne 0^\circ,\ 180^\circ$.
		\item $\tan \alpha = \dfrac{1}{\cot \alpha}$ với $\alpha \ne 0^\circ, 90^\circ, 180^\circ$.
	\end{itemize}
	% \end{multicols}	
\end{note}
...
\begin{dang}{Tính các giá trị lượng giác của các góc cho trước}
	...
	\begin{multicols}{2}
		...
		\begin{tabular}{|c|c c c c c|}
			\hline
			Góc $\alpha$ & $0^\circ$ &     & $90^\circ$ &  & $180^\circ$   \\
			\hline
			$\sin\alpha$ & $0$ &$+$ & $1$ & $+$ & $0$\\
			\hline
			$\cos\alpha$ & $1$ &$+$ & $0$ & $-$ & $-1$\\
			\hline
			$\tan\alpha$ & $0$ & $+$ & $\parallel$ & $-$ & $0$\\
			\hline
			$\cot\alpha$ & $\parallel$ & $+$ & $0$ & $-$ & $\parallel$\\
			\hline
		\end{tabular}		
	\end{multicols}
\end{dang}
...
\end{dang}
\begin{vd}%[0H4H1-2]
	Cho $a=\sin x$, $b=\cos x\sin x$, $c=\cos x\cos y$. Chứng minh rằng $a^2+b^2+c^2=1$\\
	\dongcham{3}
	\loigiai{Ta có:
		\begin{align*}
