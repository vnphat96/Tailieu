...
\begin{dang}{Định lí côsin}
	\begin{multicols}{2}
		\begin{itemize}
			\item \immini{Trong tam giác $ABC$ với $BC=a$, $CA=b$, $AB=c$, ta có
				$$
				\begin{aligned}
...
\begin{vd}%[Tex hóa THPT]%[Phạm Tuấn]%[0H4H2-1]
	...
	\begin{tikzpicture}[scale=.7, font=\footnotesize, line join=round, line cap=round,>=stealth]
		...
		\draw pic["$112^{\circ}$", draw=black, double, angle eccentricity=1.6, angle radius=0.5cm]{angle=P--N--M};
...
\begin{vd}%[24-25 Bài giảng K10-K11, Phạm Tuấn]%[0H4H2-1]
	\immini{Cho tứ giác $ACBD$ như hình vẽ dưới. Các mệnh đề sau đúng hay sai?
	\choiceTF[t]
...
\loigiai{
	\begin{itemchoice}
		...
		\itemch  Áp dụng định lí côsin cho tam giác $ACD$ ta có
		\[
...
\loigiai{
	...
	\]
	Áp dụng hệ quả định lí côsin ta có $\cos A = \dfrac{AB^2+AC^2-BC^2}{2AB \cdot AC} \approx 0{,}768$.\\
