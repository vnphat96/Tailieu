...
\end{tikzpicture}}
	\loigiai{
	\immini[thm]{Vì tam giác $A B C$ vuông tại $C$ nên ta có $$\tan A=\dfrac{B C}{A C}=\dfrac{B C}{16}\Rightarrow \mathrm{BC}=16 \cdot \tan \mathrm{A}=16 \cdot \tan 56,5^{\circ} \approx 24,2 \mathrm{~m}$$
