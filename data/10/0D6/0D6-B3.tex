...
\begin{vd}%[0D4B5-1]
	...
	\loigiai{
		\begin{enumEX}[a)]{1}
			\item \immini[thm]{Từ đồ thị hình a) ta có nghiệm của tam thức bậc hai $f(x)$ là $x=2$. Bảng xét dấu của tam thức là}{
				\begin{tikzpicture}
			...
			\item \immini[thm]{Từ đồ thị hình b) ta có tam thức bậc hai $f(x)$ có $2$ nghiệm $x_1=-4$ và $x_2=-1$. Bảng xét dấu của tam thức là}{
				\begin{tikzpicture}
					\tkzTabInit[deltacl=0.6,espcl=2.5,lgt=2,nocadre=false]
					{$x$/0.6,$f(x)$/0.6}
					{$-\infty$,$-4$,$-1$,$+\infty$}
			...
			\item \immini[thm]{Từ đồ thị hình c) ta có nghiệm của tam thức bậc hai $f(x)$ là $x_1=-1$ và $x_2=2$. Bảng xét dấu của tam thức là}{
				\begin{tikzpicture}
					\tkzTabInit[deltacl=0.6,espcl=2.5,lgt=2,nocadre=false]
					{$x$/0.6,$f(x)$/0.6}
					{$-\infty$,$-1$,$2$,$+\infty$}
...
\begin{bt}%[0D4B5-1]
	...
	\loigiai{
		\begin{enumEX}[a)]{1}
			\item \immini[thm]{Từ đồ thị hình a) ta có nghiệm của tam thức bậc hai $f(x)$ là $x=1$. Bảng xét dấu của tam thức là}{
				\begin{tikzpicture}
					\tkzTabInit[deltacl=0.6,espcl=2.5,lgt=2,nocadre=false]
					{$x$/0.6,$f(x)$/0.6}
					{$-\infty$,$1$,$+\infty$}
			...
			\item \immini[thm]{Từ đồ thị hình b) ta có tam thức bậc hai $f(x)$ vô nghiệm. Bảng xét dấu của tam thức là}{
				\begin{tikzpicture}
					\tkzTabInit[deltacl=0.6,espcl=2.5,lgt=2,nocadre=false]
					{$x$/0.6,$f(x)$/0.6}
					{$-\infty$,,$+\infty$}
			...
			\item \immini[thm]{Từ đồ thị hình c) ta có nghiệm của tam thức bậc hai $f(x)$ là $x_1=-2$ và $x_2=1$. Bảng xét dấu của tam thức là}{
				\begin{tikzpicture}
					\tkzTabInit[deltacl=0.6,espcl=2.5,lgt=2,nocadre=false]
					{$x$/0.6,$f(x)$/0.6}
					{$-\infty$,$-2$,$1$,$+\infty$}
