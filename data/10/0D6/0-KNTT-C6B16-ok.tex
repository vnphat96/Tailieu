...
\begin{vd}%[0D3H2-3]%[Biên soạn tài liệu dạy học bộ KNTT-CS]%[Trần Xuân Hòa]
	\immini[thm]{Cho hàm số $y=a x^2+b x+c$ có đồ thị ở hình bên. Xác định dấu của $a$, $b$ và $c$.}{
		\begin{tikzpicture}[scale=0.8, font=\footnotesize, line join=round, line cap=round, >=stealth]
			\def\hso{\x*\x-3*\x+1.5}
...
\end{vd}
\begin{vd}%[0D3H2-3]%[Biên soạn tài liệu dạy học bộ KNTT-CS]%[Trần Xuân Hòa]
	\immini[thm]{Cho parabol $y=ax^2+bx+c$ có đồ thị như hình bên. Tìm phương trình của parabol.}
...
\begin{vd}%[0D3H2-3]%[Biên soạn tài liệu dạy học bộ KNTT-CS]%[Trần Xuân Hòa]
	\immini[thm]{Cho parabol $\left( P \right)\colon y=ax^2+bx+c~\left( a\ne 0 \right)$ có đồ thị như hình bên. Tính $2a+b+2c$.
	}
...
\end{vd}
\begin{vd}%[0D3V2-6]%[Biên soạn tài liệu dạy học bộ KNTT-CS]%[Trần Xuân Hòa]
	\immini[thm]{Hai bạn An và Bình trao đổi với nhau:
...
\end{tikzpicture}}
	...
	\loigiai{
		\immini[thm]{Chọn hệ trục tọa độ $Oxy$ sao cho một chân cổng đặt tại gốc tọa độ, chân còn lại đặt trên tia $Ox$.\\
...
\begin{ex}%[Biên soạn tài liệu dạy học bộ KNTT-CS]%[Trần Xuân Hòa]%[0D3H2-2]
	...
	{$y=-x^2+4x+3$}
	\loigiai{
		\immini[thm]{Xét hàm số $y=2x^2-8x$.\\
		Tọa độ đỉnh $I(2;-8)$.\\
...
\begin{ex}%[0D3V2-6]%[Biên soạn tài liệu dạy học bộ KNTT-CS]%[Trần Xuân Hòa]
	...
	\par\shortans[0]{$2{,}58$}
	\loigiai{
		\immini[thm]{Do bóng được đá từ độ cao $1{,}2$ m nên trong hệ trục tọa độ $Oth$ ta có parabol cắt trục $Oh$ tại điểm có tung độ $h=1{,}2$.\\
...
\begin{ex}%[0D3V2-6]%[KNTT-CS]%[Trần Xuân Hòa]
	...
	\par\shortans[0]{$30$}
	\loigiai{
		\immini[thm]{Chọn hệ trục tọa độ $O'xy$.\\
...
\begin{ex}%[0D3H2-1]%[KNTT-CS]%[Trần Xuân Hòa]
	\immini[thm]{Tìm công thức của hàm số bậc hai  có đồ thị như hình bên.}
