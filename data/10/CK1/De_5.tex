...
\loigiai
{\immini{Hai tam giác $ABC$ và $DBC$ có diện tích bằng nhau nhưng chúng không bằng nhau.}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round,>=stealth]
