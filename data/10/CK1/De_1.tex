...
Miền nghiệm của bất phương trình $x+y\geq 2$ là phần không bị gạch trong hình vẽ nào sau đây?
\begin{center}
\begin{tabular}{cccc}
...
\draw (-2,4) -- (4,-2);
% Miền nghiệm
\fill[pattern=north west lines, pattern color=gray!50] (-2,4) -- (4,-2) -- (-2,-2) -- (-2,4) -- cycle;
% Đánh dấu trục tọa độ
\foreach \x in {2}
\draw (\x,0.1) -- (\x,-0.1) node[below] {\x};
\foreach \y in {2}
\draw (0.1,\y) -- (-0.1,\y) node[left] {\y};
\end{tikzpicture} & \begin{tikzpicture}[>=stealth, line join=round, line cap=round, font=\footnotesize, scale=0.5]
% Trục tọa độ
\draw[->] (-2,0) -- (4,0) node[right] {$x$};
\draw[->] (0,-2) -- (0,4) node[above] {$y$};
% Đường thẳng x + y = 2
\draw (-2,4) -- (4,-2);
% Miền nghiệm
\fill[pattern=north west lines, pattern color=gray!50] (-2,4) -- (4,-2) -- (4,4) -- (-2,4) -- cycle;
% Đánh dấu trục tọa độ
\foreach \x in {2}
\draw (\x,0.1) -- (\x,-0.1) node[below] {\x};
\foreach \y in {2}
...
\draw (-4,-2) -- (2,4);
% Miền nghiệm
\fill[pattern=north west lines, pattern color=gray!50] (-4,-2) -- (2,4) -- (-4,4) -- cycle;
% Đánh dấu trục tọa độ
\foreach \x in {-2}
\draw (\x,0.1) -- (\x,-0.1) node[below] {\x};
\foreach \y in {2}
...
\draw (-4,-2) -- (2,4);
% Miền nghiệm
\fill[pattern=north west lines, pattern color=gray!50] (-4,-2) -- (2,4) -- (2,-2) -- cycle;
% Đánh dấu trục tọa độ
\foreach \x in {-2}
\draw (\x,0.1) -- (\x,-0.1) node[below] {\x};
\foreach \y in {2}
...
{Hình 4}
\loigiai{
Đường thẳng $x+y=2$  đi qua $(2;0);(0;2)$. Mặt khác $0+0\geq 2$ là vô lí nên $O(0;0)$ không thuộc miền nghiệm.
}
\end{ex}
...
\begin{ex}%[0H4N2-2]%[VN-MT6, Đào Trung Kiên]%[Sở Bắc Giang]
...
\loigiai{
Ta có $\overrightarrow{u} \cdot \overrightarrow{v}=2 \cdot 1+(-3) \cdot 4=-10$.
}
\end{ex}
...
\begin{ex}%[0H9N2-2]%[KNTT - Lớp 10 - Ôn tập cuối học kì 1 - Đề 5]%[Phạm Hải Dương]
