...
\begin{ex}%[HK1, THPT Lê Quảng Chí, 2023]%[TVN-001, 10-11EX-HK1-2324]%[0H9C2-6]
	...
	\loigiai{
		\immini{\begin{itemize}
				\item Tọa độ trung điểm $J$ của đoạn $BC$ là $J(2;-1)$.
				\item Gọi $I$ là điểm xác định sao cho $\overrightarrow{IA}+2\overrightarrow{IB}=\overrightarrow{0}$. Ta có $I\left(3;2\right)$.
				\item Khi đó
				      \begin{eqnarray*}
				      ...
				      \end{eqnarray*}
				\item Từ hình vẽ, ta thấy, điểm $I$, $J$ khác phía so với trục $Ox$. Do đó
				      \[MI+MJ\geq IJ\quad \text{và } MI+MJ=IJ\Leftrightarrow M=IJ\cap Ox.\]
				\item Ta có $IJ=\sqrt{10}$ hay $Q\geq 6\sqrt{10}$. Gọi $M(m;0)$, do $\overrightarrow{MI}$, $\overrightarrow{MJ}$ cùng phương nên $m=\dfrac{7}{3}$.
			\end{itemize}}
