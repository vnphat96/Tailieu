...
\begin{ex}
	\immini[thm]{Cho hình chữ nhật $ABCD$, khẳng định nào sau đây đúng?
		\choice
...
\begin{enumerate}
\item Phân tích các vectơ $\overrightarrow{AM}$, $\overrightarrow{BN}$ qua các vectơ $\overrightarrow{AB}$ và $\overrightarrow{AC}$.
\item Phân tích các vectơ $\overrightarrow{GC}$, $\overrightarrow{MN}$ qua các vectơ $\overrightarrow{GA}$ và $\overrightarrow{GB}$.
\end{enumerate}
\loigiai{
\immini[thm]{
\begin{enumerate}
