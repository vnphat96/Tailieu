...
\begin{ex}%[0H5H2-2]%[KNTT - Lớp 10 - Ôn tập cuối học kì 1 - Đề 5]%[Phạm Hải Dương]
	...
	\loigiai{
		Ta có $(\overrightarrow{AB} - \overrightarrow{DC}) - (\overrightarrow{AD} + \overrightarrow{CB}) = (\overrightarrow{AB} + \overrightarrow{BC}) - (\overrightarrow{AD} + \overrightarrow{DC}) = \overrightarrow{AC} - \overrightarrow{AC} = \overrightarrow{0}$.\\
...
\begin{ex}%[HK1, THPT Chuyên Lương Thế Vinh - Đồng Nai, 2023-2024]%[Cao Thành Thái, 10-11EX-HK1-2324]%[0H5H3-2]
	...
	\loigiai{
		\immini{Vì $G$ là trọng tâm của tam giác $ABC$ nên $\overrightarrow{AB}+\overrightarrow{AC}=3\overrightarrow{AG}$.
		}
		{
...
\begin{ex}
	...
	\loigiai{
		\begin{align*}
			\left(x+\dfrac{1}{x}\right)^4&=\mathrm{C}_4^0x^4+\mathrm{C}_4^1x^3\dfrac{1}{x}+\mathrm{C}_4^2x^2\dfrac{1}{x^2}+\mathrm{C}_4^3x\dfrac{1}{x^3}+\mathrm{C}_4^4\dfrac{1}{x^4}\\
			&=x^4+4x^2+6+4\dfrac{1}{x^2}+\dfrac{1}{x^4}.
		\end{align*}
		Vậy hệ số của $x^2$ trong khai triển là $4$.
	}
\end{ex}
