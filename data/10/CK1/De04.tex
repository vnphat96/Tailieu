...
\begin{ex}
\immini[thm]{Cho ba lực $\vec{F_1}=\vec{MA},\vec{F_2}=\vec{MB},\vec{F_3}=\vec{MC}$ cùng tác động vào một vật tại điểm M và vật đứng yên như hình vẽ. Biết cường độ của lực $\vec{F}_3$ là $50\sqrt{3}N$, $\widehat{AMB}=120^\circ,\widehat{AMC}={{150}^\circ}$. Tìm cường độ của lực $\vec{F_1}$.}
