...
\loigiai{
\immini{
Vì $\overrightarrow{A B}$ và $\overrightarrow{C D}$ là hai véc-tơ đối nhau nên $\overrightarrow{AB}+\overrightarrow{CD}=\overrightarrow{0}$.
}
...
\choiceTF
{Tọa độ véc-tơ $\overrightarrow{AC}=(4; 7)$}
{\True Trung điểm của $AB$ là $I(-1; 1)$}
{Đoạn thẳng $BC$ có độ dài bằng $15$}
{\True Tích vô hướng của hai véc-tơ $\overrightarrow{AB}$ và $\overrightarrow{AC}$ bằng $12$}
\loigiai{
\begin{itemchoice}
