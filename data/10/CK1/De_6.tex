...
\end{ex}
\begin{ex}
	Có bao nhiêu hệ số lớn hơn $100$ trong khai triển nhị thức Newton $(3x+2y)^5$.
	\loigiai{
		\begin{align*}
			(3x+2y)^5&=\mathrm{C}^0_5(3x)^5(2y)^0+\mathrm{C}^1_5(3x)^4(2y)^1+\mathrm{C}^2_5(3x)^3(2y)^2+\mathrm{C}^3_5(3x)^2(2y)^3+\mathrm{C}^4_5(3x)^1(2y)^4+\mathrm{C}^5_5(3x)^0(2y)^5\\
			&=243x^5+810x^4y+1080x^3y^2+720x^2y^3+240xy^4+32y^5.
		\end{align*}
		Vậy có $2$ hệ số lớn hơn $100$ là $1080$ và $720$.
	}
\end{ex}
...
\begin{ex}
	...
	\loigiai{
		Ta có
		\begin{align*}
			&(2\vec{a}+3\vec{b})\cdot (\vec{a}-2\vec{b})=0\\
			\Rightarrow& 2\vec{a}\cdot \vec{a}-4\vec{b}\cdot \vec{a}+3\vec{b}\cdot \vec{a}-6\vec{b}\cdot \vec{b}=0\\
			\Rightarrow& 2|\vec{a}|^2-\vec{a}\cdot \vec{b}-6|\vec{b}|^2=0\\
			\Rightarrow& 2\cdot 3^2-\vec{a}\cdot \vec{b}-6\cdot 2^2=0\\
			\Rightarrow& \vec{a}\cdot \vec{b}=-6.
		\end{align*}
		Vậy $|\vec{a}-\vec{b}|=\sqrt{|\vec{a}|^2+|\vec{b}|^2-2\vec{a}\cdot \vec{b}}=\sqrt{3^2+2^2-2.(-6)}=5$.
	}
\end{ex}

\begin{ex}%[0H9C2-6]%[CTST-Lop 10-On-tap-cuoi-hoc-ki-1-De-6]%[Trần Hưng]
	Trong mặt phẳng tọa độ $Oxy$, cho điểm $M(3;1)$. Giả sử $A(a;0)$ và $B(0;b)$ là hai điểm nằm trên tia $Ox$, tia $Oy$ sao cho tam giác $MAB$ vuông tại $M$ và có diện tích nhỏ nhất. Tính giá trị của biểu thức $T=a^{2}+b^{2}$.
	\loigiai{
	Ta có $\overrightarrow{MA}=(a-3;-1)$, $\overrightarrow{MB}=(-3;b-1)$.\\
	Tam giác $MAB$ vuông tại $M$ khi và chỉ khi
	\[\overrightarrow{MA}\cdot \overrightarrow{MB}=0\Leftrightarrow -3(a-3)-(b-1)=0\Leftrightarrow b-1=-3(a-3) \Leftrightarrow  b=10-3a\]
	Với $a\geq 0$, $b\geq 0$, suy ra $0\leq a\leq \dfrac{10}{3}$.\\
	Ta có
	\[\begin{aligned}
	S_{MAB}=\dfrac{1}{2}MA\cdot MB&=\dfrac{1}{2}\sqrt{(a-3)^{2}+1}\cdot \sqrt{9+(b-1)^{2}}\\
	&=\dfrac{1}{2}\sqrt{(a-3)^{2}+1}\cdot \sqrt{9+[3(10-3a)]^{2}}\\
	&=\dfrac{1}{2}\sqrt{(a-3)^{2}+1}\cdot \sqrt{9+9(10-3a)^{2}}\\
	&=\dfrac{3}{2}[(a-3)^{2}+1] \ge \dfrac{3}{2}.
	\end{aligned}\]
