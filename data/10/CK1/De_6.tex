...
\begin{ex}%[De-chuan-hoa-so-13]%[Huỳnh Quy]%[0D1N1-1]
...
\loigiai
{
Phủ định của mệnh đề ``$\forall x\in \mathbb{R}, P(x)$'' là ``$\exists x\in \mathbb{R}, \overline{P(x)}$''.
}
\end{ex}
...
\begin{ex}%[Đề HK1 THPT Chuyên Võ Nguyên Giáp, Quảng Bình, 2022-2023]%[Nguyễn Trung Kiên, dự án 10EX-HK1-2223 đợt 2]%[0D1H3-3]
...
{$\dfrac{\sqrt{3}}{4}$}
\loigiai{
Ta có $A=\sin 30^\circ \cdot \cos 60^\circ=\dfrac{1}{2}\cdot\dfrac{1}{2}=\dfrac{1}{4}$.
}
\end{ex}
...
{\True $\overrightarrow{AB}+\overrightarrow{AD}+\overrightarrow{CI}=\overrightarrow{IA}$}
\loigiai{
\begin{center}
...
Khi đó $\overrightarrow{AB}+\overrightarrow{AD}+\overrightarrow{CI}=\overrightarrow{AC}+\overrightarrow{CI}=\overrightarrow{AI}$.
}
\end{ex}
...
\begin{ex}%[24-25-Bai-Giang-K10-K11, Tran Quoc]%[0H5N4-1]
...
\loigiai{Khẳng định \lq\lq $0\cdot \overrightarrow{a}=0$\rq\rq~là sai vì $0\cdot \overrightarrow{a}=\overrightarrow{0}$.}
\end{ex}
...
\Opensolutionfile{ans}[ans/ansDe6-TN2]
