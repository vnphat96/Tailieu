...
Trong mặt phẳng $Oxy$, cho $\overrightarrow{a}=\left(-5;0\right)$, $\overrightarrow{b}=\left(4;x\right)$. Tìm giá trị $x$ để hai véc-tơ $\overrightarrow{a}$ và $\overrightarrow{b}$ cùng phương.
\choice
{$x=-1$}
{\True $x=0$}
{$x=4$}
