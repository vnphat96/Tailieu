...
% \begin{boxtb}
\subsubsection{Tích của một vectơ với một số}%[Trần Quốc, BG10-2022, Nhóm 9]
\begin{dn}{}
\immini{
\begin{itemize}
\item Tích của một vectơ $\overrightarrow{a}\ne \overrightarrow{0}$ với một số $k>0$ là một vectơ, kí hiệu là $k\overrightarrow{a}$, cùng hướng với vectơ $\overrightarrow{a}$ và có độ dài bằng $k|\overrightarrow{a}|$.
\item Tích của một vectơ $\overrightarrow{a}\ne \overrightarrow{0}$ với một số $k<0$ là một vectơ, kí hiệu là $k\overrightarrow{a}$, ngược hướng với vectơ $\overrightarrow{a}$ và có độ dài bằng $(-k)|\overrightarrow{a}|$.
\end{itemize}
}
...
\item Cho tam giác $ABC$, điểm $G$ là trọng tâm của tam giác $ABC$ khi và chỉ khi $\overrightarrow{GA}+\overrightarrow{GB}+\overrightarrow{GC}=\overrightarrow{0}$.
\end{itemize}
\end{note}
\begin{note}
\immini{Cho hai vectơ không cùng phương $\overrightarrow{a}$ và $\overrightarrow{b}$. Khi đó, mọi vectơ $\overrightarrow{u}$ đều biểu thị (phân tích) được một các duy nhất theo hai vectơ $\overrightarrow{a}$ và $\overrightarrow{b}$, nghĩa là có duy nhất cặp số $(x,y)$ sao cho $\overrightarrow{u}=x\overrightarrow{a}+y\overrightarrow{b}$.}
{\begin{tikzpicture}[font=\footnotesize,line join=round, line cap=round, >=stealth,scale=0.8] 
	\tkzDefPoints{0/0/O, -1/2/x, 3/0/y};
	\path ($(x)+(y)$) coordinate (u)
			($(O)!0.5!(x)$) coordinate (A)
			($(O)!0.4!(y)$) coordinate (B);
	\draw[->] (O)--(A) node[pos=.5,left]{$\overrightarrow{a}$};
	\draw[->] (O)--(B) node[pos=.5,below]{$\overrightarrow{b}$};
	\draw[->] (O)--(u) node[pos=.5,above]{$\overrightarrow{u}$};
	\draw[dashed, gray] (A)--(x)--(u)--(y)--(B);
\end{tikzpicture}}
\end{note}
% \end{boxtb}
...
\begin{ex}%[Trần Quốc, BG10-2022, Nhóm 9]%[0H1Y3-1]
	\immini{Cho hai vectơ  $\overrightarrow{AB}$ và $\overrightarrow{CD}$ trong hình bên. Khẳng định nào sau đây đúng?
		\choice
...
\begin{ex}%[Huỳnh Đức Vũ, BG10-2022, Nhóm 9]%[0H1B3-2]
	...
	\noindent \textbf{Đáp án}: \fbox{\phantom{Đáp án}}
	\loigiai{
		\begin{center}
...
\end{ex}
\begin{ex}%[Huỳnh Đức Vũ, BG10-2022, Nhóm 9]%[0H1G3-2]
...
\begin{ex}%[Huỳnh Đức Vũ, BG10-2022, Nhóm 9]%[0H1B3-2]
	...
	\begin{enumerate}
		\item  $\overrightarrow{EA} + \overrightarrow{EB} + 2\overrightarrow{EC} = x\overrightarrow{AB}$.\qquad \textbf{Đáp án}: \fbox{\phantom{Đáp án}}
		\item  $\overrightarrow{EB} + 2\overrightarrow{EA} + 4\overrightarrow{ED} = y\overrightarrow{EC}$.\qquad \textbf{Đáp án}: \fbox{\phantom{Đáp án}}
	\end{enumerate}
...
\begin{ex}%[Nguyễn Anh Tuấn, BG10-2022, Nhóm 9]%[0H1B3-3]
	\immini{Đẳng thức nào sau đây mô tả đúng hình vẽ bên?
		\choice
		{\True $3\overrightarrow{AI}+\overrightarrow{AB}=\overrightarrow{0}$}
		{$3\overrightarrow{IA}+\overrightarrow{IB}=\overrightarrow{0}$}
		{$\overrightarrow{BI}+3\overrightarrow{BA}=\overrightarrow{0}$}
...
\begin{vd}%[Nguyễn Tiến, BG10-2022, Nhóm 9]%[0H1B3-4]
	...
	\end{enumEX}
	\loigiai{Theo giả thiết thì $AB_1CG$ là hình bình hành.
		\immini{
			\begin{enumerate}
