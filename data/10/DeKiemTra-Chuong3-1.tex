...
\begin{ex}
	...
	{$\cot x>0$}
	\loigiai{
		Khi $x\in\left(90^\circ;180^\circ\right)$ thì $\heva{&\sin x>0\\&\cos x<0\\&\tan x<0\\&\cot x<0.}$ }
\end{ex}
\begin{ex}
...
\begin{ex}
	...
	\loigiai{
		Vì $90^\circ<x<180^\circ$ nên $\sin x>0$. Ta có
		\begin{eqnarray*}
...
\shortans{2323}
\loigiai{
\immini[thm]{Kí hiệu các điểm $A$, $B$, $C$ như hình bên.\\
...
% \shortans[oly]{$3{,}3$}
\loigiai{\immini[thm]{Gọi $H$, $K$ lần lượt là hình chiếu vuông góc của $A$ và $B$ lên đường thẳng $d$ và $D$ là hình chiếu vuông góc của $A$ lên đường thẳng $BK$.\\
