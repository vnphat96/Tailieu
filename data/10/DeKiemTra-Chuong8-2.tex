...
\begin{ex}%[Hữu Bình - BG Toán 10]%[1D2B2-2]
	Từ $10$ điểm phân biệt trong không gian có thể tạo thanh bao nhiêu vectơ khác $\vec{0}$?	
	\choice
	{$2^{10}$}
	{$\mathrm{P}_{10}$}
	{\True $\mathrm{A}^2_{10}$}
	{$\mathrm{C}^2_{10}$}
	\loigiai{
		Một vectơ khác $\vec{0}$ được tạo từ hai điểm phân biệt. Do đó số vectơ được tạo thành từ $10$ điểm phân biệt là một chỉnh hợp chập $2$ của $10$ phần tử. Vậy số vectơ được tạo thành là $\mathrm{A}^2_{10}$.	
	}
\end{ex}
