...
\begin{ex}%[0H3B1-2]%[Yến Trần BG10]
	...
	\loigiai{
		...
		Vậy phương trình đường thẳng là $y=3x+8$.	
	}
\end{ex}
\begin{ex}%[0H3B2-2]%[Yến Trần BG10]
...
\end{ex}
	...
	\begin{ex}%[0H3B1-2]%[Yến Trần BG10]
		Phương trình tham số của đường thẳng đi qua điểm $A(1 ;  -2)$ và vuông góc với đường thẳng $\Delta\colon  4 x-3 y+5=0$ là
		\choice
		{$\heva{&x=1-4 t \\& y=-2-3t}$}
		...
		\loigiai{Đường thẳng vuông góc với đường thẳng $\Delta\colon  4 x-3 y+5=0$ có véc-tơ pháp tuyến là $\vec{a}=\vec{n}_{\Delta}=(4;  -3)$.\\
			Phương trình tham số của đường thẳng đi qua điểm $A(1 ;  -2)$ và có véc-tơ pháp tuyến là $\vec{a}=(4;  -3)$ là $\heva{&x=1+4t\\&y=-2-3t.}$
		}
	\end{ex}
...
\begin{bt}%[0H3K1-2]%[Yến Trần BG10]
	Trong mặt phẳng tọa độ $Oxy$, cho đường tròn $(C) \colon (x-2)^2 + (y-1)^2=4$ và đường thẳng $d \colon 2x+y+m=0$. Viết phương trình đường thẳng $\Delta$ đi qua tâm đường tròn $(C)$ và vuông góc với đường thẳng $d$.
	\loigiai{
