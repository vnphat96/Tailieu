...
%
%\begin{vd}
%	Lập PTTS của đường thẳng $\Delta$ đi qua $M(2;-3)$ và có  véc-tơ  chỉ phương $\vec{u}(4;-1)$.
%	\loigiai{
...
%		\item Lập PTTS của đường thẳng $\Delta_2$ đi qua $B$ và có véc-tơ chỉ phương $\overrightarrow{v}$.
