...
%CÁNH DIỀU
\begin{bt}
	\immini[thm]{Cho mạch điện như \emph{Hình 3}. Biết $U=20$ V, $r_1=1\ \Omega$, $r_2=0,5\ \Omega$, $R=2\ \Omega$. Tìm cường độ dòng điện $I_1,I_2,I$ trong mỗi nhánh.}
	{
...
\end{bt}
\begin{bt}
\immini[thm]{Cho mạch điện như \emph{Hình 4}. Biết $U=24$ V, $\text{Đ}_1:12\ \mathrm{V}-6\ \mathrm{W}$, $\text{Đ}_2: 12\ \mathrm{V}-12\ \mathrm{W}$, $R=3\ \Omega$.
	\begin{enumerate}[a)]
