...
\end{bt}
\begin{center}
	\color{cyan}\fbox{\faArrowCircleRight\,\bfseries CÂU HỎI TRẮC NGHIỆM \faArrowCircleLeft}
\end{center}
\setcounter{ex}{0}
...
\begin{ex}%[0D3K2-4]
	Có bao nhiêu giá trị nguyên của tham số $m\in[-10;0]$ để phương trình $$\sqrt{x^2-x+m}=x-2.\qquad (1)$$ có nghiệm?
	\choice
	{$10$}
	{\True $9$}
	{$11$}
...
\begin{vd}
	\immini{
		Hằng ngày, bạn Hùng đều đón bạn Minh đi học tại một vị trí trên lề đường thẳng đến trường. Minh đứng tại vị trí $A$ cách lề đường một khoảng $50$ m để chờ Hùng. Khi nhìn thấy Hùng đạp xe đến địa điểm $B$, cách mình một đoạn\vspace*{0.3em}
	}{
