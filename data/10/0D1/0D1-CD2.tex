...
\begin{vd}%[0D1B4]
	...
	\loigiai{
		\begin{enumerate}
			\item $A\cap B=\left[-2;4\right]\cap \left(2;+\infty\right)=\left(2;4\right]$.
			\begin{center}
				\begin{tikzpicture}[>=stealth]
					\draw[->](-4,0)->(6,0);
					\IntervalLR{-4}{0}
					\def\skipInterval{0.5cm}%Khoảng cách đặt nhãn
					\IntervalGRF{}{}{\big(}{2}%Gạch xọc					
					\IntervalLR{4}{6}
					\def\skipInterval{0.5cm}%Khoảng cách đặt nhãn
					\IntervalGRF{\big]}{4}{}{}%Gạch xọc
				\end{tikzpicture}
			\end{center}
			\item $B\cap C=\left(2;+\infty\right)\cap (-\infty;3)=\left(2;3\right)$.
			\begin{center}
				\begin{tikzpicture}[>=stealth]
					\draw[->](-4,0)->(6,0);
					\IntervalLR{-4}{0}
				...
				\end{tikzpicture}
			\end{center}
			\item $A\cap C=\left[-2;4\right]\cap (-\infty;3)=\left[-2;3\right)$.
			\begin{center}
				\begin{tikzpicture}[>=stealth]
					\draw[->](-4,0)->(6,0);
					\IntervalLR{-4}{-2}
					...
					\IntervalLR{2}{6}
					\def\skipInterval{0.5cm}%Khoảng cách đặt nhãn
					\IntervalGRF{\big)}{3}{}{}%Gạch xọc
				\end{tikzpicture}
			\end{center}
			\item $\mathbb{R}\cap A=\left[-2;4\right]$.
			\begin{center}
				\begin{tikzpicture}[>=stealth]
					\draw[->](-4,0)->(6,0);
					\IntervalLR{-4}{-2}
				...
				\end{tikzpicture}
			\end{center}
			\item $\mathbb{R}\cap B=\left(2;+\infty\right)$.
			\begin{center}
				\begin{tikzpicture}[>=stealth]
					\draw[->](-4,0)->(6,0);
					\IntervalLR{-4}{0}
					...
					% \IntervalLR{5}{6}
					% \def\skipInterval{0.5cm}%Khoảng cách đặt nhãn
					% \IntervalGRF{}{}{}{}%Gạch xọc
				\end{tikzpicture}
			\end{center}
			\item $A\cap B \cap C=\left(2;4\right]\cap (-\infty;3)=\left(2;3\right)$.
			\begin{center}
				\begin{tikzpicture}[>=stealth]
					\draw[->](-4,0)->(6,0);
					\IntervalLR{-4}{0}
...
\begin{vd}%[Hồ Thúy]%[0D1G4]
	...
	\end{tasks}
	\loigiai{
		$\bullet$ $|x+2|<2 \Leftrightarrow -2< x+2 < 2 \Leftrightarrow -4 < x < 0$, nên $A=(-4;0)$.\\
		$\bullet$ $|x+4|\geq 3 \Leftrightarrow x+4\leq -3 \text{ hoặc } x+4\geq 3 \Leftrightarrow x\leq -7 \text{ hoặc } x\geq -1$, nên $B=(-\infty;-7]\cup [-1;+\infty)$.\\
		$\bullet$ $C=[-5;3)$.\\
		\begin{enumerate}
			\item $A \cup B=(-\infty;-7]\cup (-4;0)\cup [-1;+\infty)$.
			\item $A \cap B \cup C=(-4;0)\cup [-5;3) = [-5;3)$.
			\item Vì $A \subset C$ và $B \subset B$ nên $(A \cup B)\subset (B \cup C)$. Suy ra
			$$(A \cup B)\cap(B \cup C) = (A \cup B) = (-\infty;-7]\cup (-4;0)\cup [-1;+\infty).$$
		\end{enumerate}
	}
\end{vd}
...
\begin{vd}%[0D1B4]
	...
	\loigiai{
		\begin{enumerate}
			\item $\left(0;3\right)\setminus \left(2;4\right)=\left(0;2\right]$.
			\begin{center}
				\begin{tikzpicture}[>=stealth]
					\draw[->](-1,0)->(5,0);
					\IntervalLR{-1}{0}
				...
				\end{tikzpicture}
			\end{center}
			\item $\left(-4;2\right]\setminus \left[2;4\right)=(-4;2)$.
			\begin{center}
				\begin{tikzpicture}[>=stealth]
					\draw[->](-3,0)->(3,0);
					\IntervalLR{-3}{-1.5}
				...
				\end{tikzpicture}
			\end{center}
			\item $\mathbb{R}\setminus \left(-1;1\right)=(-\infty;-1]\cup [1;+\infty)$.
			\begin{center}
				\begin{tikzpicture}[>=stealth]
					\draw[->](-3,0)->(3,0);
					\IntervalLR{-3}{-1}
...
\begin{vd}%[0D1K3-3]
	...
	\end{enumerate}
	\loigiai{
		\textbf{Cách 1:} Sử dụng sơ đồ Ven.\\
		\begin{center}
...
\begin{bt}%[0D1B3-3]
	...
	\loigiai{
		...
		Theo đề $n(A)=25$, $n(B)=20$, $n(A \cap B) =10$.\\
		Vậy số học sinh cả lớp là $n(A \cup B) =n(A)+n(B)-n(A \cap B)=25+20-10=35$.}
\end{bt}
...
\begin{bt}%[0D1K3-3]
	...
	\loigiai{
		...
		{Ký hiệu $ A $ là tập hợp những học sinh giỏi Anh,\\
			...
			$\bullet$ $n(T \cap V)=3,\; n(T \cap A)=4,\; n(V \cap A)=5, n(T \cap V \cap A)=2$.\\
			Số học sinh của nhóm là
			\begin{eqnarray*}
				|V \cup A \cup T|&=&n(V)+n(A)+n(T)-n(V \cap A)-n(T \cap A)-n(T \cap V)+n(T \cap V \cap A)\\
				&=&18+10+12-(3+4+5)+2=30.
			\end{eqnarray*}
