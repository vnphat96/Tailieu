...
\begin{vd}%[0D1H2-1]
	...
	\begin{enumerate}
		...
		\item Tập hợp $C$ các nghiệm của bất phương trình $2x+5> 0$\dotfill.
	\end{enumerate}
\loigiai{
	\begin{enumerate}
...
\begin{vd}
	...
	\begin{enumEX}{1}
		\item $A=\left\{\left. x\in \mathbb{R}\right|x^2-x+1=0\right\}$\dotfill.\\.\dotfill
		\item $B=\left\{\left. x\in \mathbb{Q}\right|\right.x^2-4x+2\left. =0\right\}$\dotfill.\\.\dotfill
		\item $C=\left\{\left. x\in \mathbb{Z}\right|\right.6x^2-7x+1\left. =0\right\}$\dotfill.\\.\dotfill
		\item $D=\left\{\left. x\in \mathbb{Z}\right|\right.\left| x\right|<\left. 1\right\}$\dotfill.\\.\dotfill
	\end{enumEX}
\loigiai{
	\begin{enumEX}{1}
...
\begin{vd}%[0D1H2-2]
	...
	\begin{enumerate}
		\item $A=\left\{-\sqrt{3}; \sqrt{3}\right\}$ và $B=\left\{x \in \mathbb{R} \mid x^2-3=0\right\}$\dotfill.\\.\dotfill
		\item $C$ là tập hợp các tam giác đều và $D$ là tập hợp các tam giác cân\dotfill.\\.\dotfill
		\item $E=\{x \in \mathbb{N} \mid x$ là ước của 12 $\}$ và $F=\{x \in \mathbb{N} \mid x$ là ước của 24 $\}$\dotfill.\\.\dotfill
	\end{enumerate}
\loigiai{
	\begin{enumerate}
		\item $A=B$.
...
\end{vd}
\begin{vd}%[0D1H2-2]
	Viết tất cả các tập con của tập hợp $A=\{a; b\}$.\dotfill.\\.\dotfill
...
\begin{enumerate}
	...
	\item $Y=A \cap B$ với $A=\left\{x \in \mathbb{R} \mid x^2<4\right\}$ và $B=\left\{x \in \mathbb{R} \mid x^2 \ge 1\right\}$.\dongcham{1}
	\item $Z=A \cup (B \cap C)$ với $A=\left\{x \in \mathbb{R} \mid x^2<4\right\}$ và $B=\left\{x \in \mathbb{R} \mid x^2 \ge 1\right\}$ \\và $C=\left\{x \in \mathbb{R} \mid x \ge 0 \right\}$.\dongcham{2}
\end{enumerate}
