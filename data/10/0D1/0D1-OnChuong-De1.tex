...
\loigiai{Mệnh đề sai là ``$-\pi<-2\Leftrightarrow\pi^2<4$'', vì $-\pi<-2$ là mệnh đề đúng và $\pi^2<4$ là mệnh đề sai.}
\end{ex}
...
{$A=\{0;1;2;3;4;5\}$}
{\True $A=\{1;2;3;4;5;6\}$}
\loigiai{Vì $x\in\mathbb{N}, x\le 5$ nên $x\in\{0;1;2;3;4;5\}\Rightarrow x+1\in\{1;2;3;4;5;6\}$ nên $A=\{1;2;3;4;5;6\}$.}
\end{ex}
...
{$2$}
{Vô số}
\loigiai{Vì $x^2\ge0$ và $y^2\ge0$ nên $x^2+y^2\ge0$, $\forall x$, $y\in\mathbb{R}$.\\
...
\loigiai{Ta có 
	\begin{itemize}
		\item $P\colon$ ``$3^2+1$ là số chẵn'' là mệnh đề đúng.
		\item $Q\colon$ ``$3$ là số lẻ'' là mệnh đề đúng.
	\end{itemize}
...
\loigiai{Mệnh đề $P\colon$ ``Nếu $a+b<2$ thì một trong hai số $a$ và $b$ nhỏ hơn $1$'' có cách phát biểu khác là ``Điều kiện đủ để một trong hai số $a$ và $b$ nhỏ hơn $1$ là $a+b<2$''.}
\end{ex}
...
\loigiai{Mệnh đề phủ định của mệnh đề ``$\forall x\in X,P(x)$'' là mệnh đề ``$\exists x\in X,\overline{P(x)}$''.\\
Do đó mệnh đề phủ định của mệnh đề ``Mọi động vật đều di chuyển'' là mệnh đề ``Có ít nhất một động vật không di chuyển''.}
\end{ex}
...
\loigiai{Phủ định của mệnh đề ``$\exists x\in\mathbb{R},x^2<0$'' là ``$\forall x\in\mathbb{R},x^2\ge0$''.}
\end{ex}
...
\loigiai{\begin{itemchoice}
		\itemch ``Nếu số $a$ chia hết cho $3$ thì $a$ chia hết cho $6$'' là mệnh đề sai vì nếu xét $a=3$ thì $a$ chia hết cho $3$ nhưng không chia hết cho $6$.
		\itemch ``Nếu $\triangle ABC$ cân tại $A$ thì $\triangle ABC$ có $AB=AC$'' là mệnh đề đúng.
		\itemch ``Tứ giác $ABCD$ là hình vuông khi và chỉ khi $ABCD$ là hình chữ nhật và có $AC$ vuông góc với $BD$'' là mệnh đề đúng.
		\itemch ``$\pi^2>10$'' là mệnh đề sai, vì $\pi^2\approx9{,}869<10$.
	\end{itemchoice}}
\end{ex}
...
\loigiai{\begin{itemchoice}
		\itemch Ta có mệnh đề phủ định là $\overline{P}\colon$ ``Hình thoi có hai đường chéo không vuông góc với nhau'' là mệnh đề sai.
		\itemch Ta có mệnh đề phủ định là $\overline{S}\colon$ ``$1\le-3$'' là mệnh đề sai.
		\itemch Ta có mệnh đề phủ định là $\overline{K}\colon$ ``phương trình $x^4-2x^2+2=0$ vô nghiệm'' là mệnh đề đúng vì $x^4-2x^2+2=\left(x^2-1\right)^2+1>0$, $\forall x\in\mathbb{R}$.
		\itemch Ta có mệnh đề phủ định là: $\overline{H}\colon``\left(\sqrt{3}-\sqrt{12}\right)^2\ne3''$ là mệnh đề sai.
	\end{itemchoice}}
\end{ex}
...
\begin{ex}%[Pj31--2-Đề KT Theo Bài--TeamTeXHoa--Phan Anh]%[0D1H1-3]
	Cho $x\in\mathbb{Z}$, xét hai mệnh đề chứa biến $A\colon``x\ge3$'' và $B\colon``x\le a$''. Để mệnh đề $B$ là phủ định của mệnh đề $A$ thì giá trị của $a$ là bao nhiêu?
	\par\shortans[oly]{2}
	\loigiai{
		Mệnh đề phủ định của $A$ là $\overline{A}\colon``x<3$''.\\
		Do $x\in\mathbb{Z}$ nên $\overline{A}\colon``x\le2$''.\\
		Do đó để mệnh đề $B$ là phủ định của mệnh đề $A$ thì $a=2$.
	}
\end{ex}
\begin{ex}%[Pj31--2-Đề KT Theo Bài--TeamTeXHoa--Phan Anh]%[0D1H1-2]
	Có bao nhiêu giá trị của $n\in\mathbb{N}$, $n\in(1;30)$ để mệnh đề $A\colon$``Nếu $2n^2+3n+1$ chia hết cho $2$ thì $n$ chia hết cho $3$'' là mệnh đề sai?
	\par\shortans[oly]{10}
	\loigiai{Mệnh đề $P\Rightarrow Q$ sai khi và chỉ khi $P$ đúng, $Q$ sai.\\
...
\par\shortans[oly]{1}
\loigiai{Gọi $A$, $B$, $C$ lần lượt là tập hợp học sinh chọn nhóm ngành Giáo dục, Y tế, Công nghệ thông tin.\\
