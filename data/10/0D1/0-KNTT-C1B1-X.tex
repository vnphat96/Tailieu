...
\begin{vd}%[0D1H1-2]%
	...
	\begin{enumerate}[a)]
		\item \lq\lq$2019$ chia hết cho $3$\rq\rq;\dotfill\\.\dotfill
		\item \lq\lq$\pi<3{,}15$\rq\rq;\dotfill\\.\dotfill
		\item \lq\lq Tam giác có hai góc bằng $45^{\circ}$ là tam giác vuông cân\rq\rq.\dotfill\\.\dotfill
	\end{enumerate}
\loigiai{
	\begin{enumerate}[a)]
...
\begin{vd}%[0D1H1-2]
		...
		\loigiai{
			\begin{itemchoice}
				\itemch \textbf{Sai}.\\ Vì $P(3)=30$ là giá trị chẵn.
				\itemch \textbf{Sai}.\\ Vì $P(4)+1=55$ không phải là số nguyên tố
				\itemch \textbf{Đúng}.\\ Vì với $n=3\Rightarrow P(7n)=P(21)=1380$; $P(n)+2025=P(3)+2025=2055$.\\ Suy ra $P(7n)<P(n)+2025$.
				\itemch \textbf{Sai}.\\ Vì $\dfrac{P(n)+1}{n+2}=\dfrac{3n^2+3n-5}{n+2}=3n-3+\dfrac{1}{n+2}$. Nhận thấy khi $n=-1$ hoặc $n=-3$ thì biểu thức $\dfrac{P(n)+1}{n+2}$ có giá trị nguyên. Mà số $n$ này không là số tự nhiên.
			\end{itemchoice}
		}
	\end{vd}
...
\begin{vd}%[0D1N1-4]%
	...
	\begin{enumerate}[a)]
		\item Phát biểu mệnh đề $P\Rightarrow Q$. Nhận xét tính đúng sai của mệnh đề đó.\\.\dotfill
		\item Phát biểu mệnh đề đảo của mệnh đề $P\Rightarrow Q$. Nhận xét tính đúng sai của mệnh đề đó.\\.\dotfill
	\end{enumerate}
\loigiai{
	\begin{enumerate}[a)]
...
\begin{vd}%[0D1H1-4]
	...
	\begin{enumerate}[a)]
		\item Phát biểu mệnh đề $P \Rightarrow Q$ và xét tính đúng sai của nó.\dotfill\\.\dotfill
		\item Phát biểu mệnh đề đảo của mệnh đề $P \Rightarrow Q$.\dotfill\\.\dotfill
	\end{enumerate}
\loigiai{
	\begin{enumerate}[a)]
...
\begin{vd}%[0D1H1-5]
	...
	\begin{multicols}{1}
		\begin{enumerate}[a)]
			\item \lq\lq$\forall x\in\mathbb{R}, x^2+2x+2>0$\rq\rq.\dotfill.
			\item \lq\lq$\exists x\in\mathbb{R}, x^2+3x+4=0$\rq\rq.\dotfill.
		\end{enumerate}
	\end{multicols}
\loigiai{
	\begin{enumerate}[a)]
...
\begin{ex}%[0D1H1-5]
	...
	\choiceTF[t]
	{\True \lq\lq Với $x\in\mathbb{R},\, x^2>2$\rq\rq\, là mệnh đề chứa biến}
	{$P$ là mệnh đề đúng}
	{$\overline{P}$ là mệnh đề sai}
	{\True Phủ định cua mệnh đề $P$ là $\overline{P}:$ \lq\lq $\exists\in\mathbb{R}\colon x^2\leq 0$\rq\rq}
\loigiai{
	\begin{itemchoice}
		\itemch Mệnh đề \lq\lq Với $x\in\mathbb{R},\, x^2>2$\rq\rq\, là mệnh đề chứa biến là khẳng định đúng.
...
\loigiai{
	\begin{itemchoice}
		...
		Suy ra $\dfrac{\cdot 2P(n)-1}{n-3}\in\mathbb{N}\Leftrightarrow\left(n-3\right)$ là ước của $1\Leftrightarrow n-3=1\Leftrightarrow n=4$.
	\end{itemchoice}
	}
\end{ex}
\begin{ex}%[0D1H1-2]
