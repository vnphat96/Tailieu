...
\begin{ex}%Câu 22%[0D1H3-5]
	...
	\loigiai{
		...
		Ta có $n(A)=25$; $n(B)=23$; $n(C)=6$; $n(A \cap B)=14$.\\
		Khi đó số học sinh chỉ chơi một môn thể thao là $n(A) + n(B) - n(A \cap B) + n(C)=25+23-14+6=40$.}
\end{ex}
%
\begin{ex}%Câu 7%[0D1H2-2]
...
\begin{ex}%Câu 22%[0D1H3-5]
	...
	\loigiai{
		Gọi $A$ là tập hợp các học sinh chơi bóng đá, $B$ là tập hợp các học sinh chơi bóng bàn.\\
		a có $n(A)=25$; $n(B)=23$; $n(A \cap B)=14$.\\
		Khi đó số học sinh chỉ chơi một môn thể thao là $n(A)+n(B)-2n(A \cap B)=25+23-2\cdot14=20$.}
\end{ex}
\Closesolutionfile{ans}
% \begin{center}	
