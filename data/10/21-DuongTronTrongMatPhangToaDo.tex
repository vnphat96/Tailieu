...
\begin{itemize}
	...
	\boxmini{$(x-a)^2+(y-b)^2=R^2.$ \quad (1)}
	\item Với các hằng số $a$, $b$, $c$ thoả mãn $a^2+b^2-c>0$, phương trình
	\boxmini{$x^2+y^2-2ax-2by+c=0$ \quad (2)}
	là phương trình của một đường tròn có tâm $I(a;b)$ và có bán kính $R=\sqrt{a^2+b^2-c}$.
	\item Cho đường tròn $(C)$ có tâm $I(a;b)$, bán kính $R$. Phương trình tiếp tuyến $\Delta$ của $(C)$ tại $M_0\left(x_0; y_0\right)$ là \boxmini{$\left(a-x_0\right) \cdot \left(x-x_{0}\right)+\left(b-y_{0}\right) \cdot\left(y-y_{0}\right)=0$.}
\end{itemize}
...
\begin{dang}{Phương trình tiếp tuyến của đường tròn}
	\begin{enumerate}
		\item Cho điểm $M(x_0;y_0)$ thuộc đường tròn $(C)\colon (x-a)^2+(y-b)^2=R^2$ (tâm $I(a;b)$, bán kính $R$). Khi đó, tiếp tuyến $\Delta$ của $(C)$ tại $M(x_0;y_0)$ có vectơ pháp tuyến $\overrightarrow{MI}=(a-x_0;b-y_0)$ và phương trình $\Delta\colon (a-x_0)(x-x_0)+(b-y_0)(y-y_0)=0$.
		\begin{center}
...
\begin{vd}%[Vương Quyền, BG10-KNTT-Tập 2]%[0H3B2-3]
	...
	\loigiai
	{
		...
		Tiếp tuyến của đường tròn $(\mathscr{C})$ tại $M(1;-1)$ có vectơ pháp tuyến là $\overrightarrow{IM}=\left(-\dfrac{1}{2};-\dfrac{3}{2}\right)$ hay $\overrightarrow{n}=(1;3)$.\\
...
\begin{bt}%[Vương Quyền, BG10-KNTT-Tập 2]%[0H3B2-3]
	...
	\loigiai{
		...
		Tiếp tuyến tại $M(-4;7)$ nhận vectơ pháp tuyến $\overrightarrow{IM}=(-3;4)$.\\
...
\begin{bt}%[Vương Quyền, BG10-KNTT-Tập 2]%[0H3B2-3]
	...
	\loigiai{
		Ta có đường tròn $(C)$ có tâm $I(1;3)$, tiếp tuyến $\Delta$ có một vectơ pháp tuyến là $\overrightarrow{IN}=(3;-4)$.\\
...
\begin{bt}%[Vương Quyền, BG10-KNTT-Tập 2]%[0H3G2-3]
	Trong mặt phẳng tọa độ $Oxy$, cho đường tròn $(C): x^2+y^2-6x+4y-7=0$ và điểm $A(5; 4)$ nằm ngoài đường tròn. Gọi tiếp điểm của tiếp tuyến kẻ từ $A$ đến đường tròn là $T_1$, $T_2$, với hoành độ $T_1$ nhỏ hơn hoành độ $T_2$. Tìm tọa độ của vectơ $\overrightarrow{T_1T_2}$. 
	\loigiai{
		Đường tròn có tâm $I(3; -2)$, bán kính $R = 2\sqrt{5}$.\\
		Gọi vectơ pháp tuyến của tiếp tuyến qua $A$ là $\overrightarrow{n}(a;b), ab \neq 0$. Ta có phương trình tiếp tuyến $\Delta: ax+by-5a-4b=0$.\\
