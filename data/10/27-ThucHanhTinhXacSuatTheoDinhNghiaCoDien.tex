...
\viduminhhoa	
\begin{vd}
	Gieo một con xúc xắc cân đối và đồng chất. Tính xác suất các biến cố sau
	\begin{enumerate}
		\item Xuất hiện mặt hai chấm.
		\item Xuất hiện mặt có số chấm lớn hơn $3$.
	\end{enumerate}
	\loigiai{
		\begin{enumerate}
			\item Xuất hiện mặt hai chấm.\\
			Số trường hợp của không gian mẫu là $n(\Omega)=6$.\\
			Gọi $A$ là biến cố xuất hiện mặt hai chấm. Số trường hợp thuận lợi của $A$ là $n(A)=1$.\\
			Xác suất xuất hiện mặt hai chấm là $\mathrm{P}(A)=\dfrac{n(A)}{n(\Omega)}=\dfrac{1}{6}$.\\
			\item Xuất hiện mặt có số chấm lớn hơn $3$.\\
			Số trường hợp của không gian mẫu là $n(\Omega)=6$.
			Gọi $B$ là biến cố xuất hiện mặt có số chấm lớn hơn $3$, suy ra $B=\{4;5;6\}$. Số trường hợp thuận lợi của $B$ là $n(B)=3$.\\
			Xác suất xuất hiện mặt có số chấm lớn hơn $3$ là $\mathrm{P}(B)=\dfrac{n(B)}{n(\Omega)}=\dfrac{3}{6}=\dfrac{1}{2}$.
		\end{enumerate}
	}
\end{vd}
\begin{vd}
	Gieo hai con xúc xắc cân đối đồng chất khác nhau. Tính xác suất để tổng số chấm trên hai mặt xuất hiện của hai con xúc xắc bằng $8$.
	\loigiai{
		\begin{itemize}
			\item Không gian mẫu là $ \Omega=\{(1;1),\,(1;2),\,(2;1),\,(1;3),\,(3;1),\,\ldots,\,(5;6),\,(6;6)\} $.\\
			Số phần tử của không gian mẫu là $ n(\Omega) = 6\cdot 6=36 $.
			\item Gọi $A$ là biến cố \lq\lq  Tổng số chấm trên hai mặt xuất hiện của hai con xúc xắc bằng $8$\rq\rq.\\
...
\setcounter{vd}{0}
\begin{vd}
	Gieo ngẫu nhiên một con xúc xắc cân đối và đồng chất hai lần. Tính xác suất để mặt sáu chấm xuất hiện ít nhất một lần.
	\loigiai
	{
		\begin{itemize}
...
\begin{bt}%[1D2K5-2]
	...
	\loigiai{
		...
		Gọi $D$ là biến cố \lq\lq  Không có học sinh nào của cùng một lớp đứng cạnh nhau\rq\rq.
		Để sắp xếp $10$ học sinh trong đó không có hai học sinh nào cùng lớp đứng cạnh nhau ta thực hiện các bước sắp xếp theo số học sinh từ nhiều đến ít như sau
		\begin{enumerate}[Bước 1:]
			\item Sắp xếp thứ tự $5$ học sinh lớp 11C thành một hàng có $5!$ cách.
			\item Vì giữa $5$ học sinh lớp 11C có $4$ khoảng trống cùng với $2$ vị trí đầu hàng nên nếu ta xếp cùng lúc $2$ học sinh lớp 11B ở đầu hàng, khi đó còn lại $3$ học sinh thì không đủ để xen vào giữa $4$ khoảng trống nên có các trường hợp sau:
			\begin{enumerate}[Trường hợp 1:]
				\item Sắp xếp $3$ lớp 11B vào $3$ trong $4$ khoảng trống giữa các học sinh 11C có $\mathrm{A}_4^3$ cách (ví dụ thứ tự học sinh là CBCBCBCC).\\
				Khi đó còn $1$ cặp học sinh 11C đứng cạnh nhau nên cần đặt $1$ học sinh lớp 11A vào đó có $2$ cách; và đặt học sinh còn lại vào các vị trí xen giữa các học sinh đã xếp hoặc đầu hàng có $8$ cách.\\
				Nên trường hợp này có $\mathrm{A}_4^3 \cdot 2 \cdot 8 = 384$ cách xếp học sinh lớp 11B và 11A.
				\item Chọn $1$ học sinh lớp 11B vào đầu hoặc cuối hàng và $4$ học sinh còn lại vào $4$ vị trí xen giữa $5$ học sinh lớp 11C có $\mathrm{C}_3^1 \cdot 2 \cdot 4! = 144$ cách.
			\end{enumerate}
		\end{enumerate}
		Suy ra $n(D) = 5!\cdot (384+144) = 63360$.\\
		Vậy xác suất của biến cố $D$ là
		$\mathrm{P}(D) = \dfrac{n(D)}{n(\Omega)} = \dfrac{63360}{10!} = \dfrac{11}{630}$.
	}
\end{bt}
...
\begin{ex}%[1D2Y5-2]
	Gieo ngẫu nhiên đồng thời hai con xúc xắc cân đối, đồng chất và khác màu. Tính xác suất để tổng số chấm trên hai mặt bằng $7$.
	\choice
	{$\dfrac{7}{9}$}
	{$\dfrac{5}{18}$}
	{$\dfrac{1}{9}$}
...
\begin{ex}%[1D2K5-5]
	Gieo một con xúc xắc đồng nhất $3$ lần. Gọi $A$ là biến cố có tổng số chấm xuất hiện ở $2$ lần gieo đầu bằng số chấm xuất hiện ở lần gieo thứ $3$. Xác xuất biến cố $A$ bằng
	\choice
	{$\dfrac{10}{216}$}
	{$\dfrac{12}{216}$}
	{\True $\dfrac{15}{216}$}
...
\begin{ex}%[1D2B5-2]
	Gieo ngẫu nhiên $2$ con xúc xắc cân đối đồng chất. Tìm xác suất của biến cố$\colon$ \lq\lq  Hiệu số chấm xuất hiện trên $2$ con xúc xắc bằng $1$ \lq\lq . 
	\choice
	{$\dfrac{2}{9}$}
	{$\dfrac{1}{9}$}
	{\True $\dfrac{5}{18}$}
...
\begin{ex}%[1D2B5-2]
	Kết quả $(b,c)$ của việc gieo con xúc xắc cân đối và đồng chất hai lần, trong đó $b$ là số chấm xuất hiện trong lần gieo đầu, $c$ là số chấm xuất hiện ở lần gieo thứ hai, được thay vào phương trình bậc hai $x^2+bx+c=0$. Tính xác suất để phương trình có nghiệm. 
	\choice
	{\True $\dfrac{19}{36}$}
	{$\dfrac{1}{2}$}
	{$\dfrac{1}{18}$}
