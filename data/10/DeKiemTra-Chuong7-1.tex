...
\end{ex}	
	...
	\begin{ex}%[0H3B1-2]%[Yến Trần BG10]
		...
		{\True $2x+y-4=0$}
		\loigiai{
			Phương trình đường thẳng đi qua hai điểm $A(2;0)$, $B(0;4)$ là $\dfrac{x}{2}+\dfrac{y}{4}=1\Leftrightarrow 2x+y=4\Leftrightarrow 2x+y-4=0$.
		}
	\end{ex}
	...
	\begin{ex}%[0H3Y1-2]%[Yến Trần BG10]
		...
		\loigiai{
			Đường thẳng $d$ đi qua điểm $(1; -2)$ và có vectơ chỉ phương $\overrightarrow{u}=(3; 5)$ có phương trình tham số là $d\colon \heva{&x=1+3t\\&y=-2+5t.}$
		}
	\end{ex}	
	...
	\begin{ex}%[0H3B1-2]%[Yến Trần BG10]
		...
		{$y=2x+10$}
		\loigiai{
			Phương trình đường thẳng đi qua $M\left( x_0;y_0 \right)$ và có hệ số góc $k$ có dạng $y=k\left( x-x_0 \right)+y_0$. \\ 
			Do đó phương trình đường thẳng đi qua $M\left( 3;4 \right)$ và có hệ số góc $k=2$ là 
...
\begin{ex}%[0H3Y1-1]%[Yến Trần BG10]
	...
	{$\left(3;-3\right)$}
	\loigiai{
		Ta có phương trình tham số của đường thẳng đi qua điểm $M\left(x_0;y_0\right)$ và có véc-tơ chỉ phương $\vec{u}=(a;b)$\\ có dạng $\heva{&x=x_0+at\\&y=y_0+bt.}$	\\
...
\begin{ex}%[0H3K1-2]%[Yến Trần BG10]
	Viết phương trình tham số của đường thẳng $d$ qua điểm $A(4;1)$ và vuông góc với đường thẳng $\Delta \colon x-3y+4=0$.
	\choice
	{$\heva{&x=t\\&y=4+3t}$}
	...
	\loigiai{
		...
		Vậy, phương trình tham số $d \colon \heva{&x=4+t\\&y=1-3t.}$}
\end{ex}
\begin{ex}%[0H3B1-2]%[Yến Trần BG10]
	...
	\loigiai{
		...
		Phương trình đường thẳng $d \colon 5(x-0) - 2(y-1) = 0 \Leftrightarrow 5x - 2y + 2 = 0$.	
	}
\end{ex}
...
\begin{ex}%[0H3B1-2]%[Yến Trần BG10]
	...
	{$3x+y+5=0$}
	\loigiai{
		Từ phương trình tham số của đường thẳng $\Delta$, ta có $\Delta$ đi qua $A(1;2)$.\\
	...
	\begin{bt}%[0H3K1-2]%[Yến TrầnBG10]
		...
		\loigiai{
			\begin{enumerate}
				...
				Ta lại có, đường thẳng $AB$ đi qua điểm $B(1;3)$ nên phương trình đường thẳng $AB$ là $$4(x-1)+(y-3)=0\Leftrightarrow 4x+y-7=0.$$
				...
				Ta lại có, đường thẳng $AC$ đi qua điểm $A(3;-5)$ nên phương trình đường thẳng $AC$ là $$ 4(x-3)+5(y-(-5))=0\Leftrightarrow 4x+5y+13=0.$$
