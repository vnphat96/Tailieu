...
\begin{ex}%[0D3H1-5]
	...
	\loigiai{
		...
		% \end{eqnarray*}
		Sử dụng chức năng bảng giá trị, ta thấy trên khoảng $(1;3)$ khi $x$ tăng, giá trị $f(x)$ cũng tăng. Suy ra hàm số đồng biến trên khoảng $(1;3)$ do đó nó cũng đồng biến trên khoảng $(2;3)$
	}
\end{ex}
...
\loigiai{\immini[thm]{Đổi đơn vị $40$ phút $=\dfrac{2}{3}$ h.\\
Gọi $A$ là vị trí đảo, $C$ là vị trí nhà ga, $B$ là vị trí nhà An và $D$ là vị trí mà An đi thuyền đến bến (hình vẽ).\\
Theo giả thuyết ta có $AC=3$ km, $BC=14$ km. Đặt $CD=x$ km.\\
Tổng thời gian mà An đã di chuyển từ đảo về nhà có đi bằng thuyền là
\[\dfrac{2}{3} =\dfrac{\sqrt{9+x^2}}{15}+\dfrac{14-x}{30}\]
\begin{eqnarray*}
& &\dfrac{2}{3} =\dfrac{\sqrt{9+x^2}}{15}+\dfrac{14-x}{30}\\
&\Leftrightarrow &x+6=2\sqrt{x^2+9}\\
&\Rightarrow & 3x^2-12x=0\Leftrightarrow\hoac{&x=0\\&x=4.}
\end{eqnarray*}
...
(3,-3) coordinate (D)
(3,-8) coordinate (B)
(1.5,-9) coordinate (FF) node[below]{ }
;
\foreach  \x in {0,-3,-8}{
...
\draw[<->,dashed] (0,1.3)--(3,1.3) node[above,midway]{$3$ km};
\draw (B)--(A)--(D);
\draw[<->,dashed] (3.7,0)--(3.7,-8) node[right,midway]{$14$ km};
\foreach \p/\g in {A/135,B/-45,C/45,D/-45}\fill[black] (\p) circle (1pt) +(\g:.5)node{$\p$};
\end{tikzpicture}}
\noindent Vì quãng đường từ nhà An đến bến thuyền ngắn hơn quãng đường đến ga cáp treo nên $x=4$ km.\\
Vậy khoảng cách giữa ga cáp treo và bến thuyền là $4$ km.
}
\end{ex}
...
An sống trong một căn nhà trên con đường dọc bờ biển. An làm việc ở một hòn đảo du lịch cách đường bờ biển $3$ km. Hằng ngày, sau giờ làm An di chuyển bằng cáp treo từ đảo về ga cáp treo nằm trên đường bờ biển tại vị trí gần hòn đảo nhất, sau đó đón xe buýt về nhà cách ga cáp treo $14$ km. Một ngày, do sự cố cáp treo nên An phải di chuyển bằng thuyền về bờ biển tại bến thuyền rồi đi xe ô tô về nhà ngay. Biết rằng, tổng thời gian để An về đến nhà là $40$ phút, tốc độ của thuyền là $15$ km/h và tốc độ của xe ô tô $30$ km/h; bến thuyền nằm trên đường bờ biển và quãng đường từ nhà An đến bến thuyền ngắn hơn quãng đường đến ga cáp treo.\\
Giả sử đường bờ biển là một đường thẳng và thuyền di chuyển trên một đường thẳng. Hãy tính khoảng cách giữa ga cáp treo và bến thuyền.
\loigiai{\immini{Đổi đơn vị $40$ phút $=\dfrac{2}{3}$ h.\\
Gọi $A$ là vị trí đảo, $C$ là vị trí nhà ga, $B$ là vị trí nhà An và $D$ là vị trí mà An đi thuyền đến bến (hình vẽ).\\
Theo giả thuyết ta có $AC=3$ km, $BC=14$ km. Đặt $CD=x$ km.\\
Tổng thời gian mà An đã di chuyển từ đảo về nhà có đi bằng thuyền là
\[\dfrac{2}{3} =\dfrac{\sqrt{9+x^2}}{15}+\dfrac{14-x}{30}\]
