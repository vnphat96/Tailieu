...
\begin{ex}
	...
	\loigiai{
		Sắp xếp $12$ học sinh thành hàng có $12!$ cách tuy nhiên khi xếp thành vòng tròn thì ứng với mỗi cách sắp xếp như trên có $12$ cách xếp trùng nó, nên có tất cả $\dfrac{12!}{12}=11!$ cách xếp $12$ học sinh thành vòng tròn. Suy ra $n(\Omega)=11!$.\\
		Gọi $A$ là biến cố \lq\lq Giữa mỗi hai học sinh nam hoặc có đúng $2$ học sinh nữ hoặc không có học sinh nữ nào\rq\rq.\\
		Xếp $6$ học sinh nam thành một vòng tròn có $\dfrac{6!}{6}=5!$ cách.\\
		Chọn $3$ trong $6$ vị trí giữa $6$ học sinh nam có $\mathrm{C}_{6}^{3}$ cách.\\
		Xếp $6$ học sinh nữ vào $6$ vị trí đã chọn ở trên có $6!$ cách.\\
		Vậy $n(A)=5! \cdot \mathrm{C}_6^3 \cdot 6!$. Do vậy $P(A)=\dfrac{n(A)}{n(\Omega)}=\dfrac{5! \cdot \mathrm{C}_6^3 \cdot 6!}{11!}=\dfrac{10}{231}$.
	}
\end{ex}
