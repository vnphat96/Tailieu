...
\textbf{Phương trình tổng quát của đường thẳng}
	...
	\boxmini{$\Delta \colon a(x-x_0) +b(y-y_0) = 0 \Leftrightarrow ax+by+c=0 (c=-ax_0-by_0).$}
...
\textbf{PTTS của đường thẳng}
	...
	\boxmini{$\Delta \colon \heva{&x= x_0 +  u_1 t\\&y =y_0 +u_2 t}$}
	với $t$ là tham số và $t \in \mathbb{R}$.\\
		\textbf{Nhận xét}
		\begin{itemize}
...
\begin{vd}%[0H3K1-6]
	...
	\loigiai{
		\begin{enumerate}
			...
			\immini[thm]{Khi đó, tọa độ điểm $I$ là nghiệm của hệ phương trình $$\heva{x-y+1&=0\\ x+y-3&=0.}$$
