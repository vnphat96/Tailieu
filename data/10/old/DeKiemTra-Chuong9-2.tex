...
\begin{ex}%[Nguyễn Kiều Nhã Tú- BG Toán 10]%[1D2Y5-4]
	Xét phép thử $T$: \lq\lq  Gieo một con xúc xắc\rq\rq\;  và biến cố $B$: \lq\lq  Số chấm trên mặt xuất hiện là một số lẻ\rq\rq. Tập hợp nào dưới đây mô tả biến cố $B$?
	\choice
	{\True $\{1;3;5\}$}
	{$\{2;3;4\}$}
	{$\{2;4;6\}$}
...
\begin{ex}%[1D2K5-2]
	Gieo một con xúc xắc cân đối và đồng chất có sáu mặt;  các mặt $1, 2, 3, 4$ được sơn đỏ, mặt $5, 6$ sơn xanh. Gọi A là biến cố được số lẻ, B là biến cố được nút đỏ (mặt sơn màu đỏ). Xác suất của $A \cap B$ là
	\choice
	{$\dfrac{3}{4}$}
	{\True $\dfrac{1}{3}$}
	{$\dfrac{2}{3}$}
...
\end{ex}
\begin{ex}%[Nguyễn Kiều Nhã Tú- BG Toán 10]%[1D2Y5-4]
	Xét phép thử $T$: \lq\lq  Gieo một con xúc xắc\rq\rq\;  và biến cố $Y$: \lq\lq  Số chấm trên mặt xuất hiện là một số lẻ\rq\rq. Tập hợp nào dưới đây mô tả biến cố $Y$?
	\choice
	{\True $\{1;3;5\}$}
	{$\{2;3;4\}$}
	{$\{2;4;6\}$}
...
\end{ex}
\begin{ex}%[Nguyễn Kiều Nhã Tú- BG Toán 10]%[1D2Y5-4]
	Xét phép thử $T$: \lq\lq  Gieo một con xúc xắc\rq\rq\
...
\end{ex}
\begin{ex}%[Nguyễn Kiều Nhã Tú- BG Toán 10]%[1D2Y4-1]
	Xét phép thử $T$: \lq\lq  Gieo một con xúc xắc\rq\rq\; có không gian mẫu là $\Omega=\{1 ; 2 ; 3 ; 4 ; 5 ; 6\}$. Xét biến cố $A$: \lq\lq  Số chấm trên mặt xuất hiện là số lẻ \rq\rq.	Số phần tử thuận lợi của biến cố $A$ là
	\choice
	{$6$}
	{ $94$}
	{$5$}
...
\end{ex}
\begin{ex}%[Nguyễn Kiều Nhã Tú- BG Toán 10]%[1D2B5-2]
	Gieo ngẫu nhiên một con xúc xắc cân đối và đồng chất. Tính xác suất của biến cố $A$: \lq\lq  Xuất hiện mặt có số chấm lẻ\rq\rq.
	\choice
	{$\dfrac{1}{6}$}
	{ $\dfrac{1}{4}$}
	{$\dfrac{1}{3}$}
...
\end{ex}
\begin{ex}%[Nguyễn Kiều Nhã Tú- BG Toán 10]%[1D2Y5-4]
	Gieo ngẫu nhiên một con xúc xắc cân đối và đồng chất. Tính xác suất của biến cố $B$: \lq\lq  Xuất hiện mặt có số chấm chia hết cho $4$\rq\rq.
	\choice
	{\True$\dfrac{1}{6}$}
	{ $\dfrac{1}{4}$}
	{$\dfrac{1}{3}$}
...
\end{ex}
\begin{ex}%[Nguyễn Kiều Nhã Tú- BG Toán 10]%[1D2Y5-4]
	Gieo ngẫu nhiên một con xúc xắc cân đối và đồng chất. Tính xác suất của biến cố $C$:  \lq\lq  Mặt xuất hiện có số chấm lớn hơn $3$\rq\rq.
	\choice
	{$\dfrac{1}{6}$}
	{ $\dfrac{2}{3}$}
	{$\dfrac{1}{3}$}
