...
\begin{ex}%[Nguyễn Kiều Nhã Tú- BG Toán 10]%[1D2B5-2]
	...
	\loigiai
	{
		...
		Xét số chấm xuất hiện trên mặt của hai con xúc xắc giống nhau có $C_{3}^{2}\cdot 6\cdot 5$ trường hợp.\\
...
\end{ex}
\begin{ex}%[Nguyễn Kiều Nhã Tú- BG Toán 10]%[1D2Y4-1]
	Xét phép thử $T$: \lq\lq  Gieo một con xúc xắc\rq\rq\; có không gian mẫu là $\Omega=\{1 ; 2 ; 3 ; 4 ; 5 ; 6\}$. Xét biến cố $A$: \lq\lq  Số chấm trên mặt xuất hiện là số chẵn\rq\rq.	Số phần tử thuận lợi của biến cố $A$ là
	\choice
	{$6$}
	{ $94$}
	{$5$}
...
\end{ex}
\begin{ex}%[Nguyễn Kiều Nhã Tú- BG Toán 10]%[1D2B5-2]
	Gieo ngẫu nhiên một con xúc xắc cân đối và đồng chất. Tính xác suất biến cố $A$: \lq\lq  Xuất hiện mặt có số chấm lẻ\rq\rq.
	\choice
	{$\dfrac{1}{6}$}
	{ $\dfrac{1}{4}$}
	{$\dfrac{1}{3}$}
...
\end{ex}
\begin{ex}%[Nguyễn Kiều Nhã Tú- BG Toán 10]%[1D2Y5-4]
	Gieo ngẫu nhiên một con xúc xắc cân đối và đồng chất. Tính xác suất biến cố $B$: \lq\lq  Xuất hiện mặt có số chấm chia hết cho $3$\rq\rq.
	\choice
	{$\dfrac{1}{6}$}
	{ $\dfrac{1}{4}$}
	{\True$\dfrac{1}{3}$}
...
\end{ex}
\begin{ex}%[Nguyễn Kiều Nhã Tú- BG Toán 10]%[1D2Y5-4]
	Gieo ngẫu nhiên một con xúc xắc cân đối và đồng chất. Tính xác suất biến cố $C$:  \lq\lq  Mặt xuất hiện có số chấm lớn hơn $2$\rq\rq.
	\choice
	{$\dfrac{1}{6}$}
	{\True  $\dfrac{2}{3}$}
	{$\dfrac{1}{3}$}
