...
\begin{vd}
 	\immini[thm]{Cho tam giác $ABC$ như hình vẽ, có $AC=1{,}9 cm$, $BC=3{,}9 cm$, $\widehat{BCA}=69^{\circ}$.
 		\begin{enumerate}
...
\end{ex}
\begin{ex}
	\immini[thm]{Hai chiếc tàu thủy $P$ và $Q$ cách nhau $300m$. Từ $P$ và $Q$ thẳng hàng với chân $A$ của tháo hải đăng $AB$ ở trên bờ biển người ta nhìn chiều cao $AB$ của tháp dưới các góc $ \widehat{BPA}=35^{\circ}$, $\widehat{BQA}=48^{\circ}$. Tính chiều cao của tháp.}{
		\begin{tikzpicture}[scale=0.7, line join=round, line cap=round,font=\footnotesize,>=stealth]
...
Một hành khách ngồi trong một máy bay, bay ở độ cao 10 km nhìn xuống hai thị trấn dưới mặt đất. Góc hợp bởi phương ngang và hai thị trấn lần lượt là $28^{\circ}$ và $55^{\circ}$ (hình vẽ). Tính khoảng cách giữa hai thị trấn.
	...
	\loigiai{\immini[thm]{	
		...
		\end{center}
Vậy khoảng cách hai thị trấn khoảng $11{,}79 km$.}{	\begin{tikzpicture}[scale=0.7, line join=round, line cap=round,font=\footnotesize,>=stealth]
