...
\end{ex}
\begin{ex}%[Hữu Bình - BG Toán 10]%[1D2Y1-1]
	\immini[thm]{Các tỉnh $A$, $B$, $C$ được nối với nhau bởi các con đường như hình vẽ. Hỏi có tất cả bao nhiêu cách để đi từ tỉnh $A$ đến tỉnh $C$ mà chỉ qua tỉnh $B$ chỉ một lần?
		\choice
		{$5$}
		{\True $6$}
		{$7$}
