...
\subsubsection{Góc giữa hai đường thẳng}
	...
	Cho hai đường thẳng $\Delta_1\colon a_1 x+b_1y+c_1=0$ và $\Delta_2 \colon a_2 x+b_2y+c_2=0$, với các vectơ pháp tuyến $\overrightarrow{n_1}=(a_1;b_1)$ và $\overrightarrow{n_2}=(a_2;b_2)$ tương ứng. Khi đó, góc $\varphi$ giữa hai đường thẳng đó được xác định thông qua công thức \boxmini{$\cos\varphi=\left|\cos\left(\overrightarrow{n_1},\overrightarrow{n_2}\right)\right|=\dfrac{\left|\overrightarrow{n_1}\cdot \overrightarrow{n_2}\right|}{\left|\overrightarrow{n_1}\right|\cdot \left|\overrightarrow{n_2}\right|}=\dfrac{\left|a_1a_2+b_1b_2\right|}{\sqrt{a_1^2+b_1^2}\cdot \sqrt{a_2^2+b_2^2}}.$}
\subsubsection{Khoảng cách từ một điểm đến một đường thẳng}	
	Cho điểm $M(x_0;y_0)$ và đường thẳng $\Delta \colon ax+by+c=0$. Khoảng cách từ điểm $M$ đến đường thẳng $\Delta$, ký hiệu là $\mathrm{\,d}(M,\Delta)$, được tính bởi công thức \boxmini{$\mathrm{\,d}(M,\Delta)=\dfrac{\left|ax_0+by_0+c\right|}{\sqrt{a^2+b^2}}.$}
\subsection{Các dạng toán}
	...
	\begin{note}
		Ta có thể xét theo trình tự: \begin{itemize}
			\item Kiểm tra hai vectơ chỉ phương (hoặc hai vectơ pháp tuyến) của hai đường thẳng có cùng phương hay không.
	...
	\begin{vd}%[0H3Y1-3]
		...
		\loigiai{
		Đường thẳng $d$ đi qua $A(1;1)$ và có một vectơ pháp tuyến là $\overrightarrow{n}=(3;-4)$.\\
		Đường thẳng $\Delta$ đi qua $M(0;1)$ và nhận $\overrightarrow{u}=(4;3)$ làm vectơ chỉ phương, nên $\overrightarrow{n'}=(3;-4)$ là một vectơ pháp tuyến của $\Delta$.\\
	...
	\begin{bt}%[Phạm Tuấn]%[0H3B1-2]
		...
		{Tọa độ giao điểm của hai đường thẳng $d_1$ và $d_2$ là nghiệm của hệ phương trình 
			...
			Đường thẳng $d$ đi qua hai điểm $A$, $M$ nên có vectơ chỉ phương $\overrightarrow{AM}=\left(-\dfrac{50}{17};\dfrac{44}{17}\right)$, ta chọn vectơ pháp tuyến của đường thẳng $d$ là $\overrightarrow{n}=\left(22;25\right)$. Vậy PTĐT $d$ là
	...
	\begin{bt}%[Phạm Tuấn]%[0H3B1-2]
		...
		\dapso{$2x+y-3=0$}
		\loigiai{Do $d_2\parallel d_1$ nên một vectơ pháp tuyến của $d_2$ là $\overrightarrow{n}=\left(2;1\right)$.\\
			Vậy PTĐT $d_2$ là $2\left(x-1\right)+1\left(y-1\right)=0\Leftrightarrow 2x+y-3=0$.
		}
	\end{bt}
	\begin{bt}%[Phạm Tuấn]%[0H3B1-2]
	...
	\begin{bt}%[Phạm Tuấn]%[0H3B1-2]
		...
		{Tọa độ giao điểm của hai đường thẳng $d_1$ và $d_2$ là nghiệm của hệ phương trình 
			...
			Đường thẳng $d_3$ có vectơ pháp tuyến $\overrightarrow{n_3}=(4;-3)$.\\
			Đường thẳng $d$ qua $M$ và vuông góc với đường thẳng $d_3$ nên có vectơ pháp tuyến $\overrightarrow{n}=(3;4)$, PTĐT $d$ là
	...
	\begin{bt}%[Phạm Tuấn]%[0H3K1-2]
		...
		\loigiai{
			...
			\begin{enumerate}
				\item Đường trung tuyến $AM$ có vectơ chỉ phương $\overrightarrow{AM}=\left(2;-\dfrac{1}{2}\right)$ nên có vectơ pháp tuyến $\overrightarrow{n}_{AM}=(1;4)$. Vậy phương trình $AM$ là
				$$x+4(y+1)=0 \Leftrightarrow x+4y+4=0.$$
				\immini
				{Đường trung tuyến $BN$ có vectơ chỉ phương $\overrightarrow{BN}=\left(-1;\dfrac{5}{2}\right)$ nên có vectơ pháp tuyến $\overrightarrow{n}_{BN}=(5;2)$. Vậy phương trình $BN$ là
					$$5(x-2)+2(y+3)=0 \Leftrightarrow 5x+2y-4=0.$$
					Đường trung tuyến $CP$ có vectơ chỉ phương $\overrightarrow{CP}=\left(-1;-2\right)$ nên có vectơ pháp tuyến $\overrightarrow{n}_{CP}=(2;-1)$. Vậy phương trình $CP$ là
				...
				\end{tikzpicture}}
				\item Đường cao $AD$ qua $A$ và nhận vectơ $\overrightarrow{BC}=(0;3)$ làm vectơ pháp tuyến nên có phương trình $3(y+1)=0 \Leftrightarrow y+1=0$.
				\immini
				{Đường cao $BE$ qua $B$ và nhận vectơ $\overrightarrow{CA}=(-2;-1)$ làm vectơ pháp tuyến nên có phương trình $$-2(x-2)-1(y+3)=0 \Leftrightarrow 2x+y-1=0.$$
					Đường cao $CF$ qua $C$ và nhận vectơ $\overrightarrow{AB}=(2;-2)$ làm vectơ pháp tuyến nên có phương trình $$2(x-2)-2y=0 \Leftrightarrow x-y-2=0.$$}
				{\begin{tikzpicture}[scale=1, font=\footnotesize,line join=round, line cap=round, >=stealth]
				...
				\end{tikzpicture}}
				\item Đường trung trực $d_M$ của $BC$ qua $M$ và nhận vectơ $\overrightarrow{BC}=(0;3)$ làm vectơ pháp tuyến nên có phương trình $3\left(y+\dfrac{3}{2}\right)=0 \Leftrightarrow y+\dfrac{3}{2}=0$.\\
				\immini
				{Đường trung trực $d_N$ của $CA$ qua $N$ và nhận vectơ $\overrightarrow{CA}=(-2;-1)$ làm vectơ pháp tuyến nên có phương trình $$-2(x-1)-1\left(y+\dfrac{1}{2}\right)=0 \Leftrightarrow 2x+y-\dfrac{3}{2}=0.$$
					Đường trung trực $d_P$ của $AB$ qua $P$ và nhận vectơ $\overrightarrow{AB}=(2;-2)$ làm vectơ pháp tuyến nên có phương trình $$2(x-1)-2(y+2)=0 \Leftrightarrow x-y-3=0.$$}
				{\begin{tikzpicture}[scale=1, font=\footnotesize,line join=round, line cap=round, >=stealth]
	...
	\end{bt}
	\begin{bt}%[Phạm Tuấn]%[0H3K1-2]
		Viết PTĐT $d$ song song với đường thẳng $\Delta\colon 3x-4y+2=0$ và cách $A(2;3)$ một khoảng $h=1$.
		...
		\loigiai{Do đường thẳng $d$ song song với $\Delta$ nên phương trình có dạng $3x-4y+m=0$.\\
			...
			Vậy PTĐT $d$ là $3x-4y+11=0$ hoặc $3x-4y-1=0$.
		}
	\end{bt}
	...
	\begin{bt}%[Nguyễn Trung Kiên, dự án 10EX-DCHT-4]%[0H3B1-2]
		...
		\loigiai{Do đường thẳng $\Delta$ song song với $d$ nên có phương trình là $2x+3y+m=0$.\\
			...
			Vậy PTĐT $\Delta$ là $2x+3y+5=0$ hoặc $2x+3y-21=0$.
		}
	\end{bt}
	\begin{bt}%[Phạm Tuấn]%[0H3K1-2]
	...
	\begin{bt}%[0H3K1-2]
		...
		\loigiai
		{Giả sử đường thẳng $d$ cần tìm có vectơ pháp tuyến $\overrightarrow{n}=(a;b)$ với $a^2+b^2>0$. Khi đó:\\
	...
	\end{bt}
	\begin{bt}%[Phạm Tuấn]%[0H3K1-2]
		Viết PTĐT đi qua điểm $M(2;5)$ và cách đều hai điểm $P(-1;2)$, $Q(5;4)$.
		\dapso{$d_1\colon x-3y+13=0$, $d_2\colon x-2=0$}
		\loigiai
		{\immini
			{\begin{itemize}
					\item \textbf{Trường hợp 1:} Đường thẳng qua $M$ và song song với $PQ$ nên nhận vectơ $\overrightarrow{PQ}=(6;2)$ làm vectơ chỉ phương và $\overrightarrow{n}_1=(1;-3)$ làm vectơ pháp tuyến nên có phương trình $$d_1\colon x-2-3(y-5)=0 \Leftrightarrow x-3y+13=0.$$
					\item \textbf{Trường hợp 2:} Đường thẳng qua $M$ và trung điểm $I(2;3)$ của $PQ$ nhận vectơ $\overrightarrow{MI}=(0;-2)$ làm vectơ chỉ phương và nhận vectơ $\overrightarrow{n}_2=(1;0)$ làm vectơ pháp tuyến nên có phương trình $$d_2\colon x-2=0.$$
			\end{itemize}}
			{\begin{tikzpicture}[scale=1, font=\footnotesize,line join=round, line cap=round, >=stealth]
...
%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{vd}%[0H3B1-3]
		...
		\begin{itemize}
			...
			\item Hai đường thẳng $d_1$, $d_2$ lần lượt có vectơ chỉ phương là $\overrightarrow{u_1}=(2;-7)$, $\overrightarrow{u_2}=(4;-14)$. Ta có $\overrightarrow{u_2}=2\overrightarrow{u_1}$, do đó $\overrightarrow{u_1}$ và $\overrightarrow{u_2}$ cùng phương. Do đó $(d_1,d_2)=0^\circ$.
		\end{itemize}	
		}
	\end{vd}
	\begin{vd}%[0H3B1-4]
		...
		\loigiai{
			Đường thẳng $\sqrt{3}x-y+1=0$ có vectơ pháp tuyến là $\overrightarrow{n}=\left(\sqrt{3};-1\right)$.\\
			Trục $Ox$ có vectơ pháp tuyến là $\overrightarrow{j}=(0;1)$.\\
	...
	\begin{vd}%[0H3B1-3]
		...
		\loigiai{
			$d\colon (2m-1)x+my-10=0 \Rightarrow d$ có một vectơ pháp tuyến là $\overrightarrow{n}_d=(2m-1;m)$.\\
			$\Delta\colon 3x+2y+6=0 \Rightarrow \Delta$ có một vectơ pháp tuyến là $ \overrightarrow{n}_{\Delta}=(3;2)$.\\
	...
	\begin{vd}%[0H3B1-3]
		...
		\loigiai{
			$d_1$ có vectơ chỉ phương $\overrightarrow{u}_{d_1}=(3;2)$; $d_2$ có vectơ chỉ phương $\overrightarrow{u}_{d_2}=(-3;-4m)$.\\
	...
	\begin{vd}%[0-23-GHK2-NguyenKhuyen-HCM-19]%[HK1-10-11-Word-T-Begin-lần 2]%[Đỗ Tiến Tuấn]%[0H3K1-4]
		...
		\loigiai{
			Đường thẳng $x+my-3=0$, $x+y=0$ lần lượt có vectơ pháp tuyến là $\overrightarrow{n}_1=(1;m)$ và $\overrightarrow{n}_2=(1;1)$.\\
	...
	\end{vd}
	\begin{vd}%[0H3B1-4]
	Trong mặt phẳng $Oxy$, viết PTĐT $d$ đi qua $A(0;1)$ và tạo với đường thẳng $\Delta\colon x+2y-7=0$ một góc $45^\circ$.
	\loigiai{
		Giả sử đường thẳng $d$ có vectơ pháp tuyến là $\vec{n}_1=(a;b)\ne\vec{0}$, đường thẳng $\Delta$ có vectơ pháp tuyến là $\vec{n}_2=(1;2)$.\\
		Khi đó ta có
		\begin{eqnarray*}
	...
	\begin{bt}%[Dự án BG10, nhóm Toán và Latex, Lý Văn Hoàng]%[0H3B1-4]
		...
		\loigiai{
			Vectơ pháp tuyến của hai đường thẳng $d_1$, $d_2$ lần lượt là $\overrightarrow{n}_1=(1;2)$ và $\overrightarrow{n}_2=(1;-3)$.\\
	...
	\begin{bt}%[Dự án Tex hóa đề kiểm tra đợt 2, nhóm LaTeX]%[Nguyễn Tuấn,pb: Lê Văn Hiếu]%[Dự án BG10, nhóm Toán và Latex, Lý Văn Hoàng]%[0H3B1-4]
		...
		\end{aligned}\right. $
		\loigiai{
			Đường thẳng $ d_1\colon 6x-5y+15=0$ có vectơ pháp tuyến $\overrightarrow{n_1}=(6;-5)$. \\
			Đường thẳng $ d_2\colon \left\{
			\begin{aligned}
				&x=10-6t\\
				&y=1+5t\\
			\end{aligned}\right. $ có vectơ pháp tuyến $\overrightarrow{n_2}=(5;6)$. \\
	...
	\begin{bt}%[Dự án Tex hóa đề kiểm tra đợt 2, nhóm LaTeX]%[Nguyễn Tuấn,pb: Lê Văn Hiếu]%[Dự án BG10, nhóm Toán và Latex, Lý Văn Hoàng]%[0H3B1-4]
		...
		\loigiai{
			...
			\begin{aligned}
				&x=1+t\\
				&y=2-3t\\
			\end{aligned}\right. $ có vectơ chỉ phương $\overrightarrow{u_1}=(1;-3)$. \\
			Đường thẳng $\left\{
			\begin{aligned}
				&x=3+2t\\
				&y=1+t\\
			\end{aligned}\right. $ có vectơ chỉ phương $\overrightarrow{u_2}=(2;1)$. \\
	...
	\begin{bt}%[Dự án BG10, nhóm Toán và Latex, Lý Văn Hoàng]%[0H3B1-4]
		...
		\loigiai{
			...
			Đường thẳng $\heva{&x=9+at\\&y=7-2t}$ $(t\in \mathbb{R})$ có vectơ chỉ phương là $\overrightarrow{u}=(a;-2)$.\\
...
%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{vd}
		...
		\begin{itemize}
			...
			\item Đường thẳng $d$ đi qua $A(-2;2)$ và có một vectơ chỉ phương là $\overrightarrow{u}=(3;-4)$, suy ra $\overrightarrow{n}=(4;3)$ là một vectơ pháp tuyến của $d$.\\
	...
	\begin{vd}%[0H3B1-5]
		...
		\loigiai{
			Ta có $\overrightarrow{BC}=(1;0)$. Suy ra vectơ pháp tuyến của đường thẳng $BC$ là $\overrightarrow{n}=(0;1)$.\\
	...
	\begin{vd}%[Bài giảng Toán 10]%[0H3B1-5] 
		Cho đường thẳng $d \colon 3x-y-1=0$. Viết PTĐT $\Delta$ song song với $d$ sao cho khoảng cách giữa hai đường thẳng bằng $\dfrac{3\sqrt{10}}{5}$.
		\loigiai{
	...
	\begin{vd}%[Bài giảng Toán 10]%[0H3K1-5] 
		Cho hai điểm $A(-2;0)$ và $B(0;1)$. Viết PTĐT $\Delta$ đi qua $B$ sao cho khoảng cách từ $A$ đến $\Delta$ bằng $1$.
		\loigiai{
	...
	\begin{bt}%[Bài giảng Toán 10]%[0H3B1-5]
		...
		\loigiai{
			Đường thẳng $(D)\parallel (D')$ nên PTĐT $(D)\colon 3x+4y+c=0$.\\
	...
	\begin{bt} 
		Cho hai điểm $M(-1;2)$, $N(1;0)$. Viết PTĐT  $\Delta$ đi qua $M$ sao cho khoảng cách từ $N$ đến $\Delta$ lớn nhất.
		\loigiai{
			Gọi $H$ là hình chiếu vuông góc của $N$ trên $\Delta$. \\
			Dễ thấy $NH \leq MN$. Đẳng thức xảy ra khi $M \equiv H$.  \\
			Do đó khi khoảng cách từ $N$ đến $\Delta$ lớn nhất thì vectơ của $\Delta$ là $\overrightarrow{MN} =(2;-2)$. \\
	...
	\begin{vd}%[Đề thi học kì 2, năm 2018 - 2019, trường THPT Thống Nhất A]%[Nguyễn Thành Khang, dự án 10EX-HK2-1819]%[0H3B1-6]
		...
		\loigiai{
			Đường thẳng $d$ có vectơ chỉ phương $\vec{u}=(-2;2)$.\\
	...
	\begin{vd}%[0H3K1-5]
		Trong mặt phẳng $Oxy$, viết PTĐT $d$ đi qua điểm $A(1;2)$ và cách $B(-2;3)$ một khoảng bằng $\dfrac{4\sqrt{10}}{5}$.
		\loigiai{
	...
	\end{vd}
	\begin{vd}%[0H3K1-5]
		\immini[thm]{Trong mặt phẳng $Oxy$, cho hình vuông $ABCD$ có $C(7;2)$. Gọi $M$, $N$ lần lượt là trung điểm của $AB$ và $AD$. Biết đường thẳng $MN$ có phương trình $3x-4y+2=0$. Tính diện tích $S$ của hình vuông $ABCD$.
		...
		\loigiai{
			\immini[thm]{Khoảng cách từ $C(7;2)$ đến đường thẳng $MN$
	...
	\begin{vd}%[GHK2, Nguyễn Hữu Cảnh, Đồng Nai, 2021, dự án 0-GHK2-2021]%[Phạm Doãn Lê Bình]%[0H3K1-5]
		...
		\loigiai{
			Đường thẳng $MN$ có một vectơ chỉ phương là $\overrightarrow{MN}=(1;-3)$, suy ra $MN$ có một vectơ pháp tuyến là $\vec{n}=(3;1)$. \\
	...
	\begin{bt}%[Bài giảng toán 10-2022-2023]%[Chim Khuyên]%[0H3K1-6] 
		Cho đường thẳng $\Delta$ có PTTS $\heva{&x=2+2t\\&y=3+t\\}$ và điểm $A(0;1)$.\\
		\begin{enumerate}	
	...
	\begin{bt}%[Bài giảng toán 10-2022-2023]%[Chim Khuyên]%[0H3K1-6] 
		...
		\loigiai{
			\begin{enumerate}
				...
				Thay $x,y$ vừa tìm được ở PTĐT $AB$ vào PTĐT $d_1$ ta có: $t-(2-2t)-1=0 \Leftrightarrow t=1$.\\
				Do đó $M(1;0)$.
				...
				Thay $x,y $ vừa tìm được ở phương trình $A_1B$ vào PTĐT $d_2$ ta có $2+5t-2-t+1=0 \Leftrightarrow t=-\dfrac{1}{4}$.\\
...
\subsection{Câu hỏi trắc nghiệm}
	...
	\begin{ex}%[0H3Y1-2]
		...
		{\True $2x-3y-9=0$}
		\loigiai{
			Đường thẳng $BC$ đi qua $H(3;-1)$ và có vectơ pháp tuyến $\overrightarrow{AH}=(2;-3)$ có phương trình tổng quát: $$2(x-3)-3(y+1)=0 \Leftrightarrow 2x-3y-9=0$$.}
	\end{ex}
	\begin{ex}%[0H3Y1-2]
		...
		{$\heva{&x=3+5t \\& y=-2-t}$}
		\loigiai{
			Do hai đường thẳng song song nên đường thẳng cần tìm nhận $\overrightarrow{u}=(-1;5)$ làm vectơ chỉ phương. Do đó PTTS là $\heva{&x=-2-t \\& y=3+5t.}$.}
	\end{ex}
	\begin{ex}%[0H3Y1-3]
	...
	\begin{ex}%[0H3Y1-3]
		...
		\loigiai{
			Vectơ chỉ phương của $\Delta_1$ và $\Delta_2$ lần lượt  là $\overrightarrow{u}_1=\left(\sqrt{2}; -\sqrt{3}\right)$, $\overrightarrow{u}_2=\left(\sqrt{3};\sqrt{2}\right)$.\\
	...
	\begin{ex}%[Bài giảng Toán 10]%[0H3B1-5]
		Trong mặt phẳng tọa độ $Oxy$, viết PTĐT $(\Delta)$ song song với $(d)\colon 2 x-y+3=0$ và cách $(d)$ một khoảng bằng $2 \sqrt{5}$.
		\choice
	...
	\begin{ex}%[0H3B1-1]
		...
		{\True $\overrightarrow{u}(2;3)$ là vectơ chỉ phương của $d$}
		{$d$ vuông góc với đường thẳng ${\Delta}' \colon 3x+2y-1=0$}
		{$d$ có hệ số góc $k=\dfrac{2}{3}$}
		\loigiai{
			Một vectơ chỉ phương của $d$ là $\overrightarrow{u}(3;2)$.}
	\end{ex}
	\begin{ex}%[0H3B1-1]
	...
	\begin{ex}%[0H3B1-1]
		...
		\loigiai{
			Ta có $\overrightarrow{AB}=(6;2)$, đường thẳng $\Delta$ vuông góc với đường thẳng $AB$ nên vectơ chỉ phương $\Delta$ là $\overrightarrow{u}=(1;-3)$.}
	\end{ex}
	\begin{ex}%[0H3B1-2]
		...
		\loigiai{
			Một vectơ pháp tuyến của $d$ là $\overrightarrow{n}(4;2)$. Do $\Delta \perp d$ nên $\overrightarrow{u}(-4;-2)$ là một vectơ chỉ phương của $\Delta$. PTTS đường thẳng $\Delta$ là: $\heva{&x=1-4t \\& y=1-2t.}$}
	\end{ex}
	\begin{ex}%[0H3B1-2]
	...
	\begin{ex}%[0H3B1-2]
		...
		{$2x+10y-13=0$}
		\loigiai{
			Ta có $\Delta \colon \heva{&x=-4+5t \\& y=1-t}$ có vectơ chỉ phương $\overrightarrow{u}=(5;-1)$, suy ra vectơ pháp tuyến của $\Delta$ là $\overrightarrow{n}=(1;5)$.\\
			Đường thẳng đi qua $M(2;0)$, song song với đường thẳng $\Delta$ nên có vectơ pháp tuyến là $\overrightarrow{n}=(1;5)$.\\
	...
	\begin{ex}%[0H3B1-2]
		...
		\loigiai{
			...
			Đường thẳng đi qua điểm $M(-1;2)$ và vuông góc với đường thẳng $2x-y+4=0$ có VTCP $\overrightarrow{u}=\overrightarrow{n_d}=(2;-1) $. PTTS $\heva{& x=-1+2t \\ & y=2-t.} $
		}
	\end{ex}
	\begin{ex}%[0H3B1-2]
		...
		\loigiai{
			...
			Đường thẳng $(d)$ vuông góc $(\Delta)$ nên $(d)$ có một vectơ pháp tuyến là vectơ chỉ phương của $(\Delta)$.\\
			Do đó đường thẳng $(d)$ có vectơ pháp tuyến là $\overrightarrow{n}(3;1)$.\\
			PTĐT $(d) \colon 3(x+1)+1(y-6)=0 \Leftrightarrow 3x+y-3=0$.}
	\end{ex}
	\begin{ex}%[0H3B1-2]
		...
		\loigiai{
			...
			Do $\overrightarrow{n}_d=\overrightarrow{n}_{AC}=(9;2)$. Vậy PTĐT $d \colon 9x+2y-11=0$.}
	\end{ex}
	\begin{ex}%[0H3B1-3]%
		Trong mặt phẳng tọa độ $Oxy$, hai đường thẳng $d_1 \colon mx+y-m-1=0$ và $d_2 \colon x+my-2=0$ song song với nhau khi và chỉ khi
		\choice
	...
	\begin{ex}%[0H3B1-3]
		...
		\loigiai
		{
			...
			Các đáp án $2x-y+3=0$, $x-2y+3=0$ loại vì các vectơ pháp tuyến không cùng phương với vectơ pháp tuyến của $d$.\\
	...
	\begin{ex}%[0H3K1-2]
		...
		\loigiai{
			...
			Vì 	$I(1;1) \in d$ nên  $1+3+c=0 \Leftrightarrow c=-4$. Vậy PTĐT $(d) \colon x+3y-4=0$.}
	\end{ex}
	...
	\begin{ex}%[Thử sức trước kì thi đề số 4, THTT, 2019]%[Trần Hòa, 12EX-7-2019]%[Dự án BG10, nhóm Toán và Latex, Lý Văn Hoàng]%[0H3B1-4]
		...
		{\True $-4$}
		\loigiai{
			Đường thẳng $mx+y-3=0$ có vectơ pháp tuyến $\overrightarrow{n_1}=(m;1)$.\\
			Đường thẳng $x+y=0$ có vectơ pháp tuyến $\overrightarrow{n_2}=(1;1)$.\\
	...
	\begin{ex}%[Đề thi thử THPT Bình Minh, Ninh Bình, lần 1 (2019)]%[Dự án BG10, nhóm Toán và Latex, Lý Văn Hoàng]%[0H3B1-4]
		...
		{\True $\dfrac{3}{5}$}
		\loigiai{
			Vectơ pháp tuyến của đường thẳng $d_1$ là $\overrightarrow{n}_1=(1;2)$.\\
			Vectơ pháp tuyến của đường thẳng $d_2$ là $\overrightarrow{n}_2=(2;-4)$.
	...
	\begin{ex}%[Dự án BG10, nhóm Toán và Latex, Lý Văn Hoàng]%[0H3B1-4]
		...
		{$45^\circ$}
		\loigiai{
			Ta có: $d_1$ có vectơ pháp tuyến $\overrightarrow{n}_1=\left(1;-\sqrt{3}\right)$; $d_2$ có vectơ pháp tuyến $\overrightarrow{n}_2=\left(0;1\right)$.\\
	...
	\begin{ex}%[Dự án Tex hóa đề kiểm tra đợt 2, nhóm LaTeX]%[Nguyễn Tuấn,pb: Lê Văn Hiếu]%[Dự án BG10, nhóm Toán và Latex, Lý Văn Hoàng]%[0H3B1-4]
		...
		{$-\dfrac{\pi }{4}$}
		\loigiai{
			Đường thẳng $ d_1\colon 2x-4y-3=0$ có vectơ pháp tuyến $\overrightarrow{n_1}=(2;-4)$.\\
			Đường thẳng $ d_2\colon 3x-y+17=0$ có vectơ pháp tuyến $\overrightarrow{n_2}=(3;-1)$. \\
			Gọi $\varphi $ là góc giữa $ d_1$ và $d_2$.\\
	...
	\begin{ex}%[Dự án Tex hóa đề kiểm tra đợt 2, nhóm LaTeX]%[Nguyễn Tuấn,pb: Lê Văn Hiếu]%[Dự án BG10, nhóm Toán và Latex, Lý Văn Hoàng]%[0H3B1-4]
		...
		{ $\dfrac{3}{5}$}
		\loigiai{
			vectơ pháp tuyến của $\Delta_1$, $\Delta _2$ lần lượt là $\overrightarrow{n_1}=(2;1)$, $\overrightarrow{n_2}=(1;1)$.\\
	...
	\begin{ex}%[Dự án Tex hóa đề kiểm tra đợt 2, nhóm LaTeX]%[Nguyễn Tuấn,pb: Lê Văn Hiếu]%[Dự án BG10, nhóm Toán và Latex, Lý Văn Hoàng]%[0H3B1-4]
		...
		{\True $45^\circ$}
		\loigiai{
			Đường thẳng $3x+y-1=0$ có vectơ pháp tuyến $\overrightarrow{n_1}=(3;1)$. \\
			Đường thẳng $4x-2y-4=0$ có vectơ pháp tuyến $\overrightarrow{n_2}=(4;-2)$. \\
	...
	\begin{ex}%[Dự án BG10, nhóm Toán và Latex, Lý Văn Hoàng]%[0H3B1-4]
		...
		{ $90^0$}
		\loigiai{
			$ d_1\colon x-2y+5=0$ có vectơ pháp tuyến $\overrightarrow{n}_{d_1}=(1;-2)$ và $ d_2\colon x+3y-7=0$ có vectơ pháp tuyến $\overrightarrow{n}_{d_2}=(1;3)$.\\
	...
	\begin{ex}%[Thi thử, Hội đồng liên trường - Hải Phòng, 2019]%[Phan Văn Thành, 12EX5]%[Dự án BG10, nhóm Toán và Latex, Lý Văn Hoàng]%[0H3K1-4]
		Trong mặt phẳng $Oxy$, cho $(d_1) \colon 2x - y + 5 = 0$; $(d_2) \colon x + y - 3 = 0$ cắt nhau tại $I$. PTĐT qua $M(-2; 0)$ cắt $(d_1), (d_2)$ lần lượt tại $A$ và $B$ sao cho $\triangle IAB$ cân tại $A$ có dạng $ax + by + 2 = 0$. Tính $T = a - 5b$.
		\choice
		{$ T = -1 $}
		{$ T = 9 $}
		{$ T = -9 $}
	...
	\begin{ex}%[Dự án Tex hóa đề kiểm tra đợt 2, nhóm LaTeX]%[Nguyễn Tuấn,pb: Lê Văn Hiếu]%[Dự án BG10, nhóm Toán và Latex, Lý Văn Hoàng]%[0H3K1-4]
		Cho đường thẳng $ d\colon 3x-2y+1=0$ và $M(1;2)$. Viết PTĐT $\Delta $ đi qua $M$ và tạo với $d$ một góc $45^\circ $.
		\choice
	...
	\begin{ex}%[Bài giảng toán 10-2022-2023]%[Chim Khuyên]%[0H3K1-6] 
		...
		{$\left( 10;8 \right)$}
		\loigiai{
			PTĐT $AB:x+3y-8=0$. Điểm $C\in \Delta \Rightarrow C\left( 2t-8;t \right)$\\
	...
	\begin{ex}%[Bài giảng toán 10-2022-2023]%[Chim Khuyên]%[0H3K1-6] 
		...
		\loigiai{
			...
			PTĐT $AA'$ đi qua $A$ và vuông góc với $\Delta$ là $x+y-3=0$.\\
			...
			PTĐT $A'B$ đi qua $A'(0;3)$ và $B(9;6)$ là $x-3y+9=0$.\\
