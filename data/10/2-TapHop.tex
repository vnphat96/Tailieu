...
\begin{vd}%[BG10-2022]%[Đỗ Văn Dự]%[0D1B3-3]
	...
	\loigiai{
		...
		Theo đề ta có $|A|=25$, $|B|=15$, $|A\cap B|= 10$.
		\begin{enumerate}				
			\item Tập hợp các cán bộ được cấp thẻ đỏ là $A\cup B$.\\
			Vậy số cán bộ được cấp thẻ đỏ là $|A\cup B|=|A|+|B|-|A\cap B|=25+15-10=30$.
	...
	\loigiai{
		\immini{		
			...
			\begin{itemize}
				...
				\item Số học sinh chỉ giỏi môn Toán $48-10-14-4=20 $.	
				\item Số học sinh chỉ giỏi môn Lí $37-10-13-4=10 $.	
				\item Số học sinh chỉ giỏi môn Văn $42-13-14-4=11 $.
			\end{itemize}
		...
		\end{tikzpicture}}
		\begin{enumerate}	
			\item Số học sinh chỉ giỏi đúng 1 môn là $20+10+11=41$. 
			\item Số học sinh chỉ giỏi đúng 2 môn là $10+14+13-4\cdot2=25 $. 
			\item Số học sinh giỏi ít nhất một môn là $(20+10+11)+(10+13+14-4\cdot 3)+ 4=70  $.
		\end{enumerate}
	}
\end{vd}
\begin{vd}%[BG10-2022]%[Đỗ Văn Dự]%[0D1K3-3]
	...
	\loigiai{
		...
		$\bullet$  $n(V\cup A\cup T)=n\left( V \right)+n\left( A \right)+n\left( T \right)-\left[ n(V\cap A)+n(A\cap T)+n(T\cap V) \right]+n\left( V\cap A\cap T \right)=
		18+10+12-\left[ 3+4+5 \right]+2=30$.
...
\begin{vd}%[BG10-2022]%[Đỗ Văn Dự]%[0D1K3-3]
	...
	\loigiai{
		...
		{Ký hiệu $ A $ là tập hợp những học sinh giỏi Anh,\\
			...
			\begin{eqnarray*}
				|V \cup A \cup T|&=&|V|+|A|+|T|-|V \cap A|-|T \cap A|-|T \cap V|+|A \cap B \cap C|\\
				&=&18+10+12-(3+4+5)+2=30.
			\end{eqnarray*}
			Vậy nhóm đó có $ 30 $ em.
		}
...
\begin{vd}%[BG10-2022]%[Đỗ Văn Dự]%[0D1K3-3]
	...
	\loigiai{
		...
		$n(V\cap T)=8,\;n(T\cap A)=7,\;n(V\cap A)=6,\; n(A\cup B\cup C)=45$.\\
		$n(V\cup A\cup T)=n\left( V \right)+n\left( A \right)+n\left( T \right)-n(V\cap A)-n(A\cap T)-n(T\cap V)+n\left( V\cap A\cap T \right)$\\
		$  \Leftrightarrow  45=22+20+25-6-7-8+n\left( V\cap A\cap T \right)$.\\
		$\Rightarrow n\left( V\cap A\cap T \right)=19$.
	}
\end{vd}
\begin{vd}%[BG10-2022]%[Đỗ Văn Dự]%[0D1B3-3]
