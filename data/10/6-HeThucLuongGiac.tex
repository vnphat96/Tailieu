...
\immini[thm]{Cho tam giác $ ABC$ có $ BC=a$, $ AC=b$ và $ AB=c$.
	\begin{listEX}
...
\begin{vd}
	...
	\loigiai{	\immini[thm]{Độ dài trung tuyến kẻ từ $C$ của tam giác $ABC$ là
			\\
...
\subsection{Câu hỏi trắc nghiệm}
	...
	\begin{ex}%[0H2T3-4]
		...
		{\True $17$ m}
		{$16$ m}
		\loigiai{\immini[thm]{Ta có $AB= \sqrt{AH^2 + BH^2} = \sqrt{4^2+20^2} = 4 \sqrt{26}$.\\
