...
\begin{ex}%[Phan Quốc Trí, Bai Giảng T10(2022)]%[0D1B3-1]
	...
	{$ A \cup B = (0;3) $}
	\loigiai{
		\immini[thm]{Tập hợp $A=(-3;3)$ có biểu diễn là}{ 
		...
		\end{tikzpicture}}
		\immini[thm]{Tập hợp $B=(0;+\infty)$ có biểu diễn là}{
			\begin{tikzpicture}[scale=1, font=\footnotesize, line join = round, line cap = round, >=stealth]
...
% %Câu 50
% \begin{bt}
% 	Cho hai tập hợp $A=\left\{ x\in \mathbb{R} \mid |mx-3|=mx-3\right\}$, $B=\left\{ x\in \mathbb{R} \mid x^2-4=0\right\}$. Tìm $m$ để $B\setminus A=B$.
% 	% \choice
...
\begin{ex}%[Phan Quốc Trí, Bai Giảng T10(2022)]%[0D1Y1-1]
	...
	{$x+1=2y-2$}
	\loigiai{
		\lq\lq  Số 0 là không là số dương cũng không là số âm \rq\rq\ là mệnh đề đúng.
	}
\end{ex}
\begin{ex}%[Phan Quốc Trí, Bai Giảng T10(2022)]%[0D1Y1-2]
