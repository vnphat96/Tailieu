...
% \begin{vd}%[Bài giảng 10 đợt 2, 2022-2023]%[Đặng Tân Hoài]%[0H3B1-1]
% 	Trong mặt phẳng $Oxy$, cho đường thẳng $\Delta$ đi qua $M(2;-1)$ và nhận $\overrightarrow{n}(1;3)$ làm véc-tơ chỉ phương. PTTS của $\Delta$ là
% 	\choice
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3Y1-1]% Câu 3
	...
	{$(1;3)$}
	\loigiai{
		PTĐT $ax+by+c=0$ có véc-tơ chỉ phương là $(b;-a)$ hoặc $(-b;\,a)$.\\
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3Y1-1]% Câu 12
	...
	{$(2;0)$}
	\loigiai{
		PTTS $\heva{&x=2+t\\&y=t }\quad (t\in \mathbb{R})$ có véc-tơ chỉ phương là $\overrightarrow{a}=(1;1)$.\\
...
\begin{ex}%[Nguyễn Hoài Nam]%[0H3B1]
	...
	{$\heva{&x=3+3t\\&y=-5+t}$}
	{$\heva{&x=3-3t\\&y=-5+t}$}
	\loigiai{Do PTĐT $d$ có hệ số góc $k=-3$ nên véc-tơ chỉ phương của $d$ là $\overrightarrow{u}=(1;-3)$. Khi đó, PTTS của $d$ là $\heva{&x=3+t\\&y=-5-3t.}$}
\end{ex}
\begin{ex}%[Nguyễn Hoài Nam]%[0H3B1]
...
\begin{ex}%[Nguyễn Hoài Nam]%[0H3K1]
	...
	\loigiai{ 
		...
		PTĐT qua $O(0;0)$ và nhận $\overrightarrow{u}=(4;3)$  làm véc-tơ chỉ phương  là  $\heva{x&=4t\\y&=3t.}$
	}
\end{ex}
\begin{ex}%[Nguyễn Hoài Nam]%[0H3K1]
