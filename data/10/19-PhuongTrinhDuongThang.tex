...
\textbf{Véc-tơ pháp tuyến của đường thẳng}
	\immini{Véc-tơ $\overrightarrow{n} \ne \overrightarrow{0}$ được gọi là véc-tơ pháp tuyến  (VTPT) của đường thẳng $\Delta$ nếu giá của nó vuông góc với $\Delta$.
	}{
...
% \begin{vd}%[Bài giảng 10 đợt 2, 2022-2023]%[Đặng Tân Hoài]%[0H3Y1-1]
% 	\immini{
% 	Trong mặt phẳng $Oxy$, cho tam giác $ABC$ có đường cao $AH$ và $I$ là trung điểm của $BC$ như hình vẽ. Một véc-tơ pháp tuyến của đường trung trực của đoạn $BC$ là
% 	\choice
% 	{$AI$}
% 	{$AH$}
% 	{$AC$}
...
% 	\def\xt{-2.75} \def\xp{3.75}
% 	\def\yd{-1.75} \def\yt{3.75} 
% 	\draw[color=gray!50,dashed] (\xt,\yd) grid (\xp,\yt); 
...
% 	;
% 	\foreach \d/\g in {A/90,B/-90,C/-90,H/-90,I/-45}{
% 		\draw[fill=black](\d) circle (1.5pt)+(\g:.35)node{$\d$};}
% 	\draw (H)--(A)--(B)--(C)--(A);
% \end{tikzpicture}	}
% 	\loigiai{
% 	\immini{ 
% 	Gọi $\Delta$ đường trung trực của đoạn $BC$.\\
% 	Khi đó $\Delta$ qua $I$ và vuông góc với $BC$.\\
% 	Vậy $\overrightarrow{BC}$ là một véc-tơ pháp tuyến của $\Delta$.
% 	}{
% \begin{tikzpicture}[scale=.8, font=\footnotesize, line join=round, line cap=round,>=stealth] 
% 	\def\xt{-2.75} \def\xp{3.75}
% 	\def\yd{-1.75} \def\yt{3.75} 
...
% 		\draw[fill=black](\d) circle (1.5pt)+(\g:.35)node{$\d$};}
% 	\draw (H)--(A)--(B)--(C)--(A);	
% 	\draw[red, line width=1pt] (0.5,\yd+0.1)--(0.5,\yt-0.5) node[right]{$\Delta$};
...
% \begin{vd}%[Bài giảng 10 đợt 2, 2022-2023]%[Đặng Tân Hoài]%[0H3B1-1]
% 		Trong mặt phẳng $Oxy$, cho đường thẳng $\Delta$ đi qua $M(2;-1)$ và nhận $\overrightarrow{n}(1;3)$ làm véc-tơ pháp tuyến. Phương trình tổng quát của $\Delta$ là
% 		\choice
% 		{\True $x+3y+1=0$}
% 		{$x+3y-1=0$}
% 		{$2x-y+1=0$}
% 		{$2x-y-1=0$}
% 	\loigiai{
% 	Đường thẳng $\Delta$ có phương trình tổng quát là 
% 	$$1(x-2)+3(y+1)=0 \Leftrightarrow x+3y+1=0.$$
% }
% \end{vd}
...
\textbf{Véc-tơ chỉ phương của đường thẳng}
	\immini{
	Véc-tơ $\overrightarrow{u} \ne \overrightarrow{0}$ được gọi là véc-tơ chỉ phương (VTCP) của đường thẳng $\Delta$ nếu giá của nó song song hoặc trùng với $\Delta$.
	}{
	\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round, >=stealth]
		\draw (0,0)--(3,0) node[right] {$\Delta$} ;
...
% \begin{vd}%[Bài giảng 10 đợt 2, 2022-2023]%[Đặng Tân Hoài]%[0H3Y1-1]
% 	\immini{
% 		Trong mặt phẳng $Oxy$, cho tam giác $ABC$ có đường cao $AH$ và $I$ là trung điểm của $BC$ như hình vẽ. Một véc-tơ chỉ phương của đường trung trực của đoạn $BC$ là
% 		\choice
% 		{$AI$}
% 		{\True $AH$}
% 		{$AC$}
...
% 		\immini{ 
% 			Gọi $\Delta$ đường trung trực của đoạn $BC$.\\
% 			Khi đó $\Delta$ qua $I$ và vuông góc với $BC$, suy ra $\Delta \parallel AH$.\\
% 			Vậy $\overrightarrow{AH}$ là một véc-tơ chỉ phương của $\Delta$.
% 		}{
% 			\begin{tikzpicture}[scale=.8, font=\footnotesize, line join=round, line cap=round,>=stealth] 
% 				\def\xt{-2.75} \def\xp{3.75}
% 				\def\yd{-1.75} \def\yt{3.75} 
...
% 				\draw (A)--(B)--(C)--(A);	
% 				\draw[red, line width=1pt] (0.5,\yd+0.1)--(0.5,\yt-0.5) node[right]{$\Delta$};
% 				\draw[->,blue, line width=1pt] (A)--(H);
% 		\end{tikzpicture}	}
% 	}
% \end{vd}
		
\textbf{Phương trình tham số của đường thẳng}
...
% \begin{vd}%[Bài giảng 10 đợt 2, 2022-2023]%[Đặng Tân Hoài]%[0H3B1-1]
% 	Trong mặt phẳng $Oxy$, cho đường thẳng $\Delta$ đi qua $M(2;-1)$ và nhận $\overrightarrow{n}(1;3)$ làm véc-tơ chỉ phương. Phương trình tham số của $\Delta$ là
% 	\choice
% 	{$\heva{& x=2-t\\&y=-1-3t} (t\in \mathbb{R})$}
% 	{\True $\heva{& x=2+t\\&y=-1+3t} (t\in \mathbb{R})$}
% 	{$\heva{& x=1+2t\\&y=3-t} (t\in \mathbb{R})$}
% 	{$\heva{& x=1-2t\\&y=3+t} (t\in \mathbb{R})$}
% 	\loigiai{
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3Y1-1]
	...
	\loigiai{
		Một véc-tơ chỉ phương của đường thẳng $d$ là $\overrightarrow{u}=(3 ;-1)$.
	}
\end{ex}
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3Y1-1]
	...
	%<MyLT2>
	\loigiai{
		Véc-tơ pháp tuyến của $d$ là $\overrightarrow{n}=\left(\dfrac{1}{3}; \dfrac{1}{2}\right)$. Suy ra chọn véc-tơ pháp tuyến là $ (2;3)$.
	}
\end{ex}
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3Y1-1]
	...
	{$\overrightarrow{n}=(-4;3)$}
	\loigiai{
		Véc-tơ pháp tuyến của đường thẳng $\Delta$ là $\overrightarrow{n}=(3;4)$.
	}
\end{ex}
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3Y1-1]
	...
	{$\overrightarrow{u}=(-1;1)$}
	\loigiai{
		Một véc-tơ chỉ phương của đường thẳng $AB$ là $\overrightarrow{u}=\dfrac{1}{4}\overrightarrow{AB}=(1;1)$.
	}
\end{ex}
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3B1-1]
	...
	\loigiai{
		Đường thẳng đi qua hai điểm $A(-3;2)$ và $B(1;4)$ có một véc-tơ chỉ phương là $\overrightarrow{AB}=(4;2)$ nên $\overrightarrow{u}=(2;1)=\dfrac{1}{2}\overrightarrow{AB}$ cũng là một véc-tơ chỉ phương của nó.
	}
\end{ex}
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3Y1-1]
	...
	\loigiai{
		Đường thẳng $d \colon \heva{&x=2+3t\\&y=4}$ có một véc-tơ chỉ phương là $\overrightarrow{u} = (3;0)$.\\
		Ta có $\overrightarrow{u} = 3 \overrightarrow{u}_1$ nên $\overrightarrow{u}_1$ cũng là véc-tơ chỉ phương của $d$.
	}
\end{ex}
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3Y1-1]
	...
	\loigiai{
		...
		Đường thẳng đi qua hai điểm $A(1;-1)$, $B(3;5)$ có một véc-tơ chỉ phương là $\overrightarrow{u}=(1;3)$.
	}
\end{ex}
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3B1-1]
	...
	{$\overrightarrow{u}=(1;-1)$}
	\loigiai{
		Đường thẳng $d$ có véc-tơ pháp tuyến $\overrightarrow{n}=(1;-1)$ nên đường thẳng $d$ có véc-tơ chỉ phương $\overrightarrow{u}=(1;1)$.
	}
\end{ex}
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3B1-1]
	...
	\loigiai{
		Đường trung trực của đoạn $MN$ có một véc-tơ pháp tuyến là $\overrightarrow{n}=\overrightarrow{NM}=(-3;4)$.
	}
\end{ex}
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3Y1-1]
	...
	\loigiai{
		Đường thẳng $d\colon x+2y-3=0 $ có một véc-tơ chỉ phương là $\overrightarrow{u}=(2;-1)$.
	}
\end{ex}
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3Y1-1]
	...
	\loigiai{
		Véc-tơ pháp tuyến của $d$ là $(5;-3)$ hay $(-5;3)$, $(-15;9)$.
	}
\end{ex}
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3Y1-1]
	...
	\loigiai{
		Trong các véc-tơ đã cho thì $\overrightarrow{u}=(3;-4)$ là một véc-tơ chỉ phương của $d$.}
\end{ex}
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3Y1-1]
	...
	{\True Vô số}
	\loigiai{
		Một đường thẳng có vô số véc-tơ pháp tuyến.
	}
\end{ex}
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3Y1-1]% Câu 3
	...
	{$(1;3)$}
	\loigiai{
		Phương trình đường thẳng $ax+by+c=0$ có véc-tơ chỉ phương là $(b;-a)$ hoặc $(-b;\,a)$.\\
		Vậy  $\Delta\colon \,\,x+3y-11=0$ có véc-tơ chỉ phương là $(3;-1)$.
	}
\end{ex}
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3Y1-1]
	...
	\loigiai{
		Véc-tơ pháp tuyến của đường thẳng có toạ độ là $(1;-3)$.
	}
\end{ex}
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3Y1-1]% Câu 12
	...
	{$(2;0)$}
	\loigiai{
		Phương trình tham số $\heva{&x=2+t\\&y=t }\quad (t\in \mathbb{R})$ có véc-tơ chỉ phương là $\overrightarrow{a}=(1;1)$.\\
		Với $\overrightarrow{n}=(-2;2)$, ta có $\overrightarrow{a}\cdot \overrightarrow{n}=0$.\\
		Vậy véc-tơ pháp tuyến của $d$ là $\overrightarrow{n}=(-2;2)$.}
\end{ex}
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3Y1-1]
	...
	\loigiai{
		Đường thẳng $d\colon 5x-y+2022=0$ có véc-tơ pháp tuyến là $\overrightarrow{u}=\left(5;-1\right)$.
	}
\end{ex}
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3Y1-1]
	...
	\loigiai{
		Một véc-tơ pháp tuyến của $d$ là $\overrightarrow{n_3}=(-2;3)$.
	}
\end{ex}
...
\begin{ex}%[Bài giảng 10 đợt 2, 2022-2023]%[Lê Văn Toàn]%[0H3Y1-1]
	...
	\loigiai{
		Véc-tơ pháp tuyến của $(d)$ là $\overrightarrow{n}=(3;2)\Rightarrow \overrightarrow{u}=(2;-3) $ là véc-tơ chỉ phương của $(d)$.
	}
\end{ex}
...
\begin{vd}%[Nguyễn Hoài Nam]%[0H3Y1]
	...
	\loigiai{
		Phương trình tham số đường thẳng $\Delta \colon \heva{&x=1-t\\&y=2+3t.}$
	}
\end{vd}
\begin{vd}%[Nguyễn Hoài Nam]%[0H3Y1]
	...
	\loigiai{
		...
		Vậy phương trình tham số đường thẳng $d \colon \heva{&x = 1 + 2t \\ &y = 2 - t.}$
	}
\end{vd}
\begin{vd}%[Nguyễn Hoài Nam]%[0H3B1]
	...
	\loigiai{
		...
		Phương trình tham số đường thẳng $d \colon \heva{&x = -2 - 3t \\& y = 3 + t.}$
	}
\end{vd}
\baitaptl   
...
\begin{ex}%[Nguyễn Hoài Nam]%[0H3B1]
	...
	\loigiai{Ta có $\overrightarrow{AB}=(-3;10)$.\\
		Đường thẳng $AB$ có vectơ chỉ phương là $\overrightarrow{AB}=(-3;10)$ và đi qua điểm $A(3;-4)$ có phương trình tham số là $\heva{& x=3-3t\\& y=-4+10t.}$ }
\end{ex}

\begin{ex}%[Nguyễn Hoài Nam]%[0H3B1]
	Trong mặt phẳng $Oxy$, cho đường thẳng $\Delta$ có phương trình tham số $\heva{& x=3+4t\\&y=-4+t}$. Điểm nào sau đây thuộc đường thẳng $\Delta$?
	\choice
	{$M(19;1)$}
	{\True $N(19;0)$}
	{$P(19;2)$}
	{$Q(7;1)$}
	\loigiai{Thay tọa độ điểm $M(19;1)$ vào phương trình đường thẳng $\Delta$
		ta có
		$$\heva{& 19=3+4t\\&1=-4+t}\Leftrightarrow \heva{&t=4\\&t=5}\Rightarrow M\notin \Delta.$$
		Thay tọa độ điểm $N(19;0)$ vào phương trình đường thẳng $\Delta$ ta có
		$$\heva{& 19=3+4t\\&0=-4+t}\Leftrightarrow \heva{&t=4\\&t=4}\Leftrightarrow t=4\Rightarrow N\in \Delta.$$
		Thay tọa độ điểm $P(19;2)$ vào phương trình đường thẳng $\Delta$
		ta có
		$$\heva{& 19=3+4t\\&2=-4+t}\Leftrightarrow \heva{&t=4\\&t=6}\Rightarrow P\notin \Delta.$$
		Thay tọa độ điểm $Q(7;1)$ vào phương trình đường thẳng $\Delta$ ta có
...
\begin{ex}%[Nguyễn Hoài Nam]%[0H3B1]
	...
	\loigiai{ Đường thẳng $\Delta\colon y=kx+b\Rightarrow \heva{&x=t\\&y=b+kt}$.\\
		Khi đó đường thẳng $\Delta$ có véc-tơ chỉ phương là $\overrightarrow{u}=(1;k).$ }
\end{ex}
...
\begin{ex}%[Nguyễn Hoài Nam]%[0H3B1]
	...
	{$\heva{&x=1+9t\\&y=-4-4t}$}
	\loigiai{Đường thẳng $d$ đi qua điểm $A(1;-4)$ có véc-tơ chỉ phương là $\overrightarrow{u} =(-4;9)$ nên có phương trình $\heva{& x=1-4t\\&y=-4+9t.}$ }
\end{ex}
...
\begin{ex}%[Nguyễn Hoài Nam]%[0H3B1]
	...
	{$\heva{&x=3+3t\\&y=-5+t}$}
	{$\heva{&x=3-3t\\&y=-5+t}$}
	\loigiai{Do phương trình đường thẳng $d$ có hệ số góc $k=-3$ nên véc-tơ chỉ phương của $d$ là $\overrightarrow{u}=(1;-3)$. Khi đó, phương trình tham số của $d$ là $\heva{&x=3+t\\&y=-5-3t.}$}
\end{ex}
\begin{ex}%[Nguyễn Hoài Nam]%[0H3B1]
...
\begin{ex}%[Nguyễn Hoài Nam]%[0H3B1]
	...
	{$\heva{& x=2+4t\\&y=5-3t}$}
	\loigiai{
		Do $\overrightarrow{n}_{\Delta}=(4;-3)$ nên $\overrightarrow{u}_{\Delta}=(3;4)$. Khi đó, phương trình đường thẳng $\Delta$ là $\heva{&x=5+3t\\&y=-2+4t.}$\\
...
\begin{ex}%[Nguyễn Hoài Nam]%[0H3K1]
	...
	{$t=-\dfrac{3}{2}$}
	\loigiai{
		Thay tọa độ điểm $A\left(\dfrac{7}{2};-2\right)$ vào phương trình đường thẳng $d$ ta được
...
\begin{ex}%[Nguyễn Hoài Nam]%[0H3B1]
	...
	{$\heva{x&=-1-2t\\y&=3+t}$}
	\loigiai{
		Phương trình tham số đường thẳng $d\colon \heva{&x=1-2t \\ &y=-3+t.}$
	}
\end{ex}
...
\begin{ex}%[Nguyễn Hoài Nam]%[0H3K1]
	Trong mặt phẳng $Oxy$, cho đường thẳng $\Delta$ có phương trình tham số $\heva{& x=2+2t\\&y=3+t}$. Tìm điểm $M$ có tọa độ nguyên nằm trên đường thẳng $\Delta$ và cách điểm $A(0;1)$ một khoảng bằng 5.
	\choice
	{$M(-4,4)$}
	{\True $M(4;4)$}
	{$M(0;2)$}
...
\begin{ex}%[Nguyễn Hoài Nam]%[0H3K1]
	Trong mặt phẳng $Oxy$, cho đường thẳng $\Delta$ có phương trình tham số $\Delta \colon \heva{& x=2+2t\\&y=3+t}$. Có bao nhiêu điểm thuộc đường thẳng $\Delta$ và cách điểm $A(0; 1)$ một khoảng bằng $5$.
	\choice
	{$1$}
	{$3$}
	{\True $2$}
...
\end{ex}
\begin{ex}%[Nguyễn Hoài Nam]%[0H3K1]
	Trong mặt phẳng $Oxy$, cho đường thẳng $\Delta$ có phương trình tham số $\heva{& x=2+2t\\&y=3+t}$. Gọi $M(a;b)$ là giao điểm của đường thẳng $\Delta$ với đường thẳng $d: x+y+1=0$. Tính $a^2+b^2$.
	\choice
	{$a^2+b^2 =4$}
	{$a^2+b^2 =3$}
	{\True $a^2+b^2 =5$}
...
\end{ex}
\begin{ex}%[Nguyễn Hoài Nam]%[0H3K1]
	Trong mặt phẳng $Oxy$, cho đường thẳng $\Delta$ có phương trình tham số $\heva{& x=2+2t\\&y=3+t}$ và $A(0;1)$. Gọi $M(a; b)$ là điểm trên $\Delta$  sao cho $AM$ ngắn nhất. Tính $a+b$.
	\choice
	{$\dfrac{9}{5}$}
	{$\dfrac{-2}{5}$}
	{$\dfrac{11}{5}$}
...
\begin{ex}%[Nguyễn Hoài Nam]%[0H3K1]
	...
	\loigiai{$\overrightarrow{AB}=(-2;0)$ cùng phương với $\overrightarrow{u}=(1;0)$.\\
		Suy ra đường thẳng $AB$ có một véc-tơ chỉ phương $\overrightarrow{u}=(1;0)$.\\
...
\end{ex}
\begin{ex}%[Nguyễn Hoài Nam]%[0H3K1]
	Viết phương trình tham số của đường thẳng đi qua gốc tọa độ $O$ và song song với đường thẳng $d\colon \heva{x&=1+4t\\y&=1+3t.}$
	\choice
	{\True $\heva{x&=4t\\y&=3t}$}
	{$\heva{x&=4t\\y&=1+3t}$}
	{$\heva{x&=-3t\\y&=4t}$}
	{$\heva{x&=3t\\y&=-4t}$}
	\loigiai{ 
		Đường thẳng song song với $d$ có một véc-tơ chỉ phương $\overrightarrow{u}=\overrightarrow{u}_{d}=(4;3)$.\\
		Phương trình đường thẳng qua $O(0;0)$ và nhận $\overrightarrow{u}=(4;3)$  làm véc-tơ chỉ phương  là  $\heva{x&=4t\\y&=3t.}$
	}
\end{ex}
\begin{ex}%[Nguyễn Hoài Nam]%[0H3K1]
	Viết phương trình tham số của đường thẳng $d$ đi qua $A(-1;2)$ và vuông góc với đường thẳng $\Delta \colon 2x-y+4=0$.
	\choice
	{$\heva{x&=-1+2t\\y&=2+t}$}
	{\True $\heva{x&=-1+2t\\y&=2-t}$}
	{$\heva{x&=1+2t\\y&=2-t}$}
	{$\heva{x&=-1+t\\y&=2+2t}$}
	\loigiai{Đường thẳng $\Delta$ có một véc-tơ pháp tuyến $\overrightarrow{n}_{\Delta}=(2;-1)$.\\
		Vì $d$ vuông góc với $\Delta$ nên $d$ có  véc-tơ chỉ phương $\overrightarrow{u}_{d}=\overrightarrow{n}_{\Delta}=(2;-1)$.\\
		Phương trình đường thẳng $d:\heva{x&=-1+2t\\y&=2-t.}$
	}
\end{ex}
\begin{ex}%[Nguyễn Hoài Nam]%[0H3K1]
	...
	\loigiai{Vì $M$ là trung điểm của $AB$ nên 
		...
		Đường thẳng $CM$ đi qua $C(3;-2)$ và nhận $\overrightarrow{u}=(-1;4)$ làm véc-tơ chỉ phương  có phương trình  là $$\heva{x&=3+t\\y&=-2-4t.}$$
	}
\end{ex}
\begin{ex}%[Nguyễn Hoài Nam]%[0H3G1]
...
\begin{ex}%[Nguyễn Hoài Nam]%[0H3G1]
	...
	{$M'\left(\dfrac{11}{5};-\dfrac{23}{5}\right)$}
	\loigiai{ 
		Đường thẳng $d$ có véc-tơ chỉ phương $\overrightarrow{u}=(3;-1)$.
...
\begin{vd}%%[0H3B1-2]
	...
	\loigiai{
		Vì đường thẳng $\Delta$ qua $N(2;3)$ và nhận $ \overrightarrow{AB} = (1;-2)$ làm véc-tơ pháp tuyến nên
...
\end{center}
\begin{bt}%[0H3B1-2]
	Trong mặt phẳng $Oxy$, cho đường thẳng $\Delta$ có phương trình tham số $\heva{ & x=1+2t \\ & y=-3-t}$.
	\begin{enumerate}
	...
	\loigiai{
		\begin{enumerate}
			\item Đường thẳng $\Delta$ có véc-tơ chỉ phương là $\overrightarrow{u}=\left(2;-1\right)$ nên $\Delta$ có véc-tơ pháp tuyến là $\overrightarrow{n}=\left(1;2\right)$.\\
...
\begin{bt}%[0H3B1-2]
	...
	\loigiai{
		\begin{enumerate}
			\item Ta có $\overrightarrow{AB}=(1;4)$ là một véc-tơ chỉ phương của đường thẳng $AB$.\\
			Đường thẳng $AB$ đi qua điểm $A$ và nhận $\overrightarrow{n}=(4;-1)$ làm véc-tơ pháp tuyến nên đường thẳng $AB$ có phương trình $$4(x-1)-1(y-1)=0 \Leftrightarrow 4x-y-3=0.$$
			...
			Đường thẳng $AM$ nhận $\overrightarrow{AM}$ làm véc-tơ chỉ phương. Do đó $AM$ nhận $\overrightarrow{m}=(3;2)$ làm véc-tơ pháp tuyến.\\
...
\end{bt}
\begin{ex}%[0H3Y1-2]
	Trong mặt phẳng $Oxy$, viết phương trình tổng quát của đường thẳng $d$ đi qua điểm $A(-1;3)$ và có véc-tơ pháp tuyến $\overrightarrow{n}=(2;1)$.
	\choice
	{$2x+y+1=0$}
	{$-x+3y-1=0$}
	{$2x+y-5=0$}
	{\True $2x+y-1=0$}
	\loigiai{
		Phương trình đường thẳng $d\colon 2(x+1)+1(y-3)=0\Leftrightarrow 2x+y-1=0$.
	}
\end{ex}
...
\begin{ex}%[0H3K1-2]
	...
	\loigiai{
		...
		Đường thẳng trung trực của đoạn $AB$ đi qua điểm $I(2;-1)$ và nhận $\overrightarrow{AB}=(2;6)$ làm véc-tơ pháp tuyến, do đó có phương trình\\
		\centerline{$2(x-2)+6(y+1)=0 \Leftrightarrow 2x+6y+2=0 \Leftrightarrow x+3y+1=0$.}
	}
\end{ex}

\begin{ex}%[0H3Y1-2]
	Cho đường thẳng $d$ có phương trình tham số $\heva{&x=5+t\\&y=-9-2t}$. Phương trình tổng quát của $d$ là
	\choice
	{$x+2y+1=0 $}
	{\True $ 2x+y-1=0$}
	{$ -2x+y-1=0$}
	{$2x+3y-1=0 $}
	\loigiai{
		Đường thẳng $d$ đi qua $A(5;-9)$ và có véc-tơ chỉ phương là $(1;-2)$ nên $d$ có véc-tơ pháp tuyến là $(2;1)$. Khi đó, phương trình tổng quát của $d$ là
...
\begin{ex}%[0H3B1-2]
	...
	{$3x-y-5=0$}
	\loigiai{
		Ta có $\overrightarrow{AB} = (1; 3)$ là véc-tơ chỉ phương của đường thẳng $AB$.\\
		Suy ra đường thẳng $AB$ có véc-tơ pháp tuyến là $\overrightarrow{n} = (3; -1)$.\\
...
\begin{ex}%[0H3B1-2]
	...
	{$4x+3y=0$}
	\loigiai{
		Vì $\Delta \perp d$ nên đường thẳng $\Delta$ nhận véc-tơ pháp tuyến $\overrightarrow{n}_\mathrm{d}(4;-3)$ làm véc-tơ chỉ phương, suy ra véc-tơ pháp tuyến của $\Delta$ là $\overrightarrow{n}_{\Delta}(3;4)$. \\
		Đường thẳng $\Delta$ đi qua điểm $O(0;0)$ và có véc-tơ pháp tuyến của $\Delta$ là $\overrightarrow{n}_{\Delta}(3;4)$. \\
...
\begin{ex}%[0H3K1-2]
	...
	{\True $7x +3y -11 =0$}
	\loigiai{
		Đường cao hạ từ đỉnh $A$ đi qua điểm $A(2;-1)$ và nhận $\overrightarrow{CB}=(7;3)$ làm véc-tơ pháp tuyến. \\
