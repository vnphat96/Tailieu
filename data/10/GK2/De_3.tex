...
\begin{ex}%[0H9N3-1]
	...
	\loigiai{
		...
		Suy ra vectơ pháp tuyến của đường thẳng $AB$ là $\vec{n}_{AB}=\left( -1;\,2 \right)$.
	}
\end{ex}
...
\begin{ex}%[0D3N1-5]
	\immini[thm]{Cho hàm số $y=ax^2+bx+c$ có đồ thị $(P)$ như hình vẽ. Khẳng định nào sau đây là đúng?
		\choice
