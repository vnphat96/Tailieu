...
\begin{vd}
	\immini[thm]{Cho hệ bất phương trình bậc nhất hai ẩn $\heva{& 3x+y\leq 6 \\& x+y\leq 4 \\& x\geq 0 \\& y\geq 0 .}$ có miền nghiệm là phần không bị gạch như hình bên (tứ giác $OABC$, bao gồm các cạnh). 
		\begin{tasks}(1)
