...
\def\tenchude{GIÁ TRỊ LƯỢNG GIÁC}
% \def\tendethi{ }
\def\tentruong{PHedu}
...
%%Bài 4
% \input{data/11KNTT/data1/1K1-4-LT.tex} \foreach \i in {2,3,4,5,6,7,11} {\input{data/11KNTT/data1/1K1-4-\i.tex}}
...
\begin{center}
\includegraphics[width=5cm]{QRcode/11D1XOTC.png}
\end{center}
\end{document}