...
\begin{ex}%[2D2B4-2]
    ...
    {$y'=\dfrac{1}{x}$}
    \loigiai{
        Áp dụng công thức $\left(\log_ax\right)'=\dfrac{1}{x\ln a}$, ta được $y'=\dfrac{1}{x\ln 10}$.
    }
\end{ex}
...
\begin{ex}%[2D2B4-2]
    ...
    {$y'=\dfrac{1}{2x+1}$}
    \loigiai{
        Ta có $y'=\left(\log_2\left(2x+1\right)\right)'=\dfrac{\left(2x+1\right)'}{\left(2x+1\right)\ln 2}=\dfrac{2}{\left(2x+1\right)\ln 2}$.
    }
\end{ex}
