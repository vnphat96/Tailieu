...
\begin{ex}%[2D1G2-3]
	...
	\loigiai{
		...
		\begin{itemize}
			...
			Để hàm số đạt cực đại tại $x=0$ thì $y’$ phải đổi dấu từ dương sang âm khi đi qua $x=0$, xảy ra khi và chỉ khi $\heva{&\mathop {\lim }\limits_{x\to {0^-}}g(x)<0\\ 
				&\mathop {\lim }\limits_{x\to {0^+}}g(x)<0}\Leftrightarrow 6(m^2-25)<0\Leftrightarrow-5<m<5.$
		\end{itemize}
...
\begin{ex}%[2D1G2-3]%[Mã 102-2018]
	...
	\loigiai{
		...
		\begin{itemize}
			...
			\item  Nếu $m\ne\pm 1$: khi đó $x=0$ là nghiệm bội lẻ. Xét  $g(x)=8x^4+5\left(m-1\right)x-4\left(m^2-1\right)$. \\Để $x=0$ là điểm cực tiểu thì $\mathop {\lim }\limits_{x\to {0^-}}g(x)=-4(m^2-1)>0\Leftrightarrow{m^2}-1<0\Leftrightarrow-1<m<1$. \\Vì $m$ nguyên nên chỉ có giá trị $m=0$.
		\end{itemize}
...
\begin{ex}%[2D1K2-4]
	...
	\loigiai{
		...
		Thay tọa độ các điểm $P$, $M$, $N$, $Q$ vào phương trình đường thẳng $AB$ ta có điểm $ N\left(1;-10\right)$ thuộc đường thẳng.
	}
\end{ex}
...
\begin{ex}%[2D1K2-4]%[Chuyên Vĩnh Phúc-2018]
	...
	\loigiai{
		...
		Ta có $y=y'.\left(\dfrac{1}{3}x+\dfrac{2}{9}\right)+\left(\dfrac{2m}{3}-\dfrac{26}{9}\right)x+\dfrac{7m}{9}+\dfrac{2}{3}$ nên phương trình đường thẳng đi qua hai điểm cực trị là $y=\left(\dfrac{2m}{3}-\dfrac{26}{9}\right)x+\dfrac{7m}{9}+\dfrac{2}{3}$. \\
...
\begin{ex}%[Đề Tham Khảo 2017]
	...
	\loigiai{
		...
		Khi đó phương trình đường thẳng $AB:y=-\dfrac{2}{3}x+\dfrac{m\left(m^2-1\right)}{3}$ \\
...
\begin{ex}%[2D1G2-4][THPT Cẩm Bình Hà Tỉnh 2019]%Câu 68
	...
	\loigiai{
		...
		Phương trình đường thẳng $AB$ là $$\dfrac{x-0}{2m-0}=\dfrac{y-\left(4m^2-2\right)}{-4m^3}\Leftrightarrow 2m^2x+y-4m^2+2=0.$$
		Do đó
...
\begin{ex}%[2D1G2-4]%Câu 74
	...
	\loigiai{
		...
		$$y'=0\Leftrightarrow\left[\begin{aligned}
			...
			&x=m+1.\\ 
		\end{aligned}\right.$$
		Từ đó đồ thị hàm số có hai điểm cực trị là $A\left(m;2m^3+3m^2+1\right)$, $B\left(m+1;2m^3+3m^2\right)$.	Suy ra $ AB=\sqrt{2}$ và phương trình đường thẳng $AB$ là
		$$x+y-2m^3-3m^2-m-1=0.$$
...
\begin{ex}%[2D1G2-4]%Câu 77
	...
	\loigiai{
		...
		Gọi $A\left(m+1;-4m-2\right)$, $ B\left(m-1;-4m+2\right)$. Suy ra $AB=2\sqrt{5}$ và phương trình đường thẳng $AB$ là
...
\begin{ex}%[2D1G2-4]%Câu 78
	...
	\loigiai{
		...
		Phương trình đường thẳng $ AB:4mx+y-4=0$. Đặt $a=d\left(I,AB\right)\left(0<a<\sqrt{2}\right)$, suy ra $HB=\sqrt{2-a^2}$ với $H$ là trung điểm của $AB$.\\
