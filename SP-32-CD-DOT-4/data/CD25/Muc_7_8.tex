...
\begin{ex}
	...
	\loigiai{
		...
		$\begin{aligned}
			&F(x)=\displaystyle\int{\left(\ln \left(x-1\right)+3x^2\right)\mathrm{d}x}=x\ln \left(x-1\right)-\displaystyle\int{x\mathrm{d}\left(\ln \left(x-1\right)\right)}+x^3=x\ln \left(x-1\right)-\displaystyle\int{x.\dfrac{1}{x-1}\mathrm{d}x}+x^3\\ 
...
\begin{ex}
	...
	\loigiai{
		...
		Suy ra\\
		$ f(x)=F'(x)=\left(\mathrm{e}^x-2x^2\right)'=\mathrm{e}^x-4x\Rightarrow f\left(2x\right)=\mathrm{e}^{2x}-8x$\\
...
\begin{ex}
	...
	\loigiai{
		Tính $ g(x)=\displaystyle\int{\left(x+1\right)}{f}'(x)\mathrm{d}x=\left(x+1\right)f(x)-\displaystyle\int{\left(x+1\right)'}f(x)\mathrm{d}x=\dfrac{x^2+x}{\sqrt{x^2+2}}-\displaystyle\int{f(x)\mathrm{d}x}$\\
