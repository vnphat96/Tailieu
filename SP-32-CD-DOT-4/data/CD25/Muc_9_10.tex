...
\begin{ex}
	...
	\loigiai{
		...
		$\dfrac{x}{x+1}.f'(x)+\dfrac{1}{\left(x+1\right)^2}f(x)=\dfrac{x}{x+1}\Leftrightarrow{\left[\dfrac{x}{x+1}.f(x)\right]'}=\dfrac{x}{x+1}$.\\
		Vậy $\dfrac{x}{x+1}.f(x)=\displaystyle\int{\left[\dfrac{x}{x+1}.f(x)\right]'}\mathrm{d}x=\displaystyle\int{\dfrac{x}{x+1}}\mathrm{d}x=\displaystyle\int{\left(1-\dfrac{1}{x+1}\right)}\mathrm{d}x=x-\ln \left| x+1\right|+C$.\\
...
\begin{ex}
	...
	\loigiai{
		...
		Đặt $\left\{\begin{aligned}
			...
			&{\mathrm{e}^x}\mathrm{d}x=\mathrm{\,d}v\Rightarrow v=\mathrm{e}^x\\
		\end{aligned}\right.$.\\
...
\begin{ex}
	...
	\loigiai{
		...
		Nên $\displaystyle\int{f(x).f'(x).\mathrm{d}x=\displaystyle\int{\left(x+\dfrac{1}{x}-1\right)}}.\mathrm{d}x$ $\Leftrightarrow\displaystyle\int{f(x).\mathrm{\,d}\left(f(x)\right)=\displaystyle\int{\left(x+\dfrac{1}{x}-1\right)}}.\mathrm{d}x$\\
...
\begin{ex}
	...
	\loigiai{
		...
		$ I=\displaystyle\int{\dfrac{x}{\cos^2x}\mathrm{d}x}=x\tan x-\displaystyle\int{\tan x\mathrm{d}x}=x\tan x+\displaystyle\int{\dfrac{\mathrm{\,d}\left(\cos x\right)}{\cos x}\mathrm{d}x}=x\tan x+\ln \left|\cos x\right|$.\\
...
\begin{ex}
	...
	\loigiai{
		...
		$\Rightarrow\displaystyle\int{\dfrac{f'(x)}{f^2(x)}\mathrm{d}x=\displaystyle\int{\dfrac{1-\dfrac{1}{x^2}}{\left(x+\dfrac{1}{x}\right)^2}\mathrm{d}x}}$$\Rightarrow\displaystyle\int{\dfrac{f'(x)}{f^2(x)}\mathrm{d}x=\displaystyle\int{\dfrac{\mathrm{\,d}\left(x+\dfrac{1}{x}\right)}{\left(x+\dfrac{1}{x}\right)^2}}}$$\Rightarrow-\dfrac{1}{f(x)}=-\dfrac{1}{x+\dfrac{1}{x}}+C$.\\
...
\begin{ex}
	...
	\loigiai{
		...
		Suy ra $\displaystyle\int{\dfrac{f(x).f'(x)}{\sqrt{1+f^2(x)}}\mathrm{d}x}=\displaystyle\int{\left(2x+1\right)}\mathrm{d}x\Leftrightarrow\displaystyle\int{\dfrac{\mathrm{\,d}\left(1+f^2(x)\right)}{2\sqrt{1+f^2(x)}}}=\displaystyle\int{\left(2x+1\right)}\mathrm{d}x\Leftrightarrow\sqrt{1+f^2(x)}=x^2+x+C$.\\
...
\begin{ex}
	...
	{\True $ 3<f(5)<4$}
	\loigiai{
		Ta có $f(x)=f'(x).\sqrt{3x+1}$ $\Leftrightarrow\dfrac{f'(x)}{f(x)}=\dfrac{1}{\sqrt{3x+1}}$ $\Rightarrow\displaystyle\int{\dfrac{f'(x)}{f(x)}\mathrm{d}x}=\displaystyle\int{\dfrac{1}{\sqrt{3x+1}}\mathrm{d}x}$ $\Leftrightarrow\displaystyle\int{\dfrac{\mathrm{\,d}\left(f(x)\right)}{f(x)}}=\displaystyle\int{\dfrac{1}{\sqrt{3x+1}}\mathrm{d}x}$ $\Leftrightarrow\ln f(x)=\dfrac{2}{3}\sqrt{3x+1}+C$ $\Leftrightarrow f(x)=e^{\frac{2}{3}\sqrt{3x+1}+C}$\\
...
\begin{ex}
	...
	\loigiai{
		...
		$\displaystyle\int{\dfrac{f'(x)}{f^2(x)}\mathrm{d}x=\displaystyle\int{\dfrac{3x^4+x^2-1}{x^2}\mathrm{d}x}}$ $\Leftrightarrow $ $\displaystyle\int{\dfrac{\mathrm{\,d}\left(f(x)\right)}{f^2(x)}=\displaystyle\int{\dfrac{3x^4+x^2-1}{x^2}\mathrm{d}x}}$. $\Leftrightarrow $ $\displaystyle\int{\dfrac{\mathrm{\,d}\left(f(x)\right)}{f^2(x)}=\displaystyle\int{\left(3x^2+1-\dfrac{1}{x^2}\right)\mathrm{d}x}}$ $\Leftrightarrow $ $\dfrac{-1}{f(x)}=x^3+x+\dfrac{1}{x}+C$ $\Leftrightarrow $ $f(x)=\dfrac{-1}{x^3+x+\dfrac{1}{x}}+C$.\\
...
\begin{ex}
	...
	\loigiai{
		...
		$\displaystyle\int{f(x){\mathrm{e}^{2x}}}\mathrm{d}x=\displaystyle\int{\left(x+2\right){\mathrm{e}^x}\mathrm{d}x}=\displaystyle\int{\left(x+2\right)\mathrm{\,d}\left(\mathrm{e}^x\right)}=\left(x+2\right){\mathrm{e}^x}-\displaystyle\int{\mathrm{e}^x\mathrm{\,d}\left(x+2\right)}=\left(x+2\right){\mathrm{e}^x}-\displaystyle\int{\mathrm{e}^x\mathrm{d}x}=$\\
...
\begin{ex}
	...
	\loigiai{
		...
		Ta có $\displaystyle\int{g(x)\mathrm{d}x}=\displaystyle\int{\dfrac{1-2\ln x}{x\ln x}\mathrm{d}x}=\displaystyle\int{\dfrac{1-2\ln x}{\ln x}\mathrm{\,d}\left(\ln x\right)}=\displaystyle\int{\left(\dfrac{1}{\ln x}-2\right)\mathrm{d}\left(\ln x\right)}$\\
