...
\begin{ex}%[2H1G3-3]
	...
	\loigiai{
		...
		$ S_{\triangle Q R C'}=\dfrac{1}{2} S_{Q R C' C}=\dfrac{1}{4} S_{B B' C' C} ; S_{\triangle Q R S}=\dfrac{1}{3} S_{Q R C'}=\dfrac{1}{3} \cdot \dfrac{1}{4} S_{B B' C' C}=\dfrac{1}{12} S_{B B' C' C}$\\
		$\begin{aligned}
			V_{A \cdot Q R S}&=\dfrac{1}{3} S_{\triangle Q R S} \cdot \mathrm{d}(A,(Q R S))=\dfrac{1}{3}\left(\dfrac{1}{12} S_{B B' C' C}\right) \cdot\left(\mathrm{d}\left(A,\left(B B' C' C\right)\right)\right)\\
...
\begin{ex}%[2H1K3-2]
	...
	\loigiai{
		\immini{
			Đặt $a=1$. Trong KG $Oxyz$, chọn hệ trục tọa độ như hình vẽ bên, ta có $A\equiv O(0; 0; 0)$, $B\left(0;\sqrt{3}; 0\right)$, $D(1; 0; 0)$, $C\left(1;\sqrt{3}; 0\right)$, $S(0; 0; b)$ với $b>0$.\\
