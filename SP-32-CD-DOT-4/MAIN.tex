...
\input{data/CD1/Muc_5_6}
\input{data/CD1/Muc_7_8}
\input{data/CD1/Muc_9_10}
\chapter{CỰC TRỊ CỦA HÀM SỐ}
\input{data/CD2/Muc_7_8}
\input{data/CD2/Muc_9_10}
\chapter{GIÁ TRỊ LỚN NHẤT - GIÁ TRỊ NHỎ NHẤT CỦA HÀM SỐ}
\input{data/CD3/Muc_5_6}
\input{data/CD3/Muc_7_8}
\input{data/CD3/Muc_9_10}
\chapter{TIỆM CẬN CỦA ĐỒ THỊ HÀM SỐ}
\input{data/CD4/Muc_5_6}
\input{data/CD4/Muc_7_8}
\input{data/CD4/Muc_9_10}
\chapter{ĐỌC ĐỒ THỊ CỦA HÀM SỐ}
\input{data/CD5/Muc_5_6}
\input{data/CD5/Muc_7_8}
\chapter{TƯƠNG GIAO ĐỒ THỊ HÀM SỐ}
\input{data/CD6/Muc_5_6}
\input{data/CD6/Muc_7_8}
\input{data/CD6/Muc_9_10}
\chapter{GÓC - HÌNH HỌC KHÔNG GIAN}
\input{data/CD7/Muc_9_10_DA2}
\chapter{KHOẢNG CÁCH - GÓC TRONG KHÔNG GIAN}
\input{data/CD8/Muc_9_10}
\chapter{NHẬN DIỆN KHỐI ĐA DIỆN}
\input{data/CD9/Muc_5_6}
\chapter{THỂ TÍCH KHỐI CHÓP}
\input{data/CD10/Muc_5_6}
\input{data/CD10/Muc_7_8}
\chapter{THỂ TÍCH KHỐI LĂNG TRỤ}
\input{data/CD11/Muc_5_6}
\input{data/CD11/Muc_7_8}
\chapter{MỘT SỐ BÀI TOÁN KHÓ VỀ THỂ TÍCH}
\input{data/CD12/Muc_9_10}
\chapter{THỂ TÍCH KHỐI ĐA DIỆN KHÁC}
\input{data/CD13/Muc_5_6}
\input{data/CD13/Muc_7_8_9_10}
\input{data/CD14/Muc_10}
\chapter{CỰC TRỊ THỂ TÍCH KHỐI ĐA DIỆN}
\input{data/CD15/Muc_9_10}
\chapter{LŨY THỪA, HÀM SỐ LŨY THỪA}
\input{data/CD16/Muc_5_6}
\chapter{CÔNG THỨC, BIẾN ĐỔI LOGARIT}
\input{data/CD17/Muc_5_6}
\input{data/CD17/Muc_7_8}
\input{data/CD17/Muc_9_10}
\chapter{HÁM SỐ MŨ HÀM SỐ LOGARIT}
\input{data/CD18/Muc_5_6}
\input{data/CD18/Muc_7_8}
\input{data/CD17/Muc_9_10}
\chapter{CD20}
\input{data/CD20/Muc_5_6}
\input{data/CD20/Muc_7_8}
\input{data/CD20/Muc_9_10}
\chapter{KHỐI TRỤ}
\input{data/CD22/Muc_5_6}
\input{data/CD22/Muc_7_8}
\input{data/CD22/Muc_9_10}
\end{document}
