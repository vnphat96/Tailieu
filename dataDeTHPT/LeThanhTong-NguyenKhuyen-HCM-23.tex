...
Trong không gian $Oxyz$, cho hai mặt phẳng $(P) \colon x-2 y+z-3=0$ và $(Q) \colon x+y-1=0$. Giao tuyến của $(P)$ và $(Q)$ có một véc-tơ chỉ phương là
\choice
...
Trong không gian $Oxyz$, đường thẳng $\Delta$ đi qua điểm $M(1; 0;-2)$ và vuông góc với mặt phẳng $(Q) \colon 4x+y-3z+2023=0$ có phương trình tham số là
\def\dotEX{}
\choice
...
Mặt khác, $\Delta$ qua $M(1;0;-2)$ nên có phương trình tham số là $\heva{&x=1+4t \\&y=t \\&z=-2-3t.}$\\
Với $t=-1$, đường thẳng $\Delta$ cũng qua điểm $N(-3;-1;1)$.\\
Do đó, $\Delta$ cũng có phương trình tham số là $\heva{&x=-3+4t \\ &y=-1+t \\ &z=1-3t.}$
}
\end{ex}
