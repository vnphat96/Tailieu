...
Trong không gian với hệ tọa độ $Oxyz$, góc giữa hai mặt phẳng $(O x z)$ và $(O y z)$ bằng
\choice
{\True $90^{\circ}$}
{$60^{\circ}$}
{$30^{\circ}$}
...
Trong không gian $Oxyz$, cho tam giác $ABC$ có $A(- 1; 3; 2) , B(2; 0; 5), C(0; -2;1)$. Viết phương trình đường thẳng $d$ chứa đường trung tuyến kẻ từ đỉnh $A$ của tam giác $ABC$.
\choice
...
Cho hàm số $y=f(x)$, bảng biến thiên của hàm số $f^{\prime}(x)$ như sau.
\begin{center}
