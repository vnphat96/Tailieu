...
\begin{ex}%[Thi thử tốt nghiệp - SGD Hưng Yên - 23]%[Lê Văn Toàn - EX6-2023]%[2H3B3-2]
	...
	\loigiai{
		...
		Vậy $d$ có phương trình tham số là $\heva{&x=1+t \\ &y=2-2t \\ &z=3+t.}$
	}
\end{ex}
...
\begin{ex}%[Thi thử tốt nghiệp - SGD Hưng Yên - 23]%[Lê Văn Toàn - EX6-2023]%[2H3B3-3]
	...
	\loigiai{
		...
		Đường thẳng $\Delta$ có véc-tơ chỉ phương $\overrightarrow{u}_\Delta=(1;1;1)$ và đi qua điểm $M(2;0;1)$ có phương trình tham số là $\heva{&x=2+t\\&y=t\\&z=1+t.}$\\
...
\begin{ex}%[Thi thử tốt nghiệp - SGD Hưng Yên - 23]%[Lê Văn Toàn - EX6-2023]%[2H3B2-3]
	Trong không gian với hệ tọa độ $Oxyz$, viết phương trình mặt phẳng $(\alpha)$ đi qua $M(-1;-1;2)$, đồng thời vuông góc với cả hai mặt phẳng $(P) \colon x+4y-6z-10=0$ và $(Q) \colon x+2y-5z-11=0$.
	\choice
	{$8x-y+2z+3=0$}
	{$-8x+y+2z-11=0$}
	{$8x+y-2z+13=0$}
