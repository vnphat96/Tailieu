...
%%==========Câu 4
\begin{ex}%[2H3Y2-2]
Trong không gian $Oxyz$, cho mặt phẳng $(\alpha)\colon 2x-y-z+3=0$. Véc-tơ nào sau đây không là một véc-tơ pháp tuyến của $(\alpha)$?
\choice
...
\begin{ex}%[2D2G6-5]
	...
	\loigiai{
		...
		$\Rightarrow g^{\prime}(y)=2 x+2 y-9-\dfrac{6}{1+x+y}=0 \Leftrightarrow x+y=5; x+y=-\dfrac{3}{2}$.\\
		Bảng biến thiên
		\begin{center}
