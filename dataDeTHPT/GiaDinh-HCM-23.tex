...
Trong không gian với hệ tọa độ $Oxyz$, điểm $M'$ đối xứng với điểm $M\left(2;2;-1\right)$ qua mặt phẳng $(Oyz)$ có tọa độ là
\choice
{$\left(-2;-2;1\right)$}
...
Phương trình đường thẳng $AB\colon x-y+3=0$; $\mathrm{d}(I;AB)=2\sqrt{2}$.\\
