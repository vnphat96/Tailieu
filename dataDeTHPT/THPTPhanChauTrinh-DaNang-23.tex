...
\begin{ex}%[Đề thi thử môn Toán 12,THPT Phan Châu Trinh, Đà Nẵng]%[Anh Duy, 12EX-6-2223]%[2H3B3-2]%Câu 33
	...
	Suy ra đường thẳng $d$ có véc-tơ chỉ phương $\vec{u}=(1;-2;1)$ và có phương trình tham số là $\heva{&x=-1+t\\&y=2-2t\\&z=3+t.}$\\
	Lấy $N\in d$, suy ra $N(0;0;4)$.\\
	Vậy phương trình tham số của $d$ là $\heva{&x=t \\& y=-2 t \\&z=4+t}$.
}
\end{ex}
