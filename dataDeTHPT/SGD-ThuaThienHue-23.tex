...
\begin{ex}%[Thi thử tốt nghiệp - SGD Thừa Thiên Huế - 23]%[Phạm Phương - EX6 - 23]%[2D1K4-2]
	...
	\loigiai{
		...
		Phương trình đường thẳng đi qua 2 điểm $A$, $B$ là $\dfrac{x}{-\tfrac{24}{a}}+\dfrac{y}{\tfrac{24}{d}}=1 \Leftrightarrow-\dfrac{ax}{24}+\dfrac{dy}{24}=1 \Leftrightarrow-ax+dy-24=0$.\\
