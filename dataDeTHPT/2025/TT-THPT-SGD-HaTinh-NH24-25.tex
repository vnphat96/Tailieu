...
%   \Opensolutionfile{ansbook}[Ansbook/TT-THPT-SGD-HaTinh-NH24-25-TN]%---Nên đặt tên theo bài
 ...
 \begin{ex}%[Dự án C đề thi thử THPT QG 2025]%[Đỗ Chí Tâm]%[2D1B5-3]
 	\immini[thm]{Cho hàm số đa thức bậc bốn $y=f(x)$ có đồ thị như hình vẽ bên. Phương trình $f(x)-1=0$ có bao nhiêu nghiệm thực phân biệt?
 	\choice
 	{\True $3$}
 	{$1$}
 	{$2$}
 ...
 \immini[thm]{Đồ thị hàm số nào sau đây có hình dạng như hình vẽ?
 	\choice
 	{$y=x^3+3 x$}
 	{$y=x^3-3 x$}
 	{\True $y=x^3-3 x^2$}
...
%   \setcounter{ex}{0}
 ...
 %%%==============HetCau_EX1==============%%%
  %%%==============Cau_EX2==============%%%
 \begin{ex}%[Dự án C đề thi thử THPT QG 2025]%[Đỗ Chí Tâm]%[2D1K3-6]
 	\immini[thm]{Một hồ nước nhân tạo được xây dựng trong một công viên giải trí. Trong mô hình minh họa, nó được giới hạn bởi các trục tọa độ và đồ thị hàm số $y=f(x)=-0{,}1 x^3+0{,}9 x^2-1{,}5 x+5{,}6$. Đơn vị đo độ dài trên mỗi trục tọa độ là $100$ m.}
 		{\begin{tikzpicture}[scale=0.5,>=stealth, font=\footnotesize, line join=round, line cap=round]
