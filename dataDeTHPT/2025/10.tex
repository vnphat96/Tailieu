...
\begin{ex}%[2H2H2-3]
	...
	\loigiai
	{
		...
		Vectơ chỉ phương của đường thẳng $AB$ là vectơ $\overrightarrow{AB}=(-2;0;1)$.
	}
\end{ex}
...
\begin{ex}%[2H5V2-8]
	...
	\loigiai{
		...
		\begin{itemchoice}
			...
			\itemch {\bf Đúng}.\\
			Đường thẳng $d$ đi qua điểm $A(-268;185;8)$ và có vectơ chỉ phương là $\overrightarrow{u}=(86;76;0)$ nên phương trình tham số của đường thẳng $d$ là $\heva{&x=-268+82t\\&y=185+76t\\&z=8}$ ($t$ là tham số)
			\itemch {\bf Sai}.\\
...
\begin{ex}%[2H5V2-7]
	...
	\loigiai{
		...
		Vậy $\overrightarrow{AB}=(0;0{,}6;0{,}3)$ nên vectơ $\overrightarrow{u}=(0;2;1)$.\\
