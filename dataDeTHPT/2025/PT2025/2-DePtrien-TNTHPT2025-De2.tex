...
\begin{ex}%[PT đề 2025, đề số 2]%[Hoàng Thanh Phương]%[2D4N3-1]
	\immini[thm]{Cho đồ thị hàm số $y=f(x)$ được xác định như hình vẽ. Diện tích $S$ của hình phẳng (phần gạch chéo) được xác định bởi 
		\choice
...
\begin{ex}%[PT đề 2025, đề số 2]%[Hoàng Thanh Phương]%[2D1H5-1]
	\immini[thm]{Hàm số nào dưới đây có đồ thị như hình vẽ?
		\choice
...
\begin{ex}%[12EX-PT-ĐỀ SỐ 2-2025, Nguyễn Anh Tuấn]%[1H8V5-4]
	...
	\loigiai
	{
		\immini[thm]{Góc giữa $ SC $ và mặt đáy bằng $45^{\circ}\Rightarrow\widehat{SCA}=45^{\circ}$.\\
