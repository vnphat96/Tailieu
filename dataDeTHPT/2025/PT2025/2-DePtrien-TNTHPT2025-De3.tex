...
\immini{Cho hình hộp $ABCD.A'B'C'D'$ như hình vẽ bên. Véc-tơ $\overrightarrow{u}=\overrightarrow{A'A}+\overrightarrow{A'B'}+\overrightarrow{A'D'}$ bằng vectơ nào dưới đây?
\choice[2]
...
\def\dotEX{} 
	...
	\loigiai
	{Đường thẳng $d \colon \dfrac{x-1}{1}=\dfrac{y-2}{-2}=\dfrac{z+2}{3}$ đi qua điểm $A(1;2;-2)$ và có một véc-tơ chỉ phương là $\overrightarrow{u}=(1;-2;3)$.\\
...
\begin{ex}%[THPT 2025, Phát triển đề số 3]%[Nguyễn Cường]%[2D4V2-6]
	...
	\begin{itemize}
		\item Véc-tơ đơn vị chỉ phương $\overrightarrow{u}=(0;b;c)\ne \overrightarrow{0}$.
		\item Hướng di chuyển vuông góc với véc-tơ $\overrightarrow{n}=(0;1;-2)$.
	...
	\loigiai{
		\begin{itemchoice}
			...
			\itemch Do $\overrightarrow{u}$ là véc-tơ đơn vị nên $b^2+c^2=1\Rightarrow 5c^2=1\Leftrightarrow c=\dfrac{\sqrt{5}}{5}>0$ vì tàu lặn xuống.\\
			Suy ra véc-tơ $\overrightarrow{u}=\left(0;\dfrac{2\sqrt{5}}{5};\dfrac{\sqrt{5}}{5}\right)$.\\
