...
\immini[thm]{Cho hình hộp $ABCD.A'B'C'D'$ như hình vẽ bên. Vectơ $\overrightarrow{u}=\overrightarrow{A'A}+\overrightarrow{A'B'}+\overrightarrow{A'D'}$ bằng vectơ nào dưới đây?
\choice[2]
...
\begin{ex}%[Phát triển đề THPT 2025 - Nhóm 3]%[Tran Quoc]%[1H4H3-2]
	\immini[thm]{Cho hình chóp $S.ABC$ có $M$, $N$ lần lượt là trung điểm của các cạnh $AB$ và $AC$ như hình vẽ bên. Mệnh đề nào dưới đây đúng?
	\choice[2]
