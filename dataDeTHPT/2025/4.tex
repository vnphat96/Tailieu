...
\begin{ex}%[Nguyễn Tuấn, dự án sáng tác đề 12 theo chủ đề]%[2H5V2-7] 
    Trong không gian với hệ tọa độ $O x y z$, một cabin cáp treo xuất phát từ điểm $A(10 ; 3 ; 0)$ và chuyển động đều theo đường cáp có vectơ chỉ phương là $\vec{u}=(2 ;-2 ; 1)$ với tốc độ là 4,5 m/s (đơn vị trên mỗi trục tọa độ là mét) (Hình bên dưới).
    ...
    \loigiai{
        \begin{itemchoice}
            ...
            Do hai vectơ $\vec{A M}$ và $\vec{u}$ là cùng phương và cùng hướng nên $\vec{A M}=k \vec{u}$ với $k$ là số thực dương nào đó. \\
            ...
            \itemch Đường thẳng $AB$ có vectơ chỉ phương $\vec{u}=(2 ;-2 ; 1)$ và mặt phẳng $(Oxy)$ có vectơ pháp tuyến $\vec{k}=(0 ; 0 ; 1)$. Do đó, ta có
            $$
