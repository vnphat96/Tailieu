...
\begin{ex}%[Dự án 12EX6-2023]%[Đề thi thử SGD Hà Nội 2023, Nguyễn Anh Quốc]%[2H3Y2-2]
	Trong KG $Oxyz$, một vectơ pháp tuyến của mặt phẳng $(\alpha)\colon x+2y-4z+2=0$ có tọa độ là	
	\choice
	{$(1;-2;4)$}
	{$(1;2;4)$}
	{$(-1;2;4)$}
...
\begin{ex}%[Dự án 12EX6-2023]%[Đề thi thử SGD Hà Nội 2023, Nguyễn Anh Quốc]%[2H3Y1-1]
	Trong KG $Oxyz$, cho $\overrightarrow{a}=-2\cdot \overrightarrow{i}+2\cdot \overrightarrow{j}-3\cdot\overrightarrow{k}$. Tọa độ của vectơ $\overrightarrow{a}$ là	
	\choice
	{$(2;-2;-3)$}
	{\True $(-2;2;-3)$}
	{$(2;-2;3)$}
