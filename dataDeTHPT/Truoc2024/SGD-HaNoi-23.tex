...
\begin{ex}%[Dự án 12EX6-2023]%[Đề thi thử SGD Hà Nội 2023, Nguyễn Anh Quốc]%[2H1Y1-1]
	\immini[thm]{Số cạnh của một hình đa diện như hình vẽ dưới đây là	
		\choice
		{\True $12$}
		{$10$}
		{$16$}
...
\begin{ex}%[Dự án 12EX6-2023]%[Đề thi thử SGD Hà Nội 2023, Nguyễn Anh Quốc]%[2H3Y2-2]
	Trong không gian $Oxyz$, một vectơ pháp tuyến của mặt phẳng $(\alpha)\colon x+2y-4z+2=0$ có tọa độ là	
	\choice
	{$(1;-2;4)$}
	{$(1;2;4)$}
	{$(-1;2;4)$}
	{\True $(1;2;-4)$}
	\loigiai{
		Vectơ pháp tuyến của mặt phẳng $(\alpha)$ là $\overrightarrow{n}=(1;2;-4)$.	
	}
\end{ex}

\begin{ex}%[Dự án 12EX6-2023]%[Đề thi thử SGD Hà Nội 2023, Nguyễn Anh Quốc]%[2D1Y3-1]
	\immini[thm]{Cho hàm số $y=f(x)$ liên tục trên đoạn $[-1;3]$ và có đồ thj như hình vẽ. Giá trị lớn nhất của hàm số đã cho trên đoạn $[-1;3]$ bằng	
		\choice
		{$3$}
		{$-1$}
		{\True $4$}
...
\begin{ex}%[Dự án 12EX6-2023]%[Đề thi thử SGD Hà Nội 2023, Nguyễn Anh Quốc]%[2H3Y1-1]
	Trong không gian $Oxyz$, cho $\overrightarrow{a}=-2\cdot \overrightarrow{i}+2\cdot \overrightarrow{j}-3\cdot\overrightarrow{k}$. Tọa độ của vectơ $\overrightarrow{a}$ là	
	\choice
	{$(2;-2;-3)$}
	{\True $(-2;2;-3)$}
	{$(2;-2;3)$}
...
\begin{ex}%[Dự án 12EX6-2023]%[Đề thi thử SGD Hà Nội 2023, Nguyễn Anh Quốc]%[2D1B5-4]
	\immini[thm]{Cho hàm số bậc bốn $y=f(x)$ có đồ thị như hình vẽ bên. Số nghiệm của phương trình $2f(x)+1=0$ là	
		\choice
		{\True $4$}
		{$3$}
		{$1$}
...
\begin{ex}%[Dự án 12EX6-2023]%[Đề thi thử SGD Hà Nội 2023, Nguyễn Anh Quốc]%[2H3B1-3]
	Trong không gian $Oxyz$, mặt cầu $(S)\colon x^2+y^2+z^2-8x+4y+2z-4=0$ có bán kính bằng	
	\choice
	{$\sqrt{5}$}
	{$25$}
	{$2$}
...
\begin{ex}%[Dự án 12EX6-2023]%[Đề thi thử SGD Hà Nội 2023, Nguyễn Anh Quốc]%[2D1B2-2]
	\immini[thm]{Cho hàm số bậc bốn $f(x)$. Hàm số $y=f'(x)$ có đồ thị như hình vẽ bên. Số điểm cực đại của hàm số $f(x)$ là
		\choice
		{\True $2$}
		{$3$}
		{$1$}
...
\begin{ex}%[Dự án 12EX6-2023]%[Đề thi thử SGD Hà Nội 2023, Nguyễn Anh Quốc]%[2H3B2-3]
	Trong không gian $Oxyz$, cho $A(1;1;-1)$, $B(5;2;1)$. Phương trình mặt phẳng trung trực của đoạn $AB$ là	
	\choice
	{$8x+2y+4z+27=0$}
	{\True $8x+2y+4z-27=0$}
	{$6x+2y-21=0$}
	...
	\loigiai{
		...
		Mặt phẳng trung trực của đoạn $AB$ đi qua $M$ và nhận $\overrightarrow{AB}=(4;1;2)$ là vectơ pháp tuyến.\\
...
\begin{ex}%[Dự án 12EX6-2023]%[Đề thi thử SGD Hà Nội 2023, Nguyễn Anh Quốc]%[2H3K1-1]
	Trong không gian $Oxyz$, cho tam giác $OAB$ có $A(2;2;-1)$ và $B(0;-4;3)$. Độ dài đường phân giác trong $\widehat{AOB}$ bằng	
	\choice
	{$\dfrac{\sqrt{30}}{5}$}
...
\begin{ex}%[Dự án 12EX6-2023]%[Đề thi thử SGD Hà Nội 2023, Nguyễn Anh Quốc]%[2D1K2-6]
	\immini[thm]{Cho hàm số bậc bốn $y=f(x)$ có đồ thị như hình vẽ bên. Số giá trị nguyên dương của tham số $m$ để hàm số $g(x)=\left(f(x)+m\right)^2$ có $5$ điểm cực trị là	
		\choice
		{$3$}
		{$5$}
		{\True $4$}
...
\begin{ex}%[Dự án 12EX6-2023]%[Đề thi thử SGD Hà Nội 2023, Nguyễn Anh Quốc]%[2D1K5-5]
	\immini[thm]{Cho hàm số bậc năm $f(x)$. Hàm số $y=f'(x)$ có đồ thị như hình vẽ bên. Số điểm cực trị của hàm số $g(x)=f(x)+\dfrac{2}{3}x^3-2x^2+3x$ là	
		\choice
		{\True $0$}
		{$1$}
		{$3$}
	...
	{\begin{tikzpicture}[scale=0.7,>=stealth, font=\footnotesize, line join=round, line cap=round]
		...
		\end{tikzpicture}}
	\loigiai{
		\immini[thm]{Ta có $g'(x)=f'(x)+2x^2-4x+3$, $g'(x)=0\Leftrightarrow f'(x)=-2x^2+4x-3$. Đây là phương trình hoành độ giao điểm của đồ thị hàm số $y=f'(x)$ và $y=-2x^2+4x-3$.\\
...
\begin{ex}%[Dự án 12EX6-2023]%[Đề thi thử SGD Hà Nội 2023, Nguyễn Anh Quốc]%[2H2B2-6]
	\immini[thm]{Một xe bồn chở nước có bồn nước gồm hai nửa hình cầu đường kính $18$ dm	 và một hình trụ có chiều cao $36$ dm (như hình vẽ). Thể tích của khối bồn đã cho bằng
		\choice
		{$9216\pi$ dm$^3$}
...
\begin{ex}%[Dự án 12EX6-2023]%[Đề thi thử SGD Hà Nội 2023, Nguyễn Anh Quốc]%[2D3K3-1]
	\immini[thm]{Cho	hai hàm số bậc bốn $f(x)$, $g(x)$ có đồ thị $y=f'(x)$ và $y=g'(x)$ như hình vẽ. Số giá trị thực của tham số $m$ để phương trình $f(x)-g(x)=m$ có một nghiệm duy nhất trên $[-1;3]$ là
		\choice
		{Vô số}
		{$0$}
		{$2$}
...
\begin{ex}%[Dự án 12EX6-2023]%[Đề thi thử SGD Hà Nội 2023, Nguyễn Anh Quốc]%[2H3G2-8]
	Trong không gian $Oxyz$, cho điểm $A(-2;6;0)$ và mặt phẳng $(\alpha)\colon 3x+4y+89=0$. Đường thẳng $d$ thay đổi nằm trên mặt phẳng $(Oxy)$ và luôn đi qua điểm $A$. Gọi $H$ là hình chiếu vuông góc của $M(4;-2;3)$ trên đường thẳng $d$. Khoảng cách nhỏ nhất từ $H$ đến mặt phẳng $(\alpha)$ bằng	
	\choice
	{\True $15$}
	{$90$}
	{$\dfrac{68}{5}$}
