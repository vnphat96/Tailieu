...
\begin{ex}%[2-TT-7-SGD-Hòa Bình- 2023- Lần 1]%[Nguyễn Cường-EX-6]%[2H3Y2-2]
	Trong không gian $Oxyz$, cho mặt phẳng $(\alpha)\colon 2x+y-z+1=0$. Vectơ nào sau đây \textbf{không} là vectơ pháp tuyến của mặt phẳng $(\alpha)$?
	\choice
	...
	{$\overrightarrow{n}=(2;1;-1)$}
	\loigiai{
		$\overrightarrow{n}=(2;1;1)$ không là vectơ pháp tuyến của mặt phẳng $(\alpha)$.
	}
\end{ex}
%%==========Câu 5
...
\begin{ex}%[2-TT-7-SGD-Hòa Bình- 2023- Lần 1]%[Nguyễn Cường-EX-6]%[2H3Y3-1]
	...
	\loigiai{
		$\overrightarrow{u}=(-1;2;1)$ là một vectơ chỉ phương của $d$.
	}
\end{ex}
%%==========Câu 12
...
Trong không gian $Oxyz$, cho mặt phẳng $(\alpha)\colon 2x-2y-z+1=0$ và hai đường thẳng $d_1\colon \heva{&x=-2+t\\&y=2+t\\&z=-t}$; $d_2\colon\heva{&x=2t'\\&y=3+t'\\&z=1}$. Gọi $\Delta$ là đường thẳng nằm trong mặt phẳng $(\alpha)$ và cắt cả hai đường thẳng $d_1$, $d_2$. Đường thẳng $\Delta$ có phương trình là
	\choice
	...
	Suy ra $B(6;6;1)$.\\
	$\Delta$ nhận $\overrightarrow{AB}=(1;-3;8)$ làm vectơ chỉ phương.\\
...
\begin{ex}%[2-TT-7-SGD-Hòa Bình- 2023- Lần 1]%[Nguyễn Cường-EX-6]%[2D1G2-6]
	\immini[thm]{Cho hàm số $y=f(x)$ có đạo hàm liên tục trên $\mathbb{R}$, đồ thị của hàm số $y=f'(x)$ có đúng bốn điểm chung với trục hoành như hình vẽ bên. Có bao nhiêu giá trị nguyên của tham số $m$ để hàm số $y=f\left(|x|^3-3|x|+m+2023\right)+2023m$ có $11$ điểm cực trị.
		\choice
		{$0$}
		{$2$}
		{$5$}
