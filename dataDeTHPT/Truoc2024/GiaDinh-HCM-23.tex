...
Trong KG $Oxyz$, phương trình mặt phẳng $(P)$ đi qua điểm $M\left(1;0;1\right)$ và có một  vectơ pháp tuyến $\overrightarrow{n}=\left(2;1;-2\right)$ là
\choice
{$-2x+y-2x+4=0$}
{$-2x-y+2z-2=0$}
{$x-z=0$}
...
Trong KG $Oxyz$, vectơ $\overrightarrow{a}=(1;2;-2)$ vuông góc với vectơ nào sau đây?
\choice
