...
Trong không gian $Oxyz$, điểm $M'$ đối xứng với điểm $M\left(2;2;-1\right)$ qua mặt phẳng $(Oyz)$ có tọa độ là
\choice
{$\left(-2;-2;1\right)$}
...
Trong không gian $Oxyz$, phương trình mặt phẳng $(P)$ đi qua điểm $M\left(1;0;1\right)$ và có một  vectơ pháp tuyến $\overrightarrow{n}=\left(2;1;-2\right)$ là
\choice
{$-2x+y-2x+4=0$}
{$-2x-y+2z-2=0$}
{$x-z=0$}
{\True $2x+y-2z=0$}
\loigiai{
Phương trình mặt phẳng $(P)$ đi qua điểm $M\left(1;0;1\right)$ và có một  vectơ pháp tuyến $\overrightarrow{n} = \left(2;1;-2\right)$ là
...
Trong không gian $Oxyz$, vectơ $\overrightarrow{a}=(1;2;-2)$ vuông góc với vectơ nào sau đây?
\choice
...
Trong không gian $Oxyz$, đường thẳng $d$ đi qua điểm $M(1;2;-1)$, đồng thời vuông góc với mặt phẳng $(P)\colon x+y-z+1=0$ có phương trình là
\choice
...
\loigiai{
Do $d\perp (P)$ nên $\overrightarrow{u}_d=\overrightarrow{n}_P=(1;1;-1)$ là một vectơ chỉ phương của đường thẳng $d$.\\
Đường thẳng $d$ đi qua điểm $M(1;2;-1)$ và có một vectơ chỉ phương $\overrightarrow{u}_d=(1;1;-1)$ có phương trình là $$\dfrac{x-1}{1}=\dfrac{y-2}{1}=\dfrac{z+1}{-1}.$$
}
\end{ex}
...
Trong không gian $Oxyz$, cho đường thẳng $\triangle \colon \dfrac{x-2}{1}=\dfrac{y+2}{2}=\dfrac{z}{-2}$ và mặt phẳng $(P)\colon 2x-y+2z-2022=0$. Gọi $\alpha $ là góc giữa đường thẳng $\Delta $ và mặt phẳng $(P)$. Khẳng định nào sau đây đúng?
\choice
{$\sin \alpha =-\dfrac{4}{9}$}
...
{$\cos \alpha =\dfrac{4}{9}$}
\loigiai{
Đường thẳng $\Delta$ có một vectơ chỉ phương $\overrightarrow{u}=(1;2;-2)$; mặt phẳng $(P)$ có một  vectơ pháp tuyến $\overrightarrow{n}=(2;-1;2)$.\\
...
\loigiai{
Vectơ  chỉ phương  của $\Delta$, $\Delta'$ lần lượt là $\overrightarrow{u}=(3;2;1)$ và $\overrightarrow{v}=(1;3;-2)$, do đó $\left[\overrightarrow{u},\overrightarrow{v}\right]=(-7;7;7)$.\\
Theo giả thiết $d$ vuông góc với $\Delta$ và $\Delta'$ nên $d$ có một vectơ chỉ phương $\overrightarrow{u}_d=(-1;1;1)$. \\
...
Trong không gian $Oxyz$, cho mặt phẳng $(P)\colon x-y+z+7=0$, đường thẳng $d\colon \dfrac{x}{1}=\dfrac{y}{-2}=\dfrac{z}{2}$ và mặt cầu $(S)\colon (x-1)^2+y^2+(z-2)^2=5$. Gọi $A$, $B$ là hai điểm trên mặt cầu $(S)$ và $AB=4$;  $A'$, $B'$ là hai điểm nằm trên mặt phẳng $(P)$ sao cho $AA',BB'$ cùng song song với đường thẳng $d$. Giá trị lớn nhất của tổng $AA'+BB'$ gần nhất với giá trị nào sau đây?
\choice
{$13$}
{$11$}
{$12$}
