...
\begin{ex}%[Đề thi thử TN Hà Tĩnh 2023]%[An Le - Ex6]%[2H3Y3-1]
	Trong KG $Oxyz$, vectơ $\overrightarrow{a}=2\overrightarrow{i}-3\overrightarrow{j}-\overrightarrow{k}$, với $\overrightarrow{i};\overrightarrow{j};\overrightarrow{k}$ là các vectơ đơn vị. Khi đó tọa độ của $\overrightarrow{a}$ là
	\choice
...
\begin{ex}%[Đề thi thử TN Hà Tĩnh 2023]%[An Le - Ex6]%[2H3Y3-1]
	Trong KG $Oxyz$, cho đường thẳng $d \colon \dfrac{x+1}{2}=\dfrac{y-2}{1}=\dfrac{z-1}{-2}$. Một vectơ chỉ phương của $d$ là
	\choice
