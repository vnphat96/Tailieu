...
Trong KG $Oxyz$, cho mặt phẳng $(P) \colon 3x - y + 2z - 1 = 0$. Vectơ nào dưới đây là một vectơ pháp tuyến của $(P)$ ?
\choice
{$\vec{n}_1 = (-3; 1; 2)$}
...
\loigiai{
Vectơ $\overrightarrow{n}_2 = (3; -1; 2)$ là một vectơ pháp tuyến của $(P)$.
}
\end{ex}
...
Trong KG $Oxyz$, cho đường thẳng $d$ đi qua điểm $M(3; -1; 4)$ và có một vectơ chỉ phương $\vec{u} = (-2; 4; 5)$. Phương trình của $d$ là
\choice
...
Trong không gian $O x y z$, cho hai điểm $A(1 ; 0 ; 0)$ và $B(4 ; 1 ; 2)$. Toạ độ vectơ $\overrightarrow{O A}-\overrightarrow{O B}$ là
\choice
{$(5 ; 1 ; 2)$}
{\True $(-3 ;-1 ;-2)$}
{$(3 ; 1 ; 2)$}
...
Do đó vectơ pháp tuyến $\vec{n}_P=\vv{BC}=(3;6;3)=3 (1;2;1)\Rightarrow (P)\colon x+2y+z-7=0$ qua điểm $N(1;2;2)$.
}
\end{ex}
...
{$4\sqrt{2}$}
\loigiai{
\immini[thm]{ Gọi $M$, $N$, $A$ lần lượt là điểm biểu diễn của các số phức $z_1$, $z_2$, $3 i$.\\
...
\immini[thm]{
Đường thẳng $IH$ đi qua điểm $I(-1;-1;2)$ và nhận $\overrightarrow{n}_{(P)}=(2;2;-1)$ làm vectơ chỉ phương có phương trình $IH\colon \heva{& x=-1+2t \\ & y=-1+2t\\&z=2-t.}$\\
