...
Trong không gian $Oxyz$, cho mặt phẳng $(P) \colon 3x - y + 2z - 1 = 0$. Vectơ nào dưới đây là một vectơ pháp tuyến của $(P)$ ?
\choice
{$\vec{n}_1 = (-3; 1; 2)$}
...
Trong không gian $Oxyz$ cho mặt cầu $(S)\colon (x+1)^2+(y+1)^2+(z-2)^2=9$ và đường
