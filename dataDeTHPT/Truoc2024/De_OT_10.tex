...
%%==========Câu 4
\begin{ex}%[2D1Y2-2]
\immini[thm]{Cho hàm số $f(x)$ có đồ thị như hình vẽ bên.
...
%%==========Câu 9
\begin{ex}%[2H3Y2-2]
Trong KG $Oxyz$, mặt phẳng nào dưới đây có một vectơ pháp tuyến là $\vec{n}=(1 ; 2 ;-3)$ ?
\choice
{\True $x+2y-3z-1=0$}
{$x+2y+3z+1=0$}
{$x-2y+3z-3=0$}
{$2x-3y+z+1=0$}
\loigiai{
Mặt phẳng $x+2y-3z-1=0$ có một vectơ pháp tuyến là $\vec{n}=(1 ; 2 ;-3)$.
}
\end{ex}
%%==========Câu 10
\begin{ex}%[2D2Y5-1]
...
%%==========Câu 25
\begin{ex}%[2H3Y1-3]
	Trong KG $Oxyz$, phương trình mặt cầu có tâm $I(2;1;2)$ bán kính bằng $3$ là
	\choice
...
%%==========Câu 28
\begin{ex}% [2D2B4-3] 
\immini[thm]{Trên khoảng $(0; +\infty)$, hàm số $y=x^{\alpha}$ có đồ thị như hình bên, khi đó $\alpha$ bằng
	\choice
	{\True $\log_3 2$}
	{$\log_2 3$}
	{$\dfrac{2}{3}$}
...
%%==========Câu 29
\begin{ex}%[2H3K2-3] 
	Trong KG $Oxyz$, mặt phẳng đi qua $M(1;1;-1)$ và vuông góc với đường $\Delta: \dfrac{x+1}{2}= \dfrac{y-2}{2} = \dfrac{z-1}{1}$ có phương trình là
	\choice
	{$2x+2y+z+3=0$}
	{$x-2y-z=0$}
	{\True $2x+2y+z-3=0$}
	...
	Khi đó vectơ pháp tuyến của mặt phẳng $(\alpha)$ là $(2;2;1)$.\\
...
%%==========Câu 32
\begin{ex}%	[1H3B2-3]
	\immini[thm]{Cho hình hộp $ABCD.A'B'C'D'$ có đáy là hình vuông. Góc giữa hai đường thẳng $BD$ và $A'C'$ bằng
	\choice
	{$30^\circ$}
	{$60^\circ$}
	{$45^\circ$}
	...
	\end{tikzpicture}}
	\loigiai{
	\immini[thm]{Ta có $BD\perp AC$, mà $AC\parallel A'C'$ nên $BD\perp A'C'$.\\
...
\begin{ex}%	[2H3B3-2]
	...
	Đường thẳng đi qua $O$ có vectơ chỉ phương $\vec{u}=(2;1;-1)$ có phương trình là $\dfrac{x}{2}=\dfrac{y}{1}=\dfrac{z}{-1}$.
	}
\end{ex}
%%==========Câu 36
\begin{ex}%[2H2K1-2]
...
%%==========Câu 42
\begin{ex}%[]%[2D1K5-3]
	Cho hàm số $f(x)$ có bảng biến thiên của đạo hàm $f'(x)$ như hình vẽ:
	\begin{center}
	...
	$$
	Hàm số $g(a)=f(a)+2 a$ có $g'(a)=f'(a)+2 \geq 0, \forall a \in \mathbb{R}$ (quan sát bảng biến thiên của $f'(x)$ ) nên $g(a)$ đồng biến trên $\mathbb{R}$ do đó $(*) \Leftrightarrow g(t)=g(x) \Leftrightarrow t=x$\\
	Vậy đưa về phương trình $f(x)=2 x+2 \Leftrightarrow h(x)=f(x)-2 x-2=0$.\\
	Ta có $h'(x)=f'(x)-2=0 \Leftrightarrow f'(x)=2 \Leftrightarrow x=-3 ; x=1 ; x=2$.\\
	Bảng biến thiên:
	\begin{center}
...
%%==========Câu 43
\begin{ex}%[2H3K3-3]
	Trong KG $Oxyz$, cho hai đường thẳng $d_1\colon \dfrac{x-1}{1}=\dfrac{y+1}{-1}=\dfrac{z}{2}$; $d_2\colon \dfrac{x}{1}=\dfrac{y-1}{2}=\dfrac{z}{1}$. Đường thẳng $d$ đi qua $A\left(1;0;1\right)$ lần lượt cắt $d_2$, $d_2$ tại $B$ và $C$. Độ dài $BC$ bằng
	\choice
...
%%==========Câu 44
\begin{ex}%[2D3K2-3]
	Cho hàm số $f(x)$ có đạo hàm $f'(x)=xe^{x-a}$, $\forall x\in\mathbb{R}$ và $f(0)=-e^{-a}-1$ (với $a$ là tham số thực). Khi $\displaystyle\int\limits_0^a f(x) \mathrm{\,d}x=4$, khẳng định nào dưới đây đúng?
	\choice
	...
	{$a\in\left(1;2\right)$}
	\loigiai{
	Ta có $\displaystyle\int f'(x) \mathrm{\,d}x=\displaystyle\int xe^{x-a} \mathrm{\,d}x$.
	...
	$=\left(xe^{x-a}-2e^{x-a}-x \right)\bigg|_0^a= -2+2e^{-a}=4\Leftrightarrow e^{-a}=3\Leftrightarrow a=-\ln 3\approx -1{,}09\in \left(-2;-1\right)$.
	}
\end{ex}
%%==========Câu 45
\begin{ex}%[2H3G2-7]
	Trong KG $Oxyz$, cho mặt cầu $(S)\colon (x-2)^2+(y-3)^2+(z-1)^2=\dfrac{1}{2}$. Có bao nhiêu cặp số nguyên $(a ; b)$ sao cho tồn tại hai điểm $A(a ; 0 ; 0)$ và $B(0 ; b ; 0)$ để có hai mặt phẳng vuông góc với nhau cùng đi qua $A$, $B$ và tiếp xúc với $(S)$?
	\choice
	{$5$}
	{$7$}
	{\True $8$}
...
\begin{ex}%[2D2G5-5]
	...
	Ta có $g'(a)=\dfrac{12 a\left(2 a^2+1\right)^2\left(a^3+2\right)^2-6 a^2\left(a^3+2\right)\left(2 a^2+1\right)^3}{\left(a^3+2\right)^4}=\dfrac{6 a\left(2 a^2+1\right)^2(4-a)}{\left(a^3+2\right)^3}$.\\
	Bảng biến thiên
	\begin{center}
