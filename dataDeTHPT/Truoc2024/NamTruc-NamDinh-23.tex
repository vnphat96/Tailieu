...
\begin{ex}%[Thi thử tốt nghiệp THPT- Cụm các trường THPT Nam Trực - Nam Định - 23]%[Phạm Tuấn B - EX6]%[2H3Y2-2]
	Trong không gian $Oxyz$, vectơ nào sau đây là một vectơ pháp tuyến của mặt phẳng $(P)\colon 4x-3y+1=0$?
	\choice
	{\True $\left(4;-3;0\right)$}
	{$\left(4;-3;1\right)$}
	{$\left(4;-3;-1\right)$}
	{$\left(-3;4;0\right)$}
	\loigiai{ Do mặt phẳng $(P)$ có phương trình $4x-3y+1=0$ nên có một vectơ pháp tuyến là $\overrightarrow{n}=\left(4;-3;0\right)$.
		}
\end{ex}
...
\immini[thm]{Cho hàm số $f(x)=ax^4+bx^2+c\,\big(a,b,c\in\mathbb{R}\big)$ và có bảng biến thiên như hình vẽ bên. Số nghiệm thực dương của phương trình $2f(x)-3=0$ là
\choice
{$1$}
{$4$}
{\True $2$}
...
Trong không gian với hệ trục toạ độ $Oxyz$, cho $\overrightarrow{a}=-\overrightarrow{i}+2\overrightarrow{j}-3\overrightarrow{k}$. Toạ độ của vectơ $\overrightarrow{a}$ là
\choice
{$\left(2;-3;-1\right)$}
{\True $\left(-1;2;-3\right)$}
{$\left(2;-1;-3\right)$}
{$\left(-3;2;-1\right)$}
\loigiai{Do $\overrightarrow{a}=-\overrightarrow{i}+2\overrightarrow{j}-3\overrightarrow{k}$ nên toạ độ của vectơ $\overrightarrow{a}$ là $\left(-1;2;-3\right)$.
	
}
\end{ex}
\begin{ex}%[Thi thử tốt nghiệp THPT- Cụm các trường THPT Nam Trực - Nam Định - 23]%[Phạm Tuấn B - EX6]%[2D1Y5-1]
\immini[thm]{Đường cong trong hình bên là đồ thị của một hàm số trong bốn hàm số được liệt kê ở bốn phương án $A$, $B$, $C$, $D$ dưới đây. Hỏi hàm số đó là hàm số nào? 
\choice
{$y=-x^3+3x+1$}
{$y=x^4-x^2+1$}
{\True $y=x^3-3x+1$}
...
{$\sqrt{2}$}
\loigiai{
	\immini[thm]{Trong $\triangle ABC$ hạ $CH\perp AB$. Do $SA\perp(ABC)$ nên $SA\perp CH$ suy ra $CH\perp(SAB)$.\\
...
\immini[thm]{Cho hàm số $y=f(x)$ có đồ thị hàm số đạo hàm $y=f'(x)$ như hình vẽ bên. Hàm số $y=f(x)$ đồng biến trên khoảng nào dưới đây?
\choice
{$\left(-1;3\right)$}
{$\left(0;2\right)$}
{$\left(1;+\infty\right)$}
...
\begin{ex}%[Thi thử tốt nghiệp THPT- Cụm các trường THPT Nam Trực - Nam Định - 23]%[Phạm Tuấn B - EX6]%[2H3Y3-3]
	...
	{$\left(1;1;0\right)$}
	{$\left(-1;-1;0\right)$}
	\loigiai{Đường thẳng $Oz$ đi qua điểm $M\left(0;0;-1\right)$ và nhận vectơ $\overrightarrow{k}=\left(0;0;1\right)$ làm một vectơ chỉ phương nên có phương trình là $\heva{&x=0\\&y=0\\&z=-1+t}\,\left(t\in\mathbb{R}\right)$.\\
...
\begin{ex}%[Thi thử tốt nghiệp THPT- Cụm các trường THPT Nam Trực - Nam Định - 23]%[Phạm Tuấn B - EX6]%[2H1Y3-2]
	...
	{$6a^3$}
	\loigiai{
		\immini[thm]{Ta có $V_{ABC.A'B'C'}=AA'\cdot S_{ABC}=6a\cdot \dfrac{1}{2}a^2=3a^3$.
		}
...
\begin{ex}%[Thi thử tốt nghiệp THPT- Cụm các trường THPT Nam Trực - Nam Định - 23]%[Phạm Tuấn B - EX6]%[2H2B1-2]
	...
	{$\dfrac{\pi a^3}{12}$}
	\loigiai{\immini[thm]{Do tam giác $ABC$ vuông cân tại $A$ nên $AH\perp BC$ và $AH=HB=HC=\dfrac{a\sqrt{2}}{2}$.\\
...
\loigiai{\immini[thm]{Gọi $G$ là tâm đường tròn ngoại tiếp tam giác đều $ABC$ cạnh $a$.\\
...
\immini[thm]{Từ đồ thị hàm số $y=x^4-2x^2-3$ ta có đồ thị của hàm số $y=\left|x^4-2x^2-3\right|$ như hình vẽ bên.\\
...
\begin{ex}%[Thi thử tốt nghiệp THPT- Cụm các trường THPT Nam Trực - Nam Định - 23]%[Phạm Tuấn B - EX6]%[2H2B2-6]
	...
	\loigiai{\immini[thm]{Do $ABCD.A'B'C'D'$ là hình lập phương có cạnh bằng $a$ nên bán kính đường tròn ngoại tiếp hình vuông $ABCD$ là $R_1=\dfrac{a\sqrt{2}}{2}$; bán kính khối cầu nội tiếp hình lập phương là $R_2=\dfrac{a}{2}$ và bán kính khối cầu ngoại tiếp hình lập phương là $R_3=\dfrac{a\sqrt{3}}{2}$.\\
			\begin{itemize}
...
\begin{ex}%[Thi thử tốt nghiệp THPT- Cụm các trường THPT Nam Trực - Nam Định - 23]%[Phạm Tuấn B - EX6]%[2H1K3-3]
	...
	{$\dfrac{1}{20}$}
	{$\dfrac{1}{12}$}
	\loigiai{\immini[thm]{Do $\dfrac{SN}{ND}=2\Rightarrow ND=\dfrac{1}{3}SD\Rightarrow S_{MND}=\dfrac{1}{3}S_{MSD}$.\\
...
\begin{ex}%[Thi thử tốt nghiệp THPT- Cụm các trường THPT Nam Trực - Nam Định - 23]%[Phạm Tuấn B - EX6]%[1H3K5-4]
	...
	\loigiai{\immini[thm]{Gọi điểm $M$ thuộc đường thẳng $BC$ sao cho $B$ là trung điểm của $MC$.\\
...
\begin{ex}%[Thi thử tốt nghiệp THPT- Cụm các trường THPT Nam Trực - Nam Định - 23]%[Phạm Tuấn B - EX6]%[2D1K2-2]
	\immini[thm]{Cho hàm số bậc bốn $y=f(x)$ có đồ thị hàm số $y=f'(x)$ như hình vẽ bên. Hàm số $g(x)=4f(x^2-4)+x^4-8x^2$ có bao nhiêu điểm cực tiểu?
	\choice
	{$3$}
	{$5$}
	{\True $4$}
...
{\begin{tikzpicture}[scale=0.6, font=\footnotesize, line join=round, line cap=round, >=stealth]
	...
	\loigiai{\immini[thm]{Ta có $g'(x)=8xf'(x^2-4)+4x^3-16x$.\\
...
\begin{ex}%[Thi thử tốt nghiệp THPT- Cụm các trường THPT Nam Trực - Nam Định - 23]%[Phạm Tuấn B - EX6]%[2H1G3-6]
	...
	\loigiai{\immini[thm]{Gọi $D$ là hình chiếu của $S$ trên $(ABCD)$.\\
...
\begin{ex}%[Thi thử tốt nghiệp THPT- Cụm các trường THPT Nam Trực - Nam Định - 23]%[Phạm Tuấn B - EX6]%[2D2G6-5]
	...
	\loigiai{Xét hàm số $f(t)=2\log_2t-t$ với $t>0$.\\
		Ta có $f'(t)=\dfrac{2}{t\cdot \ln 2}-1\Rightarrow f'(t)=0\Leftrightarrow t=\dfrac{2}{\ln 2}$.\\
