...
Trong không gian $Oxyz$, cho mặt phẳng $(P)\colon 2x-z+3=0$. Vectơ nào dưới đây là một vectơ pháp tuyến của mặt phẳng $(P)$?
\choice 
...
\loigiai
{
$\overrightarrow{n}=(2;0;-1)$ là một vectơ pháp tuyến của mặt phẳng $(P)$.
}
\end{ex}
...
Trong không gian $Oxyz$, cho đường thẳng $d\colon \dfrac{x-1}{2}=\dfrac{y+3}{-1}=\dfrac{z}{3}$. PTTS của đường thẳng $d$ là
\choice 
...
\loigiai
{
$d$ đi qua $A(1;-3;0)$ có một vectơ chỉ phương $\overrightarrow{u}=(2;-1;3)\Rightarrow d\colon\heva{& x=1+2t\\&y=-3-t\\&z=3t }$.
}
\end{ex}
...
Trong không gian $Oxyz$, PTĐT đi qua $A(1;-2;0)$ và vuông góc với mặt phẳng $(P)\colon x-2y+2z+1=0$ là
\choice 
...
\loigiai
{
$(P)$ có một vectơ pháp tuyến $\overrightarrow{n}=(1;-2;2)$.\\
Gọi $d$ là đường thẳng cần tìm.\\
Vì $d\perp (P)$ nên $\overrightarrow{n}$ là vectơ chỉ phương của $d$.\\
...
$\left (d_1 \right )$ có một vectơ chỉ phương là $\overrightarrow{u_1}=(3;2;-2)$, $\left (d_2 \right )$ có một vectơ chỉ phương là $\overrightarrow{u_2}=(2;2;-1)$.\\
Theo đề bài ta có
...
$d$ qua $A(2;2;-2)$ có vectơ chỉ phương $\overrightarrow{AB}=(2;-1;2)\Rightarrow d\colon\dfrac{x-2}{2}=\dfrac{y-2}{-1}=\dfrac{z+2}{2}$.
}
\end{ex}
...
\end{eqnarray*}
Dấu ``$=$'' xảy ra khi hai vectơ $\overrightarrow{AI}$ và $\overrightarrow{NM}$ cùng hướng.\\
...
Trong không gian $Oxyz$, cho đường thẳng $d\colon \dfrac{x+1}{1}=\dfrac{y+2}{1}=\dfrac{z-1}{1}$ và mặt cầu $(S)\colon x^2+y^2+z^2-2x-4y+6z-13=0$. Lấy điểm $M(a;b;c)$ với $a<0$ thuộc đường thẳng $d$ sao cho từ $M$ kẻ được ba tiếp tuyến $MA,MB,MC$ đến mặt cầu $(S)$ ($A,B,C$ là các tiếp điểm) thỏa mãn $\widehat{AMB}=60^{\circ}$, $\widehat{BMC}=90^{\circ}$ và $\widehat{CMA}=120^{\circ}$. Tính $a+b+c$.
\choice 
{$\dfrac{10}{3}$} 
{$1$}
{\True $-2$} 
