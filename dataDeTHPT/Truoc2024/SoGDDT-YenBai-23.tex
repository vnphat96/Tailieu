...
\begin{ex}%[Đề thi thử Sở Yên Bái - 22 - 23]%[Dự án 12EX-6-2023]%[Nhật Thiện]%[2D1Y5-1]
	\immini[thm]{Đồ thị của hàm số nào dưới đây có dạng như hình bên?
		\choice
...
\begin{ex}%[Đề thi thử Sở Yên Bái - 22 - 23]%[Dự án 12EX-6-2023]%[Nhật Thiện]%[2H3Y3-1]
	Trong KG $Oxyz$, đường thẳng $d\colon \dfrac{x-2}{-1}=\dfrac{y-1}{2}=\dfrac{z-3}{1}$ có một vectơ chỉ phương là
	\choice
	{$\vec{u}_1=(-1;2;3)$}
	{$\vec{u}_3=(2;1;3)$}
	{$\vec{u}_2=(2;1;1)$}
	{\True $\vec{u}_4=(-1;2;1)$}
	\loigiai{
		Đường thẳng $d\colon \dfrac{x-2}{-1}=\dfrac{y-1}{2}=\dfrac{z-3}{1}$ có một vectơ chỉ phương là $\vec{a}=(-1;2;1)=\vec{u}_4$.
	}
\end{ex}
\begin{ex}%[Đề thi thử Sở Yên Bái - 22 - 23]%[Dự án 12EX-6-2023]%[Nhật Thiện]%[2H3Y1-1]
	Trong KG $Oxyz$, cho điểm $M(0;2023;-5)$. Mệnh đề nào dưới đây đúng?
	\choice
	{\True $M\in (Oyz)$}
	{$M\in (Oxz)$}
	{$M\in Oy$}
...
\end{ex}
\begin{ex}%[Đề thi thử Sở Yên Bái - 22 - 23]%[Dự án 12EX-6-2023]%[Nhật Thiện]%[2H3Y1-1]
	Trong KG $Oxyz$, cho điểm $M(2;-1;4)$. Tọa độ điểm $N$ đối xứng với điểm $M$ qua mặt phẳng $(Oxz)$ là
	\choice
	{$(-2;1;-4)$}
	{$(2;0;4)$}
	{\True $(2;1;4)$}
...
\begin{ex}%[Đề thi thử Sở Yên Bái - 22 - 23]%[Dự án 12EX-6-2023]%[Nhật Thiện]%[2D1Y2-2]
	\immini[thm]{Cho hàm số bậc ba $y=f(x)$ có đồ thị như hình bên. Giá trị cực đại của hàm số đã cho là
		\choice
		{$-1$}
		{\True $2$}
		{$1$}
...
\begin{ex}%[Đề thi thử Sở Yên Bái - 22 - 23]%[Dự án 12EX-6-2023]%[Nhật Thiện]%[2H3Y2-2]
	Trong KG $Oxyz$, mặt phẳng $(P)\colon 3x-z+2=0$ có một vectơ pháp tuyến là
	\choice
	{$\vec{n}_2=(3;-1;0)$}
	{\True $\vec{n}_3=(3;0;-1)$}
	{$\vec{n}_1=(3;-1;2)$}
	{$\vec{n}_4=(-1;0;-1)$}
	\loigiai{
		Mặt phẳng $(P)\colon 3x-z+2=0$ có một vectơ pháp tuyến là $\vec{n}=(3;0;-1)=\vec{n}_3$.
	}
\end{ex}
...
\begin{ex}%[Đề thi thử Sở Yên Bái - 22 - 23]%[Dự án 12EX-6-2023]%[Nhật Thiện]%[2H3B3-2]
	Trong KG $Oxyz$, PTĐT đi qua hai điểm $P(1;1;-1)$ và $Q(2;3;2)$ là
	\choice
...
\loigiai{
Đường thẳng đi qua hai điểm $P$ và $Q$ nhận $\vec{PQ}=(1;2;3)$ làm một vectơ chỉ phương.\\
...
\begin{ex}%[Đề thi thử Sở Yên Bái - 22 - 23]%[Dự án 12EX-6-2023]%[Nhật Thiện]%[2H3B2-3]
	Trong KG $Oxyz$, cho các điểm $A(1;1;2)$, $B(2;-2;1)$, $C(-2;0;1)$. Phương trình mặt phẳng đi qua $A$ và vuông góc với $BC$ là
	\choice
	{$y+2z-5=0$}
	{$2x-y+1=0$}
	{$-y+2z-3=0$}
	{\True $2x-y-1=0$}
\loigiai{
Mặt phẳng vuông góc với $BC$ nhận $\vec{BC}=(-4;2;0)=-2(2;-1;0)$ làm một vectơ pháp tuyến.\\
...
\begin{ex}%[Đề thi thử Sở Yên Bái - 22 - 23]%[Dự án 12EX-6-2023]%[Nhật Thiện]%[1H3B3-3]
	...
	{$135^\circ$}
	\loigiai{
		\immini[thm]{Ta có $SA\perp (ABC)$ tại $A$ suy ra $AC$ là hình chiếu của $SC$ lên $(ABC)$.\\
...
\begin{ex}%[Đề thi thử Sở Yên Bái - 22 - 23]%[Dự án 12EX-6-2023]%[Nhật Thiện]%[1H3K5-3]
	...
	{$a$}
\loigiai{
\immini[thm]{Gọi $O$ là tâm hình vuông $ABCD$.\\
...
\begin{ex}%[Đề thi thử Sở Yên Bái - 22 - 23]%[Dự án 12EX-6-2023]%[Nhật Thiện]%[2H3K3-2]
	Trong KG $Oxyz$, cho mặt phẳng $(P)\colon 2x+2y-z-3=0$, đường thẳng $d\colon \dfrac{x+1}{1}=\dfrac{y-1}{1}=\dfrac{z}{2}$ và điểm $A(2;2;-1)$. PTĐT $\Delta$ qua $A$ cắt $d$ và song song với $(P)$ là
	\choice
...
Khi đó $\Delta$ qua $A$ và $B$ nên nhận $\vec{AB}=(t-3;t-1;2t+1)$ làm một vectơ chỉ phương.\\
Mà $\Delta$ song song với $(P)$ nên $\vec{AB}\perp \vec{n}$ với $\vec{n}=(2;2;-1)$ là một vectơ pháp tuyến của $(P)$.\\
...
Đường thẳng $\Delta$ qua $A(2;2;-1)$ và nhận $\vec{AB}=\left(\dfrac{3}{2};\dfrac{7}{2};10\right)=\dfrac{1}{2}\left(3;7;20\right)$ làm một vectơ chỉ phương.\\
PTĐT $\Delta$ là $$\dfrac{x-2}{3}=\dfrac{y-2}{7}=\dfrac{z+1}{20}.$$
}
\end{ex}
...
\begin{ex}%[Đề thi thử Sở Yên Bái - 22 - 23]%[Dự án 12EX-6-2023]%[Nhật Thiện]%[2D4K5-1]
	...
	{$P=8$}
\loigiai{
\immini[thm]{Giả sử số phức $z=a+bi$ có điểm biểu diễn $M(a;b)$.\\
...
\begin{ex}%[Đề thi thử Sở Yên Bái - 22 - 23]%[Dự án 12EX-6-2023]%[Nhật Thiện]%[2H1K3-2]
	...
	{$\dfrac{7\sqrt{7}}{6}$}
\loigiai{
\immini[thm]{Gọi $H$ là hình chiếu vuông góc của $S$ lên $(ABC)$.\\
...
\begin{ex}%[Đề thi thử Sở Yên Bái - 22 - 23]%[Dự án 12EX-6-2023]%[Nhật Thiện]%[2H3G3-8]
	Trong KG $Oxyz$, cho điểm $A(1;2;-3)$ và mặt phẳng $(P)\colon 2x+2y-z+9=0$. Đường thẳng $d$ đi qua $A$ và vuông góc với mặt phẳng $(Q)\colon 3x+4y-4z+5=0$ cắt mặt phẳng $(P)$ tại điểm $B$. Điểm $M$ nằm trong mặt phẳng $(P)$, nhìn đoạn $AB$ dưới góc vuông và độ dài $MB$ lớn nhất. Tính độ dài $MB$.
	\choice
	{$MB=\dfrac{\sqrt{41}}{2}$}
	{$MB=\dfrac{\sqrt{5}}{2}$}
	{\True $MB=\sqrt{5}$}
