...
\begin{ex}%[Đề thi thử THPT Kiến Thuỵ - Thái Bình]%[Bùi Mạnh Tiến, dự án 12EX-6]%[2H3Y3-2]
	Trong không gian $Oxyz$, phương trình của đường thẳng đi qua điểm $A(1;2;-1)$ và có vectơ chỉ phương $\overrightarrow{u}=(1;3;2)$ là
	\choice
	...
	\loigiai
	{
		Đường thẳng đi qua $A(1;2;-1)$ và có vectơ chỉ phương $\overrightarrow{u}=(1;3;2)$ có phương trình là
		\begin{align*}
			\dfrac{x-1}{1}=\dfrac{y-2}{3}=\dfrac{z+1}{2}.
		\end{align*}	
	}
...
\begin{ex}%[Đề thi thử THPT Kiến Thuỵ - Thái Bình]%[Bùi Mạnh Tiến, dự án 12EX-6]%[2H3Y1-3]
	Trong không gian $Oxyz$, tọa độ tâm $I$ và bán kính $R$ của mặt cầu có phương trình $(x+2)^2+(y-3)^2+z^2=5$ là
	\choice
	{$I(2;-3;0)$, $R=5$}
	{$I(-2;3;0)$, $R=5$}
...
\begin{ex}%[Đề thi thử THPT Kiến Thuỵ - Thái Bình]%[Bùi Mạnh Tiến, dự án 12EX-6]%[2H3B1-1]
	Trong không gian $Oxyz$, cho tứ diện $ABCD$ với $A(1;-4;2)$, $B(2;1;-3)$, $C(3;0;-2)$ và $D(2;-5;-1)$. Điểm $G$ thoả mãn $\overrightarrow{GA}+\overrightarrow{GB}+\overrightarrow{GC}+\overrightarrow{GD}=\overrightarrow{0}$ có toạ độ là
	\choice
	{$G(2;-1;-1)$}
	{\True $G(2;-2;-1)$}
	{$G(0;-1;-1)$}
...
\begin{ex}%[Đề thi thử THPT Kiến Thuỵ - Thái Bình]%[Bùi Mạnh Tiến, dự án 12EX-6]%[2H3B2-2]
	Trong không gian $Oxyz$, cho ba điểm $A(1;-2;1)$, $B(-1;3;3)$, $C(2;-4;2)$. Một vectơ pháp tuyến $\overrightarrow{n}$ của mặt phẳng $(ABC)$ là
	\choice
	...
	\loigiai
	{
		...
		Mặt phẳng $(ABC)$ nhận $\overrightarrow{n}=\left[\overrightarrow{AB},\overrightarrow{AC}\right]=(9;4;-1)$ làm một vectơ pháp tuyến.
	}
\end{ex}
...
\begin{ex}%[Đề thi thử THPT Kiến Thuỵ - Thái Bình]%[Bùi Mạnh Tiến, dự án 12EX-6]%[2H3K3-2]
	Trong không gian $Oxyz$, cho mặt phẳng $(P)\colon 2x-y+z-10=0$, điểm $I(1;3;2)$ và đường thẳng $d\colon \heva{& x=-2+2t \\ & y=1+t\\&z=1-t}$. Tìm PTĐT $\Delta$ cắt $(P)$ và $d$ lần lượt tại hai điểm $M$ và $N$ sao cho $I$ là trung điểm của đoạn thẳng $MN$.
	\choice
	...
	\loigiai
	{
		...
		\end{align*}
		Vì $M\in (P)$ nên $2(4-2t)-(5-t)+(3+t)-10=0\Leftrightarrow t=-2\Rightarrow N(-6;-1;3)\Rightarrow \overrightarrow{NI}=(7;4;-1)$ là một vectơ chỉ phương của đường thẳng $\Delta$.\\
		PTĐT $\Delta$ đi qua $N(-6;-1;3)$ và nhận $\overrightarrow{NI}=(7;4;-1)$ làm vectơ chỉ phương là
		\begin{align*}
...
\begin{ex}%[Đề thi thử THPT Kiến Thuỵ - Thái Bình]%[Bùi Mạnh Tiến, dự án 12EX-6]%[2H3K1-4]
	...
	\loigiai
	{
		\immini[thm]{Mặt cầu $(S)$ có tâm là $I(1;1;0)$, bán kính $R=5$.\\
			Ta có $IA=10=2R$.\\
