...
\begin{ex}%[Đề thi thử THPT Kiến Thuỵ - Thái Bình]%[Bùi Mạnh Tiến, dự án 12EX-6]%[2H3Y3-2]
	Trong KG $Oxyz$, phương trình của đường thẳng đi qua điểm $A(1;2;-1)$ và có vectơ chỉ phương $\overrightarrow{u}=(1;3;2)$ là
	\choice
...
\begin{ex}%[Đề thi thử THPT Kiến Thuỵ - Thái Bình]%[Bùi Mạnh Tiến, dự án 12EX-6]%[2H3B2-2]
	Trong KG $Oxyz$, cho ba điểm $A(1;-2;1)$, $B(-1;3;3)$, $C(2;-4;2)$. Một vectơ pháp tuyến $\overrightarrow{n}$ của mặt phẳng $(ABC)$ là
	\choice
...
\begin{ex}%[Đề thi thử THPT Kiến Thuỵ - Thái Bình]%[Bùi Mạnh Tiến, dự án 12EX-6]%[2H3B2-4]
	Trong KG $Oxyz$, cho đường thẳng $d\colon \heva{& x=1+2t \\ & y=3-t\\& z=1-t}$, $t\in \mathbb{R}$ và mặt phẳng $(P)\colon x+2y-3z+2=0$. Toạ độ của giao điểm $A$ của đường thẳng $d$ và mặt phẳng $(P)$ là
	\choice
	{$A(3;5;3)$}
	{$A(1;3;1)$}
	{\True $A(-3;5;3)$}
