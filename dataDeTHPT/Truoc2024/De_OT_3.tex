...
\begin{ex}%[2D2Y4-2]%Câu 1%[Phạm Hoài-Tex-Đề -Vted-2023]%
	...
	\loigiai{Theo định nghĩa đạo hàm của hàm số mũ ta được  $y'=3^x\cdot \ln 3$.
	}
\end{ex}	
...
\begin{ex}%[2D3B1-1]%Câu 8%[Phạm Hoài-Tex-Đề -Vted-2023]%
	...
	\loigiai{\begin{itemize}
			\item $\left(\ln x+2\right)'=\dfrac{1}{x}$. Do đó  $\ln x+2$ là một nguyên hàm của hàm số $f(x)=\dfrac{1}{x}$.
			\item $\left(\ln 2x\right)^{\prime }=\dfrac{(2x)'}{2x}=\dfrac{1}{x}$. Do đó  $\ln (2x)$ là một nguyên hàm của hàm số $f(x)=\dfrac{1}{x}$.
			\item $\left(\dfrac{1}{2}\ln x^2\right)^{\prime }=\dfrac{1}{2}\left(\ln x^2\right)'=\dfrac{1}{2}\dfrac{\left(x^2\right)'}{x^2}=\dfrac{1}{x}$. Do đó $\dfrac{1}{2}\ln x^2$ là một nguyên hàm của hàm số $f(x)=\dfrac{1}{x}$.
			\item  $\left(\ln \dfrac{1}{x}+2\right)'=\dfrac{\left(\dfrac{1}{x}\right)'}{\dfrac{1}{x}}=\dfrac{-\dfrac{1}{x^2}}{\dfrac{1}{x}}=-\dfrac{1}{x}$. Do đó  $\ln \dfrac{1}{x}+2$ không là một nguyên hàm của hàm số $f(x)=\dfrac{1}{x}$.
		\end{itemize}
...
\begin{ex}%[2H3Y3-2]%Câu 9%[Phạm Hoài-Tex-Đề -Vted-2023]%
	Trong KG $Oxyz$, cho đường thẳng $d\colon \heva{&x=1+t\\&y=2-t\\&z=2t}$. Phương trình chính tắc của $d$ là 
	\choice 
	...
	\loigiai{
		Đường thẳng $d\colon \heva{&x=1+t\\&y=2-t\\&z=2t}$ đi qua điểm $A(1;2;0)$ và có vectơ chỉ phương $\overrightarrow{u}=(1;-1;2)$.\\
...
\begin{ex}%[2H3Y1-3]%[Dự án 12-Vted-2022, Nguyen Huynh]
	Trong KG $Oxyz$, cho mặt cầu $(S)\colon x^2+y^2+z^2-2x+4y-6z-1=0$. Tâm của mặt cầu $(S)$ có tọa độ là
	\choice
	{$I(-1;2;-3)$}
	{\True$I(1;-2;3)$}
	{$I(-2;4;-6)$}
...
\begin{ex}%[2D1Y5-1]%[Dự án 12-Vted-2022, Nguyen Huynh]
	\immini[thm]{Đường cong trong hình bên là đồ thị của hàm số nào dưới đây?	\choice{\True$y=-x^3+3x-1$}{$y=-x^3-1$}{$y=x^3-3x-1$}{$y=x^3-1$}}	{\begin{tikzpicture}[thick,scale=1,nodes={scale=1}]
			\def\a{-1}
			\def\b{0}
			\def\c{3}
			\def\d{-1}
...
\begin{ex}%[Nguyễn Thắng-Dự Án Vted 2023 đề 13]%[2H3Y2-3]
	Trong KG $Oxyz$, mặt phẳng đi qua $O$ và nhận vectơ $\vec{n}=(1;-2;5)$ làm vectơ pháp tuyến có phương trình là
	\choice
	{$x+2y-5z=0$}
	{$x+2y-5z+1=0$}
	{\True $x-2y+5z=0$}
	{$x-2y+5z+1=0$}
	\loigiai{
		Mặt phẳng đi qua $O$ và nhận vectơ $\vec{n}=(1;-2;5)$ làm vectơ pháp tuyến có phương trình là $x-2y+5z=0$.
	}
\end{ex}
...
\begin{ex}%[Nguyễn Thắng-Dự Án Vted 2023 đề 13]%[2H3Y1-2]
	Trong KG $Oxyz$, cho hai vectơ $\vec{u}=(1;-2;3)$ và $\vec{v}=(0;1;-1)$. Khi đó $\vec{u}\cdot\vec{v}$
	bằng
	\choice
	{\True$-5$}
	{$5$}
...
\begin{ex}%[Nguyen Tuan, dự án tex đề VTED lần 2 2023]%[2H3B2-7]
	Trong KG $Oxyz$, cho điểm $A(1;-1;2)$ và mặt phẳng $(P) \colon 2x-y+3z+1=0$. Mặt phẳng đi qua $A$ và song song với $(P)$ có phương trình là
	\choice
	{$2x+y+3z+7=0$}
	{$2x+y+3z-7=0$}
	{$2x-y+3z+9=0$}
...
\begin{ex}%[Nguyễn Hoài Nam, Đề 13]%[2H3B3-2]
	Trong KG $Oxyz$, cho đường thẳng $(d) \colon \heva{&x=2t\\&y=1+t \\ &z=1-3t}$ và mặt phẳng $(P) \colon 3x-2y+z-1=0$. Đường thẳng $(d')$ đi qua $M(2;1;1)$ vuông góc với $(d)$ và song song với $(P)$ có phương trình là
	\choice
...
\begin{ex}%[Nguyễn Hoài Nam, Đề 13]%[2H2K1-2]
	...
	{$16 \pi$}
	\loigiai{
		\immini[thm]{Mặt xung quanh của trụ khi cắt theo một đường sinh và trải lên một mặt phẳng ta thu được hình chữ nhật kích thước  $2\pi r \times h \Rightarrow h=2\pi r=4\pi \Rightarrow r=2$.\\
...
\begin{ex}%[Nguyễn Hoài Nam, Đề 13]%[2H3K3-7]
	Trong KG $Oxyz$, mặt phẳng chứa đường thẳng $d \colon \dfrac{x-2}{1}=\dfrac{y-1}{2}=\dfrac{z}{-1}$  và cắt các trục tọa độ $Ox$, $Oy$ lần lượt tại $A$, $B$ sao cho đường thẳng $AB$ vuông góc với $d$ là
	\choice
	{$2x-y-3=0$}
	{$x+2y+5z-5=0$}
	{\True $x+2y+5z-4=0$}
	...
	\loigiai{ Gọi $(P) \cap Ox=A(a;0;0)$, $(P) \cap Oy=B(0;b;0)$. Suy ra $\overrightarrow{AB}=(-a;b;0)$.\\
		Vectơ chỉ phương của $d$ là $\overrightarrow{u}_d=(1;2;-1)$.\\
		...
		Ta có $\heva{& AB \subset (P)\\&d \subset (P)}.$ Suy ra  vectơ pháp tuyến của $(P)$ là $\overrightarrow{n}_{(P)}=\left[ \overrightarrow{u},\overrightarrow{u}_d \right]=(-1;-2;-5)$. \\
...
\begin{ex}%[Paul Hieu Nguyen-Dự Án Vted 2023 đề 13]%[2D3G3-1]%Câu 46
	\immini[thm]{Cho hàm số bậc bốn $f(x)$ có đồ thị của $f(x)$, $f'(x)$ như hình vẽ bên. Gọi $S_1$ và $S_2$ là diện tích của hai hình phẳng được gạch trong hình vẽ. Khi $S_1=1$ thì $S_2$ bằng
		\choice
		{\True $\dfrac{104}{23}$}
		{$\dfrac{70}{23}$}
		{$\dfrac{57}{23}$}
...
\begin{ex}%[Paul Hieu Nguyen-Dự Án Vted 2023 đề 13]%[2H3G3-7]%Câu 48
	Trong KG $Oxyz$, cho mặt cầu $(S)\colon (x-4)^2+(y+3)^2+(z+6)^2=50$ tâm $I$. Có bao nhiêu điểm $M$ thuộc trục hoành, với hoành độ là số nguyên, mà từ $M$ kẻ được đến $(S)$ hai tiếp tuyến và mặt phẳng chứa hai tiếp tuyến đó tạo với đường thẳng $IM$ góc $45^\circ$?
	\choice
	{\True $10$}
	{$9$}
	{$11$}
	{$8$}
	\loigiai{
		\immini[thm]{Mặt cầu đã cho có tâm $I(4 ;-3 ;-6)$, $R=5 \sqrt{2}$. Gọi $M(m ; 0 ; 0) \in Ox$, ($m \in \mathbb{Z}$).\\
...
%==================Câu 13
\begin{ex}%[2D1Y5-1]%[Dự án 12-Vted-2022, Nguyen Huynh]
	\immini{Đường cong trong hình bên là đồ thị của hàm số nào dưới đây?	\choice{\True$y=-x^3+3x-1$}{$y=-x^3-1$}{$y=x^3-3x-1$}{$y=x^3-1$}}	{\begin{tikzpicture}[thick,scale=1,nodes={scale=1}]
			\def\a{-1}
			\def\b{0}
			\def\c{3}
			\def\d{-1}
...
%%==========Câu 23
\begin{ex}%[Nguyễn Thắng-Dự Án Vted 2023 đề 13]%[2D1Y2-2]
	\immini{Cho hàm số $y=ax^4+bx^2+c$ ($a,b,c\in\mathbb{R}$) có đồ thị là đường cong trong hình bên. Điểm cực đại của đồ thị hàm số đã cho là
		\choice[2]
		{$x=0$}
		{\True $M(0;-1)$}
		{$y=-1$}
