...
\begin{ex}%[Đề 12 - Dự án đề VTED 2023 - Đợt 2 - Đoàn Minh Tân]%[2H3Y3-2]
	Trong KG $Oxyz$, phương trình của đường thẳng đi qua điểm $M(-1;0;2)$, đồng thời nhận vectơ $\overrightarrow{u}=(2;3;-1)$ làm vectơ chỉ phương là
	\choice
	...
	{$\dfrac{x+1}{2}=\dfrac{y}{3}=\dfrac{z-2}{1}$}
	\loigiai{
	Đường thẳng đi qua điểm $M(-1;0;2)$ và có vectơ chỉ phương $\overrightarrow{u}=(2;3;-1)$ có phương trình $\dfrac{x+1}{2}=\dfrac{y}{3}=\dfrac{z-2}{-1}$.
	}
\end{ex}
%%==========Câu 8
...
\begin{ex}%[Đề 12 - Dự án đề VTED 2023 - Đợt 2 - Đoàn Minh Tân]%[2D1Y2-2]
	\immini[thm]{Cho hàm đa thức bậc ba $f(x)$ có đồ thị như hình vẽ. Giá trị cực đại của hàm số bằng
	\choice
	{$-4$}
	{$2$}
	{\True $0$}
...
\begin{ex}%[2D1Y1-2]%Dự án tex đề Vted số 12%GV soạn Nguyễn Hữu Chung Kiên
	...
	{ $f'(x)>0,$ $ \forall x \in \mathbb{R}$}
	\loigiai{Ta có hàm số $y=f(x)$ đồng biến trên $\mathbb{R}$ khi và chỉ khi $f'(x) \geq 0,$ $ \forall x \in \mathbb{R}$.
	}
\end{ex}
%%==========Câu 12
\begin{ex}%[2D3Y1-3]%Dự án tex đề Vted số 12%GV soạn Nguyễn Hữu Chung Kiên
	...
	{ $\displaystyle\int u(x) \cdot v'(x) \mathrm{~d} x=u(x) \cdot v(x)-\displaystyle\int u'(x) \cdot v'(x) \mathrm{~d} x$}
	{ $\displaystyle\int u(x) \cdot v'(x) \mathrm{~d} x=u(x) \cdot v(x)+\displaystyle\int u'(x) \cdot v'(x) \mathrm{~d} x $}
	\loigiai{Theo công thức nguyên hàm từng phần thì $$\displaystyle\int u(x) \cdot v'(x) \mathrm{~d} x=u(x) \cdot v(x)-\displaystyle\int u'(x) \cdot v(x) \mathrm{~d} x.$$
	}
\end{ex}
%%==========Câu 13
...
\begin{ex}%[Dự án Đề thi thử Vted 12 Năm 2023-Lần 2]%[Nguyễn Chiến Thắng]%[2D1B5-1]
	\immini[thm]{Đồ thị của hàm số nào dưới đây có dạng như đường cong trong hình bên?}
	{
...
\begin{ex}%[Dự án Đề thi thử Vted 12 Năm 2023-Lần 2]%[Nguyễn Chiến Thắng]%[2H3B1-3]
	Trong KG $Oxyz$, phương trình của mặt cầu tâm $I(1;-2;2)$ và bán kính $r=3$ là
	\choice
	{$(x+1)^2+(y-2)^2+(z+2)^2=3$}
	{ $(x+1)^2+(y-2)^2+(z+2)^2=9$}
	{ $(x-1)^2+(y+2)^2+(z-2)^2=3$}
...
\begin{ex}%[Dự án Đề thi thử Vted 12 Năm 2023-Lần 2]%[Nguyễn Chiến Thắng]%[2H3Y2-2]
	Trong KG $Oxyz$, một vectơ pháp tuyến của mặt phẳng $(P):2x-y+3z-4=0$ là
	\choice
	{ \True $\overrightarrow{n}_4=(2;-1;3)$}
	{ $\overrightarrow{n}_3=(2;1;3)$}
	{ $\overrightarrow{n}_2=(-2;-1;3)$}
	{ $\overrightarrow{n}_1=(2;-1;-3)$}
	\loigiai{Một vectơ pháp tuyến của $(P)$ là $\overrightarrow{n}_4=(2;-1;3)$.
	}
\end{ex}

%%==========Câu 27
\begin{ex}%[Dự án Đề thi thử Vted 12 Năm 2023-Lần 2]%[Nguyễn Chiến Thắng]%[2H3Y1-1]
	Trong KG $Oxyz$, cho hai vectơ $\vec{u}=(1 ;-3 ; 2)$ và $\vec{v}=2 \vec{k}-2 \vec{i}-\vec{j}$. Tọa độ của vectơ $\vec{u}-2\vec{v}$ là
	\choice
	{\True $(5 ;-1 ;-2)$}
	{ $(-3 ;-5 ; 6)$}
	{ $(-3 ; 1 ; 4)$}
...
\begin{ex}%[Dự án Đề thi thử Vted 12 Năm 2023-Lần 2]%[Nguyễn Chiến Thắng]%[2H3B3-2]
	...
	\loigiai{Ta có $\vec{MN}=(-1;2;1)$. Chọn $\vec{u}=(1;-2;-1)$ làm một vectơ chỉ phương cho $MN$.\\
	Vậy, PTTS của $MN$ là $\heva{&x=1+t \\& y=1-2 t \\& z=2-t.}$
	}
\end{ex}
...
\begin{ex}%[Lương Như Quỳnh]%[Tex hóa Đề Vted 2023]%[2H3B2-3]
	Trong KG $Oxyz$, cho hai điểm $A(-1;0;2)$, $B(3;2;0)$. Phương trình mặt phẳng trung trực của $AB$ là
	\choice
	{$x+y+z+2=0$}
	{$2 x+y-z+2=0$}
	{$x+y+z-2=0$}
...
\begin{ex}%[Loc Do]%[Tex hóa Đề Vted 2023]%[2H3G3-2]
	Trong KG $Oxyz$, cho đường thẳng $d\colon \heva{&x=1+2t\\&y=1-t\\&z=1+2t}$ và đường thẳng $d'$ qua điểm $A(1;1;1)$ có một vectơ chỉ phương $\vec{u}=(1;1;4)$. Đường thẳng qua $M(2;3;7)$ cắt $d$, $d'$ lần lượt tại $B$ và $C$ sao cho $A$, $B$, $C$ là ba đỉnh của tam giác cân tại $B$ có phương trình là
	\choice
...
\begin{ex}%[Loc Do]%[Tex hóa Đề Vted 2023]%[2D4G5-1]
	...
	{$3\sqrt{2}+1$}
	\loigiai{
	\immini[thm]{ Vì $|z|=2;|w| =4 \Rightarrow M(z)\in (C_1), N(w)\in (C_2)$ có cùng tâm $O(0;0)$ và bán kính $R_1=2; R_2=4$.
...
\begin{ex}%[Lê Hồng Phi]%[Tex hóa Đề Vted 2023]%[2H3G2-7]
	...
	Mặt phẳng $(P)$ có vectơ pháp tuyến $\overrightarrow{n}=(4;-3;m)$ vuông góc với vectơ $\overrightarrow{I_1 I_2}=(3;4;0)$ nên $I_1I_2$ song song với $(P)$ hoặc $I_1I_2$ nằm trong mặt phẳng $(P)$.\\
