...
\begin{ex}%[Đề 12 - Dự án đề VTED 2023 - Đợt 2 - Đoàn Minh Tân]%[2H3Y3-2]
	Trong KG $Oxyz$, phương trình của đường thẳng đi qua điểm $M(-1;0;2)$, đồng thời nhận véc-tơ $\overrightarrow{u}=(2;3;-1)$ làm véc-tơ chỉ phương là
	\choice
...
\begin{ex}%[Dự án Đề thi thử Vted 12 Năm 2023-Lần 2]%[Nguyễn Chiến Thắng]%[2H3Y2-2]
	Trong KG $Oxyz$, một véc-tơ pháp tuyến của mặt phẳng $(P):2x-y+3z-4=0$ là
	\choice
...
\begin{ex}%[Loc Do]%[Tex hóa Đề Vted 2023]%[2H3G3-2]
	Trong KG $Oxyz$, cho đường thẳng $d\colon \heva{&x=1+2t\\&y=1-t\\&z=1+2t}$ và đường thẳng $d'$ qua điểm $A(1;1;1)$ có một véc-tơ chỉ phương $\vec{u}=(1;1;4)$. Đường thẳng qua $M(2;3;7)$ cắt $d$, $d'$ lần lượt tại $B$ và $C$ sao cho $A$, $B$, $C$ là ba đỉnh của tam giác cân tại $B$ có phương trình là
	\choice
