...
\begin{ex}%[Kiểm tra chuyên đề lần 2, THPT Chuyên Vĩnh Phúc Lần 2, 2023]%[Đăng Tạ, 12EX6]%[2D1B5-1]
	\immini[thm]{Hàm số $y=ax^4+bx^2+c$ có đồ thị như hình vẽ bên. Mệnh đề nào sau đây là đúng?
		\choice
		{$a>0$, $b>0$, $c<0$}
		{\True $a>0$, $b<0$, $c>0$}
		{$a>0$, $b<0$, $c<0$}
...
\begin{ex}%[Kiểm tra chuyên đề lần 2, THPT Chuyên Vĩnh Phúc Lần 2, 2023]%[Đăng Tạ, 12EX6]%[2D1B5-1] 
	\immini[thm]{	Đường cong trong hình bên là đồ thị của hàm số nào?
		\choice
		{ $y=-x^3+1$}
		{\True $y=-x^3+2$}
		{$y=-x^3+3 x+2$}
...
\begin{ex}%[Kiểm tra chuyên đề lần 2, THPT Chuyên Vĩnh Phúc Lần 2, 2023]%[Đăng Tạ, 12EX6]%[2H3K2-7]
	...
	\loigiai{
		...
		Mặt phẳng $(P)$ đi qua $M(0;1;0)$ và nhận $\overrightarrow{IM}= (1;-1;-1)$ làm vectơ pháp tuyến có dạng 
