...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[2D1Y3-1]
	\immini[thm]{Cho hàm số $y=f(x)$ có đồ thị như hình vẽ. Giá trị lớn nhất và giá trị nhỏ nhất của hàm số đã cho trên $[-1;1]$ lần lượt là
		\choice
		{\True $-3$ và $-4$}
		{$1$ và $-4$}
		{$0$ và $-4$}
...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[2D1Y1-2]
	\immini[thm]{Cho hàm số $y=f(x)$ có đồ thị như hình vẽ. Khẳng định nào sau đây đúng?
		\choice
...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[2H1Y3-2]
	...
	\loigiai{\immini[thm]{Do $SA\perp(ABCD)$ nên thể tích của khối chóp là
...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[2H3Y2-4]
	Trong không gian $Oxyz$, cho mặt phẳng $(P)\colon4x+3y+z-1=0$. Điểm nào dưới đây thuộc $(P)$?
	\choice
	{$M(0;2;-1)$}
	{\True $N(1;1;-6)$}
	{$P(1;-6;1)$}
...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[2H3Y1-3]
	Trong không gian $Oxyz$, mặt cầu tâm $I(1;0;-2)$ bán kính $R=2$ có phương trình là
	\choice
	{$(x-1)^2+y^2+(z+2)^2=2$}
...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[2H3Y1-1]
	Trong không gian tọa độ $Oxyz$, cho các điểm $M(1;2;-3)$ và $N(3;2;4)$. Tọa độ vectơ $\overrightarrow{MN}$ là
	\choice
	{$(4;4;1)$}
	{\True $(2;0;7)$}
	{$(-2;0;-7)$}
	{$\left(2;2;\dfrac{1}{2}\right)$}
	\loigiai{Tọa độ của vectơ $\overrightarrow{MN}=\left(x_N-x_M;y_N-y_M;z_N-z_M\right)=(2;0;7)$.}
\end{ex}
...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[2H3B2-5]
	...
	{$\dfrac{2}{3}$}
	{$-\dfrac{2}{3}$}
	\loigiai{Mặt phẳng $(P)$ và $(Q)$ lần lượt có vectơ pháp tuyến là $\overrightarrow{n}_{(P)}=(1;-2;2)$ và  $\overrightarrow{n}_{(Q)}=(2;2;-1)$.\\
...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[2D1B5-1]
	\immini[thm]{Đường cong trong hình vẽ bên là đồ thị của hàm số nào trong các hàm số sau
		\choice
		{$y=x^4+2x^2$}
		{$y=x^4-2x^2+2$}
		{$y=-x^4+2x^2-2$}
...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[1H3B3-3]
	...
	{$30^\circ$}
	{$90^\circ$}
	\loigiai{\immini[thm]{Do $SA\perp(ABCD)$ nên $AC$ là hình chiếu của $SC$ lên $(ABCD)$.\\
...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[1H3K5-3]
	\immini[thm]{Cho hình chóp tứ giác đều $S.ABCD$ có tất cả các cạnh bằng $2$. Khoảng cách từ $A$ đến mặt phẳng $(SCD)$ bằng
		\choice
		{$\sqrt{2}$}
		{$\sqrt{3}$}
		{$\dfrac{\sqrt{6}}{3}$}
		{\True $\dfrac{2\sqrt{6}}{3}$}}
	{
		\begin{tikzpicture}[>=stealth,line join=round,line cap=round,font=\footnotesize,scale=0.5]
			...
			\fill (\p) circle (1.2pt) node[shift={(\r:2mm)}]{$\p$};
	\end{tikzpicture}}
	\loigiai{\immini[thm]{Gọi $O$ là trung điểm của $AC$, suy ra $\mathrm{d}(A,(SCD))=2\mathrm{d}(O,(SCD))$.\\
...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[2H2K1-4]
	...
	{$33{,}3$ cm}
	{$8{,}33$ cm}
	\loigiai{\immini[thm]{Từ giả thiết bài toán ta suy ra phần bề mặt nước là thiết diện song song với trục hình trụ và cách trục hình trụ một khoảng bằng $\sqrt{3}$ m. Gọi thiết diện đó là $ABCD$ như hình vẽ.\\
...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[2H3K4-1]
	...
	{$\dfrac{16}{3}$}
	{$\dfrac{16\sqrt{2}}{3}$}
	\loigiai{\immini[thm]{Xét hình chóp trong hệ tọa độ $Oxyz$, sao cho $A$ trùng với gốc tọa độ $O$, các đỉnh $B$, $D$, $S$ lần lượt thuộc các trục tọa độ như hình vẽ.\\
...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[2D1G5-5]
	\immini[thm]{Cho $f(x)$ là hàm số bậc bốn. Biết $f(4)=0$ và đồ thị của hàm số $f'(x)$ như hình vẽ. Hàm số $g(x)=\left|f(x)-\dfrac{x^2}{4}+1\right|$ có bao nhiêu điểm cực tiểu?
		\choice
		{\True $2$}
		{$1$}
		{$4$}
	...
	\end{tikzpicture}}
	\loigiai{\immini[thm]{Xét $h(x)=f(x)-\dfrac{x^2}{4}+1$, ta có $h'(x)=f'(x)-\dfrac{x}{2}$.\\
...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[2H3G3-7]
	Trong không gian $Oxyz$ cho mặt phẳng $(P)\colon x-2y+2z+12=0$ và mặt cầu $(S)\colon x^2+y^2+z^2+2x-4y-2z+5=0$. Xét hai điểm $M$, $N$ lần lượt thuộc $(P)$ và $(S)$ sao cho $\overrightarrow{MN}$ cùng phương với vectơ $\overrightarrow{u}=(1;1;1)$. Giá trị nhỏ nhất của $MN$ bằng
	\choice
	{$3$}
	{$9\sqrt{3}-1$}
	{\True $6\sqrt{3}$}
	{$2$}
	\loigiai{Mặt phẳng $(P)$ có vectơ pháp tuyến là $\overrightarrow{n}=(1;-2;2)$.\\
