...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[2H3G3-7]
	Trong KG $Oxyz$ cho mặt phẳng $(P)\colon x-2y+2z+12=0$ và mặt cầu $(S)\colon x^2+y^2+z^2+2x-4y-2z+5=0$. Xét hai điểm $M$, $N$ lần lượt thuộc $(P)$ và $(S)$ sao cho $\overrightarrow{MN}$ cùng phương với vectơ $\overrightarrow{u}=(1;1;1)$. Giá trị nhỏ nhất của $MN$ bằng
	\choice
	{$3$}
	{$9\sqrt{3}-1$}
	{\True $6\sqrt{3}$}
