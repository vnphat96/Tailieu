...
\begin{ex}%[Dự án text đề Vted 2023]%[Hiếu Mai]%[2H3Y3-2]
	Trong không gian $Oxyz$, đường thẳng đi qua $A(1;2;3)$ và nhận vectơ $\vv{u}=(-1;2;2)$ làm vectơ chỉ phương có PTTS là
	\choice
	{$\heva{
			x&=-1+t
			\\
	...
	\loigiai{
		Đường thẳng đi qua $A(1;2;3)$ và nhận vectơ $\vv{u}=(-1;2;2)$ làm vectơ chỉ phương có PTTS là
		$$\heva{
			x&=1-t
			\\
			y&=2+2t
...
%%==========Câu 38
\begin{ex}%[2H3B2-3]
	Trong không gian $Oxyz$, cho ba điểm $A\left(1;1;1\right),B\left(0;2;1\right),C\left(1;-1;2\right)$. Mặt phẳng đi qua $A$ vuông góc với $BC$ có phương trình là
	\choice
	{$x+y+z-3=0$}
	{$x-3y+z-1=0$}
	{\True $x-3y+z+1=0$}
...
\begin{ex}%[2D2G5-5]
	...
	\loigiai{
		...
		Xét $g(x)=\dfrac{\ln (9 x)}{x}$ trên $(0 ;+\infty)$ có $g'(x)=\dfrac{1-\ln (9 x)}{x^{2}}=0 \Leftrightarrow \ln (9 x)=1 \Leftrightarrow 9 x=\mathrm{e} \Leftrightarrow x=\dfrac{\mathrm{e}}{9}$.\\
		Bảng biến thiên
		\begin{center}
...
%%==========Câu 50
\begin{ex}%[2H3G2-8]
	Trong không gian $Oxyz$, cho ba điểm $A(2;4;-1)$, $B(3;2;2)$, $C(0;3;-2)$. Xét điểm $M$ di động trên mặt phẳng $(P) \colon x-y-z+1=0$. Giá trị nhỏ nhất của $MA+MB+MC$ bằng 
	\choice
	{\True $\sqrt{38}$}
	{$6\sqrt{2}$}
	{$3\sqrt{2}+\sqrt{6}$}
