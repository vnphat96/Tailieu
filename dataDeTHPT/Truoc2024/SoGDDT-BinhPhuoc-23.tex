...
\begin{ex}%[Đề thi thử Tốt Nghiệp THPT Lần 1, SGD Bình Phước, 2023]%[12-EX-6-2023, Võ Hoàng Nghĩa]%[2H3Y2-2]
	Trong không gian $Oxyz$, cho mặt phẳng $(P)\colon x+2y+3z-1=0$. Vectơ nào dưới đây là một vectơ pháp tuyến của $(P)$?
	\choice
...
\begin{ex}%[Đề thi thử Tốt Nghiệp THPT Lần 1, SGD Bình Phước, 2023]%[12-EX-6-2023, Võ Hoàng Nghĩa]%[2H3K3-8]
	Trong không gian $Oxyz$, cho đường thẳng $d\colon\dfrac{x+2}{4}=\dfrac{y-1}{-4}=\dfrac{z+2}{3}$ và mặt phẳng $(P)\colon2x-y+2z+1=0$. Đường thẳng $\Delta $ đi qua $E\left(-2;1;-2\right)$, song song với $(P)$ đồng thời tạo với $d$ góc bé nhất. Biết rằng $\Delta$ có một vectơ chỉ phương $\overrightarrow{u}=\left(m;n;1\right).$ Tính $T=m^2-n^2$.
	\choice
	{$T=4$}
	{$T=3$}
	{\True $T=-4$}
