...
\begin{ex}%[2H3Y2-2]%[BCTuan, dự án tex đề VTED 2023]
	Trong KG $Oxyz$, mặt phẳng vuông góc với đường thẳng $d\colon \heva{&x=1-2t \\& y=2+t \\& z=3+4t}$ có một vectơ pháp tuyến là
	\choice
...
\begin{ex}%[2H3B3-1]%[BCTuan, dự án tex đề VTED 2023]
	Trong KG $Oxyz$, đường thẳng đi qua hai điểm $A(3;-2;4)$ và $B(1;1;2)$ có một vectơ chỉ phương là
	\choice
...
\begin{ex}%[2H3Y1-1]%[BCTuan, dự án tex đề VTED 2023]
	Trong KG $Oxyz$, toạ độ của vectơ $\overrightarrow{a}=2 \overrightarrow{i}+3 \overrightarrow{k}-\overrightarrow{j}$ là
	\choice
	{$(2;3;-1)$}
	{$(-1;3;2)$}
	{\True $(2;-1;3)$}
