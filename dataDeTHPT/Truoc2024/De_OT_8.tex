...
\begin{ex}%[2H3Y2-2]%[BCTuan, dự án tex đề VTED 2023]
	Trong không gian $Oxyz$, mặt phẳng vuông góc với đường thẳng $d\colon \heva{&x=1-2t \\& y=2+t \\& z=3+4t}$ có một vectơ pháp tuyến là
	\choice
	...
	\loigiai{
		Mặt phẳng  vuông góc với đường thẳng $d\colon \heva{&x=1-2t \\& y=2+t \\& z=3+4t}$ có một vectơ pháp tuyến là $\overrightarrow{n}_4=(-2;1;4)$.
	}
\end{ex}
\begin{ex}%[2H3B3-1]%[BCTuan, dự án tex đề VTED 2023]
	Trong không gian $Oxyz$, đường thẳng đi qua hai điểm $A(3;-2;4)$ và $B(1;1;2)$ có một vectơ chỉ phương là
	\choice
	...
	\loigiai{
		...
		Vậy $\overrightarrow{u}_1=(2;-3;2)$ là một vectơ chỉ phương của đường thẳng trên.
	}
\end{ex}
...
\begin{ex}%[2H3Y1-1]%[BCTuan, dự án tex đề VTED 2023]
	Trong không gian $Oxyz$, toạ độ của vectơ $\overrightarrow{a}=2 \overrightarrow{i}+3 \overrightarrow{k}-\overrightarrow{j}$ là
	\choice
	{$(2;3;-1)$}
	{$(-1;3;2)$}
	{\True $(2;-1;3)$}
...
\begin{ex}%[Nguyễn Văn Sang-Dự Án Đề VTed-2023-Đề 18]%[2H3B3-3]
	Trong không gian $Oxyz$, hình chiếu vuông góc của điểm $M(1 ; 2 ;-1)$ trên mặt phẳng $(P) \colon x+2 y-3 z+6=0$ là điểm $H(a;b;c)$. Tổng $a+b+c$ bằng
	\choice
	{$-3$}
	{$-4$}
	{$0$}
...
\begin{ex}%[Paul Hieu Nguyen-Dự Án Vted 2023 đề 18]%[1H3K5-3]
	...
	{\True $2$}
	\loigiai{
		\immini[thm]{Gọi $O$ là tâm mặt đáy và $M$ là trung điểm cạnh $CD$.\\
...
\begin{ex}%[Paul Hieu Nguyen-Dự Án Vted 2023 đề 18]%[2H1K3-2]
	...
	{$3 a^3$}
	\loigiai{
		\immini[thm]{Đặt $A B=B C=C A=x$, ($x>0$).\\
...
\begin{ex}%[Paul Hieu Nguyen-Dự Án Vted 2023 đề 18]%[2H3K3-7]
	Trong không gian $Oxyz$, cho điểm $E(3 ; 0 ; 5)$ và hai đường thẳng $d_1\colon \dfrac{x-2}{1}=\dfrac{y-2}{1}=\dfrac{z}{-1}$; $d_2\colon \left\{\begin{aligned} &x=2+t \\ &y=-1+2 t \\ &z=-3 t\end{aligned}\right.$. Gọi $(P)$ là mặt phẳng đi qua $E$, cắt hai đường thẳng $d_1$, $d_2$ lần lượt tại các điểm $A$ và $B$ sao cho $A B=\sqrt{6}$. Điểm nào dưới đây thuộc $(P)$?
	\choice
	{\True $M(1 ; 2 ; 3)$}
	{$Q(3 ; 2 ;-1)$}
	{$P(1 ;-2 ; 3)$}
...
\begin{ex}%[2H2G2-5]%[Phạm Hoài, Tex-hoa-VTed-2022-2-23]
	Trong không gian $Oxyz$, cho điểm $M(3;0;5)$ và mặt cầu $(S)\colon (x-1)^2+(y+2)^2+(z-4)^2=81$. Xét các điểm $A$, $B$, $C$ di động trên $(S)$ sao cho $MA$, $MB$, $MC$ đôi một vuông góc và gọi $E$ là đỉnh đối diện với đỉnh $M$ của hình hộp chữ nhật có ba cạnh $MA$, $MB$, $MC$. Khoảng cách từ  $E$ đến mặt phẳng $(Oxy)$ có giá trị lớn nhất bằng
	\choice
	{$21$}
	{\True $15$}
	{$17$}
	...
	\loigiai{
		\begin{itemize}
			...
			\end{tikzpicture}}
			Sử dụng tích vô hướng của hai vectơ chung gốc dạng $$\overrightarrow{OX}\cdot \overrightarrow{OY}=\dfrac{OX^2+OY^2-XY^2}{2}.$$
			Suy ra
			...
			\immini[thm]{ Gọi $H$ là hình chiếu của $E$ lên mặt phẳng $(Oxy)$.\\
...
\begin{ex}%[2D1G5-4]%[Phạm Hoài, Tex-hoa-VTed-2022-2-23]
	\immini[thm]{Cho hàm số bậc bốn $f(x)$ có đồ thị $(C)$ như hình vẽ. Đường thẳng $d\colon y=g(x)$ là tiếp tuyến của $(C) $ tại điểm có hoành độ $x=3$. Số nghiệm thực phân biệt của phương trình $\dfrac{f(x)-4}{g(x)-4}=\dfrac{g(x)}{f(x)}$ là
		\choice
		{$7$}
		{\True $4$}
		{$5$}
...
\begin{ex}%[2H2G1-5]%[Phạm Hoài, Tex-hoa-VTed-2022-2-23]
	...
	{$\dfrac{1}{\sqrt{3}}$}
	\loigiai{
		\immini[thm]{Ta có $r=h=2a$. Hạ đường sinh $AA'$.\\
		...
		\end{tikzpicture}}
		\immini[thm]{Do đó thể tích khối tứ diện $OAO'B$ đạt giá trị lớn nhất khi và chỉ khi $BH_{\max}$.\\
