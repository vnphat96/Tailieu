...
\begin{ex}%[Đề thi thử tốt nghiệp THPT Quốc Gia năm 2023 - Trường THCS-THPT Hồng Đức - Thành phố Hồ Chí Minh]%[Ninh Tiến Nam - 2EX623]%[2H3Y1-3]
	Trong không gian $Oxyz$, cho mặt cầu $(S)\colon x^2+(y-3)^2+(z+3)^2=25$. Tọa độ tâm của mặt cầu đã cho là
	\choice
	{$(0;-3;-3)$}
	{$(0;-3;3)$}
	{$(0;3;3)$}
...
\immini[thm]{Hàm số nào dưới đây có đồ thị dạng như đường cong hình vẽ
	bên?
	\choice
	{$y=-x^3+3x+1$}
	{$y=x^3+3x^2+1$}
...
\begin{ex}%[Đề thi thử tốt nghiệp THPT Quốc Gia năm 2023 - Trường THCS-THPT Hồng Đức - Thành phố Hồ Chí Minh]%[Ninh Tiến Nam - 2EX623]%[2H3Y3-1]
	Trong không gian $Oxyz$, vectơ nào dưới đây là một vectơ chỉ phương của đường thẳng đi qua hai điểm $M(1;3;-1)$ và $N(3;5;1)$?
	\choice
	{\True $\overrightarrow{u}_4=(1;1;1)$}
	{$\overrightarrow{u}_1=(1;1;-1)$}
	{$\overrightarrow{u}_2=(4;8;0)$}
	{$\overrightarrow{u}_3=(2;4;0)$}
	\loigiai{Ta có $\overrightarrow{MN}=(2;2;2)$; ta thấy $\overrightarrow{u}_4=\dfrac{1}{2}\overrightarrow{MN}$ nên $\overrightarrow{u}_4$ là một vectơ chỉ phương của đường thẳng $MN$.
	}
\end{ex}
...
\begin{ex}%[Đề thi thử tốt nghiệp THPT Quốc Gia năm 2023 - Trường THCS-THPT Hồng Đức - Thành phố Hồ Chí Minh]%[Ninh Tiến Nam - 2EX623]%[1H3B3-3]
	\immini[thm]{Cho hình chóp $S.ABCD$  có đáy $ABCD$ là hình thoi cạnh $a$, $SA$ vuông
...
\end{tikzpicture}}
	\loigiai{
	\immini[thm]{	Gọi $O$ là giao điểm của $AC$ và $BD$.\\	Ta có $AC=2AO=2\sqrt{AB^2-OB^2}=2\sqrt{a^2-\left( \dfrac{a\sqrt{3}}{2}\right)^2 }=a$.\\
...
Cắt mặt cầu tâm $I$ bởi mặt phẳng qua $I$, 	thiết diện thu được là hình tròn có diện tích bằng $9\pi$. Thể tích khối cầu đã cho bằng
	...
	{$18\pi$}
	{$27\pi$}
	\loigiai{\immini[thm]{Cắt mặt cầu tâm $I$ bởi mặt phẳng qua $I$, ta được hình tròn lớn bán kính $R$ bằng bán kính mặt cầu.\\
...
\immini[thm]{Cho hình lăng trụ đứng $ABCD.A'B'C'D'$ có đáy là hình chữ nhật cạnh	$BC=a$, $BD=2BC$ và  $AA'=2\sqrt{3}a$. Diện tích toàn phần của  hình lăng trụ đã cho bằng
	\choice
	{$16a^2\sqrt{3}$}
...
\immini[thm]{Diện tích S của phần gạch sọc trong hình được tính bằng
	\choice
...
\begin{ex}%[Đề thi thử tốt nghiệp THPT Quốc Gia năm 2023 - Trường THCS-THPT Hồng Đức - Thành phố Hồ Chí Minh]%[Ninh Tiến Nam - 2EX623]%[2H3B2-7]
	...
	{$2x-y+z=0$}
	{$2x+3y+z+3=0$}
	\loigiai{Mặt phẳng $(P)$ song song với mặt phẳng $(Q)\colon 2x+3y+z-9=0$ nên có vectơ pháp tuyến là $(2;3;1)$.\\
...
Cho hình trụ có chiều cao bằng $2\sqrt{5}$. Cắt hình trụ đã cho bởi mặt phẳng song song với trục, cách trục một khoảng $\sqrt{5}$, thiết diện thu được là hình vuông. Diện tích xung quanh hình trụ đã cho bằng	
	...
	{$10\pi\sqrt{5}$}
	{\True $20\pi\sqrt{2}$}
	\loigiai{\immini[thm]{Giả sử $OO'$ là trục của hình trụ.\\
...
\immini[thm]{	Cho hình chóp $S.ABCD$  có đáy là hình thang cạnh
...
\end{tikzpicture}	}
	\loigiai{\immini[thm]{Gọi $M$ là trung điểm của $AB$, hình thang $AMCD$ ($AM\parallel CD$) có $AM=CD$ nên là hình bình hành, suy ra $MC=AD=a=\dfrac{1}{2}AB$. Do đó, tam giác $ACB$ vuông tại $C$.\\
...
\begin{ex}%[Đề thi thử tốt nghiệp THPT Quốc Gia năm 2023 - Trường THCS-THPT Hồng Đức - Thành phố Hồ Chí Minh]%[Ninh Tiến Nam - 2EX623]%[2D1K1-2]
	\immini[thm]{Cho hàm số $f(x)$ có đồ thị $f'(x)$ như hình bên. Hàm số $g(x)=f(2-x)-\dfrac{1}{2}x^2+x$ nghịch biến trên khoảng nào dưới đây?
	\choice
	{$(-3;1)$}
 {	\True$(1;3)$}
	{$(0;1)$}
...
\immini[thm]{	Cho hàm số bậc  bốn $y=f(x)$ có đồ thị như hình vẽ. Số điểm cực trị của hàm số $g(x)=f\left(x^3-3x^2 \right) $ là
	\choice
	{$5$}
	{$9$}
	{\True $7$}
