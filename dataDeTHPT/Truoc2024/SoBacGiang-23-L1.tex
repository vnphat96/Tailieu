...
\loigiai
{Mặt phẳng $(P)\colon x-y+z+1=0$ có một vectơ pháp tuyến là $\overrightarrow{n}_2=(1;-1;1)$.
}
\end{ex}
...
Trong không gian $Oxyz$, góc giữa hai mặt phẳng $(O x z)$ và $(O y z)$ bằng
\choice
{\True $90^{\circ}$}
{$60^{\circ}$}
{$30^{\circ}$}
...
Trong không gian $Oxyz$, cho tam giác $ABC$ có $A(- 1; 3; 2) , B(2; 0; 5), C(0; -2;1)$. Viết PTĐT $d$ chứa đường trung tuyến kẻ từ đỉnh $A$ của tam giác $ABC$.
\choice
...
Đường trung tuyến $AM$ qua $A$ có vectơ chỉ phương $\overrightarrow{AM}$ có phương trình là $d\colon\dfrac{x+1}{2}=\dfrac{y-3}{-4}=\dfrac{z-2}{1}$.
}
\end{ex}
...
\loigiai
{Ta có 
$d$ qua $M(0;- 1; 2)$ và có vectơ chỉ phương $\overrightarrow{u}=(1; - 2; - 2)$.\\
Mặt phẳng $(P)$ có vectơ pháp tuyến $\overrightarrow{n}=[\overrightarrow{AM},\overrightarrow{u}]=(2;- 1; 2)$.\\
...
Trong không gian $Oxyz$, cho mặt phẳng $(P)\colon x - 2y + 2z = 0$ và ba điểm
...
{\True $\sqrt{13}$}
\loigiai
{\immini[thm]{Gọi $H$ là hình chiếu của $C$ lên mặt phẳng $(P)$. \\
Một vectơ chỉ phương của $CH$ là $\overrightarrow{CH}=\overrightarrow{n}_{P}=(1;-2;2)$. \\
