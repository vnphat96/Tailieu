...
\immini[thm]{Hàm số nào sau đây có đồ thị như hình vẽ ở bên?
\choice
{$y=\dfrac{x+2}{x}$}
{$y=\dfrac{2 x+1}{x-2}$}
...
Trong không gian $Oxyz$, cho hai mặt phẳng $(P) \colon x-2 y+z-3=0$ và $(Q) \colon x+y-1=0$. Giao tuyến của $(P)$ và $(Q)$ có một vectơ chỉ phương là
\choice
...
\loigiai{
\begin{itemize}
\item Mặt phẳng $(P)$ có một vectơ pháp tuyến là $\overrightarrow{n}_{P}=(1;-2;1)$.
\item Mặt phẳng $(Q)$ có một vectơ pháp tuyến là $\overrightarrow{n}_{Q}=(1;1;0)$.
\end{itemize}
Do đó, giao tuyến của $(P)$ và $(Q)$ có một vectơ chỉ phương là $\overrightarrow{u}=\left[\overrightarrow{n}_{Q}; \overrightarrow{n}_{P}\right]=(1;-1;-3)$.
}
\end{ex}
...
Trong không gian $Oxyz$, một vectơ pháp tuyến mặt phẳng $(Oxz)$ có tọa độ là
\choice
{$(0; 1; 1)$}
{$(1; 0; 1)$}
{\True $(0; 1; 0)$}
{$(1; 0; 0)$}
\loigiai{Một vectơ pháp tuyến của mặt phẳng $(Oxz)$ là $\overrightarrow{j}=(0; 1; 0)$.}
\end{ex}
...
\begin{ex}%[Đề thi thử Tốt Nghiệp, Liên trường Lê Thánh Tông - Nguyễn Khuyến, HCM, 2023]%[12-EX-6-2023, Trần Quốc]%[2D3B3-1]
\immini[thm]{Cho hàm số $y=f(x)$ có đồ thị như hình vẽ. Diện tích của hình phẳng gạch chéo trong hình được tính bởi công thức nào?
\choice
...
Trong không gian $Oxyz$, đường thẳng $\Delta$ đi qua điểm $M(1; 0;-2)$ và vuông góc với mặt phẳng $(Q) \colon 4x+y-3z+2023=0$ có PTTS là
\def\dotEX{}
\choice
...
\loigiai{Vì đường thẳng $\Delta$ vuông góc với mặt phẳng $(Q)$ nên có một vectơ chỉ phương là $\overrightarrow{u}_{\Delta}=\overrightarrow{n}_{P}=(4;1;-3)$.\\
...
\immini[thm]{Cho hàm số $y=f(x)$ xác định và liên tục trên $\mathbb{R}$ có đồ thị hàm số $y=f'(x)$ như hình vẽ bên. Hàm số $y=f(x+2)$ nghịch biến trên khoảng nào sau đây?
\choice
{$(-\infty;-4)$}
{$(-2; 0)$}
{\True $(-4;-2)$}
...
\immini[thm]{Cho hàm số $y=f(x)$ có đồ thị như hình dưới bên. Số nghiệm thực của phương trình
$\dfrac{3-f(x)}{1+f(x)}=5 $.
\choice
{$3$}
{$5$}
...
\end{tikzpicture}}
\loigiai{
\immini[thm]{Ta có $\dfrac{3-f(x)}{1+f(x)}=5 \Leftrightarrow \dfrac{-2-6f(x)}{1+f(x)}=0 \Leftrightarrow f(x)=-\dfrac{1}{3}$.\\
...
Trong không gian $Oxyz$, phương trình mặt cầu $(S)$ có tâm $I(1; 9;-3)$ tiếp xúc với trục $Ox$ là
\choice
...
\immini[thm]{Cho hàm số $y=g(x)$ có đồ thị như hình bên. Gọi $M$, $m$ lần lượt là giá trị lớn nhất và nhỏ nhất của hàm số $y=g\left(\sqrt{1+8 \sin^2 x}-2\right)$. Khi đó
\choice
{$M-m=2$}
{$M-m=1$}
{$M-m=6$}
...
\immini[thm]{Cho hàm số $y=f(x)=ax^3+bx+c$ có đồ thị như hình vẽ bên. Số điểm cực trị của hàm số $y=f\left(|x|\right)+2023$ là
\choice
{$2$}
{\True $3$}
{$7$}
...
\end{tikzpicture}}
\loigiai{
\immini[thm]{Số điểm cực trị của hàm số $y=f\left(|x|\right)+2023$ cũng là số điểm cực trị của hàm số $y=f\left(|x|\right)$.\\
...
{\True $V=36 \pi$}
{$V=44 \pi$}
\loigiai{\immini[thm]{Gọi $O$, $O'$ lần lượt là tâm hai đáy, $ABB'A'$ thiết diện hình vuông có cạnh bằng $a$ và $M$ là trung điểm $AB$ (như hình vẽ).\\
...
{$\dfrac{2 \sqrt{3}}{5}$}
\loigiai{
\immini[thm]{Gọi cạnh hình vuông $ABCD$ là $a$ và $H$ là trung điểm của $AB$.\\
...
\immini[thm]{Cho hàm số $y=f(x)$ liên tục trên $\mathbb{R}$ và có đồ thị như hình vẽ bên. Tổng tất cả các giá trị nguyên của tham số $m$ để phương trình $3f\left(2\log_{5}x\right)+6=m$ có đúng $3$ nghiệm thực thuộc nửa đoạn $\left(\dfrac{1}{25};25\right]$ bằng
\choice
{$69$}
{$57$}
{$60$}
...
Trong không gian $Oxyz$, gọi $d'$ là hình chiếu vuông góc của $d\colon \heva{&x=-1+2at \\ &y=3-2t \\ &z=\left(a^2-2\right)t}$, $\left(t\in \mathbb{R}\right)$ lên mặt phẳng $(\alpha) \colon 2x-3z-6=0$. Lấy các điểm $M(0;-3;-2)$, $N(3;-1; 0)$ thuộc $(\alpha)$. Tính tổng tất cả các giá trị của tham số $a$ để $MN \perp d'$.
\choice
{\True $-4$}
{$-3$}
{$1$}
{$2$}
\loigiai{
Ta có $\overrightarrow{MN}=(3;2;2)$ và đường thẳng $d$ có một vectơ chỉ phương là $\overrightarrow{u}_{d}=\left(2a; -2; a^2-2\right)$.\\
...
{$\dfrac{a \sqrt{6}}{2}$}
\loigiai{
\immini[thm]{Gọi $E$ là trung điểm cạnh $AB$.\\
...
Trong không gian $Oxyz$, cho khối đa diện $OAMEN$ có thể tích $296$ với các đỉnh $A\left(0; 0; 8\sqrt{2}\right)$, $M(5; 0; 0)$, $N(0; 7; 0)$, $E(a; b; 0)$, trong đó $a$, $b$ là các số thực dương. Khi $a$, $b$ thay đổi thì đường thẳng $AE$ tiếp xúc với mặt cầu $(S) \colon x^2+y^2+z^2=c^2$. Mặt cầu $(S)$ có bán kính nhỏ nhất bằng
\choice
...
\loigiai{
\immini[thm]{Ta có bốn điểm $O$, $M$, $N$ và $E$ cùng thuộc mặt phẳng $(Oxy)$.\\
