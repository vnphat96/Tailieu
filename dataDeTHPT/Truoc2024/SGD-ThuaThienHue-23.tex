...
\begin{ex}%[Thi thử tốt nghiệp - SGD Thừa Thiên Huế - 23]%[Phạm Phương - EX6 - 23]%[2H3Y1-1]
	Trong không gian $Oxyz$, cho điểm $A(1;-3;2)$ và $B(2;1;1)$. Hãy xác định toạ độ vectơ $\overrightarrow{AB}$.
	\choice
...
\end{ex}
\begin{ex}%[Thi thử tốt nghiệp - SGD Thừa Thiên Huế - 23]%[Phạm Phương - EX6 - 23]%[2H3Y1-1]
	Trong không gian $Oxyz$, cho vectơ $\overrightarrow{OA}=-\vec{i}+\vec{j}+2\vec{k}$. Xác định toạ độ điểm $A$.
	\choice
	{\True $(-1;1;2)$}
	{$(-1;1;-2)$}
	{$(1;-1;2)$}
...
Trong không gian $Oxyz$, cho mặt phẳng $(P)\colon 2x-y-z-4=0$. Hãy xác định giao điểm của mặt phẳng $(P)$ và trục $Oz$.
\choice
{\True $M(0;0;-4)$}
{$M(0;0;4)$}
{$M(2;0;0)$}
...
\begin{ex}%[Thi thử tốt nghiệp - SGD Thừa Thiên Huế - 23]%[Phạm Phương - EX6 - 23]%[2H3Y2-2]
	Trong không gian $Oxyz$, hãy xác định toạ độ một vectơ pháp tuyến của mặt phẳng $(P)$ có phương trình $3x-y-z+2=0$.
	\choice
	{$\vec{n}=(-1;-1;2)$}
	{\True $\vec{n}=(3;-1;-1)$}
	{$\vec{n}=(3;1;1)$}
	{$\vec{n}=(3;-1;2)$}
	\loigiai{
	Mặt phẳng $(P)\colon Ax+By+Cz+D=0$ có một vectơ pháp tuyến là $\vec{n}=(A;B;C)$.\\
...
\begin{ex}%[Thi thử tốt nghiệp - SGD Thừa Thiên Huế - 23]%[Phạm Phương - EX6 - 23]%[2H3B2-4]
	Trong không gian $Oxyz$, cho mặt phẳng $(P)\colon 2x-z+1=0$. Điểm nào trong các điểm sau thuộc mặt phẳng $(P)$?
	\choice
	{\True $M(1;7;3)$}
	{$M(0;-3;0)$}
	{$M(0;3;2)$}
...
\begin{ex}%[Thi thử tốt nghiệp - SGD Thừa Thiên Huế - 23]%[Phạm Phương - EX6 - 23]%[2H3B2-3]
	Trong không gian $Oxyz$, cho điểm $A(-2;0;6)$. Hãy xác định phương trình mặt phẳng trung trực của đoạn thẳng $OA$.
	\choice
	{$x-3y+1=0$}
	{$x-3y-1=0$}
	{$x-3z+20=0$}
	...
	Mặt phẳng trung trực của đoạn thẳng $OA$ đi qua điểm $M(-1;0;3)$ và vuông góc với $OA$ nên nhận $\overrightarrow{OA}=(-2;0;6)=-2(1;0;-3)$ làm vectơ pháp tuyến, do đó có phương trình là $$1(x+1)+0(y-0)-3(z-3)=0 \Leftrightarrow x-3z+10=0.$$
	}
\end{ex}
\begin{ex}%[Thi thử tốt nghiệp - SGD Thừa Thiên Huế - 23]%[Phạm Phương - EX6 - 23]%[2H3B2-7]
	Trong không gian $Oxyz$, cho mặt phẳng $(\alpha)\colon x-y+2z-7=0$. Hãy xác định mặt phẳng vuông góc với mặt phẳng $(\alpha)$ trong các mặt phẳng có phương trình sau
	\choice
	{$x+y-2z+7=0$}
	{$x-y-2z+7=0$}
	{\True $x+y+7=0$}
	{$x-y+7=0$}
	\loigiai{
		Mặt phẳng $(\alpha)$ có một vectơ pháp tuyến là $\overrightarrow{n}_{\alpha}=(1;-1;2)$.\\
		Xét mặt phẳng $x+y+7=0$ có vectơ pháp tuyến $\overrightarrow{n}_P=(1;1;0) \Rightarrow \overrightarrow{n}_P \cdot \overrightarrow{n}_{\alpha}=1\cdot 1+1\cdot (-1)+0\cdot 2=0$ nên suy ra $(P) \perp(\alpha)$. 
	}
\end{ex}
