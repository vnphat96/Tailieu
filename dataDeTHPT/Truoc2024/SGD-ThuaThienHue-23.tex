...
\begin{ex}%[Thi thử tốt nghiệp - SGD Thừa Thiên Huế - 23]%[Phạm Phương - EX6 - 23]%[2H3Y1-1]
	Trong KG $Oxyz$, cho điểm $A(1;-3;2)$ và $B(2;1;1)$. Hãy xác định toạ độ vectơ $\overrightarrow{AB}$.
	\choice
...
\end{ex}
\begin{ex}%[Thi thử tốt nghiệp - SGD Thừa Thiên Huế - 23]%[Phạm Phương - EX6 - 23]%[2H3Y1-1]
	Trong KG $Oxyz$, cho vectơ $\overrightarrow{OA}=-\vec{i}+\vec{j}+2\vec{k}$. Xác định toạ độ điểm $A$.
	\choice
	{\True $(-1;1;2)$}
	{$(-1;1;-2)$}
	{$(1;-1;2)$}
...
\begin{ex}%[Thi thử tốt nghiệp - SGD Thừa Thiên Huế - 23]%[Phạm Phương - EX6 - 23]%[2H3Y2-2]
	Trong KG $Oxyz$, hãy xác định toạ độ một vectơ pháp tuyến của mặt phẳng $(P)$ có phương trình $3x-y-z+2=0$.
	\choice
	{$\vec{n}=(-1;-1;2)$}
	{\True $\vec{n}=(3;-1;-1)$}
	{$\vec{n}=(3;1;1)$}
