...
%%==========Câu 2
\begin{ex}%[2H3Y1-3]
Trong không gian $Oxyz$, cho mặt cầu $(S)$ có tâm là gốc tọa độ $O$ và đi qua điểm $A(1; 2;-2)$. Bán kính của mặt cầu $(S)$ bằng
\choice
{$2$}
{\True $3$}
{$9$}
...
%%==========Câu 4
\begin{ex}%[2H3Y2-2]
Trong không gian $Oxyz$, cho mặt phẳng $(\alpha)\colon 2x-y-z+3=0$. Vectơ nào sau đây không là một vectơ pháp tuyến của $(\alpha)$?
\choice
...
\loigiai{
	Vectơ không là một vectơ pháp tuyến của $(\alpha)$ là $\overrightarrow{n}_{3}=(6;-2;-3)$.
}
\end{ex}
...
%%==========Câu 18
\begin{ex}%[2H3Y3-1]
	Trong không gian $Oxyz$, cho đường thẳng $d \colon \heva{&x=1+2t\\&y=2-t\\&z=3+t}$. Một vectơ chỉ phương của $d$ có tọa độ là
	\choice
	{$(2;1;1)$}
	{\True$(2;-1;1)$}
	{$(1;2;3)$}
	{$(2;0;0)$}
	\loigiai{
		Đường thẳng $d$ có một vectơ chỉ phương là $\vec{u}_{d}=(2;-1;1)$.
	}
\end{ex}
...
%%==========Câu 23
\begin{ex}%[2H3B3-2]
	Trong không gian $Oxyz$, đường thẳng đi qua  $M\left(1;2;-1\right)$ đồng thời vuông góc mặt phẳng $2x+3y+4z+1=0$ có phương trình là
	\choice
...
%%==========Câu 25
\begin{ex}%[2H3B1-2]
	Trong không gian $Oxyz$, cho vec-tơ $\vec{u}=\left(1;1;-2\right), \vec{v}=\left(1;0;2+\sqrt{6}\right)$. Góc giữa hai vec-tơ đã cho bằng
	\choice
	{$45^\circ$}
	{$120^\circ$}
	{\True $135^\circ$}
...
%%==========Câu 29
\begin{ex}%[2D1B2-2]
	\immini[thm]{Cho hàm số $y=ax^4+bx^2+cx+d,\,\, \left(a,b,c,d\in \mathbb{R}\right)$. Hàm số $y=f'(x)$ có đồ thị như hình vẽ. Số điểm cực trị của hàm số $f(x)$ là
		\choice
		{$4$}
		{$2$}
		{\True $3$}
...
%%==========Câu 36
\begin{ex}%[2H3B2-3]
	Trong không gian $Oxyz$, cho hai đường thẳng $d_1\colon\heva{&x=2-t\\&y=3\\&z=-1+t}$ và $d_2\colon\heva{&x=3+t\\&y=2-t\\&z=-1}$. Mặt phẳng chứa hai đường $d_1, d_2$ có phương trình là
	\choice
	{\True$x+y+z-4=0$}
	{$x-y-z+2=0$}
	{$x+y+z+4=0$}
...
%%==========Câu 39
\begin{ex}%[2D1K3-2]
	\immini[thm]{Cho hàm số $f(x)$ bậc bốn có đồ thị như hình vẽ bên.
...
\begin{ex}%[Dự án text đề Vted 2023]%[Huỳnh Xuân Tín]%[2D1G2-2]
	\immini[thm]{Cho hàm số $ y=f(x) $ có đạo hàm và liên tục trên $ \mathbb{R} $ và $ f(0)=0 $. Biết hàm số $ y=f'(x) $ có đồ thị như hình vẽ. 
