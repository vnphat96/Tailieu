...
%%==========Câu 4
\begin{ex}%[2H3Y2-2]
Trong KG $Oxyz$, cho mặt phẳng $(\alpha)\colon 2x-y-z+3=0$. Vectơ nào sau đây không là một vectơ pháp tuyến của $(\alpha)$?
\choice
...
%%==========Câu 18
\begin{ex}%[2H3Y3-1]
	Trong KG $Oxyz$, cho đường thẳng $d \colon \heva{&x=1+2t\\&y=2-t\\&z=3+t}$. Một vectơ chỉ phương của $d$ có tọa độ là
	\choice
	{$(2;1;1)$}
	{\True$(2;-1;1)$}
	{$(1;2;3)$}
