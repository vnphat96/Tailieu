...
\begin{ex}%[Thi thử tốt nghiệp - Liên trường THPT Nghệ An - 23]%[Huỳnh Xuân Tín - EX6]%[2D1Y5-1]
	\immini[thm]{Đường cong trong hình dưới đây là đồ thị của hàm số nào trong các hàm số sau?	\choice
		{$y=x^3-3x+4$}
		{\True $y=-x^3-3x^2+4$}
		{$y=x^4+2x^2$}
		{ $y=\dfrac{2x+1}{x+1}$}}{
...
\begin{ex}%[Thi thử tốt nghiệp - Liên trường THPT Nghệ An - 23]%[Huỳnh Xuân Tín - EX6]%[2H3Y2-2]
	Trong không gian $O x y z$, mặt phẳng $(P)\colon 3 x+2 y-z+1=0$ có một vectơ pháp tuyến là
	\choice
	...
	\loigiai{
		Mặt phẳng $(P)\colon 3 x+2 y-z+1=0$ có một vectơ pháp tuyến là	 $\overrightarrow{n}_2=(3;2;-1)$.			
	}
\end{ex}
...
\begin{ex}%[Thi thử tốt nghiệp - Liên trường THPT Nghệ An - 23]%[Huỳnh Xuân Tín - EX6]%[2H3Y1-1]
	Trong không gian $Oxyz$, cho hai điểm $A(1 ; 2 ; 3)$, $B(7 ; 0 ; 5)$. Toạ độ của vectơ $\overrightarrow{A B}$ là	
	\choice
	{\True $(6;-2;2)$}
	{$(4;1;4)$}
	{$(8;2;8)$}
...
\begin{ex}%[Thi thử tốt nghiệp - Liên trường THPT Nghệ An - 23]%[Huỳnh Xuân Tín - EX6]%[2H3Y3-2]
	...
	\loigiai{
		...
		PTTS của đường thẳng $M N$ đi qua $M(1;-2;-3)$ và có vectơ chỉ phương là $(2;3;2)$ là	$\heva{&x=1+2t\\&y=-2+3t\\&z=-3+2t}$	hay $\heva{&x=3+2t\\&y=1+3t\\&z=-1+2t.}$
	}
\end{ex}
...
\begin{ex}%[Thi thử tốt nghiệp - Liên trường THPT Nghệ An - 23]%[Huỳnh Xuân Tín - EX6]%[2H1B3-2]
	\immini[thm]{Cho khối chóp $S.ABC$ có đáy là tam giác vuông tại $A$, $A B=2$, $B C=\sqrt{13}$, $S A$ vuông góc với đáy và $S A=6$ (tham khảo hình vẽ bên). Thể tích khối chóp đã cho bằng 	\choice
		{$4$}
		{$12$}
		{\True $6$}
		{$18$}}{
...
\begin{ex}%[Thi thử tốt nghiệp - Liên trường THPT Nghệ An - 23]%[Huỳnh Xuân Tín - EX6]%[2D2B5-1]
	...
	{ $4$}
	\loigiai{
		Ta có $$\log _2\left(\mathrm{e}^{2 x}-5 \mathrm{e}^x+6\right)=1\Leftrightarrow \mathrm{e}^{2 x}-5 \mathrm{e}^x+6=2\Leftrightarrow\mathrm{e}^{2 x}-5 \mathrm{e}^x+4=0\Leftrightarrow \hoac{&\mathrm{e}^x=4\\&\mathrm{e}^x=1}\Leftrightarrow \hoac{&x=\ln 4\\&x=0.}$$		
...
\begin{ex}%[Thi thử tốt nghiệp - Liên trường THPT Nghệ An - 23]%[Huỳnh Xuân Tín - EX6]%[2D1B5-3]
	\immini[thm]{Cho hàm số bậc ba $y=f(x)$ có đồ thị là đường cong trong hình vẽ. Số giá trị nguyên của tham số $m$ để phương trình $f(x)=m$ có đúng $3$ nghiệm dương phân biệt là \choice
		{$4$}
		{\True $1$}
		{$2$}
		{$3$}}{
...
\begin{ex}%[Thi thử tốt nghiệp - Liên trường THPT Nghệ An - 23]%[Huỳnh Xuân Tín - EX6]%[1H3K5-3]
	\immini[thm]{Cho hình lăng trụ đứng $ABC.A'B'C'$ có chiều cao bằng $a \sqrt{3}$, có đáy $ABC$ là tam giác vuông tại $A$ và $AB=a$, $AC=2a$ (tham khảo hình vẽ). Khoảng cách từ $B$ đến mặt phẳng $\left(AB'C'\right)$ bằng
		\choice
		{$\dfrac{\sqrt{57}}{19} a$}
	...
	\end{tikzpicture}}	
	\loigiai{
		\immini[thm]{ Kẻ $A'H\perp B'C'$ (trong $(A'B'C')$). Suy ra $B'C'\perp (A'A'H)$\\
...
\begin{ex}%[Thi thử tốt nghiệp - Liên trường THPT Nghệ An - 23]%[Huỳnh Xuân Tín - EX6]%[1H3K4-3]
	\immini[thm]{ Cho hình chóp $S.A B C$ có đáy là tam giác vuông cân tại $A$, $S A$ vuông góc với đáy và $S A=\sqrt{\dfrac{3}{2}} \cdot A B$. Góc giữa hai mặt phẳng $(S B C)$ và $(A B C)$ bằng 	\choice
		{$45^\circ$}
		{\True$60^\circ$}
		{$30^\circ$}
	...
	\end{tikzpicture}}	
	\loigiai{
		\immini[thm]{ Gọi $I$ là trung điểm $BC$.\\
...
\begin{ex}%[Thi thử tốt nghiệp - Liên trường THPT Nghệ An - 23]%[Huỳnh Xuân Tín - EX6]%[2H2K1-4]
	\immini[thm]{Người ta sản xuất thùng phuy sắt có hình dạng là một hình trụ (có nắp đậy kín) bằng cách cán và gò các tấm thép có độ dày $1 \mathrm{~mm}$, biết chiều cao của thùng phuy là $876 \mathrm{~mm}$, đường kính ngoài của thùng phuy là $580 \mathrm{~mm}$ và khối lượng riêng của thép là $7850 \mathrm{~kg} / \mathrm{m}^3$. Hỏi mỗi thùng phuy nặng khoảng bao nhiêu $\mathrm{kg}$ (tính gần đúng sau dấu phẩy đến 2 chữ số thập phân)? \choice
		{$15{,}57$ kg}
		{$18{,}23$ kg}
		{\True $16{,}63$ kg}
		{$17{,}21$ kg}}{
	...
	\end{tikzpicture}}		
	\loigiai{
		\immini[thm]{Bán kính ngoài của thùng phuy là $R_1=\dfrac{580}{2}=290$ mm $=0{,}29$ m.	\\	
...
\begin{ex}%[Thi thử tốt nghiệp - Liên trường THPT Nghệ An - 23]%[Huỳnh Xuân Tín - EX6]%[2H1K3-2]
	...
	{$\dfrac{a^3 \sqrt{3}}{8}$}
	\loigiai{
		\immini[thm]{Đặt $AA'=x$. Gọi $H$ là trung điểm của $A'B'$. Suy ra $C'H\perp A'B'$.\\
...
\begin{ex}%[Thi thử tốt nghiệp - Liên trường THPT Nghệ An - 23]%[Huỳnh Xuân Tín - EX6]%[2D3G3-3]
	\immini[thm]{Cho hàm số $y=f(x)$ có đạo hàm cấp hai liên tục trên $\mathbb{R}$, biết rằng $f(0)=0$ và hàm số $g(x)=\dfrac{1}{16}\left[x f''(x)+f'(x)\right]$ là hàm số bậc ba có đồ thị như hình vẽ. Thể tích khối tròn xoay sinh bởi hình phẳng giới hạn bởi các đồ thị hàm số $y=f(x)$, $y=\dfrac{f^{\prime \prime}(x)-40}{12}$ khi quay quanh trục $O x$ có giá trị nằm trong khoảng nào sau đây? 	\choice
		{$(116;117)$}
		{\True $(117;118)$}
		{$(118;119)$}
		{$(115;116)$}}{
...
\begin{ex}%[Thi thử tốt nghiệp - Liên trường THPT Nghệ An - 23]%[Huỳnh Xuân Tín - EX6]%[2H3G3-8]
	...
	{$8-4 \sqrt{3}$}
	\loigiai{
		\immini[thm]{Gọi $H$ là hình chiếu vuông góc của $O$ lên $(P)$. Suy ra đường thẳng $OH$ là $\heva{&x=t\\&y=t\\&z=2t.}$\\
...
\begin{ex}%[Thi thử tốt nghiệp - Liên trường THPT Nghệ An - 23]%[Huỳnh Xuân Tín - EX6]%[2D1G5-5]
	...
	{$15$}
	\loigiai{
		\immini[thm]{Từ $f'(x)=(x-a)(x-b)$ với $a$, $b$ là hai hằng số và $a<b$, $f(b)=0$ ta suy ra đồ thị $y=f(x)$ có dạng như hình bên.\\
...
\begin{ex}%[Thi thử tốt nghiệp - Liên trường THPT Nghệ An - 23]%[Huỳnh Xuân Tín - EX6]%[2H3G3-7]
	...
	{$6$}
	\loigiai{
		$(\alpha)\colon x+y-z+1=0$ có vectơ pháp tuyến là $\overrightarrow{n}_1=(1;1;-1)$; $(\beta)\colon x+y-2 z-1=0$ có vectơ pháp tuyến là $\overrightarrow{n}_2=(1;1;-2)$.\\
		Vì  $d$ là giao tuyến của hai mặt phẳng $(\alpha)$ và $(\beta)$ nên $d$ có vectơ chỉ phương là $\overrightarrow{v}=\left[\overrightarrow{n}_1,\overrightarrow{n}_2\right]=(-1;1-0)$ và $d$ đi qua điểm $A(0;y;z)$, với $y$; $z$ là nghiệm của $\heva{&y-z+1=0\\&y-2z-1=0}\Leftrightarrow \heva{&y=-3\\&z=-2}\Rightarrow A(0;-3;-2)$\\
...
\begin{ex}%[Thi thử tốt nghiệp - Liên trường THPT Nghệ An - 23]%[Huỳnh Xuân Tín - EX6]%[2D4G5-1]
	...
	\loigiai{Gọi $z=x+yi$, với $x,y\in \mathbb{R}$ có điểm biểu diễn trên mặt phẳng phức là $M(x;y)$.
		...
		\end{eqnarray*}				
		\immini[thm]{Suy ra tập hợp điểm $N$ là đường tròn tâm $I(-2;0)$ với bán kính $R=\sqrt{18}$.Ta có $IA=\sqrt{3^2+1}=\sqrt{10}$; $|z-u|=\left|\overrightarrow{MN}\right|$.\\
...
\begin{ex}%[Thi thử tốt nghiệp - Liên trường THPT Nghệ An - 23]%[Huỳnh Xuân Tín - EX6]%[2D3G2-3]
	...
	\loigiai{
		...
		\begin{itemize}
			...
			Khi đó $K=\dfrac{x^2}{2}\cdot \ln x\Bigg|_1^2-\displaystyle\int\limits_1^2\dfrac{x}{2}\mathrm{d} x=2\ln 2-\dfrac{x^2}{4}\Bigg|_1^2=2\ln 2-(1-\dfrac{1}{4})=2\ln 2-\dfrac{3}{4}$.
		\end{itemize}	
		Vậy $I=-\dfrac{1}{6}+2\ln 2-\dfrac{3}{4}=2\ln 2-\dfrac{11}{12}=-\dfrac{11}{12}+\ln 4$.\\
