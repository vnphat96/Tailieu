...
\immini[thm]{Cho khối chóp $S.ABC$ có đáy là tam giác vuông cân tại $A$, $AB=2$, $SA$ vuông góc với đáy và $SA=3$. Thể tích khối chóp đã cho bằng
\choice
{$12$}
{\True $2$}
{$6$}
...
Trong không gian $Oxyz$, cho mặt cầu $(S)\colon x^2+y^2+z^2-2x+2y-4z-2=0$. Tính bán kính $r$ của mặt cầu.
\choice
{\True $r=2\sqrt{2}$}
{$r=\sqrt{26}$}
{$r=4$}
...
Trong không gian $Oxyz$, mặt phẳng $(P)\colon x-2z+3=0$ có một vectơ pháp tuyến là 
\choice
...
\loigiai{
Mặt phẳng $(P)\colon x-2z+3=0$ có một vectơ pháp tuyến là $\overrightarrow{n}_{1}=(1;0;-2)$.}
\end{ex}
...
{$5$}
{\True $3$}
{$4$}}{\begin{tikzpicture}[>=stealth,line join=round,line cap=round,font=\footnotesize,scale=0.7]
...
\begin{ex}%[Lương Như Quỳnh]%[12-EX-6-2023]%[2D4Y1-2]
		\immini[thm]{ Trong hình vẽ bên, điểm $M$ biểu diễn cho số phức $z$. Số phức $\overline{z}$ là 
\choice
{$1-2i$}
{$2+i$}
{$1+2i$}
{\True $2-i$}}{\begin{tikzpicture}[>=stealth,line join=round,line cap=round,font=\footnotesize,scale=0.6]
...
Trong không gian $Oxyz$, cho điểm $A(0;1;2)$ và đường thẳng $d\colon \dfrac{x-4}{2}=\dfrac{y-2}{-1}=\dfrac{z-1}{-2}$. Gọi $(P)$ là mặt phẳng chứa $d$ và cách $A$ một khoảng lớn nhất. Khoảng cách từ điểm $M(5;-1;3)$ đến $(P)$ bằng
\choice
{\True $ \dfrac{2}{3} $}
{$ \dfrac{7}{3}$}
{$ \dfrac{1}{3}$}
...
Do đó $\mathrm{d}(A,(P))_{\max }=A I \Leftrightarrow(P)$ chứa đường thẳng $d$ và nhận $\overrightarrow{A I}$ là vectơ pháp tuyến.\\
%Tìm $I$: 
...
\immini[thm]{Cho một cổ vật hình trụ có chiều cao đo được là $81$ cm, do bị hư hại nên khi tiến hành đo đạc lại thu được $A B=50$ cm, $B C=70$ cm, $C A=80$ cm, với $A$, $B$, $C$ thuộc đường tròn nắp trên như hình vẽ. Thể tích khối cổ vật ban đầu gần nhất với số nào sau đây?
\choice
{$6{,}56$ m$^3$}
{\True $0{,}42$ m$^3$}
{$1{,}03$ m$^3$}
...
Trong không gian $Oxyz$, cho hai điểm $A(0;0;10)$ và $B\left(3;4;\dfrac{19}{2}\right)$. Xét các điểm $M$ thay đổi sao cho tam giác $OAM$ không phải là tam giác nhọn và có diện tích bằng $20$. Giá trị nhỏ nhất của độ dài đoạn thẳng $MB$ thuộc khoảng nào dưới đây?
\choice
{$(5;10)$}
{$(3;5)$}
