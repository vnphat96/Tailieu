...
Trong không gian $Oxyz$, điểm nào sau đây {\bf không} thuộc $(Oxy)$?
\choice
{$Q(1; 1; 0)$}
{$M(1; 0; 0)$}
{$P(0; 1; 0)$}
...
\immini[thm]{Đường cong ở hình bên là đồ thị của một trong bốn hàm số dưới đây. Hàm số đó là
\choice
{$y=x^3+2 x^2+2$}
{$y=-x^3+x^2+2$}
{$y=x^4-2 x^2+2$}
...
Trong không gian $Oxyz$, cho đường thẳng $\Delta\colon \dfrac{x-1}{3}=\dfrac{y-2}{2}=\dfrac{z-3}{1}$. Phương trình nào sau đây là PTTS của $\Delta$
\choice
{\True $\heva{&x=1+3t\\&y=2+2t\\&z=3+t}$}
{$\heva{&x=-1+3t\\&y=2+2t\\&z=-3+t}$}
{$\heva{&x=3+t\\&y=2+2t\\&z=1+3t}$}
{$\heva{&x=1+t\\&y=2+2t\\&z=3+3t}$}
\loigiai{Đường thẳng $\Delta$ đi qua điểm $M(1;2;3)$ nhận $\overrightarrow{u}=(3;2;1)$ làm vectơ chỉ phương nên có PTTS là  $\heva{&x=1+3t\\&y=2+2t\\&z=3+t.}$}
\end{ex}
...
{$90^{\circ}$}
\loigiai{
\immini[thm]{$(B C',(A'B'C'D'))=(B C', B'C')=\widehat{B C'B'}=45^\circ$ vì tam giác $BC'B'$ vuông cân tại $B'$.}{\begin{tikzpicture}[scale=1,font=\footnotesize,line join = round, line cap = round, >= stealth]
\coordinate (A) at (0,0);
\def\x{3}
\def\y{2}
\def\z{3}
...
\immini[thm]{Cho hàm số bậc ba $y=f(x)$ có đồ thị như hình vẽ, phương trình $f(x^2)=1$ có bao nhiêu nghiệm?
\choice
{5}
{\True 3}
{2}
{6}}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round, >=stealth]
...
\end{tikzpicture}}
\loigiai{
\immini[thm]{Từ đồ thị hàm số ta thấy đường thẳng $y=1$ cắt đồ thị hàm số $y=f(x)$ tại 3 điểm có hoành độ là $a$, $0$, $b$ ($a<0<b$).\\
...
Vậy phương trình $f(x^2)=1$ có $3$ nghiệm.}{\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round, >=stealth]
\draw[->] (-1.5,0)--(0,0) node[below right]{$O$}--(1.5,0) node[below]{$x$};
\draw[->] (0,-.5) --(0,2.5) node[right]{$y$};
\draw [domain=-1.1:1.1, samples=100] %
plot (\x, {4*(\x)^3-3.5*(\x)+1});
...
Trong không gian $Oxyz$, cho mặt cầu $(S)\colon (x-1)^2+(y-1)^2+(z-2)^2=9$. Viết phương trình mặt phẳng $(\alpha)$ tiếp xúc với $(S)$ tại điểm $M(0;3;0)$.
\choice
{$x-2y+2z-12=0$}
{$x+4y+2z-12=0$}
{\True $x-2y+2z+6=0$}
...
Phương trình mặt phẳng $(\alpha)$ qua điểm $M(0;3;0)$ có vectơ pháp  tuyến $\overrightarrow{MI}=(1;-2;2)$ là 
...
{$\dfrac{a^3\sqrt{3}}{6}$}
\loigiai{
\immini[thm]{Ta có $BC=\sqrt{AC^2-AB^2}=a\sqrt{2}$.\\
...
\begin{ex}%[Thi thử Chuyên ĐH Vinh Lần 1, 2023]%[Trần Hoà, Ex6-2023]%[2H3B3-2]
Trong không gian $Oxyz$, đường thẳng $\Delta$ đi qua điểm $M(1;2;-3)$ và vuông góc với mặt phẳng $(\alpha)\colon 3x+2y+1=0$ có phương trình là
\choice
{$\heva{&x=1+3t\\&y=2+2t\\&z=-3+t}$}
...
{$\heva{&x=-1+3t\\&y=-2+2t\\&z=3+t}$}
\loigiai{
Do $\Delta \perp (\alpha)$ nên nhận $\overrightarrow{n}=(3;2;0)$ làm vectơ chỉ phương.\\
...
{\True $\pi$}
\loigiai{
\immini[thm]{Vì góc ở đỉnh bằng $120^\circ$ nên $\widehat{HSA}=60^\circ$.\\ Trong tam giác vuông $HAS$ ta có\\
...
\immini[thm]{Cần bao nhiêu thuỷ tinh để làm một chiếc cốc hình trụ có chiều cao bằng $12$ cm, đường kính đáy bằng $9{,}6$ cm (tính từ mép ngoài cốc), đáy cốc dày $1{,}8$ cm, thành xung quanh cốc dày $0{,}24$ cm (tính gần đúng đến hai chữ số thập phân)?
\choice
{$64{,}39$ cm$^3$}
{\True $202{,}27$ cm$^3$}
{$212{,}31$ cm$^3$}
...
\begin{ex}%[Thi thử Chuyên ĐH Vinh Lần 1, 2023]%[Trần Hoà, Ex6-2023]%[2H3B3-2]
Trong không gian $Oxyz$, cho mặt phẳng $(\alpha)\colon x+by+cz+d=0$ vuông góc với mặt phẳng $(\beta)\colon x+2y+3z+4=0$ và chứa giao tuyến của hai mặt phẳng $(P)\colon x+3y+z-7=0$, $(Q)\colon x-y+z+1=0$. Khi đó $d$ bằng
\choice
{\True $3$}
{$1$}
{$-3$}
{$-1$}
\loigiai{
Ta có vectơ pháp tuyến của $(\beta)$, $(P)$, $(Q)$ lần lượt là $\overrightarrow{n}_1=(1;2;3)$, $\overrightarrow{n}_2=(1;3;1)$, $\overrightarrow{n}_3=(1;-1;1)$.\\
...
{$\dfrac{a\sqrt{2}}{4}$}
\loigiai{
\immini[thm]{Gọi $H$ là trung điểm của $AB$, suy ra $SH\perp (ABCD)$.\\
Kẻ $HM\perp CD$ tại $M$.\\
...
{$3\sqrt{3}$}
\loigiai{
\immini[thm]{Gọi $\alpha$ là góc giữa hai mặt phẳng $(A'BD)$ và $(ABB'A')$.\\
...
\immini[thm]{Cho hàm số bậc ba $y=f(x)$. Đường thẳng $y=ax+b$ tạo với đường $y=f(x)$ hai miền phẳng có diện tích $S_1$, $S_2$ (hình vẽ). Biết $S_1=\dfrac{5}{12}$ và $\displaystyle\int\limits_0^1(1-2x)f'(3x)\mathrm{\,d}x=-\dfrac{1}{2}$, giá trị của $S_2$ bằng
\choice
{\True $\dfrac{8}{3}$}
{$\dfrac{19}{4}$}
{$\dfrac{13}{3}$}
...
Trong không gian $Oxyz$, cho tam giác $ABC$ có $A(3;4;4)$, $B(1;2;3)$, $C(5;0;-1)$. Điểm $M$ thay đổi trong không gian thoả mãn $\widehat{ABM}=\widehat{AMC}=90^\circ$. Mặt phẳng $(\alpha)$ đi qua $B$ và vuông góc với $AC$ cắt $AM$ tại $N$. Khoảng cách từ $N$ đến $(ABC)$ có giá trị lớn nhất bằng
\choice
{$\dfrac{4\sqrt{10}}{5}$}
...
{$\dfrac{6\sqrt{5}}{5}$}
\loigiai{
\immini[thm]{Ta có $\overrightarrow{BA}=(2;2;1)$, $\overrightarrow{BC}=(4;-2;-4)\Rightarrow \overrightarrow{BA}\cdot\overrightarrow{BC}=0$ do đó $\triangle ABC$ vuông tại $B$
và $BA=3$, $BC=6$.\\
...
Phương trình mặt phẳng $(BCM)$ đi qua $B$ có vectơ pháp tuyến $\overrightarrow{BA}=(2;2;1)$ có dạng 
$$2x+2y=z-9=0.$$
