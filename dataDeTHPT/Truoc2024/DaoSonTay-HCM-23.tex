...
\begin{ex}%[Hoàng Thanh Phương]%[2H3Y1-1]
	Trong không gian $Oxyz$, cho hai vectơ $\vec{u}=(1;1;0)$ và $\vec{v}=(2;0;-1)$. Tính độ dài $\left|\vec{u}+2\vec{v}\right|$.
	\choice
	{$2$}
	{$2\sqrt{2}$}
	{\True $\sqrt{30}$}
...
\end{ex}
\begin{ex}%[Hoàng Thanh Phương]%[2H3G3-7]
	Trong không gian $Oxyz$, từ điểm $A(1;1;0)$ ta kẻ các tiếp tuyến đến mặt cầu $(S)$ có tâm $I(-1;1;1)$, bán kính $R=1$. Gọi $M(a;b;c)$ là một trong các tiếp điểm ứng với các tiếp tuyến trên. Tìm giá trị lớn nhất của biểu thức $T=|2a-b+2c|$.
	\choice
	{$\dfrac{3+\sqrt{41}}{15}$}
	{$\dfrac{3+\sqrt{41}}{5}$}
