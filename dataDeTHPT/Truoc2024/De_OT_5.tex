...
\begin{ex}%[2H3Y1-1]%Câu 10
	Trong KG $Oxyz$, cho vectơ $\overrightarrow{a}=(-2;1;3)$ khi đó $2\overrightarrow{a}$ là
	\choice
	{\True $(-4;2;6)$}
	{$(0;3;5)$}
	{$(-4;-1;-1)$}
...
\begin{ex}%[Câu 15]%[]%[2H3Y1-1]
	Trong KG $Oxyz$, mặt phẳng nào dưới đây nhận vectơ $\overrightarrow{a}=(-2 ; 1 ; 3)$ là một vectơ pháp tuyến?
	\choice 
	{\True $-2x+y+3z=0$}
	{$2x+y+3z=0$}
	{$2x-y+3z=0$}
	{$x+3y-2z=0$}
	\loigiai{Mặt phẳng $-2x+y+3z=0$ nhận vectơ $\overrightarrow{a}=(-2 ; 1 ; 3)$ là 1 vectơ pháp tuyến.}
\end{ex}
...
%%==========Câu 28
\begin{ex}%[2D1Y3-1]
	\immini[thm]{Cho hàm số $f(x) = ax^3+bx^2+cx+d$ có đồ thị như hình vẽ bên. Giá trị nhỏ nhất của hàm số đã cho trên đoạn $[-3;3]$ bằng
		\choice
		{$f(2)$}
		{\True $f(-1)$}
		{$f(-3)$}
...
\begin{ex}%[2H3B2-3]
	...
	{$z-3=0$}
	\loigiai{
		Mặt phẳng cần tìm đi qua điểm $M(2;-1;3)$ và nhận vectơ $\vec{i} = (1;0;0)$ là vectơ pháp tuyến nên có phương trình là
...
%Câu 33
\begin{ex}%[1H3B5-3]
	\immini[thm]{Cho hình hộp $ABCD.A'B'C'D'$ có tất cả các cạnh bằng $6$ và các góc tại đỉnh $A$ đều bằng $60^\circ$ (tham khảo hình bên). Khoảng cách từ $C$ đến mặt phẳng $(A'B'C'D')$ bằng
		\choice
		{$3$}
		{\True $2\sqrt{6}$}
		{$3\sqrt{3}$}
...
\begin{ex}%[2H3B3-1]%Câu 2
	Trong không gian $ Oxyz$, đường thẳng $d$ là giao tuyến của hai mặt phẳng $\left(\alpha\right)\colon x+2y+z-1=0$ và $\left(\beta\right)\colon x-y-z+2=0$ có một vectơ chỉ phương là
	\choice
	...
	\loigiai{
		Mặt phẳng $\left(\alpha\right)$ có một vectơ pháp tuyến là $\vec n_\alpha=\left(1;2;1\right)$.\\
		Mặt phẳng $\left(\beta\right)$ có một vectơ pháp tuyến là $\vec n_\beta=\left(1;-1;-1\right)$.\\
		Vì $ d=\left(\alpha\right)\cap\left(\beta\right)$ nên đường thẳng $ d$ có một vectơ chỉ phương $\vec u$ thỏa $\left\{\begin{aligned}
...
%%==========Câu 49
\begin{ex}%[2H3G3-8]
	Trong KG $Oxyz$, cho hai điểm $A\left(2;\dfrac{9}{2};-2\right)$, $B\left(4;\dfrac{7}{2};0\right)$ và đường thẳng $d\colon \dfrac{x-2}{1}=\dfrac{y-6}{1}=\dfrac{z-1}{4}$. Gọi $(S)$ là mặt cầu có tâm $I$ qua hai điểm $A$, $B$ và tiếp xúc với đường thẳng $d$. Bán kính của $(S)$ có giá trị nhỏ nhất bằng
	\choice
