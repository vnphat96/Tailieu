...
\begin{ex}%[Đề thi thử TN THPT Lần 3, THPT Chuyên Thái Bình năm 2023]%[BCTuan, dự án 12EX6-2023]%[2H3Y1-1]%Câu 1
	Trong KG $Oxyz$, cho $\overrightarrow {a}=-\overrightarrow{i}+2\overrightarrow {j}-3\overrightarrow{k}$. Tọa độ của vectơ $\overrightarrow{a}$ là
	\choice
	{$(2;-1;-3)$}
	{$(-3;2;1)$}
	{$(2;-3;-1)$}
...
\begin{ex}%[Đề thi thử TN THPT Lần 3, THPT Chuyên Thái Bình năm 2023]%[BCTuan, dự án 12EX6-2023]%[2H3Y3-1]%Câu 13
	Trong KG $Oxyz$, một vectơ chỉ phương của đường thẳng $d\colon \dfrac{x-1}{1}=\dfrac{y+2}{-1}=\dfrac{z}{2}$ là
	\choice
