...
\begin{ex}%[Đề thi thử môn Toán 12,THPT Phan Châu Trinh, Đà Nẵng]%[Anh Duy, 12EX-6-2223]%[2H3Y3-1]%Câu 26
	Trong KG $Oxyz$, đường thẳng $(d):\heva{&x=1+2 t\\&y=4 \\& z=-3-t}$ có một vectơ chỉ phương là
	\choice
	{$\vec{n}_2=(1; 4;-3)$}
	{\True $\vec{u}_4=(2; 0;-1)$}
	{$\vec{n}_1=(1; 0;-3)$}
...
\begin{ex}%[Đề thi thử môn Toán 12,THPT Phan Châu Trinh, Đà Nẵng]%[Anh Duy, 12EX-6-2223]%[2H3Y1-2]%Câu 28
	Trong KG $Oxyz$, cho hai vectơ $\vec{u}=(1; 3;-2)$ và $\vec{v}=(2; 1; 0)$. Tích vô hướng $\vec{u}\cdot \vec{v}$ bằng
	\choice
	{$3$}
	{$\sqrt{70}$}
	{\True $5$}
