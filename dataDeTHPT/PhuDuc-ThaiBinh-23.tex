...
Trong không gian với hệ tọa độ $Oxyz$, cho mặt cầu $(S)\colon x^2+y^2+z^2-2x+2y-4z-2=0$. Tính bán kính $r$ của mặt cầu.
\choice
{\True $r=2\sqrt{2}$}
{$r=\sqrt{26}$}
{$r=4$}
...
Trong không gian $Oxyz$, mặt phẳng $(P)\colon x-2z+3=0$ có một véc-tơ pháp tuyến là 
\choice
...
Thay tọa độ của $M(1;-1;-1)$ vào phương trình $\heva{&x=3+2t\\&y=2+3t\\&z=t}$ ta thấy thỏa mãn nên đây là phương trình tham số của đường thẳng $MN$.}
\end{ex}
