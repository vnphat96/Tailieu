...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[2D2Y4-2]
	...
	\loigiai{Đạo hàm của hàm số là $y'=(1-x)'\cdot3^{1-x}\ln3=-3^{1-x}\ln3=3^{1-x}\ln\dfrac{1}{3}$.}
\end{ex}
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[2D3Y1-1]
...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[2D2B6-4]
	...
	{\True $x+x^2\ln2021>0$}
	{$1+x^2\ln2021>0$}
	\loigiai{Ta có $f(x)>1\Leftrightarrow\mathrm{e}^x\cdot2021^{x^2}>1\Leftrightarrow\ln\left(\mathrm{e}^x\cdot2021^{x^2}\right)>\ln1\Leftrightarrow x+x^2\ln2021>0$.}
\end{ex}
...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[2D3B2-1]
	...
	\loigiai{Ta có
		\begin{eqnarray*}
			...
			&=&\dfrac{1}{2}\left(\ln|x+1|-\ln|x+3|\right)\bigg|_0^1=\dfrac{1}{2}(\ln2-\ln4-\ln1+\ln3)=\dfrac{1}{2}\ln\dfrac{3}{2}.
	\end{eqnarray*}}
\end{ex}
...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[2D2G6-5]
	...
	\loigiai{Biến đổi bất phương trình ta được
		...
		\end{eqnarray*}
		Xét $f(t)=2021^t+t$, có $f'(t)=2021^t\ln2021+1>0$, $\forall t\in\mathbb{R}$ nên $f(t)$ đồng biến trên $\mathbb{R}$.\\
...
\begin{ex}%[Thi Chuyên Đề Lần 4 lớp 12 - THPT Trần Phú - Vĩnh Phúc - 23]%[Phan Anh - EX6-2023]%[2H3G3-7]
	Trong không gian $Oxyz$ cho mặt phẳng $(P)\colon x-2y+2z+12=0$ và mặt cầu $(S)\colon x^2+y^2+z^2+2x-4y-2z+5=0$. Xét hai điểm $M$, $N$ lần lượt thuộc $(P)$ và $(S)$ sao cho $\overrightarrow{MN}$ cùng phương với véc-tơ $\overrightarrow{u}=(1;1;1)$. Giá trị nhỏ nhất của $MN$ bằng
	\choice
	{$3$}
	{$9\sqrt{3}-1$}
	{\True $6\sqrt{3}$}
