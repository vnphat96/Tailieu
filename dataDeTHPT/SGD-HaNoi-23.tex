...
\begin{ex}%[Dự án 12EX6-2023]%[Đề thi thử SGD Hà Nội 2023, Nguyễn Anh Quốc]%[2H3Y2-2]
	Trong không gian $Oxyz$, một véc-tơ pháp tuyến của mặt phẳng $(\alpha)\colon x+2y-4z+2=0$ có tọa độ là	
	\choice
	{$(1;-2;4)$}
	{$(1;2;4)$}
	{$(-1;2;4)$}
...
\begin{ex}%[Dự án 12EX6-2023]%[Đề thi thử SGD Hà Nội 2023, Nguyễn Anh Quốc]%[2D2G5-5]
	...
	\loigiai{
		...
		Ta có $y'=-\dfrac{5^x4\ln 5}{\left(5^x-1\right)^2}-\dfrac{5^x2\ln5}{\left(5^x-2\right)^2}-\mathrm{e}^x<0,\forall x\in \mathscr{D}.$\\
