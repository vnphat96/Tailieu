...
\begin{ex}%[2D1H5-5]%[DỰ ÁN TEX ĐỀ THI THỬ THPT 2026]%[NHẬT THIỆN]
	\immini[thm]{Cho hàm số bậc bốn $y=f(x)$. Hàm số $y=f'(x)$ có đồ thị như hình vẽ bên.
	\choiceTF
...
\end{tikzpicture}
	...
	\par\shortans[0]{7{,}9}
	\loigiai{
	\immini[thm]{Ta trải phẳng $3$ bức tường $ADD'A'$, $ABB'A'$, $BCC'B'$ lên cùng một mặt phẳng.\\
