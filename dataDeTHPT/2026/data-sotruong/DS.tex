...
\end{center}
	...
	\loigiai{
		...
		Ta có	 $\heva{
			...
			Đường thẳng $BC$ có vectơ chỉ phương $\overrightarrow{u}\left( 1;-1+\dfrac{12}{b^2} \right)$. Mặt khác
		\begin{eqnarray*}
...
\end{center}
	...
	\fill (2,3.2) node[below ]{$D$};
		...
		\begin{itemchoice}
			\itemch 
		\immini[thm]{Theo đề bài ta có $S\left( 0;0;4 \right)$, $E\left(3;-2;0\right)$, $F\left( 3;2;0 \right)$, $H\left( \dfrac{3}{2};-1;2\right)$, $G\left(\dfrac{3}{2};1;2 \right)$. \\
			Suy ra $EF=4$, $HG=2$,
