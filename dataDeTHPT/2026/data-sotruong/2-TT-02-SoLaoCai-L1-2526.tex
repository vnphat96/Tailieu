...
\end{name}
\setcounter{ex}{0}
\Opensolutionfile{ans}[ans/ans-2-TT-01-SoLaoCai-L1-25-26]
\TN
\begin{ex}%[Đề thi thử sở Lào Cai 25-26, Đình Nguyên]%[2H2H2-4] 
...
\begin{ex}%[Đề thi thử sở Lào Cai 25-26, Đình Nguyên]%[2D4H3-4]
...
\begin{ex}%[Đề thi thử sở Lào Cai 25-26, Đình Nguyên]%[1D1N4-2] 
...
\end{ex}
\begin{ex}%[Đề thi thử sở Lào Cai 25-26, Đình Nguyên]%[1H8H1-3]
...
\end{ex} 
\begin{ex}%[Đề thi thử sở Lào Cai 25-26, Đình Nguyên]%[1D2N3-4] 
...
\end{ex}
\begin{ex}%[Đề thi thử sở Lào Cai 25-26, Đình Nguyên]%[2D1H4-1]
	\immini[thm]{Cho hàm số $y=f(x)=\dfrac{ax^2+bx+c}{mx+n}$ có đồ thị như hình vẽ bên dưới. Đường tiệm cận xiên của đồ thị hàm số đã cho có phương trình là
		\choice
		{$y=x-1$}
		{$y=3x+1$}
		{$y=x-2$}
...
\begin{ex}%[Đề thi thử sở Lào Cai 25-26, Đình Nguyên]%[1D6H4-3]
...
\begin{ex}%[Đề thi thử sở Lào Cai 25-26, Đình Nguyên]%[2H2N2-3]
...
\begin{ex}%[Đề thi thử sở Lào Cai 25-26, Đình Nguyên]%[2D3N2-2]
...
\end{ex} 
\begin{ex}%[2D1N2-2]%[Đề thi thử sở Lào Cai 25-26, Đình Nguyên] 
	\immini[thm]{Cho hàm số $f(x)$ có bảng biến thiên như hình vẽ. 
...
\begin{ex}%[Đề thi thử sở Lào Cai 25-26, Đình Nguyên]%[2D4N1-4] 
...
\end{ex}
\begin{ex}%[Đề thi thử sở Lào Cai 25-26, Đình Nguyên]%[2H2N1-1] 
	...
	{$\overrightarrow{BB'}$} 
	\loigiai{
		\immini[thm]{Xét tứ giác $ABC'D'$, ta có $AD' \parallel BC'$ và $AD' = BC'$ \\
...
\end{ex}
\cauds
\begin{ex}%[2-TT-01-SoLaoCai-L1-25-26, Bùi Quang Phú]%[2D4V2-3] 
...
\end{itemchoice}} 
\end{ex}
\begin{ex}%[2-TT-01-SoLaoCai-L1-25-26, Bùi Quang Phú]%[2H2V1-3] 
\immini[thm]{Cho hình lập phương $ABCD.A'B'C'D'$ có cạnh bằng $a$ (tham khảo hình vẽ).
\choiceTF
...
\end{itemchoice}} 
\end{ex}
\begin{ex}%[2-TT-01-SoLaoCai-L1-25-26, Bùi Quang Phú]%[2D1V5-1] 
	\immini[thm]{Cho hàm số $y=\dfrac{ax^2+bx+c}{mx+n}$ có đồ thị như hình vẽ bên.
		\choiceTF
	...
	\end{itemchoice}} 
\end{ex}
\begin{ex}%[2-TT-01-SoLaoCai-L1-25-26, Bùi Quang Phú]%[2D4V2-6]
	\immini[thm]{Một người chuyển động trên một quãng đường thẳng, mối quan hệ giữa vận tốc và thời gian được minh họa như hình vẽ. Đường cong trong hình vẽ là một phần của parabol có đỉnh tại điểm có vận tốc $22$ m/s.
		\choiceTF
	...
	\begin{tikzpicture}[>=stealth, xscale=0.27, yscale=0.18]
		% Trục tọa độ
...
\caukq
\begin{ex}%[Đề thi thử sở Lào Cai 25-26, Đình Nguyên]%[1H8V6-6] 
...
\par\shortans[oly]{$280$}
	\loigiai{
		\immini[thm]{Gọi $O$ là tâm hình thoi $ABCD$. Vì $ABCD$ là hình thoi có $\widehat{ABC}=60^\circ$ nên $\Delta ABC$ đều cạnh $6$.\\
...
\end{ex}
\begin{ex}%[2-TT-01-SoLaoCai-L1-25-26, Bùi Quang Phú]%[2D4V3-5] 
\immini[thm]{Một khối bê tông có chiều cao $2$ mét được đặt trên mặt đất. Nếu cắt khối bê tông bởi một mặt phẳng nằm ngang và cách mặt đất $x$ mét ($0 \le x \le 2$) thì được mặt cắt là một hình chữ nhật có chiều dài $5$ mét và chiều rộng bằng $(0,5)^x$ mét (tham khảo hình bên). Thể tích của khối bê tông đó bằng bao nhiêu mét khối (\textit{kết quả làm tròn đến hàng phần mười})?
\par\shortans[oly]{$5{,}4$}}{	\begin{tikzpicture}[scale=1,font={\footnotesize},>=stealth]	
	\def\n{4.17116751095}
	\def\m{1.73205080757}
	\def\q{0.57735036919}
...
\end{ex}
\begin{ex}%[Đề thi thử Sở Lào Cai 25-26, Đào-V- Thuỷ]%[2D4V2-6]
	\immini[thm]{
...
\begin{ex}%[Đề thi thử Sở Lào Cai 25-26, Đào-V- Thuỷ]%[2D1V5-8]
...
\begin{ex}%[Đề thi thử Sở Lào Cai 25-26, Đào-V- Thuỷ]%[1D2H2-7] 
...
%\indapan{4}{ans/ans-2-TT-01-SoLaoCai-L1-25-26}