...
\loigiai{Đường thẳng $\Delta$ đi qua điểm $M(1;2;3)$ nhận $\overrightarrow{u}=(3;2;1)$ làm véc-tơ chỉ phương nên có phương trình tham số là  $\heva{&x=1+3t\\&y=2+2t\\&z=3+t.}$}
\end{ex}
...
Phương trình đường thẳng $\Delta$ là $\heva{&x=1+3t\\&y=2+2t\\&z=-3.} $
}
\end{ex}
...
$f'(t)=\dfrac{1}{t\ln2} +2>0$ với mọi $t>0$ nên $f(t)$ đồng biến trên khoảng $(0;+\infty)$.\\
