...
%%Bài 5. Ứng dụng TT
% \input{data/12/2D1-B5.tex}
\input{datak40/2D2-1/2H2-B1-1.tex}
\input{datak40/2D2-1/2H2-B1-2.tex}
\input{datak40/2D2-1/2H2-B2.tex}
\input{datak40/2D2-1/2H2-B3.tex}
% ---------Mục lục chính
% \FULLWIDTH
% \tableofcontents %lệnh in mục lục chính
% \begin{center}
% \includegraphics[width=5cm]{QRcode/12D1X45.png}
% \end{center}
\end{document}