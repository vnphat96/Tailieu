...
\def\tenchude{HÀM SỐ VÀ ỨNG DỤNG}
\def\tendethi{ÔN TẬP HÀM SỐ}
...
% \input{input12.tex}
\input{TNKQ3-DAY-SO.tex}
\input{TNKQ5-GIOI-HAN-DAO-HAM.tex}
% ---------Mục lục chính
% \FULLWIDTH
% \vfill
...
% \newpage
% \begin{center}
% 	\includegraphics[width=5cm]{QRcode/12TX1.png}
% \end{center}
